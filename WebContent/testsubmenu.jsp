...
<!--@MK121021 <script type="text/javascript" src="jquery-1.3.2.min.js"></script> -->
<script type='text/javascript' src='org/Security/scripts/jquery-3.6.0.min.js'></script>
...
if(major_id.equals("FAS")){
	...
	<%
			...
			String minor="select * from SEC_MST_MINOR_SYSTEMS where  Minor_System_Id in (select distinct(Minor_System_Id) from SEC_MST_ROLE_MENUS where Role_Id in ("+temp+") and Major_System_Id='"+major_id+"' ) ORDER BY LIST_SEQ_NO";
 		...
 		//	System.out.println("subsystem="+subsystem);
 			...
 			results2=ps.executeQuery();
                                ...
                                while(results2.next())
                                { 
                                	//if(!results2.getString("sub_system_id").equalsIgnoreCase("MF033"))
