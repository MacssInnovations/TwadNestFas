  ...
  System.out.println("Inside");
     String CONTENT_TYPE = "text/html; charset=windows-1252";
       ...
       // PrintWriter pw=response.getWriter();
         ...
         Statement stmt=null;
         ResultSet rset=null;
        String employeeId=request.getParameter("ppono");
      ...
      try
      {
        ...
        String sql = "select FAMILY_PHOTO from HRM_PEN_ATTACH_PHOTO_MST where ppo_no="+employee_Id;
        //if(!cod.equals("")) {
        rset = stmt.executeQuery(sql);
        try {
            if(rset.next()) { System.out.println("test2");
                Blob ablob = rset.getBlob("FAMILY_PHOTO");
