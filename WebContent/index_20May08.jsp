...
width="300" height="42">
      ...
      type="application/x-shockwave-flash" width="300" height="42"></embed>
                        ...
                        &nbsp;</td>
                        <td align="center" valign="middle" class="blue_text">Where There is Water, There is Life..<br />
                          Where There is Pure Water, There is Healthy Life... </td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                ...
                <td align="left" valign="top"><table width="198" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td height="10"></td>
                         ...
                         <tr>
                          <td height="75" align="center" valign="middle" class="black_normal">
                                            ...
                                            <tr>
                                              <td height="25" align="left"
                                                ...
                                                <a style="text-decoration:none;cursor:pointer;color:blue" href="http://218.248.23.7/ruralws"
                                                   target="_blank">Rural Progress Monitoring Site</a>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td height="25" align="left"
                                                  valign="top" class="content">
                                                <a style="text-decoration:none;cursor:pointer;color:blue" href="http://www.aboutrainwaterharvesting.com"
                    ...
                    <td width="340" align="left" valign="top"><table width="340" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top"><table width="340" border="0" cellpadding="0" cellspacing="0" class="blue_border">
                          ...
                          <td height="75" align="center" valign="middle" class="black_normal">
                          <marquee id="ieslider" onMouseover="this.scrollAmount=0" onMouseout="this.scrollAmount=2" 
                                                 scrollAmount="2" width='340' height="75"
                                                 direction="up" 
                                                 style="border:0;">
                           <table>
                    <%
                        ...
                        <!--  <tr>
                          ...
                          <tr>
                            <td height="20" align="right"><!--<input  type='button' onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'" value="RSS" class="btn" onclick="javascript:loadPageInNewWindow('<%=request.getContextPath()%>/news.xml')"></input>--></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
                    <td align="right" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="blue_border">
                          ...
                          <tr>
                            <td height="15" align="left" valign="middle" class="content">
                            <a style="text-decorate:none;cursor:hand;color:blue"
                            onclick="javacript:loadPageInNewWindow('<%=request.getContextPath()%>/viewbirthday.jsp')">Birthday Wishes</a>
                            </td>
                          </tr>
                          <tr>
                            <td height="15" align="left" valign="middle" class="content">
                          ...
                          <tr>
                            <td align="center" valign="top">
                            <marquee id="ieslider" scrollAmount=1 width=323 height=34  direction=up style="border:0;">
                            <table width="95%" border="0" cellspacing="0" cellpadding="0">
