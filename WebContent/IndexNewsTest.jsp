...
<script language="javascript">
   ...
   function open_New_Win(target_page)
    ...
    function opnListOfNews()
    {
        ...
        Entire_news=window.open(url,"EntireNews",status=1,height=50,width=50);
    }
    </script>
</head>
...
<table cellspacing="0" border="0">
	<tr valign="top">
		<td colspan=3><img src="images\TWADlatest.gif" height="80px"
			width="350px"></img></td>
	</tr>
	<tr>
		<td colspan=3>
  ...
  %>
						...
						<form action="ServletLogin.con" method="POST"><pre><b>
<%
try
{
  ...
  Password   
     <input type=password name=txtPassword maxlength="15" size="15">
          ...
          <input type="image" src="images/Login_but.JPG"
					...
					<tr>
						<td><!-- code to forget password
              -->
						<div id="forgetPwd" class="forgetPwd"><!--  <a href="ForgetPassword.jsp"> -->
						<div onmouseover="this.style.cursor='hand'" align="center"
							valign="center"><img src="images/help.png"> Forgot
						Your Password?</div>
						<!--  </a>  --></div>
						</td>
					</tr>
			...
			<tr>
				...
				<%
                             String my_content="'";
                                                        ...
                                                        results.close();
                   %> <input type="hidden" name="content_tot"
					id="content_tot" value=<%=my_content%>>
...
if (iedom){
		...
		<table cellspacing="0" width="100%">
			<tr>
				<td>
				<div id="Center" class="BodyCenter"><br>
				<br>
				<hr
					style="border-width: 2.0px; border-style: groove; border-color: rgb(210, 225, 228);">
				<center><span style="font-size: 14pt; font-family: Arial">
				Welcome To TWAD Board<br>
				Intranet Services </span></center>
				<hr
					style="border-width: 2.0px; border-style: groove; border-color: rgb(210, 225, 228);">
				<p align="justify"><span> &nbsp;&nbsp;&nbsp;The Intranet
				system for TWAD Board facilitates centralized data storage and
				retrieval besides information analysis pertaining to Project
				Monitoring, Financial Accounting and HR Management. This system will
				be made available to all the offices of TWAD Board through a network
				connecting the Head Office with all the Regions, Circles and
				Divisions. </span></p>
				<hr
					style="border-width: 2.0px; border-style: groove; border-color: rgb(210, 225, 228);">
				</div>
		...
		<table cellspacing="0" width="100%">
			<tr>
				...
				<div id="seemore" name="seemore"><a id="more" name="more"
					href=# onclick="opnListOfNews();" class="forgetPwd"><font
					color="Black">SeeMore...</font></a></div>
				</div>
	...
	<tr>
		...
		<center>Designed and Developed By<br>
		<a href=# onclick=open_New_Win('www.tn.nic.in') >National
		Informatics Centre</a>, Chennai.</center>
		</div>
		</td>
	</tr>
</table>
