...
<html>
  <head>
    ...
    <title>WQS_DateWise_itemIssuejsp</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_DateWise_ItemIssuejs.js"></script>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet"          media="screen"/>    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>       
  </head>
  <body>
  <form name="ItemIssue" action="">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Item Issue Details</b></td>            
        </tr>
        <tr>
            ...
            <td class="table" align="left" width="51%">
                <select name="cat" id="cat">
                    ...
                    <%
                        ...
                        rs=st.executeQuery("select MAJOR_CATEGORY_CODE,MAJOR_CATEGORY_DESC from WQS_MST_INV_CATEGORY where MAJOR_CATEGORY_DESC not in('Instrument','INSTRUMENT','instrument')");
                        while(rs.next())
                        {
                            String catcode=rs.getString("MAJOR_CATEGORY_CODE");
                            String catdesc=rs.getString("MAJOR_CATEGORY_DESC");
                            System.out.println(catdesc);
                            out.println("<option value="+catcode+">"+catdesc+"</option>");
                        }
                %>
                </select>
        </tr>
        <tr>
            <td class="table" align="left" width="49%">Issued Date from</td>
            <td class="table" align="left" width="51%">
                <input type="text" name="fromdt" id="fromdt">
                <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.ItemIssue.fromdt);" alt="Show Calendar" id="pur_date_cal"></img>                                    
            </td>
        </tr>
        <tr>
            <td class="table" align="left" width="49%">Issued Date to</td>
            <td class="table" align="left" width="51%">
                <input type="text" name="todt" id="todt">
                <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.ItemIssue.todt);" alt="Show Calendar" id="pur_date_cal1"></img>                                    
            </td>
        </tr>
        <tr class="table">
          <td width="51%">
