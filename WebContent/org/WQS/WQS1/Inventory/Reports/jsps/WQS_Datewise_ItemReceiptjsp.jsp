...
<html>
  <head>
    ...
    <title>WQS_Datewise_ItemReceiptjsp</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_DateWise_ItemReceiptjs.js"></script>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet"          media="screen"/>    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>       
  </head>
  <body>
   <form name="ItemReceipt" action="">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Item Receipt Details</b></td>            
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.ItemReceipt.fromdt);" alt="Show Calendar" id="pur_date_cal"></img>                                    
            </td>
        </tr>
        <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.ItemReceipt.todt);" alt="Show Calendar" id="pur_date_cal1"></img>                                    
            </td>
        </tr>
        <tr class="table">
          <td width="51%">
