...
<html>
  <head>
    ...
    <title>WQS_PeriodicalPurchaseOrder_jsp</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_PeriodicalPurchaseOrder_js.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Periodical Purchase Order Details</b></td>            
        </tr>
        <tr>
