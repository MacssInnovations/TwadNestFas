...
<html>
  <head>
    ...
    <title>Purchase Orderwise Pending Supply Report</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_PurchaseOrder_PendingJS.js"></script>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/>    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>       
  </head>
    <body>
      <form name="PurchaseOrder" method="GET" action="../../../../../../WQS_PurchaseOrder_PendingServ">
      <%
            String lab="5000--Head Office,Chennai";
            Connection con=null;
            Statement st=null;
            ResultSet rs=null;
      ...
      %>
          <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
                <tr>
                    <td class="tdH" align="center" colspan="2"><b>Purchase Orderwise Pending Supply Report</b></td>            
                </tr>
                <tr>
                    <td class="table" align="left" width="49%">Laboratory <font color="Red">*</font></td>
                    <td class="table" align="left" width="51%">
                        <input type=text name="lab" id="lab" size="35" value="<%=lb%>" readonly="readonly">
                    </td>
                </tr>
                <tr>
                <td class="table" align="left" width="49%">Category <font color="Red">*</font></td>
                <td class="table" align="left" width="51%">
                ...
                <tr>
                    <td class="table" align="left" width="49%">Date From <font color="Red">*</font></td>
                    <td class="table" align="left" width="51%">
                        <input type="text" name="fromdt" id="fromdt">
                        <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.PurchaseOrder.fromdt);" alt="Show Calendar" id="pur_date_cal1"></img>                                    
                    </td>
                </tr>
                <tr>
                    <td class="table" align="left" width="49%">Date To <font color="Red">*</font></td>
                    <td class="table" align="left" width="51%">
