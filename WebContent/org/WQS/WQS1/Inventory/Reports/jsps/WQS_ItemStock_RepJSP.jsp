...
<html>
  <head>
    ...
    <title>WQS_ItemStock_RepJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen">
    <script type="text/javascript" src="../scripts/WQS_ItemStock_RepJS.js"></script>
  </head>
  <body>
  <form name=Stock action="">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Stock Details</b></td>            
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <%
                    ...
                    rs=st.executeQuery("select * from WQS_MST_INV_CATEGORY");
                    while(rs.next())
                    {
