...
<html>
  <head>
    ...
    <title>WQS_ChemDirRep</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_ChemDirRep.js"></script> 
  </head>
  <body>
   <form name="ChemDirReport" method="get" action="">
  <table cellspacing="2" cellpadding="3" border="1" width="90%">
        <tr class="tdH">
          <th colspan="2">
            <strong><font face="Times New Roman" size="4">
                Chemical Directory Report
              </font></strong>
          </th>
        </tr>
        <tr class="table">
