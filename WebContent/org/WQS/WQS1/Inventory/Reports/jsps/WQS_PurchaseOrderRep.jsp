...
<html>
  <head>
    ...
    <title>WQS_PurchaseOrderRep</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_PurchaseOrderRep.js"></script>
  </head>
  <body>
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Purchase Order Report</b></td>            
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <%
                    ps=con.prepareStatement("select distinct PURCHASE_ORDER_NO from WQS_ITEM_PUR_ORDER_DETAILS where LAB_CODE=?");
                    ps.setInt(1,odidt);
                    rs=ps.executeQuery();
                    while(rs.next())
                    {
                        String ono=rs.getString("PURCHASE_ORDER_NO");
                        System.out.println(ono);
                        out.println("<option value="+ono+">"+ono+"</option>");
                    }
                %>
                </select>
            </td>
