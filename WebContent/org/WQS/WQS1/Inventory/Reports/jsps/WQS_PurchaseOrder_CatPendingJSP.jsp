...
<html>
  <head>
    ...
    <title>Productwise Pending Supply Report</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_PurchaseOrder_CatPendingJS.js">
    </script>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet"          media="screen"/>    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>       
  </head>
  <body>
   <form name="PurchaseOrder" method="GET" action="../../../../../../WQS_PurchaseOrder_CatPendingServ">
      <%
      ...
      %>
          <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
                <tr>
                    <td class="tdH" align="center" colspan="2"><b>Productwise Pending Supply Report</b></td>            
                </tr>
                <tr>
