...
<html>
  <head>
    ...
    <title>WQS_DirectoryRepjsp</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_DirectoryRepjs.js"></script>
  </head>
  <body>
  <form name="Directory" action="">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
         <tr>
            <td class="tdH" align="center" colspan="2"><b>Directory Report</b></td>            
         </tr>
        <tr>
            <td class="table" align="left" width="49%">Category</td>
            <td class="table" align="left" width="51%">
                <input type="hidden" name="lab" id="lab" value="<%=lb%>" size="35" readonly="readonly">
                <select name="cat" id="cat">
                <option value="">--Select--</option>
                <%
                    st=con.createStatement();
                    rs=st.executeQuery("select MAJOR_CATEGORY_DESC from WQS_MST_INV_CATEGORY");
                    while(rs.next())
                    {
