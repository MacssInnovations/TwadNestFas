...
<html>
  <head>
    ...
    <title>WQS_ItemIssueJSP</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js">
    </script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_ItemIssueJS.js"></script>
  ...
  <form name="ItemIssue" method="POST" action="../../../../../../WQS_ItemIssue" onsubmit="return nullValue()">
  <%
            Connection con=null;
            Statement st=null;
            ResultSet rs=null;
  ...
  %>
   <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="2" class="tdH" align="center"><b>Issue Details</b></td>
       </tr> 
         <tr>
        ...
        <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.ItemIssue.rdate);" alt="Show Calendar" id="pur_date_cal"></img>                                    
            </td>
        </tr>
