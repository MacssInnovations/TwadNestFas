...
<html>
  <head>
    ...
    <title>WQS_PurchaseOrder_CancelJSP</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js">
    </script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_PurchaseOrder_CancelJS.js"></script>
  ...
  <form name="PurchaseCancel" action="">
  <%
            Connection con=null;
            Statement st=null;
            ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Cancel Purchase Order Details</b></td>            
        </tr>
        <tr>
    ...
    <table border="1" width="100%">
            <tr class="tdH" align="center">
                <td colspan="2" align="center">
                    <input type="button" value="Cancel" name="validate" onclick="validatefun()"></input>
