...
<html>
  <head>
    ...
    <title>WQS_UOM_Masterjsp</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js">
    </script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_UOM_Masterjs.js"></script>
  </head>
  <body onload="loading()">
   <form name="uomfrm" action="">
   <%
      ...
      <table cellspacing="3" cellpadding="2" border="1" width="90%"
        ...
        <tr class="tdH">
          <td colspan="2" align="center">
            <font face="Times New Roman">
              <strong>Unit of Measurement Master</strong>
            </font></td>
        ...
        <tr class="table">
          ...
          <td width="54%">
            ...
            size="10" id="code" onblur="checkdup()"/>
          </td>
        </tr>
        <tr class="table">
          <td width="46%">
            <font face="Times New Roman">
              <strong> UOM Description</strong>
            </font></td>
          <td width="54%">
        ...
        <tr class="tdH">
          <td colspan="2" align="center">
            ...
            <tr class="tdH">
            <th width="20%">Edit</th><th width="20%">UOM Code</th><th width="20%">UOM Description</th>
            </tr>
