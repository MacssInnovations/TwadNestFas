...
<html>
  <head>
    ...
    <title>WQS_InstrumentCategoryJSP</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js">
    </script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"          media="screen"/>
    <script language="javascript" src="../scripts/WQS_InstrumentCategoryJS.js" type="text/javascript">
    </script>
  </head>
  <body onload="loading()">
  <form name="InstrDirFrm" action="">
  <%
  ...
  %>
      ...
      <table cellspacing="3" cellpadding="2" border="1" width="90%"
        ...
        <tr class="tdH">
          <td colspan="2" align="center">
            <font face="Times New Roman">
              <strong>Instrument Directory</strong>
            </font></td>
        ...
        <tr class="table">
          <td width="46%">
            <font face="Times New Roman">
              <strong> Instrument Category Code</strong>
            </font></td>
          <td width="54%">
        ...
        <tr class="table">
          <td width="46%">
            <font face="Times New Roman">
              <strong> Instrument Category Description</strong>
            </font></td>
          <td width="54%">
      ...
      <tr class="tdH">
      <th width="20%">Edit</th><th width="20%">Instrument Category Code</th><th width="20%">Instrument Category Description</th>
      </tr>
