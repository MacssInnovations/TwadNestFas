...
<html>
       ...
       <tr>
        ...
        <tr>
          ...
          try
          {
	        ...
	        String strCusDesc=results.getString("CATEGORY_DESC");
               
                out.println("<option value='" + strCusId + "'>"+strCusDesc+"</option>");   
  ...
  %>   
         ...
         <tr>
            <td colspan="2" class="tdH" align="center"><b>Supplier Address</b></td>
