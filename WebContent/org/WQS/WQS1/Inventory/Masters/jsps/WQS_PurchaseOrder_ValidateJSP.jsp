...
<html>
  <head>
    ...
    <title>WQS_PurchaseOrder_ValidateJSP</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js">
    </script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" src="../scripts/WQS_PurchaseOrder_ValidateJS.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Validate Purchase Order Details</b></td>            
        </tr>
        <tr>
        ...
        <table cellspacing="2" cellpadding="3" border="1" width="100%">
            ...
            <tr>
                <td class="table" align="left" width="49%">Remarks</td>
                    <td class="table" align="left" width="51%">
                        <input type="text" name="rem" id="rem" readonly="readonly" size=70></input>
                    </td>
            </tr>
        </table>
    </div>
    <table border="1" width="100%">
            <tr class="tdH" align="center">
                <td colspan="2" align="center">
                    <input type="button" value="Validate" name="validate" onclick="validatefun()"></input>
