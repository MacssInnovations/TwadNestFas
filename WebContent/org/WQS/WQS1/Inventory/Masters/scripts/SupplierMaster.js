...
function Check()
{
var supid=document.SupplierForm.txtSupId.value;

}
function clearAll()
 {
   document.SupplierForm.txtSupId.selectedindex=0;
 ...
 function nullCheck()
        {
                  ...
                  if((document.SupplierForm.txtSupId.value=="") || (document.SupplierForm.txtSupId.value.length<=0))
                  {
                  ...
                  if((document.SupplierForm.txtAddr1.value=="") || (document.SupplierForm.txtAddr2.value.length<=0) || (document.SupplierForm.txtAddr3.value.length<=0))
                  {
                       alert("Please Enter the Addreses");
                 ...
                 if((document.SupplierForm.txtCatId.value=="") || (document.SupplierForm.txtCatId.value.length<=0))
                  {
                       alert("Please Select Customer Category Id");
                       document.SupplierForm.txtCatId.focus();
                       return false;
                  }
                  
                  if((document.SupplierForm.txtPin.value=="") ||(document.SupplierForm.txtFax.value.length<=0) || (document.SupplierForm.txtMail.value.length<=0))
                  {
                    alert("Please Enter the blank spaces");
...
function callServer(command,param)
 ...
 if(command=="Add")
        {           //var flag=nullCheck();
                    //if(flag==true)
                   //{
                    url="../../../../../../suppliermaster_servlet?command=Add&CategoryId="+txtcatid+"&SupplierId="+txtsupid+"&SupplierName="+txtsupname+"&Address1="+txtaddr1+"&Address2="+txtaddr2+"&Address3="+txtaddr3+"&Pin="+txtpin +"&Phone1="+txtphone1 +"&Phone2="+txtphone2 +"&Fax="+ txtfax+"&Mail="+txtmail;
        ...
        else if(command=="Update")
        {
                    ...
                    if(flag==true)
                    {
                    url="../../../../../../suppliermaster_servlet?command=Update&CategoryId="+txtcatid+"&SupplierId="+txtsupid+"&SupplierName="+txtsupname+"&Address1="+txtaddr1+"&Address2="+txtaddr2+"&Address3="+txtaddr3+"&Pin="+txtpin +"&Phone1="+txtphone1 +"&Phone2="+txtphone2 +"&Fax="+ txtfax+"&Mail="+txtmail;
                    var req=getTransport();
                    req.open("GET",url,true);       
                    req.onreadystatechange=function()
                    {
        ...
        { 
                    ...
                    url="../../../../../../suppliermaster_servlet?command=Delete&CategoryId="+txtcatid+"&SupplierId="+txtsupid+"&SupplierName="+txtsupname+"&Address1="+txtaddr1+"&Address2="+txtaddr2+"&Address3="+txtaddr3+"&Pin="+txtpin +"&Phone1="+txtphone1 +"&Phone2="+txtphone2 +"&Fax="+ txtfax+"&Mail="+txtmail;
                   var req=getTransport();
                    req.open("GET",url,true);       
                    req.onreadystatechange=function()
                    {
        ...
        {              
            ...
            url="../../../../../../suppliermaster_servlet?command=Get";
  ...
  function addRow(baseResponse)
{
              ...
              {                       
                ...
                // alert("Concession Code Is " +  did);
                 ...
                 maila=baseResponse.getElementsByTagName("Mail")[0].firstChild.nodeValue;
               ...
               seq=seq+1;                         
                ...
                var cell9 =document.createElement("TD");   
                 ...
                 var txtma=document.createTextNode(maila);                        
                ...
                document.SupplierForm.CmdUpdate.disabled=true;
                document.SupplierForm.CmdDelete.disabled=true;          
                document.SupplierForm.txtCatId.selectedIndex=0;
               document.SupplierForm.txtSupId.value="";
                ...
                document.SupplierForm.txtFax.value="";
                document.SupplierForm.txtMail.value="";
                document.SupplierForm.txtCatId.disabled=false;
      ...
      var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
       ...
       {  
           alert("Record Updated Successfully.");
               var items=new Array();
               items[0]=document.SupplierForm.txtCatId.value;
               items[1]=document.SupplierForm.txtSupId.value;
               items[2]=document.SupplierForm.txtSupName.value;
               items[3]=document.SupplierForm.txtAddr1.value;
               items[4]=document.SupplierForm.txtAddr2.value;
               items[5]=document.SupplierForm.txtAddr3.value;
               items[6]=document.SupplierForm.txtPin.value;
...
function deleteRow(baseResponse)
  ...
  function loadValuesFromTable(rid)
    {     
          ...
          var tbody=document.getElementById("tblList");
          var table=document.getElementById("Existing");
        document.SupplierForm.txtCatId.value=rcells.item(1).firstChild.nodeValue;
        document.SupplierForm.txtSupId.value=rcells.item(2).firstChild.nodeValue;
          ...
          document.SupplierForm.txtPhone1.value=rcells.item(8).firstChild.nodeValue;
          document.SupplierForm.txtPhone2.value=rcells.item(9).firstChild.nodeValue;
          document.SupplierForm.txtFax.value=rcells.item(10).firstChild.nodeValue;
          document.SupplierForm.txtMail.value=rcells.item(11).firstChild.nodeValue;
        ...
        document.SupplierForm.txtCatId.disabled=true;
