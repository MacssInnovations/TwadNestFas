...
function nullCheck()
{
                  ...
                  if((document.getElementById("MisCode").value=="") || (document.getElementById("MisCode").value.length<=0))
                  {
                       alert("Dont leave Miscellaneous Code field is empty");
                       return false;
                  }
...
var GlassCode=document.getElementById("MisCode").value;
    var url="../../../../../../WQS_Miscellaneous_Master?command=getNos&LabCode="+LabCode[0]+"&GlassCode="+GlassCode;
...
var remarks=document.getElementById("remarks").value;
    ...
    if(flag==true)
    {
        var url="../../../../../../WQS_Miscellaneous_Master?command=add&LabCode="+LabCode[0]+"&GlassCode="+GlassCode+"&nos="+qty+"&uom="+uom+"&sdate="+sdate+"&remarks="+remarks;
        var req=getTransport();
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
...
var remarks=document.getElementById("remarks").value;
    ...
    if(flag==true)
    {   
        var url="../../../../../../WQS_Miscellaneous_Master?command=upd&LabCode="+LabCode[0]+"&GlassCode="+GlassCode+"&nos="+qty+"&uom="+uom+"&sdate="+sdate+"&remarks="+remarks;
        var req=getTransport();
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
...
var GlassCode=document.getElementById("MisCode").value;
    ...
    var url="../../../../../../WQS_Miscellaneous_Master?command=del&LabCode="+LabCode[0]+"&GlassCode="+GlassCode;
    var req=getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
...
function clr()
{
               document.getElementById("MisCode").value="select";
               document.getElementById("MisCode").disabled=false;               
...
function manipulate(req)
{
        if(req.readyState==4)
        {
          if(req.status==200)
          {
               ...
               var uom=response.getElementsByTagName("udesc")[0].firstChild.nodeValue;
               ...
               document.getElementById("update").disabled=false;
               document.getElementById("delet").disabled=false;
               document.getElementById("MisCode").disabled=true;
               }
               else
               {
