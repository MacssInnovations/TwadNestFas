...
<html>
  <head>
    ...
    <title>WQS_InvoiceNumber_RepJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    </head>
  <body>
  <form name="customer_rep" method="POST" action="../../../../../../WQS_InvoiceNumber_RepServ">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
     <tr>
            <td class="tdH" align="center" colspan="2"><b>Customer Typewise Invoice number Report</b></td>            
     </tr>
     <tr>
