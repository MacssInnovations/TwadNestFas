...
<html>
  <head>
    ...
    <title>WQS_Customer_RepJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    </head>
  <body>
  <form name="customer_rep" method="POST" action="../../../../../../WQS_Customer_RepServ">
  <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
     <tr>
            <td class="tdH" align="center" colspan="2"><b>Typewise Customer Report</b></td>            
     </tr>
     <tr>
            ...
            <td class="table" align="left" width="51%">
                ...
                <%
                        ...
                        while(rs.next())
                        {
                                if(rs.getInt("lab_code")!=5000)
                                    out.println("<option value="+rs.getInt("lab_code")+"--"+rs.getInt("lab_code")+">"+rs.getString("lab_desc")+"</option>");
                                else
                                    out.println("<option value="+rs.getInt("lab_code")+"--"+rs.getInt("lab_code")+" selected='selected'>"+rs.getString("lab_desc")+"</option>");
                        }     
                %>
                </select>
    ...
    <tr>
            <td class="table" align="left" width="49%">Customer Type</td>
            <td class="table" align="left" width="51%">
    ...
    <tr class="tdH">
          <td colspan="2" align="center">
            <input type="submit" value="Generate Report" name="btsubmit" id="btsubmit">
