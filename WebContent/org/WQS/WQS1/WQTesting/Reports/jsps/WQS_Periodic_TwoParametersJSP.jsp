...
<html>
  <head>
    ...
    <title>WQS_Periodic_TwoParametersJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_Periodic_TwoParametersJS.js"></script>
  ...
  %>
   <table class="table" cellspacing="2" cellpadding="3" border="0" width="100%" align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Sample Result for Appear and Odor</b></td>            
        </tr>
      <tr>
           ...
           <tr>
            ...
            <tr>
                    ...
                    <%
                        ...
                        rs=st.executeQuery("select * from(select element_symbol from wqs_nonnumeric_parameters)a inner join(select sno,element_symbol from wqs_element_symbol)b on a.element_symbol=b.element_symbol order by sno");
                        out.println("<table cellpadding=0 cellspacing=0 border=0 width='50%'>");
                        out.println("<th colspan='2' align='center'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Comparing Values");
                        int i=0;
                        while(rs.next())
                        {
                            out.println("<tr><td>");
                            ...
                            out.println("</td><td>");
                            out.println("<input type='text' name='esval' id='esval' disabled='disabled' style='background-color:rgb(214,214,214)'>");
                            out.println("</td></tr>");
                            i++;
                        }
                        out.println("</table>");
