...
<html>
  <head>
    ...
    <title>WQS_Periodic_RegularParametersJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_Periodic_RegularParametersJS.js"></script>
  ...
  %>
   <table class="table" cellspacing="2" cellpadding="3" border="0" width="100%" align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Sample Result for Regular Parameter</b></td>            
        </tr>
      <tr>
           ...
           <tr>
            ...
            <tr>
                    ...
                    <%
                        ...
                        boolean bool=false;
                        rs=st.executeQuery("select * from(select element_symbol from wqs_regular_parameters)a inner join(select sno,element_symbol from wqs_element_symbol)b on a.element_symbol=b.element_symbol order by sno");
