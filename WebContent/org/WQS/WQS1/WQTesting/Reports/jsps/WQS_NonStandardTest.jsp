...
<html>
  <head>
    ...
    <title>Non Standard Test Details</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/NonStandardTest.js"></script>
  ...
  <form action="" name="NonStandardForm">
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="2" class="tdH" align="center"><b>Non Standard Test</b></td>
                   
       </tr> 
        <tr>
            <td class="table">Non Standard Test Code</td>
            <td class="table">
