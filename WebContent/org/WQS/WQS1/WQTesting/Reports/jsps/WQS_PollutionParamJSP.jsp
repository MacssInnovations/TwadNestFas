...
<html>
  <head>
    ...
    <title>WQS_PollutionParamJSP</title>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/WQS_PollutionParamJS.js"></script>  
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/>    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>        
    <script type="text/javascript" src="../HR/HR1/EmployeeMaster/scripts/CalendarControl.js">
    </script>
  </head>
  <body onload="loadParameter()">
  <form name="PollutionRep">
   <%
        Connection con=null;
        Statement st=null;
        ResultSet rs=null;
  ...
  %>
   <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Sample Result for Pollution Parameters</b></td>            
        </tr>
        <tr>
            <td class="table" width="50%">Period From <font color="Red">*</font></td>
            <td class="table" width="50%">
            <input type="text" name="fdate" id="fdate">
            <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.PollutionRep.fdate);" alt="Show Calendar" id="pur_date_cal"></img>
            </td>
        </tr>
        <tr>
            ...
            <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.PollutionRep.tdate);" alt="Show Calendar" id="pur_date_cal"></img>
            </td>
        </tr> 
         <tr>
            <td class="table" width="50%">Customer Type</td>
            <td class="table" width="50%">
        ...
        <div id="twaddt" style="display:none">
            ...
            <tr>
                <td class="table" align="left" width="40%">District <font color="Red">*</font></td>
