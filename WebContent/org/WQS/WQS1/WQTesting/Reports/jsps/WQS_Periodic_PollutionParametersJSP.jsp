...
<html>
  <head>
    ...
    <title>WQS_Periodic_PollutionParametersJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/WQS_Periodic_PollutionParametersJS.js"></script>
  ...
  %>
   <table class="table" cellspacing="2" cellpadding="3" border="0" width="100%" align="center">
        <tr>
            <td class="tdH" align="center" colspan="2"><b>Sample Result for Pollution Parameter</b></td>            
        </tr>
      <tr>
           ...
           <tr>
            ...
            <tr>
                    ...
                    <%
                        ...
                        boolean bool=false;
                        rs=st.executeQuery("select * from(select element_symbol from wqs_pollution_parameters)a inner join(select sno,element_symbol from wqs_element_symbol)b on a.element_symbol=b.element_symbol order by sno");
                        out.println("<table cellpadding=0 cellspacing=0 border=1 width='50%'>");
                        out.println("<th>Parameter</th><th>Min Value</th><th>Max Value</th>");
                        int i=0;
                        while(rs.next())
                        {
                            if(bool=!bool)
                            {
                                ...
                                out.println("<input type='checkbox' name='es' id='es' style='background-color:pink' value='"+rs.getString("element_symbol")+"' onclick='changeParam("+i+")'>"+rs.getString("element_symbol"));
                                out.println("</td><td>");
                                out.println("<input type='text' name='minvalue' id='minvalue' disabled='disabled' style='background-color:rgb(214,214,214)' onkeypress='return filter_real(event,this,5,5)'>");
                                out.println("</td><td>");
                                out.println("<input type='text' name='maxvalue' id='maxvalue' disabled='disabled' style='background-color:rgb(214,214,214)' onkeypress='return filter_real(event,this,5,5)'>");
                                out.println("</td></tr>");
                            }
                            else
                            {
                                out.println("<tr><td>");
                                out.println("<input type='checkbox' name='es' id='es' value='"+rs.getString("element_symbol")+"' onclick='changeParam("+i+")'>"+rs.getString("element_symbol"));
                                out.println("</td><td>");
                                out.println("<input type='text' name='minvalue' id='minvalue' disabled='disabled' style='background-color:rgb(214,214,214)' onkeypress='return filter_real(event,this,5,5)'>");
                                out.println("</td><td>");
                                out.println("<input type='text' name='maxvalue' id='maxvalue' disabled='disabled' style='background-color:rgb(214,214,214)' onkeypress='return filter_real(event,this,5,5)'>");
