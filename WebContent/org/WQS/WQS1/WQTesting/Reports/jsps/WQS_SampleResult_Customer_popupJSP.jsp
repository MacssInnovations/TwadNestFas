...
<html>
  <head>
    ...
    <title>WQS_SampleResult_Customer_popupJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" src="../scripts/WQS_SampleResult_Customer_popupJS.js" type="text/javascript"></script>
  </head>
  <body onload="loadfun()">
      <form name="customer_popup"> 
      <%
                Connection con=null;
                ResultSet rs=null;
                ...
                try
                {
                    ...
                    System.out.println("office_id===========>"+oid);
                    rs.close();
                    ps.close();
            ...
            %>
            <table cellspacing="4" cellpadding="2" border="1" width="100%" align="center" >
         <tr class="tdH">
         <td colspan="5">
