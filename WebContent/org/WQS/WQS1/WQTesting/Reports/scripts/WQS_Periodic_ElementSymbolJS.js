...
function changeLocation()
{
    ...
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype;
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeLocation&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeDistrict()
{
    ...
    if(res==true)
    {
        ...
        {
            var req=getTransport();
            var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeDistrict&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0];
            req.open("GET",url,"true");
            req.onreadystatechange=function()
            {
                manipulate(req);
        ...
        {            
            var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeLocationType&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
...
{    
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype+"&ltype="+val;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeLocalBody()
{
    ...
    lbody=lbody.split("--");
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeLocalBody&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype+"&lbody="+lbody[0];
    var req=getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
...
function changeBlock()
{
    ...
    block=block.split("--");    
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeBlock&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changePanchayat()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changePanchayat&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeHabitation()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeHabitation&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0]+"&hcode="+habitation[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function getElement()
{
        var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=element" ;
        document.SampleResult.param.focus();
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
...
function gen_rep()
{
    ...
    if(val==true)
    {
        ...
        var operation="";
        if(document.SampleResult.opt[0].ckecked==true)
            operation="Equal";
        else if(document.SampleResult.opt[1].checked==true)
            operation="Lessthan";
        else if(document.SampleResult.opt[2].checked==true)
            operation="Greaterthan";
        else if(document.SampleResult.opt[3].checked==true)
            operation="Lessthanequal";
        else if(document.SampleResult.opt[4].checked==true)
            operation="Greaterthanequal";
        var cval=document.SampleResult.cval.value;
        var url="../../../../../../WQS_Periodic_ElementSymbolServ?lab="+lab[0]+"&fdate="+fdate+"&tdate="+tdate+"&ctype="+ctype+"&ltype="+ltype+"&dname="+dname+"&lbody="+lbody+"&block="+block+"&panchayat="+panchayat+"&habitation="+habitation+"&location="+location+"&es="+es+"&operation="+operation+"&cval="+cval;
...
function changeDist()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=changeDist&dcode="+dname;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manip(req);
...
function loadData()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_ElementSymbolServ?command=loadData&lab="+lab[0];
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function checkValid()
{
    ...
    {
        if(document.SampleResult.es.checked==false)
        {
            alert("Select Parameter");
            return false;
        }
    }
    if(document.SampleResult.opt[0].checked==false && document.SampleResult.opt[1].checked==false && document.SampleResult.opt[2].checked==false && document.SampleResult.opt[3].checked==false && document.SampleResult.opt[4].checked==false)
    {
        alert("Select Value Option");
        return false;
    }
    if(document.SampleResult.cval.value==""||document.SampleResult.cval.length==0)
    {
...
function elementSelectAll()
{
  if(document.SampleResult.es)
      {
            for(i=0;i<document.SampleResult.es.length;i++)
            {
                    document.SampleResult.es[i].checked=true;
