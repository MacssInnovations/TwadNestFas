...
function changeLocation()
{
    ...
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype;
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeLocation&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeDistrict()
{
    ...
    if(res==true)
    {
        ...
        {
            var req=getTransport();
            var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeDistrict&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0];
            req.open("GET",url,"true");
            req.onreadystatechange=function()
            {
                manipulate(req);
        ...
        {            
            var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeLocationType&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
...
{    
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype+"&ltype="+val;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeLocalBody()
{
    ...
    lbody=lbody.split("--");
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeLocalBody&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype+"&lbody="+lbody[0];
    var req=getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
...
function changeBlock()
{
    ...
    block=block.split("--");    
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeBlock&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changePanchayat()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changePanchayat&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeHabitation()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeHabitation&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0]+"&hcode="+habitation[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function getElement()
{
        ...
        var url="WQS_Periodic_PollutionParameters?command=element" ;
...
function gen_rep()
{
    ...
    if(val==true)
    {
        ...
        var es=new Array();var min_val=new Array();var max_val=new Array();
        if(document.SampleResult.es.length>1)
        {
            for(i=0;i<document.SampleResult.es.length;i++)
            {
                    ...
                    {
                            es= es+document.SampleResult.es[i].value +",";
                            min_val=min_val+document.SampleResult.minvalue[i].value +",";
                            max_val=max_val+document.SampleResult.maxvalue[i].value +",";
                    }
        ...
        else
        {
            ...
            {
                es=document.SampleResult.es.value;
                min_val=document.SampleResult.minvalue.value;
                max_val=document.SampleResult.maxvalue.value;
            }
        }
        var url="../../../../../../WQS_Periodic_PollutionParameters?lab="+lab[0]+"&fdate="+fdate+"&tdate="+tdate+"&ctype="+ctype+"&ltype="+ltype+"&dname="+dname+"&lbody="+lbody+"&block="+block+"&panchayat="+panchayat+"&habitation="+habitation+"&location="+location+"&es="+es+"&minvalue="+min_val+"&maxvalue="+max_val;
...
function changeParam(id)
{
    if(document.SampleResult.es.length>1)
    {
        ...
        {
            document.SampleResult.minvalue[id].style.backgroundColor="white";
            document.SampleResult.minvalue[id].disabled=false;
            document.SampleResult.maxvalue[id].style.backgroundColor="white";
            document.SampleResult.maxvalue[id].disabled=false;
        }
        else 
        {
            document.SampleResult.minvalue[id].style.backgroundColor="rgb(214,214,214)";
            document.SampleResult.minvalue[id].value="";
            document.SampleResult.minvalue[id].disabled=true;
            document.SampleResult.maxvalue[id].style.backgroundColor="rgb(214,214,214)";
            document.SampleResult.maxvalue[id].value="";
            document.SampleResult.maxvalue[id].disabled=true;
        }
    }
    else
    {
        if(document.SampleResult.es.checked==true)
        {
            document.SampleResult.minvalue.style.backgroundColor="white";
            document.SampleResult.minvalue.disabled=false;
            document.SampleResult.maxvalue.style.backgroundColor="white";
            document.SampleResult.maxvalue.disabled=false;
        }
        else 
        {
            document.SampleResult.minvalue.style.backgroundColor="rgb(214,214,214)";
            document.SampleResult.minvalue.value="";
            document.SampleResult.minvalue.disabled=true;
            document.SampleResult.maxvalue.style.backgroundColor="rgb(214,214,214)";
            document.SampleResult.maxvalue.value="";
            document.SampleResult.maxvalue.disabled=true;
        }
    }
}
...
function changeDist()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=changeDist&dcode="+dname;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manip(req);
...
function loadData()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_PollutionParameters?command=loadData&lab="+lab[0];
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function checkValid()
{
    ...
    if(document.SampleResult.es.length>1)
    {
        ...
        for(var i=0;i<document.SampleResult.es.length;i++)
        {
            ...
            {
                count++;
                if(document.SampleResult.minvalue[i].value==""||document.SampleResult.minvalue[i].value.length==0)
                {
                    alert("Enter Minimum value");
                    return false;
                }
                else if(document.SampleResult.maxvalue[i].value==""||document.SampleResult.maxvalue[i].value.length==0)
                {
