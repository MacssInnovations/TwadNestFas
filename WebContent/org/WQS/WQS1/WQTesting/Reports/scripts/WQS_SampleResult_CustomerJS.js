...
function getElement()
{
        ...
        var url="../../../../../../WQS_SampleResult_CustomerServ?command=element" ;
...
function gen_rep()
{
    ...
    {
        var url="../../../../../../WQS_SampleResult_CustomerServ?lab="+lab+"&fdate="+fdate+"&tdate="+tdate+"&dname="+dname+"&block="+block+"&Panchayat="+Panchayat+"&Habitation="+Habitation+"&Location="+Location+"&es="+es;
