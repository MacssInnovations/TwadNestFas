...
function changeLocation()
{
    ...
    var url="../../../../../../WQS_Periodic_RegularParameters?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype;
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changeLocation&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeDistrict()
{
    ...
    if(res==true)
    {
        ...
        {
            var req=getTransport();
            var url="../../../../../../WQS_Periodic_RegularParameters?command=changeDistrict&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0];
            req.open("GET",url,"true");
            req.onreadystatechange=function()
            {
                manipulate(req);
        ...
        {            
            var url="../../../../../../WQS_Periodic_RegularParameters?command=changeLocationType&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
...
{    
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=loadDistrict&lab="+lab[0]+"&ctype="+ctype+"&ltype="+val;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeLocalBody()
{
    ...
    lbody=lbody.split("--");
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changeLocalBody&lab="+lab[0]+"&ctype="+ctype+"&dcode="+dname[0]+"&ltype="+ltype+"&lbody="+lbody[0];
    var req=getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
...
function changeBlock()
{
    ...
    block=block.split("--");    
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changeBlock&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changePanchayat()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changePanchayat&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function changeHabitation()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changeHabitation&lab="+lab[0]+"&ctype="+ctype+"&ltype="+ltype+"&dcode="+dname[0]+"&bcode="+block[0]+"&pcode="+panchayat[0]+"&hcode="+habitation[0];
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manipulate(req);
...
function getElement()
{
        ...
        var url="WQS_Periodic_RegularParameters?command=element" ;
...
function gen_rep()
{
    ...
    if(val==true)
    {
        ...
        var url="../../../../../../WQS_Periodic_RegularParameters?lab="+lab[0]+"&fdate="+fdate+"&tdate="+tdate+"&ctype="+ctype+"&ltype="+ltype+"&dname="+dname+"&lbody="+lbody+"&block="+block+"&panchayat="+panchayat+"&habitation="+habitation+"&location="+location+"&es="+es+"&minvalue="+min_val+"&maxvalue="+max_val;
...
function changeDist()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=changeDist&dcode="+dname;
    req.open("GET",url,"true");
    req.onreadystatechange=function()
    {
        manip(req);
...
function loadData()
{
    ...
    var req=getTransport();
    var url="../../../../../../WQS_Periodic_RegularParameters?command=loadData&lab="+lab[0];
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        manipulate(req);
