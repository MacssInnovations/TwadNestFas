...
<html>
  <head>
    ...
    <title>WQS_ResultEntry_ReValidateJSP</title>
    <link href="../../../../../../css/Sample3.css" rel='stylesheet' media='screen'/>
    <script language="javascript" src="../scripts/WQS_ResultEntry_ReValidateJS.js" type="text/javascript">
    </script>
  </head>
   <body>
 ...
 <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center" class="table">
  ...
  <tr class="tdH">
          <td align="center" colspan="17">
            <input type="button" name="validate" value="Un Freeze" id="validate" onclick="Revalidate_record()">
