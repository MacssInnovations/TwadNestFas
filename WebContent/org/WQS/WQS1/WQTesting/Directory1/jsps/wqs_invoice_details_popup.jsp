...
<html>
  <head>
    ...
    <title>wqs_invoice_details_popup</title>
     <link href="../../../../../../css/Sample3.css" rel='stylesheet' media='screen'/>
     <script language="javascript" src="../scripts/wqs_invoice_details_popup.js" type="text/javascript">
    </script>
  </head>
  <body onload="loadfun()">
  <form name="invoice">
   <%
            ...
            out.print("<input type=hidden name=ct id=ct value='"+ctype+"'>");
            Connection con=null;
            Statement st=null;
            ResultSet rs=null;
