...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/WQS_JobPopupJS.js">    </script>
    <!--script type="text/javascript"            src="../../../../../../org/HR/HR1/OfficeMaster/scripts/controllingOfficeContactPopupJS.js"></script-->
        ...
        %>
            ...
            <div align="center" id="divofflevel" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                ...
                <tr class="table">
                  <td  align="left" colspan="2">Designation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <select name="cmboffsgroup" id="cmboffsgroup" onchange="getDesignation()" onclick="checkOffice()">
                        <option value="0">----Select Service Group----</option>
                        <%
                           rs=null;
                           try
                      ...
                      <select name="cmboffDesignation" id="cmboffDesignation">
                      <option value="0"></option>
                 ...
                 <tr class="tdH">
                  <td colspan="3">
                    <div align="center">
                      <input type="button" id="cmdsubmit" name="Submit"
                             value="Submit" onclick="selectControllineOffice('office')"></input>
            ...
            <div align="center" id="divcity" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                ...
                <tr class="table">
                  <td  align="left" colspan="3">Designation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <select name="cmbcitysgroup" id="cmbcitysgroup" onchange="getDesignation()" onclick="checkCityOffice()">
                        <option value="0">----Select Service Group----</option>
                        <%
                           rs=null;
                           try
                      ...
                      <select name="cmbcityDesignation" id="cmbcityDesignation">
                      <option value="0"></option>
            ...
            <div align="center" id="divodept" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                ...
                <tr class="table">
                 ...
                 <tr class="table">
                  <td  align="left" colspan="3">Designation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <select name="cmbothersgroup" id="cmbothersgroup" onchange="getDesignation()" onclick="checkOtherOffice()">
                        <option value="0">----Select Service Group----</option>
                        <%
                           rs=null;
                           try
                      ...
                      <select name="cmbotherDesignation" id="cmbotherDesignation">
                      <option value="0"></option>
            ...
            <div align="center" id="divCOffice" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                ...
                <tr class="table">
                  <td  align="left" colspan="3">Designation &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <select name="cmbclosedsgroup" id="cmbclosedsgroup" onchange="getDesignation()" onclick="checkClosedOffice()">
                        <option value="0">----Select Service Group----</option>
                        <%
                           rs=null;
                           try
                      ...
                      <select name="cmbclosedDesignation" id="cmbclosedDesignation">
                      <option value="0"></option>
