...
<html>
  <head>
    ...
    <title>Sub Programme Details</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/SubProgramme.js"></script>
  ...
  <form action="" name="ProgForm">
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="2" class="tdH" align="center"><b>Sub Programme Details</b></td>
                   
       </tr> 
        <tr>
            <td class="table">Programme Main Type Id</td>
          <td class="table">
          ...
          try
          {
            ...
            String sql="select * from WQS_MST_PROGRAMME_MAIN_TYPES ORDER BY PROGRAMME_MAIN_TYPE_ID";
             results=statement.executeQuery(sql);
              ...
              while(results.next())
              {
                String strProgId=results.getString("PROGRAMME_MAIN_TYPE_ID");
	        //String strCusDesc=results.getString("CUSTOMER_TYPE_DESC");
               
                out.println("<option value='" + strProgId + "'>"+strProgId+"</option>");   
  ...
  %>   
        ...
        <tr>
            <td class="table">Programme Sub Type Id</td>
            <td class="table">
        ...
        <tr>
            <td class="table">Programme Sub Type Desc</td>
            <td class="table">
    ...
    <table cellspacing="3" cellpadding="2" border="1" width="100%"
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="100%"
        ...
        <tr class="tdH">
          ...
          <th>
            Programme Main Type Id
          </th>
         <th>
            Programme Sub Type Id
          </th>
         
          <th>
            Programme Sub Type Description
          </th>
          </tr>
