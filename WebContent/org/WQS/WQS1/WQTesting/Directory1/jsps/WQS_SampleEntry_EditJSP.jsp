...
<html>
  <head>
    ...
    <title>WQS_SampleEntry_EditJSP</title>
    ...
    <script language="javascript" src="../scripts/WQS_SampleEntry_EditJS.js" type="text/javascript">
    </script>
     <style type="text/css">
          body 
          {
  ...
  <td>
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                    <input type="text" name="ino" id="ino" maxlength=5 size=15 onchange="changeInvoice()" onkeypress="return  numbersonly(event,this)">
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                    <input type="text" name="sample" id="sample" maxlength=5 onkeyup="checkInvoice()" onkeypress="return  numbersonly(event,this)"/>
                  </td>
              </tr>
              <tr class="table">
                  <td width="40%">
                  ...
                  <td width="60%">
                      ...
                      <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.monitoring.cdate);" alt="Show Calendar" id="pur_date_cal" onmouseover="callme()"></img> 
                      Time  <input type="text" name="ctime" id="ctime" size="5" maxlength="5" onkeyup="changeTime()" onChange="checkTime()">
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                        <select name="distcode" id="distcode" onclick="checkInvoice()" onchange="changeDist()">
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                        <select name="ltype" id="ltype" onclick="checkDistrict()" onchange="changeLocation()" >
              ...
              <tr class="table">
                ...
                <td width="60%">
                     <input type="text" name="location" id="location" size="70" maxlength="100" onkeyup="checkValid()">
                </td>
              </tr>
              <tr class="table">
                      <td colspan="2" align="center" height="36">
                        <input type="button" name="update" value="Update" id="update" onclick="update_record()" disabled="disabled">
                        <input type="button" name="delete" value="Delete" id="delete" onclick="delete_record()" disabled="disabled">
                        <input type="button" id="clr" value="  Clear  " onclick="clearfun()"/>
