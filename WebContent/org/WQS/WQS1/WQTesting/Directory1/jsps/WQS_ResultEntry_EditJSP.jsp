...
<html>
  <head>
    ...
    <title>WQS_ResultEntry_EditJSP</title>
    ...
    <script language="javascript" src="../scripts/WQS_ResultEntry_EditJS.js" type="text/javascript">
    </script>
  </head>
   ...
   <tr>
      <td>
          ...
          <tr class="table">
              ...
              <td width="80%">
                  <select name="test_purpose" id="test_purpose" onchange="load_Parameter();load_values()">  
