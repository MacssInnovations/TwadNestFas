...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/SampleType.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet"          media="screen"/>    
    
    <title>Master WQS Sample Details</title>
  </head>
  <body class="table">
  <%
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr>
          <td colspan="2" class="tdH">
            <div align="center">
              <strong>Sample Type Details</strong>
            </div></td>
        </tr>
        <tr>
          <td class="table">Sample Type Id</td>
          <td class="table">
           
                   <input type="TEXT" name="wtxtCusId" maxlength="3"
                   id="wtxtCusId" size="3"/>
          </td>
        </tr>
        <tr>
          <td class="table">Sample Type Desc</td>
          <td class="table">
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr class="tdH">
          ...
          try
          {
	        ...
	        String strCusDesc=results.getString("SAMPLE_TYPE_DESC");
                if(strCusDesc==null)
                                       {
