...
<html>
   <head>
    ...
    <title>Sample Location Entry</title>
    ...
    <script language="javascript" src="../scripts/WQS_SampleEntry_JS.js" type="text/javascript">
    </script>
    <style type="text/css">
          body 
          {
  ...
  <td>
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                    <input type="text" name="ino" id="ino" size=15 maxlength=5 onchange="changeInvoice()" onkeypress="return  numbersonly(event,this)">
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                    <input type="text" name="sample" size=10 maxlength="5" id="sample" onclick="checkInvoice()" onkeypress="return  numbersonly(event,this)" onchange="changeSample()"/>
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                      <input type="text" name="cdate" id="cdate" disabled="disabled" style="backgoound-color:rgb(214,214,214)" size=10>
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                        <select name="distcode" id="distcode" onclick="return checkSample()" onchange="changeDist()">
              ...
              <tr class="table">
                  ...
                  <td width="60%">
                        <select name="ltype" id="ltype" onclick="return checkDistrict()" onchange="changeLocation()">
              ...
              <tr class="table">
                <td width="40%">
                     Sample Location <font color="Red">*</font>
                </td>
                <td width="60%">
              ...
              <tr class="table">
                      <td colspan="2" align="center" height="36">
                        ...
                        <input type="button" name="del" value="Delete" id="del" onclick="delete_record()">
        ...
        <td>
              ...
              <tr class="tdH">
                      <td align="center" colspan="17">
                        <input type="button" name="sub" value="Submit" id="sub" onclick="submitfun()">
