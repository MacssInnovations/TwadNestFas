...
<html>
  <head>
    ...
    <title>WQS_ResultEntry_CancelJSP</title>
    ...
    <script language="javascript" src="../scripts/WQS_Invoice_CancellationJS.js" type="text/javascript">
    </script>
  </head>
  <body>
  <form name="Cancel">
  ...
  <tr class="table">
   ...
   <tr class="table">
      ...
      <td width="60%">
        <input type="text" name="stype" id="stype" size="40" readonly="readonly" style="background-color:rgb(214,214,214)"/>
        Total Samples<input type="text" name="total" id="total" size="5" readonly="readonly" style="background-color:rgb(214,214,214)"/>
      </td>
  </tr>
  <tr class="table">
      <td width="40%">
        Customer_type<font color="Red">*</font>
      </td>
      <td width="60%">
  ...
  <tr class="tdH">
          <td align="center" colspan="17">
            <input type="button" name="cancel" value="Cancel" id="cancel" onclick="cancel_record()">
