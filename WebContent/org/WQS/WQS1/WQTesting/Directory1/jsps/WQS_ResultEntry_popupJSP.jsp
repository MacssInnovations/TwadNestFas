...
<html>
  <head>
    ...
    <title>WQS_ResultEntry_popupJSP</title>
    <link href="../../../../../../css/Sample3.css" rel='stylesheet' media='screen'/>
    <script language="javascript" src="../scripts/WQS_ResultEntry_popupJS.js" type="text/javascript">
    </script>
  </head>
   <body onload="loadfun()">
  <form name="invoice">
   ...
   <table cellspacing="4" cellpadding="2" border="1" width="100%"
        ...
        <tr class="tdH">
         <td colspan="5" align="center">
            ...
            <!--input type="radio" id="new_det" name="new_det" checked="checked"> New Result Entry <input type="radio" id="new_det" name="new_det"> Edit Result Entry-->
         </td>
        </tr>
      </table>
      <%
      ...
      {
      %>
          <table id="Exsisting" border="1" width="100%" style="display:block"
                 align="center">
            <tr class="tdH">
                    <th width="5%">
                        Select
        ...
        {
        %>
                <table id="Exsist" border="1" width="100%" style="display:block" align="center">
                <tr class="tdH">
                    <th width="5%">
                        Select
                    </th>
        ...
        {
        %>
        <table id="Exsisting_det" border="1" width="100%" style="display:block" align="center">
        <tr class="tdH">
                <th width="5%">
                    Select
                </th>
