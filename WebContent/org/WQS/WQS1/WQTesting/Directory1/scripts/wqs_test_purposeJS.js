...
function callServer(command)
{
    ...
    if(command=="Add")
    {
                var url = "../../../../../../wqs_test_purposeServ?command=Add&stype="+stype;
    ...
    {
                var sid  = document.getElementById("txtSamId").value;   
                url="../../../../../../wqs_test_purposeServ?command=Update&sid="+sid+"&stype="+stype;
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
                {
    ...
    {    
         ...
         {  
                url="../../../../../../wqs_test_purposeServ?command=Delete&sid="+sid
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
                {
...
function chkSamId()
{
    ...
    {
        url="../../../../../../wqs_test_purposeServ?command=chk&sid="+sid;
        var req=getTransport();
        req.open("GET",url,true); 
