...
function servicepopup()
{
    ...
    winemp= window.open("../../../../../../org/WQS/WQS1/WQTesting/Directory1/jsps/WQS_ResultEntry_popupJSP.jsp?command=Revalidation","InvoiceNumberSearch","status=1,height=500,width=600,resizable=YES, scrollbars=yes"); 
...
function changeInvoice()
{
    ...
    var url="../../../../../../WQS_ResultEntry_ReValidateServ?command=changeInvoice&lab="+lab[0]+"&invoice="+invoice;
...
function Revalidate_record()
{
     ...
     var url="../../../../../../WQS_ResultEntry_ReValidateServ?command=ReValidate&lab="+lab[0]+"&invoice_no="+ino+"&sample_no="+record;
     req.open("GET",url,true);
     req.onreadystatechange=function()
     {
        process_response(req);
