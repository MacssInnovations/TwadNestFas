...
function servicepopup()
{
    ...
    winemp= window.open("../../../../../../org/WQS/WQS1/WQTesting/Directory1/jsps/WQS_ResultEntry_popupJSP.jsp?command=edit","InvoiceNumberSearch","status=1,height=500,width=600,resizable=YES, scrollbars=yes"); 
...
function changeInvoice()
{
    ...
    lab=lab.split("--");
    var url="../../../../../../WQS_ResultEntry_EditServ?command=changeInvoice&lab="+lab[0]+"&invoice="+ino;
...
function changeSample()
{
    ...
    var lab=document.ResultEntry.labcode.value;
    lab=lab.split("--");
    var url="../../../../../../WQS_ResultEntry_EditServ?command=changeSample&lab="+lab[0]+"&invoice="+ino+"&sample="+sno;
    var req=getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
               ...
               if(cmd=="changeInvoice")
               {
                ...
                else if(cmd=="load_values")
                {
                    ...
                    if(flag=="success")
                    {
                        ...
                        rtime=rtime.split(" ");
                        document.ResultEntry.rtime.value=rtime[0];
                        if(rtime[1]=="AM")
...
function load_values()
{
    ...
    var url="../../../../../../WQS_ResultEntry_EditServ?command=load_values&lab="+lab[0]+"&invoice="+ino+"&sample="+sno+"&test_purpose_id="+test_purpose[0];
    var req=getTransport();
    req.open("GET",url,true);        
    req.onreadystatechange=function()
    {
...
function load_Parameter()
{
    ...
    var url="../../../../../../WQS_ResultEntry_EditServ?command=updateParameter&lab="+lab[0]+"&invoice="+ino+"&sample="+sno+"&test_purpose_id="+test_purpose[0]+"&test_purpose="+test_purpose[1];
    var req=getTransport();
    req.open("GET",url,true);        
    req.onreadystatechange=function()
    {
...
function callServer(command,param)
{
    ...
    if(command=="Update")
    {
            ...
            if(valid==true)
            {
                var url="../../../../../../WQS_ResultEntry_EditServ?command=Update&lab="+lab[0]+"&invoice_no="+ino+"&sample_no="+sno+"&rdate="+rdate+"&e_val="+eval+"&e_result="+result+"&cnc="+cnc+"&pnp="+pnp+"&reason="+reason+"&rtime="+rtime+"&test_purpose="+test_purpose[0]+"&percent="+percent;
                req.open("GET",url,true);
                req.onreadystatechange=function()
                {
                    manipulate(req);
    ...
    {
        if(document.ResultEntry.test_purpose.value==""||document.ResultEntry.test_purpose.selectedIndex==0)
        {
        ...
        {
            var url="../../../../../../WQS_ResultEntry_EditServ?command=Del&lab="+lab[0]+"&invoice_no="+ino+"&sample_no="+sno+"&test_purpose="+test_purpose[0];
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
                manipulate(req);
...
/*function clearAll()
{
        if(document.ResultEntry.chkparameter.length>1)
        {
            for(i=0;i<document.ResultEntry.chkparameter.length;i++)
            {
                    document.ResultEntry.chkparameter[i].checked=false
                    document.ResultEntry.paramval[i].value="";
                    document.ResultEntry.paramval[i].disabled=true
                    document.ResultEntry.paramval[i].style.backgroundColor="rgb(214,214,214)";
            }
        }
        else
        {
            document.ResultEntry.chkparameter.checked==false
            document.ResultEntry.paramval.value="";
            document.ResultEntry.paramval.disabled=true
            document.ResultEntry.paramval.style.backgroundColor="rgb(214,214,214)";
        }
...
{
        document.getElementById("potability_div").style.display="none";
        document.ResultEntry.rdate.value="";
        document.ResultEntry.rtime.value="";
        document.ResultEntry.rt[0].checked=true;
        document.ResultEntry.rt[1].checked=false;
...
/*function checkPotability()
{
    ...
    var url="../../../../../../WQS_ResultEntry_EditServ?command=Validate&lab="+lab[0]+"&invoice_no="+ino+"&sample_no="+sno+"&rdate="+rdate+"&e_val="+eval+"&e_result="+result;
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        manipulate(req);
