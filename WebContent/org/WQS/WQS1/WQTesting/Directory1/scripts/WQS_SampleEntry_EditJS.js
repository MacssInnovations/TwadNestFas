...
function servicepopup()
{
    ...
    winemp= window.open("../../../../../../org/WQS/WQS1/WQTesting/Directory1/jsps/WQS_SampleEntry_popupJSP.jsp?command=SampleEdit","InvoiceNumberSearch","status=1,height=500,width=600,resizable=YES, scrollbars=yes"); 
...
function load_labcode()
{
    ...
    lab=lab.split("--");
    req=getTransport();
    var url="../../../../../../WQS_SampleEntry_EditServ?option=load_labcode&lab="+lab[0];
...
function changeType()
{
    ...
    req=getTransport();
    var url="../../../../../../WQS_SampleEntry_EditServ?option=changeType&Type="+type1[0];
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        process_res(req);
...
function LoadRecord(sample_number)
{
    ...
    {
        var url="../../../../../../WQS_SampleEntry_EditServ?option=LoadRecord&type=others&lab="+lab[0]+"&ino="+ino+"&sample="+sample_number+"&distcode="+record5+"&ltype="+record6+"&sourcetype="+source[0];
    }
    else if(record6!="")
    {
        var url="../../../../../../WQS_SampleEntry_EditServ?option=LoadRecord&type=VP&lab="+lab[0]+"&ino="+ino+"&sample="+sample_number+"&distcode="+record5+"&blockcode="+record8+"&pancode="+record9+"&sourcetype="+source[0];
    }
    else
    {
        var url="../../../../../../WQS_SampleEntry_EditServ?option=LoadRecord&type=empty&lab="+lab[0]+"&ino="+ino+"&sample="+sample_number+"&sourcetype="+source[0];
    }
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
...
function changeLocation()
{
    ...
    if(type=="VP")
    {
        ...
        var url="../../../../../../WQS_SampleEntry_EditServ?option=loadblock&dist_code="+dist_code[0];
        req.open("GET",url,true);
        req.onreadystatechange=function()
            {
                process_response(req);
    ...
    else
    {
        ...
        var dist_code=document.getElementById("distcode").value;
        dist_code=dist_code.split("--");
        var url="../../../../../../WQS_SampleEntry_EditServ?option=loadlocalbody&ltype="+type+"&dist_code="+dist_code[0];
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
            process_response(req);
...
function load_panchayat()
{
    ...
    var url="../../../../../../WQS_SampleEntry_EditServ?option=loadpanchayat&dist_code="+dist_code[0]+"&block_code="+block_code[0];
    req.open("GET",url,true);
    req.onreadystatechange=function()
    {
        process_response(req);
...
function load_habitation()
{
    ...
    var url="../../../../../../WQS_SampleEntry_EditServ?option=loadhabitation&dist_code="+dist_code[0]+"&block_code="+block_code[0]+"&panchayat_code="+panchayat_code[0];
    req.open("GET",url,true);
     req.onreadystatechange=function()
    {
        process_response(req);
...
function update_record()
{
        ...
        if(val==true)
        {
                ...
                var dcode=distcode.split("--");
                var ltype=document.getElementById("ltype").value;
                var lbody=document.getElementById("lbody").value;   
                lbody=lbody.split("--");
                var blockcode=document.getElementById("blockcode").value;
                var bcode=blockcode.split("--");
                var pancode=document.getElementById("pancode").value;
                var pcode=pancode.split("--");
                var habitationcode=document.getElementById("habitationcode").value;
                var hcode=habitationcode.split("--");
                var schemetype=document.getElementById("schemetype").value;
                var sctype=schemetype.split("--");
                var sourcetype=document.getElementById("sourcetype").value;
                var stype=sourcetype.split("--");
                var sourcecode=document.getElementById("sourcecode").value;
                var scode=sourcecode.split("--");
                var programmecode=document.getElementById("programmecode").value;
                var pgcode=programmecode.split("--");
                var spoint=document.getElementById("spoint").value;
                var loc=document.getElementById("location").value;
                var req=getTransport();
                var url="../../../../../../WQS_SampleEntry_EditServ?option=Update&lab="+labcode[0]+"&ino="+ino+"&sample="+sample+"&cdate="+cdate+"&ctime="+ctime+"&dcode="+dcode[0]+"&ltype="+ltype+"&lbody="+lbody[0]+"&bcode="+bcode[0]+"&pcode="+pcode[0]+"&hcode="+hcode[0]+"&sctype="+sctype[0]+"&stype="+stype[0]+"&scode="+scode[0]+"&pgcode="+pgcode[0]+"&spoint="+spoint+"&loc="+loc+"&sample_type="+sample_type+"&test_purpose="+test_purpose_id;
                req.open("GET",url,true);
                 req.onreadystatechange=function()
                {
                    process_response(req);
...
function checkValid()
{
    ...
    else if(document.getElementById("sample").value==""||document.getElementById("sample").value.length=="0")
    {
...
function validUpdate()
{
    ...
    if(valid==true)
    {
        if(document.getElementById("stype").value==""||document.getElementById("stype").value.selectedIndex=="")
        {
            alert("Enter sample type");
            document.getElementById("stype").focus();
            return false;
        }
        else if(document.getElementById("cdate").value==0||document.getElementById("cdate").value=="")
        {
            alert("Select Date");
            return false;
        }
        ...
        else if(document.getElementById("distcode").value==0||document.getElementById("distcode").value=="")
        {
...
function delete_record()
{
        ...
        var sample=document.getElementById("sample").value;
        var req=getTransport();
        var url="../../../../../../WQS_SampleEntry_EditServ?option=Delete&lab="+labcode[0]+"&ino="+ino+"&sample="+sample;
        req.open("GET",url,true);
         req.onreadystatechange=function()
        {
            process_response(req);
...
{
    var inv=checkInvoice();
    if(inv==true)
    {
        if(document.getElementById("distcode").value==0||document.getElementById("distcode").value=="")
        {
            alert("Select District");
            return false;
        }
