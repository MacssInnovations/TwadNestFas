...
function loadfun()
{
    ...
    if(command=="SampleEntry")
    {
        var url="../../../../../../WQS_SampleEntry_Serv?option=load_invoice&lab="+lab[0];
    }
    else if(command=="SampleEdit")
    {
        var url="../../../../../../WQS_SampleEntry_EditServ?option=load_invoice&lab="+lab[0];
    }
    else if(command=="SampleValidation")
    {
        var url="../../../../../../WQS_SampleEntry_ValidateServ?option=load_invoice&lab="+lab[0];
    }
...
function getDetails(baseResponse)
{
    ...
    if(flag=="success")
    {
       ...
       for(var i=0;i<count.length;i++)
       {
            ...
            if (window.navigator.appName.toLowerCase().indexOf("netscape") == -1)
            {
                    lpcd=document.createElement("<INPUT type='hidden' name='idate' id='idate' size='20' style='background-color:#ececec' value="+idate[i]+">");
            }
            else
            {   
            ...
            var currentText3=document.createTextNode(idate[i]);
            ...
            if (window.navigator.appName.toLowerCase().indexOf("netscape") == -1)
            {
                    lpcd=document.createElement("<INPUT type='hidden' name='amt' id='amt' size='20' style='background-color:#ececec' value="+amt[i]+">");
            }
            else
            {   
                    lpcd=document.createElement("input");
            ...
            var currentText5=document.createTextNode(amt[i]);
