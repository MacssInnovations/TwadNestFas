...
<html>
  <head>
      ...
      <title>Create Sanctioned Staff Strength For An Office</title>
      
          <script type="text/javascript" src="../scripts/RequestStaffStrengthAjax.js" ></script>
          <script type="text/javascript" src="../scripts/RequestStaffStrengthValidation.js" ></script>
 ...
 %>        
        <table  cellspacing="1" cellpadding="3" width="100%" class="bodytext">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Create Sanctioned Staff Strength for an Office</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmOffice" method="POST" action="../../../../../RequestStaffStrengthServlet1.con" onsubmit="return nullValue()">
            ...
            <tr>
                ...
                <td>
                    <select name="cmbFinancialYear" id="cmbFinancialYear" tabindex="1" onchange="officeid()" onfocus="return OfficeCheck()">
                    <option value=0>---Select Financial Year---</option>
                    </select>
                    <input type="button" name='btnCopy' id='btnCopy' value="Copy from Previous Period" disabled onclick="callServer('copyFromPreviousPeriod','null')"></input>
                </td>
            </tr>
            <!--<tr>
                <td>
            ...
            <tr>
               <td>Remarks</td>
               <td>
                  <textarea name="txtRemarks" cols="25" rows="5" tabindex="2" onfocus="return OfficeCheck()"></textarea>
               </td>
             </tr>
             <tr>
             ...
             <tr>
                ...
                <td>
                <select name="cmbSSTemp_Id" id="cmbSSTemp_Id" onchange="callServer('TableView',null)" tabindex="3" onfocus="return OfficeCheck()">
            ...
            <!--<tr>
                ...
                <td>
                  <select name="cmbPostCategory" id="cmbPostCategory" tabindex="6" onfocus="return OfficeCheck()">
            ...
            <tr>
                ...
                <td>
                  <select name="cmbServiceGroup" id="cmbServiceGroup" onchange="callServer('ServiceGroup',null)" tabindex="4" onfocus="return OfficeCheck()">
            ...
            %>
             ...
             <tr>
                <td>Name of the Post/Cadre<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                <td>
                 <select name="cmbPostRank" id="cmbPostRank" tabindex="5" onfocus="return OfficeCheck()">
            ...
            <tr>
                ...
                <td>
                    <input type=text name="txtNoPost" id="txtNoPost" maxlength="4" tabindex="6" onkeypress="return  numbersonly1(event,this)" onfocus="return OfficeCheck()" onchange="total();return zerocheck();"/>
                </td>
            </tr>
            <tr>
            <td>No of Posts Diverted to Other</td>
            <td>
              <input type="text" name="txtNoOfPostTo" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)" tabindex="7" onchange="total();return diversionto();" onfocus="return OfficeCheck()"/>
            </td>
        </tr> 
        
        <tr>
            <td>No of Posts Diverted From Other</td>
            <td>
              <input type="text" name="txtNoOfPostFrom" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)"  tabindex="8" onchange="total();" onfocus="return OfficeCheck()" />
            </td>
        </tr>
        <tr>
        <td class="td">
        ...
        <tr>
          ...
          <td>
            <textarea name="Remarks" cols="25" rows="5" tabindex="9" onfocus="return OfficeCheck()"></textarea>
          </td>
      </tr>
              ...
              <td colspan=2 class="tdH">
                <div>
                    <table border="0">
                        <tr>
                            <td>
                   <input type="Button" value="  Save " id="Add" onclick="callServer('Add','null')" name="cmdAdd" tabindex="10" style="display:block"> 
                    </td><td>
            ...
            <table name="Existing" id="Existing"  border="1" width="100%"  style="font-family:arial;">
                ...
                <tr>
                        <td class="tdH" rowspan="2">View</td>
                        <td class="tdH" rowspan="2">Service Group</td>
                        <td class="tdH" rowspan="2">Post Rank</td>
                        <!--<th rowspan="2">Post Category</th>-->
                        <td class="tdH" rowspan="2">No Of Sanctioned Posts</td>
                        <td class="tdH" rowspan="2">No of Posts Diverted To</td>
                        <td class="tdH" rowspan="2">No of Posts Diverted From</td>
                        <td class="tdH" rowspan="2">Total Strength</td>
                        <td class="tdH" rowspan="2">Remarks</td>
          ...
          <!--  </div>
            ...
            <div class="tab-page">
                        ...
                        <div align="center">
                            ...
                            <tr>
                                      <td colspan="2">
                                         <div id="Taddresses" class="bgClass" onclick="ShowOrHideDiv('addresses')" ><label>Existing Sanctioned Strength Requirment Details</label></div>
                                         <div id="addresses"  >
                        ...
                        <div align="center">
                            <table width="100%">
                             <tr>
                                   <td colspan="2">
                                   <div id="Tcontacts" class="tdH" ><label>Details of Posts Diverted to Other Offices</label></div>
                                   <div id="contacts" >
                                        <table  cellspacing="1" cellpadding="3" width="100%" style="border-color:rgb(185,201,202); border-width:medium; border-style:groove;">    
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <input type="text" name="txtNoOfPostTo" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)" tabindex="6"/>
                                            </td>
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <input type="text" name="txtNoOfPostFrom" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)" onblur="noofpostcheck()" tabindex="7"/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td>Details of Diversion From Others</td>
                                            <td>
                                            <textarea name="RemarksFrom" cols="20" rows="5" tabindex="8"></textarea>
                                            </td>
                                        </tr>
                                        </table>
                                  ...
                                  <td colspan=2 class="tdH">
                                    ...
                                    <table border="0">
                                        <tr>
                                            <td>
                                       <input type="Button" value="  Save " id="Add" onclick="callServer1('Add','null')" name="cmdAddTo" tabindex="9" style="display:block"> 
                                       </td><td>
                                  ...
                                  <td colspan=2>&nbsp;</td>
                                   ...
                                   <table name="ExistingTo" id="ExistingTo"  border="1" width="100%"  style="font-family:arial;">
                                    ...
                                    <tr>
                                            ...
                                            <tr>
                                <tbody id="tblListTo" name="tblListTo">
                                    </tbody>
                            </tr>
                            </table>
                          </div>
                ...
                <div id="bghead" class="tdH">
                    <center>  
                        <input type="SUBMIT" value="Submit " onclick="" name="cmbSubmit"> &nbsp;
