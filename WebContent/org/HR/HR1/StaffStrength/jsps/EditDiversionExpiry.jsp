...
<html>
  <head>
    ...
    <title>Edit Diversion Expiry Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/EditDiversionExpiryValidation.js" ></script>
     <script type="text/javascript" src="../scripts/EditDiversionExpiryAjax.js"></script>
  ...
  <form action="../../../../../EditDiversionExpiry1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Edit Diversion Expiry Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
