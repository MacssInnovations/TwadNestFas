...
<html>
  <head>
    ...
    <title>Create Diversion Extension Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/CreateDiversionExtensionValidation.js" ></script>
     <script type="text/javascript" src="../scripts/CreateDiversionExtensionAjax.js"></script>
  ...
  <form action="../../../../../CreateExtensionDiversion1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Create Diversion Extension Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                ...
                                <tr>
                                  ...
                                  <td colspan="4" align="left">
                                    ...
                                    <tr>
                                        <th  align="left">Diversion Order SlNo</th>
                                        <th  align="left">Diversion Extension Order Date</th>
                                        <th  align="left">Diversion Extended Upto</th>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4"><input type=text name="txtExOrderSlNO" size=4 maxlength=4 disabled style="background-color: #ececec">(System Generated)
