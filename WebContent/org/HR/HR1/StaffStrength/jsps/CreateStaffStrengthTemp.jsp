...
<!--
    File Name     : CreateNewStaffStrengthTemp.jsp
    Purpose       : To create form that allows us add,modify and delete records residing in database
    //References    : CreateNewStaffStrengthAjax.js,CreateNewStaffStrengthValidation.js,yellow.css
    //Servlet Ref.  : CreateStaffStrengthServlet.java,CreateStaffStrengthServlet1.java
-->
...
<html>
  <head>
      ...
      <title>Create New Staff Strength Template</title>
    
          <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
          
          <script type="text/javascript" src="../scripts/CreateStaffStrengthAjax.js"></script>
          <script type="text/javascript" src="../scripts/CreateStaffStrengthValidation.js"></script>
 ...
 <%
  ...
  %>
 <form name="frmStaffStrength" method="Post" action="../../../../../CreateStaffStrengthServlet1.con">
    ...
    <script type="text/javascript" src="test.js"></script>
                ...
                <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH">
                            <center><h2>Create Staff Strength Template</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                  <tr>
                                      ...
                                      <td>
                                          <input type=text name="txtSSTemp_Id" disabled style="background-color: #ececec">(System Generated)
                                  ...
                                  <tr>
                                      <td>Template Name</td>
                                      <td>
                                      <input type="text" name="txtTemplate_Name" id="txtTemplate_Name" size="35" tabindex="1"/>
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>
                                      <select name="cmbOfficeLevel" id="cmbOfficeLevel" tabindex="2" onfocus="staffCheck()">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          ...
                                          <input type="Button" value=" Update" id="Update" onclick="callServer('Update','null')"  name="cmdUpdate" style="display:none">
                                        </td><td>
                                          <input type="Button" value=" Delete" id="Revoke" onclick="callServer('Delete','null')"  name="cmdDelete" style="display:none">
                                          </td><td>
                                          <input type="Button" value="Clear All" id="clear" onclick="clearAll()" name="cmdClearAll" style="display:block">                                 
                                          </td>
                                        </tr>
                                        </table>
                                        </div>
