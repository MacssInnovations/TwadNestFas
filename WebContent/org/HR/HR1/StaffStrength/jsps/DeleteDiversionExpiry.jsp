...
<html>
  <head>
    ...
    <title>Delete Diversion Expiry Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/DeleteDiversionExpiryValidation.js" ></script>
     <script type="text/javascript" src="../scripts/DeleteDiversionExpiryAjax.js"></script>
  ...
  <form action="../../../../../DeleteDiversionExpiry1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Delete Diversion Expiry Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                 ...
                                 %>
                                  ...
                                  <tr>
                                        ...
                                        <%
                                            try
                                            {
                                            PreparedStatement ps=connection.prepareStatement("select DIVERSION_ORDER_ID from hrm_ss_diversion_orders where process_flow_status_id  = 'FR' and order_office_id=? and (DIVERSION_EXPIRED !='Y' or DIVERSION_EXPIRED is null )order by DIVERSION_ORDER_ID");
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td class="tdH" colspan="5">
                                        <b>Diversion Expiry Details</b></td>
                                  </tr>
                                  <tr>
                                    <td>Diversion Expiry OrderId:<label style="color:rgb(255,0,0);">*</label></td>
                                    <td colspan="4">
                                    <!--<select name="cmbExpOrderId" id="cmbExpOrderId" onchange="callServer('Expiry')" onfocus="return ordercheck()">
                                    <option value=0>--Select Expiry OrderId--</option>
                                    </select>-->
                                    <input type=text name="txtExpOrderId" size=4 maxlength=4 disabled >
                                    <input type=hidden name="txtExpOrderId1" size=4>
                                    </td>
                                  </tr>
                                  <!--<tr>
                                    <td>Diversion Expired</td>
                                     <td><input type="radio" name="optExpired" value="Y" checked onfocus="return ordercheck()" disabled>Yes &nbsp; <input type="radio" name="optExpired" value="N" onfocus="return ordercheck()" disabled>No</td>
                                  </tr>-->
                                  <tr>
                                    <td>Diversion Expiry Date:</td>
                                    <td colspan="4"><input type=text name="txtExOrderDate" maxlength=10 size=10 onfocus="javascript:vDateType='3';return ordercheck()" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                    <!--<img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmStaffStrength.txtExOrderDate);" alt="Show Calendar" ></img>-->
                                    </td>
                                 ...
                                 <!-- <tr>
                                    ...
                                    <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmStaffStrength.txtExUpto);" alt="Show Calendar" ></img>
                                    </td>
                                  </tr>-->
                                  <tr>
                                    <td>Remarks</td>
                                    <td colspan="4"><textarea rows="5" cols="25" name="txtExRemarks" onfocus="return ordercheck()" disabled></textarea></td>
                                  </tr>
                             </table>
                        </td>
                    </tr>
