...
<html>
  <head>
    ...
    <title>Delete Diversion Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/DeleteUpdateDiversionDetails.js" ></script>
     <script type="text/javascript" src="../scripts/DeleteUpdateDiversionDetailAjax.js"></script>
  ...
  <form action="../../../../../DeleteUpdateDiversionServlet.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Delete Diversion Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                 ...
                                 %>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4">
                                         <select name="cmbFinancialYear" id="cmbFinancialYear" disabled>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4">
                                        <input type=text name="txtDoD" maxlength="10" size="10" onFocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <input type=text name="txtdiversionfromoffice"  size="4" disabled>
                                        <input type=hidden name="txtHdiversionfromoffice">
                                    </td>
                                    <td>
                                        <select name="cmbFromOfficeId" id="cmbFromOfficeId" onchange="getOfficesByLevel()" disabled>
                                ...
                                <td><textarea rows="5" cols="25" id="txtOfficeAddressFrom" name="txtOfficeAddressFrom" disabled></textarea></td>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <input type=text name="txtdiversiontooffice" disabled size="4">
                                        <input type=hidden name="txtHdiversiontooffice">
                                    </td>
                                    <td>
                                        <select name="cmbToOfficeId" id="cmbToOfficeId" onchange="getOfficesByLevel1()" disabled>
                                  ...
                                  <tr>
                                    ...
                                    <td >
                                        <select name="cmbPostRank" id="cmbPostRank" disabled>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4">
                                        <input type=text name="txtPostDiverted" size=10 maxlength="3" onkeypress="return  numbersonly1(event,this)" onchange="return checksanction()" disabled>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td><input type=text name="txtDEDate" size=10 maxlength=10 onfocus="javascript:vDateType='3'"
                                                   ...
                                                   onblur="return checkdt(this);" disabled>
                                ...
                                <tr>
                                    ...
                                    <td><input type=text name="txtDPDate" size=10 maxlength="10 onfocus="javascript:vDateType='3' onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                  ...
                                  <tr>
                                    <td>Remarks</td>
                                    <td colspan="4"><textarea rows="5" cols="25" name=txtRemarks disabled></textarea>
                                  </tr>
                    ...
                    <tr>
                        <td class="tdH">
                            <center>
                                    <input type="submit" value="Delete" name="cmbSubmit" id="cmbSubmit">
