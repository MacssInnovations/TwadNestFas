...
<html>
  <head>
      ...
      <title>Delete Sanctioned Staff Strength For An Office</title>    
      
          <script type="text/javascript" src="../scripts/DeleteRequestStaffStrengthAjax.js" ></script>
          <script type="text/javascript" src="../scripts/DeleteRequestStaffStrengthValidation.js" ></script>
 ...
 %>        
        <table  cellspacing="1" cellpadding="3" width="100%" class="bodytext">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Delete Sanctioned Staff Strength for an Office</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmOffice" method="POST" action="../../../../../DeleteRequestStaffStrength1.con" onsubmit="return nullValue()">                
            ...
            <tr>
                ...
                <td>
                    <select name="cmbFinancialYear" id="cmbFinancialYear" onchange="callServer('TableView',null)">
