...
<html>
  <head>
    ...
    <title>Create Diversion Expiry Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/CreateDiversionExpiryValidation.js" ></script>
     <script type="text/javascript" src="../scripts/CreateDiversionExpiryAjax.js"></script>
  ...
  <form action="../../../../../CreateDiversionExpiry1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Create Diversion Expiry Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4"><input type=text name="txtExpOrderId" size=4 maxlength=4 disabled style="background-color: #ececec">(System Generated)
                                    <input type=hidden name="txtExpOrderId1" size=4>
                                    </td>
                                  </tr>
                                  <!--<tr>
                                    <td>Diversion Expired<label style="color:rgb(255,0,0);">*</label></td>
                                     <td><input type="radio" name="optExpired" value="Y" checked>Yes &nbsp; <input type="radio" name="optExpired" value="N">No</td>
                                  </tr>-->
                                  <tr>
                                    <td>Diversion Expiry Date:<label style="color:rgb(255,0,0);">*</label></td>
                                    <td colspan="4"><input type=text name="txtExOrderDate" maxlength=10 size=10 onfocus="javascript:vDateType='3';return ordercheck()" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" onchange="if(check2(this)==true){return check3()}else{}">
