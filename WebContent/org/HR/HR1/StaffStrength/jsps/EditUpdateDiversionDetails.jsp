...
<html>
  <head>
    ...
    <title>Edit Diversion Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/EditUpdateDiversionDetails.js" ></script>
     <script type="text/javascript" src="../scripts/EditUpdateDiversionDetailAjax.js"></script>
  ...
  <form action="../../../../../EditUpdateDiversionServlet.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Edit Diversion Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                 ...
                                 %>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <input type=text name="txtdiversionfromoffice" size="4" onchange="loadofficeaddress(this.value);PostRank(this.value)" onfocus="return ordercheck()" onkeypress="return numbersonly1(event,this)" maxlength=4>
                    ...
                    <tr>
                        <td class="tdH">
                            <center>
                                    <input type="submit" value="Submit" name="cmbSubmit" id="cmbSubmit">
