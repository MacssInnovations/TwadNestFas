...
<html>
  <head>
    ...
    <title>Edit Diversion Extension Details</title>
  ...
  <form action="../../../../../EditExtensionDiversion1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Edit Diversion Extension Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
