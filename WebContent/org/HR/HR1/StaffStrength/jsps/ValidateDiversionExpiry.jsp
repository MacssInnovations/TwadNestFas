...
<html>
  <head>
    ...
    <title>Validate Diversion Expiry Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/ValidateDiversionExpiryValidation.js" ></script>
     <script type="text/javascript" src="../scripts/ValidateDiversionExpiryAjax.js"></script>
  ...
  <form action="../../../../../ValidateDiversionExpiry1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Validate Diversion Expiry Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                ...
                                <tr>
                                  ...
                                  <!--<tr>
                                    <td>Diversion Expired<label style="color:rgb(255,0,0);">*</label></td>
                                     <td><input type="radio" name="optExpired" value="Y" checked onfocus="return ordercheck()">Yes &nbsp; <input type="radio" name="optExpired" value="N" onfocus="return ordercheck()">No</td>
                                  </tr>-->
                                  <tr>
                                    <td>Diversion Expiry Date:<label style="color:rgb(255,0,0);">*</label></td>
                                    <td colspan="4"><input type=text name="txtExOrderDate" maxlength=10 size=10 onfocus="javascript:vDateType='3';return ordercheck()" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" onchange="if(check2(this)==true)return check3()">
                                 ...
                                 <!-- <tr>
                                  ...
                                  <tr>
                                    <td>Remarks</td>
                                    <td colspan="4"><textarea rows="5" cols="25" name="txtExRemarks" onfocus="return ordercheck()" onfocus="return ordercheck()"></textarea></td>
                                  </tr>
                             </table>
                        </td>
                    </tr>
