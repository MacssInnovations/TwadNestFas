...
<html>
  <head>
      ...
      <title>Edit Sanctioned Staff Strength For An Office</title>    
      
          <script type="text/javascript" src="../scripts/EditRequestStaffStrength.js" ></script>
          <script type="text/javascript" src="../scripts/EditRequestStaffStrengthValidation.js" ></script>
 ...
 %>        
        <table  cellspacing="1" cellpadding="3" width="100%" class="bodytext">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Edit Sanctioned Staff Strength for an Office</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmOffice" method="POST" action="../../../../../EditRequestStaffStrength1.con" onsubmit="return nullValue()">                
            ...
            <tr>
                ...
                <td>
                    <input type=text name="txtNoPost" id="txtNoPost" maxlength="4" tabindex="5" onkeypress="return  numbersonly1(event,this)" onfocus="return OfficeCheck()" onchange="total();return zerocheck();"/>
                </td>
            </tr>
            <tr>
        ...
        <tr>
            ...
            <td>
              <input type="text" name="txtNoOfPostFrom" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)"  tabindex="7" onchange="total();"  onfocus="return OfficeCheck()"/>
            </td>
        </tr>
        <tr>
        <td class="td">
