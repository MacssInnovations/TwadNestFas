...
<html>
  <head>
    ...
    <title>Validate Diversion Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/ValidateUpdateDiversionDetails.js" ></script>
     <script type="text/javascript" src="../scripts/ValidateUpdateDiversionDetailAjax.js"></script>
  ...
  <form action="../../../../../ValidateUpdateDiversionServlet.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Validate Diversion Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                 ...
                                 %>
                                  ...
                                  <tr>
                                        ...
                                        <td><input type=text name="txtOrderId" id="txtOrderId" onchange="officedetails();" size="3"></td>
                                        ...
                                        <%
                                            try
                                            {
                                            PreparedStatement ps=connection.prepareStatement("select diversion_order_id from hrm_ss_diversion_orders_tmp where process_flow_status_id not in 'FR' order by diversion_order_id");
                                   ...
                                   <tr>
                                    ...
                                    <td colspan="4">
                                         <select name="cmbFinancialYear" id="cmbFinancialYear" onfocus="return ordercheck()">
                                   ...
                                   <tr>
                                    ...
                                    <td colspan="4">
                                        <input type=text name="txtDoD" maxlength="10" size="10" onFocus="javascript:vDateType='3';return ordercheck()" onkeypress="return  calins(event,this)" onblur="return checkdt(this);">
                                  ...
                                  <tr>
                                    <td>Diversion From Office Id:<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td>
                                        <input type=text name="txtdiversionfromoffice"  size="4" onchange="officedetails();PostRank(this.value)" onfocus="return ordercheck()" onkeypress="return numbersonly1(event,this)" maxlength=4>
                                ...
                                <td><textarea rows="5" cols="25" id="txtOfficeAddressFrom" name="txtOfficeAddressFrom" disabled></textarea></td>
                                  ...
                                  <tr>
                                    <td>Diversion To Office Id:<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td>
                                        <input type=text name="txtdiversiontooffice" size="4" onchange="loadofficeaddressto(this.value);return checktooff();" onfocus="return ordercheck()" onkeypress="return numbersonly1(event,this)" maxlength=4>
                                  ...
                                  <tr>
                                    <td>Name of the Post Diverted:<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td >
                                        <select name="cmbPostRank" id="cmbPostRank" onchange="SanctionPost(this.value)" onfocus="return ordercheck()">
                                 ...
                                 <tr>
                                  <td >No.of Sanction Post</td>
                                   ...
                                   <td colspan="3">
                                       <table border=0>
                                           <tr>
                                                <td >No.of Post Diverted To</td> 
                                                <td><input type=text name="divertedtopost" disabled>
                                                <input type=hidden name="txtdivertedto">
                                                </td>  
                                  ...
                                  <tr>
                                    <td>No. of Posts Diverted:<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td colspan="4">
                                        <input type=text name="txtPostDiverted" size=10 maxlength="3" onkeypress="return  numbersonly1(event,this)" onchange="return checksanction()" onfocus="return ordercheck()">
                                    </td>
                                  </tr>
                                  <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type=text name="txtDPDate" size=10 maxlength="10" onfocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" onchange="return check3()">
                                    <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmStaffStrength.txtDPDate);" alt="Show Calendar"></img>
                                    
                                </tr>
                                  <tr>
                                    <td>Remarks</td>
                                    <td colspan="4"><textarea rows="5" cols="25" name=txtRemarks onfocus="return ordercheck()"></textarea>
                                  </tr>
