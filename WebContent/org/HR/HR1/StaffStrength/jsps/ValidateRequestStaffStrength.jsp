...
<html>
  <head>
      ...
      <title>Validate Sanctioned Staff Strength For An Office</title>    
      
          <script type="text/javascript" src="../scripts/ValidateRequestStaffStrengthAjax.js" ></script>
          <script type="text/javascript" src="../scripts/ValidateRequestStaffStrengthValidation.js" ></script>
 ...
 %>        
        <table  cellspacing="1" cellpadding="3" width="100%" class="bodytext">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Validate Sanctioned Staff Strength for an Office</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmOffice" method="POST" action="../../../../../ValidateRequestStaffStrength1.con" onsubmit="return nullValue()">                
            ...
            <tr>
                ...
                <td>
                    <select name="cmbFinancialYear" id="cmbFinancialYear" tabindex="1" onfocus="return OfficeCheck()" onchange="callServer('TableView',null)">
            ...
            <!--<tr>
                ...
                <td>
                  <select name="cmbPostCategory" id="cmbPostCategory" tabindex="5" onfocus="return OfficeCheck()">
            ...
            <tr>
                ...
                <td>
                  <select name="cmbServiceGroup" id="cmbServiceGroup" onchange="callServer('ServiceGroup',null)" tabindex="3" onfocus="return OfficeCheck()">
            ...
            %>
             ...
             <tr>
                ...
                <td>
                 <select name="cmbPostRank" id="cmbPostRank" tabindex="4" onfocus="return OfficeCheck()">
            ...
            <tr>
                ...
                <td>
                    <input type=text name="txtNoPost" id="txtNoPost" maxlength="4" tabindex="5" onkeypress="return  numbersonly1(event,this)" onfocus="return OfficeCheck()" onchange="total()"/>
                </td>
            </tr>
            <tr>
            <td>No of Posts Diverted to Other</td>
            <td>
              <input type="text" name="txtNoOfPostTo" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)" tabindex="6" onchange="total();return diversionto()" onfocus="return OfficeCheck()"/>
            </td>
        </tr> 
        ...
        <tr>
            ...
            <td>
              <input type="text" name="txtNoOfPostFrom" maxlength="4" size="30" onkeypress="return  numbersonly1(event,this)"  tabindex="7" onchange="total();return zerocheck();" onfocus="return OfficeCheck()"/>
            </td>
        </tr>
        <tr>
        <td class="td">
        ...
        <tr>
          ...
          <td>
            <textarea name="Remarks" cols="25" rows="5" tabindex="8" onfocus="return OfficeCheck()"></textarea>
          </td>
      </tr>
              ...
              <td colspan=2 class="tdH">
                <div>
                    <table border="0">
                        <tr>
                            <td>
                   <input type="Button" value="  Save " id="Add" onclick="callServer('Add','null')" name="cmdAdd" tabindex="9" style="display:block"> 
                    </td><td>
            ...
            <table name="Existing" id="Existing"  border="2" width="100%"  style="font-family:arial;">
                <tr>
                        <td class="tdH" colspan="11">
        ...
        <tr>
           ...
           <!-- <div class="tab-page">
                ...
                <div id="bghead" class="tdH">
                    <center>  
                        <input type="SUBMIT" value="Validate " onclick="" name="cmbSubmit"> &nbsp;
