...
<html>
  <head>
    ...
    <title>Delete Diversion Extension Details</title>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     ...
     <script type="text/javascript" src="../scripts/EditDiversionExtensionValidation.js" ></script>
     <script type="text/javascript" src="../scripts/EditDiversionExtensionAjax.js"></script>
  ...
  <form action="../../../../../DeleteExtensionDiversion1.con" name="frmStaffStrength" method="post" onsubmit="return nullCheck()">
  <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="bgbody">
                    <tr>
                        <td class="tdH" >
                            <center><h2>Delete Diversion Extension Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td>Diversion Extension Order Date:<label style="color:rgb(255,0,0);"/></td>
                                    <td colspan="4"><input type=text name="txtExOrderDate" maxlength=10 size=10 onfocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                    <!--<img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmStaffStrength.txtExOrderDate);" alt="Show Calendar"></img>-->
                                    </td>
                                    
                                  </tr>
                                  <tr>
                                    <td>Diversion Extended Upto:</td>
                                    <td colspan="4"><input type=text name="txtExUpto" maxlength=10 size=10 onfocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                    <!--<img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmStaffStrength.txtExUpto);" alt="Show Calendar"></img>-->
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Remarks</td>
                                    <td colspan="4"><textarea rows="5" cols="25" name="txtExRemarks" disabled></textarea></td>
                                  </tr>
                             </table>
                        </td>
                    </tr>
