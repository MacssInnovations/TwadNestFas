...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmEmployeeDetailRep.cmbolevel.options[document.frmEmployeeDetailRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../StaffStrengthDesig.con?OLevel=region" ;
     // alert(url);
...
function getCircle(cir)
    {
      ...
      if(document.frmEmployeeDetailRep.chkregion)
      {
            ...
            if(region!="")
            {
                ...
                var url="../../../../../../StaffStrengthDesig.con?OLevel=circle&regions="+region;
              // document.frmEmployeeDetailRep.cmbregion.focus();
                var req=getTransport();
                req.open("GET",url,false);        
                req.onreadystatechange=function()
      ...
      if(document.frmEmployeeDetailRep.chkcircle)
      {
            ...
            if(circle!="")
            {
               ...
               // alert(divisionflag);
                ...
                var url="../../../../../../StaffStrengthDesig.con?OLevel=division&circles="+circle;
              // document.frmEmployeeDetailRep.cmbregion.focus();
                var req=getTransport();
                req.open("GET",url,false);        
                req.onreadystatechange=function()
      ...
      if(document.frmEmployeeDetailRep.chkdivision)
      {
            ...
            if(division!="")
            {
               ...
               // alert(divisionflag);
                ...
                var url="../../../../../../StaffStrengthDesig.con?OLevel=subdivision&division="+division;
              // document.frmEmployeeDetailRep.cmbregion.focus();
                var req=getTransport();
                req.open("GET",url,false);        
                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../StaffStrengthDesig.con?OLevel=submit" ;
    ...
    document.frmEmployeeDetailRep.action="../../../../../../StaffStrengthDesig.con";
