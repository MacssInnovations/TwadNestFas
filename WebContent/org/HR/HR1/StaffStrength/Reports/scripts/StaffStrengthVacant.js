...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmVacantRep.cmbolevel.options[document.frmVacantRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../StaffStrengthVacantServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmVacantRep.chkregion)
      {
               if(document.frmVacantRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../StaffStrengthVacantServ.rep?OLevel=circle&regions="+region;
                              // document.frmVacantRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmVacantRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../StaffStrengthVacantServ.rep?OLevel=division&circles="+circle;
                              // document.frmVacantRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../StaffStrengthVacantServ.rep?OLevel=submit" ;
    ...
    document.frmVacantRep.action="../../../../../../StaffStrengthVacantServ.rep";
