...
function officevisible(r,c,d,s)
{
    ...
    dn.style.display=d;
    var sd=document.getElementById("divsubdivision");
    sd.style.display=s;
    ...
    dn.style.display=d;
    var sd=document.getElementById("cmbsubdivision");
    sd.style.display=s;
}
...
function showoffice()
{
    ...
    document.frmValidationSummaryRep.cmbsubdivision.disabled=true;
...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=region" ;
     // alert(url);
                                 ...
                                 if(circleflag==true && cir=='null')
                                {
                                         ...
                                         var iframe=document.getElementById("diviframecircle");
                                          ...
                                          iframe.focus();
                                           ...
                                           document.frmValidationSummaryRep.cmbsubdivision.disabled=false;
                                        return;
                                }
                                region=region.substring(0,region.length-1);
                                //var url="../../../../../../ListofEmpValidationSummaryServ.rep?OLevel=circle&regions="+region;
                                
                                var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=circle&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
                                {
                                    ...
                                    { 
                                          ...
                                          {  
                                           var iframe=document.getElementById("diviframecircle");
                                             if((type=='CL' || type=='DN' || type=='SD') && cir=='null' )
                                            {
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=division&circles="+circle;
...
function getDivision(div)
    {
       ...
       if(document.frmValidationSummaryRep.chkregion)
      {
       ...
       var circle="";
    var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
       //alert(document.frmValidationSummaryRep.chkcircle);
      if(document.frmValidationSummaryRep.chkcircle)
      {
          // alert(document.frmValidationSummaryRep.chkcircle.length);
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=division&circles="+circle+"&regions="+region;
                              //alert("url 1 " +url);
...
function getSubDivision(sdiv)
    {
      ...
      // alert(document.frmValidationSummaryRep.chkdivision);
       
      if(document.frmValidationSummaryRep.chkdivision)
      {
          // alert(document.frmValidationSummaryRep.chkdivision.length);
            ...
            if(document.frmValidationSummaryRep.chkdivision.length)
            {
                            ...
                            if(division!="")
                            {
                              ...
                              // alert("inside division");
                               /*
                                 if(subdivisionflag==true && sdiv=='null')
                                {
                                      // alert("inside subdivision");
                                         var iframe=document.getElementById("diviframesubdivision");
                                            iframe.style.visibility='visible';
                                            iframe.focus();
                                        return;
                               ...
                               // var url="../../../../../../ListofEmpValidationSummaryServ.rep?OLevel=division&circles="+circle;
                              //alert("division " +division);
                              var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=subdivision&divisions="+division;
                             // alert(url);
                            ...
                            else
                            {
                                var iframe=document.getElementById("diviframesubdivision");
                                iframe.style.visibility='hidden';
                                document.frmValidationSummaryRep.cmbsubdivision.focus();
...
{
    if(document.frmValidationSummaryRep.chksubdivision)
      {
      
            for(i=0;i<document.frmValidationSummaryRep.chksubdivision.length;i++)
            {
                    document.frmValidationSummaryRep.chksubdivision[i].checked=true;
...
{
    //alert('submit');
        var url="../../../../../../VacancyPositionSummaryServ_SubDiv?OLevel=submit" ;
                ...
                else
                {
                    ...
                    else
                    {
                            ...
                            if(document.frmValidationSummaryRep.chksubdivision)
                              {
                             //alert(document.frmValidationSummaryRep.chkregion.length);
                                     if(document.frmValidationSummaryRep.chksubdivision.length )
                                        {
                                        
                                        
                                                for(i=0;i<document.frmValidationSummaryRep.chksubdivision.length;i++)
                                                {
                                                        if(document.frmValidationSummaryRep.chksubdivision[i].checked==true)
                                                                subdivision= subdivision+document.frmValidationSummaryRep.chksubdivision[i].value +",";
                                                ...
                                                if(subdivision!="")
                                                {
                                                    subdivision=subdivision.substring(0,subdivision.length-1);
                                                     url=url+"&officeselected="+subdivision;
                                                     document.frmValidationSummaryRep.officeselected.value=subdivision;
                                        ...
                                        {
                                                if(document.frmValidationSummaryRep.chksubdivision.checked==true)
                                                {
                                                                subdivision= document.frmValidationSummaryRep.chksubdivision.value;
                                                                    //division=division.substring(0,division.length-1);
                                                                 url=url+"&officeselected="+subdivision;
                                                                 document.frmValidationSummaryRep.officeselected.value=subdivision;
    ...
    document.frmValidationSummaryRep.action="../../../../../../VacancyPositionSummaryServ_SubDiv";
