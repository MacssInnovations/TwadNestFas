...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/StaffStrengthVacant.js"></script>
  ...
  <body><form name="frmVacantRep" method="POST" action="">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Vacant Position Report</strong></td>
                </tr>
                <tr>
