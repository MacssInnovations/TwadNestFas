...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/StaffStrengthDesig.js"></script>
        ...
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              ...
              <tr>
                  <th colspan="2" align="center" class="tdH">Report on Sanctioned Strength - Cadre Wise</th>
                </tr>
              <tr>
                  <td colspan="2" class="tdH">Select Financial Year</td>
                </tr>
              <tr>
          ...
          <tr>
             ...
             <td colspan="2" align="left" valign="top" class="table">
              <div align="center">
                <table border="0" width="100%">
                  <tr>
                    <td colspan="2" align="left" class="tdH">Report Output Format</td>
                  </tr>
                  <tr>
