...
<html>
  <head>
    ...
    <title> Vacancy Position for Specific Rank</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/VacancyPositionSummaryJS_SubDiv.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../VacancyPositionSummaryServ_SubDiv">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Vacancy Position for Specific Rank</strong></td>
                </tr>
                    ...
                    <div align="left">
                      <table border="0" width="100%">
                        <tr>
                          ...
                          <td>
                            <div id="divsubdivision" style="display:none">SubDivision</div>
                          </td>
                        </tr>
                        <tr>
                          <td>
                              ...
                              <tr>
                                <td>
                                  <select name="cmbsubdivision" id="cmbsubdivision"
                                    ...
                                    <option>Select the SubDivision</option>
                                  </select>
                                </td>
                              </tr>
                              <tr>
