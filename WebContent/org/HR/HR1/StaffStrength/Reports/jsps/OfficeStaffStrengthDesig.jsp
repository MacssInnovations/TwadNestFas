...
<script type="text/javascript" src="../scripts/OfficeStaffStrengthDesigReport.js">    </script>
  ...
  <form name="OfficeSpecificReport"
              action="../../../../../OfficeStaffStrengthDesigServlet.con"
              method="POST">
      <div align="center">
        <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2" align="center"><b>Office StaffStrength Report</b></td>
        </tr>
        <tr>
