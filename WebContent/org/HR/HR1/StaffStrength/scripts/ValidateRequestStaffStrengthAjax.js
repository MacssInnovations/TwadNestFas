...
{   
    ...
    else
    {
               ...
               startwaiting(document.frmOffice) ;
                var url="../../../../../ValidateRequestStaffStrength.con?command=nil&ID="+id;
                //alert(url);
...
function OfficeLevel()
{
    ...
    startwaiting(document.frmOffice) ;
    url="../../../../../ValidateRequestStaffStrength.con?command=OfficeLevel&OfficeId="+Office_Id;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function callServer(command,param)
{
    ...
    if(command=="TableView")
    {
        ...
        startwaiting(document.frmOffice) ;
        url="../../../../../ValidateRequestStaffStrength.con?command=TableView&TemplateId="+Office_Id+"&finyear="+finyear;
        var req=getTransport();
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
   ...
   else if(command=="ServiceGroup")
    {
        ...
        startwaiting(document.frmOffice) ;
        url="../../../../../ValidateRequestStaffStrength.con?command=ServiceGroup&ServiceGroup="+ServiceGroup;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
                       ...
                       //  alert(value.length);
                          ...
                          for(var i=0;i<value.length;i++)
                          {
                              var tmpoption=value.item(i);
                                ...
                                if(NoOfPost!="")
                                {
                                    total=parseInt(NoOfPost)+parseInt(total);
                                }
                          }
                          
                            document.frmOffice.totalgrid.value=total;
                          if(recordstatus=="FR")
                           {
...
{
        startwaiting(document.frmOffice) ;
       url="../../../../../ValidateRequestStaffStrength.con?command=ServiceGroup&ServiceGroup="+ServiceGroup+"&PostRank="+PostRank;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
...
function diversionto()
{
    ...
    {
        alert("No of Post Diverted to is more than Sanctioned no of Post");
...
function zerocheck()
{
    if(document.frmOffice.txtNoOfPostFrom.value<0)
    {
