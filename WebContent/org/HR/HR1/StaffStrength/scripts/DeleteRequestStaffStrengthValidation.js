 	...
 	else 
 	{
           ...
           try
            ...
            if(cmn>=12)
            {
                for (var i = 0 ; i < 3; i++) 
                {
                  //document.frmOffice.cmbFinancialYear.options[i].text=(cyr-1)+"-"+(cyr);
                  //document.frmOffice.cmbFinancialYear.options[i].value=(cyr-1)+"-"+(cyr);
                  var id=(cyr-1)+"-"+(cyr);
                  var option=document.createElement("OPTION");
                  option.text=id;
                  option.value=id;
...
function checkIf()
    {
        ...
        for(i=0;i<rows.length;i++)
        {
            ...
            if((cells[3].lastChild.value==document.frmOffice.cmbPostCategory.value)&&(cells[2].lastChild.value==document.frmOffice.cmbPostRank.value)&&(cells[1].lastChild.value==document.frmOffice.cmbServiceGroup.value))
            {
...
function checkIfTo()
    {
        ...
        {
            var cells=rows[i].cells;
            //alert("postCategory:"+cells[4].lastChild.value);
            //alert("postRank:"+cells[3].lastChild.value);
           //alert("ServiceGroup:"+cells[2].lastChild.value);
...
function clearAllTo()
{
        ...
        //document.frmOffice.txtSl_NoTo.value="";
...
function slnocheckTo()
   {
        ...
        //alert(rows);
        var value;
        //alert("cells1:"+rows[1].cells[0].firstChild.nodeValue);
