...
{   
    ...
    else
    {
               startwaiting(document.frmStaffStrength) ;
                var url="../../../../../ValidateExtensionDiversion.con?command=nil&ID="+id;
                //alert(url);
...
function SanctionPost(p)
{
   ...
   // var finyear=document.frmStaffStrength.cmbFinancialYear.value;
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateExtensionDiversion.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateExtensionDiversion.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function PostRank1()
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateExtensionDiversion.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function diversiondetails()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../ValidateExtensionDiversion.con?command=DiversionDetails&OrderId="+orderid;
   // alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
{
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../ValidateExtensionDiversion.con?command=SlNO&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
    ...
    if(req.readyState==4)
    {
          ...
          {                
               // stopwaiting(document.frmStaffStrength) ;
                ...
                //document.frmStaffStrength.txtExOrderSlNO.value="";
                if(flag=="success")
                {
                
                    
                    var slno=response.getElementsByTagName("slno");
                    var cmbOrderSlno=document.getElementById("cmbOrderSlNo");
                    cmbOrderSlno.innerHTML="";
                    var option=document.createElement("OPTION");
                    option.value=0;
                    option.text="--Select Order SlNo--";
                        try
                            {
                                   cmbOrderSlno.add(option);
                            }catch(errorobject)
                            { 
                                     cmbOrderSlno.add(option,null);
                            }
                            
                    for(var i=0;i<slno.length;i++)
                    {
                        var tmpoption=slno.item(i);
                        var slno1=response.getElementsByTagName("slno")[i].firstChild.nodeValue;
...
function callServer(command)
{
        ...
        {
            var slno=document.frmStaffStrength.cmbOrderSlNo.value;
            var url="../../../../../ValidateExtensionDiversion.con?command=Extension&SlNo="+slno;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
            {                
               SlNoDetailsResponse(req);             
            }
            req.send(null); 
...
function SlNoDetailsResponse(req)
{
        ...
        if(req.readyState==4)
        {
          ...
          {    
            ...
            if(flag=="success")
            {
                var exorderdate=response.getElementsByTagName("extorderdate")[0].firstChild.nodeValue;
                var exupto=response.getElementsByTagName("extupto")[0].firstChild.nodeValue;
                var remarks=response.getElementsByTagName("remarks")[0].firstChild.nodeValue;
                
                document.frmStaffStrength.txtExOrderDate.value=exorderdate;
                document.frmStaffStrength.txtExUpto.value=exupto;
                if(remarks!="null")
                {
                document.frmStaffStrength.txtExRemarks.value=remarks;
                }
            ...
            document.frmStaffStrength.txtExUpto.value="";
            document.frmStaffStrength.txtExRemarks.value="";
            }
          }
        }
...
function check1()
{
    var from=document.frmStaffStrength.txtDoD.value;
...
function check(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     var fday=document.frmStaffStrength.txtDoD.value.split("/");
     var todate=todate;
     //alert("todate"+todate);
     var frmDay = fday[0];
     var frmMonth = fday[1];
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Extension Order Date Should be Greater Than Diversion Order Date ");
                   document.frmStaffStrength.txtExOrderDate.value="";
...
{
    var from=document.frmStaffStrength.txtDoD.value;
    var to=document.frmStaffStrength.txtExUpto.value;
    return check2(from,to);
    
}

function check2(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     var todate=rows[todate].cells[3].firstChild.nodeValue;*/
     //alert("todate"+todate);
     var todate=document.frmStaffStrength.txtExUpto.value;
     var fday=document.frmStaffStrength.txtDoD.value.split("/");
     var todate=todate;
     //alert("todate"+todate);
     var frmDay = fday[0];
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Extended Upto Date Should be Greater Than Diversion Order Date");
                   document.frmStaffStrength.txtExUpto.value="";
...
function check3()
{
    var from=document.frmStaffStrength.txtExOrderDate.value;
    var to=document.frmStaffStrength.txtExUpto.value;
    return check3(from,to);
    
}

function check3(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     //alert("todate"+todate);
     var todate=document.frmStaffStrength.txtExUpto.value;
     var fday=document.frmStaffStrength.txtExOrderDate.value.split("/");
     var todate=todate;
     //alert("todate"+todate);
     var frmDay = fday[0];
     var frmMonth = fday[1];
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Extended Upto Date Should be Greater Than Extension Order Date");
                   document.frmStaffStrength.txtExUpto.value="";
                   document.frmStaffStrength.txtExUpto.focus();
                   return false;
             }
