...
function nullCheck()
{
    if((document.frmStaffStrength.txtExpOrderId.value==0) || (document.frmStaffStrength.txtExpOrderId.value.length<=0))
    {
        alert("Select Diversion Expiry OrderId");
        //document.frmStaffStrength.cmbExpOrderId.focus();
        return false;
    }
    if((document.frmStaffStrength.txtExOrderDate.value==0) ||(document.frmStaffStrength.txtExOrderDate.value.lenth<=0))
    {
        alert("Enter Diversion Expiry Date");
    ...
    /*if(document.frmStaffStrength.optExpired[0].checked)
    {
      opt=document.frmStaffStrength.optExpired[0].checked;
    }
    else
    {
    opt=document.frmStaffStrength.optExpired[1].checked;
    }
    
    if(opt==false)
    {
        alert("Select Diversion Expired");
