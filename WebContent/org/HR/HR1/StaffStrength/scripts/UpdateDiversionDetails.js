          ...
          /*
            ...
            */
                  ...
                  /*
                    ...
                    if( currentMonth < getCurrentMonth())
                    {
                        alert('Entered date should be greater than current date and \n year should be greater than or equal to '+_Service_Period_Beg_Year);
                        t.value="";
                        t.focus();
                        return false;
                    }
...
function nullCheck()
{
    if((document.frmStaffStrength.cmbFinancialYear.value=="") || (document.frmStaffStrength.cmbFinancialYear.value.length<=0) || (document.frmStaffStrength.cmbFinancialYear.value==0))
      {
        alert("Please Select Financial Year");
        document.frmStaffStrength.cmbFinancialYear.focus();
        return false;
        
      }
    if((document.frmStaffStrength.txtdiversionfromoffice.value==0)||(document.frmStaffStrength.txtdiversionfromoffice.value.length<=0))
    {
        alert("Select Diversion From Office Id");
        document.frmStaffStrength.cmbFromOfficeId.focus();
        return false;
    }
    if((document.frmStaffStrength.txtdiversiontooffice.value==0)||(document.frmStaffStrength.txtdiversiontooffice.value.length<=0))
    {
        alert("Select Diversion To Office Id");
        document.frmStaffStrength.cmbToOfficeId.focus();
        return false;
    }
    /*if((document.frmStaffStrength.cmbPostCategroy==0)||(document.frmStaffStrength.cmbPostCategory.value.length<=0)||(document.frmStaffStrength.value=="0"))
    {
        alert("Select Post Category");
        document.frmStaffStrength.cmbPostCategory.focus();
        return false;
    }*/
    if((document.frmStaffStrength.cmbPostRank.value==0)||(document.frmStaffStrength.cmbPostRank.value.length<=0))
    {
        alert("Select Post Rank Id");
        document.frmStaffStrength.cmbPostRank.focus();
        return false;
    }
    if((document.frmStaffStrength.txtPostDiverted.value==0)||(document.frmStaffStrength.txtPostDiverted.value.length<=0))
    {
        alert("Enter Post Diverted");
        document.frmStaffStrength.txtPostDiverted.focus();
        return false;
    }
    /*if((document.frmStaffStrength.txtDoD.value==0)||(document.frmStaffStrength.txtDoD.value.length<=0))
    {
        alert("Enter Date of Diversion");
...
//var tableexist=document.getElementById("Existing");
...
//var tableexist=document.getElementById("Existing");
//tableexist.style.display="block";
}
...
function nullcheck()
{
    ...
    if((document.frmStaffStrength.txtdiversiontooffice.value=="")|| (document.frmStaffStrength.txtdiversiontooffice.value.length<=0))
    {
        alert("Please Enter Diversion To Office");
        document.frmStaffStrength.txtdiversiontooffice.focus();
        return false;
    }
    if((document.frmStaffStrength.txtPostDiverted.value=="") || (document.frmStaffStrength.txtPostDiverted.value.length<=0))
    {
        alert("Pleae Enter Post Diverted ");
        document.frmStaffStrength.txtPostDiverted.focus();
        return false;
    }
    return true;
