...
function SanctionPost(p)
{
   ...
   // var finyear=document.frmStaffStrength.cmbFinancialYear.value;
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateDiversionExpiry.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateDiversionExpiry.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function PostRank1()
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../ValidateDiversionExpiry.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function diversiondetails()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../ValidateDiversionExpiry.con?command=DiversionDetails&OrderId="+orderid;
   // alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
{
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../ValidateDiversionExpiry.con?command=SlNO&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
          ...
          {                
               // stopwaiting(document.frmStaffStrength) ;
                ...
                if(flag=="success")
                {
                    ...
                    /*var cmbExpOrderId=document.getElementById("cmbExpOrderId");
                    cmbExpOrderId.innerHTML="";
                    var option=document.createElement("OPTION");
                    option.value=0;
                    option.text="--Select Expiry OrderId--";
                        try
                            {
                                   cmbExpOrderId.add(option);
                            }catch(errorobject)
                            { 
                                     cmbExpOrderId.add(option,null);
                            }
...
function statuscheck()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../ValidateDiversionExpiry.con?command=Status&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function callServer(command)
{
    ...
    if(command=='Expiry')
    {
        ...
        var slno=document.frmStaffStrength.txtExpOrderId.value;
            var url="../../../../../ValidateDiversionExpiry.con?command=Expiry&SlNo="+slno;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
...
function SlNoDetailsResponse(req)
{
        ...
        if(req.readyState==4)
        {
          ...
          {    
            ...
            if(flag=="success")
            {
                var expdate=response.getElementsByTagName("expdate")[0].firstChild.nodeValue;
                var diversionexpired=response.getElementsByTagName("diversionexpired")[0].firstChild.nodeValue;
                var remarks=response.getElementsByTagName("remarks")[0].firstChild.nodeValue;
                if(expdate!="Not Specified")
                {
                    document.frmStaffStrength.txtExOrderDate.value=expdate;
                }
                if(diversionexpired!="null")
                {
                    if(diversionexpired=='N')
                    {
                        //document.frmStaffStrength.optExpired[1].checked=true;
                    }
                    else
                    {
                        //document.frmStaffStrength.optExpired[0].checked=true;
                    }
                }
                if(remarks!="null")
                {
