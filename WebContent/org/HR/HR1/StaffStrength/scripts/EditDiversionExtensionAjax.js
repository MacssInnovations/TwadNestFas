...
{   
    ...
    else
    {
               startwaiting(document.frmStaffStrength) ;
                var url="../../../../../EditExtensionDiversion.con?command=nil&ID="+id;
                //alert(url);
...
function SanctionPost(p)
{
   ...
   // var finyear=document.frmStaffStrength.cmbFinancialYear.value;
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../EditExtensionDiversion.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../EditExtensionDiversion.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function PostRank1()
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../EditExtensionDiversion.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function diversiondetails()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../EditExtensionDiversion.con?command=DiversionDetails&OrderId="+orderid;
   // alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
{
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../EditExtensionDiversion.con?command=SlNO&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function callServer(command)
{
        ...
        if(command=="Extension")
        {
            ...
            var url="../../../../../EditExtensionDiversion.con?command=Extension&SlNo="+slno;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
   ...
   // document.workdemand.elements["txt_from"+c].value=""
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Extension Order Date Should be Greater Than Date of Effective");
   ...
   // document.workdemand.elements["txt_from"+c].value=""
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Extended Upto Date Should be Greater Than Date of Effective");
