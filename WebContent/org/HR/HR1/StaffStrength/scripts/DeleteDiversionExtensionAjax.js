...
{   
    ...
    else
    {
               startwaiting(document.frmStaffStrength) ;
                var url="../../../../../DeleteExtensionDiversion.con?command=nil&ID="+id;
                //alert(url);
...
function PostRank(postrid)
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../DeleteDiversionServlet.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function SanctionPost(p)
{
   ...
   // var finyear=document.frmStaffStrength.cmbFinancialYear.value;
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../DeleteExtensionDiversion.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../DeleteExtensionDiversion.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function PostRank1()
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../DeleteExtensionDiversion.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function diversiondetails()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../DeleteExtensionDiversion.con?command=DiversionDetails&OrderId="+orderid;
   // alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
{
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../DeleteExtensionDiversion.con?command=SlNO&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function callServer(command)
{
        ...
        if(command=="Extension")
        {
            ...
            var url="../../../../../DeleteExtensionDiversion.con?command=Extension&SlNo="+slno;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
