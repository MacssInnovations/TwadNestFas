...
{   
    ...
    else
    {
               startwaiting(document.frmStaffStrength) ;
                var url="../../../../../EditDiversionServlet.con?command=nil&ID="+id;
                //alert(url);
...
function SanctionPost(p)
{
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../EditDiversionServlet.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../EditDiversionServlet.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function check3()
{
    ...
    var to=document.frmStaffStrength.txtDPDate.value;
...
function check3(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     //alert("todate"+todate);
     var todate=document.frmStaffStrength.txtDPDate.value;
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (today<frmday)
	     {
		   alert ("Diversion Period Upto Date Should be Greater Than Diversion Effective Date");
                   document.frmStaffStrength.txtDPDate.value="";
                   document.frmStaffStrength.txtDPDate.focus();
                   return false;
             }
             else
             {
