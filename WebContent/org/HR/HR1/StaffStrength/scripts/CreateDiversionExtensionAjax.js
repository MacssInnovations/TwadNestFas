...
function SanctionPost(p)
{
   ...
   // var finyear=document.frmStaffStrength.cmbFinancialYear.value;
    ...
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../CreateExtensionDiversion.con?command=SanctionPost&OfficeId="+officeid+"&PostRank="+p+"&FinYear="+finyear;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function officedetails()
{
    ...
    //alert(orderid);
   // startwaiting(document.frmStaffStrength) ;
    var url="../../../../../CreateExtensionDiversion.con?command=OfficeDetails&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function PostRank1()
{
    ...
    //alert(officeid);
    startwaiting(document.frmStaffStrength) ;
    var url="../../../../../CreateExtensionDiversion.con?command=PostRank&OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function diversiondetails()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../CreateExtensionDiversion.con?command=DiversionDetails&OrderId="+orderid;
   // alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
{
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../CreateExtensionDiversion.con?command=SlNO&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
          ...
          {                
               // stopwaiting(document.frmStaffStrength) ;
                ...
                if(flag=="success")
                {
                    ...
                    document.frmStaffStrength.txtExOrderSlNO.value=slno;
                    document.frmStaffStrength.txtExOrderSlNO1.value=slno;
                }
                else
                {
...
function statuscheck()
{
    ...
    var orderid=document.frmStaffStrength.txtOrderId.value;
    var url="../../../../../CreateExtensionDiversion.con?command=Status&OrderId="+orderid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
