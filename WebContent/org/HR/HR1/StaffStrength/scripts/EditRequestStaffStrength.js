...
{   
    ...
    else
    {
               ...
               startwaiting(document.frmOffice) ;
                var url="../../../../../EditRequestStaffStrength.con?command=nil&ID="+id;
                //alert(url);
...
function OfficeLevel()
{
    ...
    startwaiting(document.frmOffice) ;
    url="../../../../../EditRequestStaffStrength.con?command=OfficeLevel&OfficeId="+Office_Id;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function callServer(command,param)
{
    ...
    if(command=="TableView")
    {
        ...
        startwaiting(document.frmOffice) ;
        url="../../../../../EditRequestStaffStrength.con?command=TableView&TemplateId="+Office_Id+"&finyear="+finyear;
        var req=getTransport();
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
   ...
   else if(command=="ServiceGroup")
    {
        ...
        startwaiting(document.frmOffice) ;
        url="../../../../../EditRequestStaffStrength.con?command=ServiceGroup&ServiceGroup="+ServiceGroup;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
                          ...
                          for(var i=0;i<value.length;i++)
                          {
                              var tmpoption=value.item(i);
                               ...
                               // var EmploymentStatusName=response.getElementsByTagName("employmentstatusname")[i].firstChild.nodeValue;
                                ...
                                //alert('recordstatus...'+recordstatus);
...
//    return true;
  //  }
    /*else
    {
        alert("No of Post to be diverted more than the Sanctioned Strength");
