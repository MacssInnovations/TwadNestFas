...
function nullCheck()
{
    if((document.frmStaffStrength.txtExOrderSlNO.value==0) || (document.frmStaffStrength.txtExOrderSlNO.value.length<=0))
    {
        alert("Enter Diversion Extension Number");
        document.frmStaffStrength.txtExOrderSlNO.focus();
        return false;
    }
