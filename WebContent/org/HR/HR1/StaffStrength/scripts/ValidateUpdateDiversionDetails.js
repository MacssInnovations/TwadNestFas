...
function nullCheck()
{
    ...
    if((document.frmStaffStrength.txtHdiversionfromoffice.value==0)||(document.frmStaffStrength.txtHdiversionfromoffice.value.length<=0))
    {
        alert("Select Diversion From Office Id");
        document.frmStaffStrength.cmbFromOfficeId.focus();
        return false;
    }
    if((document.frmStaffStrength.txtHdiversiontooffice.value==0)||(document.frmStaffStrength.txtHdiversiontooffice.value.length<=0))
    {
