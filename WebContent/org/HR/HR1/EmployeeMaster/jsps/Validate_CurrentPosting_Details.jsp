...
<html>
  <head>
    ...
    <title>Validate Employee Designation and Office Details</title>
     <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
  <script type="text/javascript" src="../scripts/Validate_Current_PostingScript.js"></script>
      ...
      <table cellspacing="3" cellpadding="2" border="1" width="100%">
       <tr>
                                                <td align="center" class="tdH"
                                                    colspan="4">
                                                      <center>
                                                            <b>Validate Employee Designation and Office Details</b>
                                                      </center>
                                                </td>
                                          </tr>
                                          ...
                                          <tr>
                                                ...
                                                <td colspan="2">
                                                      <input tabindex="1"  type="text"
                                                             name="txtEmpName"
                                                             id="txtEmpName" readonly size="45" 
                                                             onfocus="return toFocus()" >         </input>
                                                </td>
                                          </tr>
         <tr>
        ...
        <tr>
          ...
          <td class="table" colspan="2">
            <textarea name="txtremarks" cols="25" rows="5" id="txtremarks" onfocus="return toFocus()"></textarea>
          </td>
        </tr>
         <tr>
                                    <td colspan="2" class="tdH">Record Status<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td colspan="2" class="tdH">
                                        <select id="cmbRecordStatus" name="cmbRecordStatus">
                                        <option value="0">--Select Record Status--</option>
                                        <%
                                                  try
                                                  {
                                                   PreparedStatement ps5=connection.prepareStatement("select * from COM_MST_PROCESS_FLOW where PROCESS_FLOW_STATUS_ID in('MD','VR','FR') order by PROCESS_FLOW_STATUS_DESC ");
                                                    ResultSet results11= ps5.executeQuery();
                                                    while(results11.next()) 
                                                    {
                                                        out.print("<option value='" + results11.getString("PROCESS_FLOW_STATUS_ID") + "'>" + results11.getString("PROCESS_FLOW_STATUS_DESC") + "</option>");                      
                                                    }
                                                    results11.close();
                                                  }
                                                  catch(Exception e)
                                                  {System.out.println("error in the load of process flow" + e) ;}      
                                            %> 
                                        </select>
                                    </td>
                                </tr>
        ...
        <tr>
          <td colspan="4" class="tdH">
            <input type="BUTTON" name="cmdUpdate" value="    Update    " id="cmdUpdate" onclick="callServer1('Update','null')"/>
