...
<html>
  <head>
    ...
    <title>Editing The Deputation Completion Details</title>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_DPNRelieval_serv.view?Command=Add&cmbStatus=MD"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Editing The&nbsp;<strong>Deputation Completion</strong>
                   Details</strong>
              </div>
            </td>
          </tr>
