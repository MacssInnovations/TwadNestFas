...
<html>
  <head>
    ...
    <title> Creation Of Study&nbsp;Leave Completion Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Emp_STURelieval_Script.js"> </script>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Create_STURelieval_ReportServ.view?Command=Add&cmbStatus=CR"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Creation Of Study&nbsp;Leave Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
         ...
         <!-- <tr class="table">
          ...
          <tr class="tdTitle">
            <td colspan="2">
              <div align="left">
                <strong>Study&nbsp;Leave Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="table">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" title="Don't type '&' Character while entering the remarks" cols="50" rows="4"></textarea>
              </div>
            </td>
          </tr>
          <tr class="tdH">
