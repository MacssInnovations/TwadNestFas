...
<html>
  ...
  <title>EDIT EMPLOYEE GRADE DETAIL</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/UnfreezeEmployeeSRJS.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>Unfreeze&nbsp;Employee&nbsp;SR Details</b>
                  </th>
                </tr>
               ...
               <div id="divstudy" style="display:none"/>  
                ...
                <tr class="table">
                  <td colspan="2" class="tdH">
                    ...
                    <tr>
                        <td>
                      <input type="button" name="cmdedit" value="Unfreeze" id="cmdedit"
