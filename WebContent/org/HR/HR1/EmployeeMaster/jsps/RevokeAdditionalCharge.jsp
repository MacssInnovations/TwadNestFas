...
<html>
  <head>
  <title>REVOKE ADDITIONAL CHARGE DETAILS</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/RevokeAdditionalCharge_New.js">     </script>
      ...
      <div align="center">
        <table width="100%">
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>REVOKE ADDITIONAL CHARGE DETAILS</b>
                  </th>
                </tr>
                  ...
                  <td>
                    <div align="left">
                      <input type="text" name="txtEmployeeid" id="txtEmployeeid"
                             maxlength="5" size="5"
                             onchange="doFunction('loadOffices','null')" 
                             onkeypress="return numbersonly1(event,this);" onfocus="able()"/>
                             <%
                ...
                <tr class="table">
                  <td>
                    <div align="left">Addl. Charge Office ID</div>
                  </td>
                  <td>
                    <div align="left">
                      <!--input type="text" name="txtoffid" id="txtoffid"
                             maxlength="5" size="5"
                             onchange=" doFunction('loadOffices','null');"
                             onkeypress="return numbersonly1(event,this);"/-->
                        <select name="cmbAddlChargeOffId" id="cmbAddlChargeOffId" onchange="doFunction('loadempedit','null')">     
               ...
               <tr class="table" align='left'>
                  <td colspan="2" class="tdH" >Employee Details</td>
                </tr>
                <tr class="table">
                  <td>
                    <div align="left">
          ...
          rs=null;
           try
           {
           ps=connection.prepareStatement("select SERVICE_GROUP_ID,SERVICE_GROUP_NAME from HRM_MST_SERVICE_GROUP where SERVICE_GROUP_ID in(4,6) order by SERVICE_GROUP_NAME");
            rs=ps.executeQuery();
              int strcode=0;
            String strname="";          
            while(rs.next())
        ...
        %>
               ...
               <div id="divwork" style="display:none">
                ...
                <table cellspacing="2" cellpadding="3" border="1" width="100%">
                 <tr class="table" align='left'>
                  <td colspan="2" class="tdH" >Office Details</td>
                </tr>
                        ...
                        <tr class="table">
                          ...
                          <input type="text" name="txtOffice_Id"  readonly                                       
                                         id="txtOffice_Id" 
               ...
               <div id="divstudy" style="display:none">
                <table cellspacing="3" cellpadding="2" border="1" width="100%">
                  ...
                  <tr class="table">
                    ...
                    <td>
                      <div align="left"><input type="text" name="txtInst_Name" id="txtInst_Name"
        ...
        %>
              ...
              <!--  Compulsary Wait  -->  
                ...
                <tr class="table">
                 ...
                 <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="table">
                  <td colspan="2" class="tdH">Revoking Details</td>
                </tr>
                <tr class="table">
                  <td colspan="2">
                    <div align="left">
                  ...
                  <td>
                    <div align="left">
                      <input type="text" name="txtclosuredate" id="txtclosuredate"
                             maxlength="10" size="10"
                             onfocus="javascript:vDateType='3';return checkempid();"
                             onblur="return checkdt(this);"
                             onkeypress="return calins(event,this);"/>
                      ...
                      <img id="fromimg" src="../../../../../images/calendr3.gif"
                           onclick=" if(checkempid()==true)showCalendarControl(document.frmCurrentPosting.txtclosuredate);"
                           alt="Show Calendar"></img>
                       
                      <input type="radio" value="FN" checked="checked"
                             name="optclosuredate" id="optclosuredate"
                             onclick="return checkempid();"></input>
                       FN&nbsp; 
                      <input type="radio" value="AN" name="optclosuredate"
                             id="optclosuredate" onclick="return checkempid();"></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
                ...
                <tr class="table">
                  <td colspan="2" class="tdH">
                    ...
                    <tr>
                        <td>
                      <input type="button" name="cmdedit" value="Revoke" id="cmdedit"
