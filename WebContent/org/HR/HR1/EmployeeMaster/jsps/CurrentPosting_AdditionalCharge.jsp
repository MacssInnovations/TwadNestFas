...
<html>
  <head>
  <title>UPDATE ADDITIONAL CHARGE DETAILS</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/CurrentPosting_AdditionalCharge.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>UPDATE ADDITIONAL CHARGE DETAILS</b>
                  </th>
                </tr>
