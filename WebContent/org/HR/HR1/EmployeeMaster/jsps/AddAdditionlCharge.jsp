...
<html>
  <head>
  <title>Current Posting Additional Charge</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/AddAddtionalCharge.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>Current Posting Additional Charge</b>
                  </th>
                </tr>
                  ...
                  <td colspan="2" class="tdH">
                    ...
                    <tr>
                      ...
                      <input type="button" name="cmdedit" value="Update" id="cmdedit"
                       ...
                       <td>
                      <input type="button" name="cmdAddCharge" value="Add Additional Charge" id="cmdAddCharge"
                             onclick="loadPage()" />
                       </td>
                       <td>
