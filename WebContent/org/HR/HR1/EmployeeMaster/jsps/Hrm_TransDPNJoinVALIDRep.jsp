...
<html>
  <head>
    ...
    <title>Validate Deputation Joining Details</title>
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
   <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/New_Trans_DPNJoinValid_Script.js"></script>
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Validate Deputation Joining Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdH">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtEmpId1" id="txtEmpId1" maxlength="6" size="6" onchange="callServer1('Load','null')" />
                 <img src="../../../../../images/c-lovi.gif"
                                                           width="20"
                                                           height="20"
                                                           alt="empList" onkeypress="return  numbersonly1(event,this)"
