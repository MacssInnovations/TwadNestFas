...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EmpId_Script_Reval.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <title>Validate Employee's Basic Details</title>
    <script type="text/javascript">
            ...
            <table border="1px" width="650px%">
              <tr>
                <td align="center" class="tdH" colspan="4">
                  <div align="left">
                    <center>
                      <b>Revalidate Employee's Basic Details</b>
                    </center>
                  </div>
                </td>
              </tr>
   ...
   <tr>
              ...
              <tr>
                <td colspan="4" class="tdH" align="right">
                  <input type="Button" value="Revalidate" name="cmdSub"
