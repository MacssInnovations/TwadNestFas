...
<html>
  <head>
    ...
    <title>HRM_LeaveCancellationJSP</title>
    <script type="text/javascript" src="../scripts/HRM_LeaveCancellationJS.js">
    </script>
  ...
  <tr class="tdH">
  <td colspan="2" align="center" height="35">Leave Cancellation Details</td>
  </tr>
  <tr class="table">
  <td height="35" align="left">Cancellation Date <font color="Gray">(dd/mm/yyyy)</font></td>
  <td height="35" align="left"><input type="text" name=cdate id=cdate size="20" onkeypress="return calinsert(event,this)">
  <img src="../../../../../images/calendr3.gif" onclick="if(ordercheck()==true)showCalendarControl(document.LeaveCancellation.cdate);" alt="Show Calendar" ></img>
  </td>
  </tr>
  <tr class="table">
  <td align="left">Reason for cancellation</td>
