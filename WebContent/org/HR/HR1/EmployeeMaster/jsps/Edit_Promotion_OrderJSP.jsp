...
<html>
  <head>
      ...
      <script type="text/javascript" src="../scripts/Edit_Promotion_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Edit Promotion Order Details</title>       
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Edit Promotion Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Edit_Promotion_OrderServ?Command=Edit">                
        ...
        %>              
          ...
          <td>
          <div align="left">
          <input type="text" name="txtT_OffId" id="txtT_OffId" maxlength="4" size="5" onchange="doFunction('dept','null');"/>
           <img src="../../../../../images/c-lovi.gif" width="20" 
