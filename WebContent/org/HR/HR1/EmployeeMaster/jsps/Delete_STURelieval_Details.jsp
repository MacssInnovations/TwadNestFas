...
<html>
  <head>
    ...
    <title> Delete The Study&nbsp;Leave Completion Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Edit_STURelieval_Details.js"> </script>
  ...
  <form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_STURelieval_serv.view?Command=Delete&cmbStatus=DL"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          ...
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Delete The Study&nbsp;Leave Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
        ...
        <!--  <tr class="table">
         ...
         <tr class="tdTitle">
            <td colspan="2">
              <div align="left">
                <strong>Study&nbsp;Leave Joining Details</strong>
              </div>
            </td>
          </tr>
          <tr class="table">
            ...
            <td>
              <div align="left">
                 <textarea  name="txtInstLocation" id="txtInstLocation"
                         rows="4" cols="40"  readonly="readonly" class="disab"  ></textarea>
        ...
        <tr class="tdTitle">
            <td colspan="2">
              <div align="left">
                <strong><strong>Study&nbsp;Leave Completion</strong>
                   Details</strong>
              </div>
            </td>
          </tr>
