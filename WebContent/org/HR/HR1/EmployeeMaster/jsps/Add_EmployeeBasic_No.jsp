...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Add_EmployeeBasic_No_JS.js"></script>
                ...
                <td colspan="2">
                  <div align="left">
                    <input type="text" name="Gpf_Number" maxlength="5"
                           size="10" onkeypress="return  numbersonly1(event,this)" />
                  </div>
                </td>
              </tr>
              <tr>
                <td colspan="4" class="tdH" align="right">
                  <input type="Button" value="Add" name="cmdSub"
