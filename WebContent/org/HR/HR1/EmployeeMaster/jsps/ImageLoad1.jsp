    ...
    //ConnectionString = strdsn.trim() + "@" + strhostname.trim() + ":" + strportno.trim() + ":" +strsid.trim() ;
     ...
     connection=DriverManager.getConnection(ConnectionString,strdbusername.trim(),strdbpassword.trim());
                            ...
                            fileName=fileName;
                              ...
                              ps1=connection.prepareStatement(sql1);
                               ps1.setString(1,Emp);
                                ...
                                if(i==0)
                                {
                                  ...
                                  String sql2="insert into HRM_EMP_ADDL_DETAILS(employee_id,EMP_PHOTO_FILE_NAME) values(?,?)";
                              ...
                              {
                                  String sql="update HRM_EMP_ADDL_DETAILS  set EMP_PHOTO_FILE_NAME=? where Employee_Id=?";
...
session.removeAttribute("Emp");
 ...
 String message=err+"Your Photo has been Uploaded<br>";
  String url="../../../../Library/jsps/Messenger.jsp?message=" + message + "&button=ok";
  response.sendRedirect(url);
