...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/TestsPassed.js"></script>
    <%
                    ...
                    <table cellspacing="2" cellpadding="3" border="1"
                      ...
                      <tr class="tdH">
                        <th align="center" colspan="2">
                          <div align="center">
                               Employee's Test Passed Details               </div>
                        </th>
                      </tr>
                      <!-- OFFICE DETAILS -->
                      <% 
            ...
            -->
                  ...
                  <th colspan="2">
                    <div align="left">
                     Employee's Details
                        ...
                        <td width="61%">
                          <div align="left">
                            <input type="text" name="txtEmployeeid"
                                   ...
                                   onkeypress="return numbersonly1(event,this);" onblur="checkempid()"/>
                      ...
                      <tr class="tdH">
                        <th align="center" colspan="2">
                          <div align="left">
                              Department Test Passed Details               </div>
                        </th>
                      </tr>
                      <tr class="table">
                        <td width="39%">
                          <div align="left"> Test Serial No</div>
                        </td>
                        <td width="61%">
                          <div align="left">
                         <!--   <input type="text" name="txtSNO" id="txtSNO"
                                   ...
                                   style="background-color: #ececec"/>&nbsp;(System
                                                                      Generated)-->
                                                                      <input type="text" name="Slno" maxlength="5" size="5" readonly="readonly"
                      ...
                      <tr class="table">
                        <td width="39%">
                          <div align="left"> Tests Code</div>
                        </td>
                         <td width="61%">
                    <div align="left">
                      <select size="1" name="TestCode" id="TestCode" >
                        <option value="">- Select Dept Test Name -</option>
                      <%
                      try
                      {
                       ps=connection.prepareStatement(" select test_code,test_name from hrm_mst_dept_test");
                       results=ps.executeQuery();
                         while(results.next()) 
                         {
                         %>
                            <option value=<%=results.getString("test_code")%>><%=results.getString("test_name")%></option>
                    ...
                    ps.close();
                      ...
                      <tr class="table">
                        <td width="39%">
                          <div align="left"> Date of Exam</div>
                        </td>
                        <td align="left">
                             <input type="text" name="DateExam"
                                   id="DateExam" maxlength="10" size="10"
                            ...
                            <img id="fromimg"
                                 ...
                                 onclick=" showCalendarControl(document.EmpTest.DateExam);"
                                 alt="Show Calendar"></img>
                       </td>
                        <tr class="table">
                        <td width="39%">
                          <div align="left">Effect from Date</div>
                        </td>
                        <td width="61%" align="left">
                          
                             
                            <input type="text" name="EffectDate"
                                   id="EffectDate" maxlength="10" size="10"
                                   onfocus="javascript:vDateType='3';return checkempid();"
                                   onblur="return checkdt(this);"
                                   onkeypress="return calins(event,this);"
                            ...
                            <img id="fromimg"
                                 src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.EmpTest.EffectDate);"
                                 alt="Show Calendar"></img>
                             </td>
                        ...
                        <td colspan="2">
                          <div align="center">
                            ...
                            <table id="mytable" align="center" cellspacing="3"
                              ...
                              <tr class="tdH">
                                <th align="LEFT" colspan="13">Existing 
                                                              Details</th>
                              </tr>
                              <tr class="tdH">
                                <th>Select</th>
