      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbReason" id="cmbReason"
                        onchange="check_SAN();enableReason(this.value);" onfocus="return checkEID();">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" cols="50" rows="4" onfocus="return checkEID();" onkeypress="return noEnter(event)"></textarea>
              </div>
            </td>
          </tr>
