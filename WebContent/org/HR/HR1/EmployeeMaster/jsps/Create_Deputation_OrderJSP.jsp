...
<html>
  <head>  
      ...
      <script type="text/javascript" src="../scripts/Create_Deputation_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Create Deputation Order Details</title>       
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Create Deputation Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Create_Deputation_OrderServ?Command=Insert">                
          ...
          <tr class="table">
            <td>
              <div align="left">Deputation Proceeding Id</div>
            </td>
            <td>
              <div align="left">
          ...
          <td>
          <div align="left">
          <input type="text" name="txtT_OffId" id="txtT_OffId" maxlength="2" size="5" onchange="doFunction('dept','null');"/>
           <img src="../../../../../images/c-lovi.gif" width="20" 
