...
<html>
  <head>
  <title>ADDITIONAL CHARGE DETAILS</title>
  ...
  %>
      ...
      <div align="center">
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                ...
                <tr class="table">
                  ...
                  <td>
                    <div align="left">
                    <select name="cmbsgroup" id="cmbsgroup"  disabled="disabled" onchange="getDesignation()">
        ...
        %>
                  ...
                  <tr>
                                                ...
                                                <td class="table" align="left">
                                                 <input type="radio"
                                                      ...
                                                      Normal&nbsp;
                                                      <input type="radio"
                                                             value="Selection" disabled="disabled"
                                                             name="Office_Grade" ></input>
                                                      Selection&nbsp;
                                                      <input type="radio"
                                                      ...
                                                      Special
                                                       <input type="radio"
                                                             value="Super Grade" disabled="disabled"
                                                             name="Office_Grade" ></input>
                                                      Super Grade
                ...
                <td class="table">
                    <div align="left">
                     <select id="cmbstatus" name="cmbstatus" onchange="changeStatus()" disabled="disabled">
               ...
               <div id="divwork" style="display:none">
                ...
                <table cellspacing="2" cellpadding="3" border="1" width="100%">
                 <tr class="table" align='left'>
                  <td colspan="2" class="tdH">As per Current Posting</td>
                </tr>
                <tr class="table">
                  <td colspan="2">
                    <div align="left">
                      <table cellspacing="2" cellpadding="3" border="1"   width="100%">
                        <tr class="table">
                          ...
                          <td>
                          <div align="left">
                          <input type="text" name="txtDept_Id_work"  id="txtDept_Id_work" maxlength="6" value="TWAD" disabled="disabled"></input>&nbsp;
                  ...
                  <td>
                    ...
                    <!--  <img id="fromimg" src="../../../../../images/calendr3.gif"
                      ...
                      <input type="radio" value="AN" name="optWorkDateFrom"
                             id="optWorkDateFrom2" disabled="disabled"></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
                <tr class="table" id="wing" style="display:none"   >
                          ...
                          <td>
                            <select name="cmbWing"  disabled="disabled">
                 ...
                 <tr class="table">
                          ...
                          <td>
                            <textarea name="txtworkremark" rows=2 cols="50"  disabled="disabled"></textarea>
                          </td>
                        </tr>
                      </table>
                    </div>
        ...
        %>
              ...
              <!--  Compulsary Wait  -->  
               ...
               <div id="divwork1">
                ...
                <table cellspacing="2" cellpadding="3" border="1" width="100%">
                 <tr class="table" align="left">
                  <td colspan="2" class="tdH">Additional Charge Details</td>
                </tr>
                ...
                <tr class="table">
                  <td colspan="2">
                    <div align="left">
                      ...
                      <tr class="table">
                          <td>
                            <div align="left">Addl Charge SlNo: 
                        </div>
                          </td>
                          <td>
                          <div align="left">
                          <input type="text" name="txtSlno1"  id="txtSlno1" maxlength="6"  readonly style=" background-color: #ececec">(Systems Generated)</input>&nbsp;
                  ...
                  <td>
                    <div align="left">
                      Addl. Charge Post<font color="#e70000">*</font>
                    </div>
                  </td>
                  <td>
                    <div align="left">
                    <select name="cmbsgroup1" id="cmbsgroup1" onfocus="checkempid()" onchange="getDesignation1()">
                <option value="0">Select Service Group</option>
                        <%
          rs=null;
           try
        ...
        %>
                    ...
                    <!---  designation -->
                      <select name="cmbDesignation1" id="cmbDesignation1"  
                              onclick="if(checkempid()==true)return checkGroup1();" >
                        <option value="0"></option>
                ...
                <tr>
                        ...
                        <tr class="table">
                          ...
                          <td>
                          <div align="left">
                          <input type="text" name="txtDept_Id_work1"  id="txtDept_Id_work1" maxlength="6" value="TWAD" readonly style=" background-color: #ececec"></input>&nbsp;
                        ...
                        <tr class="table">
                          ...
                          <td>
                          <div align="left"><!--onkeypress="return numbersonly1(event,this);"-->
                          <input type="text" name="txtOffice_Id1"                                          
                                         id="txtOffice_Id1" 
                                         onchange="return doFunction('Load1',true)"
                                         onfocus="checkempid()"
                                         onkeypress="return numbersonly1(event,this);"
                                         maxlength="4"></input>&nbsp;
    <img src="../../../../../images/c-lovi.gif" width="20" height="20" alt="Office_List" onclick="if(checkempid()==true){jobpopup();}">
                        </div>
                        ...
                        <tr class="table">
                          ...
                          <td>
                            <input type="text" name="txtOffice_Name1"
                                   id="txtOffice_Name1"
                                   style="background-color: #FFFFFF"
                                   disabled="disabled" size="30"></input>
                          </td>
                        ...
                        <tr class="table">
                          ...
                          <td>
                            <textarea cols="40" rows="4"  name="txtOffice_Address11"
                                   id="txtOffice_Address11"
                                   style="background-color: #FFFFFF"
                                   disabled="disabled" ></textarea>
                          </td>
                        </tr>
                  ...
                  <td>
                    <div align="left">
                      <input type="text" name="txtWorkDateFrom1" id="txtWorkDateFrom1"
                             maxlength="10" size="10"
                             onfocus="javascript:vDateType='3';return checkempid();"
                             onblur="return checkdt(this);"
                             onkeypress="return calins(event,this);"/>
                      ...
                      <img id="fromimg" src="../../../../../images/calendr3.gif"
                           onclick=" if(checkempid()==true)showCalendarControl(document.frmCurrentPosting.txtWorkDateFrom1);"
                           alt="Show Calendar"></img>
                       
                      <input type="radio" value="FN" checked="checked"
                             name="optWorkDateFrom1" id="optWorkDateFrom11"
                             onclick="return checkempid();"></input>
                       FN&nbsp; 
                      <input type="radio" value="AN" name="optWorkDateFrom1"
                             id="optWorkDateFrom21" onclick="return checkempid();"></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
                
                <tr class="table" id="wing1" style="display:none">
                          <td>
                            Wing
                          </td>
                          <td>
                            <select name="cmbWing1">
                            <option value="0">Select Wing</option>
                            </select>
                          </td>
                 </tr>
                 ...
                 <tr class="table">
                          ...
                          <td>
                            <textarea name="txtworkremark1" title="Don't type '&' Character while entering the remarks" rows=2 cols="50" ></textarea>
                          </td>
                        </tr>
                      </table>
                    </div>
                ...
                <tr class="table">
                  <td colspan="2" class="tdH">
                    ...
                    <input type="button" name="cmdedit" value="Validate" id="cmdedit"
                        ...
                        <td>
                      <input type="button" name="cmdedit" value="Add Post" id="cmdedit"
                             onclick="doFunction('AddPost','null')" />
                       </td>
                       <td> 
