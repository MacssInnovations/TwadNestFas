...
<html>
  <head>
    ...
    <title>Emp_Nomination_Revalid_GtyJSP</title>
    ...
    <script type="text/javascript" src="../scripts/Emp_Nomin_Revalid_GtyJs.js"></script>
    <%
  ...
  <form name="EMP_NOMINEE" id="EMP_NOMINEE">
      <div class="tab-pane" id="tab-pane-1">
        <div class="tab-page">
          <h2 class="tab">Nomination Details</h2>
  ...
  // int empid=11263;
   ...
   %>
                        ...
                        <td width="61%">
                          ...
                          <div align="left">
                            <select size="1" id="member" name="member"
                                    ...
                                    onclick="checkempid()">
                              <option>- Select the Nominee Name-</option>
                            </select>
                        ...
                        <td width="61%">
                          <div align="left">
                            <input type="text" name="Nominee_address1"
                                   maxlength="30" size="30" onclick="checkage()"
                                   disabled="disabled"/>
                          </div>
                        </td>
                      </tr>
                  ...
                  <td>
                    <div align="left">
                      ...
                      <tr class="table">
                        ...
                        <td width="61%">
                          <div align="left">
                            <input type="text" name="Nominee_Pecentshare"
                                   maxlength="5" size="5"
                                   onkeypress="return numbersonly1(event,this);"
                        ...
                        <td colspan="2">
                          <div align="center">
                            ...
                            <table id="mytable" align="center" cellspacing="3"
                              ...
                              <tr class="tdH">
                                <th align="LEFT" colspan="13">Existing Service
                                                              Details</th>
                              </tr>
                              <tr class="tdH">
                                 <th>Select</th>
                              ...
                              <tr class="tdH">
                                ...
                                <td align="center">
                                 ...
                                 <input type="button" name="submit" value="Submit"
                                         ...
                                         />
                                <input type="button" value="Revalidate" name="Validate" id="Validate" onclick="doFunction('Validate','null');"/>
                                  </input>
        ...
        <div class="tab-page" >
          <h2 class="tab">Other Funds Details</h2>
           
          <div align="center" >
            <table width="100%" cellspacing="2" cellpadding="3" border="0">
              <tr class="table">
                <td width="43%">&nbsp;Provident Fund</td>
                <td width="57%">
                  <input type="radio" name="pf" value="yes" checked="checked"/>
                  Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" name="pf" value="no"/>
                  No
                </td>
              </tr>
              <tr class="table">
                <td width="43%">&nbsp;Graduity</td>
                <td width="57%">
                <input type="radio" name="gf" value="yes" checked="checked"/>
                  Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" name="gf" value="no"/>
                  No
                </td>
              </tr>
              <tr class="table">
                <td width="43%"> Insurance
                </td>
                <td width="57%">
                <input type="radio" name="inf" value="yes" checked="checked"/>
                  Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input type="radio" name="inf" value="no"/>
                  No
                </td>
              </tr>
            </table>
