...
<html>
  ...
  <title>HRE_EMPLOYEE_SERVICE_DETAILS</title>
    ...
    <script type="text/javascript"     src="../scripts/CurrentPostingDeleteJS.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>DELETE CURRENT POSTING DETAIL</b>
                  </th>
                </tr>
                  ...
                  <td>
                    <div align="left">
                      <input type="text" name="txtEmployeeid" id="txtEmployeeid"
                             maxlength="5" size="5"
                             onchange=" doFunction('loadempdelete','null');"
                ...
                <tr class="table">
                  ...
                  <tr>
                                                ...
                                                <td class="table" align="left">
                                                 ...
                                                 <input type="text"  name="Office_Grade"  size=15 disabled></input>
                  ...
                  <td>
                    <div align="left">
                    <input name="cmbDesignation" id="cmbDesignation" size=40 disabled>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <td class="table">
                    <div align="left">
                     <input  id="cmbstatus" name="cmbstatus" size=20 disabled>
                      <input  id="txtstatus" name="cmbstatus" size=20 type="hidden">
               ...
               <div id="divwork" style="display:none">
                ...
                <tr class="table">
                    ...
                    <div align="left">
                      <table cellspacing="2" cellpadding="3" border="1"   width="100%">
                        <tr class="table">
                          ...
                          <td>
                          <div align="left">
                          <input type="text" name="txtDept_Id_work"  id="txtDept_Id_work" maxlength="6" value="TWAD" disabled></input>&nbsp;
                        ...
                        <tr class="table">
                          ...
                          <td>
                            <input type="text" name="txtOffice_Address1"
                                   id="txtOffice_Address1"  disabled="disabled" size="60"></input>
                          </td>
                        </tr>
                        <tr class="table">
                          <td>
                          ...
                          <td>
                            <input type="text" name="txtOffice_Address2"
                                   id="txtOffice_Address2" disabled="disabled" size="60"></input>
                          </td>
                        </tr>
                        <tr class="table">
                          <td>
                          ...
                          <td>
                            <input type="text" name="txtOffice_City"
                                   id="txtOffice_City"  disabled="disabled" size="30"></input>
                  ...
                  <td>
                    <div align="left">
                      <input type="text" name="txtWorkDateFrom" id="txtWorkDateFrom"
                             ...
                             onkeypress="return calins(event,this);" disabled/>
                       
                                          
                      <input type="radio" value="FN" checked="checked"
                             name="optWorkDateFrom" id="optWorkDateFrom1" disabled
                             ></input>
                       FN&nbsp; 
                      <input type="radio" value="AN" name="optWorkDateFrom" disabled
                             id="optWorkDateFrom2" ></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
                 <tr class="table">
                          ...
                          <td>
                            <textarea name="txtworkremark" rows=2 title="Don't type '&' Character while entering the remarks" cols="50" disabled ></textarea>
                          </td>
                        </tr>
                      </table>
                    </div>
                ...
                <tr class="table">
                    ...
                    <div align="left">
                      <table cellspacing="2" cellpadding="3" border="1"   width="100%">
                        <tr class="table">
                         ...
                         <select name="txtDept_Id"  id="txtDept_Id" onchange="checkdeptsel()" disabled >
                        ...
                        <tr class="table">
                          ...
                          <td>
                            <input type="text" name="txtOthOffice_Name"
                                   id="txtOthOffice_Name"  disabled="disabled" size="30"></input>
                          </td>
                        </tr>
                        <tr class="table">
                          <td>
                          ...
                          <td>
                            <input type="text" name="txtOthOffice_Address1"
                                   id="txtOthOffice_Address1"  disabled="disabled" size="60"></input>
                          </td>
                        </tr>
                        <tr class="table">
                          <td>
                          ...
                          <td>
                            <input type="text" name="txtOthOffice_Address2"
                                   id="txtOthOffice_Address2"  disabled="disabled" size="60"></input>
                          </td>
                        </tr>
                        <tr class="table">
                          <td>
                          ...
                          <td>
                            <input type="text" name="txtOthOffice_City"
                                   id="txtOthOffice_City"   disabled="disabled" size="30"></input>
                  ...
                  <td>
                    <div align="left">
                      ...
                      <input type="radio" value="FN" checked="checked" disabled
                             name="optDepDateFrom" id="optDepDateFrom1"
                             ></input>
                       FN&nbsp; 
                      <input type="radio" value="AN" name="optDepDateFrom" disabled
                             id="optDepDateFrom2" ></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
                      <tr class="table">
                          ...
                          <td>
                            <textarea name="txtDepremark" rows=2 cols="50" disabled ></textarea>
                          </td>
                        </tr>   
                      </table>
                    </div>
                    ...
                    <div align="left">
                      <table cellspacing="2" cellpadding="3" border="1"   width="100%">
                        <tr class="table">
                          ...
                          <td>
                          <div align="left">
                         <select name="cmbleavetype"  id="cmbleavetype" disabled >
        ...
        %>
                  ...
                  <td>
                    <div align="left">
                      ...
                      <input type="radio" value="AN" name="optDateFrom"
                             id="optDateFrom2" disabled></input>
                       AN&nbsp;
                    </div>
                  </td>
                </tr>
               ...
               -->
                       <tr class="table">
                          ...
                          <td>
                            <textarea name="txtleaveremark" rows=2 cols="50" disabled ></textarea>
                          </td>
                        </tr>
                ...
                <tr class="table">
                          ...
                          <td>
                            <textarea name="txtsusreson" rows=2 cols="50" disabled></textarea>
                          </td>
                        </tr>
                    <!--   <tr class="table">
                          <td>
                  ...
                  <td>
                    <div align="left">
                      ...
                      <tr class="table">
                          ...
                          <td>
                            <textarea name="txtabsremark" rows=2 cols="50" disabled ></textarea>
                          </td>
                        </tr>
                        </table>
                    </div>
                ...
                <tr class="table">
                  <td colspan="2" class="tdH">
                    ...
                    <tr>
                        <td>
                      <input type="button" name="cmdedit" value="Delete" id="cmdedit"
