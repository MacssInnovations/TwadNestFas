...
<html>
  <head>
    ...
    <title> Validate Employee Relieval Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Validate_New_Relieval_Details.js"> </script>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_New_Relieval_Serv.view?Command=Add&_status=FR"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Validate Employee Relieval Details</strong>
              </div>
            </td>
          </tr>
          </table>
          ...
          <tr class="table">
                ...
                <div id="bghead" class="tdH">
                   <center>  
 <input type="SUBMIT" name="butSub" id="butSub" value="Validate" />
                 &nbsp;&nbsp;&nbsp; 
