                            ...
                            //fileName=fileName;
                              ...
                              ps1=connection.prepareStatement(sql1);
                               ps1.setString(1,Emp);
                                ...
                                String sql3="select emp_photo_file_name from HRM_EMP_ADDL_PHOTO_NEW_TMP where employee_id=?";
                              ...
                              {
                                  String sql="update HRM_EMP_ADDL_PHOTO_NEW_TMP  set EMP_PHOTO_FILE_NAME=?,UPDATED_BY_USER_ID=?,UPDATED_DATE=?,PROCESS_FLOW_STATUS_ID=? where Employee_Id=?";
...
session.removeAttribute("Emp");
 ...
 String url="../../../../Library/jsps/Messenger2.jsp?message=" + message + "&button=ok";
