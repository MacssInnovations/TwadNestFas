...
<html>
  <head>
    ...
    <title> Delete The Deputation Completion Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Edit_DPNRelieval_Details.js"> </script>
  ...
  <form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_DPNRelieval_serv.view?Command=Delete&cmbStatus=DL"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          ...
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Delete The Deputation Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
        ...
        <tr class="tdTitle">
            <td colspan="2">
              <div align="left">
                <strong><strong>Deputation Completion</strong>
                   Details</strong>
              </div>
            </td>
          </tr>
