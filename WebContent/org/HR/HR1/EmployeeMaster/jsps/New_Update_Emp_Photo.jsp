  ...
  <head>
    ...
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
                       ...
                       <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
                        ...
                        <script type="text/javascript" src="../scripts/New_UpdateEmployee_Details_11.js"></script>
    ...
    alert("Please select the Photo file first");
        ...
        if(check())
        ...
        
            {
                ...
                //alert(empid);
                document.frmimageupload.action="../jsps/ImageLoad11.jsp?empidp="+empid;
                document.frmimageupload.method="post";
                document.frmimageupload.submit();
           }
        }
                                          ...
                                          <tr>
                                                ...
                                                <td colspan="2">
                                                      <input tabindex="1"
                                                             ...
                                                             onchange="callFunction('ExistgBasic','null')" onblur="toFocus()"></input>
                                                      <input tabindex="1"
                                                             type="HIDDEN"
                                                             name="EmpId"
                                                             id="EmpId"></input>
