...
<html>
  <head>
    ...
    <title> Validation Of Study&nbsp;Leave Completion Details</title>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_STURelieval_serv.view?Command=Add&_status=FR"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Validation Of Study&nbsp;Leave Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtOffName" id="txtOffName"
                       ...
                       readonly="readonly" class="disab"  readonly="readonly"/>
              </div>
            </td>
          </tr>
          <tr class="table">
      ...
      <!--    <tr class="table">
        ...
        <tr class="tdTitle">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" cols="50" rows="4" 
