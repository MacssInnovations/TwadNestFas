...
<html>
  <head>
    ...
    <title>Validate Employee's Additional&nbsp;Details </title>
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    
                       <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
                        <script type="text/javascript" src="../scripts/ReValidationEmployee2.js"></script>
                        <script type="text/javascript" src="../scripts/New_ReValidate_Employee_DetailsScript.js"></script>
                        <script type="text/javascript" src="../scripts/ReNew_UpdateEmployeeScript.js"></script>
                  ...
                  // alert(OfficeId);
                                          ...
                                          <tr>
                                                ...
                                                <td colspan="2">
                                                      <input tabindex="1"
                                                             ...
                                                             onchange="callFunction('ExistgBasic','null')"></input>
                                                      <input tabindex="1"
                                                             type="HIDDEN"
                                                             name="EmpId"
                                                             id="EmpId"></input>
                          ...
                          <option value="999">Others</option>
                                      ...
                                      %>  
                                          ...
                                          <tr>
                                                ...
                                                <td colspan="2">
                                                      <select name="Post_Status" onfocus="return toFocus()">
                        ...
                        %>
                                            ...
                                            <tr id="divprobation" style="display:none" >
                                                ...
                                                <td colspan="2">
                                                   <input type="radio" name="optprobation" value="Y" onclick="clickProbation()">Yes <input type="radio" name="optprobation" value="N" onclick="clickProbation()">No
                                                </td>
                                          </tr>       
                            ...
                            %>
                                      ...
                                      %>                          
                                          ...
                                          <tr>
                                    <td colspan="2" class="tdH">Record Status<label style="color:rgb(255,0,0);"/></td>
                                       ...
                                       <input type="text"
                                          ...
                                          <tr>
                                                <td colspan="4" class="tdH"
                                                    align="right">
                                                      <input type="button"
                                                             value="ReValidate" name="cmdUpdate" id="cmdUpdate" onclick=" callUpdateFunction('toValidate','null')"></input>
                                                      &nbsp;
                                                      <input type="Button"
                                                             value=" Cancel "
                                                             name="cmdCancel"
