...
<html>
  <head>
    ...
    <title> Validate Employee Service Particulars</title>
    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
<script type="text/javascript"     src="../scripts/HRE_EmployeeServiceValidateJS.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b> Validate Employee Service Particulars</b>
                  </th>
                </tr>
              ...
              <table align="center" cellspacing="3" cellpadding="2" border="1"
                ...
                <tr class="tdH">
                  <td>
                    <div align="center">
                     <input type="button" name="cmdchkgap" value="Validate & Freeze"
