...
<html>
  <head>
    ...
    <title> Updation Of Employee's Service Particulars</title>
    ...
    <%
     ...
     {
     %>
    <script type="text/javascript"     src="../scripts/HRE_EmployeeServiceDetailsAdminJS.js"></script>
     <%}else{%>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b> Updation Of Employee's Service Particulars</b>
                  </th>
                </tr>
                <!-- OFFICE DETAILS -->
                <% 
  ...
  // int empid=11263;
   ...
   %>
            ...
            -->
                ...
                <tr class="tdH">
                  <th colspan="2">
                    <div align="left">Service Details</div>
                  </th>
                </tr>
                <tr class="table">
                  <td>
                    <div align="left">Service&nbsp;List&nbsp;Sl. No.</div>
                  </td>
                  <td>
                    <div align="left">
                      <input type="text" name="txtSNo1" id="txtSNo1" maxlength="5"                           size="5" readonly="readonly"
                             style="background-color: #ececec"/>&nbsp;(System
                                                                Generated)
                         <input type="hidden" name="txtSNo" id="txtSNo" maxlength="5"
                             size="5" />
                    </div>
                  </td>
                </tr>
                  ...
                  <td>
                    <div align="left">
                      <select name="cmbStatus" id="cmbStatus"
                              onfocus="return checkempid();" onchange="changeempstatus();getDeptId();">
                        <option value="0">Select Place</option>
                        <%
           //ResultSet rs=null;
           try
           {
           ps=connection.prepareStatement("select EMPLOYEE_STATUS_ID,EMPLOYEE_STATUS_DESC from HRM_MST_EMPLOYEE_STATUS  order by EMPLOYEE_STATUS_DESC");
            rs=ps.executeQuery();
            String strcode="";
            String strname="";           
            while(rs.next())
            {
                ...
                strcode=rs.getString("EMPLOYEE_STATUS_ID");
                strname=rs.getString("EMPLOYEE_STATUS_DESC");
        ...
        %>
            ...
            <!--    <tr class="table">
                ...
                <!-- offic structure starting -->
                <tr class="table">
                  <td colspan="2" id="divoffice" style="display:none">
                    <div align="left">
                       ...
                       finally
                      {
                        ...
                        <!-- <input type="text" name="txtDept_Id"  id="txtDept_Id" maxlength="6" disabled="disabled"></input>&nbsp;-->
                         <select name="txtDept_Id" id="txtDept_Id"
                              onclick="if(checkempid()==true)return checkDept();">
                        <option value="0"></option>
                        ...
                        <tr class="table">
                          ...
                          <input type="text" name="txtOffice_Id"
                                         ...
                                         id="txtOffice_Id" 
                                         onchange="return callServer1('Load1','null')"
                                         onfocus="if(checkempid()==true)return checkdeptid();"
                                         onkeypress="return numbersonly1(event,this);"
                                         maxlength="4"></input>&nbsp;<img src="../../../../../images/c-lovi.gif" width="20" height="20" alt="Office_List" onclick="if(checkempid()==true){if(checkdeptid()==true)jobpopup();}">
                        </div>
                        ...
                        <tr class="table">
                          ...
                          <td>
                              ...
                              <textarea cols="40" rows="4" name="txtOffice_Address1"    id="txtOffice_Address1"
                                   style='background-color: #FFFFFF'
                ...
                <tr class="table">
                  ...
                  <td>
                    <div align="left">
                      <!--<input type="text" name="txtRemark" id="txtRemark"
                             maxlength="50" size="66" onfocus="trm(this);return checkempid();"/>-->
                          <textarea cols="50" rows="2"  name="txtRemark" id="txtRemark"
                              onfocus="trm(this);return checkempid();"></textarea>
                    </div>
                  </td>
                </tr>
                <tr class="table">
                  <td colspan="2">
                    ...
                    <tr>
                     ...
                     <!-- <input type="button" name="cmdlist" value="LIST ALL"
                        ...
                        <td>
                      <input type="button" name="cmdchkgap" value="Verify Data"
                             id="cmdchkgap" onclick="if(checkempid()==true)doFunction('Interval','null')"/>
