...
<html>
  <head>
  <title>EDIT&nbsp;CUT-OFF&nbsp;DATE CURRENT POSTING DETAIL</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/CurrentPostingEditJS.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>EDIT&nbsp;CUT-OFF&nbsp;DATE CURRENT POSTING DETAIL</b>
                  </th>
                </tr>
