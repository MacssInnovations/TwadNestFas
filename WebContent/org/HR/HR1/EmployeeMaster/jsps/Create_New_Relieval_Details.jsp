...
<html>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>
    <title> Creation Of Employee Relieval Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Create_New_Relieval_Script.js"> </script>
   ...
   %>
        ...
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3> Creation Of Employee Relieval Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
     <form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Create_New_RelievalServlet.view?Command=Add&cmbStatus=CR"
              onsubmit="return checkNull()">               
              
                <div class="tab-pane" id="tab-pane-1" >
                    <div class="tab-page">
                        <h2 class="tab">Relieval Details</h2>
                        <div align="center">
          ...
          <tr class="tdTitle">
            <td colspan="2">
              <div align="left">
                <strong>Select the Reason</strong>
              </div>
            </td>
          </tr>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
              <!--doFunction('Suspension',null);-->
                <select size="1" name="cmbReason" id="cmbReason"
                        onchange="disab_Element();check_SAN();enableReason(this.value);getFunction();" onblur="getReason()">
              ...
              <tr align="left" class="tdTitle">
            <td colspan="2">
              <strong>Proceeding Details</strong>
            </td>
          </tr>
          <tr class="table">
            <td colspan="2">
              <div align="left">
                <input type="text" name="txtReason" id="txtReason" maxlength="30"
                       size="30" readonly="readonly"/>&nbsp;&nbsp;&nbsp;Order Details                       
              </div>
            </td>
          </tr>
          <tr class="table">
            ...
            <td>
              <div align="left">                
                <select name="cmb_proc_no" id="cmb_proc_no" onchange="displaydet()">
                <option value="0">--Select Proceeding No.--</option>
                </select>                       
              </div>
            </td>
          </tr>
          ...
          <td>
              <div align="left">
               <input type="text" name="txtRDat" id="txtRDat"
                       maxlength="10" size="11"
                       onfocus="javascript:vDateType='3';"
                       onkeypress="return calins(event,this);"
                       onblur="if(checkcurdt(this)==true)return checkdt(this);" readonly="readonly"/>
                 
                <!--<img src="../../../../../images/calendr3.gif"
                     onclick=" if(checkEID()==true)showCalendarControl(document.EmpRelieval.txtRDat);"
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                ...
                <img src="../../../../../images/c-lovi.gif" width="20" id="img_emp"
                     height="20" alt="empList" onclick="servicepopup();"></img>
                     
                 <select name="cmb_EmpId" id="cmb_EmpId" onchange="displayEmployees();doFunction('loademp','null');getOther();">
          ...
          <!--<tr class="table">
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbReason" id="cmbReason"
                        onchange="check_SAN();enableReason(this.value);doFunction('Suspension',null);checkProced();" onfocus="return checkEID();" onblur="getReason()">
                  <option value="">Select Reason</option>
                  <%
                try
                {
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" title="Don't type '&' Character while entering the remarks" cols="50" rows="4" onfocus="return checkEID();"></textarea>
              </div>
            </td>
          </tr>
              ...
              <div id="Reason1" style="display:none">
                <table cellspacing="3" cellpadding="2" border="1" width="100%">
                 ...
                 <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="TRN_desigId" id="TRN_desigId" onchange="doFunction('desig','null');"
                               onkeypress="return numbersonly1(event,this);"
                               maxlength="3" size="4" readonly="readonly"/>
                         
                        <!--<img src="../../../../../images/c-lovi.gif" width="20"
                             height="20" alt="OfficeList"
                  ...
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="TRN_DesigName" id="TRN_DesigName" 
                                maxlength="60" size="60"
                               readonly="readonly" class="disab"/>
                      </div>
                    </td>
          ...
          <tr align="left" class="tdH">
            <td colspan="2">
              <strong>Relieval Proceeding Details</strong>
            </td>
          </tr>
          <tr class="table">
            <td>
              <div align="left">
                Relieval Proceeding No
                <font color="#ff2121">*</font>
              </div>
            </td>
            <td>
              <div align="left">
                <input type="text" name="txtPNo" id="txtPNo" maxlength="40"
                       size="38" />  
                <select name="cmb_relproc_no" id="cmb_relproc_no" onchange="displaydetails()">
                <option value="0">--Select Proceeding No.--</option>
                <%
                
                   String pro_no="";
                   
                  ps=con.prepareStatement("select distinct PROCEEDING_NO from HRM_EMP_RELIEVAL_DETAILS where OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') and PROCEEDING_NO is not null");
                  ps.setInt(1,oid);
                  results=ps.executeQuery();
                   
                  while(results.next()) 
                  {
                    pro_no=results.getString("PROCEEDING_NO");                    
                  
                %>   
                   <option value="<%=pro_no%>"><%=pro_no%></option>  
                   <%
                   }
                   %>
                   </select>
          ...
          <tr class="table">
                    <td>
                      <div align="left">Relieval Proceeding
                                        Date </div>
                    </td>
                    <td>
                      <div align="left">
