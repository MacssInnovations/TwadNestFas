...
<html>
  <head>
    ...
    <title>Employees Qualification Details</title>
  ...
  <meta http-equiv="Pragma" content="no-cache">
    ...
    <script type="text/javascript"     src="../scripts/Qualification.js"></script>
    <%
              ...
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  <th align="center" colspan="2" >
                    <div align="center">
                      Employee's Qualification Details 
                    </div>
                  </th>
                </tr>
                <!-- OFFICE DETAILS -->
            ...
            -->
                ...
                <tr class="tdH">
                 ...
                 <tr class="table">
                  ...
                  <td width="61%">
                    <div align="left">
                      <select size="1" name="Qualification" id="Qualification" >
                        <option value=0>- Select the Qualification -</option>
                      <%
                      try
                      {
                       ps=connection.prepareStatement(" select qualification_id,qualification_desc from hrm_mst_edu_qualification");
                       results=ps.executeQuery();
                         while(results.next()) 
                         {
                         %>
                            <option value=<%=results.getInt("qualification_id")%>><%=results.getString("qualification_desc")%></option>
                 ...
                 <tr class="table">
                  ...
                  <td width="61%">
                    <div align="left">
                      <select size="1" name="Special" id="Special" >
                        <option value=0>- Select the Specialisation -</option>
                      <%
                      try
                      {
                       ps=connection.prepareStatement(" select SPECIALISATION_id,SPECIALISATION_DESC from HRM_MST_EDU_SPECIALISATIONS");
                       results=ps.executeQuery();
                         while(results.next()) 
                         {
                         %>
                            <option value=<%=results.getInt("SPECIALISATION_id")%>><%=results.getString("SPECIALISATION_DESC")%></option>
                ...
                <td>
                <div align="left">
                <input type="radio" name="reguniv" id="reguniv" value="Y" >Yes
                <input type="radio" name="reguniv" id="reguniv" value="N" checked>No
                </div>
                </td>
                <td>
              ...
              <table id="mytable" align="center" cellspacing="3" cellpadding="2"
                     border="1" width="100%">
                <tr class="tdH">
                  <th align="LEFT" colspan="12">Existing Employee's Qualification Details</th>
                </tr>
                <tr class="tdH">
                  <th>Select</th>
                   <th>
