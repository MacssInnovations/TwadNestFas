...
<html>
  <head>
    ...
    <title>Edit_Dept_Willingness_DetailsJSP</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
      <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
      <script type="text/javascript"       src="../scripts/CalendarControl.js"></script>
      <script type="text/javascript"       src="../scripts/Validate_Dept_Willingness_DetailsJS.js"></script>
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Validate Deputation Willingness Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
        </table>
        <form name="frmDeptWilling" id="frmDeptWilling">                
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
               <select name="txtPid" id="txtPid" onchange="funclear();doFunction('getDet')">
                ...
                <%
                 ...
                 try
                 {
                 ps1=connection.prepareStatement("select distinct DPN_REF_ID from HRM_EMP_DPN_WILLINGNESS where OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') order by DPN_REF_ID");
                 ps1.setInt(1,oid);
          ...
          <tr class="table">
           <td>
              <div align="left">
                Deputation&nbsp;Reference&nbsp;Letter Date <font color="#ff2121">
                *
              </font>
            </div>
            </td>
          <td>
              <div align="left">
               <input type="text" name="txtdptdate" id="txtdptdate"
                ...
                <img src="../../../../../images/calendr3.gif"
                     onclick="showCalendarControl(document.frmDeptWilling.txtdptdate);"
          ...
          <td>
          <div align="left">
           <select name="cmb_Deptid" id="cmb_Deptid" >
          ...
          <td>
          <div align="left">
           <select name="cmb_DeptOffice" id="cmb_DeptOffice" size="1">
          ...
          <td>
          <div align="left">
          <input type="text" name="txtpostname" id="txtpostname" maxlength="60" size="80">
          </div>
          </td>
          </tr>       
          ...
          <td>
          <div align="left">
          <input type="text" name="txtpayscale" id="txtpayscale" maxlength="100" size="80">
          </div>
          </td>
          </tr>   
          ...
          <td>
          <div align="left">
          <textarea cols="20" rows="7" id="txtremark" name="txtremark"></textarea>
          </div>
          </td>
          </tr>       
            ...
            <td colspan="2">
              <div align="left">
                <strong>Employee Willingness Details</strong>
              </div>
            </td>
          </tr>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtEmployeeid" id="txtEmployeeid"
                       ...
                       onchange="doFunction('loademp','null');"/ disabled>
          ...
          <td>
              <div align="left">
               <input type="text" name="txtPDat" id="txtPDat"
                       ...
                       onfocus="javascript:vDateType='3';  "
                       onkeypress="return calins(event,this);"
                       onblur="if(checkcurdt(this)==true)return checkdt(this);"/ disabled>
                 
                <img src="../../../../../images/calendr3.gif"
                     onclick="showCalendarControl(document.frmDeptWilling.txtPDat);"
                     alt="Show Calendar"></img>
                     </div>
             </td>
            </tr>
             ...
             <tr class="tdTitle">
                  <td colspan="2">
                  <div align="center">
                   <input type="button" name="btadd" id="btadd" value="Add" onclick="doFunction('add')"/>
                   <input type="button" name="btupdate" id="btupdate" value="Update" onclick="doFunction('update')" disabled/>
                   <input type="button" name="btdelete" id="btdelete" value="Delete" disabled onclick="doFunction('delete')"/>
                  ...
                  <td colspan="2">
                  <div align="center">
                   <input type="button" name="btsubmit" id="btsubmit" value="Validate" onclick="fnsubmit()" disabled/>
                   <input type="button" name="btcancel" id="btcancel" value="Cancel" />
