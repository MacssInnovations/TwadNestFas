...
<html>
  <head>
  <title>VALIDATE ADDITIONAL CHARGE DETAILS</title>
   ...
   <!-- <script type="text/javascript" src="../scripts/AjaxOfficeContactId.js"></script>-->
    ...
    <script type="text/javascript"     src="../scripts/ValidateAdditionalCharge.js">     </script>
            ...
            <td>
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  ...
                  <b>VALIDATE ADDITIONAL CHARGE DETAILS</b>
                  </th>
                </tr>
