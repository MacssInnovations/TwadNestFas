...
<html>
  <head>
    ...
    <title> Editing The Employee Relieval Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Edit_New_Relieval_Details.js"> </script>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_New_Relieval_Serv.view?Command=Add&cmbStatus=MD"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Editing The Employee Relieval Details</strong>
              </div>
            </td>
          </tr>
          </table>
        ...
        <div class="tab-pane" id="tab-pane-1" >
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbReason" id="cmbReason"
                        onchange="getFunction();disab_Element();" onblur="getReason()">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                ...
                <select name="cmb_EmpId" id="cmb_EmpId" onchange="getOther();doFunction('loademp','null');">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                ...
                onchange="doFunction('loadReason','null');" maxlength="5" size="6" readonly style="background-color: #ececec"/>
              <!--  <img src="../../../../../images/c-lovi.gif" width="20"
                     height="20" alt="RelievalList" onclick="Relievalpopup();"></img>-->
              </div>
            </td>
          </tr>
          <tr class="table">
          ...
          <tr class="table">
                ...
                <div id="bghead" class="tdH">
                   <center>  
                        <input type="SUBMIT" name="butSub" id="butSub" value="UPDATE" />
                 &nbsp;&nbsp;&nbsp; 
