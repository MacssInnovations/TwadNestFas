...
<html>
  <head>
    ...
    <title>Create_Dept_Willingness_DetailsJSP</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
      <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
      <script type="text/javascript"       src="../scripts/CalendarControl.js"></script>
      <script type="text/javascript"       src="../scripts/Create_Dept_Willingness_DetailsJS.js"></script>
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Deputation Willingness Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
        </table>
        <form name="frmDeptWilling" id="frmDeptWilling">                
            ...
            <td>
              <div align="left">
                <input type="text" name="txtPid" id="txtPid" 
                        maxlength="6" size="12" disabled/>&nbsp;&nbsp;&nbsp;(Auto Generated)      
          ...
          <td>
          <div align="left">
           <select name="cmb_Deptid" id="cmb_Deptid" onchange="doFunction('deptoff')">
          ...
          <td>
             ...
             <tr class="tdTitle">
                  ...
                  <div align="center">
                   ...
                   <input type="button" name="btupdate" id="btupdate" value="Update" onclick="funupdate()"disabled/>
                  ...
                  <td colspan="2">
                  <div align="center">
                   <input type="button" name="btsubmit" id="btsubmit" value="Submit" onclick="fnsubmit()" disabled/>
