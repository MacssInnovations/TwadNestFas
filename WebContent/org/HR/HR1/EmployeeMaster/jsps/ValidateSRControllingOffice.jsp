...
<html>
  <head>
    ...
    <title>Validate Employee SR Controlling Office</title>
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/ValidateSRControllingOffice.js"></script>
                                    ...
                                    <table border="1px" width="650px%" align="center">
                                          <tr>
                                                <td align="center" class="tdH"
                                                    colspan="4">
                                                      <center>
                                                            <b>Validate Employee SR Controlling Office</b>
                                                      </center>
                                                </td>
                                          </tr>
                                          <tr>
                                                ...
                                                <td colspan="4" class="tdH"
                                                    align="right">
                                                      <input type="button" name="cmbValidate" id="cmbValidate"
                                                             value="Validate" onclick="callServer1('Update','null');"></input>
                                                      &nbsp;
