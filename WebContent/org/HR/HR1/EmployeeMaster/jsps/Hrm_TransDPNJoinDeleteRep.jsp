...
<html>
  <head>
    ...
    <title>Delete Deputation Joining Details</title>
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Delete Deputation Joining Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdH">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtOffId" id="txtOffId" maxlength="3" value="<%=oid%>"
                       size="43"  class="disab" readonly readonly="readonly"/>
              </div>
            </td>
          </tr>
          <tr class="table">
         ...
         <tr class="table">
            ...
            <td>
              <div align="left">
              <select name="txtDepId" id="txtDepId" disabled>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
               ...
               -->
               <select name="txtDepOffId" id="txtDepOffId" disabled>
        ...
        -->  
          ...
          <!--  <input type="text" name="txtDOJ" id="txtDOJ" maxlength="10" class="disab" readonly onFocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);"/>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtOffice_Id" id="txtOffice_Id" onchange="doFunction('Load',true)" size="6" maxlength="4" class="disab" readonly/>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtOffice_Name" id="txtOffice_Name" disabled size="30" maxlength="40" class="disab" readonly/>
