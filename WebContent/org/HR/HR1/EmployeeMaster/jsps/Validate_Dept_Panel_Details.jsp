    ...
    <title>Create_Dept_Panel_Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
      ...
      <script type="text/javascript"       src="../scripts/CalendarControl.js"></script>
        ...
        <script type="text/javascript" src="../scripts/Validate_Dept_Panel_DetailsJS.js"></script>
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Validate Deputation Panel Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
        </table>
        <form name="frmDeptPanel" id="frmDeptPanel">                
          ...
          <tr class="tdTitle">
           ...
           <tr class="table">
            ...
            <td>
              <div align="left">
               <select id="dptrefid" name="dptrefid" onchange="doFunction('getDet');doFunction('ProceedDetails')">
              <option value="0">---Select Reference Id---</option>
                <%
                 ...
                 try
                 {
                 ps1=connection.prepareStatement("select distinct DPN_REF_ID from HRM_EMP_DPN_WILLINGNESS where OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by DPN_REF_ID asc");
                 ps1.setInt(1,oid);
          ...
          <tr class="table">
            <td>
              <div align="left">Empanelment Proceeding Id<font color="#ff2121">
                 *
              </font>
            </div>
            </td>
            <td>
              <div align="left">
               <select name="txtPid" id="txtPid" onchange="doFunction('getProcedDet')">
          ...
          <textarea cols="20" rows="7" id="txtrem" name="txtrem"></textarea>
             ...
             <tr class="tdTitle">
                  ...
                  <div align="center">
                   ...
                   <input type="button" name="btupdate" id="btupdate" value="Update" disabled onclick="doFunction('update')"/>
                  ...
                  <td colspan="2">
                  <div align="center">
                   <input type="button" name="btsubmit" id="btsubmit" value="Validate" onclick="fnsubmit()"/>
