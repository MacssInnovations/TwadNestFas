...
<html>
  <head>
    ...
    <title>Emp_Nomination_Valid_GtyJSP</title>
    ...
    <script type="text/javascript" src="../scripts/Emp_Nomin_Valid_Gty.js"></script>
    <%
                              ...
                              <tr class="tdH">
                                ...
                                <td align="center">
                                 ...
                                 <input type="button" name="submit" value="Submit"
                                         ...
                                         />
                                <input type="button" value="Validate" name="Validate" id="Validate" onclick="doFunction('Validate','null');"/>
                                  </input>
