...
<html>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Create_Emp_servlet.view?Command=Add&cmbStatus=CR"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Creation Of Employee Relieval Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtEmployeeid" id="txtEmployeeid"
                       ...
                       onchange="doFunction('loademp','null');" onkeypress="return noEnter(event)"/>
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbReason" id="cmbReason"
                        onchange="check_SAN();enableReason(this.value);doFunction('Suspension',null);checkProced();" onfocus="return checkEID();" onblur="getReason()" onkeypress="return noEnter(event)">
          ...
          <!--<tr class="table">
            <td>
              <div align="left">Proceeding Number</div>
            </td>
            <td>
              <div align="left">
                <input type="text" name="txtProceedingNo" id="txtProceedingNo"
                               onkeypress="return numbersonly1(event,this);"
                               maxlength="50" />
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                ...
                <input type="text" name="txtProceeding_date" id="txtProceeding_date"
                       maxlength="10" size="11"
                       onfocus="javascript:vDateType='3';return checkEID();"
                       onkeypress="return calins(event,this);"
                       onblur="if(checkcurdt(this)==true)return checkdt(this);"/>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtProceedingOfficer" id="txtProceedingOfficer"
                                   maxlength="50" />
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtCopyTo" id="txtCopyTo" title="Don't type '&' Character while entering the remarks" cols="50" rows="4" onfocus="return checkEID();"></textarea>
              </div>
            </td>
          </tr>-->
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" title="Don't type '&' Character while entering the remarks" cols="50" rows="4" onfocus="return checkEID();" onkeypress="return noEnter(event)"></textarea>
              </div>
            </td>
          </tr>
                    ...
                    <td>
                      <div align="left">
                        ...
                        <input type="text" name="txtInst_Name" id="txtInst_Name"
                                maxlength="60" size="40" onkeypress="return noEnter(event)" />
                      </div>
                    </td>
                  </tr>
                 <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtCourse_Name"
                               id="txtCourse_Name" maxlength="40" size="30" onkeypress="return noEnter(event)"/>
                      </div>
                    </td>
                  </tr>
                  <tr class="table">
         ...
         <table cellspacing="3" cellpadding="2" border="1" width="100%">
          ...
          <tr align="left" class="tdH">
            <td colspan="2">
              <strong>Reference Order Details</strong>
            </td>
          </tr>
            ...
            <td colspan="2">
              <div align="left">
                <input type="text" name="txtReason" id="txtReason" maxlength="30"
                       size="30"  onkeypress="return noEnter(event)" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Order Details                       
              </div>
            </td>
          </tr>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtRO" id="txtRO" maxlength="15"
                       size="20" onkeypress="return noEnter(event)" />                       
              </div>
            </td>
          </tr>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtPNo" id="txtPNo" maxlength="40"
                       size="38" onkeypress="return noEnter(event)"/>  
                <select name="cmb_proc_no" id="cmb_proc_no" onchange="displaydetails()">
