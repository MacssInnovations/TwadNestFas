...
<html>
  <head>  
      ...
      <script type="text/javascript" src="../scripts/Create_Promotion_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Create Promotion Order Details</title>       
 ...
 <body class="bodyid" onload="doFunction('getProcid','null');"> 
 <%
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Create Promotion Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Create_Promotion_OrderServ?Command=Insert">                
          ...
          <tr class="table">
            <td>
              <div align="left">Promotion Proceeding Id</div>
            </td>
            <td>
              <div align="left">
