  ...
  try
            {
                   ...
                   //  {
                           // String s=(String)session.getAttribute("Emp");
                            ...
                            ps=connection.prepareStatement("select EMP_PHOTO_FILE_NAME,PHOTO from HRM_EMP_ADDL_PHOTO_NEW_TMP where EMPLOYEE_ID=?" );
                            ps.setInt(1,empid);
                            ...
                            if(results.next())
                            {
                                        ...
                                        try
                                        {
                                                 ps=connection.prepareStatement("delete from HRM_EMP_ADDL_PHOTO_NEW_TMP where EMPLOYEE_ID=?" );
                                                ps.setInt(1,empid);
                                                ps.executeUpdate();
