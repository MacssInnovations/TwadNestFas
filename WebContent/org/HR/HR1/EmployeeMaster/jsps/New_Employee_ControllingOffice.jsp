...
<html>
  <head>
    ...
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
                       ...
                       <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
                        <script type="text/javascript" src="../scripts/New_EmpControl_OffScript.js"></script>
  ...
  %>
                                    ...
                                    <table border="1px" width="650px%" align="center">
                                          ...
                                          <tr>
                                                <td colspan="2" class="table">Employee Id:</td>
                                          ...
                                          <tr>
                                                ...
                                                <td class="table">
                                                      <input tabindex="2"
                                                             size="12"
                                                             name="Employee_Initial"   style="background-color: #ececec"
                                                             readonly/>
                                                      <input type="hidden"
                                           ...
                                           <tr>
                                                <td colspan="4"
                                                    class="tdH">
                                                      <b><font face="Tahoma"
                                                               color="#000000"
                                                               size="2"> Controlling Office Details </font></b>
                                                </td>
                                          </tr>
                                          <!-- <tr>
                                                <td colspan="2" class="table">
                                          ...
                                          <tr>
                                              ...
                                              <td class="table" colspan="2">
                                                <textarea name="txtOffAddress" cols="25" rows="5" id="txtOffAddress" onfocus="return toFocus()" readonly></textarea>
                                              </td>
                                            </tr>
                                           <!-- <tr>
