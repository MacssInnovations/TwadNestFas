...
<html>
  <head>
    ...
    <title>Delete Employee's Details</title>
    <script type="text/javascript">
          ...
          <td align="center" colspan="2">
            <table border="1px" width="650px%">
              ...
              <tr>
                <td>
                  <div align="left">
                       <input name="Employee_Prefix" type="text" readonly>
                  </div>
                </td>
                <td>
                  <div align="left">
                    <input tabindex="2" size="10" maxlength="8" name="Employee_Initial"
                           onchange="return toCheck1()" readonly
                           onkeypress="return nonanum(event)" style="text-transform:uppercase"/>
                  </div>
                </td>
                <td>
                  <div align="left">
                    <input tabindex="2" size="30" maxlength="40" name="Employee_Name"
                        readonly      onchange="return toCheck()"  onkeypress="return nonanum(event)"/>
                  </div>
                </td>
              </tr>
              <tr>
   ...
   <tr>
              ...
              <tr>
                <td colspan="4" class="tdH" align="right">
                  <input type="Button" value="Delete" name="cmdSub"
                         onclick="callServer('Delete','null')" ></input>
                  &nbsp;
