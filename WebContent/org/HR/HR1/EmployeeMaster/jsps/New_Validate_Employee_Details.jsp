  ...
  <head>
    ...
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
                       ...
                       <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
                        ...
                        <script type="text/javascript" src="../scripts/New_Validate_Employee_DetailsScript.js"></script>
                             ...
                             <%}%>
                                                         ...
                                                         System.out.println("image path after is:"+imagepath);
                                                          String img=context+imagepath;
                                                           strEmpId=request.getParameter("txtEmpId1");
                                                           System.out.println("EmpId........................"+strEmpId);
                                                        //   newpath="ShowImageProfile.jsp";
                                                           %>
                                                           <!--script language="javascript" type="text/javascript">
                                                          imgpath="<%=img%>";
                                                           </script-->
                                                        <img  align="top" src=""  alt="Photo" width="60" height="60" id="EmpImage" alt="EmpImage"></img>
                                                         <%--
                             strEmpId=request.getParameter("txtEmpId1");                             
                            System.out.println("EmpId..........."+strEmpId);
                                       ...
                                       <input type="text"
                                          ...
                                          <tr>
                                                <td colspan="4" class="tdH"
                                                    align="right">
                                                      <input type="button"
                                                             value="Validate" name="cmdUpdate" id="cmdUpdate" onclick=" callUpdateFunction('toValidate','null')"></input>
                                                      &nbsp;
                                                      <input type="Button"
                                                             value=" Cancel "
                                                             name="cmdCancel"
