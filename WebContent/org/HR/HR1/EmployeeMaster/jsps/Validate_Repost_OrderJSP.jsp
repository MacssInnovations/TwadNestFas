...
<html>
  <head>
      ...
      <script type="text/javascript" src="../scripts/Validate_Repost_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Validate Reposting Order Details</title>       
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Validate Reposting Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Validate_Repost_OrderServ?Command=Validate">                
            ...
            <td>
              <div align="left">
                <input type="text" name="txtRno" id="txtRno" onkeypress="return noEnter(event)"
                        maxlength="50" size="60" readonly="readonly"/>                       
              </div>
            </td>
          </tr>
              ...
              <div align="left">
                <input type="text" name="txtT_OffId" id="txtT_OffId"
                 onkeypress="return numbersonly1(event,this);" onchange="doFunction('office',this.value);"
                  maxlength="4" size="5" onblur="return chkLen()" readonly="readonly"/>
                    ...
                    <td>
                      <div align="left">
                        <input type="radio" name="radT_Repost" id="radT_Repost"
                               value="Y" readonly="readonly"/>YES &nbsp;&nbsp;&nbsp;&nbsp; 
                        <input type="radio" name="radT_Repost" id="radT_Repost"
                               value="N" checked="checked" readonly="readonly"/>NO
                      </div>
                    </td>
                  </tr>
