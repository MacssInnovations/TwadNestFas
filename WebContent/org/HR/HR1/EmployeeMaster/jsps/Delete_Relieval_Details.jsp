...
<html>
  <head>
    ...
    <title> Delete The Employee Relieval Details</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Delete_Relieval_Details.js"> </script>
  ...
  <body id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_Relieval_serv.view?Command=Delete&cmbStatus=DL"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Delete The Employee Relieval Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtDORelieval" id="txtDORelieval"
                       ...
                       onblur="return checkdt(this); " readonly="readonly" class="disab"/>
              ...
              <!--  <img src="../../../../../images/calendr3.gif"
                ...
                <input type="radio" name="rad_DORelieval" id="rad_DORelieval"
                       value="FN" checked="checked"   disabled   />FN &nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="radio" name="rad_DORelieval" id="rad_DORelieval"
                       value="AN" disabled/>AN
              </div>
            </td>
          </tr>
          <tr class="table">
            ...
            <td>
              <div align="left">
              <input type="text"  name="cmbReason1" id="cmbReason1" readonly="readonly" class="disab">
                <select size="1" name="cmbReason" id="cmbReason" style="display:none"
                        onchange="document.EmpRelieval.cmbReason1.value=document.EmpRelieval.cmbReason.value;"  class="disab" >
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtRemarks" id="txtRemarks" cols="50" rows="4" readonly="readonly" class="disab"></textarea>
              </div>
            </td>
          </tr>
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtT_OffId" id="txtT_OffId"
                               ...
                               maxlength="4" size="5" readonly="readonly" class="disab"/>
                    ...
                    <td>
                      <div align="left">
                        <input type="radio" name="radT_Repost" id="radT_Repost"
                               value="Y" disabled/>YES &nbsp;&nbsp;&nbsp;&nbsp; 
                        <input type="radio" name="radT_Repost" id="radT_Repost"
                               value="N" checked="checked" disabled/>NO
                      </div>
                    </td>
                  </tr>
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtT_proc_No" id="txtT_proc_No"
                               maxlength="50" size="55" readonly="readonly" class="disab"/>
                      </div>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                       ...
                       <select name="txtDept_Id"  id="txtDept_Id" onchange="deptchange()" onfocus="return checkEID();" disabled>
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtD_Period" id="txtD_Period"
                               maxlength="20" size="25" readonly="readonly" class="disab"/>
                      </div>
                    </td>
                  </tr>
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtP_desigId" id="txtP_desigId" onchange="doFunction('desig','null');"
                               onkeypress="return numbersonly1(event,this);"
                               maxlength="3" size="4" readonly="readonly" class="disab"/>
              ...
              <div id="Reason4" style="display:none">
                <table cellspacing="3" cellpadding="2" border="1" width="100%">
                  ...
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <select size="1" name="cmbLL_TypeId" id="cmbLL_TypeId" readonly="readonly" class="disab">
                    ...
                    <td>
                      <div align="left">
                        <textarea name="txtLL_purpose" id="txtLL_purpose"
                                  cols="50" rows="4" readonly="readonly" class="disab"></textarea>
                      </div>
                    </td>
                  </tr>
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        ...
                        <input type="text" name="txtInst_Name" id="txtInst_Name"
                                maxlength="60" size="40" class="disab" />
                      </div>
                    </td>
                  </tr>
                 <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <textarea name="txtInst_Location" id="txtInst_Location" 
                                rows="4" cols="40" class="disab"></textarea>
                      </div>
                    </td>
                 </tr>
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtCourse_Name"
                               id="txtCourse_Name" maxlength="40" size="30" class="disab"/>
                      </div>
                    </td>
                  </tr>
                  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtSDate_From" id="txtSDate_From"
                               maxlength="10" size="11" class="disab"
                               onfocus="javascript:vDateType='3';"
                               onkeypress="return calins(event,this);"
          ...
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <input type="submit" name="butSub" id="butSub" value="Delete" />
                 &nbsp;&nbsp;&nbsp; 
