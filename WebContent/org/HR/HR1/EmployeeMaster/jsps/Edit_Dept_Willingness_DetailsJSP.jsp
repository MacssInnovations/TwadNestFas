  ...
  <head>
    ...
    <title>Edit_Dept_Willingness_DetailsJSP</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
      ...
      <script type="text/javascript"       src="../scripts/Edit_Dept_Willingness_DetailsJS.js"></script>
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Edit Deputation Willingness Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
        </table>
        <form name="frmDeptWilling" id="frmDeptWilling">                
          ...
          <td>
             ...
             <tr class="tdTitle">
                  ...
                  <td colspan="2">
                  <div align="center">
                   <input type="button" name="btsubmit" id="btsubmit" value="Edit" onclick="fnsubmit()" disabled/>
