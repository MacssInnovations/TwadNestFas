...
<html>
  <head>
      ...
      <script type="text/javascript" src="../scripts/Validate_Promotion_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Validate Promotion Order Details</title>       
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Validate Promotion Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Validate_Promotion_OrderServ?Command=Validate">                
                <div class="tab-pane" id="tab-pane-1" >
                    <div class="tab-page">
                        <h2 class="tab">Promotion Details</h2>
                        <div align="center">
          ...
          <tr class="table">
            <td>
              <div align="left">Promotion Proceeding Id
            ...
            <td>
              <div align="left">
                ...
                <%
                 ...
                 try
                 {
                 ps1=connection.prepareStatement("select distinct PROMOTION_ORDER_ID from HRM_PROMOTION_ORDERS where PROMOTION_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') order by PROMOTION_ORDER_ID desc");
                 ps1.setInt(1,oid);
                 ...
                 while(rs2.next())
                 {
                    out.println("<option value='"+rs2.getInt("PROMOTION_ORDER_ID")+"'>"+rs2.getInt("PROMOTION_ORDER_ID")+"</option>");
                 }
                 }
                 catch(Exception e)
                 {
          ...
          <td>
            ...
            <td colspan="2">
              <div align="left">
                <strong>Employee and Promotion Details</strong>
              </div>
            </td>
          </tr>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtCurOff" id="txtCurOff"
                       ...
                       size="60"/>
                        <input type="hidden" name="txt_offid" id="txt_offid">
              </div>
            </td>
          </tr>
        ...
        %>              
          ...
          <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="radio" name="radT_Posting" id="radT_Posting"
                               value="Y" onclick="getPost()"/>YES &nbsp;&nbsp;&nbsp;&nbsp; 
                        <input type="radio" name="radT_Posting" id="radT_Posting"
                               value="N" checked="checked" onclick="getPost()"/>NO
                      </div>
                    </td>
                  </tr>
                  
                  <tr class="table" id="dep_row" style="display:none">
          <td>
          <div align="left">
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Department
                     to which Posted
          ...
          <tr class="table" id="offid_row" style="display:none">
          <td>
          <div align="left">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Office Id
          <font color="#ff2121">*</font>
          ...
          <td>
          <div align="left">
          <input type="text" name="txtT_OffId" id="txtT_OffId" maxlength="4" size="5" onchange="doFunction('dept','null');" readonly="readonly"/>
           <!--<img src="../../../../../images/c-lovi.gif" width="20" 
                             height="20" alt="DepartmentList" onclick="jobpopup_pro();"></img>-->
          </div>
          </td>
          </tr>
          
          
          <tr class="table" id="offnme_row" style="display:none">
          <td>
          <div align="left">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Office Name
          </div>
          ...
          <td>
          <div align="left">
          <input type="text" name="txtT_OffName" id="txtT_OffName" maxlength="60" size="60"
                               readonly="readonly" class="disab"/>
          </div>
          </td>
          </tr>       
                         ...
                         <td>
                          ...
                          <td>
                           ...
                           <div align="left">Subject</div>
                            ...
                            <td>
                             <div align="left">
                               <textarea cols="50" rows="2" id="txtSub" name="txtSub" title="Don't type '&' Character while entering data" onkeypress="return noEnter(event)" onblur="return chkSubj()" readonly="readonly"></textarea>                      
                              </div>
                            </td>
                            </tr>
                           ...
                           <div align="left">Reference</div>
                            ...
                            <td>
                             <div align="left">
                               <textarea cols="50" rows="2" id="txtRef" name="txtRef" title="Don't type '&' Character while entering data" onkeypress="return noEnter(event)" onblur="return chkRef()" readonly="readonly"></textarea>                       
                              </div>
                            </td>
                            </tr>
                           ...
                           <div align="left">Additional Para 1</div>
                            ...
                            <td>
                             <div align="left">
                               <textarea cols="50" rows="4" id="txtAdd1" name="txtAdd1" title="Don't type '&' Character while entering data" onkeypress="return noEnter(event)" onblur="return chkPara1()" readonly="readonly"></textarea>                       
                              </div>
                            </td>
                            </tr>
                           ...
                           <div align="left">Additional Para 2</div>
                            ...
                            <td>
                             <div align="left">
                               <textarea cols="50" rows="4" id="txtAdd2" name="txtAdd2" title="Don't type '&' Character while entering data" onkeypress="return noEnter(event)" onblur="return chkPara2()" readonly="readonly"></textarea>                       
                              </div>
                            </td>
                            </tr>
                           ...
                           <div align="left">Copy To</div>
                            ...
                            <td>
                             <div align="left">
                               <textarea cols="40" rows="5" id="txtcopy" name="txtcopy" title="Don't type '&' Character while entering data" onkeypress="return noEnter(event)" onblur="return chkCopy()" readonly="readonly"></textarea>                       
                              </div>
                            </td>
                            </tr>
                ...
                <div id="bghead" class="tdH">
                    <center>  
                        <input type="Submit" name="btsub" id="btsub" value="Validate" onclick="return checkNull2();" disabled="disabled"/>                   
