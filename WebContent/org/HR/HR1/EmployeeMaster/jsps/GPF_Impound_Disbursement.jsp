...
<html>
  <head>
    ...
    <title>Creation Of Impound_Disbursement</title>
    ...
    <script type="text/javascript" src="../scripts/GPF_Impound_Disb.js">  </script>
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>GPF Impound Disbursement</strong>
              </div>
            </td>
          </tr>
          <tr class="tdH">
          ...
          <tr class="table">
            <td>
              <div align="left">Type of Impound</div>
            </td>
            <td>
              <div align="left">
                <input type="radio" name="impound_type" id="impound_type"
                       value="Impound(Regular)" checked="checked"/>
                 Impound(Regular)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="radio" name="impound_type" id="impound_type"
                       value="Impound 2003"/>
                 Impound 2003
