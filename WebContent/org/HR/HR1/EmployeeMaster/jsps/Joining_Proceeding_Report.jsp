...
<html>
  <head>
    ...
    <title>Generate Joining Proceeding Report</title>
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
   <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/Joining_Proceeding_Report.js"></script>
 <!-- <script type="text/javascript" src="../../../../../org/Library/scripts/CalendarControl.js"></script>-->
  ...
  <body id="bodyid">
  <form name="frmEmployee" id="frmEmployee" action="../../../../../Joining_Proceeding_Report?_status=FR" method="POST">
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Generate Joining Proceeding Report</strong>
              </div>
            </td>
          </tr>
          <tr class="tdH">
