...
<html>
  <head>
    ...
    <title> Editing The&nbsp;Study&nbsp;Leave Completion Details</title>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_STURelieval_serv.view?Command=Add&cmbStatus=MD"
        ...
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>
                   Editing The&nbsp;Study&nbsp;Leave Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
