...
<html>
  <head>
    ...
    <title>Create Employee Basic Details</title>
     <script type="text/javascript" src="../scripts/OtherUserProfileUpdateJS.js"></script> 
 ...
 %>     
  ...
  <table width="100%">
      ...
      <b>Other User Profile Updation</b><input type="HIDDEN" name="txtMode" value="insert">
      </td>      
      </tr>
       ...
       <TR>
             ...
             <TD colspan="2">
                  <select name="txtusercategory"  id="txtusercategory" onchange="callServer('Exist',null)" >
   ...
   <TR>
            ...
            <TD colspan="2">
                   <select name="txtuserid" id="txtuserid"  onchange="callServer('ExistRecord',null)">
