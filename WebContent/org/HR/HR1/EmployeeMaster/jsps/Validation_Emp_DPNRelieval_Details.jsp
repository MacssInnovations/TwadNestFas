...
<html>
  <head>
    ...
    <title> Validation Of Deputation Completion Details</title>
  ...
  <body  id="bodyid"><form name="EmpRelieval" id="EmpRelieval" method="POST"
              action="../../../../../Edit_DPNRelieval_serv.view?Command=Add&_status=FR"
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong> Validation Of Deputation Completion Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdTitle">
      ...
      <!--    <tr class="table">
        ...
        <tr class="tdTitle">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtRel_SLNO" id="txtRel_SLNO" readonly
