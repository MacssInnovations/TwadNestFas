...
<html>
  <head>
      ...
      <script type="text/javascript" src="../scripts/Create_Repost_OrderJS.js"></script>
      <script type="text/javascript" src="../../../../Security/scripts/tabpane.js"></script>
      
      <meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
      <meta http-equiv="cache-control" content="no-cache">
      <title>Create Reposting Order Details</title>       
  ...
  %>
        <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Create Reposting Order Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
        <form name="frmTransfer" id="frmTransfer" method="POST" action="../../../../../Create_Repost_OrderServ?Command=Insert">                
          ...
          <tr class="table">
            ...
            <td> 
               <div align="left">
                <select name="cmbProceeding" id="cmbProceeding" onchange="getDt()">
                <option value="0">---Select Proceeding---</option>
                </select>                                  
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date&nbsp;&nbsp;&nbsp;<input type="text" name="txtProDat" id="txtProDat"  maxlength="10" size="11" readonly="readonly"/>              
              </div>
