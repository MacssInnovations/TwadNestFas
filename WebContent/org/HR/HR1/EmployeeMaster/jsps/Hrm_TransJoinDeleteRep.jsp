...
<html>
  <head>
    ...
    <title>Delete Joining Report Details</title>
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

   <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/New_Trans_Joinedit_Script.js"></script>
      ...
      <div align="center">
        <table cellspacing="3" cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Delete Joining Report Details</strong>
              </div>
            </td>
          </tr>
          <tr class="tdH">
...
<textarea rows="4" cols="40"  name="txtOffAddr" id="txtOffAddr" readonly="readonly"
        ...
        -->  
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
              <input type="radio" name="optjoin" value="D"  checked="checked" disabled="disabled"/> Division <input type="radio" name="optjoin" value="S" disabled="disabled" /> SubDivision
            <div style="display:none" id="divsubdivision"><select name="cmbsubdivision" id="cmbsubdivision"  disabled="disabled">
            ...
            <td>
              <div align="left">
                Designation
                                                ...
                                                <input type="text" name="cmbdes1" class="disab" size="40" readonly>
                                                <div style="display:none">
                                                      <table cellspacing="2"
                                                            ...
                                                            <tr>
                                                                  <td>
                                                                        <select name="cmbsgroup" style="visibility:hidden"
                                                                                id="cmbsgroup"
     ...
     <%
        ...
        %>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
              <input type="text" name="comPostTow1" class="disab" size="40" readonly>
                <select size="1" name="comPostTow" id="comPostTow" onFocus="return toFocus();" style="display:none">
                <option>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- - - - Select - - - -
                </option>
                <%
