...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/UpdateAdditionalCharge.js"> </script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Update Additional Charge Details</strong>
               </div> 
            </td>
          </tr>
           <tr class="table">
     ...
     <!--   <tr class="tdH">
          ...
          <tr class="table">
            ...
            <td colspan="2">
            <div align="left">
                <strong>Update Additional Charge</strong>
               </div> 
            </td>
          </tr>-->
          <tr class="table">
            ...
            <%
                try
                {
                ps=con.prepareStatement("select office_id from HRM_EMP_ADDITIONAL_CHARGE where employee_id=?");
                rs=ps.executeQuery();
                    while(rs.next())
                    {
