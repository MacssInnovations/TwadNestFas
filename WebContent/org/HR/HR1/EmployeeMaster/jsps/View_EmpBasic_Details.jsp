...
function validate()
{
    ...
    else
    {
        ...
        if(sr==0)
           ...
           url="../../../../../InsertEmployee1.con?command=ExistgviewSR&EmpId=" + strEmpId;   
    ...
    if(request.getParameter("txtEmpId")!=null)
    {
        ...
        catch(Exception e)
        {
         ...
         try{
                ...
                String sql="select a.CONTROLLING_OFFICE_ID,b.OFFICE_NAME from HRM_EMP_CONTROLLING_OFFICE a,COM_MST_OFFICES b where b.OFFICE_ID=a.CONTROLLING_OFFICE_ID AND  a.EMPLOYEE_ID=?";
                //System.out.println(sql);
                ps=con.prepareStatement(sql);
                ps.setInt(1,empid);
                rs=ps.executeQuery();
              ...
              <tr>
                ...
                <td  valign="center">
                  <table border="0" align="left">
                    <tr>
                      <td>
                        <input tabindex="1" type="text" name="txtEmpId" readonly="readonly"      id="txtEmpId" maxlength="5" value="<%=strEmpId%>"
                             ></input>
                      ...
                      <td>
                         <img align="top" src="<%=EmpImage%>"  alt="Photo" width="90" height="90" id="EmpImage"></img>
                       </td>
                    </tr>
                  </table>
                </td>
