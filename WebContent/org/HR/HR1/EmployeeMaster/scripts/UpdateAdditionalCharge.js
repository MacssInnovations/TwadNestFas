...
if(Command=='loadEmp')
 ...
 // alert('second')
    ...
    var url="../../../../../UpdateAdditionalCharge?Command=loadEmployee&prono="+prono+"&officeid="+offid;
   // alert(url);
  ...
  //alert(prono);
  var req=getTransport();
    var url="../../../../../UpdateAdditionalCharge?Command=save&prono="+prono;
   // alert(url);
    req.open("Get",url,true);
    //alert(req);
    req.onreadystatechange=function()
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.frmListEmpProceed.action="../../../../../UpdateAdditionalCharge";
