...
<html>
 ...
 %>
        ...
        <form name="frmOffice" method="POST"
              action="../../../../../ServletUpdateOfficeDetails.con" onsubmit="return nullcheckUp()">
           <table  cellspacing="1" cellpadding="3" width="100%" >
                    ...
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%">
                                  ...
                                  <tr>
                                      ...
                                      <td style="color:rgb(255,51,102);">
                                        <input type="text" name="txtOffName" size="25" maxlength="75" value=<%=strName%> >
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtShortName" maxlength="55" size="15" value=<%=strSName%> />
                                      </td>
                                  </tr> 
                                  <tr>
                                      <td  >Office Headed by
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="txtContrllingOfficeID" maxlength="70" size="6" value="<%=intCOffId%>" >                                                 
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <select name="cmbSelectOffice" id="cmbSelectOffice" onchange="selectControllineOffice()">
                                        ...
                                        <select name="cmbHRAClassID">
                                            ...
                                            <%
                                                  try
                                                  {
                                                    ...
                                                    while(results.next()) 
                                                    {
                                                        String hra=results.getString("HRA_CCA_Class_Id");
                                                        out.print("<option value='" + hra + "' ");
                                                        if(strHRAClassId!=null)
                                                        {
                                                            if(strHRAClassId.equals(hra))
                                                            {
                                                                out.print("selected");
                                                            }
                                                        }
                                                        out.print(" > " + results.getString("HRA_CCA_Class_Desc") + "</option>"); 
                                                    }
                                                    results.close();                                                    
                                                  }
                                                  catch(Exception e)
                                        ...
                                        <select name="cmbCCAClassID">
                                            ...
                                            <%
                                                  try
                                                  {
                                                    ...
                                                    while(results.next()) 
                                                    {
                                                        String cca=results.getString("HRA_CCA_Class_Id");
                                                        out.print("<option value='" + cca + "' ");
                                                        if(strCCAClassId!=null)
                                                        {
                                                            if(strCCAClassId.equals(cca))
                                                            {
                                                                out.print("selected");
                                                            }
                                                        }
                         ...
                         <!--         <tr>
                                      <td  >HRA CCA Class<label style="color:rgb(255,0,0);"> </label>
                                      <label style="color:rgb(255,0,0);">&nbsp;*</label></td>
                                      <td>
                                            ...
                                            /*      try
                                                  {
                                                    ...
                                                    while(results.next()) 
                                                    {
                                                        String sel2=results.getString("HRA_CCA_Class_Id");
                                                        out.print("<option value='" + sel2 + "' ");                                                          
                                                        if(strHRACCAClassId.equals(sel2))
                                                        {
                                                            out.print("selected");
                                                        }
                                                        out.print(" >" + results.getString("HRA_CCA_Class_Desc") + "</option>");                                                         
                                  ...
                                  <tr>
                                      <td  >Is Accounting Unit</td>
                                      <td>
                                        <%                                        
                                        out.println("<input type='radio' name='optIAU' ");
                                        if(strIsAccountUnit!=null)
                                            if(strIsAccountUnit.equalsIgnoreCase("y")) 
                                                out.println("checked ");
                                        out.println("value='yes'/>Yes");                                        
                                        out.println("<input type='radio' name='optIAU' ");
                                        if(strIsAccountUnit!=null)
                                            if(strIsAccountUnit.equalsIgnoreCase("n")) 
                                                out.println("checked ");
                                        out.println("value='no'/>No");                                        
                                        %>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td  >Wings Applicable</td>
                                      <td>
                                      <%
                                        out.println("<input type='radio' name='optWA' ");                                           
                                        if(strWingsApplicable!=null)
                                            if(strWingsApplicable.equalsIgnoreCase("y"))
                                                out.println("checked ");
                                        out.println("value='yes'/>Yes");
                                        out.println("<input type='radio' name='optWA' ");                                           
                                        if(strWingsApplicable!=null)
                                            if(strWingsApplicable.equalsIgnoreCase("n"))
                                                out.println("checked ");
                                        out.println("value='no'/>No");
                                      %>
                                      </td>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <textarea name="txtRemarks" cols="25" rows="5" >
                                        <%=strRemarks%>
                                        </textarea>
                                      </td>
                                  </tr>
