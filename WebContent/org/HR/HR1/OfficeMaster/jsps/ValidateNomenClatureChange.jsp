...
<html>
  <head>
    ...
    <title>ValidateNomenClatureChange</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/ValidateNomenClatureChange.js"></script>
<script type="text/javascript" src="../scripts/CalendarControl.js"></script>
 ...
 %>
  <form action="../../../../../ValidateNomenClatureChange.con" name="frmNomenClature" method="post" onsubmit="return nullCheck()">
  <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Validate Office Nomenclature Change</b></center>
            </td>
        </tr>
        <tr>
            <td class="tdH">
        ...
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td>
                    <input type=text name="txtOffice_Id" maxlength="4" onchange="loadOffice(this.value);checkControlId();" onkeypress="return numbersonly1(event,this)" size="10">
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtconOfficeName" size="40" disabled>
                    </td>
                </tr>
                <tr>
                    <td> 
                    ...
                    <td>
                        <textarea rows="5" cols="25" id="txtconOfficeAddress" name="txtconOfficeAddress" disabled></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="tdH" colspan="3">
                ...
                <tr>
                    ...
                    <td>
                        <input type=text size=10 disabled style="background-color: #ececec">(System Generated)
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtDateOfNomen" id="txtDateOfNomen" maxlength="10" onFocus="javascript:vDateType='3';return officeCheck()"  onkeypress="return  calins(event,this)" onblur="checkdt(this)">
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtDateOfRelieval" id="txtDateOfRelieval"maxlength="10" onFocus="javascript:vDateType='3';return officeCheck()"  onkeypress="return  calins(event,this)" onblur="return checkdt(this)" > <!--checkdt() & calins() in comJS.js **** -->
