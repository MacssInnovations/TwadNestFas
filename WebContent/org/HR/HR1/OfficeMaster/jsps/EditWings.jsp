...
<html>
    <head>
      ...
      <title>Edit Wings Details</title>
    
          <!--<link href="../../../../../css/yellow.css" rel="stylesheet" media="screen"/>-->
          <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
          <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
          <script type="text/javascript" src="../scripts/EditWings.js"></script>
 ...
 <%
  ...
  %>
 <form name="frmOffice" method="Post" action="../../../../../EditWingsDetails.con?command=Add" >
    ...
    <script type="text/javascript" src="test.js"></script>
                ...
                <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="table">
                    <tr>
                        <td class="tdH">
                            <center><h2>Edit Wings Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                  ...
                                  <tr>
                                      ...
                                      <%
                                                        try
                                                        {
                                                          results=statement.executeQuery("select designation_id,designation from HRM_MST_WING_HEAD_DESIG"); 
                                                          while(results.next()) 
                                                          {
                                   ...
                                   <!--<div id="mydiv" name="mydiv"> -->
                                    ...
                                    <tr>
                                        <td colspan=8 class="bgClass"><center>
                                            <input type=Submit value=Submit  name="cmbSubmit" id="cmbSubmit" onclick="return nullcheck()"/>
