...
<html>
    <head>
      ...
      <title>Create Wings Details</title>
    
          <!--<link href="../../../../../css/yellow.css" rel="stylesheet" media="screen"/>-->
          
          <script type="text/javascript" src="../scripts/AjaxOfficeWing.js"></script>
 ...
 <%
  ...
  %>
 <form name="frmOffice" method="Post" action="../../../../../ServletOfficeWing.con?command=Add">
    ...
    <script type="text/javascript" src="test.js"></script>
                ...
                <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="table">
                    <tr>
                        <td class="tdH">
                            <center><h2>Create Wings Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                  ...
                                  <tr>
                                      ...
                                      <%
                                                        try
                                                        {
                                                        //select a.cadre_id,b.cadre_name from HRM_MST_WING_HEAD_DESIG a,hrm_mst_cadre b where a.cadre_id=b.cadre_id order by b.cadre_name
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type=text name="txtDateCreated" id="txtDateCreated" maxlength="10" tabindex="5"  onFocus="return officeCheck();javascript:vDateType='3'" onchange="if(checkdt1(this)==true)return check1()" onkeypress="return calins(event,this)" >
                                        <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmOffice.txtDateCreated);"  alt="Show Calendar"></img>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>
                                  ...
                                  <tr>
                                        ...
                                        <div>
                                            <table border=0>
                                                <tr>
                                                    ...
                                                    <td>
                                                      <input type="Button" value=" Update" onclick="callServer1('Update','null')"  name="cmdUpdate" style="display:none" onfocus="return officeCheck()">
                                                    </td>
                                                    <td>
                                   ...
                                   <!--<div id="mydiv" name="mydiv"> -->
                                    ...
                                    <tr>
                                        <td colspan=9 class="bgClass"><center>
                                            <input type=Submit value=Submit onclick="return nullcheck()" name="cmbSubmit" id="cmbSubmit"/>
