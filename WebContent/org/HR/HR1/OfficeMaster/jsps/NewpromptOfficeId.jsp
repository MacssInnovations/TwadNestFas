...
<html>
 ...
 %>
    <form name="prompt" action="NewUpdateOffice.jsp" onsubmit="return nullcheck()">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td colspan="2" class="bgClass">
            <center>Updating an Office Detail</center>
          </td>
        </tr>
        <tr>
          <td width="49%" align="right" height="41">Enter The Office Id</td>
          <td width="51%" height="41">
            <input type="text" name="txtOffice_Id" maxlength="10"  tabindex="1" size="10" onblur="officeprompt()"/>
             
            <img src="../../../../../images/c-lovi.gif" alt="" onclick="popup()"></img>
          </td>
        </tr>
        <tr>
            <td align="right">Office Name</td>
            <td><input type=text name="txtOffice_Name" disabled>
            
        </tr>
        <!--<tr>
          <td width="49%" align="right">Or Select The Office Type<br>&nbsp;&nbsp;to filter the Offices</td>
          <td width="51%">
            <table>
                                        <tr>
                                            <td>Office Level</td>
        ...
        <tr class="bgClass">
          <td align="right" width="49%">
            <input type="submit" value="  Show  " tabindex="2"/>
          </td>
          <td width="51%">
