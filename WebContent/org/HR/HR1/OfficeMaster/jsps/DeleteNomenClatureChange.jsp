...
<html>
  <head>
    ...
    <title>DeleteNomenClatureChange</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/DeleteNomenClatureChange.js"></script>
 ...
 %>
  <form action="../../../../../DeleteNomenClatureChange.con" name="frmNomenClature" method="post" onsubmit="return nullCheck()">
  <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Delete Office Nomenclature Change</b></center>
            </td>
        </tr>
        <tr>
            <td class="tdH">
        ...
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtconOfficeId" size=10 disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtNewOfficeName" id="txtNewOfficeName" size="40" disabled>
                   
                    </td>
                </tr>
                <tr>
                    <td>
                        New Short Office Name:
                    </td>
                    <td>
                        <input type=text name="txtNewShortName" id="txtNewShortName" size="40" disabled>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        Date of Nomenclature Change:
                    </td>
                    <td>
                        <input type=text name="txtDateOfNomen" maxlength="10" onFocus="javascript:vDateType='3'"  onkeypress="return  calins(event,this)" onblur="checkdt(this)" disabled>
