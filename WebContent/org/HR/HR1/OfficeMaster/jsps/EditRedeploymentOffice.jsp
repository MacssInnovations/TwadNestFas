...
<html>
  <head>
    ...
    <title>Edit Redepolyment of an office</title>    
    <!--<script type="text/javascript" src="../../../../Library/scripts/selectOffice.js">
    </script>-->
    <script type="text/javascript" src="../scripts/EditselectAttachedOffice.js">
    </script>
    <script type="text/javascript" src="../scripts/EditRedeploymentOffice.js">
    </script>
...
%>
  <form name="frmClosure" method="POST" action="../../../../../EditRedeploymentServlet.con" onsubmit="return nullCheckRedeployment()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Edit Redeployment of an Office</b></center>
            </td>
        </tr>
        <tr>
            <td>
