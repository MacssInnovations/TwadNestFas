...
<html>
  <head>
    ...
    <title>Validate Closure of an office</title>    
    ...
    <script type="text/javascript" src="../scripts/ValidateClosureOfOffice.js">
    </script>
...
w.close();
 ...
 %>
  <form name="frmClosure" method="POST" action="../../../../../ValidateServletClosureOfOffice.con" onsubmit="return nullCheckMaster()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Validate Closure Of An Office</b></center>
            </td>
        </tr>
        <tr>
            <td>
         ...
         <td width="64%">
           ...
           <option value=0>---Select Office---</option>
              ...
              %>
                ...
                <!--<tr>
                    <td>Record Status<label style="color:rgb(255,0,0);">
                    &nbsp;
                  </label></td>
                  <td>
