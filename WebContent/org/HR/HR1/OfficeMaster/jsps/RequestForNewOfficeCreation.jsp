...
<html>
  <head>
    ...
    <title>Request for New Office Creation</title>
      ...
      <script type="text/javascript" src="../scripts/ReqNewOfficeCreationValids.js"></script> 
...
<form name="frmOffice" method="POST" action="../../../../../ServletRequestForNewOfficeCreation.con" >
<table width=100% cellpadding="3" cellspacing="1" border="1" align="center">
 <tr >
    <td class="bgClass">
        <center><h3>Request For New Office Creation</h3></center>
    </td>
 </tr>
 <tr>
    <td>                        
        <table  cellspacing="3" cellpadding="1"  width="101%" >
             <tr>
                ...
                %>
                <input type="text" name="txtOffice_Id" id="txtOffice_Id"  onfocus="loadOffice(document.frmOffice.txtOffice_Id.value,'nothing')" disabled value=<%=Office_Id%> >
            ...
            <tr>
                ...
                int max=0;
                                                  try
                                                  {
                                                    results=statement.executeQuery("select MAX(NEW_OFFICE_REQUEST_ID) from com_office_new_requests"); 
                                                    while(results.next()) 
                                                    {
                 ...
                 %>
                <input type="text" name="txt_Request_Id" id="txt_Request_Id" disabled onblur="loadGridInitValsForReq(this.value)" value=<%=max+1%> >
                <input type="hidden" name="txt_Request_Id1" id="txt_Request_Id1" value=<%=max+1%>> 
