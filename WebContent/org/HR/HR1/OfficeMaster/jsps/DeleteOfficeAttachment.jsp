...
<html>
  <head>
    ...
    <title>Delete Office Attachment</title>
    <script type="text/javascript" src="../scripts/DeleteOfficeAttachmentValidation.js" >    
    </script>
    <script type="text/javascript" src="../scripts/DeleteselectOfficeAttached.js" >    
    </script>
 ...
 %>
  ...
  <table  cellspacing="1" cellpadding="3" width="100%">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <b>Delete Attachment of an Office </b>                            
                            </center>
                        </td>
                    </tr>  
                    ...
                    <tr>
                    <td>
        <form name="frmConversion" method="POST" action="../../../../../DeleteAttachmentServlet.con" onsubmit="return nullcheck()" >                
                                      ...
                                      <table>
                                        ...
                                        <tr>                                            
                                            ...
                                            <input type="text" name="txtAttachedOfficeID" maxlength="4" size="6"
                                                   onchange="loadOffice1(document.frmConversion.txtAttachedOfficeID.value,'attach');return checkAttachedoffice();" onkeypress="return  numbersonly1(event,this)" onfocus="return officeCheck()" disabled/>
                                            </td>
                                            <td>
                                                <SELECT size=1
                                                        name="cmbAttachedOfficeLevel" id="cmbAttachedOfficeLevel"
                                                        onchange="getAttachOfficesByLevel(this.form.name)" onfocus="return officeCheck()" disabled>   
                                                <option value=0>
                                                        ----Select
                                                        OfficeLevel----
                                                    </option>
                    ...
                    <td width="64%">
                        <textarea name="txtAttachedOfficeAddress" cols="25" rows="4"
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtDOC" maxlength="10" size="10"
                                               onFocus="return officeCheck();javascript:vDateType='3'" onKeyUp="DateFormat(this,this.value,event,false,'3')" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled/>
                                  ...
                                  <tr>
                                      ...
                                      <td>                                        
                                        <select name="cmbPrimaryID" onfocus="return officeCheck()" disabled>                                        
                                            <option value="">
                                                                  ----Select
                                                                  Work Nature----
                                                            </option>
