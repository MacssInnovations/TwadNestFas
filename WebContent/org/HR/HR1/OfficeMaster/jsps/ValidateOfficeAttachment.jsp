...
<html>
  <head>
    ...
    <title>Validate Office Attachment</title>
    <script type="text/javascript" src="../scripts/ValidateOfficeAttachmentValidation.js" >    
    </script>
    <script type="text/javascript" src="../scripts/ValidateselectOfficeAttached.js" >    
    </script>
 ...
 %>
  ...
  <table  cellspacing="1" cellpadding="3" width="100%">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <b>Validate Attachment of an Office </b>                            
                            </center>
                        </td>
                    </tr>  
                    ...
                    <tr>
                    <td>
        <form name="frmConversion" method="POST" action="../../../../../ValidateAttachmentServlet.con" onsubmit="return nullcheck()" >                
