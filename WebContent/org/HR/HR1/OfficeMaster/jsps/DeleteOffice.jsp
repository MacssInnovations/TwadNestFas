...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/DeleteOffice.js"></script>
  ...
  {         
   ...
   <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Delete Office Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
  <form action="../../../../../DeleteOffice.con" name="frmOffice" method="POST" onsubmit="return nullcheck()">
  ...
  <table cellspacing="1" cellpadding="3" width="100%">
        ...
        <tr>
            <td>Enter Office Id:<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
        ...
        <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtShortName" maxlength="55" size="40" onfocus="return officeCheck()" disabled/>
                                      </td>
                                  </tr> 
                                  <tr>
                                      <td  >Office Head Code
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <SELECT size=1 name=cmbLevelId onchange="checkLevel();setDefaultCadre(this.value);" onfocus="return officeCheck()" disabled>   
                                            <option value=0>
                                            ----Select OfficeLevel------------
                                        </option>
                                            <%
                                  ...
                                  <!--<tr>
                                      <td colspan=3 class="tdH" align="center">
                                          ...
                                          <input type="SUBMIT" value="  Delete  " name="cmdSub"> &nbsp;
                ...
                <div id="bghead" class="tdH">
                    <center>  
                        <input type="SUBMIT" value="  Delete  " name="cmdSub" id="cmdSub"> &nbsp;
