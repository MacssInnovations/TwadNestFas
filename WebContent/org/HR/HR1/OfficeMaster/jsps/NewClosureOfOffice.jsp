...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/NewClosureOfOffice.js">
    </script>
...
w.close();
 ...
 %>
  <form name="frmClosure" method="POST" action="../../../../../NewServletClosureOfOffice.con" onsubmit="return nullCheckMaster()">
      <table width="100%" align="center">
        ...
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td width="64%">
                    <table>
                                        ...
                                        <tr>                                            
                                            <td>
                                                <input type="text" name="txtOffice_Id" maxlength="4" size="6" onchange="loadOffice(document.frmClosure.txtOffice_Id.value,'nothing');checkofficestatus();checkclosure()" onkeypress="return numbersonly1(event,this)"/>
                                                       <img src="../../../../../images/c-lovi.gif" alt="" onclick="jobpopup()" ></img>
                                                 <input type="hidden" name="hid_level" id="hid_level">      
                                            </td>
                                            <!--<td>
                ...
                <tr>
                    ...
                    <td width="64%">
                        <textarea name="txtRemarks" cols="25" rows="4" onfocus="return officeCheck()"></textarea>
                    </td>
                </tr>
                <tr id="cmb_transfer">
         <td width="36%">Accounts Transfer To</td>
         <td width="64%">
        ...
        <td align="center" class="tdH">
            <input type="submit" value="Confirm Closure" name=submit>
