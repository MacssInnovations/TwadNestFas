...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/ViewOfficeDetails.js"></script>
  ...
  {         
   ...
   <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>View Office Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
  <form action="" name="frmOffice" method="POST" onsubmit="return nullcheck()">
  ...
  <table cellspacing="3" cellpadding="1" width="100%">
        <!--<tr>
            <td colspan="2" class="tdH"><center><b>Office Details</b></center></td>
        </tr>-->
        ...
        <tr>
                                      ...
                                      <td style="color:rgb(255,51,102);">
                                        <input type="text" name="txtOff_Name"
                                               size="40" maxlength="75" onfocus="return officeCheck()" disabled>
                                      </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtShortName"
                                               maxlength="55" size="40" onfocus="return officeCheck()" disabled/>
                                      </td>
                                  </tr> 
                                  ...
                                  <tr>
                                      ...
                                      <label style="color:rgb(255,0,0);">&nbsp;</label></td>
                                      <td>
                                        <SELECT size=1 name=cmbLevelId onchange="checkLevel();setDefaultCadre(this.value);setOfficeLevel();" onfocus="return officeCheck()" disabled>   
                                            <option value=0>
                                            ----Select OfficeLevel------------
                                        </option>
                                            <%
                                  ...
                                  <tr>
                                      ...
                                      <label style="color:rgb(255,0,0);">&nbsp;</label></td>
                                      <td>
                                        <select name="cmbHeadCode" id="cmbHeadCode" onfocus="return officeCheck()" disabled>                                        
                                            <option value=0>
                                            ----Select Cadre-------------
                                        </option>                                            
                                            <%
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="txtContrllingOfficeID" maxlength="70" size="6"  disabled value=<% if(intCOffId!=0){ %> <%=intCOffId%> <%}%> >                                                 
                                                <input type="hidden" name="txtHContrllingOfficeID" />
                                            </td>
                                            <td>
                                                <SELECT size=1 name=cmbControllingLevel id="cmbControllingLevel" onchange="getOfficesByLevel()" onfocus="return officeCheck()" disabled>   
                                                <option value>
                                                        ----Select
                                                        OfficeLevel----
                                                    </option>
                                              ...
                                              <td>
                                                <select name="cmbOfficeType" style="visibility:hidden" onchange="getOfficesByType()" onfocus="return officeCheck()">
                                                    ...
                                                    <%
                                                          try
                                                          {
                                                            results=statement.executeQuery("select work_nature_id,work_nature_desc from COM_MST_WORK_NATURE"); 
                                                            while(results.next()) 
                                                            {
                                  ...
                                  <tr>
                                      ...
                                      <td>                                        
                                        <select name="cmbPrimaryID" id="cmbPrimaryID" onfocus="return officeCheck()" disabled>                                        
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtDOF" maxlength="10" size="10"  onFocus="return officeCheck();javascript:vDateType='3'"  onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <textarea name="txtRemarks" cols="25" rows="5" onfocus="return officeCheck()" disabled><%=strRemarks%></textarea>
                                      </td>
                                  </tr>
                                  <!--<tr>
                                      <td colspan=3 class="tdH" align="center">
                                         
                                          <input type="SUBMIT" value="  Submit  " name="cmdSub" id="cmdSub"> &nbsp;
                            ...
                            <tr>
                                      <td colspan="2">
                                         ...
                                         <tr>
                                            ...
                                            <input type="text" name="txtAdd1" maxlength="50"
                                                   size="40" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="57%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="57%">
                                              <input type="text" name="txtAdd3" maxlength="50" size="25" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                         ...
                                         <tr>
                                            ...
                                            <label style="color:rgb(255,0,0);"> &nbsp;</label></td>
                                            <td width="57%">
                                              <SELECT size=1 name=cmbDistrict onfocus="return officeCheck()" disabled>
                                                  <option value="0">
                                                                                          ----Select
                                                                                          District----
                                                                                    </option>
                                        ...
                                        <tr>
                                            ...
                                            <td width="57%">
                                              <input type="text" name="txtPinCode" maxlength="6" size="6"   onkeypress="return  numbersonly1(event,this)" onchange="return checkpincode();" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr>
                                        </table>
                                        </div>
                                   ...
                                   <div id="contacts" >
                                        ...
                                        <tr>    
                                            ...
                                            <td width="57%">
                                              <input type="text" name="txtSTDCode" maxlength="5" size="6" onkeypress="return  numbersonly1(event,this)" onchange="return checkstd();" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td width="43%">Phone Number </td>
                                            <td width="57%">
                                              <input type="text" name="txtPhoneNo" maxlength="10" size="10" onkeypress="return  numbersonly1(event,this)" onchange="return checkphone();" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            ...
                                            <td width="57%">
                                              <input type="text" name="txtAddPhoneNo"
                                                     maxlength="50" size="30" onkeypress="return  addphone(event)" onchange="return checkaddphone();" onfocus="return officeCheck()" disabled>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td width="43%">FAX Number </td>
                                            <td width="57%">
                                              <input type="text" name="txtFAXNo" maxlength="10" size="10" onkeypress="return  numbersonly1(event,this)" onchange="return checkfax();" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td width="43%">Additional FAX Numbers( seperated&nbsp;by&nbsp;,)<label style="color:rgb(255,0,0);"></label></td>
                                            <td width="57%">
                                              <input type="text" name="txtAddFAXNo" maxlength="50" size="30" onkeypress="return  addphone(event)" onchange="return checkfaxno();" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td width="43%">E-Mail&nbsp;ID</td>
                                            <td width="57%">
                                              <input type="text" name="txtEMail" maxlength="75" size="25" onchange="checkemail()" onfocus="return officeCheck()" disabled/>
                                            </td>
                                        </tr> 
                                        <tr>
                                            ...
                                            <td width="57%">
                                              <textarea name="txtAddEMail" cols="25" rows="4" onchange="addcheckemail()" onfocus="return officeCheck()" disabled></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Office Status </td>
                                            <td><input type=text name=txtofficestatus size=5 disabled>
