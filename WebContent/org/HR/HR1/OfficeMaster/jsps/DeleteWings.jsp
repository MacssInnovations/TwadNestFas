...
<html>
    <head>
      ...
      <title>Delete Wings Details</title>
    
          <!--<link href="../../../../../css/yellow.css" rel="stylesheet" media="screen"/>-->
          <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
          <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
          <script type="text/javascript" src="../scripts/DeleteWings.js"></script>
 ...
 <%
  ...
  %>
 <form name="frmOffice" method="Post" action="../../../../../DeleteWingsDetails.con?command=Add" >
    ...
    <script type="text/javascript" src="test.js"></script>
                ...
                <table  cellspacing="1" cellpadding="3"  width="100%" border="1" class="table">
                    <tr>
                        <td class="tdH">
                            <center><h2>Delete Wings Details</h2></center>
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                              <table  cellspacing="3" cellpadding="1"  width="100%" >
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="txtOffice_Id"  onkeyup="isInteger(this,event)" id="txtOffice_Id" onchange="callServer1('Load','null');checkofficestatus();" tabindex="1" size="4" maxlength="4" onkeypress="return  numbersonly1(event,this)"><img src="../../../../../images/c-lovi.gif" onclick="jobpopup()" alt=""></img>
                                            </td>
                                            <!--<td>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type=text name="txtWing_Name" id="txtWing_Name" tabindex="3" disabled>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>
                                      ...
                                      <td>
                                        <select name="cmbWing_Head" id="cmbWing_Head" tabindex="4" disabled>
                                      <option value=0>--Select Wing Head--</option>
                                      <%
                                                        try
                                                        {
                                                          results=statement.executeQuery("select cadre_id,cadre_name from HRM_MST_CADRE"); 
                                                          while(results.next()) 
                                                          {
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type=text name="txtDateCreated" id="txtDateCreated" maxlength="10" tabindex="5" onFocus="javascript:vDateType='3'" onkeypress="return  calins(event,this)" onblur="return checkdt(this);" disabled>
                           ...
                           alt="Show Calendar"></img>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type=text name="txtPhone_No" id="txtPhone_No" onkeypress="return  numbersonly1(event,this)" tabindex="6" maxlength="10" onchange="return checkphone();" disabled>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>
                                      ...
                                      <td>
                                        <input type=text name="txtFax_No" id="txtFax_No" onkeypress="return  numbersonly1(event,this)" tabindex="7" maxlength="10" onchange="return checkfax();" disabled>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>
                                      ...
                                      <td>
                                        <textarea rows="4" name="Work_Nature" cols="38" id="Work_Nature" tabindex="8" disabled></textarea>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td>
                                      ...
                                      <td>
                                        <input type=text name="txtEmailId" id="txtEmailId" onchange="return ValidateForm()" tabindex="9" disabled>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td colspan=2 >
                                        <div>
                                            <table border=0>
                                                <tr>
                                                    <td>
                                                      <input type="Button" value="  Save " id="Add" onclick="callServer1('Add','null')" name="cmdAdd" tabindex="10" style="display:none"> 
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                      <input type="Button" value="Clear All" onclick="clearAllWing()" name="cmdClearAll" style="display:none">                                 
                                                    </td>
                                                </tr>
                                                </table>
                                          </div>
                                   ...
                                   <!--<div id="mydiv" name="mydiv"> -->
                                    ...
                                    <tr>
                                        <td colspan=8 class="bgClass"><center>
                                            <input type=Submit value=Delete  name="cmbSubmit" id="cmbSubmit" onclick="return nullcheck()"/>
