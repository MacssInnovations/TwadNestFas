...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/OfficeTest.js"></script>
  ...
  {         
   ...
   <table  cellspacing="1" cellpadding="3" width="100%" class="table">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <h3>Edit Office Details</h3>                            
                            </center>
                        </td>
                    </tr>                    
              </table>
  <form action="../../../../../NewServletUpdateOfficeDetails.con" name="frmOffice" method="POST" onsubmit="return nullcheck()">
  ...
  <table cellspacing="3" cellpadding="1" width="100%">
        ...
        <tr>
            <td>Enter Temporary Office Id:</td>
        ...
        <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <input type="text" name="txtShortName" maxlength="30" size="40" onfocus="return officeCheck()"/>
                                      </td>
                                  </tr> 
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <textarea name="txtRemarks" cols="25" rows="5" onfocus="return officeCheck()"><%=strRemarks%></textarea>
                                      </td>
                                  </tr>
                                  <!--<tr>
