...
<html>
  <head>
    ...
    <title>Validate Redepolyment of an office</title>    
    <!--<script type="text/javascript" src="../../../../Library/scripts/selectOffice.js">
    </script>-->
    <script type="text/javascript" src="../scripts/ValidateselectAttachedOffice.js">
    </script>
    <script type="text/javascript" src="../scripts/ValidateRedeploymentOffice.js">
    </script>
...
%>
  <form name="frmClosure" method="POST" action="../../../../../ValidateRedeploymentServlet.con" onsubmit="return nullCheckRedeployment()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Validate Redeployment of an Office</b></center>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtcontrolling" id="txtcontrolling" readonly>
                    </td>
                </tr>
                <tr>
                  ...
                  <table>
                                        ...
                                        <tr>                                            
                                            ...
                                            <input type="text" name="txtAttachedOfficeID" maxlength="6" size="6"
                                                   onchange="loadOffice1(document.frmClosure.txtAttachedOfficeID.value,'attach');return checkAttachedoffice()" onclick="return officeCheck()" onkeypress="return  numbersonly1(event,this)"/>
                                            </td>
                                            <td>
                                                <SELECT size=1
             ...
             <option value=0>---Select Office---</option>
              ...
              %>
                ...
                <!--<tr>
                                ...
                                <tr>
                                    <td>Record Status<label style="color:rgb(255,0,0);"> &nbsp;*</label></td>
                                    <td>
