...
<html>
  <head>
    ...
    <title>Office Attachment</title>
    <script type="text/javascript" src="../scripts/NewOfficeAttachmentValidation.js" >    
    </script>
 ...
 %>
  ...
  <table  cellspacing="1" cellpadding="3" width="100%">
                    <tr>
                        <td class="tdH">
                            <center>                           
                            <b>Create Attachment of an Office </b>                            
                            </center>
                        </td>
                    </tr>  
                    ...
                    <tr>
                    <td>
        <form name="frmConversion" method="POST" action="../../../../../NewAttachmentServlet.con" onsubmit="return nullcheck()" >                
                                        ...
                                        <tr>                                            
                                            <td>
                                                <input type="text" name="txtOffice_Id" maxlength="4" size="6"
                                                       onchange="loadOffice(document.frmConversion.txtOffice_Id.value);checkofficestatus();return checkoffice();" onkeypress="return  numbersonly1(event,this)"/>
