...
<html>
  <head>
    ...
    <title>Create Redepolyment of an office</title>    
    ...
    <script type="text/javascript" src="../scripts/NewRedeploymentOffice.js">
    </script>
    <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    <script type="text/javascript" src="../../../../Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/RedeploymentDateCheck.js"></script>
...
%>
  <form name="frmClosure" method="POST" action="../../../../../NewRedeploymentOffice.con" onsubmit="return nullCheckRedeployment()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Create Redeployment of an Office</b></center>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td width="64%">
                    <table>
                                        ...
                                        <tr>                                            
                                            <td>
                                                <input type="text" name="txtOffice_Id" id="txtOffice_Id" maxlength="4" size="6" onchange="loadOffice(document.frmClosure.txtOffice_Id.value,'nothing');OfficeLevel();existingOffice();checkofficestatus();return checkoffice();" onkeypress="return  numbersonly1(event,this)"/>
                ...
                <tr>
                   ...
                   <tr>
                        <td>New Office Id</td>
                        <td><input type=text name="txtnewOffice" disabled style="background-color: #ececec">(System Generated)
                   </tr>
                   <tr>
                <td>New Office Name <label style="color:rgb(255,0,0);">&nbsp;*</label></td>
                <td>
                    <input type=text name="txtNewOfficeName" size="40" onclick="return officeCheck()">
                </td>
                </tr>
                <tr>
                <td>New Office Short Name <label style="color:rgb(255,0,0);">&nbsp;*</label></td>
                <td>
                    <input type=text name="txtNewOfficeShortName" size="40" onclick="return officeCheck()" >
                </td>
                </tr>
                  ...
                  <table>
                                        ...
                                        <tr>                                            
                                            ...
                                            <input type="text" name="txtAttachedOfficeID" maxlength="6" size="6"
                                                   onchange="loadOffice1(document.frmClosure.txtAttachedOfficeID.value,'attach');" onclick="return officeCheck()" onkeypress="return  numbersonly1(event,this)"/>
                                            </td>
                                            <td>
                                                <SELECT size=1
                                                        name="cmbAttachedOfficeLevel" id="cmbAttachedOfficeLevel"
                                                        onchange="getAttachOfficesByLevel(this.form.name)" onclick="return officeCheck()">   
                                                <option value=0>
                                                        ----Select
                                                        OfficeLevel----
                                                    </option>
               ...
               <!-- <tr>
                ...
                <tr>
                    ...
                    <td>
                    <select name="cmbSecondaryID" id="cmbSecondaryID" onclick="return officeCheck()">                                        
                                            <option value="0">
                                                       ----Select Work Nature----
                                                  </option>
                                            <%
                ...
                <tr>
                  ...
                  <td width="64%">
                    <input type="text" name="txtDateOfRedepolyment" size="10" maxlength="10"
                           onFocus="javascript:vDateType='3'"  onkeypress="return  calins(event,this)" onblur="checkdt(this)" onclick="return officeCheck()"/>        
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtDateOfRelieval" maxlength="10" onFocus="javascript:vDateType='3';return officeCheck()"  onkeypress="return  calins(event,this)" onblur="return checkdt(this)" > <!--checkdt() & calins() in comJS.js **** -->
                        <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmClosure.txtDateOfRelieval);" alt="Show Calendar"></img> <!--CalenderControl.js   NOT in library-->
                ...
                <tr>
                    ...
                    <td>
                        <input type=text name="txtDateOfJoining" maxlength="10" onFocus="javascript:vDateType='3';return officeCheck()"  onkeypress="return  calins(event,this)" onblur="return checkdt(this)" >
                        <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.frmClosure.txtDateOfJoining);" alt="Show Calendar"></img>
                ...
                <tr>
                    <td>Remarks</td>
                    <td>
                    <textarea cols="20" rows="5" name="txtRemarks" onclick="return officeCheck()"></textarea>
                    </td>
                </tr>
                
                <tr>
         <td width="36%">Accounts Transfer To
          <label style="color:rgb(255,0,0);">
                    &nbsp;
          </label>
         </td>
         <td width="64%">
           <select name="acc_unit_id" id="acc_unit_id" size="1" onfocus="return officeCheck()">
              ...
              <%
                ...
                try
                {
                String sql="select accounting_unit_id,accounting_unit_name from fas_mst_acct_units order by accounting_unit_id";
                ps=connection.prepareStatement(sql);
                rs1=ps.executeQuery();
                
                 while(rs1.next())
                 {
                    acc_unit_id=rs1.getInt("accounting_unit_id");
                    acc_unit_name=rs1.getString("accounting_unit_name");
                    
                    out.println("<option value="+acc_unit_id+">"+acc_unit_name+"-("+acc_unit_id+")</option>");
                 }
                }
                catch(Exception e)
                {
        ...
        <td align="center" class="tdH">
            <input type="submit" value="Confirm Redeployment" name=submit>
