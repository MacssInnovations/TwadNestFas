...
<html>
  <head>
    ...
    <title>EditNomenClatureChange</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/EditNomenClatureChange.js"></script>
 ...
 %>
  <form action="../../../../../EditNomenClatureChange.con" name="frmNomenClature" method="post" onsubmit="return nullCheck()">
  <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Edit Office Nomenclature Change</b></center>
            </td>
        </tr>
        <tr>
            <td class="tdH">
