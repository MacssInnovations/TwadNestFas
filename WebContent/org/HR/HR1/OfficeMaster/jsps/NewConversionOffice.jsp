...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/NewConversionValidation.js" >    
    </script>    
  ...
  <table  cellspacing="1" cellpadding="3" width="100%">
        ...
        <form name="frmConversion" method="POST" action="" onsubmit="return nullcheck()" >                
                            <table  cellspacing="3" cellpadding="1"  width="100%"
                                  ...
                                  <tr>
                                      <td class="td">New&nbsp;Nature of Work  
