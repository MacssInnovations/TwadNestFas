...
<html>
  <head>
    ...
    <title>Edit Closure of an office</title>    
    ...
    <script type="text/javascript" src="../scripts/EditClosureOfOffice.js">
    </script>
...
w.close();
 ...
 %>
  <form name="frmClosure" method="POST" action="../../../../../EditServletClosureOfOffice.con" onsubmit="return nullCheckMaster()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Edit Closure Of An Office</b></center>
            </td>
        </tr>
        <tr>
            <td>
