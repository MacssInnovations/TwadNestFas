...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/JobPopupJS_RLV.js">    </script>
    <script type="text/javascript"            src="../scripts/controllingOfficeContactPopupJS_RLV.js"></script>
    <link href="../../../../../css/Sample3.css" rel="stylesheet"           media="screen"/>
  </head>
  <body  ondragstart = "return false" onselectstart = "return false" >
  <form name="HRM_JobSearch" id="HRM_JobSearch" method="POST">
      <p>
        <%
   String offlevel="";
            int  oid=0;
           ...
           try
          {
            ...
            rs1=ps.executeQuery();
                 if(rs1.next()) 
                 {
                    ...
                    System.out.println("the office id is"+oid);
                 
                 }
            rs1.close();
            ps.close();
                    
             ps=connection.prepareStatement("select office_id,OFFICE_LEVEL_ID from COM_MST_ALL_OFFICES_VIEW where OFFICE_ID=?" );
            ps.setInt(1,oid);
            rs1=ps.executeQuery();
                 if(rs1.next()) 
                 {
                    offlevel=rs1.getString("OFFICE_LEVEL_ID");
                    System.out.println("the office level is"+offlevel);
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="tdH">
          <td>
            ...
            <br></br>-->
            <input type="radio" name="optoff" id="optcoffice" onclick="funclosedoffice()" disabled="disabled"></input>
        ...
        <tr>
          <td>
            ...
            <input type="hidden" name="offid" id="offid" value="<%=oid%>">
            <div align="center" id="divhier" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
             
             <% if(offlevel.equalsIgnoreCase("HO"))
                {
                System.out.println("inside Ho Office"+offlevel);
                %>
                <tr class="table">
                  <td>
        ...
        %>
                ...
                %>
                  ...
                  <%   if(offlevel.equalsIgnoreCase("RN"))
                {
                System.out.println("inside RN Office"+offlevel);
                %>
                <tr class="table">
                  <td>
                    <div align="left">Select Office Level</div>
           ...
           try
           {
           ps=connection.prepareStatement("select OFFICE_LEVEL_ID,OFFICE_LEVEL_NAME from COM_MST_OFFICE_LEVELS  where OFFICE_LEVEL_ID not in ('HO','RN','SN')  order by HIERARCHICAL_SEQUENCE");
            rs=ps.executeQuery();
             String strcode="";
            String strname="";          
            while(rs.next())
        ...
        %>
           ...
           <%   if(offlevel.equalsIgnoreCase("CL"))
                {
                System.out.println("inside CL Office"+offlevel);
                %>
                <tr class="table">
                  <td>
                    <div align="left">Select Office Level</div>
           ...
           try
           {
           ps=connection.prepareStatement("select OFFICE_LEVEL_ID,OFFICE_LEVEL_NAME from COM_MST_OFFICE_LEVELS  where OFFICE_LEVEL_ID not in ('HO','RN','AW','CL','SN')  order by HIERARCHICAL_SEQUENCE");
            rs=ps.executeQuery();
             String strcode="";
            String strname="";          
            while(rs.next())
        ...
        %>
           ...
           <%   if(offlevel.equalsIgnoreCase("LB"))
                {
                System.out.println("inside LB Office"+offlevel);
                %>
                <tr class="table">
                  <td>
                    <div align="left">Select Office Level</div>
           ...
           try
           {
           ps=connection.prepareStatement("select OFFICE_LEVEL_ID,OFFICE_LEVEL_NAME from COM_MST_OFFICE_LEVELS  where OFFICE_LEVEL_ID not in ('HO','RN','AW','CL','DN','SN')  order by HIERARCHICAL_SEQUENCE");
            rs=ps.executeQuery();
             String strcode="";
            String strname="";          
            while(rs.next())
        ...
        %>
           ...
           <%   if(offlevel.equalsIgnoreCase("DN"))
                {
                System.out.println("inside DN Office"+offlevel);
                %>
                <tr class="table">
                  <td>
                    <div align="left">Select Office Level</div>
        ...
        %>
                      ...
                      <table>
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                            <div id="divaudit" style="visibility:hidden">Internal Audit Wing</div>
                          </td>
                          <td>
                            <div id="divdivision" style="visibility:hidden">Division</div>
                          </td>
                           <td>
                            <div id="divlab" style="visibility:hidden">Lab</div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <select name="cmbregion" id="cmbregion"
                                    ...
                                    onchange="getCircle();getAudit()"></select>
                          </td>
                          <td>
                            <select name="cmbcircle" id="cmbcircle"
                                    style="visibility:hidden"
                                    onchange="getDivision();getLab()"></select>
                          </td>
                           <td>
            ...
            <div align="center" id="divofflevel" style="display:none">
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                  ...
                  <td rowspan="2">
                    ...
                    <select size="1" name="cmbControllingLevel"
                      ...
                      <%
                                                      try
                                                      {
                                                        ps=connection.prepareStatement("select Office_Level_Id,Office_Level_Name from COM_MST_OFFICE_LEVELS WHERE  OFFICE_LEVEL_ID not in ('HO','RN','SN','CL') order by HIERARCHICAL_SEQUENCE");
                                                        results=ps.executeQuery(); 
                                                        while(results.next()) 
                                                        {
                                                            out.print("<option value='" + results.getString("Office_Level_Id") + "'>" + results.getString("Office_Level_Name") + "</option>");                      
               ...
               <% if(offlevel.equalsIgnoreCase("AW"))
                {
                System.out.println("inside AW Office"+offlevel);
                %>
                <tr class="table">
                  <td rowspan="2">
                    Office Level
                    <select size="1" name="cmbControllingLevel"
                      ...
                      <%
                                                      try
                                                      {
                                                        ps=connection.prepareStatement("select Office_Level_Id,Office_Level_Name from COM_MST_OFFICE_LEVELS WHERE  OFFICE_LEVEL_ID not in ('HO','RN','SN','CL','AW') order by HIERARCHICAL_SEQUENCE");
                                                        results=ps.executeQuery(); 
                                                        while(results.next()) 
                                                        {
                                                            out.print("<option value='" + results.getString("Office_Level_Id") + "'>" + results.getString("Office_Level_Name") + "</option>");                      
                  ...
                  <td rowspan="2">
                    ...
                    <select size="1" name="cmbControllingLevel"
                      ...
                      <%
                                                      try
                                                      {
                                                        ps=connection.prepareStatement("select Office_Level_Id,Office_Level_Name from COM_MST_OFFICE_LEVELS WHERE  OFFICE_LEVEL_ID not in ('HO','RN','SN','CL','AW','LB') order by HIERARCHICAL_SEQUENCE");
                                                        results=ps.executeQuery(); 
                                                        while(results.next()) 
                                                        {
                                                            out.print("<option value='" + results.getString("Office_Level_Id") + "'>" + results.getString("Office_Level_Name") + "</option>");                      
                  ...
                  <td rowspan="2">
                    ...
                    <select size="1" name="cmbControllingLevel"
                      ...
                      <%
                                                      try
                                                      {
                                                        ps=connection.prepareStatement("select Office_Level_Id,Office_Level_Name from COM_MST_OFFICE_LEVELS WHERE  OFFICE_LEVEL_ID not in ('HO','RN','SN','CL','AW','LB','DN') order by HIERARCHICAL_SEQUENCE");
                                                        results=ps.executeQuery(); 
                                                        while(results.next()) 
                                                        {
                                                            out.print("<option value='" + results.getString("Office_Level_Id") + "'>" + results.getString("Office_Level_Name") + "</option>");                      
                  ...
                  <td  align="left">Closed Office</td>
                   <td align="left">
                    <select name="cmbClosedOffice" id="cmbClosedOffice"  >
                      <option value="0">--- Select Closed Offcie ---</option>
                      <%
                           rs=null;
                           try
                           {
