...
function OfficeLevelResponse(req)
   ...
   //alert('hai');
                ...
                if((document.frmOffice.txtOff_Name.value=="") || (document.frmOffice.txtOff_Name.value.length<=0))
                  ...
                  /*if((document.frmOffice.cmbRecordStatus.value=="0") || (document.frmOffice.cmbRecordStatus.selectedIndex<=0))
                  {
                      alert("Please Select Record Status");
                      document.frmOffice.cmbRecordStatus.focus();
                      return false;
                  } */ 
            return true;
        }
...
function officedetails(ctlOffice)
{
        ...
        else
        {
            ...
            //alert(officeid);
            var url="../../../../../ServletValidateOfficeTest.con?officeid="+officeid;
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
            {
        ...
        if(req.readyState==4)
            {
                  ...
                  {      
                        ...
                        if(flag=="success")
                        {
                            ...
                            if(RecordStatus=="FR" && RecordStatus!="null")
                            {
                           // document.frmOffice.cmbRecordStatus.value=RecordStatus;
