...
//alert('loadoffice');
    ...
    else
    {
            ...
            var url="../../../../../ServletLoadOfficeDetails_Validate?ID="+id;            
          ...
          stopwaiting(document.frmConversion) ;
                ...
                if(flag=="success")
                {
                    ...
                    document.frmConversion.cmbPrimaryID.value=primaryid;
                      ...
                      //  document.frmConversion.cmbRecordStatus.value=recordstatus;
...
//alert(document.frmConversion.txtAttachedOfficeID.value);
    ...
    /*if((document.frmConversion.cmbRecordStatus.value==0) || (document.frmConversion.cmbRecordStatus.length<=0))
    {
        alert("Please Select RecordStatus");
        document.frmConversion.cmbRecordStatus.focus();
        return false;
