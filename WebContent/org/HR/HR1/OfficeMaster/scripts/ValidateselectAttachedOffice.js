// code for selecting the controlling office
    ...
    function getAttachOfficesByType(frmName)
    {
        ...
        if(type!=0)
        {
            ...
            eval("document." + frmName+".cmbSelectAttachOffice.style.visibility='visible'"); 
    ...
    function getAttachOfficesByLevel(frmName)
    {
        ...
        if(levelt=="Division" || levelt=="Sub-Division" || levelt=="Section" )
        {
            ...
            eval("document." + frmName+".cmbSelectAttachOffice.style.visibility='hidden'");            
            try
            {
    ...
    function selectAttachOffice(frmName,txtBoxName)
    {
        ...
        var ctlOfficeName=eval("document." + frmName + ".cmbSelectAttachOffice.options[document." + frmName + ".cmbSelectAttachOffice.selectedIndex].text");        
        if(ctlOffice!=0)
        {
            eval("document." + frmName + "." + txtBoxName + ".value=ctlOffice");
            document.frmClosure.txtNewControllingOfficeName.value=ctlOfficeName;
            var din=document.getElementById("divType2");
            din.style.visibility="hidden";
            eval("document." + frmName+".cmbSelectAttachOffice.style.visibility='hidden'");
            checkAttachedoffice();
