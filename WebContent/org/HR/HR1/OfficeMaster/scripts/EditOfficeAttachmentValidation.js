        ...
        if(req.readyState==4)
        {
          ...
          stopwaiting(document.frmConversion) ;
                ...
                if(flag=="success")
                {
                    ...
                    //ExistingOffice(document.frmConversion.txtExistOfficeId.value);
                    //alert('checkofficeresponse'+document.frmConversion.txtAttachedOfficeID.value);
                    loadOffice1(document.frmConversion.txtAttachedOfficeID.value);
