...
function nullCheck()
{
    ...
    if((document.frmNomenClature.txtNewOfficeName.value=="")||(document.frmNomenClature.txtNewOfficeName.length<=0))
    {
        alert("Please Enter New Office Name");
        document.frmNomenClature.txtNewOfficeName.focus();
        return false;
    }
    
    if((document.frmNomenClature.txtNewShortName.value=="")||(document.frmNomenClature.txtNewShortName.length<=0))
    {
        alert("Please Enter New Short Office Name");
        document.frmNomenClature.txtNewShortName.focus();
        return false;
    }
    if((document.frmNomenClature.cmbSecondaryID.value=="0")||(document.frmNomenClature.cmbSecondaryID.value.length<=0))
    {
        
        alert("Please Select Work Nature");
        document.frmNomenClature.cmbSecondaryID.focus();
        return false;
    }
    if((document.frmNomenClature.txtDateOfNomen.value=="")||(document.frmNomenClature.txtDateOfNomen.length<=0))
    {
        alert("Please Enter Date of Nomen");
        document.frmNomenClature.txtDateOfNomen.focus();
        return false;
    }
    if((document.frmNomenClature.txtDateOfRelieval.value=="")||(document.frmNomenClature.txtDateOfRelieval.length<=0))
    {
        alert("Please Enter Relieval Date");
        document.frmNomenClature.txtDateOfRelieval.focus();
        return false;
    }
    if((document.frmNomenClature.txtDateOfJoining.value=="")||(document.frmNomenClature.txtDateOfJoining.length<=0))
    {
        alert("Please Enter Joining Date");
        document.frmNomenClature.txtDateOfJoining.focus();
        return false;
    }
    return true;
        ...
        if(req.readyState==4)
        {
          ...
          {     
                ...
                if(flag=="success")
                {
                    ...
                    document.frmNomenClature.txtDateOfRelieval.value="";
                    document.frmNomenClature.txtDateOfJoining.value="";
          ...
          {         
               ...
               // alert(req.responseTEXT);
                ...
                else if(flag=="success")
                {
                       ...
                       /*var con=confirm("The following offices will also be attached to the new Office.Is it Ok");
                       if(con==false)
                       {
                        window.open('','_parent',''); 
                    window.close(); 
        ...
        if(req.readyState==4)
        {
          ...
          {      
                ...
                if(flag=="success")
                {
                    ...
                    var dateJoining=response.getElementsByTagName("dateJoining")[0].firstChild.nodeValue;
                    ...
                    document.frmNomenClature.txtDateOfRelieval.value=dateRelieval;
                    document.frmNomenClature.txtDateOfJoining.value=dateJoining;
                    
                    if(relievalSession == "FN")
                    document.frmNomenClature.rad_Relieval[0].checked = true;
                    else
                    document.frmNomenClature.rad_Relieval[1].checked = true;

                    if(joinSession == "FN")
                    document.frmNomenClature.rad_Joining[0].checked = true;
                    else
                    document.frmNomenClature.rad_Joining[1].checked = true;
...
function check1()
{
    var from=document.frmNomenClature.txtDateOfFormation.value;
    var to=document.frmNomenClature.txtDateOfNomen.value;
    //check(from,to);
    check5(from,to);
...
function check(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     //alert("todate"+todate);
     var todate=document.frmNomenClature.txtDateOfFormation.value;
     var fday=document.frmNomenClature.txtDateOfNomen.value.split("/");
     var todate=todate;
     //alert("todate"+todate);
     var frmDay = fday[0];
     var frmMonth = fday[1];
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (frmday>today)
	     {
		   alert ("Date of NomenClature Should Not Be GreaterThan Date of Formation");
                   document.frmNomenClature.txtDateOfNomen.focus();
		   //todate.value=""
		   //todate.focus();
...
function check5(c,todate)
{
  //alert('inside date');
     ...
     var todate=document.frmNomenClature.txtDateOfFormation.value;
     //alert('todate...'+todate);
     var fday=document.frmNomenClature.txtDateOfNomen.value;
     //alert('nomen date...'+fday);
     
     var tday=todate.split("/");
     var toDay = tday[0];
     var toMonth= tday[1];
     var toYear = tday[2];
     
     var nomdat=fday.split("/");
     var nomDay = nomdat[0];
     var nomMonth= nomdat[1];
     var nomYear = nomdat[2];
         ...
         if(nomDay>=toDay)
         {
          if(nomMonth>=toMonth)
           return true;
            ...
            {
            //alert('ok')
            alert ("Date of NomenClature Should Be GreaterThan Date of Formation");
            document.frmNomenClature.txtDateOfNomen.focus();
            document.frmNomenClature.txtDateOfNomen.value="";
            return false;
            }
         }
         else if(nomDay<toDay)
         {
          if(nomMonth>toMonth)
           {
           //alert('a');
