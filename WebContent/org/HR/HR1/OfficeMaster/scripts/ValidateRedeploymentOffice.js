...
//START - ADDED PART 
                    ...
                    if(accounts=="disable")
                    {
                        document.frmClosure.acc_unit_id.selectedIndex=0;
        ...
        if(req.readyState==4)
        {
              ...
              {   
                ...
                if(flag=="success")
                {
                    ...
                    var dateRedeploy=response.getElementsByTagName("dateRedeploy")[0].firstChild.nodeValue;
                    ...
                    document.frmClosure.txtDateOfRedepolyment.value=dateRedeploy;
                    document.frmClosure.txtDateOfRelieval.value=dateRelieval;
                    document.frmClosure.txtDateOfJoining.value=dateJoining;
                    document.frmClosure.txtRemarks.value=remarks;
...
function CheckAttachedOfficeResponse(req)
{
        if(req.readyState==4)
        {
          ...
          stopwaiting(document.frmClosure) ;
                ...
                if(flag=="success")
                {
                    alert("This Office is Closed, So did't Redeployed");
                    document.frmClosure.submit.disabled=true;
                    return false;
