...
//alert("Callserver Called"+command);
    ...
    if(command=="Load")
    {
        ...
        //alert(Office_Id);
        url="../../../../../ServletOfficeWing.con?command=Load&OfficeId="+Office_Id;
        //alert(url);
   ...
   else if(command=="Add")
    {
        ...
        var txtheadwing=document.createTextNode(Head_Wing1);
    ...
    else if(command=="Update")
    {
        ...
        cells.item(1).firstChild.nodeValue=document.frmOffice.txtWing_Name.value;
        cells.item(1).lastChild.value=document.frmOffice.txtWing_Name.value;
        
        cells.item(2).firstChild.nodeValue=document.frmOffice.cmbWing_Head.options[document.frmOffice.cmbWing_Head.selectedIndex].text;
        cells.item(2).lastChild.value=document.frmOffice.cmbWing_Head.value;
        
        cells.item(3).firstChild.nodeValue=document.frmOffice.txtDateCreated.value;
        cells.item(3).lastChild.value=document.frmOffice.txtDateCreated.value;
        
        cells.item(4).firstChild.nodeValue=document.frmOffice.txtPhone_No.value;
        cells.item(4).lastChild.value=document.frmOffice.txtPhone_No.value;
        
        cells.item(5).firstChild.nodeValue=document.frmOffice.txtFax_No.value;
        cells.item(5).lastChild.value=document.frmOffice.txtFax_No.value;
        
        cells.item(6).firstChild.nodeValue=document.frmOffice.Work_Nature.value;
        cells.item(6).lastChild.value=document.frmOffice.Work_Nature.value;
        
        cells.item(7).firstChild.nodeValue=document.frmOffice.txtEmailId.value;
        cells.item(7).lastChild.value=document.frmOffice.txtEmailId.value;
        var slno=slnocheck();
        //document.frmOffice.txtSl_No.value=++slno;
    ...
    {
        Office_Id=document.frmOffice.txtOffice_Id.value;
        url="../../../../../ServletOfficeWing.con?command=SlNo&OfficeId="+Office_Id;
        //alert(url);
        var req=getTransport();
        req.open("POST",url,true);        
        req.onreadystatechange=function()
    ...
    {
        Office_Id=document.frmOffice.txtOffice_Id.value;
        url="../../../../../ServletOfficeWing.con?command=TableView&OfficeId="+Office_Id;
        //alert(url);
        var req=getTransport();
        req.open("POST",url,true);        
        req.onreadystatechange=function()
                ...
                if(req.status==200)
                {
                      ...
                      else
                      {
                          ...
                          for(var i=0;i<value.length;i++)
                          {
                              ...
                              {
                                document.frmOffice.txtDateOfFormation.value=date;
                                document.frmOffice.txtHDateOfFormation.value=date;
                              }
                              /*if(Phone!="null")
                              {
...
// code for loading the values from the table to the input boxes
    ...
    //alert("hai");
      ...
      document.frmOffice.cmbWing_Head.value=rcells.item(2).lastChild.value;
                    ...
                    var recordstatus=response.getElementsByTagName("recordstatus")[0].firstChild.nodeValue;
                       ...
                       else
                       {
                            if((recordstatus=="CR") || (recordstatus=="MD"))
                            {
                                ...
                                document.frmOffice.cmbDistrict1.selectedIndex=0;
                                document.frmOffice.txtDateOfFormation.value="";
                                var tbody=document.getElementById("tblList");
                                var t=0;
                                 for(t=tbody.rows.length-1;t>=0;t--)
                                 {
...
function officelevel()
{
    ...
    var officeid=document.frmOffice.txtOffice_Id.value;
    url="../../../../../ServletWingOfficeLevel.con?OfficeId="+officeid;
    //alert(url);
    var req=getTransport();
    req.open("GET",url,true);         
    req.onreadystatechange=function()
...
function CheckLevel(req)
{
        if(req.readyState==4)
        {
          ...
          {     
                ...
                if(flag=="success")
                {
                    var levelid=response.getElementsByTagName("levelid")[0].firstChild.nodeValue;
                    //alert(levelid);
                    if((levelid=="CL") || (levelid=="SD") || (levelid=="DN"))
                    {
                        alert("Wings are applicable only for HeadOffice and Region Level Offices");
                        window.open('','_parent','');                
                        window.close(); 
                        window.opener.focus();
                    }
...
function check1()
{
    var from=document.frmOffice.txtDateOfFormation.value;
    var to=document.frmOffice.txtDateCreated.value;
...
function check(c,todate)
{
   ...
   // document.workdemand.elements["txt_from"+c].value=""
     ...
     //alert("todate"+todate);
     var todate=document.frmOffice.txtDateOfFormation.value;
     var fday=document.frmOffice.txtDateCreated.value.split("/");
     var todate=todate;
     //alert("todate"+todate);
     var frmDay = fday[0];
     var frmMonth = fday[1];
    ...
    /* var frmDay = document.workdemand.elements["txt_from"+c].value.substr(0,2);
	 ...
	 var today=new Date(toYear,toMonth-1,toDay);
       ...
       if (frmday<today)
	     {
		   alert ("Date Created Should Not Be LesserThan DateOfFormation");
                   document.frmOffice.txtDateCreated.value="";
                   document.frmOffice.txtDateCreated.focus();
		   return false;
