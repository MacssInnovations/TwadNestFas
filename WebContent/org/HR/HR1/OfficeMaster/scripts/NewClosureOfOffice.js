...
function nullCheckMaster()
{
    ...
    /*
    if(document.frmClosure.hid_level.value=="SD")
    {
      return true;
    }
    else
    {
      ...
      alert('Please Select Account Transfer Office Id');
      return false;
    }
    */
    return true;
...
function checkofficestatus()
{
            ...
            startwaiting(document.frmClosure) ;
           // alert(officeid);
            url="../../../../../ServletClosureCheck.con?OfficeId="+officeid;
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
            {
        ...
        if(req.readyState==4)
        {
          ...
          {     
                ...
                if(flag=="success")
                {
                    ...
                    document.frmClosure.txtOfficeAddress.value="";
                    document.frmClosure.txtDateOfFormation.value="";
                    document.frmClosure.HDateOfFormation.value="";
                    document.frmClosure.txtClosureDate.value="";
                    document.frmClosure.txtRemarks.value="";
                    //document.frmClosure.txtExistOfficeName.value="";
                   // document.frmClosure.txtExistOfficeAddress.value="";
                    ...
                    //attachofficeid.selectedIndex=0;
...
function checkLevel()
{
  ...
  else if(accUnit)                          //CHANGED.. else      - accUnit=true iff the office is an Accounting Unit
  {
    document.frmClosure.acc_unit_id.disabled=false;
  }
}