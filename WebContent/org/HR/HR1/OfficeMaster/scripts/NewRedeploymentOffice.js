...
function nullCheckRedeployment()
{
    ...
    else
    {
        ...
        var con=confirm("The following subdivision offices will also be Redeployed and attached to the new Office.Is it Ok");
        if(con==false)
           {
            window.open('','_parent',''); 
            window.close(); 
           //window.opener.focus();
            ...
            else
            {
                ...
                if((document.frmClosure.txtDateOfRelieval.value=="") || (document.frmClosure.txtDateOfRelieval.value.length<=0))
                {
                     alert("Please Enter DateOfRelieval");
                     document.frmClosure.txtDateOfRelieval.focus();
                     return false;
                } 
                if((document.frmClosure.txtDateOfJoining.value=="") || (document.frmClosure.txtDateOfJoining.value.length<=0))
                {
                     alert("Please Enter DateOfJoining");
                     document.frmClosure.txtDateOfJoining.focus();
                     return false;
                } 
...
//alert('hai');
            ...
            startwaiting(document.frmClosure) ;
           // alert(officeid);
            url="../../../../../ServletCheckRedeployment.con?OfficeId="+officeid;
            var req=getTransport();
            req.open("GET",url,true);         
            req.onreadystatechange=function()
            {
