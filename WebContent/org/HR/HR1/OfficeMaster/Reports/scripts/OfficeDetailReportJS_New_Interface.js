...
function getRegion()
    {
      //  alert(regionflag);
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=region" ;
        //alert(url);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=division&circles="+circle;
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../OfficeAbsDetailReportServ_New_Interface";
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?desigs="+desig;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkdesig)
      ...
      //alert("1");
        ...
        //      alert("2");
                            ...
                            var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?ranks="+rank;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkcadre)
      ...
      //alert("1");
             ...
             // alert("2");
                            ...
                            var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?cadres="+cadre;
                            }
               }
        }  
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../OfficeAbsDetailReportServ_New_Interface?OLevel=offtype" ;
         //alert(url);
