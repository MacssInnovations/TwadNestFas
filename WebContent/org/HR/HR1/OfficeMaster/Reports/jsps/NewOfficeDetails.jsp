...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/NewOfficeDetails.js"></script>
  ...
  <body>
        ...
        <form name="frmVacantRep" method="POST" action="">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Office&nbsp;Details Report</strong></td>
                </tr>
                <tr>
                 ...
                 <tr id="troffice" style="display:none">
                  <td class="table" align="left">
                    <div id="divalloffice" onclick="hideoffice()"
                         style="cursor:hand">
                      <input type="radio" name="optoffice" id="optoffice" checked="checked"></input>All
                                                                                     Offices
                    </div>
                  </td>
                  <td class="table" align="left">
                    <div id="divspecificoffice" onclick="showoffice()"
                         style="cursor:hand">
                      <input type="radio" name="optoffice" id="optoffice"></input>Specific Offices
