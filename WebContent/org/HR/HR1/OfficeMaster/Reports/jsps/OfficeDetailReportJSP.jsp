...
<html>
  <head>
    ...
    <title>Directory of Offices - Detailed</title>
    ...
    <script type="text/javascript" src="../scripts/OfficeDetailReportJS.js"></script>
              ...
              <div align="left">
                ...
                <!--  <input type="radio" name="optoffdetail" value="REGIONABS"
                  ...
                  <input type="radio" name="optoffdetail" value="REGIONDETAIL"
                         onclick="activatespecific()" checked="checked"/>
                   Details of Region
                </p>
              </div>
            </td>
          ...
          <tr class="table">
            <td>
              <div align="left">
                ...
                <p>
                   <input type="HIDDEN" name="optsel" value="DETAILS">
