...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ClosedOfficesReport.js"></script>
    ...
    <title>List of Closed Offices Report</title>
  </head>
  <body class="table">
  <form action="../../../../../../ClosedOfficeServlet.con" name=frmReport method=post onsubmit="return nullcheck()"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>List of Closed Offices</b></center></td>
        </tr>
          <tr>
            <td>
