...
<html>
  <head>
    ...
    <title> Directory of Office - Detailed</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/OfficeDetailReportJS_New_Interface.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../OfficeAbsDetailReportServ_New_Interface">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Directory of Office - Detailed</strong></td>
                </tr>
