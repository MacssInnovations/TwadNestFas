...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/RedeployedOfficesReport.js"></script>
    ...
    <title>List of Redeployed Offices Report</title>
  </head>
  <body class="table">
  <form action="../../../../../../RedeployedOfficeServlet.con" name=frmReport method=post onsubmit="return nullcheck()"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>List of Redeployed Offices</b></center></td>
        </tr>
          <tr>
            <td>
