...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/NewOfficesCreationReport.js"></script>
    ...
    <title>List of New Offices Report</title>
  </head>
  <body class="table">
  <form action="../../../../../../NewOfficeCreationReport.con" name=frmReport method=post onsubmit="return nullcheck()"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>List of New Offices Report</b></center></td>
        </tr>
          <tr>
            <td>
