...
<html>
  <head>
    ...
    <title>List of Attached Offices Report</title>
  </head>
  <body class="table">
  <form action="../../../../../../AttachedOfficeServlet.con" name=frmReport method=post onsubmit="return nullcheck()"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>List of Attached Offices</b></center></td>
        </tr>
          <tr>
            <td>
