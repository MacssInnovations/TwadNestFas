...
<html>
  <head>
    ...
    <title>Master HRM Languages Details</title>
  </head>
  <body>
  <%
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr>
          <td colspan="2" class="tdH">
            <div align="center">
              <strong>Languages Details</strong>
            </div></td>
        </tr>
        <tr>
          <td class="table">Language Code</td>
          <td class="table">
         
                   <input type="TEXT" name="htxtLangCode" maxlength="3"
                   id="htxtLangCode" readonly/>System Generated
          </td>
        </tr>
        <tr>
          <td class="table">Language  Name</td>
          <td class="table">
            <input type="text" name="txtLangName" size="40" maxlength="25"
                   id="txtLangName"/>
          </td>
        </tr>
       <tr>
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr class="tdH">
          ...
          try
          {
            ...
            String sql="select * from HRM_MST_LANGUAGES ORDER BY LANGUAGE_CODE";
             results=statement.executeQuery(sql);
            try
            {
              while(results.next())
              {
                String strLangCode=results.getString("LANGUAGE_CODE");
	        String strLangName=results.getString("LANGUAGE_NAME");
                if(strLangName==null)
                                       {
                                           strLangName="Undefined Record Found";
                                           
                                       }
                                       else {
                                           strLangName=strLangName;
                                           
                                       }
                out.println("<tr id='" + strLangCode + "'>");   
                out.println("<td><a href=\"javascript:loadValuesFromTable('" + strLangCode + "')\">Edit</a></td>");
                out.println("<td>" + strLangCode + "</td>");
	 out.println("<td>" + strLangName + "</td></tr>");
