...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EduQualScript.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    
    <title>Master HRM Education Qualifications Details</title>
  </head>
  <body>
  <%
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr>
          <td colspan="2" class="tdH">
            <div align="center">
              <strong>Education Qualifications Details</strong>
            </div></td>
        </tr>
        <tr>
          <td class="table">Qualification Id</td>
          <td class="table">
        ...
        <tr>
          <td class="table">Qualification Desc</td>
          <td class="table">
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr class="tdH">
          ...
          try
          {
            ...
            String sql="select * from HRM_MST_EDU_QUALIFICATION ORDER BY QUALIFICATION_ID";
             results=statement.executeQuery(sql);
            try
            {
              while(results.next())
              {
                String strQualId=results.getString("QUALIFICATION_ID");
	        String strQualDesc=results.getString("QUALIFICATION_DESC");
                if(strQualDesc==null)
                                       {
