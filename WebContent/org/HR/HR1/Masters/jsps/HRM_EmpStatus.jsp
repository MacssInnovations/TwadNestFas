...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/empStatusScript.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

   <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    
    <title>Master HRM Employee Status Details</title>
  </head>
  <body>
  <%
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr>
          <td colspan="2" class="tdH">
            <div align="center">
              <strong>Employee Status Details</strong>
            </div></td>
        </tr>
        <tr>
          <td class="table">Employee Status Id</td>
          <td class="table">
           
                   <input type="TEXT" name="htxtEmpId" maxlength="3"
                   id="htxtEmpId" readonly size="3"/>System Generated
          </td>
        </tr>
        <tr>
          <td class="table">Employee Status Desc</td>
          <td class="table">
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr class="tdH">
          ...
          try
          {
            ...
            String sql="select * from HRM_MST_EMPLOYEE_STATUS ORDER BY EMPLOYEE_STATUS_ID ";
             results=statement.executeQuery(sql);
            try
            {
              while(results.next())
              {
                String strEmpId=results.getString("EMPLOYEE_STATUS_ID");
	        String strEmpDesc=results.getString("EMPLOYEE_STATUS_DESC");
                if(strEmpDesc==null)
                                       {
