...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EduLevelScript.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

   <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    
    <title>Master HRM Education Qualifications Level Details</title>
  </head>
  <body>
  <%
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr>
          <td colspan="2" class="tdH">
            <div align="center">
              <strong>Education Qualifications Level Details</strong>
            </div></td>
        </tr>
        <tr>
          <td class="table">Qualification Level Id</td>
          <td class="table">
            
                   <input type="TEXT" name="htxtQualId" maxlength="3"
                   id="htxtQualId" readonly size="3"/>System Generated
          </td>
        </tr>
        <tr>
          <td class="table">Qualification Level</td>
          <td class="table">
            <input type="text" name="txtQualDesc" size="40" maxlength="60"
                   id="txtQualDesc"/>
          </td>
        </tr>
        <tr>
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="75%"
        ...
        <tr class="tdH">
          ...
          try
          {
            ...
            String sql="select * from HRM_MST_EDU_LEVELS ORDER BY QUALIFICATION_LEVEL_ID";
             results=statement.executeQuery(sql);
            try
            {
              while(results.next())
              {
                String strQualId=results.getString("QUALIFICATION_LEVEL_ID");
	        String strQualDesc=results.getString("QUALIFICATION_LEVEL");
                                if(strQualDesc==null)
                                       {
                                           strQualDesc="Undefined Record Found";
                                           
                                       }
                                       else {
                                           strQualDesc=strQualDesc;
                                           
                                       } 
                out.println("<tr id='" + strQualId + "'>");   
                out.println("<td><a href=\"javascript:loadValuesFromTable('" + strQualId + "')\">Edit</a></td>");
                out.println("<td>" + strQualId + "</td>");
	 out.println("<td>" + strQualDesc + "</td></tr>");
