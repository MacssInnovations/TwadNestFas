...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/DCBCash_Receipt_Edition.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            //document.Cash_Receipt_Edit_Form.txtCash_year.value=year;
            //document.Cash_Receipt_Edit_Form.txtCash_Month_hid.value=month;
            //document.Cash_Receipt_Edit_Form.txtCash_Month.value=monthArray[today.getMonth()];
  ...
  <table cellspacing="0" cellpadding="3" width="100%" style="border-collapse: collapse">
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Modify  DCB Cash Receipt </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="Cash_Receipt_Edit_Form" id="Cash_Receipt_Edit_Form" method="POST"
                  action="../../../../../DCBCash_Receipt_Edition?Command=Add"
                  onsubmit="return checkNull_CASHDCB()">
      ...
      <div class="tab-pane" id="tab-pane-1">
        <div class="tab-page">
          ...
          <div align="center">
            <table cellspacing="0" cellpadding="3" border="1" width="95%" style="border-collapse: collapse">
              <tr class="tdTitle">
                <td colspan="2">
                  <div align="left">
             ...
             <!-- <tr class="table" style="display:none">
              ...
              <tr class="table">
                        ...
                        <td >
                          <div align="left">
                            <select size="1" name="txtReceipt_No" id="txtReceipt_No" tabindex="4" onchange="doFunction_voucher('load_Receipt_Details','null');">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtRef_no" id="txtRef_no" tabindex="5"
                           maxlength="50" size="55"/>
                     
                    <input type="text" name="txtRef_date" id="txtRef_date" tabindex="6"
                           maxlength="10" size="11"
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);"
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Cash_Receipt_Edit_Form.txtRef_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
                    ...
                    <table align="left">
                     ...
                     <td>
                          <div align="left">
                                ...
                                <select size="1" name="cmbMas_SL_Code" id="cmbMas_SL_Code"  tabindex="8">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="50" tabindex="9" onkeypress="return check_leng(this.value,'remarks');"
                              rows="4"></textarea>
                  </div>
                </td>
              </tr>
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtRecei_from" tabindex="10" onkeypress="check_leng(this.value,'received_from');"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtAmount" onkeypress="return limit_amt(this,event);" tabindex="11" onblur="valid_amt(this);"
            ...
            <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <input type="radio" checked="checked" name="rad_ReClass" id="rad_ReClass" 
                           value="N" />NO &nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  <div align="left">
                    <input type="text" name="txtAcc_HeadCode" 
                           ...
                           onkeypress="return numbersonly(event)"
                            ...
                            onblur="doFunction('checkCode','null');checkACC();"  size="9"/>
                    <img src="../../../../../images/c-lovi.gif" width="20" 
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <div id="grid" style="display:block">
                    <table id="mytable" cellspacing="0" cellpadding="4" style="border-collapse: collapse"
                           border="1" width="100%">
