...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/DCB_Receipt_Cancel.js"></script>
  ...
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation Of DCB Receipt </font>
          </div>
        </td>
      </tr>
    </table><form name="Bank_Receipt_Edit_Form" id="Bank_Receipt_Edit_Form"
                  method="POST"
                  action="../../../../../DCB_Receipt_Cancel?Command=Cancel"
