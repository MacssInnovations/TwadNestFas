...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/DCBCash_Receipt_List_All.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.Cash_Rec_List_All_Form.txtCB_Year.value=year
        document.Cash_Rec_List_All_Form.txtCB_Month.value=month;
  ...
  <form name="Cash_Rec_List_All_Form" method="POST">
   
  <table cellspacing="0" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Cash Receipt </strong>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Cash_Rec_List_All_Form.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Cash_Rec_List_All_Form.txtTo_date);"
                         alt="Show Calendar"></img>
