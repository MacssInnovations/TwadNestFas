...
{           
        ...
        */
        ...
        items[5]=document.getElementById("projectid").value;
        if(document.getElementById("cmbSL_Code").value=="")
        {
        items[6]="";                //"Not Available";
        }
...
function load_Receipt_Details(baseResponse)
{
   ...
   //   if(baseResponse.getElementsByTagName(Ref_No)[0].firstChild!=null)
    //  	 Ref_No=baseResponse.getElementsByTagName("Ref_No")[0].firstChild.nodeValue;
      	  ...
      	  if(baseResponse.getElementsByTagName(Ref_No)[0]==undefined){
				Ref_No="";
			}else
			{
				Ref_No=baseResponse.getElementsByTagName("Ref_No")[0].firstChild.nodeValue;
    ...
    /*---------------------------------------------------------------------------------*/          
      ...
      //  alert("items[6]"+items[6]);
        ...
        if(baseResponse.getElementsByTagName("che_DD_no")[k].firstChild == null){
			items[8]="";
		}else {
