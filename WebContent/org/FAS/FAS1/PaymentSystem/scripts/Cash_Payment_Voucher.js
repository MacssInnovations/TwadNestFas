...
{   
        ...
        {  
            ...
            {
                var txtCreat_By_Module='CRM';
                var url="../../../../../Cash_Payment_Voucher.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='CRM';
                var url="../../../../../Cash_Payment_Voucher.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
             ...
             if(service)
             {
               ...
               // alert("service");
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                       ...
                       if(document.getElementById("cmbAcc_UnitCode").value==Offid)//document.getElementById("unitid").value)
                        {
