       ...
       //var txtAUTHORIZED_TO='C';
        ...
        {  
          ...
          //  if(txtCrea_date.length!=0)
            {
            var url="../../../../../Cheque_Cancellation_System.view?Command=load_Voucher_No&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&doc_type="+doc_type;
           // alert(url)
        ...
        {  
           ...
           // if(txtReceipt_No!="")
            {
            var url="../../../../../Cheque_Cancellation_System.view?Command=load_Voucher_Details&txtReceipt_No="+txtReceipt_No+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCrea_date="+
            txtCrea_date+"&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&doc_type="+doc_type+"&che_DD_no="+che_DD_no;
         //   alert(url)
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
{   
    ...
    if(flag=="success")
    {
      ...
      //  alert("txtCheque_DD2"+txtCheque_DD2);
        
        document.getElementById("txtCheque_DD").value=baseResponse.getElementsByTagName("cheq_dd")[0].firstChild.nodeValue;
       // document.getElementById("txtCheque_DD_NO").value=baseResponse.getElementsByTagName("che_DD_no")[0].firstChild.nodeValue;
       ...
       document.getElementById("txtAmount2").value=baseResponse.getElementsByTagName("Total_amt")[0].firstChild.nodeValue;
        document.getElementById("txtCheque_DD2").value=baseResponse.getElementsByTagName("txtCheque_DD2")[0].firstChild.nodeValue;
        document.getElementById("txtCheque_DD_NO2").value=baseResponse.getElementsByTagName("txtCheque_DD_NO2")[0].firstChild.nodeValue;
       document.getElementById("txtCheque_DD_date2").value=baseResponse.getElementsByTagName("txtCheque_DD_date2")[0].firstChild.nodeValue;
