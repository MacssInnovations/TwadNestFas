       ...
       if(Command=="chequenodetails")
        ...
        {  
           ...
           // if(txtReceipt_No!="")
            ...
            if(rad_val=="C"){
            var url="../../../../../Cheque_Dishonour_System_New.view?Command=Voucher_Details&txtCheque_No="+txtCheque_No+"&txtDoc_date="+txtDoc_date+"&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
            }
        //    alert(url)
            var req=getTransport();
            req.open("GET",url,true); 
        ...
        {  
           ...
           // if(txtReceipt_No!="")
            ...
            if(rad_val=="C"){
             var url="../../../../../Cheque_Dishonour_System_New.view?Command=Other_Details&txtCheque_No="+txtCheque_No+"&txtReceipt_No="+txtReceipt_No+"&txtDoc_date="+txtDoc_date+"&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
            }
           // alert(url)
            var req=getTransport();
            req.open("GET",url,true); 
...
if(id=="M")
   ...
   //  txtCheque_DD3.style.display="none";
     //txtCheq_DD_Issued.style.display="none";
            ...
            var url="../../../../../Cheque_Dishonour_System_New.view?Command=chequenodetails_cheqwise&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date;
            //alert(url)
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
