...
function call_pendingbills()
{
    ...
    winPendingbills= window.open("../../../../../org/FAS/FAS1/PaymentSystem/jsps/PendingBills_Revised.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&dateval="+dateval+"&frmDate="+frmDate+"&toDate="+toDate+"&type_MasSL="+type_MasSL+"&code_MasSL="+code_MasSL,"PendingBillsSearch","status=1,height=1000,width=1000,resizable=YES, scrollbars=yes"); 
    winPendingbills.moveTo(250,250);  
    winPendingbills.focus();
}
function doParentPendingbills(vouNO,vouSL_NO,vouDATE,vouTYPE,AcHeadCode,AcHeadName,CR_DB_indic,subLed_type,subLed_typeName,subLed_code,subLed_codeName,billNO,billdate,billtype,agree_NO,agree_date,paid_to,subamount,txt_particular,vrAmt,MULTIPLE_PVR_DETAILS,MVR_no,j,flag)
{
