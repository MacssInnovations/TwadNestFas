        ...
        if(req.status==200)
        {
             ...
             var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
                ...
                if(flag=="success")
                {
                    ...
                    items[19]=baseResponse.getElementsByTagName("payment_date")[k].firstChild.nodeValue;
                    items[20]=baseResponse.getElementsByTagName("vou_date")[k].firstChild.nodeValue;
                    items[21]=baseResponse.getElementsByTagName("JOURNAL_TYPE")[k].firstChild.nodeValue;
                    items[22]=baseResponse.getElementsByTagName("SL_NO")[k].firstChild.nodeValue;                           
                    items[23]=baseResponse.getElementsByTagName("JOURNAL_TYPE_CODE")[k].firstChild.nodeValue;
                   ...
                   vou_no.setAttribute("onchange", "checkboxAlert(this.value)");
                   /*@NK included for onchange function*/
                        ...
                        cell2=document.createElement("TD");
                         ...
                         cell2=document.createElement("TD");
                             ...
                             // mycurrent_row.appendChild(cell2);
                              ...
                              Vr_amt.setAttribute("onchange","Changebtext(this.value,"+items[24]+","+seq+","+cnt+");");
 ...
 function GetPayDate(val)
 {
     ...
     var doc=window.opener.document;             // get the parent form
           var dateval=doc.frmBankPay_PendingBill_create.txtCrea_date.value;    // used to get cash book month and year  	
              ...
              /*if(pmtDate=="Under 1st.pmt. 00:00")*/
               /* var paypaidedDate = Date.parse(pmtDate);*/
