...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Voucher_list_SL= window.open("../../../../../org/FAS/FAS1/PaymentSystem/jsps/BankPay_PendingBill_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"VoucherDetails","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Voucher_list_SL.moveTo(250,250);  
    Voucher_list_SL.focus();
...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    var txtCreat_By_Module='BPP';
    var url="../../../../../BankPay_Pending_Bills_print.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
    ...
    document.frmBankPay_pendingBill.action=url;
    document.frmBankPay_pendingBill.method="POST";
    document.frmBankPay_pendingBill.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            {
                var txtCreat_By_Module='BPP';
                var url="../../../../../BankPay_NonBill_List.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='BPP';
                var url="../../../../../BankPay_NonBill_List.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.frmBankPay_pendingBill.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmBankPay_pendingBill.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
...
function changepagesize()
{
           ...
           __pagination=document.frmBankPay_pendingBill.cmbpagination.value;
