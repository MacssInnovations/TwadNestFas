...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    document.frmBankPay_NilPayment_ListAll.action=url;
    document.frmBankPay_NilPayment_ListAll.method="POST";
    document.frmBankPay_NilPayment_ListAll.submit();
      return true;
}
/////////-------------------------- end report
...
function changepage()
{
var page=document.frmBankPay_NilPayment_ListAll.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmBankPay_NilPayment_ListAll.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
...
function changepagesize()
{
           ...
           __pagination=document.frmBankPay_NilPayment_ListAll.cmbpagination.value;
