...
{   
        ...
        {  
            ...
            {
                var url="../../../../../ListCheque_Cancellation.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.frmCheqCancel_List.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmCheqCancel_List.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        c++;s++;
                         var items=new Array();
                         items[0]=s;
                        items[1]=service[i].getElementsByTagName("cheq_cancel_date")[0].firstChild.nodeValue; 
                        items[2]=service[i].getElementsByTagName("doc_type")[0].firstChild.nodeValue;
                        items[3]=service[i].getElementsByTagName("doc_no")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("doc_date")[0].firstChild.nodeValue;
                        items[5]=service[i].getElementsByTagName("oldcheq_type")[0].firstChild.nodeValue;
                        items[6]=service[i].getElementsByTagName("old_cheqno")[0].firstChild.nodeValue;
                        items[7]=service[i].getElementsByTagName("old_cheqdate")[0].firstChild.nodeValue;
                        items[8]=service[i].getElementsByTagName("old_cheqamt")[0].firstChild.nodeValue;
                        items[9]=service[i].getElementsByTagName("newcheq_status")[0].firstChild.nodeValue;
                        items[10]=service[i].getElementsByTagName("new_cheqno")[0].firstChild.nodeValue;
                        items[11]=service[i].getElementsByTagName("new_cheqdate")[0].firstChild.nodeValue;
                        items[12]=service[i].getElementsByTagName("new_cheqamt")[0].firstChild.nodeValue;
                        items[13]=service[i].getElementsByTagName("gjvno")[0].firstChild.nodeValue;
                        items[14]=service[i].getElementsByTagName("gjvdate")[0].firstChild.nodeValue;
                        ...
                        document.getElementById("cmbAcc_UnitCode").value==Ucode;
...
function changepagesize()
{
           ...
           __pagination=document.frmCheqCancel_List.cmbpagination.value;
