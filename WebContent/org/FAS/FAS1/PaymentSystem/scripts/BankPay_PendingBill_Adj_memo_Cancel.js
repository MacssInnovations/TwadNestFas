...
//            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
            	...
            	var url="../../../../../BankPay_PendingBill_Adj_memo_Cancel.view?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
                cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
...
//            alert(url)
        ...
        {  
            ...
            if(txtVoucher_No!="")
            {
            var url="../../../../../BankPay_PendingBill_Adj_memo_Cancel.view?Command=load_Voucher_Details&txtVoucher_No="+txtVoucher_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
