...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/BankPay_PendingBill_ListAll.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmBankPay_pendingBill.txtCB_Year.value=year
        document.frmBankPay_pendingBill.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmBankPay_pendingBill" method="POST">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Bank Payment for Pending Bills</strong>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_pendingBill.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_pendingBill.txtTo_date);"
                         alt="Show Calendar"></img>
         ...
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
           ...
           <th>
            	...
            	<div  id="cc_clmn2" style="display:none">Cheque Amount</div>
            </th>
            <th>
            	<div  id="a_clmn" style="display:block">Print Payment ?</div>
            	<div  id="cc_clmn" style="display:none">GJV No.</div>
            </th>            
            <th>
            	<div id="cc_clmn1" style="display:none">GJV Date.
            	</div>
            </th>
          </tr>
