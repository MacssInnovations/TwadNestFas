...
<html>
  ...
  <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Revert_Cheque_Cancel_Status.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function loadyear_month()
        ...
        document.frmRevert_Cheque_Cancel.txtCB_Year.value=year
        document.frmRevert_Cheque_Cancel.txtCB_Month.value=month;
     //     call_date(document.frmRevert_Cheque_Cancel.txtCrea_date);
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmRevert_Cheque_Cancel" id="frmRevert_Cheque_Cancel" method="POST" 
                action="../../../../../Revert_Cheque_Cancel_Status" > 
...
onkeypress="return numbersonly(event)">
          ...
          <select name="txtCB_Month"  id="txtCB_Month" onchange= "call_date()" tabindex="4"  >
          ...
          <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth"  tabindex="5" onclick="call_date();loadCheque()"/>
           </div>
          </td>
              </tr>
              <tr class="table" >
          ...
          <div align="left">
              ...
              <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmRevert_Cheque_Cancel.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmRevert_Cheque_Cancel.txtTo_date);"
                         alt="Show Calendar"></img>
            <input type="BUTTON" value="GO" name="ByDate" id="ByDate" tabindex="8" onclick="call_date();searchByDate()"/>
            </div>
          </td>          
        </tr>
              </table>
