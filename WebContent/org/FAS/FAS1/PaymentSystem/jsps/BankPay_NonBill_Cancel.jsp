...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_NonBill_Cancel.js"></script>
   ...
   <script type="text/javascript" src="../../../../../org/FAS/FAS1/CalendarCtrl.js"></script>  
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            //document.frmBankPay_FinalBill.txtCash_year.value=year;
            //document.frmBankPay_FinalBill.txtCash_Month_hid.value=month;
            //document.frmBankPay_FinalBill.txtCash_Month.value=monthArray[today.getMonth()];
...
%>
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation Of Bank Payment for Final Heads </font>
          </div>
        </td>
      </tr>
    </table><form name="frmBankPay_FinalBill" id="frmBankPay_FinalBill"
                  method="POST"
                  action="../../../../../BankPay_NonBill_Cancel.view?Command=Cancel"
          ...
          <div align="center">
            ...
            <!--  <tr class="table" style="display:none">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtPaid_to" tabindex="9" style="background-color: #ececec" readonly="readonly"
