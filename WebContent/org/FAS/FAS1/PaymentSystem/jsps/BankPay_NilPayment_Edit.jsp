...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_NilPayment_Edit.js"></script>
    ...
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/CommonControls/scripts/Sub_Ledger_Type_Applicable.js"></script>  
        ...
        <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
                ...
                document.frmBankPay_NilPayment_Edit.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Modify Nil Payment System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmBankPay_NilPayment_Edit" id="frmBankPay_NilPayment_Edit" method="POST"
                  action="../../../../../BankPay_NilPayment_Edit.view?Command=Add"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_NilPayment_Edit.txtCrea_date,1);"
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmBankPay_NilPayment_Edit.txtBill_date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
