...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_NonBill_Edit.js"></script>
...
%>
  <body onload="call_clr();loadDate();LoadAccountingUnitID('LIST_ALL_UNITS');foc()" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Modify Bank Payment for Final Heads </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmBankPay_FinalBill" id="frmBankPay_FinalBill" method="POST"
                  action="../../../../../BankPay_NonBill_Edit.view?Command=Add"
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             ...
             <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="50" tabindex="6" onkeypress="return Remarks_Lenght_Check('remarks',this.value);"
                              rows="4"></textarea>
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtPaid_to"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_FinalBill.txtReferDate_edit);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
