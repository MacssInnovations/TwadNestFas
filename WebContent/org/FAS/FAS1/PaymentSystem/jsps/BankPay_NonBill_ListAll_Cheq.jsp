  ...
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    function EditHead(rowID)
    {
      ...
      cheqno=rcells.item(6).firstChild.nodeValue;
      cheqdate=rcells.item(7).firstChild.nodeValue;
      cheqamount=rcells.item(9).firstChild.nodeValue;
  ...
  %>
      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          String sql="select SL_NO,VOUCHER_NO,ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            ...
            ",BANK_ID,BRANCH_ID from FAS_PAYMENT_TRANSACTION where CHEQUE_OR_DD='C' and ACCOUNTING_UNIT_ID="+cmbAcc_UnitCode+" and ACCOUNTING_FOR_OFFICE_ID="+
            cmbOffice_code+"and CASHBOOK_YEAR="+yr+"and CASHBOOK_MONTH="+mon;
