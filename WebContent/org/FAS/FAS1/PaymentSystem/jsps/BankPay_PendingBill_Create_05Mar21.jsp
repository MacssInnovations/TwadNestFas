                ...
                <td width="60%">
                  <div align="left">
                    <select  name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="6"
                     ...
                     try
                     {
                            ps=con.prepareStatement("select decode(JOURNAL_TYPE_CODE,89,7,JOURNAL_TYPE_CODE) as JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='L' order by JOURNAL_TYPE_DESC ");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
