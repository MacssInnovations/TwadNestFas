  ...
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Payment System</title>
     ...
     <script type="text/javascript" src="../scripts/PendingBills_Revised1.js"></script>
     <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     <!-- /*@NK Included on 26062019 to create own alert box*/ -->
      <!--/*MK@1810202 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> -->
...
%>
  ...
  <input type="hidden" id="hid_value" name="hid_value" value="Single">
    <input type="text" id="selOff" name="selOff"  style="display:none;"> 
   <%
  Connection con=null;
  ...
  %>
   ...
   <input type="hidden" id="off_code" name="off_code" value=<%=cmbOffice_code%>>  
