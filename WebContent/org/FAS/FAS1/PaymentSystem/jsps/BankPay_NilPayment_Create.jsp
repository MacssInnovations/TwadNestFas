...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_NilPayment_Create.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Creation Of Nil Payment System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmBankPay_NilPayment_Create" id="frmBankPay_NilPayment_Create" method="POST"
                  action="../../../../../BankPay_NilPayment_Create.view?Command=Add"
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_NilPayment_Create.txtCrea_date,1);"
             ...
             <!-- <tr class="table" style="display:none">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="50"  onkeypress="return Remarks_Lenght_Check('remarks',this.value);"
                              rows="4"></textarea>
                  </div>
                </td>
              </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmBankPay_NilPayment_Create.txtBill_date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtReferenceNo" 
                           id="txtReferenceNo" maxlength="20" size="21"/>
                  </div>
                </td>
              </tr>
              <tr class="table">
