...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_NilPayment_Cancel.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
                ...
                document.frmBankPay_NilPayment_Cancel.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation of Nil Payment System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmBankPay_NilPayment_Cancel" id="frmBankPay_NilPayment_Cancel" method="POST"
                  action="../../../../../BankPay_NilPayment_Cancel.view?Command=Cancel"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_NilPayment_Cancel.txtCrea_date,1);"
                ...
                <td width="60%">
                  <div align="left">
                    <select size="1" name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="6"
                            onchange="doFunction('Load_MasterSL_Code','null');">
