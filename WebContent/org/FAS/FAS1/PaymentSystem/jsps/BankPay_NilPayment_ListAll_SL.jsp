      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          /*String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME  ,BILL_NO,PAID_TO,to_char(BILL_DATE,'DD/MM/YYYY') as BillDate "+
            ",REFERENCE_NO,PARTICULARS from FAS_PAYMENT_TRANSACTION where ACCOUNTING_UNIT_ID="+cmbAcc_UnitCode+" and ACCOUNTING_FOR_OFFICE_ID="+
            cmbOffice_code+"and CASHBOOK_YEAR="+yr+"and CASHBOOK_MONTH="+mon+"and  VOUCHER_NO="+recNo;*/
            
            
            String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW_M where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME  ,BILL_NO,PAID_TO,to_char(BILL_DATE,'DD/MM/YYYY') as BillDate "+
            ",REFERENCE_NO,PARTICULARS from FAS_PAYMENT_TRANSACTION where ACCOUNTING_UNIT_ID="+cmbAcc_UnitCode+" and ACCOUNTING_FOR_OFFICE_ID="+
            cmbOffice_code+"and CASHBOOK_YEAR="+yr+"and CASHBOOK_MONTH="+mon+"and  VOUCHER_NO="+recNo;
           ...
           // System.out.println(sql);
            ...
            while(rs2.next())
            {
               System.out.println("while");
                ...
                if(rs2.getString("BillDate")!=null)
                out.println("<td align='center'>"+rs2.getString("BillDate")+"</td>");
                else
                out.println("<td align='left'>"+"   --  "+"</td>");
                
                if(rs2.getString("REFERENCE_NO")!=null)
                out.println("<td align='left'>"+rs2.getString("REFERENCE_NO")+"</td>");
                else
                out.println("<td align='left'>"+"   --  "+"</td>");
