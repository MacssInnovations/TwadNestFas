...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankPay_PendingBill_Adj_memo_Create.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%">
    ...
    <form name="frmBankPay_PendingBill_create" id="frmBankPay_PendingBill_create" method="POST"
            action="../../../../../BankPay_PendingBill_Adj_memo_Create.view?Command=Add" onsubmit="return checkNull()">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
                ...
                %>
                  ...
                  <input type="radio" name="par_rad" value="Y" disabled onclick="rd_hid(this.value);"> Yes
