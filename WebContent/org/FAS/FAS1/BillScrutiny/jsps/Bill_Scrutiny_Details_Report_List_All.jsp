...
<title>Bill Scrutiny List</title>
...
<script src="../scripts/Bill_Scrutiny_Details_Report_List_All.js"
...
function loadyear_month()
{
       ...
       document.frmBill_Scrutiny_Report_list.txtCB_Year.value=year;
       document.frmBill_Scrutiny_Report_list.txtCB_Month.value=month1;
}
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Bill Scrutiny Details List</font></div>
		</td>
	</tr>
</table>
<form name="frmBill_Scrutiny_Report_list" id="frmBill_Scrutiny_Report_list" method="POST" >
      ...
      <div align="center">
        <div id="firstDiv" >
     <table id="mytable" align="center"  cellspacing="1" 
