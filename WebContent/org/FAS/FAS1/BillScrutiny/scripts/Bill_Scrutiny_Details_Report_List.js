...
{   
        ...
        else
        {
                ...
                var url="../../../../../Bill_Scrutiny_Details_Report_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
                             ...
                             items[3]=service[i].getElementsByTagName("billscrdate")[0].firstChild.nodeValue;
                             items[4]=service[i].getElementsByTagName("sancamt")[0].firstChild.nodeValue;
                             ...
                             items[7]=service[i].getElementsByTagName("deducted_amount")[0].firstChild.nodeValue;
                             items[8]=service[i].getElementsByTagName("NET_AMOUNT")[0].firstChild.nodeValue;
                           ...
                           //  items[4]="Employees";
                            ...
                            var url="";
                            var url="javascript:Show_new('"+cmbAcc_UnitCode+"','"+cmbOffice_code+"','"+CASHBOOK_YEAR+"','"+CASHBOOK_MONTH+"','"+items[0]+"','"+items[2]+"')";
                            anc.href=url;
