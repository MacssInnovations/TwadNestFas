...
<title>Bills_Token_Register_without_SP</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Bills-Token Register Entry-Without System generated Sanction Proceeding</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="1" width="100%">	
	...
	<tr class="table">
		...
		<div align="left"><select size="1" name="cboBillSubType"
			id="cboBillSubType" onchange="checkinvoicee()" onblur="checkinvoicee(),loadAccHead()">
			<option value="s">---Select---</option>
		</select></div>		</td>
	</tr>
	<tr class="table">
	...
	<tr class="table">
	  ...
	  <td><div align="left">
	    <input type="text" name="txtManualProceedingDate" maxlength="10" size="10" onblur="checksan();checkinvdate();"
	...
	<tr class="table">
		...
		<div align="left"><input type="text" name="txtTotalSanctionAmount"
			...
			onkeypress="return numbersonly1(event,this)" onchange="callbills();" /></div>		</td>
	</tr>
	<tr class="table">
	...
	<tr class="table">
		...
		<input type="text" name="txtPayeeCode" id="txtPayeeCode" maxlength="15" size="7"  onkeypress="return numbersonly1(event,this)" onchange="callpd()" onblur="callpd()"/>
	...
	<tr class="tdH">
		...
		<div align="center"><input type="button" name="onsubmit"
			value="ADD" id="onsubmit" onClick="saveFunc('<%=s%>');" /> 
			<!--<input type="button" name="ondelete" value="CANCEL" id="ondelete"
			 onClick="deleteeee('<%=s%>');" disabled="disabled" />--> 
			 <input type="button" name="onupdate" value="EDIT" id="onupdate"
			onClick="update('<%=s%>');" disabled="disabled" /> 
			<!--<input type="button" name="onlist" value="LIST" id="onlist"
			onClick="forList('<%=s%>');" /> 
			-->
