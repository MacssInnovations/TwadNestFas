...
<form name="frm_BillTokenRegisterEntry_WithProceeding" id="frm_BillTokenRegisterEntry_WithProceeding" method="POST" action="../../../../../Bills_Token_Register_with_SP?command=saveFunc">
      <input type="hidden" id="hid" name="hid" value="HO">
        <div class="tab-page">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
               ...
               <!--<tr class="table">
				...
				<tr class="table">
					...
					--><tr class="table">
				<td>
				 <div align="left">All Bills - With Sanction Proceeding <font   color="#ff2121">*</font></div>
				</td>
					<td>
			                   <div align="left"><input type="radio" name="sancidwith" id="sancidwith" value="Y" checked="checked" ><label>With Sanction Proceeding</label><input
			type="radio" name="sancidwith" id="sancidwith" value="GPF" ><label> GPF - Without Sanction Proceeding</label>
			<input
			type="radio" name="sancidwith" id="sancidwith" value="N" ><label>All Bills - Without Sanction Proceeding</label></div>
		</td>
				</tr>
				<tr class="table">
		             <td class="table">
