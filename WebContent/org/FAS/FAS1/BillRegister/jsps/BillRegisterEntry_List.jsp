...
<html>
  <head>
        ...
        <title>BillRegisterEntry_List</title>
        <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
         <script type="text/javascript" src="../scripts/BillRegisterEntry_List.js"></script>
  </head>
   <body onload="initialLoad();">
        <form name="billlistform" action="Get">
            <%
            ...
            <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="100%" align="center" >
                <tr class="tdH">
                     ...
                     <th>Bill No</th>
                     <th>Bill Date</th>
                     <th>Proceeding/Certificate No</th>  
