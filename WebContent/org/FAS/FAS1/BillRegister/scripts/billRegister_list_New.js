...
{ 
	...
	if(hid=="HO")
	{
        ...
        else
        {
                ...
                "&hid="+hid+"&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&optionId="+optionId+"&sancidwith="+sancidwith[i].value;			                
                if(hid=="OF"){
                	url=url+"&fromDte="+frmDte+"&toDte="+toDte+"&cmd="+Command;
                }
                // alert(url);
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
                           ...
                           /*  items[5]=service[i].getElementsByTagName("paytypecode")[0].firstChild.nodeValue;
                             ...
                             items[5]=service[i].getElementsByTagName("processing")[0].firstChild.nodeValue;                            
                             items[6]=service[i].getElementsByTagName("sancamt")[0].firstChild.nodeValue;
                             items[7]=service[i].getElementsByTagName("billamt")[0].firstChild.nodeValue;
                           //  items[10]=service[i].getElementsByTagName("AMOUNT")[0].firstChild.nodeValue;
                             ...
                             items[9]=service[i].getElementsByTagName("subdesc")[0].firstChild.nodeValue;
