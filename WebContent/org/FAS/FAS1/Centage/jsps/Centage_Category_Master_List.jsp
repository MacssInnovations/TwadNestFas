...
<html>
  <head>
    ...
    <title>Centage Category List</title>
   ...
   <script type="text/javascript" language="javascript">
    ...
    function EditHead(rowID)
    {
                ...
                txtCategory_Desc  = rcells.item(2).firstChild.nodeValue;
                cmbCategoryType  = rcells.item(3).firstChild.nodeValue;
                            
        Minimize();
        opener.doParentBankAccNumbers(txtCategory_Code,txtCategory_Desc,cmbCategoryType);
        self.close();
  ...
  <form name="frmBillReceiptRegisterList" id="frmBillReceiptRegisterList">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="table">
          <td>
            <div align="center">
               List of Centage Category Code and Description 
            </div></td>
       ...
       <tbody id="tb" class="table" align="left">
          <%    
           try
           {
            ...
            String sql_que="select CATEGORY_CODE,CATEGORY_DESC,CATEGORY_TYPE from FAS_CENTAGE_CATEGORY_HO_MASTER where ACCOUNTING_UNIT_ID= ? and ACCOUNTING_FOR_OFFICE_ID= ? order by CATEGORY_CODE  ";
            ...
            while(rs.next())
            {
                ...
                out.println("<td>"+rs.getInt("CATEGORY_CODE")+"</td>");
                out.println("<td>"+rs.getString("CATEGORY_DESC")+"</td>");
                
                if ( rs.getString("CATEGORY_TYPE").equalsIgnoreCase("C") ) 
                {
                   out.println("<td>Common</td>");                             
                }
                else 
                {
                   out.println("<td>Specific</td>");                            
                }
