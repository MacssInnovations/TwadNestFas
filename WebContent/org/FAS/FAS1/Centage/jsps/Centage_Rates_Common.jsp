  ...
  <body onload="loadfyr();foc();LoadAccountingUnitID('LIST_ALL_UNITS')" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <table cellspacing="1" cellpadding="2" border="1" width="100%">      
        ...
        <tr class="table">
          ...
          <td>
            <div align="left">
              <input type="text" name="txtCentageRates" id="txtCentageRates" onkeypress="return numbersonly1(event)" ></input>
            </div>
          </td>
        </tr>
        <tr class="table">
     ...
     <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode"
                        tabindex="1" onchange="common_LoadOffice()"  style="visibility:hidden" ></select>
     <select size="1" name="cmbOffice_code" id="cmbOffice_code"  style="visibility:hidden"  tabindex="2" ></select>
