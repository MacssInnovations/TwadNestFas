...
<html>
  <head>
    ...
    <title>Scheme Independent Centage Account Heads </title>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/Independent_Centage_AC_Heads.js"></script>
  ...
  <form  action="#" name="frmIndependentCentageACHeads" id="frmIndependentCentageACHeads" >
           
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Scheme Independent Centage Account Heads </center>
          </td>
        </tr>
        <tr class="table">
          <td>
        ...
        <tr class="table">
          ...
          <td>
            <div align="left">
                <input type="text" name="txtWorkExpACHeadCode" 
                            id="txtWorkExpACHeadCode"
                            maxlength="6" 
                            onkeypress="return numbersonly(event)"                           
                            onblur="doFunction_ACHeadDesc_Load('ExpCode')" 
                            size="9"></input>
          ...
          <td>
            <div align="left">
                 <input type="text" name="txtDrACHeadCode" id="txtDrACHeadCode"
                            maxlength="6" 
                            onkeypress="return numbersonly(event)"                           
                            onblur="doFunction_ACHeadDesc_Load('DrCode');"  size="9"
                 ></input>
                  <img src="../../../../../images/c-lovi.gif"
                                 width="20" height="20" alt="AccountHeadList"
