...
{ 
        if (window_BankAccNumber && window_BankAccNumber.open && !window_BankAccNumber.closed) 
         ...
         window_BankAccNumber= window.open("Independent_Centage_AC_Heads_List.jsp?cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code,"mywindow1","resizable=YES, scrollbars=yes"); 
         window_BankAccNumber.moveTo(250,250); 
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function doParentBankAccNumbers( txtWorkExpACHeadCode, txtWorkExpACHeadCode_Desc, txtDftCentageCtgy, txtDftCentageCtgy_Desc, txtCrACHeadCode, txtCrACHeadCode_Desc, txtDrACHeadCode, txtDrACHeadCode_Desc, txtRemarks )
{
        ...
        document.frmIndependentCentageACHeads.WxpTourch.style.visibility='hidden';
...
{   
   ...
   var  txtRemarks    =  document.getElementById("txtRemarks").value;   
     ...
     if(Command=="Load_Category_Code")
       {   
                var url="../../../../../Independent_Centage_AC_Heads.kv?Command=Load_Category_Code&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
            ...
            if(flag==true)
               {
                ...
                var url="../../../../../Independent_Centage_AC_Heads.kv?Command=Add&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+
        ...
        { 
            if(confirm("Do You Really want to Delete it?"))
            {
               ...
               if(flag==true)
               {  
                    var url="../../../../../Independent_Centage_AC_Heads.kv?Command=Delete&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+
                        "&txtWorkExpACHeadCode="+txtWorkExpACHeadCode;   
            ...
            if(flag==true)
             {
               ...
               var url="../../../../../Independent_Centage_AC_Heads.kv?Command=Update&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+
                        "&txtWorkExpACHeadCode="+txtWorkExpACHeadCode+        
                        "&txtDftCentageCtgy="+txtDftCentageCtgy+        
                        "&txtCrACHeadCode="+txtCrACHeadCode+        
                        "&txtDrACHeadCode="+txtDrACHeadCode+   
...
function ClearAll()
{
   ...
   document.frmIndependentCentageACHeads.WxpTourch.style.visibility='visible';    
