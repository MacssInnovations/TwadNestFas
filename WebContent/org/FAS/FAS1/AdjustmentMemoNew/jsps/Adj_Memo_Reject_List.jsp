...
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
      ...
      <script language="javascript" type="text/javascript" src="../js/Adj_Memo_Reject_List.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     	 function loadyear_month()
         {
	         ...
	         document.RejectList.txtCB_Year.value=year;
	         document.RejectList.txtCB_Month.value=month;
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo Reject List</font>
          </div>
        </td>
      </tr>
</table>
<%
  ...
  <% 
         ...
         %>
<form name="RejectList" method="POST">
<div align="center">
			          ...
			          <div align="left">
			              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
			                    ...
			                    <img src="../../../../../images/calendr3.gif"
			                         onclick="showCalendarControl(document.RejectList.txtFrom_date);"
			                    ...
			                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
			                     ...
			                     <img src="../../../../../images/calendr3.gif"
			                         onclick="showCalendarControl(document.RejectList.txtTo_date);"
			                         alt="Show Calendar"></img>
