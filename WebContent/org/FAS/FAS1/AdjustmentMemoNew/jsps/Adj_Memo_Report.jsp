...
<html>
  <head>
    ...
    <title>Adjustment Memo Register </title>
   ...
   <script type="text/javascript" language="javascript">
    function loadyear_month(){
               ...
               document.frmadj_memo_report.txtCB_Year.value=year;
               document.frmadj_memo_report.txtCB_Month.value=month;
                       
               document.frmadj_memo_report.txtCB_Year_from.value=year;
               document.frmadj_memo_report.txtCB_Month_from.value=month;
               
               document.frmadj_memo_report.txtCB_Year_to.value=year;
               document.frmadj_memo_report.txtCB_Month_to.value=month;
        ...
        function checkNull()
         {
          ...
          if((document.frmadj_memo_report.month_year[0].checked==false) && (document.frmadj_memo_report.month_year[1].checked==false))
          {
        	 alert("select cashbook month and year");
        	 return false;
          }  
          var statusRadios = document.getElementsByName("txt_status");
...
<body class="table" onload="loadyear_month();">
 ...
 <form name="frmadj_memo_report" id="frmadj_memo_report" action="../../../../../Adj_Memo_Report" method="post" onsubmit="return checkNull()"> 
    ...
    <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo Register</font>
          </div>
        </td>
      </tr>
    </table>
          ...
          <tr class="table">
           ...
           <td class="table">
              <div align="left">
                 Raised Cash Book Year &amp; Month <font color="#ff2121">*</font></td>
              </div>
           </td>
          <td>
        ...
        <tr class="table">
               ...
               <td>
                  <input type="radio" name = "txt_status" id="txt_status" value="Pending" >Pending</input>   &nbsp;
                  <input type="radio" name = "txt_status" id="txt_status" value="All" >All</input>   &nbsp;
