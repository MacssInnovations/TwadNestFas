...
<title>Adjustment Memo System(Single Receipt-Multiple Units) Cancel </title>
<link href="../../../../../css/Sample3.css" rel="stylesheet"  media="screen"/>
    ...
    <script type="text/javascript" src="../js/Adj_Memo_SingleReceipt_Cancel.js"></script>
...
<body onload="loadDate(),LoadAccountingUnitID('LIST_ALL_UNITS'),doFunction_voucher('load_Receipt_No',null);" bgcolor="rgb(255,255,225)">
  ...
  <% 
         ...
         %>
  <form name="Adjustment_Memo_SingleReceipt" id="Adjustment_Memo_SingleReceipt" method="POST" action="../../../../../Adj_Memo_SingleReceipt_Cancel?Command=Add">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.forms[0].txtCrea_date,1);"
              ...
              <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea rows="3"  tabindex="8" cols="35" id="authority" name="authority" readonly="readonly"></textarea>
                  </div>
                </td>
              </tr>  
                <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea rows="3"  tabindex="8" cols="35" id="authorityaddress" name="authorityaddress" readonly="readonly"></textarea>
                  </div>
                </td>
              </tr> 
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea rows="3"  tabindex="8" cols="35" id="particulars" name="particulars" readonly="readonly"></textarea>
                  </div>
                </td>
              </tr>     
               <tr class="table">
					          ...
					          <td>
					              <div align="left">
					                <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3" maxlength="4" size="5" readonly="readonly"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtTotalAmt" id="txtTotalAmt"  maxlength="16" onkeypress="return filter_real(event,this,10,2)" readonly tabindex="9"></input>
                  </div>
                </td>
              </tr>                 
            </table>
