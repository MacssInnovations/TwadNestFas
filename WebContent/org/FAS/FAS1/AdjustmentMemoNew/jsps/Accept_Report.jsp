...
<title>Adjustment Memo Accept Report</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
      ...
      <script language="javascript" type="text/javascript" src="../js/Accept_Report.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo Accept Report</font>
          </div>
        </td>
      </tr>
</table>
<%
  ...
  <% 
         ...
         %>
<form name="AcceptList" method="POST" action="../../../../../Adj_Accept_Report" onsubmit="return nullcheck()">
<div align="center">
