...
<html>
  <head>
    ...
    <script type="text/javascript" src="../js/AdjustmentMemo_SingleReceiptMultipleUnit_Report1.js"></script>
			  ...
			  <tr class="table">
               ...
               <tr class="table">
                     ...
                     VOUCHER_NO
                       ...
                       <td>
                        <div align="left">
                          <select size="1" name="cmbvocharNo" id="cmbvocharNo" onchange="doFunction_voucher('load_Receipt_Details','null');Verify_officeAddress();">
      ...
      <div align="center">
        <table cellspacing="1" cellpadding="3" width="100%">
          <tr class="tdH">
            <td>
              <div align="center">
                <input type="button" name="butSub" id="butSub" value="SUBMIT" onclick="add();"/>
                <input type="submit" name="butSub1" id="butSub1" disabled="disabled" value="REPORT" onclick="report();"/>
