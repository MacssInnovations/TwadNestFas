        ...
        <div class="tab-page">
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <!-- @NK load employee name based on emp code -->
                <tr align="left" class="table">
                        <td >
                            <div align="left">
                               Employee Name and Desg. Of Letter Signing Authority-HeadOfficeWing 
                               <font color="#ff2121">*</font>
                            </div>
                        </td>
                        <td >
                            <div align="left">
                                 <input type="text" class="light" name="txtempName"  id="txtempName"  maxlength="100" size="100"  />&nbsp;&nbsp;  
                                 
				<marquee width="50%" behavior="alternate" bgcolor="white">
								<p style="color:red;text-align:center">  
								Kindly Enter Name and Designation the following format<br>  EmpName-Designation </p>
				</marquee> 
                                  
                        <input type="hidden" name="txtempCode"  id="txtempCode"  maxlength="6" size="6" onchange="Load_emp_details();"  onkeypress="return numbersonly(event)"/>
                            </div>
                        </td>
                    </tr> 
