...
<link href="../../../../../css/Sample3.css" rel="stylesheet"  media="screen"/>
    ...
    <script type="text/javascript" src="../js/Adj_Memo_SingleReceipt_Edit.js"></script>
...
<body onload="loadDate(),LoadAccountingUnitID('LIST_ALL_UNITS'),doFunction_voucher('load_Receipt_No',null);" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo from Board(Single Receipt-Multiple Units)</font>
          </div>
        </td>
      </tr>
    </table>
  ...
  <% 
         ...
         %>
  <form name="Adjustment_Memo_SingleReceipt" id="Adjustment_Memo_SingleReceipt" method="POST" action="../../../../../Adj_Memo_SingleReceipt_Edit?Command=Add" onsubmit="return checkNull();">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
			  ...
			  <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                           ...
                           onblur="return checkdt(this),doFunction_voucher('load_Receipt_No',null);"/>
               ...
               <tr class="table">
                ...
                <td>
                <div align="left">
                  <textarea rows="3"  tabindex="5" cols="35" id="authority" name="authority"  ></textarea>   
                </div>
                </td>
              </tr>  
               <tr class="table">
                ...
                <td>
                <div align="left">
                  <textarea rows="3"  tabindex="5" cols="35" id="authorityaddress" name="authorityaddress"  ></textarea>   
                </div>
                </td>
              </tr>  
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea rows="3"  tabindex="7" cols="35" id="particulars" name="particulars"  ></textarea>
                  </div>
                </td>
              </tr>     
                 <tr class="table">
				              ...
				              <td>
				                  <div align="left">
				                    <select size="1" name="txtReceipt_No" id="txtReceipt_No"
				                            tabindex="5"  onchange="doFunction_voucher('load_Receipt_Details1','null');">
				                      <option value="0">--Select Receipt Number--</option>
				                    </select>
				                  </div>
                			  </td>
              		  </tr>
              		 ...
              		 <tr class="table">
		                ...
		                <td>
		                  <div align="left">
		                    <input type="text" name="ho_ref_no" id="ho_ref_no" />		                             
		                  </div>
		                </td>
		              </tr>
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtTotalAmt" id="txtTotalAmt"  maxlength="16" onkeypress="return filter_real(event,this,10,2)"  tabindex="9"></input>
                  </div>
                </td>
              </tr>                 
            </table>
                  ...
                  <div id="sub_ledge_dis" >
                    <table cellspacing="1" cellpadding="2" border="1"
			                ...
			                <td>
			                  <div align="left">
			                    <input type="text" name="txtAcc_HeadCode" 
			                           id="txtAcc_HeadCode" maxlength="6" value="610102" disabled="disabled" onkeypress="return numbersonly(event)"
				                         onchange="sixdigit();" 
		              ...
		              <tr class="table">
		                ...
		                <td>
		                  <div align="left">
		                    <select name="office_id" id="office_id" tabindex="4" >
