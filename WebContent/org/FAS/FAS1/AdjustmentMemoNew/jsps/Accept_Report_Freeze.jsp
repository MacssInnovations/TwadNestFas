...
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
      ...
      <script language="javascript" type="text/javascript" src="../js/Accept_Report_Freeze.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo Accept Report Freeze</font>
          </div>
        </td>
      </tr>
</table>
     ...
     <br> 
        ...
        <table align="center"  cellspacing="3" cellpadding="2" border="0" width="100%" >
	      ...
	      <tr class="tdH">
		      <td>
		          <div align="center">
		             <input type="button" name="butSub" id="butSub" value="Freeze" onclick="update()"/>
                        &nbsp;&nbsp;&nbsp; 
