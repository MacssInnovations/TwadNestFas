...
<html>
  <head>
    ...
    <script type="text/javascript" src="../js/Adj_Memo_MultipleReceipt_Edit.js"></script>
 ...
 <body onload="loadDate(),LoadAccountingUnitID('LIST_ALL_UNITS'),doFunction_voucher('load_Receipt_No',null)" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo from Board Edit</font>
          </div>
        </td>
      </tr>
    </table>
  ...
  <% 
         ...
         %>
  <form name="Adjustment_Memo_Form" id="Adjustment_Memo_Form" method="POST" action="../../../../../Adj_Memo_MultipleReceipt_Edit?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
                ...
                <td>
                   <div align="left">
                     <textarea rows="3"  tabindex="8" cols="35" id="authority" name="authority" ></textarea>
                  </div>
                </td>
              </tr>   
               <tr class="table">
                ...
                <td>
                   <div align="left">
                     <textarea rows="3"  tabindex="8" cols="35" id="authorityaddress" name="authorityaddress" ></textarea>
                  </div>
                </td>
              </tr>   
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                     <textarea rows="3"  tabindex="8" cols="35" id="particulars" name="particulars" ></textarea>
                  </div>
                </td>
              </tr>   
                  ...
                  <div id="sub_ledge_dis" >
                    <table cellspacing="1" cellpadding="2" border="1"
		              ...
		              <tr class="table">
					          ...
					          <td>
					              <div align="left">
					                ...
					                <select name="txtCB_Month" id="txtCB_Month" tabindex="4" onchange="doFunction_voucher('load_Receipt_No1',null);">
				              ...
				              <td>
				                  <div align="left">
				                    <select size="1" name="txtReceipt_No" id="txtReceipt_No"
				                            tabindex="5"
				                            onchange="doFunction_voucher('load_Receipt_Details1','null');">
		              ...
		              <tr class="table">
		                ...
		                <td>
		                  <div align="left">
		                    <textarea name="txtParticular" id="txtParticular" cols="70" 
		                              rows="3"></textarea>
		                  </div>
		                </td>
		              </tr>
