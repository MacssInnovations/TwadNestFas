...
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
      ...
      <script language="javascript" type="text/javascript" src="../js/Adj_Memo_Pending_List.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     	 function loadyear_month()
         {
	         ...
	         document.PendingList.txtCB_Year.value=year;
	         document.PendingList.txtCB_Month.value=month;
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Adjustment Memo Pending List</font>
          </div>
        </td>
      </tr>
</table>
...
<form name="PendingList" method="POST">
<div align="center">
			          ...
			          <div align="left">
			              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
			                    ...
			                    <img src="../../../../../images/calendr3.gif"
			                         onclick="showCalendarControl(document.PendingList.txtFrom_date);"
			                    ...
			                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
			                     ...
			                     <img src="../../../../../images/calendr3.gif"
			                         onclick="showCalendarControl(document.PendingList.txtTo_date);"
			                         alt="Show Calendar"></img>
