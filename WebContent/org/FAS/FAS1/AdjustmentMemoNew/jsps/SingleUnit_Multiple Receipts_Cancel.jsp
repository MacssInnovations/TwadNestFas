...
<html>
  <head>
    ...
    <script type="text/javascript" src="../js/Adj_Memo_MultipleReceipt_Cancel.js"></script>
 ...
 <body onload="loadDate(),LoadAccountingUnitID('LIST_ALL_UNITS'),doFunction_voucher('load_Receipt_No',null)" bgcolor="rgb(255,255,225)">
  ...
  <% 
         ...
         %>
  <form name="Adjustment_Memo_Form" id="Adjustment_Memo_Form" method="POST" action="../../../../../Adj_Memo_MultipleReceipt_Cancel?Command=Add"
