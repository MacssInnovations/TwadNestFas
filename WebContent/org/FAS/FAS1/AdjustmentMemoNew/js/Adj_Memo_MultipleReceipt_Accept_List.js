...
function Show(unitcode,yr,mon,vocNo,for_unit)
{
		//alert("unitcode>>>"+unitcode+"yr>>>"+yr+"mon>>>"+mon+"vocNo>>>"+vocNo+"for_unit>>>"+for_unit);
    ...
    Receipt_list_SL= window.open("../../../../../org/FAS/FAS1/AdjustmentMemoNew/jsps/Adj_Memo_MultipleReceipt_DetailPart.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&vocNo="+vocNo+"&for_unit="+for_unit+"&accep_status=Y","SingleReceiptList","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();
...
{   
        ...
        var cmbAdvice=document.getElementById("cmbAdvice").value;
        ...
        {  
            ...
            {
	                var url="../../../../../Adj_Memo_MultipleReceipt_Accept_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
	                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&cmbAdvice="+cmbAdvice;
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adj_Memo_MultipleReceipt_Accept_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbStatus="+cmbStatus+"&cmbAdvice="+cmbAdvice;
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
                {
...
function loadPage(page)
{
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                        ...
		                        items[7]=service[i].getElementsByTagName("for_unit_id")[0].firstChild.nodeValue;
		                        var tbody=document.getElementById("tbody");
		                        ...
		                        var url="javascript:Show('"+Ucode+"','"+Offid+"','"+txtCB_Year1+"','"+txtCB_Month1+"','"+items[0]+"','"+items[7]+"')";
		                        anc.href=url;
	...
	//alert("here");
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                       ...
		                       // items[0]=service[i].getElementsByTagName("for_unit_id")[0].firstChild.nodeValue;
		                        items[0]=service[i].getElementsByTagName("OFFICE_NAME")[0].firstChild.nodeValue;
		                        items[1]=service[i].getElementsByTagName("VOUCHER_NO")[0].firstChild.nodeValue;
		                       
		                        items[2]=service[i].getElementsByTagName("VOUCHER_DATE")[0].firstChild.nodeValue;
		                        var date1=service[i].getElementsByTagName("VOUCHER_DATE")[0].firstChild.nodeValue.split("/")
		                          txtCB_Year1=date1[2];
		                         txtCB_Month1=date1[1];
		                        
//		                        items[3]=service[i].getElementsByTagName("acceptunit")[0].firstChild.nodeValue;
		                        items[3]=service[i].getElementsByTagName("acpt_office_name")[0].firstChild.nodeValue;
		                        items[4]=service[i].getElementsByTagName("accept_voucher_date")[0].firstChild.nodeValue;
		                       
		                        
		                        if(service[i].getElementsByTagName("PARTICULARS")[0].firstChild == null){
									items[5]= "";
								}else{
									 items[5]=service[i].getElementsByTagName("PARTICULARS")[0].firstChild.nodeValue;

								}
		                       
		                        items[6]=service[i].getElementsByTagName("TOTAL_AMOUNT")[0].firstChild.nodeValue;
		                      
		                        items[7]=service[i].getElementsByTagName("receiptno")[0].firstChild.nodeValue;
		                       
		                        items[8]=service[i].getElementsByTagName("receiptdate")[0].firstChild.nodeValue;
		                        items[9]=service[i].getElementsByTagName("for_unit_id")[0].firstChild.nodeValue;
		                        items[10]=service[i].getElementsByTagName("acceptunit")[0].firstChild.nodeValue;
		                        //
		                        ...
		                        cell.align='CENTER';
		                        var anc=document.createElement("A");
//		                        var url="javascript:Show('"+Ucode+"','"+Offid+"','"+txtCB_Year1+"','"+txtCB_Month1+"','"+items[9]+"','"+items[10]+"')";
		                        var url="javascript:Show('"+Ucode+"','"+txtCB_Year1+"','"+txtCB_Month1+"','"+items[1]+"','"+items[9]+"')";
		                        anc.href=url;
		                        var txtedit=document.createTextNode("DETAILS");
		                        anc.appendChild(txtedit);
		                        cell.appendChild(anc);
