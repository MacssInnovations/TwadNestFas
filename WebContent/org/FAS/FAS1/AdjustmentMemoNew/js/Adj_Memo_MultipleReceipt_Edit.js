...
function doFunction_voucher(command,param)
{
		...
		{
			var url="../../../../../Adj_Memo_MultipleReceipt_Edit?Command=load_Voucher_No&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date;
			//alert(url);
		...
		else if(command=="load_Receipt_Details")
		{
			...
			var url="../../../../../Adj_Memo_MultipleReceipt_Edit?Command=load_Ref_No&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbvocharNo="+cmbvocharNo+"&txtCrea_date="+txtCrea_date;                                    
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
		...
		else if(command=="load_Receipt_No1")
		{
			
			var url="../../../../../Adjustment_Memo_Creation?Command=loadno&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCrea_date="+txtCrea_date;
			 var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
		...
		else if(command=="load_Receipt_Details1")
		{
		   ...
		   if(req.status==200)
	          {
                  ...
                  // alert(command);
                    ...
                    { 
	                	loadreceiptNo(baseResponse);
                    }
	                else if(command=="load_Ref_Number")
                    { 
	                	loadreceiptdetails(baseResponse);
                    }
	          }
	    }
}
...
function loadreceiptNo(baseResponse)
{
...
function loadreceiptdetails(baseResponse)
{
	//alert("enter");
