...
{  
	//alert("main function");
        ...
        {  
            ...
            {
	                var url="../../../../../Adj_Memo_SingleReceipt_Accept_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adj_Memo_SingleReceipt_Accept_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
