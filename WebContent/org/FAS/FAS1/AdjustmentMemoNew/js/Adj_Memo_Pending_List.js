...
{   
        ...
        {  
            ...
            {
	                var url="../../../../../Adjust_Memo_Pending_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adjust_Memo_Pending_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function loadPage(page)
{
            ...
            document.PendingList.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
