...
function doFunction_voucher(command,param)
{
	...
	//	var txtCB_Year=document.getElementById("txtCB_Year").value;
		...
		{
			var url="../../../../../AdjustmentMemo_SingleReceiptMultipleUnit_Report1?Command=load_Voucher_No&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date;
			//alert(url);
		...
		else if(command=="load_Receipt_Details")
		{
			...
			var url="../../../../../AdjustmentMemo_SingleReceiptMultipleUnit_Report1?Command=load_Ref_No&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&cmbvocharNo="+cmbvocharNo;                                    
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
...
{
	var office_id=document.forms[0].office_id;
	var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue
	if(flag=="success")
	{
	 var accountunitid=baseResponse.getElementsByTagName("accountunitid");
	  var officename=baseResponse.getElementsByTagName("officename");
	 if(accountunitid.length>0)
	 {
		  for(var i=0;i<accountunitid.length;i++)
		  {
	 var opt=document.createElement('option');
     opt.value=accountunitid[i].firstChild.nodeValue;
     opt.innerHTML=officename[i].firstChild.nodeValue;
     office_id.appendChild(opt);
		  }
	 }
...
function add()
{
	 ...
	 var cmbvocharNo=document.forms[0].cmbvocharNo.value;
	// var particulars=document.forms[0].particulars.value;
	 var office_id=document.forms[0].office_id.value;
	 alert(office_id);
	 var txtOfficeAddress=document.forms[0].txtOfficeAddress.value;
	
	 
	 var url="../../../../../AdjustmentMemo_SingleReceiptMultipleUnit_Report1?Command=Add&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&cmbvocharNo="+cmbvocharNo+"&txtOfficeAddress="+txtOfficeAddress+"&officeid="+office_id;
...
function report()
{
//alert("enter into the function");
	// var btnvalue1=document.forms[0].butSub1.value;
	// var cmbAcc_UnitCode=document.forms[0].cmbAcc_UnitCode.value;
	// var cmbOffice_code=document.forms[0].cmbOffice_code.value;
	 var txtCrea_date=document.forms[0].txtCrea_date.value;
	 var cmbvocharNo=document.forms[0].cmbvocharNo.value;
	
	 var url="../../../../../AdjustmentMemo_SingleReceiptMultipleUnit_Report1?Command=REPORT&txtCrea_date="+txtCrea_date+"&cmbvocharNo="+cmbvocharNo;
	 //alert(url);
	  document.Adjustment_Memo_Form.action=url;
      document.Adjustment_Memo_Form.submit();
	
}
function Verify_officeAddress()
{
	
	alert("Enter into Verify_officeAddress()")
	var cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code=document.getElementById("cmbOffice_code").value;

	   var txtCrea_date=document.getElementById("txtCrea_date").value;
	 var cmbvocharNo=document.forms[0].cmbvocharNo.value;
	 var url="../../../../../AdjustmentMemo_SingleReceiptMultipleUnit_Report1?Command=verify&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&cmbvocharNo="+cmbvocharNo;
