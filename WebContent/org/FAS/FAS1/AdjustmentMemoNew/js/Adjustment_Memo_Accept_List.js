...
{   
        ...
        {  
            ...
            {
	                var url="../../../../../Adjust_Memo_Accept_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adjust_Memo_Accept_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function loadPage(page)
{
            ...
            document.AcceptList.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                        ...
		                        items[7]=service[i].getElementsByTagName("JOUR_NO")[0].firstChild.nodeValue;
