...
function Show(unitcode,offid,yr,mon,vocNo,for_unit)
{
    ...
    Receipt_list_SL= window.open("../../../../../org/FAS/FAS1/AdjustmentMemoNew/jsps/Adj_Memo_MultipleReceipt_DetailPart.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&vocNo="+vocNo+"&for_unit="+for_unit+"&accep_status=null","SingleReceiptList","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();
...
{   
       ...
       // var check = document.getElementById("displayingOrder").checked;
      //   alert(check)
       //  if(check==true){
			// c="All"
		// }
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
						...
						var url="../../../../../Adj_Memo_MultipleReceipt_Pending_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
	                "&cmbOffice_code="+cmbOffice_code+"&status="+c+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&cmbAdvice="+cmbAdvice;
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adj_Memo_MultipleReceipt_Pending_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function loadPage(page)
{
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                        ...
		                        items[7]=service[i].getElementsByTagName("for_unit")[0].firstChild.nodeValue;
		                        var tbody=document.getElementById("tbody");
