...
function Show(unitcode,offid,yr,mon,vocNo,for_unit)
{
    ...
    Receipt_list_SL= window.open("../../../../../org/FAS/FAS1/AdjustmentMemoNew/jsps/Adj_Memo_MultipleReceipt_DetailPart.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&vocNo="+vocNo+"&for_unit="+for_unit+"&accep_status=N","SingleReceiptList","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();
...
{   
        ...
        {  
            ...
            {
	                var url="../../../../../Adj_Memo_MultipleReceipt_Reject_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adj_Memo_MultipleReceipt_Reject_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function loadPage(page)
{
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                        ...
		                        cell.align='CENTER';
		                        var txtedit=document.createTextNode(items[8]);
