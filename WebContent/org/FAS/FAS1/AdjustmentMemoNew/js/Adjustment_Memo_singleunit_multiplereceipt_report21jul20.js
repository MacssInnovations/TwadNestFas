...
function call_clr()
{
	    ...
	    document.getElementById("cmbvocharNo").value="0";
...
function report()
{
	 ...
	 var url="../../../../../SingleUnit_multipleReceipt_Report1?Command=REPORT&txtCrea_date="+txtCrea_date+"&cmbvocharNo="+cmbvocharNo[0]+"&rpttype="+rpttype;
	 alert(url);
