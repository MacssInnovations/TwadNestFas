...
function Show(unitcode,offid,yr,mon,vocNo)
{
    ...
    Receipt_list_SL= window.open("../../../../../org/FAS/FAS1/AdjustmentMemoNew/jsps/Adj_Memo_SingleReceipt_DetailPart.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&vocNo="+vocNo,"SingleReceiptList","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();
...
{   
        ...
        {  
            ...
            {
	                var url="../../../../../Adj_Memo_SingleReceipt_List_one?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var url="../../../../../Adj_Memo_SingleReceipt_List_one?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function loadPage(page)
{
            ...
            if(service)
		    {
		                ...
		                for(i=p;i<service.length&& c<__pagination;i++)
		                {
		                       ...
		                       // items[2]=service[i].getElementsByTagName("PARTICULARS")[0].firstChild.nodeValue;
		                       
		                        items[2]=service[i].getElementsByTagName("TOTAL_AMOUNT")[0].firstChild.nodeValue;
		                      
		                        items[3]=service[i].getElementsByTagName("receiptno")[0].firstChild.nodeValue;
		                       
		                        items[4]=service[i].getElementsByTagName("receiptdate")[0].firstChild.nodeValue;
