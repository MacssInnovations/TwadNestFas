...
{   
        ...
        {  
           ...
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            {
            var url="../../../../../Supplement_Journal_Cancel.kv?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtJournalVou_No!="")
            {
            var url="../../../../../Supplement_Journal_Cancel.kv?Command=load_Voucher_Details&txtJournalVou_No="+txtJournalVou_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function load_Voucher_Details(baseResponse)
{
    ...
    if(flag=="success")
    {
		if(baseResponse.getElementsByTagName("cheq_No")[0].firstChild!=undefined)
       ...
       var Mas_SL_desc=baseResponse.getElementsByTagName("Mas_SL_desc")[0].firstChild.nodeValue;
...
//               }
//           }
    	  // alert("Mas_SL_desc===>"+Mas_SL_desc);
    	   document.getElementById("cmbMas_SL_type").value=Mas_SL_desc;
      ...
      document.getElementById("txtRecei_from").value="";*/
       ...
       var tbody=document.getElementById("grid_body");
        ...
        if(baseResponse.getElementsByTagName("sub_part")[k].firstChild!=null)
