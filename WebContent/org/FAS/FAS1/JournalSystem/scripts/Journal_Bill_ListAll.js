...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Voucher_list_SL= window.open("../../../../../org/FAS/FAS1/JournalSystem/jsps/Journal_Bill_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"ReceiptDateSearch","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Voucher_list_SL.moveTo(250,250);  
    Voucher_list_SL.focus();
...
function printing(unitcode,offid,yr,mon,recNo,type)
{
   // alert("inside printing function");
    ...
    if(type==108){
    	txtCreat_By_Module='GJV';
    }else{
     txtCreat_By_Module='LJV';
    }
    ...
    document.frmJournal_Bill_ListAll.action=url;
    document.frmJournal_Bill_ListAll.method="POST";
    document.frmJournal_Bill_ListAll.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            {
                var txtCreat_By_Module='LJV';
                var url="../../../../../Journal_ListAll.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&type=2";                ;
             //   alert(url);
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='LJV';
                var url="../../../../../Journal_ListAll.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&type=2";                
                //alert(url);
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../Journal_ListAll.view?Command=SLSsearchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
       ...
       else if(Command=="SLSsearchByDate")
        {  
            var txtCB_Year=document.getElementById("txtCB_Year").value;
            var txtCB_Month=document.getElementById("txtCB_Month").value;
            var txtFrom_date=document.getElementById("txtFrom_date").value;
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='GJV';
                var url="../../../../../Journal_ListAll.view?Command=SLSsearchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
...
{
//alert('test');
var page=document.frmJournal_Bill_ListAll.cmbpage.value;
//alert(page);
...
function loadPage(page)
{
         ...
         // alert(page);
            document.frmJournal_Bill_ListAll.cmbpage.selectedIndex=page-1;
                var tbody=document.getElementById("tbody");
                     ...
                     c++;
                      ...
                      //  alert(items[1]);
                       ...
                       // alert(items[4]);
                        ...
                        items[5]=service[i].getElementsByTagName("CB_REF_NO")[0].firstChild.nodeValue;
                        items[6]=service[i].getElementsByTagName("CB_REF_DATE")[0].firstChild.nodeValue;
                        items[7]=service[i].getElementsByTagName("typecode")[0].firstChild.nodeValue;
                        items[8]=service[i].getElementsByTagName("Mode")[0].firstChild.nodeValue;
                       ...
                       if(document.getElementById("cmbAcc_UnitCode").value!==null)
                        {
                            if(document.getElementById("cmbStatus").value=='L')
                            {
                                ...
                                cell.align='CENTER';
                                var anc=document.createElement("A");
                                var url="javascript:printing('"+Ucode+"','"+Offid+"','"+txtCB_Year+"','"+txtCB_Month+"','"+items[0]+"','"+items[5]+"')";
                                anc.href=url;
                                var txtedit=document.createTextNode("PRINT");
                                anc.appendChild(txtedit);
                                cell.appendChild(anc);
...
function changepagesize()
{
           ...
           __pagination=document.frmJournal_Bill_ListAll.cmbpagination.value;
