...
{   
        ...
        {  
           ...
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            {
            var url="../../../../../Rectificational_Journal_Cancel?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtJournalVou_No!="")
            {
            var url="../../../../../Rectificational_Journal_Cancel?Command=load_Voucher_Details&txtJournalVou_No="+txtJournalVou_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
