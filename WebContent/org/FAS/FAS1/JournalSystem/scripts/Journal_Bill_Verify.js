...
{   
           ...
           if(Command=="loadPendingJournals_NV")
           {
            ...
            var url="../../../../../Journal_Bill_Verify.kv?Command=loadPendingJournals_NV&cmbAcc_UnitCode="+cmbAcc_UnitCode
           ...
           var url="../../../../../Journal_Bill_Verify.kv?Command=loadPendingJournals_V&cmbAcc_UnitCode="+cmbAcc_UnitCode
                    +"&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtfromdate="+txtfromdate+"&txttodate="+txttodate;
