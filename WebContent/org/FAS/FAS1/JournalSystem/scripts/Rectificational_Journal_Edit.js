...
//        var doc_No=rcells.item(11).firstChild.value;
//        alert(">>><<<<"+doc_No);        
//        document.frmJournal_General_Edit.receiptno.value=doc_No;        
        
        
//        try{document.getElementById("receiptno").value=rcells.item(11).firstChild.value;}catch(e){}
//        alert(">>>***>>>>"+document.getElementById("receiptno").value);
        tohidedoc();
...
//        var rno=document.getElementById("receiptno").value;
//    	alert(">>>****>>>>"+rno);
//        try{rno=rcells.item(11).firstChild.value;}catch(e){} 
//        alert(">>>**rno**>>>>"+rno);
