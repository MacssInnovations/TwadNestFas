...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    document.frmJournal_ListAll_Deft.action=url;
    document.frmJournal_ListAll_Deft.method="POST";
    document.frmJournal_ListAll_Deft.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            {
                var txtCreat_By_Module='GJV';
                var url="../../../../../Rectificational_Journal_ListAll_Deft?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='GJV';
                var url="../../../../../Rectificational_Journal_ListAll_Deft?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
{
//alert('test');
var page=document.frmJournal_ListAll_Deft.cmbpage.value;
//alert(page);
...
function loadPage(page)
{
         ...
         // alert(page);
            document.frmJournal_ListAll_Deft.cmbpage.selectedIndex=page-1;
                var tbody=document.getElementById("tbody");
...
function changepagesize()
{
           ...
           __pagination=document.frmJournal_ListAll_Deft.cmbpagination.value;
