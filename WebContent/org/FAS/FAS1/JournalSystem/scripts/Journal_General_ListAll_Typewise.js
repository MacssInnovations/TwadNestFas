...
{   
        ...
        var cmbJrnltype=document.getElementById("cmbJrnltype").value;
        //alert("cmbJrnltype**********"+cmbJrnltype);
        ...
        {  
            ...
            {
               // var txtCreat_By_Module='GJV';
                var url="../../../../../Journal_ListAll_Typewise.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&cmbJrnltype="+cmbJrnltype;
                //alert(url);
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                //var txtCreat_By_Module='GJV';
                var url="../../../../../Journal_ListAll_Typewise.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbStatus="+cmbStatus+"&cmbJrnltype="+cmbJrnltype;
                //alert(url);
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
