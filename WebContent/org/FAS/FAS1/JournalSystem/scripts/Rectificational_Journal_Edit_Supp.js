...
{   
        ...
        {  
           ...
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            {
            var url="../../../../../Rectificational_Journal_Edit?Command=load_Voucher_No_Supp&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&supNo="+supNo;	
            //alert(url)
        ...
        {  
            ...
            if(txtJournalVou_No!="")
            {
            var url="../../../../../Rectificational_Journal_Edit?Command=load_Voucher_Details_Supp&txtJournalVou_No="+txtJournalVou_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&supNo="+supNo;	
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
     ...
     setTimeout('document.getElementById("cmbSL_type").value=com_cmbSL_type',900); 
      ...
      try{document.getElementById("cmbSL_Code").value=rcells.item(4).firstChild.value;}catch(e){}
       ...
       var val=Trim(rcells.item(10).firstChild.value);
        	...
        	for(i=0;i<document.frmJournal_General_Edit.paymentreceipt.length;i++)
        	{
        	if(document.frmJournal_General_Edit.paymentreceipt.options[i].value==val)
        	{
     		document.frmJournal_General_Edit.paymentreceipt.selectedIndex=i;
        	}
        	}
     ...
     //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       ...
       */ 
       /*  cmbSL_type=document.getElementById("cmbSL_type").value;
        ...
        var w = document.frmJournal_General_Edit.receiptno.selectedIndex;
        var selected_text = document.frmJournal_General_Edit.receiptno.options[w].text;
...
function payreceipt()
{
	...
	xmlhttp=getxmlhttpObject();
	 var url="../../../../../Rectificational_Journal?command=paymentreceipt&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&adjyear="+adjyear+"&adjmonth="+adjmonth+"&doctype="+doctype+"";
     //alert(url);
