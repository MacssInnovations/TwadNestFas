...
{   
        ...
        {  
	            ...
	            {
		                var txtCreat_By_Module='GJV';
		                var url="../../../../../Imprest_Journal_ListAll?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
		                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbAdvance_type;
		                //alert(url);
        ...
        {  
	            ...
	            {
		                var txtCreat_By_Module='GJV';
		                var url="../../../../../Imprest_Journal_ListAll?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
		                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
		                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbAdvance_type;
		                //alert(url);
		                var req=getTransport();
		                req.open("GET",url,true); 
		                req.onreadystatechange=function()
