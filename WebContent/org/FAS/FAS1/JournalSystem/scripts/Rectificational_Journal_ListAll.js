...
{   
        ...
        {  
            ...
            {
                var txtCreat_By_Module='GJV';
                var url="../../../../../Rectificational_Journal_ListAll?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='GJV';
                var url="../../../../../Rectificational_Journal_ListAll?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
