...
document.frmJournal_General.rad_sub_CR_DR[1].checked=false;
...
function update_GRID() {
 ...
 if((txtAcc_HeadCode==900301) || (txtAcc_HeadCode==620101))
        {
	if (adjyear == "") {
...
function checkNull() {
	 ...
	 * alert("Enter the value in Received From Field");
	 * //document.getElementById("txtRecei_from").focus(); return false; }
	 */
...
function payreceipt() {
	...
	var adjyear = document.getElementById("adjyear").value;
	var adjmonth = document.getElementById("adjmonth").value;
	var loginUnit = document.getElementById("cmbAcc_UnitCode").value;
        var txtUnitId = document.getElementById("txtUnitId").value;
	...
	xmlhttp = getxmlhttpObject();
		...
		if (txtAcc_HeadCode==900301) {
			var url = "../../../../../TPA_Cut_off_Journal?command=paymentreceipt&cmbAcc_UnitCode="
					+ txtUnitId
					...
					+ "&adjmonth="
					+ adjmonth
					+ "&doctype=" + doctype + "&acc_hd_code=900301"+"&loginUnit="+loginUnit;
			...
			var url = "../../../../../TPA_Cut_off_Journal?command=paymentreceipt&cmbAcc_UnitCode="
					...
					+ "&adjmonth="
					+ adjmonth
					+ "&doctype=" + doctype + "&acc_hd_code=620101"+"&loginUnit="+loginUnit;
		}
		//alert(url);
...
function payreceiptdetails() {
	...
	payreceipt = window.open(
			"Rectification_Pay_Receipt_Details.jsp?cmbAcc_UnitCode="
					+ cmbAcc_UnitCode
					+ "&yr=" + adjyear + "&mon=" + adjmonth + "&recNo=" + docno
...
function acheadcodecheck(chec) {
    ...
    if( (txtAcc_HeadCode==620101) || (txtAcc_HeadCode==900301) )
        {
...
function loadTransferUnit() {
	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	url = "../../../../../TDA_Raised_Create?command=loadTransferUnit_one&txtUnitId="
			+ cmbAcc_UnitCode;
...
//	document.getElementById("txtUnitId").value=cmbSL_Code;	
	...
	document.getElementById("cmbSL_Code").value=txtUnitId;
	}
...
if(txtAcc_HeadCode==610101 || txtAcc_HeadCode==610102)
{
	...
	document.getElementById("txtAcc_HeadDesc").value = "";
		...
		if( (cmbMas_SL_type==79) && (txtAcc_HeadCode==900301) )
		{
		alert("This Account Head Code Not Allowed Here");
		document.getElementById("txtAcc_HeadCode").value="";
		}
		
		if( (cmbMas_SL_type==81) && (txtAcc_HeadCode==620101) )
		{
		alert("This Account Head Code Not Allowed Here");
		document.getElementById("txtAcc_HeadCode").value="";
		}
		...
		if( (cmbMas_SL_type==79) && (txtAcc_HeadCode==620101) )
		{
		document.frmJournal_General.rad_sub_CR_DR[0].disabled=true;
		document.frmJournal_General.rad_sub_CR_DR[1].checked=true;
		}else if( (cmbMas_SL_type==81) && (txtAcc_HeadCode==900301) )
		{
		document.frmJournal_General.rad_sub_CR_DR[0].checked=true;
