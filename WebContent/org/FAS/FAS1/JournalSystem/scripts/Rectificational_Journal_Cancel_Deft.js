...
{   
        ...
        {  
           clearGeneral_Detail();
           var txtCrea_date= document.frmJournal_General_Cancel_Deft.txtCrea_date.value
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            var cmbOffice_code=document.getElementById("cmbOffice_code").value;
            
            if(txtCrea_date.length!=0)
            {
            var url="../../../../../Rectificational_Journal_Cancel_Deft?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtJournalVou_No!="")
            {
            var url="../../../../../Rectificational_Journal_Cancel_Deft?Command=load_Voucher_Details&txtJournalVou_No="+txtJournalVou_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    ...
    if(flag=="success")
    {
      ...
      document.getElementById("txtAcc_HeadCode").value=hid;
       ...
       if(BalType=="CR")
             { document.frmJournal_General_Cancel_Deft.rad_sub_CR_DR[0].checked=true;}
       else if(BalType=="DR")
       {
            document.frmJournal_General_Cancel_Deft.rad_sub_CR_DR[1].checked=true;
            }
...
function clearall()
{
 ...
 document.frmJournal_General_Cancel_Deft.cmdadd.style.display='block';
 document.frmJournal_General_Cancel_Deft.cmdupdate.style.display='none';
 document.frmJournal_General_Cancel_Deft.cmddelete.disabled=true;
}
...
function load_Voucher_Details(baseResponse)
{
    ...
    if(flag=="success")
    {
       ...
       sltype[75]="Recification Journal";
