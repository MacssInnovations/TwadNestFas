...
var tbody=document.getElementById("grid_body");
        ...
        if(document.getElementById("cmbMas_SL_type").value==82)
         ...
         document.frmJournal_General_Deft.rad_sub_CR_DR[1].checked=true;
          document.frmJournal_General_Deft.rad_sub_CR_DR[0].checked=false;
         //  document.frmJournal_General_Deft.rad_sub_CR_DR[1].disabled=true;
          document.frmJournal_General_Deft.rad_sub_CR_DR[0].disabled=true;
         
         }
         else
         {
         document.frmJournal_General_Deft.rad_sub_CR_DR[1].disabled=false;
          document.frmJournal_General_Deft.rad_sub_CR_DR[0].disabled=false;
       ...
       //text_field.readOnly=true;
        ...
        try{common_cmbSL_Code=rcells.item(4).firstChild.value;} catch(e){common_cmbSL_Code=""} 
         ...
         document.frmJournal_General_Deft.rad_sub_CR_DR[0].checked=true;
    ...
    document.frmJournal_General_Deft.cmdupdate.style.display='block';
    document.frmJournal_General_Deft.cmddelete.disabled=false;
    document.frmJournal_General_Deft.cmdadd.style.display='none';
}
...
function ADD_GRID()
{
      ...
      if ( isMan.account_head_status) 
       ...
       else
       {
        ...
        var w = document.frmJournal_General_Deft.receiptno.selectedIndex;
        var selected_text = document.frmJournal_General_Deft.receiptno.options[w].text;
        ...
        if(document.frmJournal_General_Deft.rad_sub_CR_DR[0].checked==true)
          items[2]=document.frmJournal_General_Deft.rad_sub_CR_DR[0].value;
        else if(document.frmJournal_General_Deft.rad_sub_CR_DR[1].checked==true)
          items[2]=document.frmJournal_General_Deft.rad_sub_CR_DR[1].value;
...
function clear_main_fields()
{
    ...
    document.getElementById("txtParticular").value="";
     ...
     document.frmJournal_General_Deft.cmdadd.style.display='block';
     document.frmJournal_General_Deft.cmdupdate.style.display='none';
     document.frmJournal_General_Deft.cmddelete.disabled=true;
...
function payreceipt()
{
	if(document.getElementById("cmbMas_SL_type").value==91)
        ...
        //    var cmbOffice_code=document.getElementById("cmbOffice_code").value;
          xmlhttp=getxmlhttpObject();
             //var url="../../../../../Rectificational_Journal_Deft?command=paymentreceipt_centage&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&adjyear="+adjyear+"&adjmonth="+adjmonth+"&txtAcc_HeadCode="+hh;
          var url="../../../../../Rectificational_Journal_Deft?command=paymentreceipt_centage&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&adjyear="+adjyear+"&adjmonth="+adjmonth+"&txtAcc_HeadCode="+hh;
         //alert(url);
	...
	var doctype=document.getElementById("paymentreceipt").value;
        var txtAcc_HeadCode=document.getElementById("txtAcc_HeadCode").value;
	xmlhttp=getxmlhttpObject();
	 var url="../../../../../Rectificational_Journal_Deft?command=paymentreceipt&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&adjyear="+adjyear+"&adjmonth="+adjmonth+"&doctype="+doctype+"&txtAcc_HeadCode="+txtAcc_HeadCode;
	 //var url="../../../../../Rectificational_Journal_Deft?command=paymentreceipt&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&adjyear="+adjyear+"&adjmonth="+adjmonth+"&doctype="+doctype+"&txtAcc_HeadCode="+txtAcc_HeadCode;
    // alert(url);
	 url=url+"&sid="+Math.random();
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
...
//    var selected_text = document.frmJournal_General_Deft.receiptno.options[w].text;
   // alert("ttttt");
    var selected_text = document.frmJournal_General_Deft.receiptno.value;
    ...
    if(tbody.rows.length>0)
    {
     acheadcodecheck('1');
        ...
        if(document.getElementById("cmbMas_SL_type").value==82)
        {
            var cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            xmlhttp=getxmlhttpObject();
             var url="../../../../../Rectificational_Journal_Deft?command=chooseHead&cmbAcc_UnitCode="+cmbAcc_UnitCode;
        // alert(url);
             url=url+"&sid="+Math.random();
         xmlhttp.open("GET",url,true);
         xmlhttp.onreadystatechange=stateChanged;
