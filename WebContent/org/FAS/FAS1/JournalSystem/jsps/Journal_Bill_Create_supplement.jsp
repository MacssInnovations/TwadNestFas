...
<html>
  ...
  <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Journal_Bill_Create_supplement.js"></script>
    ...
    <script type="text/javascript" language="javascript">
          ...
          function loadDate()
         {
            ...
            document.frmJournal_Bill_Create.txtCrea_date.value="31/03/"+year;
            Check_Supplement_No();
...
%>
  <body onload="call_clr();loadDate();" bgcolor="rgb(255,255,225)"><table cellspacing="1"
                                                                               cellpadding="3"
                                                                               width="100%">
      <tr class="tdH">
        <td colspan="2">
    ...
    <form name="frmJournal_Bill_Create" id="frmJournal_Bill_Create" 
                  method="POST"  
                  action="../../../../../Journal_Bill_Create_supplement?Command=Add"
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" readonly
                           ...
                           onblur="return call_mainJSP_script(this,1);"/>
