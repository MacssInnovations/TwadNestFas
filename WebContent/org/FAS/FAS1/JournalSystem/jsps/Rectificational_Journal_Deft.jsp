...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Rectificational_Journal_Deft.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmJournal_General_Deft.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create Rectification Journal System (Deft)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmJournal_General_Deft" id="frmJournal_General_Deft" method="POST"
                  action="../../../../../Rectificational_Journal_Deft?Command=Add"
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_General_Deft.txtCrea_date,1);"
               ...
               <%
                     try
                     {
                         //   ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and (JOURNAL_TYPE_CODE=75 or JOURNAL_TYPE_CODE=87 or JOURNAL_TYPE_CODE=90)  order by JOURNAL_TYPE_DESC");
                            ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and JOURNAL_TYPE_CODE in(75,82,87,91,104)  order by JOURNAL_TYPE_DESC");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
               ...
               <tr class="table" >
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_General_Deft.txtCheque_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmJournal_General_Deft.txtBill_date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
