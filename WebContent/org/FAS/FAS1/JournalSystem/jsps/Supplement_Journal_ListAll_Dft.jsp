...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Supplement_Journal_ListAll.js"></script>
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Supplement Journal Vouchers ( Defunt ) </strong>
          </div>
        </td>
      </tr>
    </table>
