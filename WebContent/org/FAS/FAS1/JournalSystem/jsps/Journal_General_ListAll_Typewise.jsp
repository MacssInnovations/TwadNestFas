...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Journal_General_ListAll_Typewise.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of General Journal Vouchers</strong>
          </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbJrnltype" id="cmbJrnltype" tabindex="3">
                          <option value="0">Select Journal Type</option>
                      <option value="1">All</option>
                      <option value="53">General Adjustment Journal</option> 
                      <option value="54">Pay roll Journal</option> 
                      <option value="56">Cheque Cancellation</option> 
                      <option value="57">Cheque Dishonoured</option> 
                      <option value="62">TDA Originating Journal</option> 
                      <option value="63">TDA Accepting Journal</option> 
                      <option value="64">TDA Suspense Head Clearance</option> 
                      <option value="65">TCA Originating Journal</option> 
                      <option value="66">TCA Accepting Journal</option> 
                      <option value="67">TCA Suspense Head Clearance</option> 
                      <option value="68">Imprest Journal</option> 
                      <option value="69">Temporary Adv.  Journal</option>
                      <option value="75">Rectification Journal For erraneous Transaction</option> 
                      <option value="78">TPA CR Originating Journal</option> 
                      <option value="79">TPA CR Accepting Journal</option> 
                      <option value="80">TPA DR Originating Journal</option> 
                      <option value="81">TPA DR Accepting Journal</option> 
                      <option value="84">TWAD CPS Journal</option> 
                      <option value="90">Rectification Journal for Omitted Transactions</option> 
                    </select>
                  </div>
                </td>
              </tr>
