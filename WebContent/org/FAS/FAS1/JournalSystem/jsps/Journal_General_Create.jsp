...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Journal_General_Create.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create General Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmJournal_General" id="frmJournal_General" method="POST"
                 action="../../../../../Journal_General_Create.view?Command=Add"
        ...
        <div class="tab-page">
          ...
          <div align="center">
           ...
           <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="4" onchange="enable_cheque(this.value);pending();ClearGrid();fixAccHdCode('<%=s%>');">
               ...
               if(unitid==3)
               {
            	   try
                   {
                          ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and DISPLAY_RESTRICTED!='Y' and JOURNAL_TYPE_CODE not in ( 64, 65,105)  order by JOURNAL_TYPE_DESC");
                          rs=ps.executeQuery();
                          while(rs.next())
                          {
                ...
                <div align="left" style="display:none" id="yr_mon">
                    Year &amp; Month    
                              <input type="text" name="txtCash_year" id="txtCash_year" tabindex="3" value="2011" maxlength="4" size="5" onkeypress="return numbersonly(event)">
		         
				          <select name="txtCash_Month"  id="txtCash_Month" tabindex="4" >
                         ...
                         <input type="button"  value="Go" onclick="call_pendingbills()"></input>
                            
                    <input type="text" name="num" id="num" readonly
                           maxlength="10" size="11"  onkeypress="return numbersonly(event)"/>
                           
                    <input type="text" name="date1" id="date1" readonly
                           maxlength="14" size="11"  onkeypress="return numbersonly(event)"/>
