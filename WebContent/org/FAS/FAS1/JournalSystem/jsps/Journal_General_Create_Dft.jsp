...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Defunct General Journal System</title>
    ...
    <script type="text/javascript" src="../scripts/Journal_General_Create_dft.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create Defunct General Journal System </font>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="center">
                  ...
                  <div align="left">
                   ...
                   <%
                      ...
                      try{
                       ...
                       {
                           //commanded on 30-oct-18 ref issue id 
           ...
           <tr class="table">   
               ...
               <%
                     try
                     {
                            ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' order by JOURNAL_TYPE_DESC");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
                  ...
                  <div align="left">
                    <input type="text" name="txtAcc_HeadCode" 
                           ...
                           onkeypress="return numbersonly(event)"
                            ...
                            onblur="doFunction('checkCode','null');Acc_HeadCodeValidation();"  size="9"/>
