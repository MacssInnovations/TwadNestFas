    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
         ...
         var today= new Date(); 
           ...
           document.frmJournalBillVerify.txtfromdate.value="31/03/"+year;
           document.frmJournalBillVerify.txttodate.value="31/03/"+year;
...
%>
  <body class="table"
        onload="call_clr();loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS')">
