...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Rectificational_Journal.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        call_date(document.frmJournal_General.txtCrea_date); 
        
         }
       /*  function clrfiled()
        {
        	  document.frmJournal_General.paymentreceipt.value="";
        	document.frmJournal_General.receiptno.value="";
        	 // document.frmJournal_General.receiptno.length=0;
        	  //document.frmJournal_General.receiptno.value="";
...
%>
  <body onload="call_clr();LoadAccountingUnitID_Create('LIST_ALL_UNITS');setTimeout('loadDate()', 300);foc();Mas_SL_Type();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create Rectification Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmJournal_General" id="frmJournal_General" method="POST"
                  action="../../../../../Rectificational_Journal?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                      ...
                      try{
                        if(oid==5000)
                        {
                            ...
                            rs=ps.executeQuery();
                              ...
                              System.out.println("WING.."+rs.getInt("OFFICE_WING_SINO"));
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" readonly="readonly"
                           maxlength="10" size="11" 
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);dateCheck(this);"
           ...
           <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="4" onchange="enable_cheque(this.value),setAdjYrMnth();Mas_SL_Type();">
                      
               <%
                     try
                     {
                         //   ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and (JOURNAL_TYPE_CODE=75 or JOURNAL_TYPE_CODE=87 or JOURNAL_TYPE_CODE=90)  order by JOURNAL_TYPE_DESC");
                            ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and JOURNAL_TYPE_CODE in(75,82,87,91,104,109,113)  order by JOURNAL_TYPE_DESC");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              <tr>
                ...
                <!--  <div id="hCodeDiv" name="hCodeDiv" style="display:none">
                        ...
                        <td colspan="2" height="23">
                         <div align="center">
                          ...
                          <input type="button" name="cmdadd" id="cmdadd"
                                 value="ADD" onclick="testCode();" style="display:block"/></td>
                          <td>
                          <input type="button" name="cmdupdate" value="UPDATE"
                                 id="cmdupdate" onclick="editTest();"
