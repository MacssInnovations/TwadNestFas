...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Journal_Bill_Edit.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmJournal_Bill_Edit.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Edit Journal System (for Liablity ) </font>
          </div>
        </td>
      </tr>
    </table><form name="frmJournal_Bill_Edit" id="frmJournal_Bill_Edit"
                  method="POST"
                  action="../../../../../Journal_Bill_Edit.view?Command=Add"
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_Bill_Edit.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <select size="1" name="txtJournalVou_No" id="txtJournalVou_No"
                            tabindex="5" onchange="doFunction_voucher('load_Voucher_Details','null');">
               ...
               <tr class="tdTitle">
                ...
                <tr class="table">
                  ...
                  <tr class="table">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_Bill_Edit.txtReferDate_edit);"
                         alt="Show Calendar"></img>
                      </div>
                    </td>
                 </tr>
                          ...
                          <div align="left">
                            <input type="text" name="txtAcc_HeadCode"
                                   ...
                                   onkeypress="return numbersonly(event)"
                                    ...
                                    onblur="doFunctionBLOCK('checkCode','null');Acc_HeadCodeValidation();" 
                                   size="9"/>
             ...
             <td>
              ...
              <td>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmJournal_Bill_Edit.txtBill_date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmJournal_Bill_Edit.txtAgree_Date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div align="left">
                            <input type="text" name="txtsub_Amount"
                                   onkeypress="return limit_amt_journal(this,event);"
                  ...
                  <div id="grid" style="display:block">
                    ...
                    <input type="hidden" id="CB_REF_NO" name="CB_REF_NO" value="0">
                    <input type="hidden" id="CB_REF_DATE" name="CB_REF_DATE" value="">
                    <input type="hidden" id="MULTIPLE_PVRS" name="MULTIPLE_PVRS" value="">
                    <input type="hidden" id="MULTIPLE_PVR_DETAILS" name="MULTIPLE_PVR_DETAILS" value="">
                    <input type="hidden" id="CB_TDCA_REF_NO" name="CB_TDCA_REF_NO" value="">
                    <input type="hidden" id="CB_TDCA_REF_DATE" name="CB_TDCA_REF_DATE" value="">
                    <input type="hidden" id="CB_TPA_REF_NO" name="CB_TPA_REF_NO" value="">
			        <input type="hidden" id="CB_TPA_REF_DATE" name="CB_TPA_REF_DATE" value="">
			        
			         <input type="hidden" name="VERIFIED" id="VERIFIED">
                  <input type="hidden" name="VERIFIED_DATE" id="VERIFIED_DATE">
                  <input type="hidden" name="VERIFIED_AUTHORITY" id="VERIFIED_AUTHORITY">
