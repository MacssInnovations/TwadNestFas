...
%>
<body onload="LoadAccountingUnitID('LIST_ALL_UNITS');loadDate();foc();" bgcolor="rgb(255,255,225)">
						...
						<tr class="table">
							...
							<td>
								...
								<div align="left">
									...
									<select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" onChange="common_LoadOffice(this.value);" onblur="clr();"
								tabindex="1">
							...
							<td>
								<div align="left">
									<input type="text" name="txtCrea_date" id="txtCrea_date"
										...
										onblur="return call_mainJSP_script(this,1);" /> <img
							...
							<td>
								<div align="left">
									<select name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="6" 
										...
										<%
											try {
												ps = con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='L' AND JOURNAL_TYPE_CODE=11");
												rs = ps.executeQuery();
												if (rs.next()) {
													out.println("<option value="
							...
							<td width="60%">
								<table align="left">
									<tr align="left">
										<td>
											<div align="left">
												<select size="1" name="cmbMas_SL_Code" id="cmbMas_SL_Code" onchange="getmyvalue();"
													tabindex="7">
