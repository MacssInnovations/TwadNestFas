...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Rectification Journal System</title>
    ...
    <script type="text/javascript" src="../scripts/Rectificational_Journal_Edit.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Edit Rectification Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmJournal_General_Edit" id="frmJournal_General_Edit" method="POST"   action="../../../../../Rectificational_Journal_Edit?Command=Add"
