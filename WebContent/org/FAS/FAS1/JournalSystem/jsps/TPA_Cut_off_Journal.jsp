...
<title>TPA_Cutt_off_Journal_Create</title>
    ...
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/ReceiptSystem/scripts/Com_Function_SL_Case_closed.js"></script> 
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/ReceiptSystem/scripts/Common_ReceiptType_NegativeAmtAllowed.js"></script>
    <script type="text/javascript" src="../scripts/TPA_Cut_off_Journal.js"></script>
...
%>
  <body onload="call_clr();loadDate();LoadAccountingUnitID_Create('LIST_ALL_UNITS');setTimeout('loadTransferUnit()',500);" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create TPA Cut off Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmJournal_General" id="frmJournal_General" method="POST"
                  action="../../../../../TPA_Cut_off_Journal?Command=Add"
          ...
          <div align="center">
           ...
           <tr class="table">
               ...
               <%
                     try
                     {
                            ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and JOURNAL_TYPE_CODE in (79,81) order by JOURNAL_TYPE_DESC");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
                  ...
                  <div align="left">
                    <input type="text" name="txtAcc_HeadCode" 
                           ...
                           onkeypress="return numbersonly(event)"
                            onchange="sixdigit();" 
                            onblur="doFunction('checkCode','null');accHdCheck();"  size="9"/>
             ...
             <td>
              ...
              <tr class="table">
               ...
               <tr class="table">
                 ...
                 <td><div align="left">
                   <select name="txtUnitId" id="txtUnitId" onchange="toSetSubLedgerTypeCode();">
