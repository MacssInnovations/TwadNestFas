...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Supplement_Journal_Edit.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Edit Supplement Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmJournal_General_Edit" id="frmJournal_General_Edit" method="POST"
                  action="../../../../../Supplement_Journal_Edit.kv?Command=Add"
...
// "      || extract(YEAR FROM now()) " + modified by sathya on 18/06/2018
 ...
 "  order by a.year");
              ...
              <td>
              <div align="left">
              <select name="supNo" id="supNo" onchange="checkLiveSub();doFunction_voucher('load_Voucher_No','null');">
