...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>General Journal Verification (Defunct) </title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/General_Journal_Verify.js"></script>
    ...
    <script type="text/javascript"            
            src="../../../../../org/FAS/FAS1/Reports/ReceiptSystem/scripts/CalendarControl.js"></script>
  ...
  catch(Exception e)
  {
   ...
   %>
        ...
        <form name="frmJournalBillVerify"
              ...
              method="POST"
              action="../../../../../General_Journal_Verify.kv?Command=Add"
      ...
      <table cellspacing="2" cellpadding="3" width="100%" border="0">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Journal Verification (Defunct) </strong>
            </div>
          </td>
        </tr>
      </table>
