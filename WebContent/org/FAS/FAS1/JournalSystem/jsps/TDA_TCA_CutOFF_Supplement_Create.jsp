...
%>
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS');call_clr();loadDate();setTimeout('loadTransferUnit()',500);Check_Supplement_No();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create TCA / TDA Cut off Journal System (Supplement) </font>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" readonly tabindex="3"
