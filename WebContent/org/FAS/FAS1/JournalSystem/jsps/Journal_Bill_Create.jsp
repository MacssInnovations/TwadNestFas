...
<html>
  ...
  <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Journal_Bill_Create.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        //	  setTimeout('call_a52()',900);
            ...
            document.frmJournal_Bill_Create.txtCrea_date.value=day+"/"+month+"/"+year;
            call_date(document.frmJournal_Bill_Create.txtCrea_date); 
...
%>
  <body onload="call_clr();LoadAccountingUnitID_Create('LIST_ALL_UNITS');setTimeout('loadDate()', 300);foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
                                                                               cellpadding="3"
                                                                               width="100%">
      <tr class="tdH">
        <td colspan="2">
    ...
    <form name="frmJournal_Bill_Create" id="frmJournal_Bill_Create" 
                  method="POST"  
                  action="../../../../../Journal_Bill_Create.view?Command=Add"
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" readonly
                           ...
                           onblur="return call_mainJSP_script(this,1);dateCheck(this);"/>
                     
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_Bill_Create.txtCrea_date,1);"
                          ...
                          <div align="left">
                            <input type="text" name="txtAcc_HeadCode"
                                   ...
                                   onkeypress="return numbersonly(event)"
                                    ...
                                    onblur="checkOffices(this.value);Acc_HeadCodeValidation();" 
                                   size="9"/>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmJournal_Bill_Create.txtBill_date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            ...
                            <img src="../../../../../images/calendr3.gif"
                                 onclick="showCalendarControl(document.frmJournal_Bill_Create.txtAgree_Date);"
                                 alt="Show Calendar"></img>
                          </div>
                        </td>
                      </tr>
