...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Imprest_Journal_Edit.js"></script>
    ...
    <script type="text/javascript" language="javascript">
	       function loadDate()
	       {
	          ...
	          document.frmJournal_Imprest_Edit.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS');clrForm('load');loadDate();doFunction('checkCode','null');" bgcolor="rgb(255,255,225)">
  	<table cellspacing="1" cellpadding="3" width="100%" >
	      <tr class="tdH">
	        <td colspan="2">
	          <div align="center">
	            <font size="4">Edit Imprest/Temp.Advance A/c Journal System</font>
	          </div>
	        </td>
	      </tr>
    </table>
    
    <form name="frmJournal_Imprest_Edit" id="frmJournal_Imprest_Edit" method="POST"
                  action="../../../../../Imprest_Journal_Edit?Command=Add"
	         ...
	         <div align="center">
	            <table cellspacing="1" cellpadding="2" border="1" width="100%">
	                ...
	                <td>
	                  <div align="left">
	                    ...
	                    <img src="../../../../../images/calendr3.gif"
	                         onclick="showCalendarControl(document.frmJournal_Imprest_Edit.txtCrea_date,1);"
	              ...
	              <tr class="table">
	                ...
	                <td>
	                  <div align="left">
	                    <select size="1" name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="4" onchange="doFunction_voucher('load_Voucher_No','null');loadAccountHead();">
				                     ...
				                     try
				                     {
				                            ...
				                            while(rs.next())
				                            {
				                            	if(rs.getInt("JOURNAL_TYPE_CODE")==68){
				                            		out.println("<option value="+rs.getInt("JOURNAL_TYPE_CODE")+">"+"Imprest Journal"+"</option>");
				                            	//	out.println("<option value="+rs.getInt("JOURNAL_TYPE_CODE")+">"+"Imprest Journal-SelfCheque"+"</option>");
				                            		
				                            	}
				                            	else{
				                            		out.println("<option value="+rs.getInt("JOURNAL_TYPE_CODE")+">"+"Temporary Adv.  Journal"+"</option>");
				                            	//	out.println("<option value="+rs.getInt("JOURNAL_TYPE_CODE")+">"+"Temporary Adv.  Journal-SelfCheque"+"</option>");
				                            	}
				                            }
	               ...
	               <tr class="table">
	                <td>
	                  <div align="left">
	                    Imprest/Temporary Advance &nbsp;Voucher Number <font color="#ff2121">*</font>
	                  </div>
	                </td>
	                <td>
	                  <div align="left">
             ...
             <tr class="table">
	              ...
	              <tr class="table" >
	                ...
	                <td>
	                  <div align="left">
	                    ...
	                    <img src="../../../../../images/calendr3.gif"
	                         onclick="showCalendarControl(document.frmJournal_Imprest_Edit.txtCheque_date);"
	                         alt="Show Calendar"></img>
	                  </div>
	                </td>
	              </tr>
	            ...
	            <table cellspacing="1" cellpadding="2" border="1" width="100%">
	              <tr class="table">
	                ...
	                <td>
	                  <div align="left">
	                    <textarea name="txtRemarks" id="txtRemarks" cols="50" tabindex="8"  onkeypress="return check_leng('remarks',this.value);"
	                              rows="4"></textarea>
	                  </div>
	                </td>
	              </tr>
		                ...
		                <td>
		                  <div align="left">
		                    <input type="text" name="txtAcc_HeadCode" 
		                           ...
		                           value=<%=ac_head_code%>  size="9" onchange="callHeadCodeCP();doFunction('checkCode','null');" onblur="chkHeadcode();"/>
				             ...
				             <tr align="left">
					          ...
					          <td width="80">
					                  ...
					                  <div align="left" id="emplist_div_trans"  style="display:none">
					                            ...
					                            <input type="text" name="total_remaining_amt" id="total_remaining_amt"></input>
					                 </div>
					               </td>             
            				 </tr>
