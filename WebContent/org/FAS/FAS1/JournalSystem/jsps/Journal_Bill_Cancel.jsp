...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Journal_Bill_Cancel.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmJournal_Bill_Cancel.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancel Journal Voucher Number (for Liablity ) </font>
          </div>
        </td>
      </tr>
    </table><form name="frmJournal_Bill_Cancel" id="frmJournal_Bill_Cancel"
                  method="POST"
                  action="../../../../../Journal_Bill_Cancel.view?Command=Cancel"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmJournal_Bill_Cancel.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <select size="1" name="txtJournalVou_No" id="txtJournalVou_No"
                            tabindex="5" onchange="doFunction('load_Voucher_Details','null');">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="cmbMas_SL_type"   style="background-color: #ececec"  readonly="readonly"  
                ...
                <td width="60%">
                  <table align="left">
                    <tr align="left">
                      <td>
                        <div align="left">
                          <input type="text" name="cmbMas_SL_Code"   style="background-color: #ececec"  readonly="readonly"  
