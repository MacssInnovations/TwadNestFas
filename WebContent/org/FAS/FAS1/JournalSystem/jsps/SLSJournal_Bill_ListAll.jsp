...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>SLS Journal System</title>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmJournal_Bill_ListAll.txtCB_Year.value=year;
        document.frmJournal_Bill_ListAll.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmJournal_Bill_ListAll" method="POST">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Journal Vouchers for SLS</strong>
          </div>
        </td>
      </tr>
    </table>
       ...
       <tr align="left" class="tdH"> <th>Search By Month or Date</th></tr>
        <tr align="left">
          ...
          <option value="12">December</option>
           ...
           <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth"  tabindex="5" onclick="doFunction('SLSsearchByMonth','null')"/>
           </div>
          </td>
        </tr>
        <tr align="left">
              ...
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         ...
                         alt="Show Calendar"></img>
            <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth" tabindex="8" onclick="doFunction('SLSsearchByDate','null')"/>
            </div>
          </td>          
        </tr>
     </table>
