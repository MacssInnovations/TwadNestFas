...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Defunt General Journal System</title>
    ...
    <script type="text/javascript" src="../scripts/Journal_General_Edit_dft.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Edit Defunct General Journal System </font>
          </div>
        </td>
      </tr>
    </table>
