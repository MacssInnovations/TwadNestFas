...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Rectification Journal(Supplement) System</title>
    ...
    <script type="text/javascript" src="../scripts/Rectificational_Journal_Edit_Supp.js"></script>
    ...
    <script type="text/javascript" language="javascript">
       ...
       // document.frmJournal_General_Edit.txtCrea_date.value=day+"/"+month+"/"+year;
                document.frmJournal_General_Edit.txtCrea_date.value="31"+"/"+"03"+"/"+year;
...
%>
  <body onload="loadDate();foc();Check_Supplement_No();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Edit Rectification(Supplement) Journal System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmJournal_General_Edit" id="frmJournal_General_Edit" method="POST"   action="../../../../../Rectificational_Journal_Edit_Supp?Command=Add"
                  ...
                  <div align="left">
                    <input type="text" name="txtAcc_HeadCode" 
                           ...
                           onkeypress="return numbersonly(event)"
                            ...
                            onblur="doFunctionBLOCK('checkCode','null');"  size="9"/>
                    <img src="../../../../../images/c-lovi.gif" width="20" 
