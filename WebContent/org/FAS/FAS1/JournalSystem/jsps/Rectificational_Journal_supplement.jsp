...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Supplement Journal System For RJV</title>
    ...
    <script type="text/javascript" src="../scripts/Rectificational_Journal_supplement_js.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmJournal_General.txtCrea_date.value="31"+"/"+"03"+"/"+year;
...
%>
  <body onload="call_clr();loadDate();foc();Check_Supplement_No();checkSuppTB();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create Rectification Journal System(Supplement) </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="frmJournal_General" id="frmJournal_General" method="POST"
                  action="../../../../../Rectificational_Journal_supplement?Command=Add"
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <select name="supNo" id="supNo" onchange="checkLiveSub();">
                      <!--    <option value="">Select Supplement No</option>  changed on 04_jul_17-->
                       </select>
                  </div>
                </td>
              </tr>
               ...
               <%
                     try
                     {
                         //   ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and (JOURNAL_TYPE_CODE=75 or JOURNAL_TYPE_CODE=87 or JOURNAL_TYPE_CODE=90)  order by JOURNAL_TYPE_DESC");
                            ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC from FAS_MST_JOURNAL_TYPE where CATEGORY='G' and JOURNAL_TYPE_CODE in(75,82,87,91)  order by JOURNAL_TYPE_DESC");
                            rs=ps.executeQuery();
                            while(rs.next())
                            {
