...
function clear1()
{
    ...
    document.getElementById("txtOper_accode").value="";
...
function callServer(id,command)
{
    if(command=="Office")
    {
        ...
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=BankName&cmbOffice_code="+office;
    ...
    if(command=="Branch")
    {
        ...
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=Branch&BranchId="+Bank;
        var req=getTransport();
        req.open("POST",url,true); 
        req.onreadystatechange=function()
        {
    ...
    if(command=="AccType")
    {
        ...
        var Bank=document.getElementById("cmbbank_name").value;
        var office=document.getElementById("cmbAcc_UnitCode").value;
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=AccType&BankId="+Bank+"&BranchId="+Branch+"&cmbOffice_code="+office;
        var req=getTransport();
        req.open("POST",url,true); 
        req.onreadystatechange=function()
        {
    ...
    if(command=="AccHead")
    {
        ...
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=AccHead&BankId="+Bank+"&BranchId="+Branch+"&cmbOffice_code="+office+"&AcType="+actype;
        //alert(url);
        var req=getTransport();
        req.open("POST",url,true); 
        req.onreadystatechange=function()
    ...
    if(command=="BankAcNo")
    {
        ...
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=BankAcNo&BankId="+Bank+"&BranchId="+Branch+"&cmbOffice_code="+office+"&CollAcCode="+Collacc;
        var req=getTransport();
        req.open("POST",url,true); 
        req.onreadystatechange=function()
        {
    ...
    if(command=="OpeningBal")
    {
        ...
        var office=document.getElementById("cmbAcc_UnitCode").value;
        var actype=document.getElementById("cmbaccount_type").value;
        var txtOper_accode1=document.getElementById("txtOper_accode1").value;
        var cmbbank_accno=document.getElementById("cmbbank_accno").value;
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=OpeningBal&BankId="+Bank+"&BranchId="+Branch+"&cmbOffice_code="+office+"&AcType="+actype+"&CollAcCode="+txtOper_accode1+"&BankAcNo="+cmbbank_accno;
        var req=getTransport();
        req.open("POST",url,true); 
        req.onreadystatechange=function()
        {
    ...
    if(command=="Collection")
    {
        ...
        var AccHead=document.getElementById("txtOper_accode1").value;
        var Adate=document.getElementById("txtverify_date").value;
        var OpeningBal=document.getElementById("txtOpening_Bal1").value;
        var url="../../../../../BankBalanceMontoringOperServlet.con?Command=Collection&BankId="+Bank+"&BranchId="+Branch+"&cmbOffice_code="+office+"&CollAcCode="+txtOper_accode1+"&BankAcNo="+cmbbank_accno+"&AccUnit="+unit+"&txtCB_Year="+Year+"&txtCB_Month="+Month+"&AccHead="+AccHead+"&txtverify_date="+Adate+"&OpeningBal="+OpeningBal;
            ...
            var command=baseResponse.getElementsByTagName("command")[0].firstChild.nodeValue;
                    ...
                    if(command=="AccType")
                    {
                        ...
                        else
                        {
                            ...
                            document.frmBankBalance.txtOper_accode.value="";
                            document.frmBankBalance.txtOper_accode.value="";
                        }
                    ...
                    if(command=="AccHead")
                    {
                        if(flag=="success")
                        {
                             ...
                             document.frmBankBalance.txtOper_accode.value="";
                             document.frmBankBalance.txtOper_accode1.value="";
                             document.frmBankBalance.txtOper_accode.value=Acchead;
                             document.frmBankBalance.txtOper_accode1.value=Acchead;
