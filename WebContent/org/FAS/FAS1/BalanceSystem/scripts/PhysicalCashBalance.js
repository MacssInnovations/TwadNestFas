...
function computedcash()
{
    ...
    var url="../../../../../PhysicalCashBalance.con?Command=Computed&Unit="+unit+"&Office="+office+"&Year="+year+"&Month="+month+"&txtverify_date="+verifydate;
...
function handleResponse(req)
{
    if(req.readyState==4)
    {
        ...
        { 
            ...
            {
                document.frmPhysicalCashBalance.txtcomputed_verifi.value="";
                var value=baseResponse.getElementsByTagName("Amount")[0].firstChild.nodeValue;
