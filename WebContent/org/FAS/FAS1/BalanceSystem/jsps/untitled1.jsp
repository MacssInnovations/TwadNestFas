...
<html>
  <head>
    ...
    <title>Bank Balance Montoring System</title>
  ...
  <form name="frmBankBalance" method="POST" action="" >
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Bank Balance Montoring System</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             <tr class="table">
                ...
                try
                {
                        ps=con.prepareStatement("select ACCOUNTING_UNIT_ID, ACCOUNTING_FOR_OFFICE_ID  from FAS_MST_ACCT_UNIT_OFFICES where ACCOUNTING_FOR_OFFICE_ID=? order by ACCOUNTING_FOR_OFFICE_ID desc ");
                        ps.setInt(1,oid);
                        rs=ps.executeQuery();
                        if(rs.next())
                        {
                ...
                %>
                      ...
                      <input type="hidden" name="txtaccount_office" id="txtaccount_office" value=<%=accountoffice%> >
                  </div>
                </td>
              </tr>
              <!--<tr class="table">
