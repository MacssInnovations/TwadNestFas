...
<html>
  <head>
    ...
    <title>Bank Balance Montoring System Operational A/C</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript"
             src="../../../../Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/BankBalanceMontoringOper.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Bank Balance Montoring System Operational A/C</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
        ...
        <tr>
            ...
            <td align="left">
            <input type="text" name="txtOper_accode" id="txtOper_accode" size="15" disabled>
            <input type="hidden" name="txtOper_accode1" id="txtOper_accode1" size="15">
