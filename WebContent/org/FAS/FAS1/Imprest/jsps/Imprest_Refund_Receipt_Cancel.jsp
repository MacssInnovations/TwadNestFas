...
<html>
  <head>
    ...
    <title>Imprest/Temporary Advance Receipt System</title>
    ...
    <script type="text/javascript" src="../scripts/Imprest_Refund_Receipt_Cancel.js"></script>
...
%>
  <body onload="clrForm('load');foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
                                                                    cellpadding="3"
                                                                    width="100%">
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation Of Imprest/Temporary Advance Receipt </font>
          </div>
        </td>
      </tr>
    </table><form name="frm_Imp_Refund_Receipt" id="Bank_Receipt_Edit_Form"
                  method="POST"
                  action="../../../../../Imprest_Refund_Receipt_Cancel.kv?Command=Cancel"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
              ...
              <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <select name="cmbAdvance_type" id="cmbAdvance_type" tabindex="4" onchange="doFunction('load_Receipt_No','null');">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="txtReceipt_No" id="txtReceipt_No"
                            tabindex="5"
                            onchange="doFunction('load_Receipt_Details','null');">
              ...
              <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtBankAccountNo"  onkeypress="return numbersonly(event)" style="background-color: #ececec" readonly="readonly"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtRef_no" id="txtRef_no" style="background-color: #ececec" readonly="readonly"
                           tabindex="6" maxlength="50" size="55"/>
                     
                    <input type="text" name="txtRef_date" id="txtRef_date" style="background-color: #ececec" readonly="readonly"
                ...
                <td width="60%">
                          ...
                          <div align="left">
                            <input type="text" name="cmbMas_SL_Code" tabindex="9"  style="background-color: #ececec"  readonly="readonly"  
                                ...
                                <input type="hidden" name="sl_code_hid" id="sl_code_hid">
                          </div>
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="50" style="background-color: #ececec" readonly="readonly"
                              tabindex="8" rows="4"></textarea>
                  </div>
                </td>
              </tr>
              <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtAmount" style="background-color: #ececec" readonly="readonly"
                           onkeypress="return limit_amt(this,event);"
                           tabindex="10" id="txtAmount" maxlength="17"
                           size="18"/>
                  </div>
                </td>
              </tr>
