      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW_M where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME  ,RECEIVED_FROM , AMOUNT,CHEQUE_DD_NO ,to_char(CHEQUE_DD_DATE,'DD/MM/YYYY') as CHE_DD_DATE,BANK_NAME "+
            ...
            while(rs2.next())
            {
               System.out.println("while");
                ...
                out.println("<td align='center'>"+rs2.getString("CR_DR_INDICATOR")+"</td>");
                  ...
                  if(rs2.getString("BANK_NAME")!=null)
                  {
