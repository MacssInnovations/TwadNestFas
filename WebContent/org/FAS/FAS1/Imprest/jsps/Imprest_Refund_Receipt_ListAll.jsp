...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Imprest_Refund_Receipt_ListAll.js"></script>
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Imprest/Temporary Advance Receipt </strong>
          </div>
        </td>
      </tr>
    </table>
