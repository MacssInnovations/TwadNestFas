...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Imprest_Account_ListAll.js"></script>
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Imprest/Temporary Advance Payment for Final Heads</strong>
          </div>
        </td>
      </tr>
    </table>
         ...
         <tr class="table">
              ...
              <tr class="table">
                  ...
                  <div align="left">
                    <select size="1" name="cmbStatus" id="cmbStatus" tabindex="3">
                      ...
                      <option value="C">Cancelled</option> 
                  	  <option value="Y">Cheque Dishonour</option>
                    </select>
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select name="cmbPayment_type" id="cmbPayment_type" tabindex="4">
         ...
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
           ...
           <th>
            ...
            <th>
            	<div  id="a_clmn" style="display:none">Print Payment ?</div>
            	<div  id="cc_clmn" style="display:block">GJV No.</div>
            </th>            
            <th>
            	<div id="cc_clmn1" style="display:block">GJV Date.
            	</div>
            </th>
          </tr>
