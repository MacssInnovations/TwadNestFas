...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Voucher_list_SL= window.open("../../../../../org/FAS/FAS1/Imprest/jsps/Imprest_Account_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"ReceiptDateSearch","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Voucher_list_SL.moveTo(250,250);  
    Voucher_list_SL.focus();
...
{   
        ...
        var cmbPayment_type1=document.getElementById("cmbPayment_type").value;
        ...
        {  
	            ...
	            if(cmbPayment_type1=="I1")
	            {
	            	cmbPayment_type='I';
	            	txtCreat_By_Module='BPF';
	            }
	            else if(cmbPayment_type1=="I2")
	            {
	            	cmbPayment_type='I';
	            	txtCreat_By_Module='SC';
	            }
	            else if(cmbPayment_type1=="T1")
	            {
	            	cmbPayment_type='T';
	            	txtCreat_By_Module='BPF';
	            }
	            else if(cmbPayment_type1=="T2")
	            {
	            	cmbPayment_type='T';
	            	txtCreat_By_Module='SC';
	            }
	            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
	            {
		                ...
		                var url="../../../../../Imprest_Account_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
		                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbPayment_type;
		              //  alert(url);
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
	            ...
	            else if(cmbPayment_type1=="T2")
	            {
	             ...
	             //   var txtCreat_By_Module='BPF';
	                var url="../../../../../Imprest_Account_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
	                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
	                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&txtCreat_By_Module="+txtCreat_By_Module+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbPayment_type;
	                //alert(url);
	                var req=getTransport();
	                req.open("GET",url,true); 
	                req.onreadystatechange=function()
