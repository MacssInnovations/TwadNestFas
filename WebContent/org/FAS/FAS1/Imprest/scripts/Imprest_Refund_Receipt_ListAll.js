...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Receipt_list_SL= window.open("../../../../../org/FAS/FAS1/Imprest/jsps/Imprest_Refund_Receipt_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"ReceiptDateSearch","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();    
}
...
/** Printing */
function printing(unitcode,offid,yr,mon,recNo,recdate, created_by_mod)
{
    ...
    var txtReceipt_type=created_by_mod;
    
   // alert(created_by_mod);
...
{   
        ...
        if(document.getElementById("cmbStatus").value!='Y')
 	    {
             	   document.getElementById("a_clmn").style.display="block";
             	   document.getElementById("a_clmn2").style.display="block";
             	   document.getElementById("cc_clmn").style.display="none";
             	   document.getElementById("cc_clmn1").style.display="none";
             	   document.getElementById("cc_clmn2").style.display="none";
 	    }
        else
        {        	
             	   document.getElementById("a_clmn").style.display="none";
             	   document.getElementById("a_clmn2").style.display="none";
             	   document.getElementById("cc_clmn").style.display="block";
             	   document.getElementById("cc_clmn1").style.display="block";
             	   document.getElementById("cc_clmn2").style.display="block";
        }
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../Imprest_Refund_Receipt_List.kv?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtReceipt_type="+txtReceipt_type+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbAdvance_type; 
                //alert(url);
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtReceipt_type='BR';
                var url="../../../../../Imprest_Refund_Receipt_List.kv?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&txtReceipt_type="+txtReceipt_type+"&cmbStatus="+cmbStatus+"&txtMode_of_creat="+cmbAdvance_type; 
                //alert(url);
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
              ...
              //alert('test');  
                  ...
                  var tbody=document.getElementById("tbody");
                    ...
                    if(service)
                    {
                               ...
                               if(document.getElementById("cmbStatus").value=="Y")
                               {
                            	   cheque_amt=baseResponse.getElementsByTagName("cheque_amt")[0].firstChild.nodeValue;
                            	   GJV_No=baseResponse.getElementsByTagName("GJV_No")[0].firstChild.nodeValue;
                            	   GJV_Date=baseResponse.getElementsByTagName("GJV_Date")[0].firstChild.nodeValue;
                               }
             ...
             if(service)
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                     c++;
                        ...
                        //items[4]=service[i].getElementsByTagName("created_by_mod")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("curr_month")[0].firstChild.nodeValue;
                      ...
                      if(document.getElementById("cmbStatus").value=='L' || document.getElementById("cmbStatus").value=='C')
                      {
                      ...
                      {
                      		cheque_amt=service[i].getElementsByTagName("cheque_amt")[0].firstChild.nodeValue;
                      		var cell=document.createElement("TD");
                              cell.align='CENTER';
                              var txtedit=document.createTextNode(cheque_amt);
                      ...
                      /*  var cell=document.createElement("TD");
                       ...
                       // {
                            ...
                            if(document.getElementById("cmbStatus").value=='L')
                            {
                                ...
                                cell.align='CENTER';
                                var anc=document.createElement("A");
                                var url="javascript:printing('"+Ucode+"','"+Offid+"','"+txtCB_Year+"','"+txtCB_Month+"','"+items[0]+"','"+items[1]+"','"+items[4]+"')";
                                anc.href=url;
                                var txtedit=document.createTextNode("PRINT");
                                anc.appendChild(txtedit);
                                cell.appendChild(anc);
                            ...
                            else if(document.getElementById("cmbStatus").value=='C')
                            {
                                ...
                                cell.appendChild(txtedit);
                                mycurrent_row.appendChild(cell);
                            }else if(document.getElementById("cmbStatus").value!='Y')
                        	{				                        	
	                            var cell=document.createElement("TD");
	                            cell.align='CENTER';
	                            var txtedit=document.createTextNode("--");
