...
<script src="../scripts/MemoPayment_List_All.js"
...
function loadyear_month()
{
       ...
       document.frmmemo_list_All.txtCB_Year.value=year;
       document.frmmemo_list_All.txtCB_Month.value=month1;
}
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Memo Payment Details List</font></div>
		</td>
	</tr>
</table>
<form name="frmmemo_list_All" id="frmmemo_list_All" method="POST" >
