...
<script src="../scripts/Memo_Of_Pay_Edit.js" type="text/javascript"> </script>
...
<table cellspacing="1" cellpadding="2" border="1" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><input type="radio" name="sancidwith" id="sancidwith" value="Y" checked="checked" onclick="clearone(),blockSanNo();"><label>With Sanction Proceeding</label><input
			type="radio" name="sancidwith" id="sancidwith" value="N" onclick="clearone(),blockSanNo();">
	...
	<tr class="table">
		...
		<div align="left"><select size="1" name="cboCashBook_Month"
			id="cboCashBook_Month" onChange="forBillNo('<%=s%>');">
	...
	<tr class="table">
		...
		<td>
		<div align="left">
		 <div id="head_div1" name="head_div1" ><input type="text" readonly="readonly" class="light" name="txtSanctionProceedingNo" id="txtSanctionProceedingNo" maxlength="18" size="11"></div></div>
