...
{   
        ...
        if(document.frmmemo_list.optionId[0].checked==true)
	    {
        	optionId=document.frmmemo_list.optionId[0].value;
	    }else{
	    	optionId=document.frmmemo_list.optionId[1].value;
	    }
        if(txtCB_Year=="")
        {
        ...
        else
        {
                ...
                var url="../../../../../MemoPayment_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
		                   ...
		                   var items=new Array();
                             ...
                             items[3]=service[i].getElementsByTagName("sanction_proceeding_date")[0].firstChild.nodeValue;
                             items[4]=service[i].getElementsByTagName("sanctioned_amount")[0].firstChild.nodeValue;
                             items[5]=service[i].getElementsByTagName("sub_ledger_type_code")[0].firstChild.nodeValue;
                             items[6]=service[i].getElementsByTagName("paydesc")[0].firstChild.nodeValue;
                             items[7]=service[i].getElementsByTagName("amount")[0].firstChild.nodeValue;
