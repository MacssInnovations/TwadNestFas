...
<html>
  <head>
    ...
    <title>A52 Register Qty Push to Numerical </title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>  <!-- to avoid future date the above script used-->
    ...
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/Masters/scripts/A52_Qty_Push_to_Num.js"></script>
  ...
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS'),callServer('loadMajor'),setTimeout('common_LoadOfficeCode()',200);">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A52 Register Qty Push to Numerical </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmA52_Qty_Push" id="frmA52_Qty_Push" method="POST" action="../../../../../A52_Qty_Push_to_Num?command=updateTotally" onsubmit="return checkNull_verify()">
