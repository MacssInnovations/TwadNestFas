...
<html>
  <head>
    ...
    <title>A52 Register Qty Push to Numerical View(Circle)</title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>  
    ...
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/Masters/scripts/A52_Qty_Push_to_Num_Cricle.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A52 Register Qty Push to Numerical View(Circle)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmA52_Qty_Push_Cricle" id="frmA52_Qty_Push_Cricle" method="POST" action="../../../../../A52_Qty_Push_to_Num_Cricle?command=updateTotally" onsubmit="return checkNull_verify()">
