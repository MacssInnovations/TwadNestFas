...
<html>
  <head>
    ...
    <title>Bank Branch Details List</title>
   ...
   <script type="text/javascript" language="javascript">
    ...
    function EditHead(rowID)
    {
                ...
                var district="",branch_id="",bankid="",bank_acc_type="",operID="",status="";
                   r=document.getElementById(rowID);
                 rcells=r.cells;
     // alert(rcells.item(1).firstChild.nodeValue);
                bank=rcells.item(2).firstChild.nodeValue;
                bankid=rcells.item(13).firstChild.nodeValue;
                branch_id=rcells.item(3).firstChild.nodeValue;
                officename=rcells.item(4).firstChild.nodeValue;
                address1=rcells.item(5).firstChild.nodeValue;
                address2=rcells.item(6).firstChild.nodeValue;
                city=rcells.item(7).firstChild.nodeValue;
                district=rcells.item(8).firstChild.nodeValue;
                mic=rcells.item(10).firstChild.nodeValue;
                phoneno=rcells.item(11).firstChild.nodeValue;
                faxno=rcells.item(12).firstChild.nodeValue;
                remark=rcells.item(13).firstChild.nodeValue
                status=rcells.item(14).firstChild.nodeValue
          
        Minimize();
    
      
        opener.doParentBankAccNumbers(bank,bankid,branch_id,officename,address1,address2,city,district,mic,phoneno,faxno,remark,status);
       ...
       <tbody id="tb" class="table" align="left">
          <%
           ...
           int cmbDistrict=0;
                ...
                String sql_que="select a.BANK_ID,a.DISTRICT_CODE,a.BRANCH_ID,a.BRANCH_NAME,a.BRANCH_ADDRESS1,a.BRANCH_ADDRESS2,a.CITY_TOWN_NAME,a.MICR_CODE,a.PHONE,a.FAX,a.REMARKS,"
                              +" b.district_name,c.BANK_NAME,a.STATUS from FAS_MST_BANK_BRANCHES a ,COM_MST_DISTRICTS b, FAS_MST_BANKS C"
                              +" WHERE  a.BANK_ID=? AND a.Bank_id=c.Bank_id and a.district_code=b.district_code";
