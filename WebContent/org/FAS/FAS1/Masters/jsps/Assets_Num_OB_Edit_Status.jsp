...
<html>
  <head>
    ...
    <title>Assets Numerical OB Edit Status</title>
   ...
   <script type="text/javascript"
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Assets_Num_OB_Edit_Status.js"></script>
  ...
  <body class="table" onload="LoadAccountingUnitID('FOR_LIST_1');">
  <form name="frmAssets_Numerical_AC_OB_Edit_Status" id="frmAssets_Numerical_AC_OB_Edit_Status" method="get" action="">
      
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Assets Numerical OB Edit Status</strong>
            </div>
          </td>
        </tr>
      </table>                                                 
   ...
   %>
	  ...
	  <td><div align="left">
          <select name="cmbAcc_UnitCode"
			id="cmbAcc_UnitCode"  class="combolist" onchange="common_LoadOffice(this.value);">
	...
	<tr class="table1">
	  ...
	  <td><div align="left">
          ...
          <tr align="left">
            <td class="table">
              <div align="left">Status Option </div>
            </td>
            <td>
              <div align="left">
           <input type="checkbox" id="AssetsNumEditStatus" name="AssetsNumEditStatus" value="AssetsNumEditStatus" onclick="checkStatus();">Number OB Edit Status
           <input type="checkbox" id="AssetsNumEditStatusNil" name="AssetsNumEditStatusNil" value="AssetsNumEditStatusNil" onclick="checkStatus();">Number OB Edit Nil Status
	   </div>
            </td>
          </tr>
        </table>
      ...
      <table align="center" cellspacing="3" cellpadding="2" border="1"
        ...
        <tr class="tdH">
          <td>
            <div align="center">
              <input type="button" name="btverify" value="Freeze Num Correction" id="btverify" onclick="callServer('AddOBEdit','null');"/>               
