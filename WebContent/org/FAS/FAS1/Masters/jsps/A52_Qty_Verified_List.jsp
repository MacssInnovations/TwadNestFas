...
<script type="text/javascript" language="javascript">
       ...
       { 
            document.frmA52Verified_List.submit();   
      }
       function exit()
       {
       self.close();
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">A52 Qty Verified List</font></div>
		</td>
	</tr>
</table>

<form name="frmA52Verified_List" id="frmA52Verified_List"
	method="POST" action="../../../../../A52_Verified_List?command=A52QtyVerified">
<div align="center">
