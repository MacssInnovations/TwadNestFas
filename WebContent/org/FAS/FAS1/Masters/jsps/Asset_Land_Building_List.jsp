  ...
  <form name="frmassetnumOB" id="frmassetnumOB">
      ...
      <th>Select </th>
         ...
         String sql_que="select * from " +
                        "(select ASSET_CODE_OF_LAND,ASSET_CODE_OF_BUILDING  from FAS_ASSETS_LANDS_AND_BUILDINGS where ACCOUNTING_UNIT_ID=?" +
                        ...
                        " ) b  " +
                        " on  a.ASSET_CODE_OF_LAND=b.ASSET_CODE " +
                        " left outer join" +
                        ...
                        " ) c " +
                       " on  a.ASSET_CODE_OF_BUILDING=c.ASSET_CODE ";
          ...
          // amcperiod=rs.
            ...
            while(rs.next())
            {
                ...
                out.println("<td style='display:none' >"+rs.getInt("ASSET_CODE_OF_LAND")+"</td>");
                out.println("<td>"+rs.getString("assetrigsdesc")+"</td>");
                System.out.println(rs.getString("assetrigsdesc"));
                out.println("<td style='display:none' >"+rs.getInt("ASSET_CODE_OF_BUILDING")+"</td>");
