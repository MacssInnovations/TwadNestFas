  ...
  <form action="" name="frmAList">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="table">
          <td>
            <div align="center">
              List of Buildings (<%=request.getParameter("financial_year")%>)
            </div>
          </td>
        </tr>
			...
			try
                {
	                  ...
	                  while(results.next())
	                  {
	                      ...
	                      out.println("<tr id=" + cnt + ">");
		                      ...
		                      out.println("<td align='center'>"+results.getString("building_name")+"</td>"); 
		                      out.println("<td align='center'><a href='javascript:FloorEdit("+cnt+")'>"+results.getString("no_of_floors")+"</a></td>");
		                      out.println("<td align='center'>"+results.getString("type_of_foundation")+"</td>");
		                      out.println("<td align='center'>"+results.getString("total_civil_cost")+"</td>");
		                      out.println("<td align='center'>"+results.getInt("total_book_value")+"</td>");
		                      out.println("<td align='center'>"+results.getString("account_head_code")+"</td>");
// asset_code building_name no_of_floors type_of_foundation total_civil_cost total_book_value account_head_code
	                      out.println("</tr>");
	                  }
	                  if(cnt==0)
	                  {
