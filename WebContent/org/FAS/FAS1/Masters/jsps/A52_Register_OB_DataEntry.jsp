...
<html>
  <head>
    ...
    <title>A52 Register for Closing Balance Report</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>
	<script type="text/javascript" src="../scripts/A52_Register_OB_DataEntry.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmA52_Register_OBEntry" id="frmA52_Register_OBEntry" action="../../../../../A52Register_OBEntry" method=post onsubmit="return checkNull()">
