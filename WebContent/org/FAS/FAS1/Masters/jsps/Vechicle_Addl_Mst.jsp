...
<html>
  <head>
    ...
    <title>Vehicle Additional Details</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/Vehicle_Addl_Mst.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Additional Details of Vehicle </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmvehicle_AddlDetails" id="frmvehicle_AddlDetails" >
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
         ...
         FAS_SU="NO";
                  ...
                  <div align="left">
                    <input type="text" name="txt_date" id="txt_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmvehicle_AddlDetails.txt_date,1);"
           ...
           <tr align="left">
              ...
              <TR class="table">
                                      <TD >
                                          Registration Details<font color="#ff2121">*</font>
                                </TD>
                                      <TD>
              ...
              <TR class="table">
                                      <TD>
                                        Registration Office Address  <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                      <textarea name="txtOffice_Address1" id="txtOffice_Address1" cols="50" tabindex="13" onkeypress="return check_leng(this.value);"
                              rows="4"></textarea>
                              </TD>
                                  </TR>
              <tr class="table">
                                    <td>Registration Number  <font color="#ff2121">*</font> </td>
                                    <td><input type=text name="txtreg_no" id="txtreg_no" size=15 maxlength="20" tabindex="9" >
                                    
                                  </tr>
             
                                   <tr class="table">
                <td>
                  <div align="left"> Registration Date  <font color="#ff2121">*</font>
                   
                   </div>
                </td>
                <td>
                  <div align="left">
                    <input type="text" name="txt_regstdate" id="txt_regstdate"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmvehicle_AddlDetails.txt_regstdate,1);"
                         alt="Show Calendar"></img>                     
                  </div>
                </td>
              </tr>     
                                  ...
                                  <TR class="table">
                                      <TD>
                                         Year of Manufacture  <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                          <input type="text" name="txtman" id="txtman" tabindex="12"  >
                                  ...
                                  <TR class="table">
                                      ...
                                      <TD>
                                          <input type="text" name="txtcubic" id="txtcubic" tabindex="12"  >
                                  ...
                                  <TR class="table">
                                      ...
                                      <TD>
                                          <input type="text" name="txttank" id="txttank" tabindex="12" >
                                          
                                      </TD>
                                  </TR>
                                  <TR class="table">
                                      <TD>
                                         Road Tax Reference <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                          <input type="text" name="txtroad" id="txtroad" tabindex="12" >
