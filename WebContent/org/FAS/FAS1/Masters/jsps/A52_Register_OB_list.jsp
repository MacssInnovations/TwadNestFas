...
<html>
  <head>
    ...
    <title>A52 Register List for Closing Balance  - Edit </title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>  <!-- to avoid future date the above script used-->
    ...
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/Masters/scripts/A52_Register_OB_list.js"></script>
  ...
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS'),callServer('loadMajor'),setTimeout('common_LoadOfficeRedeploye()',600);">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A52 Register for Closing Balance List </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmA52_Registerlist" id="frmA52_Registerlist" method="POST" action="../../../../../A52_Register_OB_list?command=updateTotally" onsubmit="return checkNull_verify()">
   ...
   %>
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="common_LoadOfficeRedeploye();" onblur="common_LoadOfficeRedeploye();">
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
         ...
         FAS_SU="NO";
              ...
              <td colspan="2">
               <div align="left">
                    <select name="cmbOffice_code" id="cmbOffice_code" >
       ...
       <tr class="tdH">
		...
		<th>Office Name</th>
		<th>Particulars</th>
		<th>OB Org Quantity</th>
		<th>OB Crt Qty</th>
		<th>Receipts Org Quantity</th>
		<th>Receipts Crt Qty</th>
		<th>Issues Org Quantity</th>
		<th>Issues Crt Qty</th>
            ...
            <table align="center" cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  <td>
                    <div align="center">
                             <input type="submit" id="updateTotally" name="updateTotally" value="Update" ></input><!--onclick="UpdateTotallyValues();"
                            --><input type="button" name="CmdExit" value="EXIT" onclick="closeWindow()">
                    </div>
                  </td>
                </tr>
