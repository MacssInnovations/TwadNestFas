...
<html>
  <head>
    ...
    <title>UnFreeze A52 Register Value(Circle Level)</title>
  ...
  <form name="frmVerify_A52_AA52_Register" id="frmVerify_A52_AA52_Register" method="post" >
...
%>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong> UnFreeze A52 Register Value</strong>
            </div>
          </td>
        </tr>
      </table>
        ...
        <tr class="tdH">
          <td>
            <div align="center">
              ...
              <input type="button" id="btverifyA52AA52" name="btverifyA52AA52"  value="UnFreeze A52 Value" onclick="doFunction('UnFreezeA52Value','null');"/>               
