...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Apportionment_GrantCategory_Master.js"></script>
  ...
  <form action="" name="frmApportGrantCatMaster">
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="3" class="tdH" align="center"><b>Apportionment Of Grant Category Master</b></td>
                   
       </tr> 
        <tr>
            <td class="table">Apportion of Grant Category Code</td>
          <td class="table">
            <input type="text" name="txtApportGrantCatCode" maxlength="2"
                   id="txtApportGrantCatCode" readonly size="3"/>System Generated
           </td>
           
        </tr>
        <tr>
            <td class="table">Apportion of Grant Category  Description</td>
            <td class="table">
	            <input type="text" name="txtApportGrantCatDesc" id="txtApportGrantCatDesc" onchange="callServer('Load','null')"/>
            </td>
        </tr>
    ...
    <table cellspacing="3" cellpadding="2" border="1" width="100%"
      ...
      <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="100%"
        ...
        <tr class="tdH">
          ...
          <th>
          	Apportion of Grant Category Code
          </th>
          <th>
          	Apportion of Grant Category  Description
          </th>
          <th>
          	Status
          </th>
