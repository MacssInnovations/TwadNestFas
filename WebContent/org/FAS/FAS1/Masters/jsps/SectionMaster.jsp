...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/SectionMaster.js"></script>
  ...
  <form action="" name="frmSectionMaster" id="frmSectionMaster">
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="2" class="tdH" align="center"><b>Section Master</b></td>
                   
       </tr> 
        <tr>
            <td class="table">Section Code</td>
          <td class="table">
            <input type="text" name="txtsectionId" maxlength="2"
        ...
        <tr>
            ...
            <td class="table">
            <input type="text" name="txtSectionName" size="100" maxlength="50"
                   id="txtSectionName"/>
        </tr>
