...
<html>
  <head>
    ...
    <title>Amc Details of Assets</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/Asset_AMC_Details.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">AMC Details of Assets </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmAMC_Details" id="frmAMC_Details" >
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
         ...
         FAS_SU="NO";
                  ...
                  <div align="left">
                    <input type="text" name="txt_date" id="txt_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmAMC_Details.txt_date,1);"
           ...
           <tr class="table">
              ...
              <TR class="table">
                                      <TD >
                                          AMC Company Name<font color="#ff2121">*</font>
                                </TD>
                                      <TD>
              ...
              <TR class="table">
                                      <TD>
                                        AMC_Period_from  <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                      <div align="left">
                    <input type="text" name="Amcfromdate" id="Amcfromdate"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmAMC_Details.Amcfromdate,1);"
                         alt="Show Calendar"></img>                     
                  </div>
                              </TD>
                                  </TR>
              <tr class="table">
                                    <td>AMC_Period_To  <font color="#ff2121">*</font> </td>
                                    <td><div align="left">
                    <input type="text" name="Amctodate" id="Amctodate"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmAMC_Details.Amctodate,1);"
                         alt="Show Calendar"></img>                     
                  </div>
                                   ...
                                   <tr class="table">
                <td>
                  <div align="left"> AMC Amount  <font color="#ff2121">*</font>
                   
                   </div>
                </td>
                <td>
                   <input type="text" name="txtamc_amount" id="txtamc_amount"  >
                </td>
              </tr>     
                                  <TR class="table">
                                      <TD>
                                         Agreement Number  <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                          <input type="text" name="txtagr_no" id="txtagr_no" >
                                          
                                      </TD>
                                  </TR>
                                  <TR class="table">
                                      <TD>
                                         Agreement Date  <font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                          <div align="left">
                    <input type="text" name="Agrdate" id="Agrdate"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmAMC_Details.Agrdate,1);"
                         alt="Show Calendar"></img>                     
                  </div>
