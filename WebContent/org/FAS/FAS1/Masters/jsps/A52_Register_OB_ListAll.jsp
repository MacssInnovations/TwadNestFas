  ...
  <form action="" name="frmAList">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="table">
          <td>
            <div align="center">
              List of A52 Register for Opening Balance (<%=request.getParameter("financial_year")%>)
            </div>
          </td>
        </tr>
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
       ...
       <tr class="tdH">
      	...
      	<th>Select</th>
       	<th>Asset Code</th>
        <th>OB for quantity</th>
        <th>OB for value</th>
        <th>Reciepts during the yr(Qty)</th>
        <th>Reciepts during the year value</th>
        <th>Issues during the yr(Qty)</th>
        <th>Issues during the yr value</th>
        <th>Total during the yr(Qty)</th>
        <th>Total during the yr(value)</th>
        <th>Deprn allowed upto previous yr</th>
        <th>Deprn Recieved(A/C)</th>
        <th>Deprn allowed during yr</th>
        <th>Total deprn</th>
        <th>Deprn transfer thro(A/c)</th>
        <th>Deprn upto date</th>
        <th>Net Deprn cost </th> 
        <th>Appor allowed previous yr</th>
        <th>Appor through A/c</th>
        <th>Appor allowed during yr</th>
        <th>Total apporn of grant</th>
        <th>Apporn of grant(A/C)</th>
        <th>Apporn grant upto date</th>
        <th>Remarks</th>
