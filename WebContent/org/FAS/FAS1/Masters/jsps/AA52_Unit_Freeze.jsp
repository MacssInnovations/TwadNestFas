...
<html>
  <head>
    ...
    <title>Freeze AA52 Register(Unit Level)</title>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/AA52_Unit_Freeze.js"></script>
  ...
  <form name="frmFreeze_AA52Register" id="frmFreeze_AA52Register" ><!--
...
%>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Freeze AA52 Register(Unit Level)</strong>
            </div>
          </td>
        </tr>
      </table>
	...
	<tr class="table1">
	  ...
	  <td><div align="left">
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
           <input type="radio" id="aa52_option" name="aa52_option" value="AA52">AA52 Register
	    </div>
            </td>
          </tr>
        </table>
          ...
          <td>
            <div align="center"><!--
             <input type="submit" id="cmdview" name="cmdview" value="View Abstract" onclick="return nullcheck();"></input>
              --><input type="button" id="btverifyA52AA52" name="btverifyA52AA52"  value="Freeze AA52 " onclick="doFunction('FreezeAA52Unit','null');"/>               
