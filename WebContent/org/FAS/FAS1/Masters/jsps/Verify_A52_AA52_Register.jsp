...
<html>
  <head>
    ...
    <title>Freeze A52 Register Value(Circle Level)</title>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Verify_A52_AA52_Register.js"></script>
  ...
  <form name="frmVerify_A52_AA52_Register" id="frmVerify_A52_AA52_Register" method="post" action="../../../../../Verify_A52_AA52_Register?command=viewAbstract">
...
%>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong> Freeze A52 Register Value</strong>
            </div>
          </td>
        </tr>
      </table>
	...
	<tr class="table1">
	  ...
	  <td><div align="left">
          ...
          <tr align="left">
            ...
            <td>
              ...
              <!--
                <input type="text" name="txtFN_Year" id="txtFN_Year"
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
           <input type="radio" id="a52_aa52_option" name="a52_aa52_option" value="A52">A52 Register
	   </div>
            </td>
          </tr>
        </table>
      ...
      <table align="center" cellspacing="3" cellpadding="2" border="0"
        ...
        <tr class="tdH">
          <td>
            <div align="center">
             <input type="submit" id="cmdview" name="cmdview" value="View Abstract" onclick="return nullcheck();"></input>
              <input type="button" id="btverifyA52AA52" name="btverifyA52AA52"  value="Freeze A52 Value" onclick="doFunction('VerifyA52AA52','null');"/>               
