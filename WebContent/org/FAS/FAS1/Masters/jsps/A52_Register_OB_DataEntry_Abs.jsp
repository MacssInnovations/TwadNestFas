...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/A52_Register_OB_DataEntry_Abstract.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmA52_Register_OBEntry_Abstract" id="frmA52_Register_OBEntry_Abstract" action="../../../../../A52Register_OBEntry_Abstract" method=post onsubmit="return checkNull()">
