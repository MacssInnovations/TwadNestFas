...
<html>
  <head>
    ...
    <title>A52 Register Value Edit</title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>
    <script type="text/javascript" src="../scripts/A52_Value_Edit.js"></script>
	<script language="javascript" type="text/javascript">
                ...
                window.setTimeout(callServer('officeload'),200);
    </script>
    
  </head>
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS');callServer('loadMajor');">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A52 Register for Value Edit </font>
          </div>
        </td>
      </tr>
    </table><!--
    setTimeout('callServer('officeload')',1000) 
    --><form name="frmA52_RegisterValue" id="frmA52_RegisterValue" method="post" action="../../../../../A52_Value_Edit?command=updateTotally" onsubmit="return checkNull_verify()">
    <%
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onblur="callServer('officeload');">
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
       ...
       <tr class="tdH">
          ...
          <td colspan="3" class="table">
            <input type="button" name="CmdGo" value="Go" id="CmdGo" onclick="callServer('checkVerifyA52')"/>
          </td>
        </tr>
                </table>
                </div>
         ...
         <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="100%" align="center" >
           ...
           <th width="5%">OB Org Qty</th>     
           <th width="5%">OB Crt Qty</th>             
          <th width="5%">OB Org Value</th> 
            <th width="5%">OB Crt Value</th> 
			<th width="5%">Receipts Org Qty</th>
			<th width="5%">Receipts Crt Qty</th>
           <th width="5%">Receipts Org Value</th>
            <th width="5%">Receipts Crt Value</th>
			<th width="5%">Issues Org Qty</th>
			<th width="5%">Issues Crt Qty</th>
			<th width="5%">Issues Org Value</th>
			<th width="5%">Issues Crt Value</th>		
             </tr>
