...
<html>
  <head>
    ...
    <title>Freeze A52 Register (Circle Level)</title>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/A52_Register_Circle_Status_Freeze.js"></script>
  ...
  <form name="frmFreeze_A52_Register_Circle" id="frmFreeze_A52_Register_Circle">
...
%>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Freeze A52 Register (Circle Level)</strong>
            </div>
          </td>
        </tr>
      </table>
	...
	<tr class="table1">
	  ...
	  <td><div align="left">
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
           <input type="radio" id="a52_option" name="a52_option" value="A52" >A52 Register Circle
	   </div>
            </td>
          </tr>
        </table>
        ...
        <tr class="tdH">
          <td>
            <div align="center">
              ...
              <input type="button" id="btverifyA52" name="btverifyA52"  value="Freeze A52 Circle" onclick="doFunction('FreezeA52_Circle','null');"/>               
