...
<html>
  <head>
    ...
    <title>Update Issues Values </title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/Masters/scripts/UpdateFromIssue.js"></script>
  ...
  <body onload="foc();callServer('loadMajor');LoadAccountingUnitID_new('LIST_ALL_UNITS');">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Update Issues Values </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmupdateIssue" id="frmupdateIssue" method="post" action="../../../../../UpdateFromIssue?command=updateTotally" onsubmit="return checkNull_verify()">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="loadOffice_REC();">
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
              ...
              <tr class="table">
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        while(rs.next())
                        { */
                        ps2=con.prepareStatement(" SELECT DISTINCT ACCOUNTING_FOR_OFFICE_ID, " +
                        		"  OFFICE_NAME " +
                        		" FROM " +
       ...
       <tr class="tdH">
          ...
          <td colspan="3" class="table">
            <input type="button" name="CmdGo" value="Go" id="CmdGo" onclick="callServer('Go')"/></td>
        </tr>
                </table>
                </div>
              </td>
         ...
         <table id="Existing" cellspacing="2" cellpadding="3" border="1" width="100%" align="center" >
				<tr class="tdH"><!--
					...
					-->
					<th width="1%">S.No</th>
					<th width="4%">CashBook Year</th>
					<th width="4%">CashBook Month</th>
					<th width="2%">Asset Code</th>
					<th width="5%">Issue Date</th>
					<th width="2%">Issued To Level ID</th>
					<th width="5%">Issued To Office</th>
					<th width="3%">Issued Qty</th>
					<th width="3%">Issued Value</th>
            ...
            <table align="center" cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  <td>
                    <div align="center">
                             <input type="submit" id="updateTotally" name="updateTotally" value="Update To A52"></input>
