...
<script type="text/javascript" src="../scripts/Building_Details_Edit.js"></script>
...
<form action="../../../../../Building_Details_Edit?command=Add" name="frmBuildingDetails" method="post" >
<%
	Connection con = null;
...
<table cellspacing="1" cellpadding="2" border="1" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><input type="text" name="txtAsset"
			id="txtAsset" onkeypress="return numonly(event);" size="6" onchange="callServer('Load');"/></div>
		</td>
	</tr>
        ...
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
	            ...
	            <tr>
		            <td>
		            	<input type="button" name="CmdAddFloor" value="ADD" id="CmdAddFloor" onclick="addTempRow('funEditFloor','txtFloorNo','tblListFloor/txtFloorNo/txtFloorConsYear/txtFloorHeight/txtPlinthArea/txtFloorCivilCost/txtFloorElectricalCost/txtFloorExternalServCost/txtFloorAdditionCost/txtFloorBookValue/txtBPNo/txtFloorAcHeadCode/txtFloorRemarks'); hideRemarks('tblListFloor','txtFloorRemarks'); clearFloor();"/>
		            </td>
		            <td>
		            	<input type="button" name="CmdUpdateFloor" value="UPDATE" style="display:none" id="CmdUpdateFloor" onclick="updateTempRow(SELECTED_FLOOR,'tblListFloor/txtFloorNo/txtFloorConsYear/txtFloorHeight/txtPlinthArea/txtFloorCivilCost/txtFloorElectricalCost/txtFloorExternalServCost/txtFloorAdditionCost/txtFloorBookValue/txtBPNo/txtFloorAcHeadCode/txtFloorRemarks');   "/> <!-- hideRemarks('tblListFloor','txtFloorRemarks'); -->
		            </td>
		            <td>
        ...
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
	            ...
	            <tr>
		            <td>
		            	<input type="button" name="CmdAddOffice" value="ADD" id="CmdAddOffice" onclick="addTempRow('funEditOffice','txtOfficeFloorNo/cmbOffice','tblListOffice/txtOfficeFloorNo/cmbOffice/hidOfficeType/txtOfficeRemarks'); hideRemarks('tblListOffice','txtOfficeRemarks');  cmbCaptionGrid('tblListOffice/cmbOffice'); clearOffice();"/>
		            </td>
		            <!-- td>
		            	<input type="button" name="CmdUpdateOffice" value="UPDATE" style="display:none" id="CmdUpdateOffice" onclick="updateTempRow(SELECTED_OFFICE,'tblListOffice/txtOfficeFloorNo/cmbOffice/hidOfficeType/txtOfficeRemarks'); cmbCaptionGrid('tblListOffice/cmbOffice'); hideRemarks('tblListOffice','txtOfficeRemarks'); "/>
		            </td-->
		            <td>
    	...
    	<td colspan="2">
        	<div align="center">
	        	<table>
	            	<tr>
		            	<td>
		            		<input type="submit" name="CmdSubmit" value="SUBMIT" id="CmdSubmit" style="display:inline" onclick=""/>
		            	</td>
		            	<td>
		            		<input type="button" name="CmdSubmit" value="DELETE" id="CmdDelete" style="display:inline" onclick="callServer('Delete');"/>
		            	</td>
		            	<td>
