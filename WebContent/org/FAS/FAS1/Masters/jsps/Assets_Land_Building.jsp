...
<html>
  <head>
    ...
    <title>Mapping of Land and Associated Buildings</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/Asset_Land_Building.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">
              Mapping of Land and Associated Buildings
            </font>
          </div>
        </td>
      </tr>
    ...
    <form name="frmLand_Building" id="frmLand_Building" >
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <option value="">-- Select Asset code of Land--</option>
                      <%
                      int asset=0;
                    try
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <option value="">-- Select Asset Code of Building--</option>
                      <%
                     // int asset=0;
                    try
                    {ps=con.prepareStatement("select ASSET_CODE,PARTICULARS from FAS_ASSET_VAL_AC_DETAILS where ACCOUNTING_UNIT_ID=? and ACCOUNTING_UNIT_OFFICE_ID=? and ASSET_MAJOR_CLASS_CODE=? and financial_year=?");
