...
<html>
  <head>
    ...
    <title>Subledger Details</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/SubLedgerMaster.js"></script>
  ...
  <form action="" name="frmSubledgerMaster">
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
             align="center">
       <tr>
            <td colspan="2" class="tdH" align="center"><b>SubLedger Details</b></td>
                   
       </tr> 
        <tr>
            <td class="table">SubLedger Code</td>
          <td class="table">
            <input type="text" name="txtsubledgercode" maxlength="2"
                   id="txtsubledgercode" readonly size="3"/>System Generated
           </td>
        ...
        <tr>
            <td class="table">SubLedger Description</td>
            <td class="table">
            <input type="text" name="txtsubledgerdesc" size="30" maxlength="25"
                   id="txtsubledgerdesc"/>
        </tr>
