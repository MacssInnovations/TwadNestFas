  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">
              <strong><strong>Bank Balance Montoring System-Collection A/C</strong></strong>
            </font>
          </div>
        </td>
      </tr>
             ...
             <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <%
                    ps2=con.prepareStatement("select BANK_AC_NO,BANK_AC_TYPE_ID||'-'||bank_ac_no||'-'||AC_OPERATIONAL_MODE_ID as bankacno_type from FAS_MST_BANK_BALANCE where accounting_unit_id=?");
                    ps2.setInt(1,unitid);
                   
                    results2=ps2.executeQuery();
                    System.out.println("before while in getting bank accno");
                    while(results2.next())
                    {
                    ...
                    System.out.println("bank ac no....."+accno2);
                    out.println("<option value="+accno+">"+accno2+"</option>");
                    //out.println("<option value="+accno+">"+accno+"</option>");
                    System.out.println("upto this over");
                     }
                     System.out.println("After getting bank account number");
