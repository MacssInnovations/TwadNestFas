...
<html>
  <head>
    ...
    <title>Details of Assets Lost/Theft</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script type="text/javascript" src="../scripts/Asset_Lost_Theft_Details.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Details of Assets Lost/Theft </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmAsset_Lost_Details" id="frmAsset_Lost_Details" >
   ...
   %>
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
         ...
         FAS_SU="NO";
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <%
                    ps=con.prepareStatement("select distinct asset_code,ASSET_MAJOR_CLASS_CODE,financial_year,"+
                    		"	particulars from fas_asset_val_ac_details where accounting_unit_id=? and	"+
                    		"	ACCOUNTING_UNIT_OFFICE_ID=? order by ASSET_MAJOR_CLASS_CODE,asset_code,financial_year");
                    ps.setInt(1,unitid);
                    ps.setInt(2,oid);
                    rs=ps.executeQuery();
                    while(rs.next())
               ...
               <tr class="table">
                                      <td>
                                       <div align="left">
                                        Date of Lost/Theft  <font color="#ff2121">*</font>
                                </td>
                                      <TD>
                                      <div align="left">
                    <input type="text" name="txt_date" id="txt_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmAsset_Lost_Details.txt_date,1);"
              ...
              <TR class="table">
                                      <TD >
                                          Physical location of asset during lost/theft            <font color="#ff2121">*</font>
                                </TD>
                                <td>
                                        <SELECT size=1 name=txtphy_loc id=txtphy_loc >   
                                            ...
                                            try
                                            {
                                                    ...
                                                    ps=con.prepareStatement("select OFFICE_NAME from COM_MST_OFFICES order by office_id");
                                                    //ps.setInt(1,unitid);
                                                    rs=ps.executeQuery();
                                                    //out.println("<option value="+oid+">"+oname+"</option>");
                                                    while(rs.next())
             ...
             <td>
                  ...
                  <td>
                    ...
                    <input type="radio" name="txtcomp_status" id="txtcomp_status" tabindex="15"
                            value="Y" checked  onchange="check_amount(this.value)">Yes
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtcomp_status" id="txtcomp_status" onchange="check_amount(this.value)"
                           value="N"  >No &nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <TR class="table">
                                      <TD >
                                          Complaint No and Details<font color="#ff2121">*</font>
                                </TD>
                                      <TD>
                                          <input type="text" name="txtcomp_details" id="txtcomp_details"  >
                ...
                <td>
                  <div align="left">
                   Complaint lodging office          <font color="#ff2121">* </font>
                          </div>
                </td>
                <td>
