...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Asset_NumericalAC_OB_entry.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Assets Numerical A/C OB Entry </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
         ...
         FAS_SU="NO";
              ...
              <tr class="table">
                                      <td>
                                       <div align="left">
                                        Date of Entry  <font color="#ff2121">*</font>
                                        </div>
                                        </td>
                                      <TD>
                                      <div align="left">
                    <input type="text" name="txtdate_entry" id="txtdate_entry"  tabindex="7" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmNum_OB_Details.txtdate_entry,1);"
               ...
               <tr class="table">
                ...
                System Generated
                 ...
                 <td>
                  ...
                  <input type="text" name="txtassetcode"  id="txtassetcode"  maxlength="20" size="25" readonly /> 
                    System Generated
                  </div>
                </td>
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtAsset_alias"  id="txtAsset_alias"  maxlength="20" size="21">                  
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                                      <td>
                                       <div align="left">
                                        Quantity available as on Date  <font color="#ff2121">*</font>
                                        </div>
                                        </td>
                                      <TD>
                                      <div align="left">
                    <input type="text" name="quantity_date" id="quantity_date"  tabindex="7">
                    <!--
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmNum_OB_Details.quantity_date,1);"
                         alt="Show Calendar"></img>                     
                  -->
                  </div>
                              </TD>
              ...
              <TR class="table">
                ...
                <td>
                  <div align="left">
                   Status          <font color="#ff2121">* </font>
                          </div>
                </td>
                <td>
                  
                    <input type="radio" name="txtcheck" id="txtcheck" tabindex="13"
                            value="L"  onclick="cheque(this.value)" checked="checked" > Live
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtcheck" id="txtcheck" tabindex="14"
                           value="C" onclick="cheque(this.value)">Cancelled &nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
