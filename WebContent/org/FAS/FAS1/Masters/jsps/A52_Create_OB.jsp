...
<html>
  <head>
    ...
    <title>Create A52 OB from Verified A52</title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>  <!-- to avoid future date the above script used-->
    ...
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/Masters/scripts/A52_Create_OB.js"></script>
 <script type="text/javascript"   src="../../../../Security/scripts/tabpane.js"></script>
  ...
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS'),setTimeout('common_LoadOffice(this.value)',200),callServer('loadMajor');">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Create A52 OB from Verified A52</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmA52_Create_OB" id="frmA52_Create_OB" method="POST" action="../../../../../A52_Create_OB?command=insertOB"><%
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
       ...
       <tr class="tdH">
          ...
          <td colspan="3" class="table">
            <input type="button" name="CmdGo" value="Go" id="CmdGo" onclick="callServer('checkFreeze')"/>
