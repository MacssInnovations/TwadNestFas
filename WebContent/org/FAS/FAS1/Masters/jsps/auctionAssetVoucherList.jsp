...
<html>
  <head>
    ...
    <title>Auction Asset Voucher Details</title>
   ...
   <script type="text/javascript" src="../../../../../org/FAS/FAS1/Masters/scripts/auctionAssetDoneCash.js"></script>
    <script type="text/javascript"   src="../../../../Security/scripts/tabpane.js"></script>
  </head>
  <%String accId=request.getParameter("accId");
  	String offId=request.getParameter("offId");
  %>
  <body onload="getAuctionDetails('all')">
  <!-- ////////////////////// phone master heading ///////////////////////////////////-->
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">List of Asset Auction Voucher Details </font>
          </div>
        </td>
      </tr>
    </table>
