...
<html>
  <head>
    ...
    <title>A52_Central Register Report</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>
     ...
     <script language="javascript" type="text/javascript">
                ...
                function loadYear()
                {
                 ...
                 function rad_Abstract()
                 {
                 	...
                 	if(document.frmAsset52.All.checked == true){
                 		 
                 		document.frmAsset52.AllMajorType.checked=false;
                 		document.frmAsset52.OneMajorType.checked=false;
                 ...
                 {
                 	if(document.frmAsset52.AllMajorType.checked == true){
             		document.frmAsset52.All.checked=false;
             		document.frmAsset52.OneMajorType.checked=false;
             			document.getElementById("tr_row").style.display="none";
             			document.getElementById("tr_row1").style.display="none";
                 ...
                 if(document.frmAsset52.OneMajorType.checked == true){
                 		document.frmAsset52.All.checked=false;
                 		document.frmAsset52.AllMajorType.checked =false;
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A52 Central Register of Fixed Assets</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmAsset52" id="frmAsset52" action="">
                ...
                <table >
                 <tr>
				          <td colspan="3" class="table">
				           <input type="button" name="cmdsubmit" value="SUBMIT" onclick="report_A52();"
				                   id="cmdsubmit" />
