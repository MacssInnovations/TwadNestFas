...
<title>AA52 Verified List</title>
...
<script type="text/javascript" language="javascript">
       ...
       { 
            document.frmAA52Verified_List.submit();   
      }
       function exit()
       {
       self.close();
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">AA52 Circle Verified List</font></div>
		</td>
	</tr>
</table>

<form name="frmAA52Verified_List" id="frmAA52Verified_List"
	method="POST" action="../../../../../AA52_Un_Verified_List?command=AA52CircleVerified">
<div align="center">
