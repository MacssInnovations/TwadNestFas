...
<html>
  <head>
    ...
    <title>Qty Freeze A52 Register</title>
  ...
  <form name="frmQty_Freeze_A52Register" id="frmQty_Freeze_A52Register" method="post" action="../../../../../Freeze_Qty_A52?command=viewAbstract">
...
%>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Qty Freeze A52 Register</strong>
            </div>
          </td>
        </tr>
      </table>
          ...
          <td>
            <div align="center"><!--
             <input type="submit" id="cmdview" name="cmdview" value="View Abstract" onclick="return nullcheck();"></input>
              --><input type="button" id="btverifyA52AA52" name="btverifyA52AA52"  value="Freeze A52 Qty" onclick="doFunction('FreezeA52Qty','null');"/>               
