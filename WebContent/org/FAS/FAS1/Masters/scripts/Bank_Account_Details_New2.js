...
{   
    ...
    var open_date=document.getElementById("txtOpening_date").value;
...
function loadOtherDetails(baseResponse,param)
{
    ...
    {    
        ...
        document.getElementById("txtColCR").value=baseResponse.getElementsByTagName("CollAmount_cr")[0].firstChild.nodeValue;
        document.getElementById("txtColBR").value=baseResponse.getElementsByTagName("CollAmount_br")[0].firstChild.nodeValue;
        document.getElementById("txtColFR").value=baseResponse.getElementsByTagName("CollAmount_fr")[0].firstChild.nodeValue;
...
var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    ...
    {                      
        ...
        var open_date=baseResponse.getElementsByTagName("OPEN_DATE")[0].firstChild.nodeValue;
...
//        else
//        {
//        open_date=baseResponse.getElementbyTagName("OPEN_DATE")[0].firstchild.nodevalue;
//        }
        //alert("Open Date    "+open_date);
    ...
    else if(flag=="failure")
    {
       ...
       // document.getElementById("txtBankAccountNo").value="";
        ...
        document.getElementById("txtOB_Remittance").value="";
...
function ClearAll()
{
    //document.getElementById("txtBankAccountNo").value="-- Select bank a/c number -- ";
    document.getElementById("txtBankId").value="";
    document.getElementById("txtBankId_name").value="";
    document.getElementById("txtBranchId").value="";
    document.getElementById("txtBranchId_name").value="";
...
function ClearSecondPart()
{
  document.getElementById("txtBalanceAmount").value="";  
  document.getElementById("txtOB_Remittance").value="";
  document.getElementById("txtColCR").value="";  
  document.getElementById("txtColBR").value="";    
  document.getElementById("txtColFR").value="";   
