//alert("A52_Register_OB_DataEntry....");//A52_Register_OB_DataEntry	//
...
function checkOffice(){
	 document.frmA52_Register_OBEntry_Abstract.allid[0].checked=true;
...
/*function checkNull(){
	//alert("check null ");
	var accounting_unit_id=document.frmA52_Register_OBEntry_Abstract.cmbAcc_UnitCode.value;
	//var accounting_unit_office_id = document.frmA52_Register_OBEntry_Abstract.cmbOffice_code.value;
	var assetmajor=document.frmA52_Register_OBEntry_Abstract.cmbasset.value;
	var financial_year = document.frmA52_Register_OBEntry_Abstract.cmbFinancialYear.value; 
...
function blockHead()
{
	if(document.frmA52_Register_OBEntry_Abstract.allasset[0].checked==true)
	{
			 ...
			 if (command=="unitLoad")
			{
				 ...
				 var i = 0;
				    ...
				    if(flag=="success"){
				        ...
				        document.frmA52_Register_OBEntry_Abstract.allid[0].checked=true;
				        document.frmA52_Register_OBEntry_Abstract.allid[1].checked=false;
				        }
