...
function checkOffice(){
	 document.frmA52_Report_After_Edit.allid[0].checked=true;
...
function checkNull(){
	//alert("check null ");
	var accounting_unit_id=document.frmA52_Report_After_Edit.cmbAcc_UnitCode.value;
	//var accounting_unit_office_id = document.frmA52_Report_After_Edit.cmbOffice_code.value;
	var assetmajor=document.frmA52_Report_After_Edit.cmbasset.value;
	var financial_year = document.frmA52_Report_After_Edit.cmbFinancialYear.value; 
...
function blockHead()
{
	if(document.frmA52_Report_After_Edit.allasset[0].checked==true)
	{
...
function loadUnits()
{
	...
	var url ="../../../../../A52_Report_After_Edit?command=loadUnitRendering&unitid="+unitid ;
			 ...
			 if (command=="unitLoad")
			{
				 ...
				 var i = 0;
				    ...
				    if(flag=="success"){
				        ...
				        document.frmA52_Report_After_Edit.allid[0].checked=true;
				        document.frmA52_Report_After_Edit.allid[1].checked=false;
				        }
