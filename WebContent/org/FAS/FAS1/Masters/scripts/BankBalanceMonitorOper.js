  ...
  //  var txtRemarks=document.getElementById("txtRemarks").value;
        ...
        {  
            ...
            if(txtBankAccountNo.length!=0)
            {
                ...
                var url="../../../../../BankBalanceMonitorOperNew?Command=loadbankdeatils&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&txtBankAccountNo="+txtBankAccountNo;
         ...
         
    {
        ...
        var url="../../../../../BankBalanceMonitorOper?Command=Collection&BankId="+txtBankId+"&BranchId="+txtBranchId+"&BankAcNo="+txtBankAccountNo+"&AccUnit="+cmbAcc_UnitCode+"&txtCB_Year="+Year+"&txtCB_Month="+Month+"&txtverify_date="+Adate+"&AccHeadcode="+txtAcc_HeadCode+"&OpeningBal="+openBal;
        //alert(url);
        var req=getTransport();
