...
{  
    ...
    var verifya52;
        ...
        if(Command=="FreezeA52Unit")
        {
           if(nullcheck())
            {
        	   if(document.frmFreeze_A52Register.a52_option.checked==true)
        	    {
        	    	verifya52=document.getElementById("a52_option").value;
        	    }
                var url="../../../../../A52_Register_Unit_Status_Freeze?command=FreezeA52Unit"+
...
function nullcheck()
{
    ...
    if(document.frmFreeze_A52Register.cmbFinancialYear.value.length==0 )
    {
        alert("select finanical year");
        return false;
    }  
    if((document.frmFreeze_A52Register.a52_option.checked==false) )//&& (document.frmFreeze_A52Register.aa52_option[1].checked==false)
    {
...
function addRow(baseResponse)
{
 var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    if(flag=="success")
    {   
         alert("successfully Freeze A52 Unit Level Done");
         clearall();
...
function common_LoadOfficeCode()
{
  ...
  // alert("unitID_val"+unitID_val);
    if(unitID_val!="")
    {
        ...
        var url="../../../../../A52_Register_Unit_Status_Freeze?command=LoadUnitWise_OfficeCode&cmbAcc_UnitCode="+cmbAcc_UnitCode;
        var req=getTransport();
        req.open("GET",url,true);
        req.onreadystatechange=function()
        {
...
function clearall()
{
       document.frmFreeze_A52Register.a52_option.checked=false;
       document.frmFreeze_A52Register.cmbFinancialYear.value="2011-12";
       document.frmFreeze_A52Register.a52_option.disabled=false;
