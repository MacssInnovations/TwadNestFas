...
function checkNull(){
	//alert("check null ");
	var accounting_unit_id=document.frmA52_Register_OBEntry.cmbAcc_UnitCode.value;
	//var accounting_unit_office_id = document.frmA52_Register_OBEntry.cmbOffice_code.value;
	var assetmajor=document.frmA52_Register_OBEntry.cmbasset.value;
	var financial_year = document.frmA52_Register_OBEntry.cmbFinancialYear.value; 
...
function blockHead()
{
	if(document.frmA52_Register_OBEntry.allasset[0].checked==true)
	{
