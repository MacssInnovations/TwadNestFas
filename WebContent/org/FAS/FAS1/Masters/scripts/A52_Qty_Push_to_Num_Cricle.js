...
function callServer(command)  {  
	...
	var accounting_unit_id=document.frmA52_Qty_Push_Cricle.cmbAcc_UnitCode.value;
//var accounting_unit_office_id = document.frmA52_Qty_Push_Cricle.cmbOffice_code.value;
var assetmajor=document.frmA52_Qty_Push_Cricle.cmbmajorasset.value;
var financial_year = document.frmA52_Qty_Push_Cricle.cmbFinancialYear.value;  
var url="";
 if(command=="Go")
 {  
 	
 	//if(checkNull()){
 			url="../../../../../A52_Qty_Push_to_Num_Cricle?command=GoGet&unit_id="+accounting_unit_id+"&financial_year="+financial_year+"&assetmajor="+assetmajor;//"&office_id="+accounting_unit_office_id+
 	...
 	url="../../../../../A52_Qty_Push_to_Num_Cricle?command=loadMajor";
	...
	if(checkNull()){
 	url="../../../../../A52_Qty_Push_to_Num_Cricle?command=checkStatus&unit_id="+accounting_unit_id+"&financial_year="+financial_year;
		var req=getTransport();
     req.open("GET",url,true);  
     req.onreadystatechange=function(){
     	processResponse(req);
