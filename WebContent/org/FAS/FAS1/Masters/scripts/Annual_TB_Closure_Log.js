...
function saveFunc(path) {
	...
	{
	var url = path	+ "/AnnualTBClosureLog?command=save&cmbFinancial_Year="	+ cmbFinancial_Year + "&date=" + date;	
	//alert(url);
...
function saveFunc1(baseResponse) {
	...
	if(flag == "NoData")
	{
		alert("First Freeze Annual TB Closure");
	}
	else if(flag == "success")
	{
		alert("Annual TB Closure Unfreezed Successfully");
	}
	else
	{
