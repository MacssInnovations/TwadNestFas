...
{   
   ...
   ///////////////////////////// 
       ...
       // var txtAcc_HeadCode=document.getElementById("txtCol_accode").value;
    ...
    //alert(document.getElementById("rad_CR_DR").value)
  //  var txtRemarks=document.getElementById("txtRemarks").value;
        ...
        {  
            ...
            if(txtBankAccountNo.length!=0)
            {
                ...
                var url="../../../../../Bank_Account_Details_New.view?Command=loadbankdeatils&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&txtBankAccountNo="+txtBankAccountNo;
         ...
         
    {
        ...
        var url="../../../../../Bank_Balance_Monitor_New?Command=Collection&BankId="+txtBankId+"&BranchId="+txtBranchId+"&BankAcNo="+txtBankAccountNo+"&AccUnit="+cmbAcc_UnitCode+"&txtCB_Year="+Year+"&txtCB_Month="+Month+"&txtverify_date="+Adate+"&OpeningBal="+openBal;
        //var url="../../../../../Bank_Balance_Monitor_New?Command=Collection&BankId="+txtBankId+"&BranchId="+txtBranchId+"&BankAcNo="+txtBankAccountNo+"&AccUnit="+cmbAcc_UnitCode+"&txtCB_Year="+Year+"&txtCB_Month="+Month+"&txtverify_date="+Adate+"&AccHeadcode="+txtAcc_HeadCode+"&OpeningBal="+openBal;
        //alert(url);
        var req=getTransport();
...
function loadOtherDetails(baseResponse)
{
// alert("comes inside2")   
...
var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    ...
    {                      
        ...
        document.getElementById("txtBalance_date").value=baseResponse.getElementsByTagName("BAL_DATE")[0].firstChild.nodeValue;
