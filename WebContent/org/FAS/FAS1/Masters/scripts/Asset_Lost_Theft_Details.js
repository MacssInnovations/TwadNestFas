...
function ListAll()
    ...
    else
    {
        window_BankAccNumber=null
         ...
         var cmbAcc_UnitCode=document.frmAsset_Lost_Details.cmbAcc_UnitCode.value;
         var cmbOffice_code=document.frmAsset_Lost_Details.cmbOffice_code.value;
       //  alert(cmbAcc_UnitCode);
         window_BankAccNumber= window.open("Assets_Lost_Theft_Details_List.jsp?cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code,"mywindow1","resizable=YES, scrollbars=yes"); 
         window_BankAccNumber.moveTo(250,250);    
    }
...
function doParentBankAccNumbers(dateentry,assetcode,location,iscomp,compdetails,compoffice,remarks)
{
  // alert("inside parent");
    //     alert(compoffice);
    //     alert(iscomp);
       //  alert("assetcode"+assetcode)
            ...
            document.getElementById("txtOffice_Name").options[document.getElementById("txtOffice_Name").selectedIndex].text=compoffice
            document.getElementById("txtcomp_details").value=compdetails;
            document.getElementById("txtcomp_status").value=iscomp;
...
//    var cmbFinancialYear=document.getElementById("cmbFinancialYear").value;
   ...
   // alert("cmbasset"+cmbasset);
    var iscomp=document.getElementById("txtcomp_status").value;
    var compdetails=document.getElementById("txtcomp_details").value;
    ...
    var comp_lodged_off=document.getElementById("txtcheck").value;
    ...
    var txtRemarks=document.getElementById("txtRemarks").value;
         ...
         if(Command=="Add")
        {
            ...
            if(flag==true)
               {
                var url="../../../../../Assets_Lost_Theft_Details.view?Command=Add&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                        "&cmbOffice_code="+cmbOffice_code+"&txt_date="+txt_date+"&iscomp="+iscomp+"&compdetails="+compdetails+
                        "&cmbasset="+cmbasset+"&txtOffice_Name="+txtOffice_Name+"&comp_lodged_off="+comp_lodged_off+
        ...
        else if(Command=="Delete")
        {
            ...
            if(confirm("Do You Really want to Delete it?"))
            {
               ...
               if(flag==true)
               {  
                  var url="../../../../../Assets_Lost_Theft_Details.view?Command=Delete&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                        "&cmbOffice_code="+cmbOffice_code+"&txt_date="+txt_date+"&iscomp="+iscomp+"&compdetails="+compdetails+
                        "&cmbasset="+cmbasset+"&txtOffice_Name="+txtOffice_Name+"&comp_lodged_off="+comp_lodged_off+
                        "&phy_loc="+phy_loc+"&txtRemarks="+txtRemarks;
                 //  alert(url);
       ...
       { 
    	  // alert("inside update");
            ...
            if(flag==true)
             {
                var url="../../../../../Assets_Lost_Theft_Details.view?Command=Update&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                        "&cmbOffice_code="+cmbOffice_code+"&txt_date="+txt_date+"&iscomp="+iscomp+"&compdetails="+compdetails+
                        "&cmbasset="+cmbasset+"&txtOffice_Name="+txtOffice_Name+"&comp_lodged_off="+comp_lodged_off+
                        "&phy_loc="+phy_loc+"&txtRemarks="+txtRemarks;
               // alert(url);
...
function UpdateRow(baseResponse)
{
    ...
    if(flag=="success")
    {
        ...
        document.frmAsset_Lost_Details.cmbasset.disabled=false;
       // document.frmAsset_Lost_Details.cmbFinancialYear.disabled=false;
...
function ClearAll()
{
    ...
    document.getElementById("cmbasset").disabled=true;
   document.getElementById("txtphy_loc").disabled=true;
   document.getElementById("txtOffice_Name").disabled=true;
   
    document.getElementById("txtRemarks").value="";
    document.getElementById("txtcomp_details").value="";
    document.getElementById("txtcomp_status").value="";
...
function officeCheck()
{
                ...
                if((document.frmAsset_Lost_Details.unitid.value=="") || (document.frmAsset_Lost_Details.unitid.value.length<=0))
                {
                    alert("Please Enter Office Id or Select ");
                    document.frmAsset_Lost_Details.unitid.focus();
                    return false;
...
//alert('hai');
            ...
            var officeid=document.frmAsset_Lost_Details.txtOffice_Id.value;
            startwaiting(document.frmAsset_Lost_Details) ;
