...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Authorization System ( Defunct SJV ) </title>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmAuthorization_JAO_Create.txtCrea_date.value="31/03/"+year;
        }
...
%>
  <body  onload="call_clr();loadDate()" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Authorization Details ( Defunct SJV ) </font>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="center">
            ...
            <tr class="table">
                ...
                <td width="60%">
                  ...
                  <select name="supNo" id="supNo" onchange="SupVoucherNo();">
