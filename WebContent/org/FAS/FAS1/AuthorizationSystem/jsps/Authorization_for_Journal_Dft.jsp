...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Authorization System for Defunct Units</title>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Authorization for Defunct Units </font>
          </div>
        </td>
      </tr>
    </table>
   ...
   %>
          ...
          <div align="center">
            ...
            <tr class="table">
                ...
                <td width="60%">
                  <div align="left">
                    <select size="1" name="cmbSubSystemType" id="cmbSubSystemType" tabindex="3" onchange="doFunction('load_Voucher_No','null');Supplement_Date();">
