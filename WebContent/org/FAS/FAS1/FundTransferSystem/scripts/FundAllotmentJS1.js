...
//alert(divname);
var offid=document.frmJournal_General_Edit.cmbOffice_code.value;
//alert(offid)
var url="../../../../../FundAllotmentServ1?Command=loadVoucher&accunit="+accunitid+"&txtyear="+year+"&txtmonth="+month+"&officeId="+offid;
            //alert(url);
...
var offid=document.frmJournal_General_Edit.cmbOffice_code.value;
//alert(offid)
//var vno=document.frmJournal_General_Edit.txtVoucherNo.value;
//alert(vno)
var url="../../../../../FundAllotmentServ1?Command=loadDivision&accunit="+accunitid+"&txtyear="+year+"&txtmonth="+month+"&officeId="+offid+"&voucherno="+divname;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
         ...
         for(var k=0;k<transofficeid.length;k++)
            {
                ...
                officename[k]=baseResponse.getElementsByTagName("officeName")[k].firstChild.nodeValue;
               // items_name[k]=baseResponse.getElementsByTagName("cname")[k].firstChild.nodeValue;
            }
...
var vno=document.frmJournal_General_Edit.txtVoucherNo.value;
//alert(vno)
var url="../../../../../FundAllotmentServ1?Command=loadLetNo&txtyear="+year+"&txtmonth="+month+"&diviname="+divname+"&accunit="+accunitid+"&office_id="+officeid+"&voucherno="+vno;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
//alert(flag);
    ...
    var fundtyp=baseResponse.getElementsByTagName("fundtype")[0].firstChild.nodeValue;
    //alert(fundtyp)
    //alert(transamt);
    //alert(lettdate);
    if(lettno=='null')
...
var mycurrent_row=document.createElement("TR");
     ...
     //        alert('first td'+(slno.value))
                  ...
                  //var currentText=document.createTextNode(letnum);
                   ...
                   {
                   letdatehid=document.createElement("input");
                  ...
                  cell2.appendChild(letdatehid);
                   if (window.navigator.appName.toLowerCase().indexOf("netscape") == -1)
                   {
                  var cal=document.createElement("<img src='../../../../../images/calendr3.gif' alt='ShowCalendar' onclick='showCalendarControl(document.frmJournal_General_Edit.let_date_hid)'>");
                  }
                  else
                  {
                  //alert('1')
                  var cal=document.createElement("img");
                  cal.src="../../../../../images/calendr3.gif";
                  cal.alt='ShowCalendar';
                  cal.setAttribute('onclick','showCalendarControl(document.frmJournal_General_Edit.let_date_hid)');
                  }
                  cell2.appendChild(cal);
                 // var currentText=document.createTextNode(letno+"-"+letdate);
                 // cell2.appendChild(currentText);
                   mycurrent_row.appendChild(cell2);
             ...
             cell2=document.createElement("TD");
              var alotamthid=document.createElement("input");
                  ...
                  cell2.appendChild(alotamthid);
                    var currentText=document.createTextNode(transamt);
                   cell2.appendChild(currentText);
                   //alert(transamt)
                  //alert(alotamthid.value);
                  //cell2.appendChild(alotamthid);     
          ...
          /*   cell2=document.createElement("TD");
              var worktypehid=document.createElement("input");
                  worktypehid.type="text";
                  worktypehid.name="work_type_hid";
                  worktypehid.value=worktype;
                  cell2.appendChild(worktypehid);     
              var remarkshid=document.createElement("input");
                  remarkshid.type="text";
                  remarkshid.name="remarks_hid";
                  remarkshid.value=remarks;
                  cell2.appendChild(remarkshid);     
                   var currentText=document.createTextNode(worktype);
              ...
              cell2=document.createElement("TD");
                    var letdatehid=document.createElement("input");
                     ...
                     letdatehid.value=fundtyp;
                     if(fundtyp=='W')
                        var txtfundtype="Work";
                     else
                        var txtfundtype="Civil";
                     // cell2.appendChild(letdatehid);  
                      var currentText=document.createTextNode(txtfundtype);
                   cell2.appendChild(currentText);
                  //   cell2.appendChild(letdatehid);
...
var officeid=document.frmJournal_General_Edit.cmbOffice_code.value;
//alert(officeid);
var url="../../../../../FundAllotmentServ1?Command=loadVoucherNo&txtyear="+year+"&txtmonth="+month+"&diviname="+divname+"&accunit="+accunitid+"&office_id="+officeid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
