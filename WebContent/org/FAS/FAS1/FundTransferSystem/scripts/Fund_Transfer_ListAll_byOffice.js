...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../Fund_Transfer_ListAll_byOffice.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='';
                var url="../../../../../Fund_Transfer_ListAll_byOffice.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
            ...
            try{tbody.innerHTML="";}
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        ...
                        items[4]=service[i].getElementsByTagName("Remak")[0].firstChild.nodeValue;
                        items[5]=service[i].getElementsByTagName("OFFICE_ACCOUNT_NO")[0].firstChild.nodeValue;
                        items[6]=service[i].getElementsByTagName("HO_ACCOUNT_NO")[0].firstChild.nodeValue;
                        ...
                        items[7]=service[i].getElementsByTagName("che_or_DD")[0].firstChild.nodeValue+"-"+service[i].getElementsByTagName("che_DD_no")[0].firstChild.nodeValue;
                        ...
                        /*if(items[2]=="U")
                            ...
                            items[2]="Collection"*/
                            	 ...
                            	 if(items[2]=="U")
                            		 ...
                            		 items[2]="Unspent from NRDWP-Main";
                            	 else if(items[2]=="NS")
                            		 items[2]="Unspent from NRDWP-Support";                                     
                            	 else if(items[2]=="UNM")
                            		 items[2]="NRDWP-Main-Int.Transfer";                                     
                            	 else if(items[2]=="UNS")
                            		 items[2]="NRDWP-Support-Int.Transfer";
                            	 else if(items[2]=="UNC")
                                     items[2]="Unspent from NRDWP-Calamity";
