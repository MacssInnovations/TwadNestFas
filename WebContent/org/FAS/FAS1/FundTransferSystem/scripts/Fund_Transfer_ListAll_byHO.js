...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Voucher_list_SL= window.open("../../../../../org/FAS/FAS1/FundTransferSystem/jsps/Fund_Transfer_ListAll_SL_byHO.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"ReceiptDateSearch","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Voucher_list_SL.moveTo(250,250);  
    Voucher_list_SL.focus();
...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    document.frmFund_Transfer_ListAll_byHO.action=url;
    document.frmFund_Transfer_ListAll_byHO.method="POST";
    document.frmFund_Transfer_ListAll_byHO.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../Fund_Transfer_ListAll_byHO.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='';
                var url="../../../../../Fund_Transfer_ListAll_byHO.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.frmFund_Transfer_ListAll_byHO.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmFund_Transfer_ListAll_byHO.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        ...
                        items[2]=service[i].getElementsByTagName("HO_REF_NO")[0].firstChild.nodeValue;
                        items[3]=service[i].getElementsByTagName("HO_ref_date")[0].firstChild.nodeValue;
                         items[4]=service[i].getElementsByTagName("BK_BR_CITY")[0].firstChild.nodeValue;
                         if(items[5]=service[i].getElementsByTagName("Remak")[0].firstChild!=null){
                         items[5]=service[i].getElementsByTagName("Remak")[0].firstChild.nodeValue;
                         }
                        items[6]=service[i].getElementsByTagName("Tot_Amt")[0].firstChild.nodeValue;
...
function changepagesize()
{
           ...
           __pagination=document.frmFund_Transfer_ListAll_byHO.cmbpagination.value;
