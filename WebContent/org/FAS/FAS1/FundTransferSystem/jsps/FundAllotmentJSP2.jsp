...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/FundAllotmentJS2.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmFund_Allotment_Details" id="frmFund_Allotment_Details"  method="POST" onsubmit="return checkNull()"
                action="../../../../../FundAllotmentSubmitServ2">
