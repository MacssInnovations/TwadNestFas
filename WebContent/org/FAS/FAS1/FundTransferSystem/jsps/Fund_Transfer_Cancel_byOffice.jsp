...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Transfer_Cancel_byOffice.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
                ...
                document.frmFundTrs_Cancel_byOffice.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Transfer System - From Region/Circle/Division (Cancel) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFundTrs_Cancel_byOffice" id="frmFundTrs_Cancel_byOffice" method="POST"
                  action="../../../../../Fund_Transfer_Cancel_byOffice.view?Command=Cancel"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Cancel_byOffice.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <!--<input type="radio" name="radRemitType" id="radRemitType"
              ...
              <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  ...
                  <!--   
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Create_byHO.txtCheque_DD_date);"
                         alt="Show Calendar"></img>                         
                  -->
                  </div>
                </td>
               ...
               <tr class="table">
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"                  
                           ...
                           onblur=" return checkdt(this);;"/>
                <!--     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Cancel_byOffice.txtReferenceDate);"
                         alt="Show Calendar"></img> -->
                  </div>
                </td>
              </tr>  
