...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
    ...
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/CommonControls/scripts/Cheque_Number_Check_FT_fromHO.js"></script>  
    ...
    <script type="text/javascript" src="../scripts/Fund_Transfer_Create_byHO.js"></script>
   ...
   <!-- 
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmFundTrs_Create_byHO.txtCrea_date.value=day+"/"+month+"/"+year;
            call_date(document.frmFundTrs_Create_byHO.txtCrea_date);
      }
    </script>
...
%>
  <body onload="LoadAccountingUnitID_Create('LIST_ALL_UNITS');call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Transfer System - From Banking Unit(HO) (Create) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFundTrs_Create_byHO" id="frmFundTrs_Create_byHO" method="POST"
                  action="../../../../../Fund_Transfer_Create_byHO.view?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Create_byHO.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="hidden" name="txtVoucher_No" id="txtVoucher_No"  tabindex="4" 
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCash_Acc_code" id="txtCash_Acc_code" tabindex="5"  value="<%=AC_HEAD_CODE%>"
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtBankAccountNo"  onkeypress="return numbersonly(event)"    value="<%=bankAccNo%>"
                           id="txtBankAccountNo" maxlength="18"  size="18"  style="background-color: #ececec" readonly="readonly" />
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtReferenceNo" tabindex="7" 
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"  tabindex="8" 
                           maxlength="10" size="11"  
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);"
                           onblur=" return checkdt(this);;"/>
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Create_byHO.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
          ...
          <div align="center">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtSub_Office_code" 
                           ...
                           onkeypress="return numbersonly(event)" onblur="doFunction('office_with_bank_betails','null');"
                           size="6"/>
           ...
           <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtSubBankAccountNo" 
                           id="txtSubBankAccountNo" maxlength="18"  size="18"  style="background-color: #ececec"  readonly="readonly" />
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCheque_DD_NO" maxlength="10" onkeypress="return numbersonly(event)" onblur="check_dd_cheque(),chequeRange();"
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Create_byHO.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>   
