...
<html>
  <head>
    ...
    <title>Fund Transfer Monitoring for Office</title>
...
%>
  ...
  <form name="frmJournal_forCashBookMonth" method="POST" action="../../../../../fund_transfer_monitoring_for_office" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Fund Transfer Monitoring for Office</strong>
          </div>
        </td>
      </tr>
    </table>
