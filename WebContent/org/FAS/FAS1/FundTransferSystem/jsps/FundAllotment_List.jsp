...
onkeypress="return numbersonly(event)">
          ...
          <select name="txtCB_Month"  id="txtCB_Month" tabindex="4" onclick="ListAll()" >
          ...
          <option value="12">December</option>
              ...
              <tr class="table">
                ...
                <td>
                   <div align="left">
                  <input type="text" name="txtVoucherNo" id="txtVoucherNo"   tabindex="4" readonly="readonly" style="background-color: #ececec" >
           ...
           <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtLetNo" readonly="readonly" tabindex="5"  style="background-color: #ececec"
                                id="txtLetNo"  size="15"/>
                  </div>
                 </td>
              </tr>
               <tr class="table">
                ...
                <td>
                    ...
                    <input type="text" name="txtLetterDate" tabindex="5"  onkeypress="return  calins(event,this)"
                         style="background-color: #ececec" readonly="readonly" onblur="return checkdt(this);"
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtRemarks" id="txtRemarks" style="background-color: #ececec" readonly="readonly" size="50" tabindex="8"></input>  
