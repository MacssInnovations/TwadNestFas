...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/FundAllotmentJS.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmJournal_General_Edit" id="frmJournal_General_Edit"  method="POST" onsubmit="return checkGrid()"
                action="../../../../../FundAllotmentSubmitServ">
...
readonly="readonly"   maxlength="4" size="5"/>accunit
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                  <select size="1" name="txtDivname" id="txtDivname" onchange="loadLetNo()"  tabindex="4" >
...
System.out.println("today-----------"+to_day);
           ...
           <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtLetterDate" tabindex="5"  style="background-color: #ececec"  readonly="readonly" 
