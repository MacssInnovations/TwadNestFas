...
<html>
  <head>
    ...
    <title>Verify Fund Transfers At HO</title>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmVerify_Fund_Transfer_HO.txtCB_Year.value=year
        document.frmVerify_Fund_Transfer_HO.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmVerify_Fund_Transfer_HO" method="POST">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Verify Fund Transfers At HO
 </strong>
          </div>
        </td>
      </tr>
    ...
    <br>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmVerify_Fund_Transfer_HO.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmVerify_Fund_Transfer_HO.txtTo_date);"
                         alt="Show Calendar"></img>
     ...
     <table id="mytable" align="center"  cellspacing="3" 
      ...
      <td>
          <div align="center">
          <input type="button" name="cmdEdit" value="Verify" id="cmdEdit"  onclick="Updat()" tabindex="30" />
	             &nbsp;&nbsp;&nbsp; 
