...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Transfer_Cancel_byHO.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmFundTrs_Cancel_byHO.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Transfer System - From Banking Unit(HO) (Cancel) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFundTrs_Cancel_byHO" id="frmFundTrs_Cancel_byHO" method="POST"
                  action="../../../../../Fund_Transfer_Cancel_byHO.view?Command=Cancel"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Cancel_byHO.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundTrs_Cancel_byHO.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
