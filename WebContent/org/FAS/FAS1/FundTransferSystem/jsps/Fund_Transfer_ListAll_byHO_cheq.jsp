     ...
     <table id="mytable" align="center"  cellspacing="3" 
         ...
         <tbody id="tbody" class="table">
          <%
           ...
           try
           {
           String sql="select m.VOUCHER_NO as vno,to_char(m.DATE_OF_TRANSFER,'DD/MM/YYYY') as rec_date ,trim(to_char(j.AMOUNT,'99999999999999.99')) as AMOUNT," +
                      "m.REMARKS as remarks,m.HO_REF_NO as refno,to_char(m.HO_REF_DATE,'DD/MM/YYYY') as ref_date," +
                      "j.CHEQUE_DD_NO as cheqno,to_char(j.CHEQUE_DD_DATE,'DD/MM/YYYY') as cheqdate,j.CHEQUE_OR_DD as cheqtype, " +
                      "bk.BANK_NAME ||'-'|| br.BRANCH_NAME ||'-'|| br.CITY_TOWN_NAME AS BK_BR_CITY " +
                      "from FAS_FUND_TRF_FROM_HO_MASTER m,FAS_MST_BANKS bk,FAS_MST_BANK_BRANCHES br,FAS_FUND_TRF_FROM_HO_TRN j " +
                      "where m.ACCOUNTING_UNIT_ID="+cmbAcc_UnitCode+" and m.ACCOUNTING_FOR_OFFICE_ID="+cmbOffice_code+" and m.CASHBOOK_YEAR="+yr+" and m.CASHBOOK_MONTH="+mon+"  and m.TRANSFER_STATUS='L'" +
                      "and m.HO_BANK_ID=br.BANK_ID and m.HO_BRANCH_ID=br.BRANCH_ID and m.HO_BANK_ID=bk.BANK_ID " + 
                      "and m.ACCOUNTING_UNIT_ID=j.ACCOUNTING_UNIT_ID and m.ACCOUNTING_FOR_OFFICE_ID=j.ACCOUNTING_FOR_OFFICE_ID " +
                      "and m.CASHBOOK_YEAR=j.CASHBOOK_YEAR and m.CASHBOOK_MONTH=j.CASHBOOK_MONTH and m.VOUCHER_NO=j.VOUCHER_NO AND m.CHEQUE_OR_DD='C'";
