...
%>
      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          String sql="select t.SL_NO,t.TRANSFER_TO_OFFICE_ID ,t.TRANSFERED_TO_HO_UNIT_ID,o.OFFICE_NAME ,t.ACCOUNT_HEAD_CODE,t.OFFICE_ACCOUNT_NO, t.AMOUNT,  t.CHEQUE_OR_DD ||'-'|| t.CHEQUE_DD_NO as cheDD,"+
           ...
           // System.out.println(sql);
            ...
            while(rs2.next())
            {
                ...
                out.println("<td align='left'>"+officeName+"</td>");
                 out.println("<td align='left'>"+rs2.getString("ACCOUNT_HEAD_CODE")+"</td>");
                 out.println("<td align='left'>"+rs2.getString("OFFICE_ACCOUNT_NO")+"</td>");
