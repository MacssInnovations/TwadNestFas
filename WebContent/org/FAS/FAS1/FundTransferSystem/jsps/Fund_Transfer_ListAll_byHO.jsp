...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Fund_Transfer_ListAll_byHO.js"></script>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmFund_Transfer_ListAll_byHO.txtCB_Year.value=year
        document.frmFund_Transfer_ListAll_byHO.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmFund_Transfer_ListAll_byHO" method="POST">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Fund Transfers from Banking Unit(HO)
 </strong>
          </div>
        </td>
      </tr>
                     ...
                     <!-- <option value="0"> Select Account Unit </option>-->
                      ...
                      try{
                            ...
                            if(oid==5000)
                            {
                               ...
                               System.out.println("SSSSSSSSSSSSSSSS::::::::::"+oid);
                                  ...
                                  if(rs.next())
                                  {
                                      ...
                                      rs.close();
                                          ...
                                          { 
                                            ...
                                            // String su="select ACCOUNTING_UNIT_ID,ACCOUNTING_UNIT_NAME,OFFICE_WING_SINO from FAS_MST_ACCT_UNITS where ACCOUNTING_UNIT_OFFICE_ID=5000 and OFFICE_WING_SINO=(2)";
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Transfer_ListAll_byHO.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Transfer_ListAll_byHO.txtTo_date);"
                         alt="Show Calendar"></img>
