...
<html>
  <head>
   <meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/> 
    ...
    <title>Fund Transfer Monitoring for Head Office</title>
     ...
     <script type="text/javascript" src="../scripts/Fund_Transfer_Monitoring.js"></script>
...
%>
  ...
  <form name="frmJournal_forCashBookMonth" method="POST" action="../../../../../fund_transfer_monitoring_for_ho" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Fund Transfer Monitoring for Head Office</strong>
          </div>
        </td>
      </tr>
    </table>
