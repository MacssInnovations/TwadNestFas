...
{   
	     ...
	     var supNo=document.getElementById("supNo1").value;
	     //alert("SupNo--->"+supNo);
	     ...
	     if(document.TDA_TCA.reptype[0].checked==true)
	    	 {
	    	 	reptype="Regular";
	    	 }
	     else
	    	 {
	    	 	reptype="InclusiveSJV";
	    	 
	    	 }
	     
         url="../../../../../TDA_TCA_Acceptance_Create?command=load_Vno&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&type1="+type1+"&reptype="+reptype+"&supNo="+supNo;
         //alert(url); //pradha
         req=getTransport();
         req.open("GET",url,true);        
         req.onreadystatechange=function()
...
function loadVoucherDetails()
{
	     ...
	     url="../../../../../TDA_TCA_Acceptance_Create?command=loadVoucherDetails&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&originated_slno="+originated_slno+"&type1="+type1+"&reptype="+reptype+"&supNo=1";
	     req=getTransport();
	     req.open("GET",url,true);        
	     req.onreadystatechange=function()
	     {        	  
...
{      
    ...
    document.TDA_TCA.isAccept[1].checked=false;
         if(checkdt(dateCtrl))
         {
                 ...
                 {
                	 //Lakshmi
                         var url="../../../../../TDA_TCA_Acceptance_Create?command=check_TB&TB_date="+TB_date+"&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&supNo="+supNo;
                         var req=getTransport();
                         req.open("GET",url,true); 
                         req.onreadystatechange=function()
                         {
...
{		
      ...
      //           document.getElementById("butSub").disabled=false;
        ...
        document.getElementById("txtCB_Month").value=1;
        document.getElementById("originated_slno").length=1;
        document.getElementById("supNo").length=0;
...
function Check_Supplement_No1()
{
      //var txtCrea_date=document.getElementById("txtCrea_date").value;
	//alert("Welcome Check_Supplement_No1");
	var txtCash_year=document.getElementById("txtCB_Year").value;
    var txtCash_Month_hid=document.getElementById("txtCB_Month").value;
	
//	var txtCrea_date1=document.getElementById("txtCrea_date").value;
//    var txtCrea_date=txtCrea_date1.split("/");
...
{
 //alert("Welcome!")
	//alert("Welcome Check_Supplement_No");
	var txtCrea_date1=document.getElementById("txtCrea_date").value;
     // alert(txtCrea_date1);
      var txtCrea_date=txtCrea_date1.split("/");
      //alert("Year==>"+txtCrea_date[2]);
    //  alert("Month==>"+txtCrea_date[1]);
	//var txtCash_year=document.getElementById("txtCB_Year").value;
    //var txtCash_Month_hid=document.getElementById("txtCB_Month").value;
    var url="../../../../../Supplement_Journal_Create.kv?Command=Check_Supplement_No1&txtCash_year="+txtCrea_date[2]+"&txtCash_Month_hid="+txtCrea_date[1];
         ...
         if(flag=="failure")
              {
                ...
                document.getElementById("supNo1").options.length = 0;
              ...
              else if(flag=="success")
              {
            	  ...
            	  document.forms[0].supNo1.length=0;
                 ...
                 var supNo2 = document.forms[0].supNo1;
                 var supno = baseResponse.getElementsByTagName("supno"); 
                 for(var i=0; i<supno.length; i++)
                     {
                         var opt = document.createElement('option');
