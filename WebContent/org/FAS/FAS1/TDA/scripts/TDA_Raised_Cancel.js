...
function doFunction_TDA(command)
{
		 ...
		 {
			  url="../../../../../TDA_Raised_Edit?command=load_Voucher_No&Option=Cancel&txtUnitId="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type;           			  
		 }
		 else if(command=="load_Voucher_Details") 
		 {
			  var originated_slno=document.getElementById("originated_slno").value;
			  url="../../../../../TDA_Raised_Edit?command=load_Voucher_Details&txtUnitId="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type+"&originated_slno="+originated_slno;           			  
		 }
		 //alert(url);
		 req=getTransport();
		 req.open("GET",url,true);        
