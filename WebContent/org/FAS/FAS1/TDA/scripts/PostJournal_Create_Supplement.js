...
function nullCheck()
{
		 ...
		 else if(document.getElementById("supNo").value=="")
		 {
			 	alert("Select Supplement No");
			 	return false;
		 }
			return true;
}
...
document.getElementById("butSub_go").disabled=false;
	       ...
	       var supp=document.getElementById("supNo").value;
          ...
          //    alert("cmbJournal_type:::"+cmbJournal_type);
               if(cmbJournal_type=="63" ||cmbJournal_type=="66") //Accepting
               {
                    ...
                    url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByMonth_accepting&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtCB_Year="+yr+"&txtCB_Month="+mn+"&txtCrea_date="+txtCrea_date+"&supp="+supp;
               }
               else
               {
                var cell=document.getElementById("grid");
                ...
                var tbody=document.getElementById("grid_body");
                 ...
                 url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtCB_Year="+yr+"&txtCB_Month="+mn+"&txtCrea_date="+txtCrea_date+"&supp="+supp;
               }
             ...
             if(command=="searchByDate")
                   {  
                         ...
                         if(cmbJournal_type=="63" ||cmbJournal_type=="66") //Accepting
                           {
                            var tbody=document.getElementById("grid_body2");
                                 ...
                                 url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByDate_accepting&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&supp="+supp;
                         ...
                         else
                         {
                                 ...
                                 url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&supp="+supp;
                         }
                         req=getTransport();
                         req.open("GET",url,true);        
                         req.onreadystatechange=function()
			                        ...
			                        if(cmbJournal_type=="63" ||cmbJournal_type=="66") //Accepting
			                           {
			                                ...
			                                url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByMonth_accepting&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCrea_date="+txtCrea_date+"&supp="+supp;
			                         ...
			                         else
			                         {
			                             ...
			                             url="../../../../../PostJournal_Create_Supplement?command=loadVoucherByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&cmbJournal_type="+cmbJournal_type+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtCrea_date="+txtCrea_date+"&supp="+supp;
			                         }
			                         req=getTransport();
			                         req.open("GET",url,true);        
			                         req.onreadystatechange=function()
...
function checkNull()
{       
	var sup=document.getElementById("supNo").value;
	if(sup=="")
	{
		alert("Select Supplement No");
		return false;
...
//       var url="../../../../../Supplement_Journal_Create.kv?Command=Check_Supplement_No&txtCrea_date="+txtCrea_date;
      ...
      var url="../../../../../Supplement_Journal_Create.kv?Command=Check_Supplement_No_New&txtCrea_date="+txtCrea_date;
      // alert(url);
       var req=getTransport();
       req.open("GET",url,true); 
       req.onreadystatechange=function()
...
//              var supno=baseResponse.getElementsByTagName("supno")[0].firstChild.nodeValue;
           //   alert("supno"+supno);
                 ...
                 document.Post_Journal.txtCrea_date.value="31"+"/"+"03"+"/"+year;
                 document.getElementById("txtFrom_date").value="31"+"/"+"03"+"/"+year;
                 document.Post_Journal.txtTo_date.value="31"+"/"+"03"+"/"+year;
