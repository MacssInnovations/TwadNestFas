...
{   
		 ...
		 {
        	    url="../../../../../TDA_TCA_Acceptance_Edit?command=loadVoucher&Option=Edit&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type;           			  
		 }
