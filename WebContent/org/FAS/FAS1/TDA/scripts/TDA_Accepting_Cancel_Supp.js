...
{   
         ...
         if(command=="load_Voucher_No") 
		 {
     			...
     			document.getElementById("accepted_slno").length=1;
        	    url="../../../../../TDA_Accepting_Edit_Supp?command=loadVr_sup&Option=Cancel&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type+"&supNo="+SupNo;           			  
		 }
