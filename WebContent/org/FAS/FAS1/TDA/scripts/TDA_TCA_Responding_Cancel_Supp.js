...
{   
         ...
         url="../../../../../TDA_TCA_Responding_Cancel_Supp?command=loadVr&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&supNo="+supNo; 
...
function loadVoucherDetails()
{
	     ...
	     url="../../../../../TDA_TCA_Responding_Cancel?command=loadVrDetails&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&originated_slno="+originated_slno+"&supNo="+supNo; 
	     req=getTransport();
	     req.open("GET",url,true);        
	     req.onreadystatechange=function()
	     {        	  
