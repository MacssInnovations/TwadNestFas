...
function doFunction_voucher(param)
{
		 ...
		 if(param=="load_voucher_no")
			 	url="../../../../../Post_TDA_Create?command=load_voucher_no&txtUnitId="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date;
		 else
		 {	
			 	var voucher_no=document.getElementById("txtVoucher_No").value;
			 	url="../../../../../Post_TDA_Create?command=load_Voucher_Details&txtUnitId="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&voucher_no="+voucher_no;
		 }	 	
		 req=getTransport();
	     req.open("GET",url,true);        
	     req.onreadystatechange=function()
		 ...
		 if(req.readyState==4)
		 {
                ...
                {  
                       ...
                       else if(Command=="load_Voucher_Details")
                       {
	                    	   if(flag=="success")
	                	   	   {
                                                           amt=baseResponse.getElementsByTagName("amt")[0].firstChild.nodeValue;
	                	   		   	   ...
	                	   		   	   for(var k=0;k<head_code.length;k++)
	                                   {
				              	   		   		...
				              	   		   		if(item12[k]=="null")
				              	   		   			item12[k]="";
		              	   		   		   	    item13[k]=baseResponse.getElementsByTagName("paid_to")[k].firstChild.nodeValue;
...
function loadGrid()
{
		 ...
		 for(var i=0;i<item1.length;i++)
		 {
	          ...
	          cell2.appendChild(sl_amt);
                  if(item1[i]!=900108)
                    var currentText=document.createTextNode(amt);
                  else
	          ...
	          {	        	
	        	  ...
	        	  //     doFunction('Load_MasterSL_Code',item6[i]);
	        	       ...
	        	       document.getElementById("txtPaidTo").value=item13[i];
...
function clrForm(param)
{
        ...
        document.getElementById("txtUnitId").value="";
        document.getElementById("txtUnitId1").value="";       
