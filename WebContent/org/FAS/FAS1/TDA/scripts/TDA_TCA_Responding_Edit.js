...
{   
		 ...
		 {
        	    url="../../../../../TDA_TCA_Responding_Edit?command=loadVoucher&Option=Edit&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type;           			  
		 }
		 else if(command=="load_Voucher_Details") 
		 {
			    var responded_slno=document.getElementById("responded_slno").value;
			    url="../../../../../TDA_TCA_Responding_Edit?command=loadVoucherDetails&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCrea_date="+txtCrea_date+"&Journal_type="+Journal_type+"&responded_slno="+responded_slno;           			  
		 }
         req=getTransport();
