...
{   
         ...
         url="../../../../../TDA_TCA_Responding_Create?command=loadVoucher_SJV&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&type2="+type2+"&reptype="+reptype+"&supNo="+supNo;
     //alert(url);
         req=getTransport();
         req.open("GET",url,true);        
         req.onreadystatechange=function()
