...
//        	cmbJournal_type="TCAR";
        ...
        {   
          ...
          document.frmBankPay_FinalBill.paghide.value="searchByMonth";
		           ...
		           if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
		           {
		        	   		...
		        	   		var url="../../../../../TDA_TCA_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
			                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&journal_type="+cmbJournal_type+"&txtCreat_By_Module="+txtCreat_By_Module+"&hid="+hid;			                
      ...
      document.frmBankPay_FinalBill.paghide.value="searchByDate";
		           ...
		           {
			                var url="../../../../../TDA_TCA_List?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
			                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
			                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbStatus="+cmbStatus+"&journal_type="+cmbJournal_type+"&txtCreat_By_Module="+txtCreat_By_Module;
			                var req=getTransport();
			                req.open("GET",url,true); 
			                req.onreadystatechange=function()
			                {
                        ...
                        for(i=p;i<service.length&& c<__pagination;i++)
                                    {
                                                ...
                                                items[1]=service[i].getElementsByTagName("tda_tca")[0].firstChild.nodeValue;
                                                items[2]=service[i].getElementsByTagName("vou_date")[0].firstChild.nodeValue;
                                                items[3]=service[i].getElementsByTagName("unitName")[0].firstChild.nodeValue;
