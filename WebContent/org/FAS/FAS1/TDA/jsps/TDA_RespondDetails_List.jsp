...
%>
  ...
  <%
          ...
          try{
        	  jvr_date=request.getParameter("trf_date");
       }catch(Exception e){System.out.println("Exception in getting req:"+e);}
          System.out.println("jvr_date===>"+jvr_date);
          ...
          <%
		          ...
		          try
		          {
			 	        ...
			 	        String sql="SELECT t.SL_NO, "+
			 	        	  ...
			 	        	  " AND SL_CODE  =t.SUB_LEDGER_CODE "+
			 	        	  " )AS SLNAME, "+
			 	        	 "  trim(TO_CHAR(t.AMOUNT,'99999999999999.99')) AS AMOUNT, "+
			 	        	  " t.PARTICULARS "+
			 	        	" FROM FAS_TDA_TCA_RAISED_TRN t,fas_tda_tca_raised_mst m  "+
			 	        	...
			 	        	" and t.VOUCHER_NO= "+vou_no+
			 	        	" and m.TRF_ACCOUNTING_UNIT_ID= "+cmbAcc_UnitCode+
			 	       /*  	" and extract(year from m.RESPONDING_JVR_DATE) = "+yr+
			 	        	" and extract(month from m.RESPONDING_JVR_DATE) ="+mon; */
			 	       	" and extract(year from m.VOUCHER_DATE) = "+yr+
		 	        	" and extract(month from m.VOUCHER_DATE) ="+mon+
			 	        	" And To_Char(M.Responding_Jvr_Date,'dd/mm/yyyy')  = '"+jvr_date+"'";
