...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/TDA_TCA_Acceptance_Create.js"></script>
...
%>
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_TCA_Acceptance_Create?Command=Add" onsubmit="return checkNull()">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtCrea_date" id="txtCrea_date" 
                               ...
                               onblur="accDate();call_date(this);dateCheck(this);" />
                  ...
                  <div id="sub_ledge_dis" >
                    <table cellspacing="1" cellpadding="2" border="1"
			             ...
			             <tr class="table">
                                   ...
                                   <td>
                                     <div align="left">
                                       <input type="text" name="txtAcc_HeadCode" onblur="doFunction('checkCode','null');" onchange="checkAccHead();sixdigit();"
