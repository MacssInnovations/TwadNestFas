...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA Responding System(Supplement)</title>
    ...
    <script type="text/javascript" src="../scripts/TDA_TCA_Responding_Edit_Supp.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Transfer of Debit/Credit Advice (TDA/TCA) Responding System(Supplement)</font>
          </div>
        </td>
      </tr>
    </table>
