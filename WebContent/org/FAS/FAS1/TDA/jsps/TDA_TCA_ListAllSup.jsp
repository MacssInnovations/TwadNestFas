...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA System(Sup)</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/TDA_TCA_ListAll.js"></script>
...
%>
  ...
  <form name="frmBankPay_FinalBill" method="POST">
   ...
   <input type="hidden" id="hid" name="hid" value="sup">
     <input type="hidden" id="txtFrom_date" name="txtFrom_date" value="">
       <input type="hidden" id="txtTo_date" name="txtTo_date" value="">
