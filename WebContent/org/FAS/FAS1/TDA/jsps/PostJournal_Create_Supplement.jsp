...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Post Journal System(Supplement)</title>
    ...
    <script type="text/javascript" src="../scripts/PostJournal_Create_Supplement.js"></script>
  ...
  %>
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS');loadDate();call_clr();Check_Supplement_No();checkSuppTB();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Post Journal(Supplement)</font>
          </div>
        </td>
      </tr>
    </table>
   
  <form name="Post_Journal" id="Post_Journal" method="post" 
  action="../../../../../PostJournal_Create_Supplement?Command=Add" onsubmit="return checkNull();">
    <div align="center">
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
	          ...
	          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3" readonly="readonly"  maxlength="4" size="5" onkeypress="return numbersonly(event)">
