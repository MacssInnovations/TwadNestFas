...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
 ...
 <link href="../../../../../css/Sample3.css" rel="stylesheet"  media="screen"/>
    ...
    <script type="text/javascript" src="../scripts/TDA_TCA_Responding_Cancel_Supp.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function loadDate()
        {
              ...
              //   document.TDA_TCA_CANCEL.txtCrea_date.value=day+"/"+month+"/"+year;  
                 document.TDA_TCA_CANCEL.txtCB_Year.value=year;           
...
%>
<body onload="loadDate();LoadAccountingUnitID('LIST_ALL_UNITS');clrForm('load');Check_Supplement_No();" bgcolor="rgb(255,255,225)">
   <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Transfer of Debit/Credit Advice (TDA/TCA) Responding System Cancel</font>
          </div>
        </td>
      </tr>
    </table>
    <form name="TDA_TCA_CANCEL" id="TDA_TCA_CANCEL" method="POST"
                  action="../../../../../TDA_TCA_Responding_Cancel_Supp?Command=Add" onsubmit="return checkNull()">
        <div align="center">
                ...
                <td>
                  <div align="left">
                    <select name="originated_slno" id="originated_slno" onchange="changeLink();loadVoucherDetails();">
                    	...
                    	</select> <a id="linkId" href="javascript:ShowDetails('originated_slno');" style="visibility:hidden">Voucher Details</a>
                    </select>
                  </div>
                </td>
              </tr>
                    ...
                    <td>
                      <div align="left">
                        ...
                        <img src="../../../../../images/calendr3.gif"
                             onclick="showCalendarControl(document.TDA_TCA_CANCEL.txtCrea_date,1);"
