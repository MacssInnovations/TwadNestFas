...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/ManyEmployee_One_units.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        {     
           ...
           // alert("enter into Check null");          
                ...
                {
        	            alert("Select Reason for TDA in General");
        	            return false;    
                }
  ...
  %>
  <body onload="clrForm('load');LoadAccountingUnitID('LIST_ALL_UNITS');loadDate();">
  ...
  <form name="TCA_POST" id="TCA_POST" method="POST"
                  action="../../../../../ManyEmployee_One_units?Command=Add" onsubmit="return checkNull()">
        ...
        <div class="tab-page">
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
                <td><div align="left">Doc.Type <font color="#ff2121">*</font> </div>
                  </td>
                <td><div align="left" id="since2007">
                    <select name="cmbDocType"  id="cmbDocType" onchange="setAccHdCode();doFunction_voucher('load_voucher_no');">
              ...
              <tr class="table">
			      ...
			      <td>
			          <div align="left">
			              <select name="txtVoucher_No" id="txtVoucher_No" tabindex="5" onchange="doFunction_voucher('load_Voucher_Details');loadName_Mas(this);">
             ...
             <tr class="table">
                ...
                <td width="60%">
                  <div align="left">
                    <select  name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="6" readonly>
              ...
              <tr class="table">
                ...
                <td width="60%">
                    <table align="left">
                     <tr align="left">
                     <td>
                        <select size="1" name="cmbMas_SL_Code" id="cmbMas_SL_Code" readonly>
                          <option value="">--Select Code--</option>
                        </select>
                        <input type="hidden" name="sl_offCode" id="sl_offCode" >
                      </td>
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
			                  ...
			                  <div align="left">
			                    <input type="text" name="txtAcc_HeadCode" 
			                           id="txtAcc_HeadCode" maxlength="6" onkeypress="return numbersonly(event)"
				                        onblur="checkAccHead();" onchange="sixdigit();" size="9"/>
             ...
             <tr class="table">
                ...
                <td width="60%">
                  <div align="left">
                   <select size="1" name="cmbSL_type" id="cmbSL_type" onchange="OfficeCheck(this.value);">
                      <option value="">--Select Type--</option>
