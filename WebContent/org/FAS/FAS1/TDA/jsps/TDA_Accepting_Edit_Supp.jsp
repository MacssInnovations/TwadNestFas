...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/TDA_Accepting_Edit_Supp.js"></script>
...
%>
  ...
  %>
  <body onload="clrForm('load');loadDate();LoadAccountingUnitID('LIST_ALL_UNITS');doFunction('checkCode','null');Check_Supplement_No();" bgcolor="rgb(255,255,225)">
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_Accepting_Edit_Supp?Command=Edit" onsubmit="return checkNull()">
