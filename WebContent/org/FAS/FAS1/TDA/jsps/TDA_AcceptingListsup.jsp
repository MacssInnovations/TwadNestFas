...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA Accepting List</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/TDA_AcceptingList.js"></script>
    ...
    function loadyear_month()
    {
	        ...
	        document.tda_accepting_list.txtCB_Year.value=year;
	        document.tda_accepting_list.txtCB_Month.value=month;
	       // document.tda_accepting_list.txtFrom_date.value="01/04/2010";
	       // document.tda_accepting_list.txtTo_date.value=day+"/"+month+"/"+year;
	        
    }
    </script>
</head>
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');" >
  <form name="tda_accepting_list" method="POST">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>TDA/TCA Accepting List</strong>
          </div>
        </td>
      </tr>
    </table>
                ...
                <td>
                  <div align="left">
                    <select name="cmbJournal_type" id="cmbJournal_type" onchange="showGrid()">
                      ...
                      <option value="63A">TDA - Pending For Acceptance</option>
                      <option value="63B">TDA - Accepted Against a Month</option>
                      <option value="63C">TDA - Accepted During The Month</option>
                      
                      <option value="66A">TCA - Pending For Acceptance</option>
                      <option value="66B">TCA - Accepted Against a Month</option>
                      <option value="66C">TCA - Accepted During The Month</option>
                       </select>                                           
                  </div>
                </td>
              </tr>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.tda_accepting_list.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.tda_accepting_list.txtTo_date);"
                         alt="Show Calendar"></img>
