...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/TDA_Raised_Cancel.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Originated Sl.No.Transfer of Debit/Credit Advice (TDA/TCA) System</font>
          </div>
        </td>
      </tr>
    </table>
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_Raised_Cancel?Command=Cancel" onsubmit="return checkNull()">
