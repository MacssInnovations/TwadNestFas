...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA List Through Payment</title>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of TDA Through Payment</strong>
          </div>
        </td>
      </tr>
    </table>
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <input type="hidden" name="txtJournal_type" id="txtJournal_type" value="TDAO"></input>
                  </div>
                </td>
              </tr>                           
        </table>
