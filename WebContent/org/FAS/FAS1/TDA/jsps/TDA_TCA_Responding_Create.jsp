...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/TDA_TCA_Responding_Create.js"></script>
...
%>
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_TCA_Responding_Create?Command=Add" onsubmit="return checkNull()">
        <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             ...
             <tr class="table">
              ...
              <tr class="table">
                   ...
                   <td>
                     <div align="left">
                       <input type="text" name="accepted_jvr_date" id="accepted_jvr_date" readonly size=10 />                   
                     </div> 
                   </td>
              </tr>  
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtCrea_date" id="txtCrea_date" 
                               ...
                               onblur="accDate();return call_date(this);dateCheck(this);"/>
