...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA System Edit(Supplement)</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function loadDate()
        {
                ...
                // document.TDA_TCA_one.txtCrea_date.value="31/03/2012";       
                
                document.TDA_TCA_one.txtCrea_date.value="31"+"/"+"03"+"/"+year;  
            
                 //document.TDA_TCA_one.txtCB_Year.value=year;               
        }
        function checkNull()
        {               
		...
		<tr align="left" class="table">
            ...
            <td>
			  ...
			  <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="radio" name=Journal_type_one id=Journal_type_one value="TDAO" onclick="doFunction_TDA('load_Vr_No')"></input> TDA Originating
                        <input type="radio" name=Journal_type_one id=Journal_type_one value="TCAO" onclick="doFunction_TDA('load_Vr_No')"></input> TCA Originating
                      </div>
                    </td>
              </tr>
               ...
               <tr class="table">
			      ...
			      <td>
			          <div align="left">
			              <select name="originated_slno" id="originated_slno" tabindex="5" onchange="doFunction_TDA('load_Vr_Details')">
