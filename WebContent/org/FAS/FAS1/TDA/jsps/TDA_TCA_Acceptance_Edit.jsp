...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA Accepting System</title>
    ...
    <script type="text/javascript" src="../scripts/TDA_TCA_Acceptance_Edit.js"></script>
...
%>
  ...
  %>
  <body onload="clrForm('load');loadDate();LoadAccountingUnitID('LIST_ALL_UNITS');doFunction('checkCode','null');" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Transfer of Debit/Credit Advice (TDA/TCA) Accepting System</font>
          </div>
        </td>
      </tr>
    </table>
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_TCA_Acceptance_Edit?Command=Edit" onsubmit="return checkNull()">
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             ...
             <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select name="accepted_slno" id="accepted_slno" onchange="changeLink();doFunction_TDA('load_Voucher_Details')">  
                    	<option value="">Select Voucher</option>   
                    </select> 
                     <a id="linkId" href="javascript:checkVoucherNo();" style="visibility:hidden">Advice Details</a>             	
                  </div>
                </td>
              </tr>      
