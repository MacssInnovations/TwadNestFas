...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/TDA_Raised_Create.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function loadDate()
        {
                 ...
                 call_date(document.TDA_TCA.txtCrea_date);          
        }
        function checkNull()
        {               
                ...
                if(tbody.rows.length>0)
                {
                        ...
                        for(i=0;i<rows.length;i++)
                        {
                                    ...
                                    {
                                    		alert("dr-->bf"+parseFloat(dr_check_amt))
                                    		alert("dr2-->bf"+parseFloat(cells.item(5).lastChild.nodeValue).toFixed(2))
                                            dr_check_amt=(parseFloat(dr_check_amt) + parseFloat(cells.item(5).lastChild.nodeValue)).toFixed(2);
                                            ...
                                            if(cells.item(3).lastChild.nodeValue=="")
                                            	{
                                            	 alert("Select The Sub Ledger Type in Details");
                        			             document.getElementById("butSub").disabled=true;
                        			             return false;
                                            	}
                                            if(cells.item(4).lastChild.nodeValue=="")
                                        	{
                                            	alert("Select The Sub Ledger Code in Details");
                       			             document.getElementById("butSub").disabled=true;
                       			             return false;
                                        	}
                                    ...
                                    {
                                            cr_check_amt=(parseFloat(cr_check_amt) + parseFloat(cells.item(5).lastChild.nodeValue)).toFixed(2);     
                                            alert(cr_check_amt);
                                            ...
                                            if(cells.item(3).lastChild.nodeValue=="" && cells.item(1).firstChild.value!=220401)
                                        	{
                                        	 alert("Select The Sub Ledger Type in Details");
                    			             document.getElementById("butSub").disabled=true;
                    			             return false;
                                        	}
                                        if(cells.item(4).lastChild.nodeValue=="" && cells.item(1).firstChild.value!=220401)
                                    	{
                                        	alert("Select The Sub Ledger Code in Details");
                   			             document.getElementById("butSub").disabled=true;
                   			             return false;
                        ...
                        else if(cr_check_amt!=parseFloat(document.getElementById("txtTotalAmt").value).toFixed(2))
                        {
...
%>
  ...
  %>
  <body onload="clrForm('load');LoadAccountingUnitID('LIST_ALL_UNITS');setTimeout('loadDate()', 300);setTimeout('loadTransferUnit()',500);doFunction('checkCode','null');" bgcolor="rgb(255,255,225)">
  ...
  <form name="TDA_TCA" id="TDA_TCA" method="POST"
                  action="../../../../../TDA_Raised_Create?Command=Add" onsubmit="return checkNull()">
                  ...
                  <div id="sub_ledge_dis" >
                    <table cellspacing="1" cellpadding="2" border="1"
			             ...
			             <tr class="table">
                                            ...
                                            <td>
                                              <div align="left">
                                                <input type="text" name="txtAcc_HeadCode" onchange="checkAccHead();sixdigit();"
