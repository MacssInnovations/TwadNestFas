...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TCA List Through Payment</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/Post_TDA_ListAll.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of TCA Through Receipt</strong>
          </div>
        </td>
      </tr>
    </table>
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <input type="hidden" name="txtJournal_type" id="txtJournal_type" value="TCACB_receipt"></input>
                  </div>
                </td>
              </tr>                           
        </table>
         ...
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
           ...
           <th>
            ...
            <th>       	
            Payment /Receipt Voucher Number.
            	
            </th>            
            <th>
            Payment / Receipt Voucher Date.
            </th>
          </tr>
