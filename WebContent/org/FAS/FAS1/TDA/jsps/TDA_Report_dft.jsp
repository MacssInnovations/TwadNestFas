...
<title>TDA(Defunct) Report</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <script type="text/javascript"
      ...
      <script language="javascript" type="text/javascript" src="../scripts/TDA_Report.js"></script>
    <script type="text/javascript" language="javascript">
            ...
            {       
                ...
                document.TDA_Report_dft.txtCB_Year.value=year;
                document.TDA_Report_dft.txtCB_Month.value=month;        
            }
             function ChooseReptype(id)
             {
                 ...
                 if(document.TDA_Report_dft.reporttype[0].checked==true)
                 {
                	     dispsupnochosen1.style.display="none";
                         dispsupnochosen2.style.display="none";
                 }
                 else if(document.TDA_Report_dft.reporttype[1].checked==true)
                 {
             ...
             function dispsuppno()
             {
                 ...
                 {
                	 dispsupnochosen3.style.display="block";
                	 document.TDA_Report_dft.reporttype[0].checked=true;
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">TDA(Defunct) Report</font>
          </div>
        </td>
      </tr>
</table>
<%
  ...
  <% 
         ...
         %>
<form name="TDA_Report_dft" method="POST" action="../../../../../TDA_Report" onsubmit="return nullcheck()">
<div align="center">
        ...
        <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    Adjust Memo Advice No.
                  </div>
                </td>
                <td>
                  <div align="left" >
                      <select name="txtAdvice_No" id="txtAdvice_No">
