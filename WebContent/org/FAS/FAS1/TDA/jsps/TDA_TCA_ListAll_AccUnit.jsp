   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <link href="../../../../../css/Sample3.css" rel="stylesheet"
          ...
          function callDetails()
          {
          		...
          		var ddd=document.getElementById("hidden_text1").value;
          		
          		if(ddd=="accepted_slno"||ddd=="originated_slno")
          		{
              		document.getElementById("advice_id").style.display="block";
              		document.getElementById("voucher_id").style.display="none";
          		}
          		else
          		{
          			document.getElementById("advice_id").style.display="none";
              		document.getElementById("voucher_id").style.display="block";
          		}
          }
...
%>
  <body class="table" onload="callDetails();">
  ...
  <%
       ...
       }catch(Exception e){System.out.println("Exception in getting param:"+e);}
  ...
  %>
     ...
     <div align="center" id="advice_id" style="display:none">
      <table cellspacing="3" cellpadding="2"  width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Advice Details</strong>
            </div>
          </td>
          ...
          <%
		          ...
		          try
		          {
			 	        ...
			 	        String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
						            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME,PAID_TO,trim(to_char(AMOUNT,'99999999999999.99')) as AMOUNT,CHEQUE_DD_NO ,to_char(CHEQUE_DD_DATE,'DD/MM/YYYY') as CHE_DD_DATE "+
						            ",BANK_ID,BRANCH_ID from FAS_TDA_TCA_RAISED_TRN where CASHBOOK_YEAR="+yr+" and CASHBOOK_MONTH="+mon+" and  VOUCHER_NO="+vou_no;
                                       ...
                                       /* if(rs2.getInt("SUB_LEDGER_TYPE_CODE")==15)
                                           {
                                                   ...
                                                   if(rs.next())
                                                   {
                                                          // xml=xml+"<desc_type>"+rs4.getString("BENEFICIARY_NAME")+"</desc_type>"; 
                                                           out.println("<td align='left'>"+rs.getString("ACCOUNTING_UNIT_NAME")+"</td>");
                                                   }else{
