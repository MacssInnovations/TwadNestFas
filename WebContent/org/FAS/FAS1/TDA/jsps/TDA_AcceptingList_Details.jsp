...
<title>TDA Pending Details</title>
...
<body class="table">
<form name="tda_list_details" method="POST">
<%
		  Connection con=null;
		  ResultSet rs=null;
          ...
          System.out.println("cmbAcc_UnitCode===>"+cmbAcc_UnitCode+" yr====>"+yr+" mon====>"+mon+" vou_no===>"+vou_no );
  %>
  <table cellspacing="3" cellpadding="2"  width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TDAListDetails</strong>
            </div>
          </td>
        </tr>
      </table>
        ...
        <tbody id="tbody" class="table">
          <%
		          ...
		          try
		          {
			 	        ...
			 	        String sql="select a.*,b.SUB_LEDGER_TYPE_DESC from "+
			 	        	" (SELECT SL_NO,"+
			 	        			 " ACCOUNT_HEAD_CODE ,"+
			 	        			"  CR_DR_INDICATOR ,"+
			 	        			  " SUB_LEDGER_TYPE_CODE ,"+
			 	        			 // " SUB_LEDGER_CODE,"+
			 	        			  " (select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW_M where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SUB_LEDGER_CODE," +
			 	        			  " PAID_TO,"+
			 	        			  " trim(TO_CHAR(AMOUNT,'99999999999999.99')) AS AMOUNT,"+
			 	        			  " PARTICULARS "+
			 	        			" FROM FAS_TDA_TCA_RAISED_TRN"+
			            ...
			            while(rs2.next())
			            {
			               ...
			               if(rs2.getString("SUB_LEDGER_CODE")!=null)
			                {
			            	   //System.out.println("SUB_LEDGER_CODE");
			            	   out.println("<td align='left'>"+rs2.getString("SUB_LEDGER_CODE")+"</td>");
			                }
			                else
			                	    out.println("<td align='left'>"+"   --  "+"</td>");
