...
<title>TDA(Originating) Report</title>
<script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    ...
    <script type="text/javascript" language="javascript">
            ...
            {       
                ...
                document.TDA_Report.txtCB_Year.value=year;
                document.TDA_Report.txtCB_Month.value=month;        
            }
             function ChooseReptype(id)
             {
                 ...
                 if(document.TDA_Report.reporttype[0].checked==true)
                 {
                	     dispsupnochosen1.style.display="none";
                         dispsupnochosen2.style.display="none";
                 }
                 else if(document.TDA_Report.reporttype[1].checked==true)
                 {
             ...
             function dispsuppno()
             {
                 ...
                 {
                	 dispsupnochosen3.style.display="block";
                	 document.TDA_Report.reporttype[0].checked=true;
...
<table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">TDA(Originating) Report</font>
          </div>
        </td>
      </tr>
</table>
<%
  ...
  <% 
         ...
         %>
<form name="TDA_Report" method="POST" action="../../../../../TDA_Report" onsubmit="return nullcheck()">
<div align="center">
