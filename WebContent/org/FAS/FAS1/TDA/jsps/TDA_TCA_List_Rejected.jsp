...
<head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA Rejected</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/TDA_TCA_List_Rejected_js.js"></script>
    ...
    function loadyear_month()
    {
	        ...
	        document.list_rejected.txtCB_Year.value=year;
	        document.list_rejected.txtCB_Month.value=month;
	      //  document.list_rejected.txtFrom_date.value="01/04/2010";
	       
	      //  document.list_rejected.txtTo_date.value=day+"/"+month+"/"+year;
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');" >
  <form name="list_rejected" method="POST">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of TDA/TCA Rejected</strong>
          </div>
        </td>
      </tr>
    </table>
                ...
                <td>
                  <div align="left">
                    <select name="cmbJournal_type" id="cmbJournal_type" >
                      ...
                      <option value="62A">TDA Originated by You and Rejected by Others</option>
                      <option value="62B">TCA Originated by You and Rejected by Others</option>
                      <option value="63A">TDA Originated by Others and  Rejected by You</option>
                       <option value="63B">TCA Originated by Others and  Rejected by You</option>
                     </select>                                           
                  </div>
                </td>
              </tr>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.list_rejected.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.list_rejected.txtTo_date);"
                         alt="Show Calendar"></img>
