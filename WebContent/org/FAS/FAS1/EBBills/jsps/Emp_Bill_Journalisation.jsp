              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                   ...
                   <%      ps=con.prepareStatement("select JOURNAL_TYPE_CODE,JOURNAL_TYPE_DESC   from FAS_MST_JOURNAL_TYPE ");
                ...
                <table >
                 <tr>
                    ...
                    <input type="button" name="cmdList" value="LIST" id="cmdList" onclick="ListHeads()" tabindex="60"/>
                       ...
                       <td>
                     <input type="button" id="Exit" name="Exit" value="EXIT" onclick="self.close();" tabindex="70"/>
                     </td>
                 </tr>
