...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EB_Energy_Quota_Details.js"></script>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/CalendarControl.js"></script>
         ...
         <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/checkDate.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">EB Energy Quota Details</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="eb_energy" id="eb_energy" >
      <%
  ...
  %>
   ...
   %>
                ...
                <td>
                  ...
                  <%
                   ps=con.prepareStatement("select SERVICE_NO from FAS_EB_METER_MASTER where ACCOUNTING_UNIT_ID=? and ACCOUNTING_FOR_OFFICE_ID=?");
                        ...
                        <select  name="seviceno" id="serviceno" >
                  <%      while(rs.next())
                        {
                ...
                <td>
                  <div align="left">
                   <input type="text" name="billdate"  id="billdate"  size="11" /> 
                    <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.eb_energy.billdate);"  alt="Show Calendar"></img>
          ...
          <option value="12">December</option>
              ...
              <tr class="table">
                <td>
                  <div align="left">EPK_Units_Time</div>
                </td>
                <td>
                  <div align="left">
                    <input type="text" name="unitstime"  id="unitstime"   />
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                <td>
                  <div align="left">EPK_Units_Quota Fixed</div>
                </td>
                <td>
                  <div align="left">
                    <input type="text" name="unitsquotafixed"  id="unitsquotafixed" onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">EPK_Units_Excess_Over_Quota</div>
                </td>
                <td>
                  <div align="left">
                    <input type="text" name="unitsquotaexcess"  id="unitsquotaexcess" onkeypress="return filter_real(event,this,5,2)" /> 
              ...
              <tr class="table">
                <td>
                  <div align="left">EPD_KVA_Time </div>
                </td>
                <td>
                 <div align="left">
                     <input type="text" name="kvatime"  id="kvatime" />   
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                <td>
                  <div align="left">EPD_Units_Quota Fixed</div>
                </td>
                <td>
                  <div align="left">
                       <input type="text" name="epdunitsfixed"  id="epdunitsfixed" onkeypress="return filter_real(event,this,5,2)" /> 
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">EPD_Units_Excess_Over_Quota</div>
                </td>
                <td>
                  <div align="left">
                     <input type="text" name="epdunitsexcess"  id="epdunitsexcess" onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
