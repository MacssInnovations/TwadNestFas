...
<html>
  <head>
    ...
    <title>EB Bill & Consumption Work Sheet Details</title>
    ...
    <script type="text/javascript" src="../scripts/EB_Consumption_Worksheet.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">EB Bill & Consumption Work Sheet Details</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="eb_bill_worksheet" id="eb_bill_worksheet">
      <%
   ...
   %>
      <div class="tab-pane" id="tab-pane-1">
        <div class="tab-page">
                ...
                <td>
                  <div align="left">
                   <input type="text" name="billdate"  id="billdate"  size="11" /> 
                    <img src="../../../../../images/calendr3.gif" onclick="showCalendarControl(document.eb_bill_worksheet.billdate);"  alt="Show Calendar"></img>
          ...
          <option value="12">December</option>
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                   <input type="text" name="circlecode"  id="circlecode" size="11" /> 
              ...
              <tr class="table">
               ...
               Power Cut ?
                ...
                <td>
                  <div align="left">
                  <input type="radio" name="powercut" id="powercut"  checked="checked" value="Y"/>Yes
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="powercut" value="N"/>No &nbsp;&nbsp;&nbsp;&nbsp;   
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">
                  Net Consumption (Normal)
                  </div>
                </td>
                <td>
                  <div align="left">
                     <input type="text" name="netnormal"  id="netnormal" onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">
                  Net Consumption (Peak)
                  </div>
                </td>
                <td>
                  <div align="left">
                     <input type="text" name="netpeak"  id="netpeak" onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">
                 Net Consumption (Off-Peak)
                  </div>
                </td>
                <td>
                  <div align="left">
                    <input type="text" name="netoffpeak"  id="netoffpeak" onblur="netconscalulate()" onkeypress="return filter_real(event,this,5,2)"  />
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                <td>
                  <div align="left">
               Net Consumption (Total)
                  </div>
                </td>
                <td>
                  <div align="left">
                     <input type="text" name="nettotal"  id="nettotal" disabled="disabled" onkeypress="return filter_real(event,this,5,2)"  />
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
               ...
               KVAH
                ...
                <td>
                  <div align="left">
                     <input type="text" name="kvah"  id="kvah"  onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
              ...
              RKAH
                ...
                <td>
                  <div align="left">
                     <input type="text" name="rkah"  id="rkah" onkeypress="return filter_real(event,this,5,2)" />
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
               ...
               Power Factor
                ...
                <td>
                  <div align="left">
                     <input type="text" name="powerfactor"  id="powerfactor" onkeypress="return filter_real(event,this,5,2)"  />
                  </div>
                </td>
              </tr>
        ...
        <div class="tab-page" id="gd" >
          <h2 class="tab" >Work Sheet Details</h2>
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              <tr>
                  ...
                  <div id="sub_ledge_dis" >
                    <table cellspacing="1" cellpadding="2" border="1"
                      ...
                      <tr class="tdTitle">
                        <td colspan="2">
                          <div align="left">
                            <strong>Work Sheet Details</strong>
                          </div>
                        </td>
                      </tr>
               ...
               <tr class="table">
                <td >
                  <div align="left">Consumption Description</div>
                </td>
                <td>
                  <div align="left">
                                                        
                    <textarea name="consdesc" id="consdesc" cols="50" tabindex="7" onkeypress="return check_leng(this.value);"
                              rows="4"></textarea>
                  </div>
                </td>
              </tr>
                        ...
                        <td>
                          <div align="left">
                            <input type="text" name="normal" maxlength="8" onkeypress="return filter_real(event,this,5,2)" id="normal" size="11" />
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            <input type="text" name="peak"  onkeypress="return filter_real(event,this,5,2)" id="peak"  size="11"/>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            <input type="text" name="offpeak" maxlength="8"  id="offpeak" onkeypress="return filter_real(event,this,5,2)" size="11" onblur="valuecalulate()" />
                          </div>
                        </td>
                      </tr>
                       ...
                       <tr class="table">
                        ...
                        <td>
                          <div align="left">
                            <input type="text" name="netconstot"  id="netconstot" size="11" disabled="disabled"/>
                          </div>
                        </td>
                      </tr>
