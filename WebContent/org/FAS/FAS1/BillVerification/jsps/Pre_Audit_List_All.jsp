...
<script src="../scripts/Pre_Audit_List_All.js"	type="text/javascript"> </script>
...
function loadyear_month()
{
       ...
       document.frmpreAudit_list.txtCB_Year.value=year;
       document.frmpreAudit_list.txtCB_Month.value=month1;
}
</script>
</head>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Pre-Audit Details List</font></div>
		</td>
	</tr>
</table>
<form name="frmpreAudit_list" id="frmpreAudit_list" method="POST" >
