...
{   
        ...
        else
        {
                ...
                var url="../../../../../Pre_Audit_List_All?Command=searchByMonth&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&optionId="+optionId;			                
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
                             ...
                             items[4]=service[i].getElementsByTagName("BILL_AMOUNT")[0].firstChild.nodeValue;
                             items[5]=service[i].getElementsByTagName("checkDesc")[0].firstChild.nodeValue;
                             
                             items[6]=service[i].getElementsByTagName("PRE_AUDIT_DATE")[0].firstChild.nodeValue;
                             items[7]=service[i].getElementsByTagName("PRE_AUDIT_BY")[0].firstChild.nodeValue;
                             items[8]=service[i].getElementsByTagName("MajorDesc")[0].firstChild.nodeValue;
                             items[9]=service[i].getElementsByTagName("MinorDesc")[0].firstChild.nodeValue;
                             items[10]=service[i].getElementsByTagName("SubDesc")[0].firstChild.nodeValue;
