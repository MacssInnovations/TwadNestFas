...
{  
        ...
        {             
		           if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
		           {
		        	   		...
		        	   		//alert("haiiiiii");
			                var url="../../../../../TDA_Responding_List_supp?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
			                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&active="+radActive+"&txtCreat_By_Module="+txtCreat_By_Module+"&supNo="+supNo;
			               // alert("haiiiiii=====>"+url);
        ...
        {  
           ...
           var txtTo_date=document.getElementById("txtTo_date").value;
		           ...
		           {
			                var url="../../../../../TDA_Responding_List_supp?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
			                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+
			                txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbStatus="+cmbStatus+"&active="+radActive+"&txtCreat_By_Module="+txtCreat_By_Module+"&supNo="+supNo;
			                var req=getTransport();
			                req.open("GET",url,true); 
			                req.onreadystatechange=function()
			                {
...
//        	
	               ...
	               var tbod=document.getElementById("tbody1");
//	           	alert(tbod.rows.length);
	           	var h=0;
	           
	           		for (h = tbod.rows.length - 1; h >= 0; h--)
	           		{
	           		tbod.deleteRow(0);
	           		}
        			  ...
        			  if(document.forms[0].radActive.value=="tdaPending" || document.forms[0].radActive.value=="tcaPending")
        			   ...
        			   document.getElementById("clearedDiv").style.display="none";
    	         	   document.getElementById("pendingDiv").style.display="block";
	                        ...
	                        var url="javascript:Show('"+Ucode+"','"+Offid+"','"+txtCB_Year+"','"+txtCB_Month+"','"+items[0]+"','"+items[6]+"')";
	                        anc.href=url;
