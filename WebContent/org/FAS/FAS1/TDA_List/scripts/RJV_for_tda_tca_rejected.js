	              ...
	              for(var i=0; i<service.length;i++)
	               {
		                        ...
		                        var mycurrent_row=document.createElement("TR");                
                                       ...
                                       {
                                        chcksel=document.createElement("<input type='checkbox' name='chckparameter' id='chckparameter' onclick=chk("+seq+") value='"+checkparam+"' />");
                                       }
                                       else
                                       {
                                             ...
                                             // chcksel.checked='checked';
                                              ...
                                              chcksel.setAttribute('onclick','chk('+seq+')');
                                       }
...
function selectAll(Opt)
{
  ...
  //alert("cmoing hereeeeeeeeeee");
	var len=  document.getElementById("tbody").rows.length;
//alert("length of row::::::::"+len);
  if(len==1)
  {
          if (Opt =="ALL")
          {
