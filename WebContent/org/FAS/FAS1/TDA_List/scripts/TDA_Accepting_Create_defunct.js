...
//    	 
//    	 }
	       url="../../../../../TDA_TCA_Acceptance_Create?command=load_Vno_dft&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&type1="+type1;
...
//	     url="../../../../../TDA_TCA_Acceptance_Create?command=loadVoucher_Details&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&originated_slno="+originated_slno+"&type1="+type1+"&reptype="+reptype+"&supNo="+supNo;
	     url="../../../../../TDA_TCA_Acceptance_Create?command=loadVoucher_Details_dft&cmbAcc_UnitCode="+UnitCode+"&cmbOffice_code="+office_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&Journal_type="+Journal_type+"&originated_slno="+originated_slno+"&type1="+type1;
...
function Acceptance_ServletResponse(req,slcode)
{
		 if(req.readyState==4)
		 {
                ...
                {  
                         ...
                         else if(Command=="loadVoucher_Details")
                         {	                    	   
	                    	   if(flag=="success")
	                           {                                      
