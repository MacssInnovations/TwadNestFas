...
<head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Verify_TDA_TCA_Rejected Supplement</title>
    ...
    function loadDate()
    {
            ...
            // document.list_rejectedVerify.txtFrom_date.value="31/"+"03/"+year;                
    }
    </script>
  </head>
  <%
...
%>
<body class="table" onload="loadDate();setTimeout('Check_Supplement_No()',200);" >
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Verify_TDA_TCA_Rejected Supplement</strong>
          </div>
        </td>
      </tr>
    </table>
         ...
         <tr class="table">
              ...
              <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="hidden" name="txtSupp_No" id="txtSupp_No"  
                    style="background-color: #ececec"  readonly="readonly" size="6" maxlength="5"/>
                  </div>
                  <div align="left">
...
// "      || extract(YEAR FROM now()) " + modified by sathya on 18/02/2016
 ...
 " ON a.id=b.id");
              ...
              <td class="table">
                    <input type="text" name="txtFrom_date" id="txtFrom_date" value="<%=cash_year %>" tabindex="6"
            ...
            <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth" tabindex="8" onclick="doFunction_supp('searchByDate','null')"/>
            </div>
          </td>          
        </tr>                         
        </table>
