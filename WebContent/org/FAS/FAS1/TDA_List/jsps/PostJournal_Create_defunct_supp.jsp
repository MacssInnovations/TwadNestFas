...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Post Journal System Supplement(Defunct)</title>
    ...
    <script type="text/javascript" src="../scripts/PostJournal_Create_defunct_supp.js"></script>
  ...
  <% 
   ...
   %>
  <body onload="loadDate();call_clr();Check_Supplement_No();checkSuppTB();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Post Journal Supplement(Defunct)</font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <div align="center">
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
              ...
              <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <input type="text" name="txtCrea_date" id="txtCrea_date" value="31/03/2017" readonly="readonly"                               maxlength="10" size="11"
