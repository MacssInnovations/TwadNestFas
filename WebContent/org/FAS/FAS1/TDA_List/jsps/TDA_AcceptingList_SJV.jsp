...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TDA_AcceptingList_SJV.js"></script>
    ...
    function loadyear_month()
    {
	   ...
	   //     document.tda_accepting_list.txtCB_Month.value=month;
	    //    document.tda_accepting_list.txtFrom_date.value="01/03/2013";
	   //     document.tda_accepting_list.txtTo_date.value="31/03/2013";
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');Check_Supplement_No();" >
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>TDA Accepting List</strong>
          </div>
        </td>
      </tr>
    </table>
