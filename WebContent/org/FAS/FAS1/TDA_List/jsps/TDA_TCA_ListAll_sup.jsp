...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TDA_TCA_List_sup.js"></script>
    ...
    function loadyear_month()
    {
	        ...
	        if(year < 1900) year += 1900;
                ...
                document.frmBankPay_FinalBill.txtCB_Year.value=year;
	        document.frmBankPay_FinalBill.txtCB_Month.value=month;
	        /*document.frmBankPay_FinalBill.txtFrom_date.value="01/04/2010";
	       ...
	       /* var prev=year-1;
                document.frmBankPay_FinalBill.txtFrom_date.value=day+"/"+month+"/"+prev;
                document.frmBankPay_FinalBill.txtTo_date.value=day+"/"+month+"/"+year;*/
    }
    function loadfirstdayofmonth()
    {
      ...
      if(month_chosen==01||02||03||04||05||06||07||08||09) 
...
%>
  <body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');Check_Supplement_No();" >
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
         ...
         <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select name="cmbJournal_type" id="cmbJournal_type" onchange=showGrid()>
                      <option value="">Select Advice Type</option>
                      <option value="62">TDA Originated By You</option>
                      <option value="63">TDA Originated By You and Accepted By Others</option>
                      <option value="65">TCA Originated By You</option>
                      <option value="66">TCA Originated By You and Accepted By Others</option>
            ...
            <td class="table">
            <div align="left"> Cash Book Year &amp; Month&nbsp;&nbsp;<strong>:</strong><font color="#ff2121">*</font> </div>
            </td>
            <td>
              <div align="left">
              <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event);" onblur="Check_Supplement_No();">
    ...
    <br>
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
           ...
           <input type="hidden" id="paghide" name="paghide" />
           </div>
          </td>
        </tr>
        <!--  <tr align="left">
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_FinalBill.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankPay_FinalBill.txtTo_date);"
                         alt="Show Calendar"></img>
     ...
     <table id="mytable" align="center"  cellspacing="3" 
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
           ...
           <th>
            ...
            <th>    
            	<div id="cc_clmn2">Journal Type</div>        	
            	<div id="cc_clmn">GJV No.</div>
            	
            </th>            
            <th>
            	<div id="cc_clmn1">GJV Date.</div>
            </th>
          </tr>
        ...
        <table id="mytable_one" align="center"  cellspacing="3" 
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
          ...
          <tbody id="tbody_one" class="table">          
          </tbody>
        </table>
        </div>
