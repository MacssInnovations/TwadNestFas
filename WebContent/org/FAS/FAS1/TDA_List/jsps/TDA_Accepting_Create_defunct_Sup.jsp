...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA Accepting System Supplement(Defunct)</title>
    ...
    <script type="text/javascript" src="../scripts/TDA_Accepting_Create_defunct.js"></script>
...
%>
  ...
  <% 
   ...
   %>
  <body onload="clrForm('load');loadDate();doFunction('checkCode','null');checkSuppTB();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">(TDA/TCA) Accepting System Supplement(Defunct)</font>
          </div>
        </td>
      </tr>
    </table>
        ...
        <div class="tab-page">
          ...
          <td>
            <div align="left" id="reguDis" style="display:none">                
                            ...
                            <input type=radio id="reptype" name="reptype" value="InclusiveSJV" onclick="ChooseReptype(this.value);Check_Supplement_No();" >SJV
            ...
            <td>
               <div id="dispsupno2" name="dispsupno2" style="display:none">
                <select name="supNo1" id="supNo1" onclick="loadVoucher();">
             ...
             <tr class="table">
                    ...
                    <td>
                      <div align="left">
                        <!--<input type="text" name="txtCrea_date" id="txtCrea_date" value="31/03/2012"
