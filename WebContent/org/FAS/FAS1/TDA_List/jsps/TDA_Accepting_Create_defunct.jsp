...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA/TCA Accepting System(Defunct)</title>
...
%>
  ...
  <% 
   ...
   %>
  <body onload="clrForm('load');loadDate();doFunction('checkCode','null');" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">(TDA/TCA) Accepting System(Defunct)</font>
          </div>
        </td>
      </tr>
    </table>
