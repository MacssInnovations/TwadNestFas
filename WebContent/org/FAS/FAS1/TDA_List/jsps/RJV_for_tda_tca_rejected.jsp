...
<head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>RJV_for_tda_tca_rejected</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/RJV_for_tda_tca_rejected.js"></script>
...
<body class="table" onload="LoadAccountingUnitID('LIST_ALL_UNITS');" >
  ...
  action="../../../../../TDA_TCA_Verify_List?Command=verify_list" onsubmit="return checkNull_verify()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>RJV_for_tda_tca_rejected</strong>
          </div>
        </td>
      </tr>
    </table>
