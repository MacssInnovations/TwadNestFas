...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>TDA_TCA Verification </title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../org/Library/scripts/checkDate.js"></script>
    <script 
            src="../scripts/TDA_TCA_Verify_List.js"></script>
...
%>
  <body class="table"
        onload="call_clr();loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS')"><form name="frmJournalBillVerify" id="frmJournalBillVerify"
                                                                                          method="POST"
                                                                                          action="../../../../../TDA_TCA_Verify_List?Command=Add"
                                                                                          onsubmit="return checkNull()">
      <table cellspacing="2" cellpadding="3" width="100%" border="0">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TDA_TCA Verification </strong>
            </div>
          </td>
        </tr>
      </table>
      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
             border="0" width="100%">
        <tr class="tdH">
          <th>TDA Advice Number</th>
          <th>TDA Advice Date</th>
