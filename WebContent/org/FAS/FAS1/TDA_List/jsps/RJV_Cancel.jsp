...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/RJV_for_tda_tca_cancel.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.RJVRejected.txtCrea_date.value=day+"/"+month+"/"+year;
        //alert(document.RJVRejected.txtCrea_date.value);
     ...
     {
        //alert("from here");
        if(document.RJVRejected.txtCrea_date.value.length!=0)
        {
           var DOC=document.RJVRejected.txtCrea_date.value;
        ...
        else if(document.RJVRejected.txtCrea_date.value.length==0)
            document.RJVRejected.txtCrea_date.focus();
...
%>
  <body onload="loadDate();foc()" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation of RJV </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="RJVRejected" id="RJVRejected" method="POST"
                  action="../../../../../RJV_Cancel?Command=Cancel" onsubmit="return checkNull_cancel()">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3"
                           ...
                           onblur="call_date(this);doFunction('load_Voucher_No','null');"/>
                     
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.RJVRejected.txtCrea_date,1);"
               ...
               <tr class="table" >
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.RJVRejected.txtCheque_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
