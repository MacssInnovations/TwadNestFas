...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TDA_Responding_List_sjv.js"></script>
              ...
              <tr>
			       ...
			       <!--     <input type="radio" name="radActive" id="radActive" value="Pending" checked>TDA Responding Pending &nbsp;
			            <input type="radio" name="radActive" id="radActive" value="Cleared" >TDA Responding Cleared  -->
                                    <select name="radActive" id="radActive" tabindex="4" >
                                          ...
                                          <option value="tdaCleared">TDA Responding Cleared</option>
                                          <option value="tcaCleared">TCA Responding Cleared</option>
