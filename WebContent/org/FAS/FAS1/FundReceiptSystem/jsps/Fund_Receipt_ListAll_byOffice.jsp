...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Fund_Receipt_ListAll_byOffice.js"></script>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmFund_Receipt_ListAll_byOffice.txtCB_Year.value=year
        document.frmFund_Receipt_ListAll_byOffice.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmFund_Receipt_ListAll_byOffice" method="POST">
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
          <strong>  List of Fund Receipts - By  Region/Circle/Division Voucher </strong>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_ListAll_byOffice.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_ListAll_byOffice.txtTo_date);"
                         alt="Show Calendar"></img>
