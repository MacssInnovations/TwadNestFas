...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Fund Receipts - By Banking Unit(HO)
 </strong>
          </div>
        </td>
      </tr>
         ...
         <tbody id="tbody" class="table">
          <%
           ...
           String sql= "select m.RECEIPT_NO,to_char(m.RECEIPT_DATE,'DD/MM/YYYY') as rec_date," +
                       "trim(to_char(m.TOTAL_AMOUNT,'99999999999999.99')) as TOTAL_AMOUNT ,m.PARTICULARS,m.REF_NO,to_char(m.REF_DATE,'DD/MM/YYYY') as ref_date," +
             ...
             cnt++;
               ...
               // out.println("<td align='left'>"+rs2.getString("REMITTANCE_TYPE")+"</td>");
                ...
                out.println("<td align='left'>"+"---"+"</td>");
                 ...
                 if (rs2.getString("REF_NO")!=null){
                out.println("<td align='left'>"+rs2.getString("REF_NO")+"</td>");
                }
                else
                out.println("<td align='left'>"+"---"+"</td>");
