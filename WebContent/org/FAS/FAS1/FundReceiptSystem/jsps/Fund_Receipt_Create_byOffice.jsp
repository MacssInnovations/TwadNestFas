...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Receipt_Create_byOffice.js"></script>
   <!-- 
    ...
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/CommonControls/scripts/Cheque_Number_Check_FR_byOffice.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmFund_Receipt_Create_byOffice.txtCrea_date.value=day+"/"+month+"/"+year;
        call_date(document.frmFund_Receipt_Create_byOffice.txtCrea_date);
       }
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Receipt System - By Region/Circle/Division (Create) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFund_Receipt_Create_byOffice" id="frmFund_Receipt_Create_byOffice" method="POST"
                  action="../../../../../Fund_Receipt_Create_byOffice.view?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byOffice.txtCrea_date,1);"
              ...
              <%
                    ...
                    String sql_bank="select curr.BANK_ID,curr.BRANCH_ID,curr.BANK_AC_NO,curr.AC_HEAD_CODE,substr(curr.AC_HEAD_CODE,1,4) as main_AHCODE,bk.BANK_NAME || '-' || br.BRANCH_NAME ||'-' || br.CITY_TOWN_NAME as bk_br_city "+
               ...
               <tr class="table" >
                ...
                <td height="35">
                  <div align="left" >
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byOffice.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>                         
              </tr>
              ...
              <%
                    ...
                    String sql_bank_section_HO="select curr.BANK_ID,curr.BRANCH_ID,curr.BANK_AC_NO,curr.AC_HEAD_CODE,bk.BANK_NAME || '-' || br.BRANCH_NAME ||'-' || br.CITY_TOWN_NAME as bk_br_city "+
                    " from FAS_OFFICE_BANK_AC_CURRENT curr,FAS_MST_BANK_BRANCHES br ,FAS_MST_BANKS bk where curr.STATUS='Y' and curr.ACCOUNTING_UNIT_ID=? and curr.MODULE_ID=? and curr.CR_DR_TYPE=? "+
                    " and curr.AC_HEAD_CODE like '"+main_AHCODE+"%' "+
                    ...
                    // here SL_NO=1 means that DEFAULT account number for that unit ..
                     ...
                     Sub_psbank.setInt(1,5);            // Here i used Banking section unit ID of Head office
                     Sub_psbank.setString(2,mod_id);    // Same as above
                     Sub_psbank.setString(3,"CR");     // Always Credit 
            ...
            <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCreditAccCode" value="<%=SUB_AC_HEAD_CODE%>"
               ...
               <tr class="table">
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"  
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byOffice.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
