...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Fund_Receipt_ListAll_byHO.js"></script>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmFund_Receipt_ListAll_byHO.txtCB_Year.value=year
        document.frmFund_Receipt_ListAll_byHO.txtCB_Month.value=month;
...
%>
  ...
  <form name="frmFund_Receipt_ListAll_byHO" method="POST">
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
            ...
            <td>
              <div align="left">
                <input type="radio" name="txtTypes" id="txtTypes" value="ALL"
                       checked="checked"/>All &nbsp; 
                <input type="radio" name="txtTypes" id="txtTypes" value="AUTO"/>Auto
                                                                                &nbsp; 
                <input type="radio" name="txtTypes" id="txtTypes" value="MAN"/>Manual &nbsp;
              </div>
            </td>
          </tr>
               <tr class="table">
    ...
    <br>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_ListAll_byHO.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_ListAll_byHO.txtTo_date);"
                         alt="Show Calendar"></img>
     ...
     <table id="mytable" align="center"  cellspacing="3" 
         ...
         <tr class="tdH">
          ...
          <th>
            <div>Cheque/DD No</div>
            <div>(C-Cheq,D-DD,E-ECS)</div>
          </th>
