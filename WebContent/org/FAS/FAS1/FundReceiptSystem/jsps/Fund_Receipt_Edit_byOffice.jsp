...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Receipt_Edit_byOffice.js"></script>
   ...
   <!--       
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.frmFund_Receipt_Edit_byOffice.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Receipt System - By Region/Circle/Division (Modify) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFund_Receipt_Edit_byOffice" id="frmFund_Receipt_Edit_byOffice" method="POST"
                  action="../../../../../Fund_Receipt_Edit_byOffice.view?Command=Add"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byOffice.txtCrea_date,1);"
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byOffice.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
               ...
               <tr class="table">
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"  
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byOffice.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
