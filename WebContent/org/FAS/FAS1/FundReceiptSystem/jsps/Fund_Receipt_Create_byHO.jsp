...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Receipt_Create_byHO.js"></script>      
    <!--
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmFund_Receipt_Create_byHO.txtCrea_date.value=day+"/"+month+"/"+year;
            
            call_date(document.frmFund_Receipt_Create_byHO.txtCrea_date);
       }
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Receipt System - By Banking Unit(HO) (Create) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFund_Receipt_Create_byHO" id="frmFund_Receipt_Create_byHO" method="POST"
                  action="../../../../../Fund_Receipt_Create_byHO.view?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                   ...
                   <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byHO.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="radio" name="radRecType" id="radRecType" onclick="doFunction('unspent_OR_col_based_bank','null');"
                ...
                <td>
                  <div align="left">
                    <input type="radio" name="txtCheque_DD" id="txtCheque_DD"
                           value="C" onclick="ecs_check()" />Cheque
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtCheque_DD" id="txtCheque_DD"  checked="checked"
                           value="D"  onclick="ecs_check()" />DD &nbsp;&nbsp;&nbsp;&nbsp; 
                           
                     <input type="radio" name="txtCheque_DD" id="txtCheque_DD"
                           value="E"  onclick="ecs_check()" />ECS
               ...
               <tr class="table" >
                ...
                <td height="35">
                  <div align="left" id="ecs_hide1" >
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byHO.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>                         
              </tr>
           ...
           <tr class="table">
                <td>
                  <div align="left">
                   Office Bank Account Number  <font color="#ff2121">*</font>
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtReferenceNo"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Create_byHO.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="60"  onkeypress="return check_leng(this.value);" rows="3"></textarea>
                  </div>
                </td>
              </tr>
