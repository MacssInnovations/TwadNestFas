...
<html>
  <head>
    ...
    <title>Fund_Receipt_Create_atOffice</title>
  ...
  <script type="text/javascript" src="../scripts/Auto_Fund_Receipt_Create_atOfficejs.js"></script>
   ...
   <script type="text/javascript" language="javascript">
    function loadyear_month()
         {
    	 // setTimeout('call_bankUpdate()',900);
...
<form name="frmauto_Fund" id="frmauto_Fund" > 
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Auto Fund Receipt Creation at Office</font>
          </div>
        </td>
      </tr>
    </table>
      ...
      <tr class="tdH">
        <td colspan="14">
           <div align="center" style="disply:block" id="newDiv" name="newDiv">
            <input type="button" id="submitid"  value="Submit" onclick="btSubmit()">
