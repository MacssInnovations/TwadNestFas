...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Receipt_Edit_byHO.js"></script>
   ...
   <!--       
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmFund_Receipt_Edit_byHO.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Receipt System - By Banking Unit(HO) (Modify) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFund_Receipt_Edit_byHO" id="frmFund_Receipt_Edit_byHO" method="POST"
                  action="../../../../../Fund_Receipt_Edit_byHO.view?Command=Add"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byHO.txtCrea_date,1);"
               ...
               <tr class="table">
                ...
                <td height="35">
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byHO.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtReferenceNo"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Edit_byHO.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
