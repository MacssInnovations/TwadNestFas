...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Fund_Receipt_Cancel_byHO.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmFund_Receipt_Cancel_byHO.txtCrea_date.value=day+"/"+month+"/"+year;
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Fund Receipt System - By Banking Unit(HO) (Cancel) </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmFund_Receipt_Cancel_byHO" id="frmFund_Receipt_Cancel_byHO" method="POST"
                  action="../../../../../Fund_Receipt_Cancel_byHO.view?Command=Cancel"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Cancel_byHO.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="radio" name="radRecType" id="radRecType"
               ...
               <tr class="table">
                ...
                <td height="35">
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Cancel_byHO.txtCheque_DD_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
        ...
        <td>
                  <div align="left">
                    <input type="text" name="txtSub_Office_code" 
                      ...
                      <select name="cmb_HO_acc_unitid" id="cmb_HO_acc_unitid" size="1">
                  ...
                  <div align="left">
                    <input type="text" name="txtReferenceNo"
                     ...
                     <input type="text" name="txtReferenceDate" id="txtReferenceDate"
                           ...
                           onblur=" return checkdt(this);;"/>
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFund_Receipt_Cancel_byHO.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
