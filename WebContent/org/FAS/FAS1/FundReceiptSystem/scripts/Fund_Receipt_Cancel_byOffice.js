...
{   
        ...
        {  
           clearGeneral_Detail();
           var txtCrea_date= document.frmFund_Receipt_Cancel_byOffice.txtCrea_date.value
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
           var cmbOffice_code=document.getElementById("cmbOffice_code").value;
            
            if(txtCrea_date.length!=0)
            {
            var url="../../../../../Fund_Receipt_Cancel_byOffice.view?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtVoucher_No!="")
            {
            var url="../../../../../Fund_Receipt_Cancel_byOffice.view?Command=load_Voucher_Details&txtVoucher_No="+txtVoucher_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function clearGeneral_Detail()
{
    ...
    document.frmFund_Receipt_Cancel_byOffice.txtCheque_DD[0].checked=true;
    //document.frmFund_Receipt_Cancel_byOffice.radRecType[0].checked=true;
    ...
    if(flag=="success")
    {
      ...
      document.getElementById("txtBranchId").value=br_id;
       ...
       if(R_type=="U")
            ...
            document.frmFund_Receipt_Cancel_byOffice.radRecType[1].checked=true;
        */
       ...
       che_DD_date=baseResponse.getElementsByTagName("che_DD_date")[0].firstChild.nodeValue;
        ...
        if(che_or_DD=="C")
            ...
            document.frmFund_Receipt_Cancel_byOffice.txtCheque_DD[1].checked=true;
        else if(che_or_DD=="E")    
            document.frmFund_Receipt_Cancel_byOffice.txtCheque_DD[2].checked=true;
