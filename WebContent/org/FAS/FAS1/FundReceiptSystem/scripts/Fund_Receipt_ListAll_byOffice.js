...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    document.frmFund_Receipt_ListAll_byOffice.action=url;
    document.frmFund_Receipt_ListAll_byOffice.method="POST";
    document.frmFund_Receipt_ListAll_byOffice.submit();
    return true;
}
...
{   
        ...
        if ( document.frmFund_Receipt_ListAll_byOffice.txtTypes[0].checked==true ) 
        {
            txtTypes="ALL"; 
        }
        else if (document.frmFund_Receipt_ListAll_byOffice.txtTypes[1].checked==true ) 
        {
            txtTypes="AUTO"; 
        }
        else if (document.frmFund_Receipt_ListAll_byOffice.txtTypes[2].checked==true ) 
        {
            txtTypes="MAN"; 
        }
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../Fund_Receipt_ListAll_byOffice.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
            ...
            {
                var txtCreat_By_Module='';
                var url="../../../../../Fund_Receipt_ListAll_byOffice.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.frmFund_Receipt_ListAll_byOffice.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmFund_Receipt_ListAll_byOffice.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        ...
                        items[2]=service[i].getElementsByTagName("Tot_Amt")[0].firstChild.nodeValue;
                        items[3]=service[i].getElementsByTagName("Remak")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("HO_ACCOUNT_NO")[0].firstChild.nodeValue;
                     //   items[5]=service[i].getElementsByTagName("ref_date")[0].firstChild.nodeValue;
                        
                        items[5]=service[i].getElementsByTagName("OFFICE_ACCOUNT_NO")[0].firstChild.nodeValue;
                     // alert(items[5]);
                        var cheque_dd_no;
                        ...
                        {
                          items[6]=service[i].getElementsByTagName("che_or_DD")[0].firstChild.nodeValue;
                        }
                        else
                        {
                          items[6]=service[i].getElementsByTagName("che_or_DD")[0].firstChild.nodeValue+"-"+cheque_dd_no; 
                        }
                        
                      
                       // items[6]=service[i].getElementsByTagName("che_or_DD")[0].firstChild.nodeValue+"-"+service[i].getElementsByTagName("che_DD_no")[0].firstChild.nodeValue;
                      
                        items[7]=service[i].getElementsByTagName("che_DD_date")[0].firstChild.nodeValue;
                        items[8]=service[i].getElementsByTagName("BK_BR_CITY")[0].firstChild.nodeValue;
                       ...
                       // items[10]=service[i].getElementsByTagName("AC_OPERATIONAL_MODE_ID")[0].firstChild.nodeValue;
...
function changepagesize()
{
           ...
           __pagination=document.frmFund_Receipt_ListAll_byOffice.cmbpagination.value;
