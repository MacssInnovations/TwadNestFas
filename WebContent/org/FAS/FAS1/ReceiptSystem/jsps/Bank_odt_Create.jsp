...
<html>
  <head>
    ...
    <title>Creation Of Other Department Receipt System</title>
    ...
    <script type="text/javascript" src="../scripts/Bank_odt_Create.js"></script>
    ...
    <!-- to avoid future date the above script used-->
       <script type="text/javascript" language="javascript">
        ...
        //	setTimeout('call_a52()',900);
             ...
             call_date(document.Bank_Receipt_Form_odt.txtCrea_date);
     }
         function disFun()
         {
         ...
         function chkStype()
         {
        	 if(document.getElementById("cmbMas_SL_Code").value=="")
        		 {
        		 alert("Select General Sub Ledger Code ... ");
...
%>
  <body onload="setTimeout('loadDate()', 300);LoadAccountingUnitID_Create('LIST_ALL_UNITS');" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Creation Of Other Department Receipt System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="Bank_Receipt_Form_odt" id="Bank_Receipt_Form_odt" method="POST"
                  action="../../../../../Bank_odt_Create?Command=Add"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                   <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Bank_Receipt_Form_odt.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Bank_Receipt_Form_odt.txtRef_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
                ...
                <td width="60%">
                  <div align="left">
                    <select size="1" name="cmbMas_SL_type" id="cmbMas_SL_type" tabindex="6"
                      ...
                      <option value="9">Other Departments</option>
              ...
              <tr class="table">
                ...
                <td width="60%">
                    <table align="left">
                     ...
                     <td>
                          <div align="left">
                                <select name="cmbMas_SL_Code" id="cmbMas_SL_Code" onchange="disFun();loadrecfrom();">
                                  <option value="">--Select Code--</option>
                                 <%
                            
                                     try
                                     {
                                           ps=con.prepareStatement("select sl_code,sl_codename from sl_type_code_name_view where sl_type=9 order by sl_codename");
             ...
             <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtRecei_from" readonly="readonly" tabindex="9" onkeypress="return check_leng(this.value,'received_from');"
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              <tr>
                ...
                <td>
                  <div align="left">
                     <input type="text" name="txtCB_Year" id="txtCB_Year" onblur="chkStype();"  maxlength="4" size="5" >
         
			          <select name="txtCB_Month"  id="txtCB_Month" onchange="chkStype();">
                      ...
                      <tr class="table">
                <td>
                  <div align="left" id="headcodeid" style="display:none">
                    Account Head Code 
                    <font color="#ff2121">*</font>
                  </div>
                </td>
                <td>
                 <div align="left" id="headdescid" style="display:none">			              
                          <select name="txtAcc_HeadCode" id="txtAcc_HeadCode" >
                            <option value="">--Select Headcode--</option>
                            <%
                            
                                     try
                                     {
                                            ps=con.prepareStatement("select ACCOUNT_HEAD_CODE,ACCOUNT_HEAD_DESC from FAS_ODP_RECOVERY_HEADS where STATUS='Y' order by ACCOUNT_HEAD_CODE ");
                                            rs=ps.executeQuery();
                                            while(rs.next())
                                            {
                                                out.println("<option value="+rs.getInt("ACCOUNT_HEAD_CODE")+" selected>"+rs.getInt("ACCOUNT_HEAD_CODE")+" ("+rs.getString("ACCOUNT_HEAD_DESC")+")"+"</option>");
                                            }
                                        
                                     } 
                                     catch(Exception e)
                                     {
                                            System.out.println("Exception in ACCOUNT_HEAD_CODE combo..."+e);
                                     }
                                     finally
                                     {
                                            rs.close();
                  ...
                  <div align="left">
                    <input type="radio" name="rad_sub_CR_DR" id="rad_sub_CR_DR" 
                           checked="checked" value="CR"/>Credit
                                                        &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="rad_sub_CR_DR" id="rad_sub_CR_DR" 
                           value="DR" disabled="disabled">Debit &nbsp;&nbsp;&nbsp;&nbsp; 
                          ...
                          <table align="left">
                                 ...
                                 <td>
                                  ...
                                  <td>
                                      ...
                                      <input type="hidden" name="txtOfficeID_trs" id="txtOfficeID_trs" maxlength="4" size="5"/>
                                      </div>
                                      <div align="left" id="emplist_div_trans"  style="display:block">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left" id="ecs_hide" >
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Bank_Receipt_Form_odt.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
