...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Cash_Receipt_Creation.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
          ...
          //alert(ctdate);
           call_date(document.Cash_Receipt_Form.txtCrea_date);
...
%>
  <body onload="call_clr();LoadAccountingUnitID_Create('LIST_ALL_UNITS');setTimeout('loadDate()', 300);loadAccHead();foc();" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Creation of Cash Receipt </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="Cash_Receipt_Form" id="Cash_Receipt_Form" method="POST"
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbOffice_code" id="cmbOffice_code" tabindex="2">
                      ...
                      <%
                      int old_offid=0;
                   System.out.println("here in Cash Receipt******");
                   System.out.println(oid+"  " +oname);
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                           ...
                           onfocus="call_date(this.value);dateCheck(this.value);"/>
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Cash_Receipt_Form.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.Cash_Receipt_Form.txtRef_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
