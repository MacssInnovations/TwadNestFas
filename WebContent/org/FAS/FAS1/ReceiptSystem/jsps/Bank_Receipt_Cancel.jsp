...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Bank_Receipt_Cancel.js"></script>
  ...
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation Of Bank Receipt </font>
          </div>
        </td>
      </tr>
    </table><form name="Bank_Receipt_Edit_Form" id="Bank_Receipt_Edit_Form"
                  method="POST"
                  action="../../../../../Bank_Receipt_Cancel.view?Command=Cancel"
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <!--  <img src="../../../../../images/c-lovi.gif" width="20"
                         height="20" alt="ReceiptList"
                         onclick="Receipt_list_popup();"></img>-->
                  </div>
                </td>
              </tr>
