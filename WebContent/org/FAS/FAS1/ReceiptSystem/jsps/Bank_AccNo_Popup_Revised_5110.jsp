  ...
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    function btnsubmit()
    {
        ...
        var val=0;
        var getId='',bankid='',br_id='',B_name='',Acc_Head_Code='',Bank_Acc_No='';
        ...
        opener.doParentAcc_NO(Acc_Head_Code,Bank_Acc_No,bankid,br_id,B_name);
       ...
       try
       {
           ...
           String txtModule_Type="",cr_dr_indi="",unspent_OR_col="";
            ...
            String sql_bank="";
                ...
                {
                        System.out.println("inside unspent_OR_col.. null");
                        ...
                        " and t.ACCOUNT_TYPE_ID=ac.BANK_AC_TYPE_ID and ac.AC_OPERATIONAL_MODE_ID=m.AC_OPERATIONAL_MODE_ID and ac.BANK_ID=br.BANK_ID and ac.BRANCH_ID=br.BRANCH_ID and ac.BANK_ID=bk.BANK_ID order by ac.SL_NO desc";
                 }     
                                 ...
                                 sql_bank="SELECT ac.AC_HEAD_CODE,\n" + 
                                          ...
                                          // "and ac.ac_head_code like '%3'\n" + 
                                           // Lakshmi " and Ac.Bank_Id = "+txtSubBankId+
                                            "  AND ac.AC_OPERATIONAL_MODE_ID in ('COL','SCH','RBI','OPR') ORDER BY ac.SL_NO DESC";
                ...
                System.out.println("cmbAcc_UnitCode***&&&&::::"+cmbAcc_UnitCode);
                    ...
                    " and t.ACCOUNT_TYPE_ID=ac.BANK_AC_TYPE_ID and ac.AC_OPERATIONAL_MODE_ID=m.AC_OPERATIONAL_MODE_ID and ac.BANK_ID=br.BANK_ID and ac.BRANCH_ID=br.BRANCH_ID and ac.BANK_ID=bk.BANK_ID and ac.AC_OPERATIONAL_MODE_ID IN('OPR') and Ac.Bank_Id = "+txtSubBankId+" AND ac.ac_head_code like '8%2' order by ac.SL_NO desc";
                      ...
                      else
                      {
    	               ...
    	               "  FAS_MST_AC_OPER_MODES m\n" + 
    	               "WHERE ac.STATUS                ='Y'\n" + 
    	               "AND ac.ACCOUNTING_UNIT_ID      =" +cmbAcc_UnitCode+ 
    	               "AND ac.MODULE_ID               ='"+txtModule_Type+"'\n" + 
    	               "AND ac.CR_DR_TYPE              ='"+cr_dr_indi+"'\n" + 
    	               "AND t.ACCOUNT_TYPE_ID          =ac.BANK_AC_TYPE_ID\n" + 
    	               "AND ac.AC_OPERATIONAL_MODE_ID  =m.AC_OPERATIONAL_MODE_ID\n" + 
    	               "AND ac.BANK_ID                 =br.BANK_ID\n" + 
    	               "AND ac.BRANCH_ID               =br.BRANCH_ID\n" + 
                       ...
                       {               
                        ...
                        " ac.BANK_ID,ac.BRANCH_ID,ac.BANK_AC_TYPE_ID, ac.AC_OPERATIONAL_MODE_ID,t.ACCOUNT_TYPE,m.AC_OPERATIONAL_MODE , ac.CR_DR_TYPE,ac.MODULE_ID from "+
                        " FAS_OFFICE_BANK_AC_CURRENT ac,FAS_MST_BANKS bk,FAS_MST_BANK_BRANCHES br,FAS_MST_BANK_AC_TYPES t,FAS_MST_AC_OPER_MODES m  where ac.STATUS='Y' and ac.ACCOUNTING_UNIT_ID=? and ac.MODULE_ID=? and ac.CR_DR_TYPE=? "+
                        " and t.ACCOUNT_TYPE_ID=ac.BANK_AC_TYPE_ID and ac.AC_OPERATIONAL_MODE_ID=m.AC_OPERATIONAL_MODE_ID and ac.BANK_ID=br.BANK_ID and ac.BRANCH_ID=br.BRANCH_ID and ac.BANK_ID=bk.BANK_ID and ac.AC_OPERATIONAL_MODE_ID='"+unspent_OR_col+"'"+
               ...
               // here SL_NO=1 not mentioned here for  DEFAULT account number for that unit .. instead it shows all the account numbers
                        ...
                        System.out.println("lst****cmbAcc_UnitCode::::"+cmbAcc_UnitCode);
                        ...
                        while(rs2.next())
                        {
                           ...
                           if(y==0)
                            ...
                            out.println("<td align='left'>"+rs2.getInt("AC_HEAD_CODE")+"</td>");
                            out.println("<td align='left'>"+rs2.getLong("BANK_AC_NO")+"</td>");
                            out.println("<td align='left'>"+rs2.getString("BANK_NAME")+"</td>");
                            out.println("<td align='left'>"+rs2.getString("BRANCH_CITY")+"</td>");
                            out.println("<td align='left'>"+rs2.getString("ACCOUNT_TYPE")+"</td>");
                            out.println("<td align='left'>"+rs2.getString("AC_OPERATIONAL_MODE")+"</td>");
                            out.println("<td align='left'>"+rs2.getString("CR_DR_TYPE")+"</td>");
                            out.println("<td align='left'>"+rs2.getInt("BANK_ID")+"</td>");
                            out.println("<td align='left'>"+rs2.getInt("BRANCH_ID")+"</td></tr>");
                        }
                        if(y!=0)
                         {
                                rs2.close();
