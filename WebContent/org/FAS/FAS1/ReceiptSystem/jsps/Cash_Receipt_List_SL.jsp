      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW_M where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME ,RECEIVED_FROM , AMOUNT, PARTICULARS "+
                ...
                out.println("<td align='center'>"+rs2.getString("CR_DR_INDICATOR")+"</td>");
                   ...
                   if(rs2.getInt("SUB_LEDGER_TYPE_CODE")!=0)
                    ...
                    if(rs2.getString("SLNAME")!=null)
                        ...
                        out.println("<td align='left'>"+"--"+"</td>");
                    //new BigDecimal(tot6).setScale(2,BigDecimal.ROUND_CEILING)
               // out.println("<td align='right'>"+rs2.getFloat("AMOUNT")+"</td>");
