...
<html>
  <head>
    ...
    <title>Modify Other Department Receipt System</title>
    ...
    <script type="text/javascript" src="../../../../../org/PMS/PMS1/DCB//scripts/DCB_Receipt_Edition.js"></script>
  ...
  /twadFas/WebContent/org/PMS/PMS1/DCB/scripts/DCB_Receipt_Edition.js  -->
  ...
  <body onload="call_clr();loadDate();foc()" bgcolor="rgb(255,255,225)"><table cellspacing="1"
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Modify Other Department Receipt System </font>
          </div>
        </td>
      </tr>
    </table><form name="Bank_Receipt_Edit_Form" id="Bank_Receipt_Edit_Form"
                  method="POST"
                  action="../../../../../DCB_Receipt_Edition?Command=Add"
                  onsubmit="return checkNull_DCB()">
