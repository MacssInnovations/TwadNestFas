...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Cash_Receipt_Edition.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Modify Cash Receipt </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="Cash_Receipt_Edit_Form" id="Cash_Receipt_Edit_Form" method="POST"
                  action="../../../../../Cash_Receipt_Edition.view?Command=Add"
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                           ...
                           onblur="call_date(this);"  onchange="doFunction_voucher('load_Receipt_No','null');"/>
                ...
                <td>
                  <div align="left">
                    ...
                    <input type="radio" name="rad_ReClass" id="rad_ReClass" 
                           value="N" checked="checked" readonly/>NO &nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <div id="grid" style="display:block">
            		...
            		<input type="hidden" name="CB_REF_NO" id="CB_REF_NO" value="">
