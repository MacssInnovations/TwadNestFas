...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/Cash_Receipt_Cancel.js"></script>
...
%>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Cancellation Of Cash Receipt </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="Cash_Receipt_Edit_Form" id="Cash_Receipt_Edit_Form" method="POST"
                  action="../../../../../Cash_Receipt_Cancel.view?Command=Cancel"
