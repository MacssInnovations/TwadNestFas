...
<html>
  <head>
    ...
    <title>Print Challan cash bank DCB</title>
  </head>
  ...
  <form action="../../../../../Print_challan_cashbankDCB" name=frmReport method=post onsubmit="return nullcheck();"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>Print Challan Cash,Bank,DCB</b></center></td>
        </tr>
          <tr>
            <td>
                  ...
                  <div align="left">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            ...
                            <option value="DCBCR">DCB Cash Receipt</option>
                            <option value="DCBBR">DCB Bank Receipt</option>
                            </select>
                        </td>
                    </tr>
                    <tr >
