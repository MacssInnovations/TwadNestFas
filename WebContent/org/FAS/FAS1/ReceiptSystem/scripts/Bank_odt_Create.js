...
function loadTable(scod)
{
	//alert(scod);
       ...
       //  alert(rcells.item(4).lastChild.nodeValue);
         document.getElementById("txtEmpID_trs").value=rcells.item(4).firstChild.value;
        var splcode=rcells.item(4).lastChild.nodeValue.split("(");
        document.getElementById("cmbSL_Code").options[document.getElementById("cmbSL_Code").selectedIndex].text=splcode[0];
        
         if(rcells.item(2).firstChild.value=="CR")
         document.Bank_Receipt_Form_odt.rad_sub_CR_DR[0].checked=true;
         else if(rcells.item(2).firstChild.value=="DR")
         document.Bank_Receipt_Form_odt.rad_sub_CR_DR[1].checked=true;
      
        if(rcells.item(5).firstChild.value=="C")
           document.Bank_Receipt_Form_odt.txtCheque_DD[0].checked=true;
        else if(rcells.item(5).firstChild.value=="D")
          document.Bank_Receipt_Form_odt.txtCheque_DD[1].checked=true;
        else if(rcells.item(5).firstChild.value=="E")
          document.Bank_Receipt_Form_odt.txtCheque_DD[2].checked=true;
    ...
    document.Bank_Receipt_Form_odt.cmdupdate.style.display='block';
    document.Bank_Receipt_Form_odt.cmddelete.disabled=false;
    document.Bank_Receipt_Form_odt.cmdadd.style.display='none';
}
...
function ADD_GRID()
{
  ...
  if(document.Bank_Receipt_Form_odt.txtCheque_DD[2].checked==false)
  {      
  ...
  if(document.getElementById("txtEmpID_trs").value=="")
  {
      alert("Enter Subledger Code");
       document.getElementById("txtEmpID_trs").focus();
      return false;
  }
  
  if(document.getElementById("cmbSL_Code").value=="")
  {
      alert("Choose Subledger Code");
      ...
      //  alert(items[0]);
        items[1]=document.getElementById("txtAcc_HeadCode").options[document.getElementById("txtAcc_HeadCode").selectedIndex].text;
        if(document.Bank_Receipt_Form_odt.rad_sub_CR_DR[0].checked==true)
          items[2]=document.Bank_Receipt_Form_odt.rad_sub_CR_DR[0].value;
        else if(document.Bank_Receipt_Form_odt.rad_sub_CR_DR[1].checked==true)
          items[2]=document.Bank_Receipt_Form_odt.rad_sub_CR_DR[1].value;
        ...
        if(document.Bank_Receipt_Form_odt.txtCheque_DD[0].checked==true)
          items[7]=document.Bank_Receipt_Form_odt.txtCheque_DD[0].value;
        else if(document.Bank_Receipt_Form_odt.txtCheque_DD[1].checked==true)
          items[7]=document.Bank_Receipt_Form_odt.txtCheque_DD[1].value;
        else if(document.Bank_Receipt_Form_odt.txtCheque_DD[2].checked==true)
          items[7]=document.Bank_Receipt_Form_odt.txtCheque_DD[2].value;  
...
//document.getElementById("txtCB_Month").value="";
 ...
 document.Bank_Receipt_Form_odt.cmdadd.style.display='block';
 document.Bank_Receipt_Form_odt.cmdupdate.style.display='none';
 document.Bank_Receipt_Form_odt.cmddelete.disabled=true;
}

function loadrecfrom()
{
	var desc=document.getElementById("cmbMas_SL_Code").options[document.getElementById("cmbMas_SL_Code").selectedIndex].text;
	document.getElementById("txtRecei_from").value=desc;
	//document.getElementById("txtRecei_from").readOn
...
{      
       ...
       // items[5]=document.getElementById("cmbSL_Code").value;
       items[5]=document.getElementById("txtEmpID_trs").value;
        if(document.getElementById("txtEmpID_trs").value=="")
        {
        	alert("Enter SubLedger Code");
        	return false;
      ...
      //  items[13]=document.getElementById("txtsub_Recei_from").value;
        ...
        rcells.item(1).lastChild.nodeValue=items[1];
...
//	alert("Welcome!!!!!!!!");
	...
	document.getElementById("headcodeid").style.display="block";
	document.getElementById("headdescid").style.display="block";
...
//alert(head);
var url="../../../../../Bank_odt_Create?Command=loadDCBhead&acchead="+head;
...
function call_a52()
{
	...
	else
	{
       ...
       document.Bank_Receipt_Form_odt.txtCrea_date.value=day+"/"+month+"/"+year; 
	}
}
