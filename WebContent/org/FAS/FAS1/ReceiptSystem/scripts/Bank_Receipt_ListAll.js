...
function handleResponse_fir(req)
{ 
    if(req.readyState==4)
    {
        if(req.status==200)
       ...
       // alert("baseResponse:::"+baseResponse);
          ...
          //  alert(tagcommand);
            ...
            {
                loadTable_Date(baseResponse);
            }
        }
    }
}

function loadTable_Date(baseResponse)
{
             ...
             if(service)
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                     c++;
                        ...
                        items[3]=service[i].getElementsByTagName("achead")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("Tot_Amt")[0].firstChild.nodeValue;
                        items[5]=service[i].getElementsByTagName("accno")[0].firstChild.nodeValue;
                        items[6]=service[i].getElementsByTagName("curr_month")[0].firstChild.nodeValue;
                        rec_month=items[1].split("/")[1];
                        rec_year=items[1].split("/")[2];
                      //  alert(items[1]+" > "+rec_month+" > "+rec_year+" mm ");
                      ...
                      if(document.getElementById("cmbStatus").value=='L' || document.getElementById("cmbStatus").value=='C')
                      {
		                        ...
		                        var url="javascript:Show('"+Ucode+"','"+Offid+"','"+rec_year+"','"+rec_month+"','"+items[0]+"')";
		                        anc.href=url;
                        ...
                        */
                        ...
                        if(document.getElementById("cmbAcc_UnitCode").value!==null)
                        {
                            if(document.getElementById("cmbStatus").value=='L')
                            {
                                ...
                                cell.align='CENTER';
                                var anc=document.createElement("A");
                                var url="javascript:printing('"+Ucode+"','"+Offid+"','"+rec_year+"','"+rec_month+"','"+items[0]+"','"+items[1]+"')";
                                anc.href=url;
                                var txtedit=document.createTextNode("PRINT");
                                anc.appendChild(txtedit);
                                cell.appendChild(anc);
           ...
           var cell=document.getElementById("divpage");
            ...
            if(page<totalblock)
            {
                ...
                try{cell.innerHTML="";}
                 ...
                 var anc=document.createElement("A");
                var url="javascript:loadPage1("+(page+1)+")";
                anc.href=url;
