       ...
       if(Command=="load_Receipt_No")
        {  
           ...
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            {
            var url="../../../../../Cash_Receipt_Cancel.view?Command=load_Receipt_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
           ...
           var  txtReceipt_No=document.getElementById("txtReceipt_No").value;
            ...
            if(txtReceipt_No!="")
            {
            var url="../../../../../Cash_Receipt_Cancel.view?Command=load_Receipt_Details&txtReceipt_No="+txtReceipt_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
