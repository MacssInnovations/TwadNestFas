...
{   
        ...
        {  
           ...
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            {
            var url="../../../../../Bank_Receipt_Cancel.view?Command=load_Receipt_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
           ...
           var  txtReceipt_No=document.getElementById("txtReceipt_No").value;
            ...
            if(txtReceipt_No!="")
            {
            var url="../../../../../Bank_Receipt_Cancel.view?Command=load_Receipt_Details&txtReceipt_No="+txtReceipt_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function load_Receipt_Details(baseResponse)
{
    ...
    if(flag=="success")
    {
      ...
      if(baseResponse.getElementsByTagName("accNo")[0].firstChild!=null)
      var accNo=baseResponse.getElementsByTagName("accNo")[0].firstChild.nodeValue;
      if(baseResponse.getElementsByTagName("bk_name")[0].firstChild!=null)
       var bk_name=baseResponse.getElementsByTagName("bk_name")[0].firstChild.nodeValue;
       if(baseResponse.getElementsByTagName("bk_id")[0].firstChild!=null)
       var bk_id=baseResponse.getElementsByTagName("bk_id")[0].firstChild.nodeValue;
       if(baseResponse.getElementsByTagName("br_id")[0].firstChild!=null)
       var br_id=baseResponse.getElementsByTagName("br_id")[0].firstChild.nodeValue;
      if(baseResponse.getElementsByTagName("Total_amt")[0].firstChild!=null)
    ...
    document.getElementById("txtCash_Acc_code").value=MasHeadCode
      ...
      document.getElementById("txtRecei_from").value="";
       ...
       var tbody=document.getElementById("grid_body");
        ...
        if(items[13]=baseResponse.getElementsByTagName("sub_rec_frm")[k]=null)
