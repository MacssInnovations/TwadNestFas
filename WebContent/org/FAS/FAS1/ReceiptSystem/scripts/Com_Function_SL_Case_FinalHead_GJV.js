    ...
    var txtCrea_date=document.getElementById("txtCrea_date").value;
        ...
        {  
          ...
          //alert("haiiii");
           ...
           {
               var url="../../../../../Receipt_SL_FinalHead_GJV.kv?Command=checkCode_BLOCK&txtAcc_HeadCode="+txtAcc_HeadCode+"&cmbOffice_code="+cmbOffice_code+"&vr_date="+txtCrea_date;                
     ...
     try{   
       ...
       if(SL_YN=="Y")
       {
          ...
          //  alert(SLCODE.length);
           ...
           // alert("be4");
          //  alert("common_cmbSL_type:::"+common_cmbSL_type);
