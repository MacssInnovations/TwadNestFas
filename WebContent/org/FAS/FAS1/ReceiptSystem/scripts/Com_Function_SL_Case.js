             ...
             if(cmbSL_type==7)
              {
               ...
               //   alert(addtional_field_value);
                  ...
                  {
                        clear_Combo(document.getElementById("cmbSL_Code")); 
                        alert("Enter or select the employee code3");
             ...
             if(cmbSL_type==7)
              {
                  ...
                  {
                        clear_Combo(document.getElementById("cmbSL_Code")); 
                        alert("Enter or select the employee code4");
                        return true;
                  }
              }
            else
         ...
         else if(Command=="Load_SL_Code_NEW")
         {
             ...
             //	 alert("kkk");
                ...
                //   alert(addtional_field_value);
                   ...
                   {
                         clear_Combo(document.getElementById("cmbSL_Code")); 
                         alert("Enter or select the employee code5");
                         return true;
                   }
               }
             else
         ...
         //   alert('here second');
            ...
            {   
                   ...
                   try
                  {
                      ...
                      //alert(genslValue);
                      var sltypeGen=document.getElementById("cmbSL_type").disabled;
                      if((detslValue== genslValue)&& (sltypeGen==true))
                     	 {
             ...
             if(cmbSL_type==7)
              {
                  ...
                  {
                        clear_Combo(document.getElementById("cmbSL_Code")); 
                        alert("Enter or select the employee code6");
                        return true;
                  }
              }
            else
         ...
         else if(Command=="Load_SL_Code_NEW")
         {
             ...
             //	 alert("kkk");
                ...
                //   alert(addtional_field_value);
                   ...
                   {
                         clear_Combo(document.getElementById("cmbSL_Code")); 
                         alert("Enter or select the employee code7");
                         return true;
                   }
               }
             else
