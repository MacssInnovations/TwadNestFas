...
{   
        ...
        {  
            ...
            {
                var txtReceipt_type='BR';
                var url="../../../../../DCB_Receipt_ListAllcp?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtReceipt_type='BR';
                var url="../../../../../DCB_Receipt_ListAllcp?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
