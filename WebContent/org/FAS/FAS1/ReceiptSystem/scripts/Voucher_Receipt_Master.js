...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                //var txtCreat_By_Module='CRM';
                var txtCreat_By_Module
               /* var url="../../../../../Voucher_Receipt_Master.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
               // var txtCreat_By_Module='CRM';
               var txtCreat_By_Module
                var url="../../../../../Voucher_Receipt_Master.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
            ...
            try{tbody.innerHTML="";}
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        ...
                        items[4]=service[i].getElementsByTagName("RECEIVED_FROM")[0].firstChild.nodeValue;
