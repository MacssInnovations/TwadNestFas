...
<html>
  <head>
    ...
    <script language="javascript" src="../scripts/LoadNewRegList.js"></script>
  ...
  <body onload="loadDate()">
    ...
    <form name="SearchRecord" method="get">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%" class="table">
        ...
        <tr>
          <td width="28%">
            <input type="radio" name="search" onclick="callServer()" checked/>Registration No</td>
          <td width="35%">
        ...
        <tr>
          <td width="28%">
            <input type="text" size="7" name="txtRegn_no"/>
          </td>
          <td width="35%">
    ...
    <table id="tblTable">
              <tr>
                  <td colspan="6">
                    <center>
                      <b><FONT size="5">
                          <center>
                           <FONT size="4">Listing details</FONT> 
</center>
                        </FONT>
                      </b>
                    </center>
              ...
              <tr>
              <table  cellspacing="3" cellpadding="2" border="1" width="100%" id="ExistingRecord">
                 <th>
                    <FONT class="td3">Select</FONT>
                  </th> 
                 <th>
                    <FONT class="td3" id="si_no"><b>SI.No</b></FONT>
                  </th>
                  <th>
                    <FONT class="td3" id="reg_no"><b>Reg.SlNo</b></FONT>
                  </th>
                  <th>
