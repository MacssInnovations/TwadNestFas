...
<title>MTC70 Register Updated List</title>
...
<script src="../scripts/MTC70_Register_Updated_List.js"
...
function loadyear_month()
{
       ...
       document.frmMtc_upd_list.txtCB_Year.value=year;
       document.frmMtc_upd_list.txtCB_Month.value=month1;
}
</script>
</head>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">MTC70 Register Updated List</font></div>
		</td>
	</tr>
</table>
<form name="frmMtc_upd_list" id="frmMtc_upd_list" method="POST" >
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
					...
					<td>
					          ...
					          <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth"  tabindex="5" onclick="doFunction('searchByMonth','MTCOFF')"/>
			                    </div>		
			                </td>
				</tr>
