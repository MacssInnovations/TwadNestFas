...
<script src="../scripts/MTC_Register_List.js"
...
function loadyear_month()
{
       ...
       document.frmMtc_list.txtCB_Year.value=year;
       document.frmMtc_list.txtCB_Month.value=month1;
}
</script>
</head>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">MTC70 Register List</font></div>
		</td>
	</tr>
</table>
<form name="frmMtc_list" id="frmMtc_list" method="POST" >
