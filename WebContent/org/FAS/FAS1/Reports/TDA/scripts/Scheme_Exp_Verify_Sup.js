...
function verify_btn_sup()
{
    ...
    if(tbody.rows.length==0)
    {
        ...
        return false; 
	    	  ...
	    	  url="../../../../../../Scheme_Exp_Verify_Sup?" +"command=submit_all&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
{     
        ...
        var supNo=document.getElementById("supNo").value;
        	  ...
        	  url="../../../../../../Scheme_Exp_Verify_Sup?" +"command=verify_cr_dr&cmbAcc_UnitCode="+cmbAcc_UnitCode+
