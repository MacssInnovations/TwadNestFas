function checknull()
{
    ...
    if((document.twadA90.cmbOffice_code.value=="") || (document.twadA90.cmbOffice_code.value.length<=0) || (document.twadA90.cmbOffice_code.value=="0"))
    {
        alert("Please Select Accounting Office Code");
        document.twadA90.cmbOffice_code.focus();
        return false;
