...
function verify_btn()
{
    ...
    if(tbody.rows.length==0)
    {
        ...
        return false; 
	    	  ...
	    	  url="../../../../../../tda_tca_verification_units_only?" +"command=submit_all&cmbAcc_UnitCode="+cmbAcc_UnitCode+
	    	  "&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbOffice_code="+cmbOffice_code;
	       //  alert("Loading");
	         req=getTransport();
	         req.open("GET",url,true);        
...
{     
        ...
        var txtCB_Year=document.getElementById("txtCB_Year").value;
        var txtCB_Month=document.getElementById("txtCB_Month").value;
        	  url="../../../../../../tda_tca_verification_units_only?" +"command=verify_cr_dr&cmbAcc_UnitCode="+cmbAcc_UnitCode+
