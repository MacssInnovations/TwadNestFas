...
<html>
  ...
  <form name="frmtparaisedReport" method="POST"  action="../../../../../../TDA_Reports" >
                ...
                <td>
                  <div align="left">
                    <select name="reportname" id="reportname" >
                     ...
                     <option value="RaisedReport"> TDA Raised</option>
                      <option value="AcceptedReport">TDA Accepted</option>
                      <option value="PendingReport">TDA Pending</option>
                       <option value="TDAALL">TDA All</option>
                       </select>                                           
                  </div>
                </td>
              </tr> 
