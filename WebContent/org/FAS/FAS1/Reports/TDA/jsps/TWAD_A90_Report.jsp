...
<title>TWAD A90</title>
<script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Imprest_Temp_Adv_Cash.js"></script>
    ...
    <script type="text/javascript"
     ...
     function loadyear_month()
     {
		    ...
		    var today= new Date(); 
		     ...
		     document.twadA90.txtCB_Year.value=year;
		     document.twadA90.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.twadA90.reporttype[0].checked==true)
         {
        	     dispsupnochosen1.style.display="none";
                 dispsupnochosen2.style.display="none";
         }
         else if(document.twadA90.reporttype[1].checked==true)
         {
     ...
     function dispsuppno()
     {
         ...
         {
        	 dispsupnochosen3.style.display="block";
        	 document.twadA90.reporttype[0].checked=true;
...
<form name="twadA90" id="twadA90"  method="POST" action="../../../../../../Twad_A90_Report_Servlet" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TWAD A90</strong>
            </div>
          </td>
        </tr>
      </table>
      <div align="center">
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbJour_type" id="cmbJour_type" tabindex="2">
                <option value="">select</option>
                <option value="TDAO">Suspense Head Clearence</option>
              <!--  <option value="TCAO">TCA Suspense Head Clearence</option>   -->
                </select>
              </div>
            </td>
          </tr>
