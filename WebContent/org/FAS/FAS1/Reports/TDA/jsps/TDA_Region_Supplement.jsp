...
<html>
  <head>
    ...
    <title>TDA Supplement Reports for Region </title>
   ...
   <script type="text/javascript" language="javascript">
    function loadyear_month(){
               ...
               document.frmSupp_Region.txtCB_Year.value=year;
        //  document.frmSupp_Region.txtCB_Month.value=month;
                       
               document.frmSupp_Region.txtCB_Year_from.value=year;
               document.frmSupp_Region.txtCB_Month_from.value=month;
               
               document.frmSupp_Region.txtCB_Year_to.value=year;
               document.frmSupp_Region.txtCB_Month_to.value=month;
      }
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');">
 ...
 <form name="frmSupp_Region" id="frmSupp_Region" action="../../../../../../TDA_Region_Supplement" method="post" onsubmit="return checkNull()"> 
   ...
   %>
    ...
    <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">TDA Supplement Reports for Region</font>
          </div>
        </td>
      </tr>
    </table>
               ...
               <tr class="table">
                 <td width="30%">
                  ...
                  <div align="left">
                   ...
                   <td>
                   <input type="text" id="supp_id" name="supp_id" value="1" size="1" />
