...
<script type="text/javascript"
    ...
    <script type="text/javascript"
         ...
         <script language="javascript" type="text/javascript"
            src="../scripts/TwadA88_Report.js"></script>      
    ...
    <script type="text/javascript"
     ...
     function loadyear_month()
     {
		    ...
		    var today= new Date(); 
		     ...
		     document.adviceDebitOrCredit.txtCB_Year.value=year;
		     document.adviceDebitOrCredit.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.adviceDebitOrCredit.reporttype[0].checked==true)
         {
        	     dispsupnochosen1.style.display="none";
                 dispsupnochosen2.style.display="none";
         }
         else if(document.adviceDebitOrCredit.reporttype[1].checked==true)
         {
     ...
     function dispsuppno()
     {
         ...
         {
        	 dispsupnochosen3.style.display="block";
        	 document.adviceDebitOrCredit.reporttype[0].checked=true;
...
<form name="adviceDebitOrCredit" id="adviceDebitOrCredit"  method="POST" action="../../../../../../Twad_A88_Report" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Advice Of Transfer Debit/Credit</strong>
            </div>
          </td>
        </tr>
      </table>
      <div align="center">
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr align="left">
            ...
            <td>
            <select id="advnumber" name="advnumber">
            <option value="0">select</option>
            </select>
            </td>
          </tr>
          <!-- modified by sathya on Nov 2012 -->
          <tr align="left">
          <td class="table">
