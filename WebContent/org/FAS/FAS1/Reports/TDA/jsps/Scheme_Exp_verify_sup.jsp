...
<title>Verification of Scheme Expenditure</title>
<script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Scheme_Exp_Verify_Sup.js"></script>
    ...
    <script type="text/javascript"
     ...
     function loadyear_month()
     {
		    ...
		    var today= new Date(); 
		     ...
		     document.scheme_exp_grid.txtCB_Year.value=year;
             document.scheme_exp_grid.txtCB_Month.value=month;
     }
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');Suppl_Number_CheckNew();">
<form name="scheme_exp_grid" id="scheme_exp_grid" method="post" >
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Verification of Scheme Expenditure (Supplement)</strong>
            </div>
          </td>
        </tr>
      </table>
        ...
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
         ...
         <tr class="table">
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
                 <select name="txtCB_Year" id="txtCB_Year" onchange="Suppl_Number_CheckNew();" >
                 ...
                 <select name="txtCB_Month"  id="txtCB_Month" tabindex="4" onchange="Suppl_Number_CheckNew();">
          ...
          <tr class="tdH">
            ...
            <table id="mytable1" cellspacing="3" cellpadding="2"
              ...
              <tr class="table">
                ...
                <th>Scheme Code</th>
                <th>Scheme Name</th>
                <th>Debit During the Month</th>
                <th>Credit During the Month</th>
                <th>Net During the Month</th>
        ...
        <tr class="tdH">
          <td>
            <div align="center" style="display:none" id="one_id" >
              <input type="button" value="Verify" id="btnSubmit" onclick="verify_btn_sup();"></input>
