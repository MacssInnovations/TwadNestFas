...
<title>Verification of Scheme Expenditure(Defunct)</title>
<script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Scheme_Exp_Verify.js"></script>
...
<form name="scheme_exp_grid" id="scheme_exp_grid" method="post" >
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Verification of Scheme Expenditure</strong>
            </div>
          </td>
        </tr>
      </table>
                   ...
                   <%
                      ...
                      try{
                        ...
                        if(oid==5000)
                        {
                            ...
                            System.out.println("getWing====>"+getWing);
