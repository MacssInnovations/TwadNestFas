...
<title>Verification Of TDA/TCA Register Only For Units</title>
<script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/tda_tca_verification_units_only_sup.js"></script>
    ...
    <script type="text/javascript"
     ...
     function loadyear_month()
     {
		    ...
		    var today= new Date(); 
             ...
             document.tda_tca_grid.txtCB_Month.value=3;
             setTimeout('Suppl_Number_CheckNew()',900);
     }
...
<form name="tda_tca_grid" id="tda_tca_grid" method="post" >
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Verification Of TDA/TCA Register Only For Units</strong>
            </div>
          </td>
        </tr>
      </table>
            ...
            <td>
              <div align="left">
                <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode"
                        tabindex="1" onchange="common_LoadOffice(this.value);Suppl_Number_CheckNew();"></select>
              </div>
            </td>
          </tr>
         <tr class="table">
