...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');">
 ...
 <form name="frmauto_Fund" id="frmauto_Fund" action="../../../../../../TDA_Reports_HO_only" method="GET" onsubmit="return checkNull()"> 
               ...
               <td>
                <div align="left">
                	<select name="txtStatus" id="txtStatus" >
                		...
                		<option value="1" >Acceptance Pending</option>      
                		<option value="2">Suspense Head Clearance Pending</option>    
                		<option value="3">Rejected Items - RJV made</option> 
                		<option value="4">Rejected items - Pending RJV</option>
