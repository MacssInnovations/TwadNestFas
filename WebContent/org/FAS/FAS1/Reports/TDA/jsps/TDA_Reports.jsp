...
<html>
  <head>
    ...
    <script type="text/javascript" language="javascript">
     ...
     document.frmtparaisedReport.txtCB_Year.value=year;
     document.frmtparaisedReport.txtCB_Month.value=month;
             
     /** Load From Cash Book Month and From Cash Book Year during Form Load */
     document.frmtparaisedReport.txtCB_Year_from.value=year;
     document.frmtparaisedReport.txtCB_Month_from.value=month;
     
     /** Load To Cash Book Month and To Cash Book Year during Form Load */
     document.frmtparaisedReport.txtCB_Year_to.value=year;
     document.frmtparaisedReport.txtCB_Month_to.value=month;
  ...
  <form name="frmtparaisedReport" method="POST"  action="../../../../../../TDA_Reports" onsubmit="return checkNull()">
  
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TDA Report</strong>
            </div>
          </td>
        </tr>
      </table>
