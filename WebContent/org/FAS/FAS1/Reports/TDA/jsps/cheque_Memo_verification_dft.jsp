...
<title>Cheque Memo and Payments(Defunct)</title>
...
<form name="cheque_grid" id="cheque_grid" method="post" >
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Cheque Memo and Payments</strong>
            </div>
			...
			src="<%=request.getContextPath()%>/images/Loading.gif" height="200"></div>
          </td>
        </tr>
      </table>
      <div align="center">
          ...
          <tr align="left">
            ...
            <td>
	          ...
	          <option value="12">December</option>
                ...
                <input type="button" name="gobtn" id="gobtn" value="Go" onclick="callGrid_Memo1();"></input>
              </div>
            </td>
         ...
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            ...
            <!--     <th>Cheque Memo No</th>
                   <th>Cheque Memo Date</th> <th>Difference</th>-->
