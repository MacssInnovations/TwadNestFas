...
<html>
  <head>
    ...
    <title>Fund Transfer Reconciliation</title>
   ...
   <script type="text/javascript"
    ...
    <script type="text/javascript" src="../scripts/Fund_Transfer_reconcillation_atHO_JS.js"></script>
   ...
   <script type="text/javascript"
    ...
    <script type="text/javascript" language="javascript">
     ...
     function onlyregion()
     {
    	 document.frmGeneralLedgerReport.displayingOrder[0].checked=true;
      
        document.frmGeneralLedgerReport.displayingOrder[1].disabled=true;	
        cb_month_year("RW") ;
     }
     function bothregionbank()
     {
    	
    	 document.frmGeneralLedgerReport.displayingOrder[1].disabled=false;	
  ...
  <body class="table" onload="loadyear_month();test_one();" >
   <%
...
%>
  ...
  <form name="frmGeneralLedgerReport" id="frmGeneralLedgerReport" method="POST" action="../../../../../../Fund_Transfer_Reconciliation_atHo" >
    <input type="hidden" id="hid" name="hid" value="">
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Fund Transfer Reconciliation at HO</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="LoadOffice(this.value);test_one();" >
                     <!-- <option value="0"> Select Account Unit </option>-->
                          <%
                          
                        //added sathya on16Mar2012
                          String FAS_FEW_LIST = "";
                                ...
                                rs=ps.executeQuery();
                                  ...
                                  if(rs.next())
                                  {
                                      ...
                                      rs.close();
                                          ...
                                          if(session.getAttribute("FAS_FEW_LIST")!=null && ((String)session.getAttribute("FAS_FEW_LIST")).equalsIgnoreCase("YES"))
                                          { 
                                             String su="select ACCOUNTING_UNIT_ID,ACCOUNTING_UNIT_NAME,OFFICE_WING_SINO from FAS_MST_ACCT_UNITS where ACCOUNTING_UNIT_OFFICE_ID=? and OFFICE_WING_SINO=(2)";
                                             ps=con.prepareStatement(su);
                                             ps.setInt(1,oid);
                                             rs=ps.executeQuery();
                                              while(rs.next())
           ...
           <td class="table">
              <div align="left">
                 Cash Book Year &amp; Month <font color="#ff2121">*</font></div></td>
          ...
          <tr>
                        ...
                        <td colspan="3" align="left">
                            <input type=radio name=seletype value="accounted" checked onclick="bothregionbank()">Accounted
                            <input type=radio name=seletype  value="notaccounted" onclick="onlyregion()" >Not Accounted
