...
%>
   ...
   <input type="hidden" id="hid" name="hid" value="Unit">
            ...
            <td>
              ...
              <tr>
                        ...
                        <td colspan="3" align="left">
                            <input type=radio name=seletype value="accounted" checked>Accounted
                            <input type=radio name=seletype  value="notaccounted">Not Accounted
