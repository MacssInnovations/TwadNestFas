...
<html>
  <head>
   ...
   <link href="../../../../../../css/Sample3.css" rel='stylesheet'
    ...
    <title>Fund Transfer Reconciliation at HO</title>
  </head>
  <body class="table"
...
%>
   ...
   <input type="hidden" id="hid" name="hid" value="FTR_HO">
   
      <table width="100%">
        <tr>
          <td class="tdH">
            <center>
              <b>Fund Transfer Reconciliation at HO</b>
            </center>
          </td>
        </tr>
          ...
          <table width="100%">
              ...
              <tr>
                    ...
                    <tr>
                    <td align="left">
                    Bank Type:<font color="#ff2121">*</font>
                    </td>
                    <td colspan="3" align="left">
                       <select name="txtBankAccountNo" id="txtBankAccountNo" >
                    <option value="All">ALL</option>
                    <%
                   String qry="Select B.Bank_Ac_No,  C.Bank_Short_Name  || '-'  || B.Bank_Ac_Type_Id  ||'-'  || B.Bank_Ac_No As Bankshow"+ 
                   " FROM FAS_OFFICE_BANK_AC_CURRENT b,  Fas_Mst_Banks C "+
                   " Where B.Bank_Id         =C.Bank_Id And B.Accounting_Unit_Id=5 And Module_Id           ='MF009' "+
                   " AND CR_DR_TYPE          ='DR' AND b.STATUS            ='Y'";
                    ps=con.prepareStatement(qry);
                    rs=ps.executeQuery();
                    while(rs.next()){
                    	out.println("<option value="+rs.getString("Bank_Ac_No")+">"+rs.getString("Bankshow")+"</option>");
                    }
                    %>
                    </select>
                    </td>
