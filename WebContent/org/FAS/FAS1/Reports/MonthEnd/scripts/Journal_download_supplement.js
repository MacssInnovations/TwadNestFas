...
{
	//alert("llll");
	 var from_txtCB_Year=document.getElementById("txtCB_Year").value;
	 if(from_txtCB_Year=="")
		 {
		 alert("Enter CashBookYear");
		 return false;
		 }
	 else if(document.getElementById("txtCB_Year").value.length<4)
		 {
...
{       
		 //alert("coming here in supplement journal download.js");
	     var from_txtCB_Year=document.getElementById("txtCB_Year").value;
		 var from_txtCB_Month=document.getElementById("txtCB_Month").value;
         url="../../../../../Jrnl_download_sup?command=forJournalTBstatus&from_txtCB_Year="+from_txtCB_Year+"&from_txtCB_Month="+from_txtCB_Month;
        // alert(url);
         req=getTransport();
