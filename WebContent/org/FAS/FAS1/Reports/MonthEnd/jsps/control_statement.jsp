...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/View_Receipt_count_Region.js"></script>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/control_statement.js"></script>
    <script language="javascript" type="text/javascript">
  ...
  <form name="control_fig" id="control_fig" method="POST"
                 action="../../../../../../control_statement" onsubmit="return checkNull();">
                 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>Month Wise Control Statement</b></center></td>
        </tr>
          <tr>
            <td>
                    ...
                    <select size="1" name="txtRegionId" id="txtRegionId" tabindex="1">
                     ...
                     <option value="1">Entire State</option>
                      ...
                      try{                             
                                ...
                                ps=con.prepareStatement("select OFFICE_NAME,OFFICE_ID from COM_MST_OFFICES where OFFICE_LEVEL_ID in ('RN','HO') and OFFICE_STATUS_ID='CR' and OFFICE_ID!=6777");
                                rs=ps.executeQuery();
                                while(rs.next())
                                {
           ...
           <tr align="left">
            ...
            <td>
              <div align="left">
                 <input type="radio" name="Acc_Head_Type" id="Acc_Head_Type_A" value="A"  onclick="checkType()"/> All 
                 <input type="radio" name="Acc_Head_Type" id="Acc_Head_Type_S" value="S" checked onclick="checkType()"/> Single                  
              </div>
            </td>
          </tr>
         ...
         <tr align="left">
          ...
          <td>
            <div align="left">               
              ...
              onkeypress="return numbersonly(event)" onblur="doFunction('checkCode','null');sixdigit();"tabindex="4"/>               
            ...
            <td>
              <div align="left">
                <input type="text" name="txtsupplement_no" id="txtsupplement_no" value=0
                       tabindex="3" maxlength="4" size="3"
                       onkeypress="return numbersonly(event)"></input>                 
                </div>
            </td>
          </tr>                             
