...
<html>
  <head>
    ...
    <title>Cash and Bank Collection Report </title>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/Cash_and_Bank_Collection_Report.js"></script>
    <script type="text/javascript"
  ...
  <body class="table"
        onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')"><form action="../../../../../../Cash_and_Bank_Collection_Report1.kv"
                                                                           name="cash_and_bank_collection"
                                                                           id="cash_and_bank_collection"
                                                                           method="post"
       ...
       <%
        ...
        <% 
                ...
                System.out.println("Getting attribute::::"+session.getAttribute("FAS_SU"));
                //int empid=10099;
                int  oid=0;
                String oname="";
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Cash and Bank Collection Report </center>
          </td>
        </tr>
     <!--   <tr class="table">
          <td>
                                  ...
                                  if(rs.next())
                                  {
                                      ...
                                      rs.close();
                                         // if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
                                          ...
                                          System.out.println("inside the if part i.e., office id is 5000");
                                  }
                              ps.close();
                              rs.close();
                              }
                                  ...
                                  {
                                    System.out.println("else part i.e., employee other than oid=5000 HO");
