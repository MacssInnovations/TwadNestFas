...
<html>
  <head>
    ...
    <title>GPF Report</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
    <script language="javascript" type="text/javascript"
            src="../scripts/GPF_Report.js"></script>
  ...
  %><% 
   ...
   %><form action="../../../../../../GPF_Report" name="miscRep" method="post"
           onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Report on
                    Field&nbsp;Expenditure&nbsp;incurred&nbsp;on&nbsp;maintenance&nbsp;of&nbsp;CWSS</center>
          </td>
        </tr>
        <tr align="left">
          <td class="table">
