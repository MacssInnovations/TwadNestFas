...
<html>
  <head>
    ...
    <title>Report on Demand Raised and Water Charges Collection</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/CWSS.js"></script>
  ...
  <form action="../../../../../../CWSS" name="miscRep" method="post" onsubmit="return checknull()">
  <table cellspacing="2" cellpadding="3" border="1" width="100%">
  <tr>
        <td class="tdH" colspan="2"><center>Report on Field&nbsp;Expenditure&nbsp;incurred&nbsp;on&nbsp;maintenance&nbsp;of&nbsp;CWSS</center></td>
  </tr>
