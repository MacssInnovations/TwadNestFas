...
<title>List Of Fund Transfered Units Report</title>
<script type="text/javascript"
    ...
    <script type="text/javascript"
            ...
            function loadyear_month()
            {
       		     ...
       		     document.bank_to_office.txtCB_Year.value=year;
       		     document.bank_to_office.txtCB_Month.value=month;
...
<form name="bank_to_office" id="bank_to_office"  method="POST" 
action="../../../../../../list_of_fund_transfered_servlet" >
<input  type="hidden" name="ReportType" id="ReportType" value="Office" >
        <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>List Of Fund Transfered Units Report</strong>
            </div>
          </td>
        </tr>
      </table>
