...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/FundsReceivedByOfficeJS.js"></script>
   ...
   %>
     ...
     <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Funds Received By Office </strong>
          </div>
        </td>
      </tr>
    </table>
                ...
                <td class="table">
                    ...
                    <%
                     ...
                     {        
                      ...
                      ps=con.prepareStatement("select bank_id,bank_name from fas_mst_banks order by 1");
                      rs=ps.executeQuery();
