...
<title>TDA/TCA For March_April</title>
<script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/verify_TDA_TCA.js"></script>
...
<form name="tda_tca_grid" id="tda_tca_grid" method="post" action="../../../../../../Twad_common_servlet?Command=Add" onsubmit="return checkNull();">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TDA/TCA Verification</strong>
            </div>
          </td>
        </tr>
      </table>
         ...
         <tr class="table">
          ...
          <tr>
                        ...
                        <td colspan="3" align="left">
                            <input type=radio name=txtoption id=txtoption value="mr" onclick="callGrid();">March-2012-Regular
                            <input type=radio name=txtoption id=txtoption value="ms" onclick="callGrid();">March-2012-Supplement
                            <input type=radio name=txtoption id=txtoption value="ar" onclick="callGrid();">April-2012-Regular
                      <!--    <input type="text" id="countId" value=0></input>  -->  
                        </td>
      ...
      <table cellspacing="2" cellpadding="3" width="100%" id="hTable1" style="display:none">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>March-2012-Regular</strong>
            </div>
          </td>
        </tr>
      </table>
      
      <table cellspacing="2" cellpadding="3" width="100%" id="hTable2" style="display:none">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>March-2012-Supplement</strong>
            </div>
          </td>
        </tr>
      </table>
      <table cellspacing="2" cellpadding="3" width="100%" id="hTable3" style="display:none">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>April-2012-Regular</strong>
            </div>
          </td>
        </tr>
      </table>
          ...
          <tr class="tdH">
            ...
            <table id="mytable1" cellspacing="3" cellpadding="2"
              ...
              <tr class="table">
                ...
                <th>Trial Balance DR Amount</th>
                <th>Trial Balance CR Amount</th>
                <th>TB NET Amount</th>
                <th>Difference</th>
