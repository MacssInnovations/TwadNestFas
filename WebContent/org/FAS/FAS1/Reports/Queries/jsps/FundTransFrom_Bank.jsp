...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/FundTransFrom_Bank.js"></script>
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                     ...
                     <!-- <option value="0"> Select Account Unit </option>-->
                      ...
                      String unitname="";
                       try{
                                             ...
                                             String su="select ACCOUNTING_UNIT_ID,ACCOUNTING_UNIT_NAME from FAS_MST_ACCT_UNITS where ACCOUNTING_UNIT_ID=5 order by ACCOUNTING_UNIT_NAME";
              ...
              <tr class="table">
                ...
                
                {
                        ...
                        ps=con.prepareStatement("select ACCOUNTING_UNIT_ID, ACCOUNTING_FOR_OFFICE_ID  from FAS_MST_ACCT_UNIT_OFFICES where ACCOUNTING_UNIT_ID=5");
                        //ps.setInt(1,unitid);
                        rs=ps.executeQuery();
