...
//alert("show");
        ...
        var cmbbankid=document.getElementById("txt_bkname").value;
        //alert("cmbbankid----"+cmbbankid);
        ...
        {  
           ...
           // alert(txtCB_Month);
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
              ...
              // alert("inside");
                var url="../../../../../../Funds_ReceivedServ_Office.con?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbbankid1="+cmbbankid;
                //alert("url---->"+url);
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            ...
            //alert("date");
                //var txtReceipt_type='BR';
                var url="../../../../../../Funds_ReceivedServ_Office.con?Command=Funds_ReceivedServ_Office&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbbankid1="+cmbbankid;
                document.Bank_Rec_ListAll_Form.action=url;
                document.Bank_Rec_ListAll_Form.method="post";
                document.Bank_Rec_ListAll_Form.submit();
