        ...
        {  
           ...
           // alert(txtCB_Month);
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../../FundTransFfrom_HO?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            ...
            //alert("date");
                ...
                var url="../../../../../../FundTransFfrom_HO?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
