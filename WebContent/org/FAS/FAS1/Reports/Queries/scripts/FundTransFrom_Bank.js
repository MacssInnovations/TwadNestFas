        ...
        {  
           ...
           // alert(txtCB_Month);
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../../FundTransFfrom_Bank?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbBankId="+cmbBankId;
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            ...
            //alert("date");
                ...
                var url="../../../../../../FundTransFfrom_Bank?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbBankId="+cmbBankId;
                document.Bank_Rec_ListAll_Form.action=url;
                document.Bank_Rec_ListAll_Form.method="post";
                document.Bank_Rec_ListAll_Form.submit();
