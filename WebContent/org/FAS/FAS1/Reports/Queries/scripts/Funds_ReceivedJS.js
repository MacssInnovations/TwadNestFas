...
//alert("show");
       ...
       // alert(cmbStatus);
        ...
        {  
         ...
         //   alert(txtCB_Month);
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
              ...
              // alert("inside");
                var url="../../../../../../Funds_ReceivedServ.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&cmbStatus="+cmbStatus+"&cmbBankId="+cmbBankId;
             // alert(url);
        ...
        {  
           ...
           //alert("date");
                //var txtReceipt_type='BR';
                var url="../../../../../../Funds_ReceivedServ.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtFrom_date="+txtFrom_date+"&txtTo_date="+txtTo_date+"&cmbStatus="+cmbStatus+"&cmbBankId="+cmbBankId;
              // alert(url);
                document.Bank_Rec_ListAll_Form.action=url;
                document.Bank_Rec_ListAll_Form.method="post";
                document.Bank_Rec_ListAll_Form.submit();
