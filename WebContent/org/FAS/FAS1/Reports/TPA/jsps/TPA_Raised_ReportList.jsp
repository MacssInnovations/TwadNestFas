...
<html>
  ...
  <form name="frmtparaisedReport" method="POST"  action="../../../../../../TPA_Raised_Report" >
  
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>TPA Raised Report</strong>
            </div>
          </td>
        </tr>
      </table>
                ...
                <td>
                  <div align="left">
                    <select name="reportname" id="reportname" >
                     ...
                     <option value="RaisedReport"> TPA Raised</option>
                      <option value="AcceptedReport">TPA Accepted</option>
                      <option value="PendingReport">TPA Pending</option>
                       <option value="TPAALL">TPA All</option>
                       </select>                                           
                  </div>
                </td>
              </tr> 
