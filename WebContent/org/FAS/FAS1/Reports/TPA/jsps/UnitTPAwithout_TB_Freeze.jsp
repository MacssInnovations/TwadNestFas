...
<html>
  <head>
    ...
    <title>Unit with TPA without TB Freeze</title>
   ...
   --><script type="text/javascript" language="javascript">
    function loadyear_month(){
               ...
               document.frmTDA_Report.txtCB_Year.value=year;
               document.frmTDA_Report.txtCB_Month.value=month;
                       
               document.frmTDA_Report.txtCB_Year_from.value=year;
               document.frmTDA_Report.txtCB_Month_from.value=month;
               
               document.frmTDA_Report.txtCB_Year_to.value=year;
               document.frmTDA_Report.txtCB_Month_to.value=month;
      }
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');">
 ...
 <form name="frmTDA_Report" id="frmTDA_Report" action="../../../../../../TPAReports" method="GET" > 
   ...
   %>
    ...
    <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Unit with TPA without TB Freeze</font>
          </div>
        </td>
      </tr>
    </table>
        ...
        <!--    
              <tr class="table">
               ...
               <td>
                <div align="left">
                <input type="radio" name="txtTPA" id="txtTPA" value="Accept" checked="checked"/>TPA Originated & Accepted
                   <input type="radio" name="txtTPA" id="txtTPA" value="NotAccept"/>TPA Originated & Not Accepted
                   <input type="radio" name="txtTPA" id="txtTPA" value="TBNotAccept"/>TPA Originaged , Accepted but TB not freezed
               ...
               <td>
                <div align="left">
                <input type="radio" name="txtoption" id="txtoption" value="PDF" checked="checked"/>PDF
