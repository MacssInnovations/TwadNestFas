  ...
  <head>
   ...
   <script type="text/javascript" language="javascript">
    function loadyear_month(){
               ...
               document.frmTDA_ReportView.txtCB_Year.value=year;
               document.frmTDA_ReportView.txtCB_Month.value=month;
                       
               document.frmTDA_ReportView.txtCB_Year_from.value=year;
               document.frmTDA_ReportView.txtCB_Month_from.value=month;
               
               document.frmTDA_ReportView.txtCB_Year_to.value=year;
               document.frmTDA_ReportView.txtCB_Month_to.value=month;
      }
...
<body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');">
 ...
 <form name="frmTDA_ReportView" id="frmTDA_ReportView" action="../../../../../../TPAReports_Grp" method="post" onsubmit="return checkNull()"> 
