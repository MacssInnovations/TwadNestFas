function checknull()
{
   ...
   /* if((document.frmSubLedgerPartywise.cmbMas_SL_type.value=="") || (document.frmSubLedgerPartywise.cmbMas_SL_type.value.length<=0) || (document.frmSubLedgerPartywise.cmbMas_SL_type.value=="0"))
    {
        alert("Please Select Sub-Ledger Type");
        document.frmSubLedgerPartywise.cmbMas_SL_type.focus();
        return false;
    }*/
 return true;
}
