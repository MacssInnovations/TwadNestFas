...
function submit_form()
{
	//alert("Inside Submit Function!!!!!!")
      /** For All offices for some accounting units added by sathya on 26March2012 */
  // if(document.frmGeneralLedgerReport.all_office.checked==true)
	// change on july joe 2014
//	alert(document.getElementById("all_office").value);
	if(document.getElementById("all_office").value=="all_office")
  {
