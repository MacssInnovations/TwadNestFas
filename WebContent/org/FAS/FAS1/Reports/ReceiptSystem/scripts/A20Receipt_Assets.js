...
function getTransport()
{
 ...
 function nullCheck(){
	 var accounting_unit_id=document.frmA20Receipt.cmbAcc_UnitCode;
		...
		var accounting_unit_office_id = document.frmA20Receipt.cmbOffice_code;
		...
		var cmbFinancialYear1 = document.frmA20Receipt.cmbFinancialYear;
		...
		var to_txtCB_Year=document.frmA20Receipt.to_txtCB_Year;
		...
		var from_txtCB_Year=document.frmA20Receipt.from_txtCB_Year;
 ...
 function checkToYear(){
	 var cmbFinancialYear1 = document.frmA20Receipt.cmbFinancialYear;
	 var cmbFinancialYear2 = document.frmA20Receipt.cmbFinancialYear.value;
	 var tomonth=document.frmA20Receipt.to_txtCB_Month;
 ...
 function checkFromYear(){
	 var cmbFinancialYear1 = document.frmA20Receipt.cmbFinancialYear;
	 var cmbFinancialYear2 = document.frmA20Receipt.cmbFinancialYear.value;
	var frommonth=document.frmA20Receipt.from_txtCB_Month;
 ...
 function callServer(command){  
     var accounting_unit_id=document.frmA20Receipt.cmbAcc_UnitCode.value;
 var accounting_unit_office_id = document.frmA20Receipt.cmbOffice_code.value;
 var assetmajor=document.frmA20Receipt.cmbmajorasset.value;
 var financial_year = document.frmA20Receipt.cmbFinancialYear.value;  
 var assetmajor=document.frmA20Receipt.cmbmajorasset.value;
 var url="";
 if(command=="loadMajor"){
  	url="../../../../../../A20Receipt_Assets?command=loadMajor";
  	//alert(url);
...
document.frmA20Receipt.from_txtCB_Year.value=year;
document.frmA20Receipt.from_txtCB_Month.value=month;

document.frmA20Receipt.to_txtCB_Year.value=year;
document.frmA20Receipt.to_txtCB_Month.value=month;
 }
 function clearAll()
{
