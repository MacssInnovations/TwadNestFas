function checknull()
{
    ...
    if((document.frmA14Report.cmbOffice_code.value=="") || (document.frmA14Report.cmbOffice_code.value.length<=0) || (document.frmA14Report.cmbOffice_code.value=="0"))
    {
        alert("Please Select Accounting Office Code");
        document.frmA14Report.cmbOffice_code.focus();
        return false;
