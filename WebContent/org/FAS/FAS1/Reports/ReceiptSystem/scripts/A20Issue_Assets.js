...
function getTransport()
{
 ...
 function nullCheck(){
	 var accounting_unit_id=document.frmA20Issue.cmbAcc_UnitCode;
		...
		var accounting_unit_office_id = document.frmA20Issue.cmbOffice_code;
		...
		var cmbFinancialYear1 = document.frmA20Issue.cmbFinancialYear;
		...
		var to_txtCB_Year=document.frmA20Issue.to_txtCB_Year;
		...
		var from_txtCB_Year=document.frmA20Issue.from_txtCB_Year;
 ...
 function checkToYear(){
	 var cmbFinancialYear1 = document.frmA20Issue.cmbFinancialYear;
	 var cmbFinancialYear2 = document.frmA20Issue.cmbFinancialYear.value;
	 var tomonth=document.frmA20Issue.to_txtCB_Month;
	 if(cmbFinancialYear1.value=="")
		{ 
		     alert("Please select the 'Financial Year'");
		     cmbFinancialYear1.focus();
 ...
 function checkFromYear(){
	 var cmbFinancialYear1 = document.frmA20Issue.cmbFinancialYear;
	 var cmbFinancialYear2 = document.frmA20Issue.cmbFinancialYear.value;
	var frommonth=document.frmA20Issue.from_txtCB_Month;
 ...
 function callServer(command){  
     var accounting_unit_id=document.frmA20Issue.cmbAcc_UnitCode.value;
 var accounting_unit_office_id = document.frmA20Issue.cmbOffice_code.value;
 var assetmajor=document.frmA20Issue.cmbmajorasset.value;
 var financial_year = document.frmA20Issue.cmbFinancialYear.value;  
 var assetmajor=document.frmA20Issue.cmbmajorasset.value;
 var url="";
 if(command=="loadMajor"){
  	url="../../../../../../A20Issue_Assets?command=loadMajor";
  	//alert(url);
...
document.frmA20Issue.from_txtCB_Year.value=year;
document.frmA20Issue.from_txtCB_Month.value=month;

document.frmA20Issue.to_txtCB_Year.value=year;
document.frmA20Issue.to_txtCB_Month.value=month;
 }
 function clearAll()
{
