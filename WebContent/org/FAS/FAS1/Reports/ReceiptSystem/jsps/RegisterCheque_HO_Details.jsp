...
<html>
  <head>
    ...
    <title>Register Cheques Issued System Details</title>
  ...
  <form name="frmReceivedRegister" method="POST" action="../../../../../../RegisterCheque_HO_Details" onsubmit="return checknull()">
