...
<html>
  <head>
    ...
    <title>MIS_WorksExpenditure_AnnualGrouping_JSP</title>
  ...
  <form action="../../../../../../MIS_WorksExpenditure_AnnualGrouping_Serv" name="miscRep" method="post" onsubmit="return checknull()">
  <table cellspacing="2" cellpadding="3" border="1" width="100%">
  <tr>
        <td class="tdH" colspan="2"><center>Annual Grouping (Detailed) </center></td>
  </tr>
