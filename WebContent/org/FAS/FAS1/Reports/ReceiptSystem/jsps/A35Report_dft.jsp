...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/A35ScheduleReport.js"></script>
    <script type="text/javascript"
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmA35Report.txtCB_Year.value=year
        document.frmA35Report.txtCB_Month.value=month;
  ...
  <body class="table"
        onload="loadyear_month();Schedule_Account_Heads('A35');">
        <form action="../../../../../../A35ScheduleServlet.con"
                                                                                                         id="frmA35Report"
                                                                                                         name="frmA35Report"
                                                                                                         method="post"
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>A 35 Schedule of Sundry Debtors</center>
          </td>
        </tr>
        <tr class="table">
                <td>
        ...
        <tr align="left">
          ...
          <td>
            <div align="left">
                ...
                <input type="radio" name="reporttype" id="reporttype" value="1" checked /> Regular &nbsp;
                <input type="radio" name="reporttype" id="reporttype" value="2"/> Regular( Account Head Code on New Page ) &nbsp;
                <input type="radio" name="reporttype" id="reporttype" value="3"/> Supplement 
