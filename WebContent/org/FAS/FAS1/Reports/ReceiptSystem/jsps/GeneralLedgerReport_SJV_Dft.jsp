...
<html>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_Check_allsup();"><form name="frmGeneralLedgerReport"
                                                      id="frmGeneralLedgerReport"
                                                      method="POST" action="../../../../../../GeneralLedgerReport_SJV.kv"
   ...
   %>
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Posting Report (Defunct) </strong>
            </div>
          </td>
        </tr>
      </table>
        ...
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr align="left">
            ...
            <td>
              <div>
                Year 
                <input type="text" name="txtCB_Year" id="txtCB_Year"  onblur="Suppl_Number_Check();"
