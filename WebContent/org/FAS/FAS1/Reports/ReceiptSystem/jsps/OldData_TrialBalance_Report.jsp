...
<html>
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../Old_Data_TrialBalance_Report" onsubmit="return checknull()">
   <%
  Connection con=null;
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1">
                     <!-- <option value="0"> Select Account Unit </option>-->
                      ...
                      try{
                                    ...
                                    ps=con.prepareStatement("select ACCOUNTING_UNIT_ID,ACCOUNTING_UNIT_NAME from FAS_MST_ACCNT_UNIT_OLD9507 )");
                                    //ps.setInt(1,unitid);
                                    rs=ps.executeQuery();
                                      if(rs.next())
                                      {
