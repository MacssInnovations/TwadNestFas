...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/MIS_WorksExpenditure_Abstract_JS.js"></script>
  ...
  <form action="../../../../../../MIS_WorksExpenditure_Abstract_Serv" name="miscRep" method="post" onsubmit="return checknull()">
