...
<html>
  ...
  <body class="table"
        ...
        <form name="frmReceivedRegister" method="POST" action="../../../../../../RegisterChequeServletAbs.con" onsubmit="return checknull()">
        ...
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr class="table">
           ...
           <tr align="left">
            <td>Total</td>
            <td>
              <input type="radio" name="cnrn" id="cnrn" value="che"
                     checked="checked"></input>
              ChequeNoWise
           <!--    <input type="radio" name="cnrn" id="cnrn" value="rec"></input>ReceiptNoWise  -->
