...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Fund_Transfer_Unspent_CollJS.js"></script>
  ...
  <form name="frmFundReceive" method="POST" action="../../../../../../Fund_Transfer_Unspent_CollServ" onsubmit="return checknull()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Fund Transfer Report</strong>
          </div>
        </td>
      </tr>
    </table>
