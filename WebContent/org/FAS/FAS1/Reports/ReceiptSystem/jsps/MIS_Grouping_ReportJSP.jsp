...
<html>
  <head>
    ...
    <title>MIS_Grouping_ReportJSP</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/MIS_Grouping_ReportJS.js"></script>
  ...
  <form action="../../../../../../MIS_Grouping_ReportServ" name="miscRep" method="post" onsubmit="return checknull()">
  <%
  ...
  <tr>
        <td class="tdH" colspan="2"><center>Major Head Abstract</center></td>
  </tr>
   <tr align="left">
          <td class="table">
            <div align="left">
            ...
            <td>
             <div align="left">
                ...
                <%
                    ResultSet rs=statement.executeQuery("select major_head_code,major_head_desc from com_mst_major_heads");
                    while(rs.next())
                    {
