...
<html>
  <head>
    ...
    <title>A20 Issues Of Assets </title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script language="javascript" type="text/javascript" src="../scripts/A20Issue_Assets.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="frmA20Issue" id="frmA20Issue" method="post" action="../../../../../../A20Issue_Assets" onsubmit="return nullCheck()">
