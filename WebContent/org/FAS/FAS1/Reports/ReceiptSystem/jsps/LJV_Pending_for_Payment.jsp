...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/LJV_Pending_for_Payment.js"></script>
    ...
    <script language="javascript" type="text/javascript">
                ...
                document.LJV_Pending_Payment_Report.txtCB_Year.value=year
                document.LJV_Pending_Payment_Report.txtCB_Month.value=month;
  ...
  <form action="../../../../../../LJV_Pending_for_Payment.view" name=LJV_Pending_Payment_Report method=post onsubmit="return nullcheck();"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>List of LJV Pending for Payment</b></center></td>
        </tr>
          <tr>
            <td>
              ...
              <!--      <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.LJV_Pending_Payment_Report.txtfromdate);" alt="Show Calendar"
                        ...
                        <td>
                            ...
                            <img src="../../../../../../images/calendr3.gif" onclick="showCalendarControl(document.LJV_Pending_Payment_Report.txttodate);" alt="Show Calendar" ></img>
                         </td>
                    </tr>
                    <tr>
                        <td>
