...
<html>
  <head>
    ...
    <title>Sales Tax Recovery Report</title>
  ...
  <body class="table" onload="loadyear_month();"><form action="../../../../../../SalesTax_Recovery_Report.kv?Command=Summary"
                                                       name="miscRep"
                                                       method="post"
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Sales&nbsp;Tax Recovery Report</center>
          </td>
        </tr>
        <tr align="left">
          <td class="table">
