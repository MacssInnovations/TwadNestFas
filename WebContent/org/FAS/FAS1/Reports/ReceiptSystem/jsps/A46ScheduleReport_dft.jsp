...
<html>
  <head>
    ...
    <title>A46 schedule</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
    <script language="javascript" type="text/javascript"
            src="../scripts/A46ScheduleReport.js"></script>
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A46');">
   
   <form  name="frmA46Report" id="frmA46Report" action="../../../../../../A46ScheduleServlet.con" method="post" onsubmit="return checknull()">
   <%
  Connection con=null;
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>A 46 Schedule of Payments</center>
          </td>
        </tr>
           <tr class="table">
                <td>
