...
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>A14Report</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/A14ScheduleReport.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
		     ...
		     document.frmA14Report.txtCB_Year.value=year;
		     document.frmA14Report.txtCB_Month.value=month;
...
<form name="frmA14Report" method="POST" action="../../../../../../A14ScheduleReport" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Statement Of Liabilities </strong>
            </div>
          </td>
        </tr>
      </table>
