...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/A45ScheduleReport_New.js"></script>
    <script type="text/javascript"
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A45');">
  <form action="../../../../../../A45ScheduleServlet_New.kv"
           name="frmA45Report" method="post" onsubmit="return checknull()">
           <%
  Connection con=null;
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>A 45 Schedule of Payments</center>
          </td>
        </tr>
       <tr class="table">
                <td>
