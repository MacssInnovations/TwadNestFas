...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/GPFReport_VoucherWise.js"></script>
  ...
  <form action="" 
      ...
      <table cellspacing="2" cellpadding="3" border="0" width="100%">
       ...
       <!--  <input type="button" id="go" name="go" value="Go" onclick="FormSubmit_new()"/>    -->   
        ...
        <tr align="left">
          <td class="table">
            <div align="left" id="reg_id" style="display:none">Peroid From</div>
          </td>
          <td>
            <div align="left" id="reg_date_id" style="display:none">
                  From 
