...
<html>
  ...
  <form action="../../../../../../ListOfReceiptServlet.con" name=frmReport method=post onsubmit="return nullcheck();"> 
    <table width="100%" >
        <tr>
            <td class="tdH"><center><b>Transactions Listings-Document Wise</b></center></td>
        </tr>
          <tr>
            <td>
