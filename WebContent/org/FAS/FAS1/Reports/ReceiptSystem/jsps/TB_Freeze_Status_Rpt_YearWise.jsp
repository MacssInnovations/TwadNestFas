...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/TB_Freeze_Status_Rpt.js"></script>
    <script type="text/javascript"
    ...
    <title>TB_Freeze_Status_Rpt</title>
  </head>
<body class="table"
  ...
  <form action="../../../../../../TB_Freeze_Status_Rpt_Yearwise?" name=frmReport method=post> 
    <table width="930" border="1" align="center">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><strong>TB_Freeze_Status_Report</strong></div>		</td>
	</tr>
