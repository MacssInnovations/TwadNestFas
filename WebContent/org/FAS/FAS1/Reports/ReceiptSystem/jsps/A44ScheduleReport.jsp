...
<html>
  <head>
    ...
    <title>A44 Schedule</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
    <script language="javascript" type="text/javascript"
            src="../scripts/A44ScheduleReport.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmA44Report.txtCB_Year.value=year;
        document.frmA44Report.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.frmA44Report.reporttype[0].checked==true)
         {
         ...
         else if(document.frmA44Report.reporttype[1].checked==true)
         {
        	 dispsupnochosen1.style.display="none";
             dispsupnochosen2.style.display="none";
         }
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A44');LoadAccountingUnitID('FOR_LIST_1')">
  <form action="../../../../../../A44ScheduleServlet.con"
                                                                                    name="frmA44Report"
                                                                                    method="post"
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>A 44 Schedule of Medical/Travelling &amp; Conveyance Expenses</center>
          </td>
        </tr>
        <tr class="table">
          <td>
        ...
        <tr align="left">
          ...
          <td>
            <div align="left">
              <input type="radio" name="reporttype" id="reporttype" value="1"
                     checked="checked" onclick="ChooseReptype(this.value);" />
               Regular &nbsp; 
              <input type="radio" name="reporttype" id="reporttype" value="2" onclick="ChooseReptype(this.value);"  />
               Regular(Account Head Code on New Page) &nbsp; 
              <input type="radio" name="reporttype" id="reporttype" value="3"onclick="ChooseReptype(this.value);" />
               Supplement 
            </div>
          </td>
        </tr>
