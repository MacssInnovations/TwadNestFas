...
<html>
  ...
  <form name="DCBReceipt_Report" method="POST" action="../../../../../../DCBReceipt_Reports"  onsubmit="return nullcheck()">
      ...
      <div align="center">
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr>
                ...
                <tr>
                <td>Whether to include Vr number and date:</td>
                <td colspan="3">
                  <input type="radio" name="incl_Vr" id="incl_Vr"
                         value="Y" checked="checked"></input>
                  YES
                  <input type="radio" name="incl_Vr" id="incl_Vr"
                         value="N"></input>
                  NO
