...
<html>
  <head>
    ...
    <title>Cheques Received Abstract System</title>
  ...
  <body class="table"
        ...
        <form name="frmReceivedRegister" method="POST" action="../../../../../../ChequeAbstractServlet" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Cheques Received Abstract for the Month &amp; Year</strong>
            </div>
          </td>
        </tr>
      </table>
