...
<html>
  <head>
    ...
    <title>Payment of Pending Bill</title>
...
<!--   /*@NK on 29072019*/ -->
  <!-- <input type="hidden" id="hdid" name="hdid" value="pay"> -->
   <input type=radio name=hdid id=hdid value="pay" checked style="display:none">
 <!--   /*@NK on 29072019*/ -->
  <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Payment of Pending Bill</strong>
            </div>
        </td>
      </tr>
    </table>
