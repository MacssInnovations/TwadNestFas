...
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>A4ScheduleReport</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/A4ScheduleReport.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
		     ...
		     document.frmA4ScheduleReport.txtCB_Year.value=year;
		     document.frmA4ScheduleReport.txtCB_Month.value=month;
...
<form name="frmA4ScheduleReport" method="POST" action="../../../../../../A4ScheduleReport" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>ACCOUNT OF RECEIPTS OF ASSETS - A4 Schedule </strong>
            </div>
          </td>
        </tr>
      </table>
