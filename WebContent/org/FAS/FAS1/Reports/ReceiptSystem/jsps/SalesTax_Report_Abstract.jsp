...
<html>
  <head>
    ...
    <title>Sales Tax Recovery Abstract Report</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
    <script language="javascript" type="text/javascript"
            src="../scripts/Misc_Rep_DRWCJS.js"></script>
  ...
  <body class="table" onload="loadyear_month();"><form action="../../../../../../SalesTax_Recovery_Report.kv?Command=Abstract"
                                                       name="miscRep"
                                                       method="post"
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Sales&nbsp;Tax&nbsp;Recovery Abstract Report</center>
          </td>
        </tr>
        <tr align="left">
          <td class="table">
