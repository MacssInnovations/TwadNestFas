...
<html>
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A44');"><form action="../../../../../../A44ScheduleServlet.con"
                                                                                    name="frmA44Report"
                                                                                    method="post"
          ...
          <td>
            <div align="left">
              <input type="radio" name="reporttype" id="reporttype" value="1"
                     checked="checked"/>
               Regular &nbsp; 
              <input type="radio" name="reporttype" id="reporttype" value="2"/>
               Regular(Account Head Code on New Page) &nbsp; 
              <input type="radio" name="reporttype" id="reporttype" value="3"/>
               Supplement 
            </div>
          </td>
        </tr>
