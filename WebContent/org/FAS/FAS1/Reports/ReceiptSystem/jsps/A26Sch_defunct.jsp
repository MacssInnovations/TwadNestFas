...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/A26Sch_defunct.js"></script>
    <script type="text/javascript"
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.A26ScheduleReport_dft.txtCB_Year.value=year
        document.A26ScheduleReport_dft.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.A26ScheduleReport_dft.reporttype[0].checked==true)
         {
         ...
         else if(document.A26ScheduleReport_dft.reporttype[1].checked==true)
         {
  ...
  <form action="../../../../../../A26ScheduleReport_kv.kv" name="A26ScheduleReport_dft" id="A26ScheduleReport_dft" method="post" onsubmit="return checknull()">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>TWAD A26 Sch_defunct </center>
          </td>
        </tr>
        <tr class="table">
                <td>
