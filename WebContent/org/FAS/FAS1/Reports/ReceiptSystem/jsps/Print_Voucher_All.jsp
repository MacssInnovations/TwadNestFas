              ...
              <tr class="table">
                ...
                <td colspan="3">
                  <div align="left">
                    ...
                    <tr class="table">
                        <td>Receipt Type:</td><td colspan=""><select name="cbtype" id="cbtype" onchange="loadmonth();loadDocNo();">
                    ...
                    <tr class="table">
                        ...
                        <td >
                        <!--<input type="radio" name="selection" id=selection value="voucherwise"   onclick="return enable_cheque(this.value)" checked />By Voucher Wise
                        --><input type="radio" name="selection" id=selection value="datewise" onclick="return enable_cheque(this.value)" checked="checked"/> By Date
                            <input type="radio" name="selection"  id=selection value="monthwise" onclick="return enable_cheque(this.value)" />By Cash Book Month
                    </td>   
                    </tr>
                    </table>
                    ...
                    <tr class="table">
                        <td>Cash Book Year & Month</td>
                         ...
                         <td colspan=""><input name="txtCB_Year" id="txtCB_Year" size="4" value="2006" onchange="loadDocNo()" /> 
                    ...
                    <table cellspacing="1" cellpadding="2" border="1" width="100%">
                        ...
                        <td>Cash Book Year & month</td>
                         ...
                         <td colspan=""><input name="txtCB_Yearwise" id="txtCB_Yearwise" size="4" value="2006" /> 
