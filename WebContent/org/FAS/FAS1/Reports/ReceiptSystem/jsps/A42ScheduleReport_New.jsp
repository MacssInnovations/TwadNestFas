...
<html>
  <head>
    ...
    <title>A42 Schedule</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
    <script language="javascript" type="text/javascript"
            src="../scripts/A42ScheduleReport_New.js"></script>
    ...
    <script type="text/javascript"
            src="../../../../../../org/FAS/FAS1/CommonControls/scripts/AccountHead_PopUp.js"></script>
    <script type="text/javascript"
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmA42Report.txtCB_Year.value=year;
        document.frmA42Report.txtCB_Month.value=month;
        
         }
     
     //siva added on 2016-06-10 in the purpose off supplement Number added .
     ///* in the  coming all forms A42,A44,A45,A46,A47,A51
     function ChooseReptype(id)
     {
         ...
         if(document.frmA42Report.reporttype[0].checked==true)
         {
         ...
         else if(document.frmA42Report.reporttype[1].checked==true)
         {
        	 dispsupnochosen1.style.display="none";
             dispsupnochosen2.style.display="none";
         }
  ...
  <body class="table"
        onload="loadyear_month();Schedule_Account_Heads('A42');LoadAccountingUnitID('FOR_LIST_1')"><form action="../../../../../../A42ScheduleReport_New"
                                                                                                         name="frmA42Report"
                                                                                                         id="frmA42Report"
                                                                                                         method="post"
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>A 42 Schedule of Medical/Travelling &amp; Conveyance Expenses</center>
          </td>
        </tr>
