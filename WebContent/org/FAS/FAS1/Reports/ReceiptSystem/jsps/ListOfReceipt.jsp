...
<html>
  <head>
    ...
    <title>Transactions Listings-Document Wise</title>
  </head>
  <body class="table"
        onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')">
        <form action="../../../../../../ListOfReceiptServlet.con"
                                                                           name="frmReport"
                                                                           method="post"
      ...
      <table width="100%">
        <tr>
          <td class="tdH">
            <center>
              <b>Transactions Listings-Document Wise</b>
            </center>
          </td>
        </tr>
        <tr>
          <td>
            <table border="4" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tr>
                ...
                <td colspan="4">
                  <select name="cmbdoctype" id="cmbdoctype">
                    ...
                    <option value="CP">Cash Remittance</option>
                    <option value="SC">Self Cheque</option>
                    <option value="FR">Fund Receipt</option>
                    <!--   <option value="FR-HO">Fund Receipt by HO</option> -->
                    <option value="FT">Fund Transfer</option>
                   <!--     <option value="FT-HO">Fund Transfer by HO</option>-->
              ...
              <tr>
                <td>From Date( WithIn CashBook Month )</td>
                <td>
