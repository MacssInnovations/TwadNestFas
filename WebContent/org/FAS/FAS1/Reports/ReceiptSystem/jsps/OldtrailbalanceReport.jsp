...
<html>
  ...
  //alert("Hai");
   ...
   {
   document.frmOldTrailbalanceReport.month_year[0].checked=false;
   }
   else
   {document.frmOldTrailbalanceReport.month_year[1].checked=false}
   //document.frmOldTrailbalanceReport.month_year[1].checked==false;
   }
...
document.getElementById("unit").style.display="none";
  ...
  <body class="table" onload="loadyear_month();clr();" >
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Old&nbsp;Trail balance Report</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
           ...
           <div id="more_supp" name="more_supp" style="display:none">
             <div align="left">
                ...
                <!--select size="1" name="suppmnt" id="suppmnt" tabindex="1">
                  ...
                  <div align="left" id="unit" style="display:block">
         ...
         From 
          ...
          <select name="txtCB_Year_from"  id="txtCB_Year_from" tabindex="4" onchange="finYr();LoadAccountingUnitIDfin()" >
        ...
        To 
        <select name="txtCB_Year_to" id="txtCB_Year_to" tabindex="3" disabled >
       <!--   <option value="">--Select Year--</option>-->
		...
		<input type="hidden" name="myselect" id="myselect" value="1995-1996"/>          
         ...
         <tr>
          ...
          <td align="left">
                            ...
                            <div id ="optionAHC" name="optionAHC" style="display:block">
                            <input type=radio id="SpecificAHC" name="SpecificAHC" value="All"  onclick="hideacunit();AccHead(this.value)"> Trial Balance for All units for the Year<br>
                            <input type=radio id="SpecificAHC" name="SpecificAHC" value="Specific" onclick="hideacunit();AccHead(this.value)">Month  Details for specific head for all units
                            </div>
                            <div id ="optionAHC1" name="optionAHC1" style="display:none">
                            <input type=radio id="SpecificAHC" name="SpecificAHC" value="Allunits"  onclick="AccHead(this.value)"> Trial Balance for All units for the Year<br>
                             <input type=radio id="SpecificAHC" name="SpecificAHC" value="Specific" onclick="AccHead(this.value)"> Unit wise summary for the head for  the year<br>
                            <!--  <input type=radio id="SpecificAHC" name="SpecificAHC" value="Allunits"  onclick="AccHead(this.value)"> Trial Balance for All units for the Year<br>-->
                            <input type=radio id="SpecificAHC" name="SpecificAHC" value="AllunitsTB"  onclick="AccHead(this.value)"> Trial Balance for the Selected Unit<br>
                            <input type=radio id="SpecificAHC" name="SpecificAHC" value="SpecificTB"  onclick="AccHead(this.value)"> Monthwise details for the unit for the specific head<br>
                             <input type=radio id="SpecificAHC" name="SpecificAHC" value="UnitwiseTB"  onclick="AccHead(this.value)"> Unit wise summary for the year 
                            </div>
