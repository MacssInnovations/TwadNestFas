...
<html>
  <head>
    ...
    <title>A20 Receipt Of Assets </title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script language="javascript" type="text/javascript" src="../scripts/A20Receipt_Assets.js"></script>
  ...
  <body onload="LoadAccountingUnitID('FOR_LIST_1'),loadyear_month(),callServer('loadMajor');">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">A20 Receipt of Assets </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmA20Receipt" id="frmA20Receipt" method="post" action="../../../../../../A20Receipt_Assets" onsubmit="return nullCheck()">
