...
<html>
  <head>
    ...
    <title>Cheque Cancelled Report</title>
    ...
    <script type="text/javascript"
            ...
            function loadyear_month(){
               ...
               document.frmChequeCancelled.txtCB_Year.value=year;
               document.frmChequeCancelled.txtCB_Month.value=month;
            ...
            function checkNull()
            {
                   ...
                   if(document.frmChequeCancelled.month_year[1].checked==true)
                   {
  ...
  <body class="table"
        ...
        <form name="frmChequeCancelled"
                                                                           method="POST"
                                                                           action="../../../../../../Cheque_Cancelled_Report"
                                                                           onsubmit="return checkNull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Cheque Cancelled Report</strong>
            </div>
          </td>
        </tr>
      </table>
