...
<html>
  <head>
    ...
    <title>MIS_AssetLiability_JSP</title>
  ...
  <form action="../../../../../../MIS_AssetLiability_DetailedServ" name="miscRep" method="post" onsubmit="return checknull()">
  <table cellspacing="2" cellpadding="3" border="1" width="100%">
  <tr>
        <td class="tdH" colspan="2"><center>Asset and Liability (Detailed)</center></td>
  </tr>
