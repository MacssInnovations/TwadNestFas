...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/SubLedgerReport_New.js"></script>
  ...
  <body class="table" onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')"><form name="frmSubLedgerReport"
                                                      method="POST"
                                                      action="../../../../../../SubLedgerReportServlet_New"
                                                      onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Sub Ledger Report</strong>
            </div>
          </td>
        </tr>
      </table>
