...
<html>
  <head>
    ...
    <title>Annexure III (a)</title>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script language="javascript" type="text/javascript" src="../scripts/Annex-III(a)JS.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function chkCurMonth()
     {
      ...
      var year_cur=document.getElementById("txtto_CB_Year").value; 
      var month_cur=document.getElementById("txtto_CB_Month").value;
      var today= new Date(); 
      var day=today.getDate();
      var month=today.getMonth();
      month=month+1;
      ...
      if(year_cur==year){
          if(month_cur>month){
     	 document.getElementById("txtto_CB_Month").value=month;
  ...
  <form action="../../../../../../Annex_IIIa_Serv" name="miscRep" method="post" onsubmit="return checknull()">
  <table cellspacing="2" cellpadding="3" border="1" width="100%">
  <tr>
        <td class="tdH" colspan="2"><center>Annexure III</center></td>
  </tr>
  ...
  <tr class="tdH">
      <td colspan="2">
          <div align="center">
          <input type=submit value=Submit onclick="chkCurMonth();" >
