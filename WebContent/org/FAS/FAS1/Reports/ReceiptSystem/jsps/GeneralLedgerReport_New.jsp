...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/GeneralLedgerReport_New.js"></script>
  ...
  <body class="table" onload="LoadAccountingUnitID('FOR_LIST_1');loadyear_month()"><form name="frmGeneralLedgerReport"
                                                      id="frmGeneralLedgerReport"
                                                      method="POST" action="../../../../../../GeneralLedgerReport"
      ...
      <div align="center">
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <input type="radio" name="month_year" id="month_year" value="more_cb" onclick="cb_month_year(this.value)" disabled="disabled"> More than one Month 
