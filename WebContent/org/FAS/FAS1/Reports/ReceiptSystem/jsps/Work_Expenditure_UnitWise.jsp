...
<html>
  <head>
    ...
    <title>Work Expenditure Unit Wise </title>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/Work_Expenditure_UnitWise.js"></script>
    <script type="text/javascript"
  ...
  <body class="table"
        onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')"><form name="frmWorkExpenditure"
                                                                           method="POST"
                                                                           action="../../../../../../Work_Expenditure_UnitWise.kv"
                                                                           onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Work Expenditure Unit Wise </strong>
            </div>
          </td>
        </tr>
      </table>
