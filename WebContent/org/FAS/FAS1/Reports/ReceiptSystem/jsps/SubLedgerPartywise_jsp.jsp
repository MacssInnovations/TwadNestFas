...
<html>
  <head>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>Sub Ledger Report(PartyWise)</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/SubLedgerPartywise_js.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmSubLedgerPartywise.txtCB_Year.value=year;
        document.frmSubLedgerPartywise.txtCB_Month.value=month;
        
       /** Load To Cash Book Month and To Cash Book Year during Form Load */
        document.frmSubLedgerPartywise.txtCB_Year_to.value=year;
        document.frmSubLedgerPartywise.txtCB_Month_to.value=month;
  ...
  <form name="frmSubLedgerPartywise" method="POST" action="../../../../../../SubLedgerPartywise_servlet"  onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Sub Ledger Report(PartyWise)</strong>
            </div>
          </td>
        </tr>
      </table>
