...
<html>
  <head>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.frmA46Report.reporttype[0].checked==true)
         {
         ...
         else if(document.frmA46Report.reporttype[1].checked==true)
         {
        	 dispsupnochosen1.style.display="none";
             dispsupnochosen2.style.display="none";
         }
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A46');LoadAccountingUnitID('FOR_LIST_1')">
