...
<html>
  <head>
    ...
    <title>Journal and Payment Details of Pending Bills</title>
...
%>
 ...
 <input type="hidden" id="hdid" name="hdid" value="jrnlandPay">
  <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Journal and Payment Details of Pending Bills</strong>
            </div>
        </td>
      </tr>
    </table>
