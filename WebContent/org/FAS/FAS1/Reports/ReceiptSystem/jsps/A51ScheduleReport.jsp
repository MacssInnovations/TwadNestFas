...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/A51ScheduleReport.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmA51Report.txtCB_Year.value=year;
        document.frmA51Report.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.frmA51Report.reporttype[0].checked==true)
         {
         ...
         else if(document.frmA51Report.reporttype[1].checked==true)
         {
        	 dispsupnochosen1.style.display="none";
             dispsupnochosen2.style.display="none";
         }
  ...
  <body class="table" onload="loadyear_month();Schedule_Account_Heads('A51');LoadAccountingUnitID('FOR_LIST_1')">
  <form action="../../../../../../A51ScheduleReport.kv" name="frmA51Report"
           method="post" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>TWAD FORM A51-Schedule Docket</center>
          </td>
        </tr>
        <tr class="table">
          <td>
        ...
        <tr align="left">
          ...
          <td>
            <div align="left">
                ...
                <input type="radio" name="reporttype" id="reporttype" value="2" onclick="ChooseReptype(this.value);" /> Regular and SJV(Account Head Code on New Page) &nbsp;
