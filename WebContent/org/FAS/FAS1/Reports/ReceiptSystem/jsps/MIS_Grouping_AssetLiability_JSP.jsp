...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/MIS_Grouping_AssetLiability_JS.js"></script>
  ...
  <form action="../../../../../../MIS_Grouping_AssetLiability_Serv" name="miscRep" method="post" onsubmit="return checknull()">
  <%
  ...
  <tr>
        <td class="tdH" colspan="2"><center>Asset and Liability</center></td>
  </tr>
   <tr align="left">
          <td class="table">
            <div align="left">
