...
<html>
  <head>
    ...
    <title>Supplement Work Expenditure Unit Wise </title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Abstract_Journal_Book.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/HR/HR1/EmployeeMaster/scripts/CalendarControl.js"></script>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/FAS/FAS1/Reports/Unitwise_Office_Report.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Work_Expenditure_UnitWise_SJV.js"></script>
    <script type="text/javascript"
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmWorkExpenditure.txtCB_Year.value=year
        document.frmWorkExpenditure.txtCB_Month.value=month;
  ...
  <body class="table"
        onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')"><form name="frmWorkExpenditure"
                                                                           method="POST"
                                                                           action="../../../../../../Work_Expenditure_UnitWise_SJV.kv"
                                                                           onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement Work Expenditure Unit Wise </strong>
            </div>
          </td>
        </tr>
      </table>
