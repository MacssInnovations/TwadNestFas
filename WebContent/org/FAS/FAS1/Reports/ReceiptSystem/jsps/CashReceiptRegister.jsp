...
<html>
  <head>
    ...
    <title>Cash Received Register Report</title>
    
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/CashReceiptRegister.js"></script>
   <!--  <script language="javascript" type="text/javascript" src="../scripts/ChequeReceivedReport.js"></script> -->
  ...
  <form name="cash_rcp_reg_frm" method="POST" action="../../../../../../CashReceipt.view" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Cash Receipt Register for a month</strong>
          </div>
        </td>
      </tr>
    </table>
     <div align="center">
        ...
        <tr  align="left">
            ...
            <td>
                <input type=radio name=seloption id=seloption value="Detail" checked>Detail
                <input type=radio name=seloption id=seloption value="Abstract">Abstract
