...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/GL_AC_Heads.js"></script>
  ...
  <body class="table"
        onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_1')"><form name="frmGeneralLedgerReport"
                                                                           method="POST"
                                                                           action="../../../../../../GL_AC_Heads"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Account Heads Report</strong>
            </div>
          </td>
        </tr>
      </table>
      <div align="center">
        <table cellspacing="1" cellpadding="2" border="1" width="100%">
          ...
          <tr>
            <td align="left">
              Select Specific Account Head Code:
              <font color="#ff2121">*</font>
            </td>
            <td align="left">
              <input type="radio" id="SpecificAHC" name="SpecificAHC"
                     value="All" checked="checked"
                     onclick="AccHead(this.value)"></input>
              All
              <input type="radio" id="SpecificAHC" name="SpecificAHC"
                     value="Specific" onclick="AccHead(this.value)"></input>
              Specific
              <div id="acchead" name="acchead" style="display:none">
                ...
                <img src="../../../../../../images/c-lovi.gif"
                     alt="AccountHeadList" onclick="AccHeadpopup();" height="24"
                     width="24"></img>
              </div>
            </td>
          </tr>
