...
<html>
  <head>
    ...
    <title>Assets Sub-Ledger Master</title>
  ...
  <form name="frmAssets_SL_Master" method="POST" action="../../../../../../Assets_SL_Master" onsubmit="return checknull()">
   <%
  Connection con=null;
  ...
  */
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Assets Sub-Ledger Master</strong>
            </div>
        </td>
      </tr>
   </table>
