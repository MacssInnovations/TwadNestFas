...
<html>
  ...
  <form name="frmJournal_forCashBookMonth" method="POST" action="../../../../../../Trial_Balance_Report.view" onsubmit="return checknull()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <table align="center"  cellspacing="3" cellpadding="2" border="1" width="100%" >
      ...
      <td>
         ...
         <input type="button" id="cmdcancel" name="cancel" value="EXIT" onclick="javascript:btncancel()">
      </div>
      </td>
      </tr>
     </table>
