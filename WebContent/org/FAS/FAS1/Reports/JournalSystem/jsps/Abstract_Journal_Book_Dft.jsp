...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Abstract_Journal_Book.js"></script>
  ...
  <form name="frmJournal_forCashBookMonth" method="POST" action="../../../../../../Abstract_Journal_Book.view" onsubmit="return checknull()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Abstract of JOURNAL BOOK (For the Cash Book Month)</strong>
          </div>
        </td>
      </tr>
    </table>
             ...
             <tr class="table">
              ...
              <tr class="table">
                ...
                "                   )\n    ";
                    ...
                    {
           //dhana changes on 19th march2012         
                   String sql=" select                                 \n" + 
                "                REDEPLOYED_OFFICE_ID,  \n" + 
                "                ( select office_short_name from com_mst_offices where office_id = REDEPLOYED_OFFICE_ID) as office_desc     \n" + 
                "            from                                   \n" + 
