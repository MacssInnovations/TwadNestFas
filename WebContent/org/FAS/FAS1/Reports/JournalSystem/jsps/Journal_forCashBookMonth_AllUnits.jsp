...
<html>
  ...
  <form name="frmJournal_forCashBookMonth" method="POST" action="../../../../../../Journal_forCashBookMonth_AllUnits.view" onsubmit="return checknull()">
  <%
      Connection con=null;
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="LoadOffice(this.value);" >
                     <option value=999> All Units </option>
                          <%
                              int unitid=0;
                              String unitname="";
                              try{
