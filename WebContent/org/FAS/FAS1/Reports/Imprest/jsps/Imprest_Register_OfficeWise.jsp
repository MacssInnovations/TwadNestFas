...
<html>
  <head>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>Imprest/Temporary Advance Register-OfficeWise</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/Imprest_Register_OfficeWise.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
		     ...
		     document.imprest_officeWise.txtCB_Year.value=year
		     document.imprest_officeWise.txtCB_Month.value=month;
		    
		     /** Load To Cash Book Month and To Cash Book Year during Form Load */
		     document.imprest_officeWise.txtCB_Year_to.value=year
		     document.imprest_officeWise.txtCB_Month_to.value=month;
...
ConnectionString = strdsn.trim() + "://" + strhostname.trim() + ":" + strportno.trim() + "/" +strsid.trim() ;// Postgres DB  Connection
  ...
  <form name="imprest_officeWise" method="POST"  action="../../../../../../Imprest_Register_OfficeWise" onsubmit="return checknull()">
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Imprest/Temporary Advance Register-OfficeWise</strong>
            </div>
          </td>
        </tr>
      </table>
