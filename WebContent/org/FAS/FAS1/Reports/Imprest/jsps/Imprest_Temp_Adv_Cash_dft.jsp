...
<title>Imprest/Temp.AdV Cash Count</title>
    ...
    <script type="text/javascript"
     ...
     function loadyear_month()
     {
		    ...
		    var today= new Date(); 
		     ...
		     document.impOrTempAdv.txtCB_Year.value=year;
		     document.impOrTempAdv.txtCB_Month.value=month;
     ...
     function ChooseReptype(id)
     {
         ...
         if(document.impOrTempAdv.reporttype[0].checked==true)
         {
        	     dispsupnochosen1.style.display="none";
                 dispsupnochosen2.style.display="none";
         }
         else if(document.impOrTempAdv.reporttype[1].checked==true)
         {
...
function dispsuppno()
     {
         ...
         {
        	 dispsupnochosen3.style.display="block";
        	 document.impOrTempAdv.reporttype[0].checked=true;
...
<form name="impOrTempAdv" id="impOrTempAdv"  method="POST" action="../../../../../../Imprest_Temp_Adv_Cash" onsubmit="return checknull()">
   ...
   %>
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Imprest/Temp.Adv Cash Account</strong>
            </div>
          </td>
        </tr>
      </table>
