function checknull()
{
    ...
    if((document.impOrTempAdv.cmbOffice_code.value=="") || (document.impOrTempAdv.cmbOffice_code.value.length<=0) || (document.impOrTempAdv.cmbOffice_code.value=="0"))
    {
        alert("Please Select Accounting Office Code");
        document.impOrTempAdv.cmbOffice_code.focus();
        return false;
