function checknull()
{
    ...
    if((document.imprestSancNew.cmbOffice_code.value=="") || (document.imprestSancNew.cmbOffice_code.value.length<=0) || (document.imprestSancNew.cmbOffice_code.value=="0"))
    {
        alert("Please Select Accounting Office Code");
        document.imprestSancNew.cmbOffice_code.focus();
        return false;
