...
function printing(unitcode,offid,challanNo,challanDate)
{
    ...
    document.frmBankRemit_Cancel.action=url;
    document.frmBankRemit_Cancel.method="POST";
    document.frmBankRemit_Cancel.submit();
    return true;
}
...
{   
       if(Command=="loadPendingRemittance")
        {  
            ...
            var url="../../../../../Bank_Remittance_Cancel.kv?Command=loadPendingRemittance&cmbAcc_UnitCode="+cmbAcc_UnitCode
