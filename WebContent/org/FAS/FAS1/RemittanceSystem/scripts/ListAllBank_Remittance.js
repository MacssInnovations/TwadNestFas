...
function Show(unitcode,offid,challanNo,challanDate)
{
    ...
    loadRemit_ReceiptDetails= window.open("../../../../../org/FAS/FAS1/RemittanceSystem/jsps/RemitMonitor_ReceiptDetails_ForBank_New.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&challanNo="+challanNo+"&challanDate="+challanDate,"ReceiptDetails","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    loadRemit_ReceiptDetails.moveTo(250,250);  
    loadRemit_ReceiptDetails.focus();
...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../ListAllBank_Remittance?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtRemittance_type='B';
                var url="../../../../../ListAllBank_Remittance?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
