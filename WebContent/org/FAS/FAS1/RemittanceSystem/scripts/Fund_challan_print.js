...
function printing(unitcode,offid,challanNo,challanDate)
{
    ...
    var url="../../../../../Remittance_print.view?Command=FundRemit_print&cmbAcc_UnitCode="+cmbAcc_UnitCode+
    ...
    document.frmFundRemit_print.action=url;
    document.frmFundRemit_print.method="POST";
    document.frmFundRemit_print.submit();
      return true;
}
/////////-------------------------- end report
