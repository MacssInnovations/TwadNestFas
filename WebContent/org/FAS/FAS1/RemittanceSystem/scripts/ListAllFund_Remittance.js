...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../ListAllFund_Remittance?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtRemittance_type='F';
                var url="../../../../../ListAllFund_Remittance?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
