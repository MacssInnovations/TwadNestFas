...
function printing(unitcode,offid,challanNo,challanDate)
{
    ...
    //var payVr_No=payVr_No;
    //var payVr_Date=payVr_Date;
    //alert(recNo);
    var challanNo=challanNo;  
    //var txtReceipt_type='CR';
    var challanDate=challanDate;
    var url="../../../../../Remittance_print.view?Command=BankRemit_print&cmbAcc_UnitCode="+cmbAcc_UnitCode+
    "&cmbOffice_code="+cmbOffice_code+                                  
    "&challanNo="+challanNo+ "&challanDate="+challanDate;
    
    //"&payVr_No="+payVr_No+"&payVr_Date="+payVr_Date+                  //"&txtReceipt_type="+txtReceipt_type+

    document.frmBankRemit_print.action=url;
    document.frmBankRemit_print.method="POST";
    document.frmBankRemit_print.submit();
      return true;
}
/////////-------------------------- end report
...
{   
      ...
      if(Command=="loadPendingRemittance")
        {  
            ...
            var url="../../../../../Bank_Remit_Monitor_Create.view?Command=loadPendingRemittance&cmbAcc_UnitCode="+cmbAcc_UnitCode
                    ...
                    //alert("hello "+i+"  " + items[i])
                     ...
                     cell2=document.createElement("TD");
                       ...
                       //---------------------------------------end 
                        ...
                        cell.align='CENTER';
                        var anc=document.createElement("A");
                        var url="javascript:printing('"+Ucode+"','"+Offid+"','"+items[0]+"','"+items[1]+"')";
                        anc.href=url;
