...
var page=document.frmFundRemit_ListAll.cmbpage.value;
...
function loadPage(page)
{
         ...
         // alert(page);
            document.frmFundRemit_ListAll.cmbpage.selectedIndex=page-1;
                var tbody=document.getElementById("tbody");
...
function changepagesize()
{
           ...
           __pagination=document.frmFundRemit_ListAll.cmbpagination.value;
