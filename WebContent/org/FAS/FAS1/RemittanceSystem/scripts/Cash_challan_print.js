...
function printing(unitcode,offid,challanNo,challanDate)
{
    ...
    document.frmCashRemit_print.action=url;
    document.frmCashRemit_print.method="POST";
    document.frmCashRemit_print.submit();
      return true;
}
/////////-------------------------- end report
...
{   
      ...
      if(Command=="loadPendingRemittance")
        {  
            ...
            var url="../../../../../Cash_Remit_Monitor_Create.view?Command=loadPendingRemittance&cmbAcc_UnitCode="+cmbAcc_UnitCode
