...
function printing(unitcode,offid,challanNo,challanDate)
{
    ...
    document.frmCashRemit_Cancel.action=url;
    document.frmCashRemit_Cancel.method="POST";
    document.frmCashRemit_Cancel.submit();
      return true;
}
...
{   
       if(Command=="loadPendingRemittance")
        {  
            ...
            var url="../../../../../Cash_Remittance_Cancel.kv?Command=loadPendingRemittance&cmbAcc_UnitCode="+cmbAcc_UnitCode
     ...
     if(flag=="success")
     {
        ...
        for(var k=0;k<Challan.length;k++)
        {
             ...
             items[1]=baseResponse.getElementsByTagName("challan_date")[k].firstChild.nodeValue;   //******* remitted on is filled with challan date, bcoz both are same
              ...
              console.log(baseResponse.getElementsByTagName("remarks")[k].firstChild);
