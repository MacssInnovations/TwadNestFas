...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Remittance System</title>
     ...
     <script language="javascript" type="text/javascript" src="../scripts/Bank_challan_print.js"></script>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
         ...
         var today= new Date(); 
            ...
            document.frmBankRemit_print.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <form name="frmBankRemit_print" id="frmBankRemit_print" action="" method="POST">
   <%
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Bank Remittances Printing System</strong>
          </div>
        </td>
      </tr>
    </table>
                  ...
                  <div align="left">
                    ...
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankRemit_print.txtCrea_date,1);"
