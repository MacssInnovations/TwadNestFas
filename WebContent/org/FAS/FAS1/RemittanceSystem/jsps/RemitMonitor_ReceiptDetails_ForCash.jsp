      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          <%
           ...
           try 
            {
                    ps=con.prepareStatement("select ACCOUNT_HEAD_CODE,RECEIPT_NO,to_char(RECEIPT_DATE,'DD/MM/YYYY') as rec_date,RECEIVED_FROM,trim(to_char(TOTAL_AMOUNT,'99999999999999.99'))  as amt from FAS_RECEIPT_MASTER where RECEIPT_TYPE='C' and CREATED_BY_MODULE='CR' " +
                                            " and ACCOUNTING_UNIT_ID=? and  ACCOUNTING_FOR_OFFICE_ID=?  and  CHALLAN_NO=? and CHALLAN_DATE=? and RECEIPT_STATUS='L' ");
