...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Cash_challan_print.js"></script>
   ...
   <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
         ...
         var today= new Date(); 
            ...
            document.frmCashRemit_print.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <form name="frmCashRemit_print" id="frmCashRemit_print" action="" method="POST">
   <%
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Cash Remittances Printing System</strong>
          </div>
        </td>
      </tr>
    </table>
                  ...
                  <div align="left">
                    ...
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmCashRemit_print.txtCrea_date,1);"
