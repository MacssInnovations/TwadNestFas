...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script language="javascript" type="text/javascript" src="../scripts/FundRemit_ListAll.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
     {
        ...
        document.frmFundRemit_ListAll.txtCB_Year.value=year
        document.frmFundRemit_ListAll.txtCB_Month.value=month;
        
     }
    </script>
      </head>
  <body class="table" onload="loadyear_month()" >
  <form name="frmFundRemit_ListAll" method="POST">
  <%
...
%>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Fund&nbsp;Remittances </strong>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundRemit_ListAll.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmFundRemit_ListAll.txtTo_date);"
                         alt="Show Calendar"></img>
