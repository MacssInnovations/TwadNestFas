...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/BankRemit_Create.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         { 
            ...
            //document.frmBankRemit_Create.txtCrea_date.value=day+"/"+month+"/"+year;
            //call_date(document.frmBankRemit_Create.txtCrea_date);
        }
</script>
  </head>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Bank Remittance System </font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmBankRemit_Create" id="frmBankRemit_Create" method="POST"
                  action="../../../../../BankRemit_Create.view?Command=Add"
                  onsubmit="return verify_one();return checkNull();">
       <%
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmBankRemit_Create.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <div align="left">
                    ...
                    <%
                        ...
                        psbank.setString(2,"MF004");        // Here we loading Bank receipt Account numbers only with indicator "DR",bcoz we r going to remit tghe amount based on it only.
