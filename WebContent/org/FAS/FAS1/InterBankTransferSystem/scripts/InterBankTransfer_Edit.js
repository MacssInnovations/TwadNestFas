...
function doFunction(Command,param)
{
        ...
        {  
           clearGeneral_Detail();
           var txtCrea_date= document.frmInterBankTransfer_Edit.txtCrea_date.value
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
           var cmbOffice_code=document.getElementById("cmbOffice_code").value;
            
            if(txtCrea_date.length!=0)
            {
            var url="../../../../../InterBankTransfer_Edit.view?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtVoucher_No!="")
            {
            var url="../../../../../InterBankTransfer_Edit.view?Command=load_Voucher_Details&txtVoucher_No="+txtVoucher_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
        ...
        {  
            ...
            {
                var url="../../../../../InterBankTransfer_Create.view?Command=load_bank_deatils&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&bank_acc_no="+bank_acc_no+"&cr_dr_indicator="+cr_dr_indicator;
                var req=getTransport();
                //alert(url)
                req.open("GET",url,true); 
                req.onreadystatechange=function()
...
function clearGeneral_Detail()
{
    ...
    document.frmInterBankTransfer_Edit.txtCheque_DD[0].checked=true;
    ...
    if(flag=="success")
    {
      ...
      document.getElementById("txtBranchId").value=br_id;
       ...
       che_DD_date=baseResponse.getElementsByTagName("che_DD_date")[0].firstChild.nodeValue;
        ...
        {
        	document.frmInterBankTransfer_Edit.txtCheque_DD[1].checked=true;
        }
        else if(che_or_DD=="E")
        {
        	document.frmInterBankTransfer_Edit.txtCheque_DD[2].checked=true;
        } 
