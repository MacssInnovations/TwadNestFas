...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    var url="../../../../../InterBankTransfer_print.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
    ...
    document.frmInterBankTransfer_ListAll.action=url;
    document.frmInterBankTransfer_ListAll.method="POST";
    document.frmInterBankTransfer_ListAll.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            if(txtCB_Year.length!=0 && txtCB_Month.length!=0)
            {
                ...
                var url="../../../../../InterBankTransfer_ListAll.view?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtCreat_By_Module='';
                var url="../../../../../InterBankTransfer_ListAll.view?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.frmInterBankTransfer_ListAll.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.frmInterBankTransfer_ListAll.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        ...
                        items[2]=service[i].getElementsByTagName("BK_BR_CITY")[0].firstChild.nodeValue;
                        items[3]=service[i].getElementsByTagName("BK_BR_CITY1")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("CR_ACCOUNT_HEAD_CODE")[0].firstChild.nodeValue;
                        items[5]=service[i].getElementsByTagName("DR_ACCOUNT_HEAD_CODE")[0].firstChild.nodeValue;
                        ...
                        items[8]=service[i].getElementsByTagName("che_DD_no")[0].firstChild.nodeValue;
                        items[9]=service[i].getElementsByTagName("che_DD_date")[0].firstChild.nodeValue;
                      
                      
                        //items[4]=service[i].getElementsByTagName("REF_NO")[0].firstChild.nodeValue;
...
function changepagesize()
{
           ...
           __pagination=document.frmInterBankTransfer_ListAll.cmbpagination.value;
