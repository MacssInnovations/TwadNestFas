  ...
  <head>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frminterbankReport1.txtCB_Month.value=month;
                
       
        document.frminterbankReport1.txtCB_Year_from.value=year;
        document.frminterbankReport1.txtCB_Month_from.value=month;
        
       
        document.frminterbankReport1.txtCB_Year_to.value=year;
        document.frminterbankReport1.txtCB_Month_to.value=month;
...
%>
  ...
  <form name="frminterbankReport1" id="frminterbankReport1" method="POST" action="IBT_From_Report">
  <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Inter Bank Transfer Report</strong>
            </div>
        </td>
      </tr>
    </table>
 ...
 <tr align="left">
          <td class="table"> From Date &amp; To Date<font color="#ff2121">*</font></td>
                  ...
                  <input type="text" name="txtFrom_date" id="txtFrom_date"  tabindex="6"
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frminterbankReport1.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frminterbankReport1.txtTo_date);"
                         alt="Show Calendar"></img>
           </div>
          </td> 
	      ...
	      <tr class="table">
                <td>
                  <div align="left">
                   From Bank Account Number  <font color="#ff2121">*</font>
                  
                  </div>
                </td>
                <td>
                  <div align="left">
                     <select name="txtSubBankAccountNo" id="txtSubBankAccountNo" >
                    <option value="">--Select Bank Account Number--</option>
                    <%
                       
                        ps = con.prepareStatement("SELECT b.BANK_AC_NO, a.BANK_SHORT_NAME || '-' || b.BANK_AC_TYPE_ID || '-' || b.BANK_AC_NO AS BANK_AC_NO_DISPLAY	FROM FAS_MST_BANKS a, FAS_MST_BANK_BALANCE b WHERE b.BANK_ID =a.BANK_ID	AND b.ACCOUNTING_UNIT_ID=? ORDER BY a.BANK_SHORT_NAME");
                        ps.setInt(1,unitid);
        				rs= ps.executeQuery();
        				while (rs.next()) {
      ...
      <td>
          <div align="center">
          <input type="button"  value="GO" id="sum" name="sum" onclick="reportFunction('<%=s%>');"/ >
