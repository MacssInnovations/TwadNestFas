...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/InterBankTransfer_Edit.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
                ...
                document.frmInterBankTransfer_Edit.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Inter Bank Transfer System (Modify)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmInterBankTransfer_Edit" id="frmInterBankTransfer_Edit" method="POST"
                  action="../../../../../InterBankTransfer_Edit.view?Command=Add"
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Edit.txtCrea_date,1);"
                ...
                <td>
                  ...
                  <!--  <input type="text" name="txtBankAccountNo"  onkeypress="return numbersonly(event)" onchange="doFunction('load_bank_deatils','CR');"
                    ...
                    <%
                       ...
                       PreparedStatement ps_acc=con.prepareStatement("select BANK_AC_NO,BANK_AC_TYPE_ID || '-' || BANK_AC_NO as BANK_AC_NO_DISPLAY from FAS_OFFICE_BANK_AC_CURRENT where STATUS='Y' and  ACCOUNTING_UNIT_ID=? and  MODULE_ID=? and  CR_DR_TYPE=?");
                        ...
                        while(rs_acc.next())
                        {
                            ...
                            System.out.println("bank_ac_no..."+rs_acc.getLong("BANK_AC_NO"));
                        }
                        rs_acc.close();
                        ps_acc.close();
           ...
           <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <option value="">--Select Bank Account Number--</option>
                    <%
                        ps_acc=con.prepareStatement("select BANK_AC_NO,BANK_AC_TYPE_ID || '-' || BANK_AC_NO as BANK_AC_NO_DISPLAY from FAS_OFFICE_BANK_AC_CURRENT where STATUS='Y'and ACCOUNTING_UNIT_ID=? and  MODULE_ID=? and  CR_DR_TYPE=?");
                        ps_acc.setInt(1,unitid);
                        ps_acc.setString(2,"MF010");
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Edit.txtCheque_DD_date,0,2);"
                         alt="Show Calendar"></img>
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"  
                           ...
                           onblur=" return checkdt(this);;"/>
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Edit.txtReferenceDate);"
                         alt="Show Calendar"></img> 
                  </div>
                </td>
              </tr>  
