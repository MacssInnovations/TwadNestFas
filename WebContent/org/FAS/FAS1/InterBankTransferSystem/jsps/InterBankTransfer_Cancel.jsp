...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/InterBankTransfer_Cancel.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
                ...
                document.frmInterBankTransfer_Cancel.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Inter Bank Transfer System (Cancel)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmInterBankTransfer_Cancel" id="frmInterBankTransfer_Cancel" method="POST"
                  action="../../../../../InterBankTransfer_Cancel.view?Command=Cancel"
          ...
          <div align="center">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Cancel.txtCrea_date,1);"
           ...
           <tr class="table">
               ...
               <tr class="table">
                ...
                <!--    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Cancel.txtCheque_DD_date);"
                         alt="Show Calendar"></img>  -->
                  </div>
                </td>
              </tr>
                ...
                <td>
                  ...
                  <input type="text" name="txtReferenceDate" id="txtReferenceDate"  
                           ...
                           onblur=" return checkdt(this);;"/>
                  <!--   <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmInterBankTransfer_Cancel.txtReferenceDate);"
                         alt="Show Calendar"></img> -->
                  </div>
                </td>
              </tr>  
