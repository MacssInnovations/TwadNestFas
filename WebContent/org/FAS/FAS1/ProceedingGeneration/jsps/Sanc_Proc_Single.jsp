...
<html>
    ...
    <script type="text/javascript"
         ...
         <script type="text/javascript" language="javascript">
		    function loadDate()
	        {
	                 ...
	                 document.SancProcSingle.sanc_date.value=day+"/"+month+"/"+year;                   
	        }  
	     	 function loadyear_month()
	         {
		         ...
		         document.SancProcSingle.txtCB_Year.value=year;
		         document.SancProcSingle.txtCB_Month.value=month;
  ...
  <form name="SancProcSingle" id="SancProcSingle" method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
          ...
          <tr align="left">
		          ...
		          <td>
				          ...
				          <input type="button" id="goBtn" name="goBtn" onclick="loadNote_no();" value="GO">			          
				   </td>       
           ...
           <tr >
            <td>
              <div align="left">
                 Sanction Proceeding Office
                <font color="#ff2121">*</font>
              </div>
            </td>
            <td>
               <input type="text" name="sanc_Office" value="" id="sanc_Office" size="10" disabled="disabled"/>
		    </td>
          </tr>
              <tr>
         ...
         <tr>
            <td class="table">Payee Code</td>
                 <td>
                     ...
                     <input type="button" value="Select" name="txtEmpVal" id="txtEmpVal" onclick="employee_popup_trans();paydisp();" onblur="paydisp();"/>&nbsp;&nbsp;&nbsp;
