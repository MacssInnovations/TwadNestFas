...
<head>
    ...
    <title>HR Sanction Proceedings Multiple Payee (Employee/Pensioner)</title>
...
<!--  <body onload="loadDate(),setTimeout('loadMemoNO()',3000),dispvalue();">-->
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">HR Sanction Proceedings Multiple Payee (Employee/Pensioner)</font>
          </div>
        </td>
      </tr>
    </table>
        ...
        <div class="tab-page">
          ...
          <tr align="left">
		          ...
		          <td>
				          ...
				          <input type="button" id="goBtn" name="goBtn" onclick="loadNote_noMUL();" value="GO">			          
				   </td>       
            ...
            <td class="table">
			                  ...
			                  <div align="left">
			                    <select name="note_no" 
			                           id="note_no" onchange="loadDetailsMUL(this.value);" >	
