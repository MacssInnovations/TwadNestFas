...
<title>Single Payee Report</title>
...
<script src="../scripts/Sanc_Proc_SingleReport.js" type="text/javascript"> </script>
<script type="text/javascript">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Single Payee Report</font></div>
		</td>
	</tr>
</table>
			...
			type="radio" name="sancidwith" id="sancidwith" value="N" ><label>Without Sanction Proceeding</label></div>
              ...
              <tr class="table">
					...
					<td>
					          ...
					          <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth"  tabindex="5" onclick="show1('searchByMonth');"/>
			                    </div>		
			                </td>
				</tr>
