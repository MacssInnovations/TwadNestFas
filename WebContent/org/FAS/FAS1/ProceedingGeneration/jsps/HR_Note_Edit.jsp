...
<html>
  <head>
    ...
    <title>HR Note Preparation  Edit</title>
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center">
          ...
          <tr>
            ...
            <td class="table">
			                  ...
			                  <div align="left">
			                    <select name="note_no" 
			                           id="note_no" onchange="loadDetailsEdit(this.value);">	
       ...
       <tr class="table" id="tr4">
                ...
                <td>
                  <div align="left">
                        <input type="text" name="officeId"  id="officeId" value="<%=oid%>" onkeypress="return numbersonly1(event,this)" maxlength="20" size="7" onblur="callServer1('Check','null');" />
                        <img src="../../../../../images/c-lovi.gif" width="20" height="20" alt="OfficeList" onclick="jobpopup1('txtOffice_Id','txtOfficeName')" id="off_img" name="off_img"></img>  <input type="hidden" name="dept_id" id="dept_id"/>
                  </div>
                </td>
              </tr>
                <tr class="table">
       ...
       <tr class="table">
	        ...
	        <td>
	          ...
	          <select  id="txtAcc_HeadCode" name="txtAcc_HeadCode"  onchange="load_head();chkBud(1);" >
                 ...
                 <table >
                     ...
                     <!--   <input type="button" name="cmdAdd" value="Submit" id="cmdAdd" onclick="calling('Add');check()" tabindex="20"/>
                        ...
                        <input type="submit" name="cmdDelete" value="Report" id="cmdDelete"  tabindex="40" />
                         ...
                         -->
                           <td>
                           <input type="button" name="cmdEdit" value="Update" id="cmdEdit"  onclick="calling('Update');"/>
                         </td><td>
                     </tr>
                </table>
                    </div>
