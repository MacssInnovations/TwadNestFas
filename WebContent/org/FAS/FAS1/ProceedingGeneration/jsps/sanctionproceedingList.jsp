...
<html>
  <head>
    ...
    <title>Sanction Proceedings List</title>
...
<script type="text/javascript"  src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID.js"></script>
    ...
    <script type="text/javascript" src="../../../../../org/FAS/FAS1/CalendarCtrl_forChequeDate.js"></script> 
     ...
     function loadDate()
        ...
        document.frmSanctionProceedingsList.txtCB_Year.value=year
        document.frmSanctionProceedingsList.txtCB_Month.value=month;
...
<form name="frmSanctionProceedingsList" id="frmSanctionProceedingsList">      
    
 <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong> Sanction Proceedings List</strong>
          </div>
        </td>
      </tr>
    </table>
       ...
       <tr align="left" class="tdH"> <th>Search By Month or Date</th></tr>
        <tr align="left">
          ...
          <option value="12">December</option>
           ...
           <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth"  tabindex="5" onclick="doFunction('searchByMonth')"/>
           </div>
          </td>
        </tr>
        <tr align="left">
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                                   <input type="text" name="txtFrom_date" id="txtFrom_date" maxlength="10" size="11"  
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);"
                          />
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmSanctionProceedingsList.txtFrom_date);"
                         alt="Show Calendar"></img> 
           
                    <input type="text" name="txtTo_date" id="txtTo_date" maxlength="10" size="11"  
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);"
                          />
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmSanctionProceedingsList.txtTo_date);"
                         alt="Show Calendar"></img> 
            <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth" tabindex="8" onclick="doFunction('searchByDate')"/>
            </div>
          </td>          
        </tr>
     </table>
