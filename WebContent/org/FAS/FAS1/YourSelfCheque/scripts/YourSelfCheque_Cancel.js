...
{  
	 ...
	 var url="../../../../../YourSelfCheque_Cancel.kv?Command=LoadBankAccounts&cmbAcc_UnitCode="+cmbAcc_UnitCode;
...
{   
       ...
       if(Command=="load_Voucher_No")
        {  
            ...
            { 
            	var url="../../../../../YourSelfCheque_Cancel.kv?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtVoucher_No!="")
            {
            	var url="../../../../../YourSelfCheque_Cancel.kv?Command=load_Voucher_Details&txtVoucher_No="+txtVoucher_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            	cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
