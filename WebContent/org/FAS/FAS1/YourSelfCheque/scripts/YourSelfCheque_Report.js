...
function disp()
{
        ...
        var txtCB_Year=document.Self_Cheque_Report.txtCB_Year.value;
        var txtCB_Month=document.Self_Cheque_Report.txtCB_Month.value;
        var cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
        var cmbOffice_code=document.getElementById("cmbOffice_code").value;
        var url="../../../../../YourSelfCheque_Report?command=check&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month;                
        var req=getTransport();
        //alert(url);
