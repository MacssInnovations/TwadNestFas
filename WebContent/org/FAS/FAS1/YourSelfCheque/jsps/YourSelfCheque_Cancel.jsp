...
<html>
  <head>
    ...
    <title>YourSelf Cheque Edit</title>
    ...
    <script type="text/javascript" src="../scripts/YourSelfCheque_Cancel.js"></script>
  ...
  <body onload="loadDate();foc();LoadAccountingUnitID('LIST_ALL_UNITS');" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">YourSelf Cheque Cancel </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="YourSelfChequeForm" id="YourSelfChequeForm" method="POST"
                  action="../../../../../YourSelfCheque_Cancel.kv?Command=Add"
      ...
      <div class="tab-pane" id="tab-pane-1">
        <div class="tab-page">
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
                  ...
                  <div align="left">
                    ...
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.YourSelfChequeForm.txtCrea_date,1);"
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left" >
                  	  <select name="txtVoucher_No" id="txtVoucher_No" onchange="LoadBankAccountNumber();" >
              ...
              <tr class="table">
                <td>
                  <div align="left">Bank Account Number<font color="#ff2121">*</font> </div>
                </td>
                <td>
                  <div align="left">
          ...
          -->    
             ...
             <tr class="table">
                <td width="40%">
                  <div align="left">Cheque Date  <font color="#ff2121">*</font>    </div>             
                </td>
                <td width="60%">
                  <div align="left">
              ...
              <tr class="table">
                <td width="40%">
                  <div align="left">Cheque Number<font color="#ff2121">*</font></div>
                </td>
                <td>
                    <div align="left">
                    <input type="text" name="txtChequeNo" id="txtChequeNo"  rows="4" onkeypress="return numbersonly1(event,this)"></input>
                  </div>
                </td>
              </tr>
              ...
              <tr class="table">
                <td>
                  <div align="left">Cheque Amount <font color="#ff2121">*</font></div>
                </td>
                <td>
                  <div align="left">
