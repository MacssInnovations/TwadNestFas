...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/YourSelfCheque_Edit.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">YourSelf Cheque Updation </font>
          </div>
        </td>
      </tr>
    </table>
    ...
    <form name="YourSelfChequeForm" id="YourSelfChequeForm" method="POST"
                  action="../../../../../YourSelfCheque_Edit.kv?Command=Add"
