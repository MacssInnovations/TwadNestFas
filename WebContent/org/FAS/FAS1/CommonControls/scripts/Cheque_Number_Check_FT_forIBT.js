...
////////////////////////////////////////////////////////////////////////////////
 ...
 function check_dd_cheque()
 {
      ...
      var url="../../../../../Cheque_Number_Check_forIBT.kv?Command=check_cheque_no&cheque_no="+cheque_no+"&cmbAcc_UnitCode="+cmbAcc_UnitCode;
            ...
            if(flag=="Success")
              {
                 ...
                 { 
                    temp=temp+"----------------------------------------------------\n";
                  temp=temp+"Voucher Number = "+baseResponse.getElementsByTagName("voc_no")[k].firstChild.nodeValue+"\n";
