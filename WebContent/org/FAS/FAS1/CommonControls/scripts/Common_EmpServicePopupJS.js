...
function getEmployee()  
{
         ...
         OfficeId=document.getElementById("OffId").value;
       	 var url="../../../../../Common_EmpServicePopupServ?Command=Emp&cmbsgroup=" + group ;
...
function getEmployeeGpf()  
{
         ...
         OfficeId=document.getElementById("OffId").value;
         var url="../../../../../Common_EmpServicePopupServ?Command=GPF&txtgpf=" + group+"&OfficeId="+OfficeId;
...
function loadOfficesByType(type)
{
         ...
         var url="../../../../../Common_EmpServicePopupServ?Command=SGroup&cmbsgroup=" + type ;
         var req=getTransport();
         req.open("GET",url,true);        
         req.onreadystatechange=function()
         {
