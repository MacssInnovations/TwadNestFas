...
{
         var type=document.HRM_EmpSearch_selfCheque.cmbsgroup.options[document.HRM_EmpSearch_selfCheque.cmbsgroup.selectedIndex].value;
         if(type!=0)
         {
	            var din=document.getElementById("divdes");
	            din.style.visibility="visible";
	            document.HRM_EmpSearch_selfCheque.cmbdes.style.visibility="visible";
	            loadOfficesByType(type);
         }
         else
         {
	            document.HRM_EmpSearch_selfCheque.cmbdes.value="0";
	            var din=document.getElementById("divdes");
	            din.style.visibility="hidden";
	            document.HRM_EmpSearch_selfCheque.cmbdes.style.visibility="hidden";
         }
}
...
{
         if(document.HRM_EmpSearch_selfCheque.txtEmpName.value.length==0 && document.HRM_EmpSearch_selfCheque.cmbsgroup.options[document.HRM_EmpSearch_selfCheque.cmbsgroup.selectedIndex].value==0)
         {
	            alert('Enter or Select the employee values');
	            return false;
         }
         if(document.HRM_EmpSearch_selfCheque.txtEmpName.value.length!=0)
         {
                if(document.HRM_EmpSearch_selfCheque.txtEmpName.value.length<3)
                {
	                    alert('employee Name should have atleast 3 characters');
	                    return false;
                }
         }
         var group=document.HRM_EmpSearch_selfCheque.cmbsgroup.options[document.HRM_EmpSearch_selfCheque.cmbsgroup.selectedIndex].value;
         try{
        	 	var des=document.HRM_EmpSearch_selfCheque.cmbdes.options[document.HRM_EmpSearch_selfCheque.cmbdes.selectedIndex].value;
         }catch(e){var des=0;}
         var name=document.HRM_EmpSearch_selfCheque.txtEmpName.value;
         startwaiting(document.HRM_EmpSearch_selfCheque);
       	 service=null;
         ...
         OfficeId=document.getElementById("OffId").value;
       	 var url="../../../../../Self_Cheque_Popup_serv?Command=Emp&cmbsgroup=" + group ;
       	 url=url+"&cmbdes="+des+"&txtEmpName="+name+"&OfficeId="+OfficeId;
...
function getEmployeeGpf()  
{
         ...
         if(document.HRM_EmpSearch_selfCheque.txtgpf.value.length==0 || document.HRM_EmpSearch_selfCheque.txtgpf.value==null)
         {
	            alert("Enter Employee's  GPF No.");
	            document.HRM_EmpSearch_selfCheque.txtgpf.focus();
	            return false;
         }
       	 var group=document.HRM_EmpSearch_selfCheque.txtgpf.value;
         ...
         OfficeId=document.getElementById("OffId").value;
         var url="../../../../../Self_Cheque_Popup_serv?Command=GPF&txtgpf=" + group+"&OfficeId="+OfficeId;
...
function loadOfficesByType(type)
{
         ...
         var url="../../../../../Self_Cheque_Popup_serv?Command=SGroup&cmbsgroup=" + type ;
         var req=getTransport();
         req.open("GET",url,true);        
         req.onreadystatechange=function()
         {
...
function  loadDesignation(req)
{
     	 if(req.readyState==4)
         {
			    ...
			    { 
		                ...
		                stopwaiting(document.HRM_EmpSearch_selfCheque);
			            if(flag=="failure")
			            {
			                    alert("No Designation exists under this level");
			                    document.HRM_EmpSearch_selfCheque.txtEmpName.value="";
			                    document.HRM_EmpSearch_selfCheque.txtgpf.value="";
			                    document.HRM_EmpSearch_selfCheque.cmbsgroup.value="0";
			                    document.HRM_EmpSearch_selfCheque.cmbdes.value="0";
			                    s=0;
...
function changepage()
{
		 var page=document.HRM_EmpSearch_selfCheque.cmbpage.value;
...
function loadPage(page)
{
         ...
         document.HRM_EmpSearch_selfCheque.cmbpage.selectedIndex=page-1;
         var tbody=document.getElementById("tb");
...
function changepagesize()
{
         ...
         __pagination=document.HRM_EmpSearch_selfCheque.cmbpagination.value;
