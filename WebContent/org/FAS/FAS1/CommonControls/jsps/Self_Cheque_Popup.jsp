...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Self_Cheque_Popup.js">
    </script>
    <link href="../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
  </head>
  <body><form name="HRM_EmpSearch_selfCheque" id="HRM_EmpSearch_selfCheque">
      <p>
      <%
  				  int OfficeId=Integer.parseInt(request.getParameter("OfficeId"));
      			  System.out.println("Office Id :::"+OfficeId);
      			  out.println("<input type='hidden' name='OffId' id='OffId' value="+OfficeId+">");
