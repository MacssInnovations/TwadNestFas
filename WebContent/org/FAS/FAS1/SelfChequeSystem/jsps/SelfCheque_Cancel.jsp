 ...
 <html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/SelfCheque_Cancel.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmSelfCheque_Cancel.txtCrea_date.value=day+"/"+month+"/"+year;
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Self Cheque System (Cancel)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmSelfCheque_Cancel" id="frmSelfCheque_Cancel" method="POST" onsubmit="return checkNull()" 
             action="../../../../../SelfCheque_Cancel.view?Command=Add"  >
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmSelfCheque_Cancel.txtCrea_date,1);"
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                   ...
                   readonly="readonly"   style="background-color: #ececec"  size="50" maxlength="50"/>
              ...
              <tr class="table">
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="txtCheque_DD_NO" maxlength="10" onkeypress="return numbersonly(event)"  style="background-color: #ececec"  readonly="readonly" 
                ...
                <td>
                  <div align="left">
                    <textarea name="txtRemarks" id="txtRemarks" cols="60"  onkeypress="return check_leng(this.value);" tabindex="9" 
                          readonly="readonly"   style="background-color: #ececec"    rows="3"></textarea>
                  </div>
                </td>
              </tr>
            </table>
