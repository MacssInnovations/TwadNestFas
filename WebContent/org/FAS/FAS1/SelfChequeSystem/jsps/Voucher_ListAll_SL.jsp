  ...
  %>
      <table cellspacing="3" cellpadding="2"  width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Voucher Sub-Details</strong>
            </div>
          </td>
        </tr>
      </table>
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          /*String sql="select SL_NO, ACCOUNT_HEAD_CODE ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME  ,trim(to_char(AMOUNT,'99999999999999.99')) as AMOUNT,PARTICULARS "+
            "from FAS_PAYMENT_TRANSACTION where ACCOUNTING_UNIT_ID=? and ACCOUNTING_FOR_OFFICE_ID=? "+
             " and CASHBOOK_YEAR=? and CASHBOOK_MONTH=? and  VOUCHER_NO=?";*/
             
              String sql="select SL_NO, ACCOUNT_HEAD_CODE ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW_M where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME  ,trim(to_char(AMOUNT,'99999999999999.99')) as AMOUNT,PARTICULARS "+
            "from FAS_PAYMENT_TRANSACTION where ACCOUNTING_UNIT_ID=? and ACCOUNTING_FOR_OFFICE_ID=? "+
             " and CASHBOOK_YEAR=? and CASHBOOK_MONTH=? and  VOUCHER_NO=?";
           ...
           // System.out.println(sql);
            ...
            while(rs2.next())
            {
               System.out.println("hi");
                ...
                out.println("<td align='left'>"+rs2.getString("AMOUNT") +"</td></tr>");
            }
          }
          catch(Exception e)
          {
