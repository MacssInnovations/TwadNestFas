...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../scripts/SelfCheque_Create.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frmSelfCheque_Create.txtCrea_date.value=day+"/"+month+"/"+year;
            call_date(document.frmSelfCheque_Create.txtCrea_date);
...
%>
  <body onload="call_clr();setTimeout('loadDate()', 300);" bgcolor="rgb(255,255,225)">
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">Self Cheque System (Create)</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmSelfCheque_Create" id="frmSelfCheque_Create" method="POST" onsubmit="return checkNull()" 
             action="../../../../../SelfCheque_Create.view?Command=Add"  >
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="cmbOffice_code" id="cmbOffice_code" tabindex="2" >
                      ...
                      <%
                   System.out.println("here unitid:"+unitid);
                   System.out.println(oid+"  " +oname);
                try
                {
                   if(oid==5000)
                    ...
                    {
                    	 int countoffice=0;    
                        ps=con.prepareStatement("select ACCOUNTING_UNIT_ID, ACCOUNTING_FOR_OFFICE_ID  from FAS_MST_ACCT_UNIT_OFFICES where ACCOUNTING_UNIT_ID="+unitid+" order by ACCOUNTING_FOR_OFFICE_ID desc" );
                        rs=ps.executeQuery();
                       
                        while(rs.next())
                        {
                        //System.out.println("ACCOUNTING_UNIT_ID..."+rs.getInt("ACCOUNTING_FOR_OFFICE_ID"));
                  ...
                  <div align="left">
                    <input type="text" name="txtCrea_date" id="txtCrea_date" tabindex="3" 
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmSelfCheque_Create.txtCrea_date,1);"
              ...
              <tr class="table" style="display:none">
                <td>
                  <div align="left">
                    Voucher  Number  <!--It' going to be Receipt voucher number , but here it's not needed to show the user 
                                         So it's made as hidden-->
                  </div>
                </td>
                <td>
                  <div align="left">
                    <input type="hidden" name="txtReceipt_No" id="txtReceipt_No"  tabindex="4" 
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmSelfCheque_Create.txtCheque_DD_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             ...
             <tr class="tdTitle">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                  <input type="radio" name="radAcq_roll_YN" id="radAcq_roll_YN" value="Y" checked="checked" onclick="enable_acq(this.value);"/>YES
                  <input type="radio" name="radAcq_roll_YN" id="radAcq_roll_YN" value="N" onclick="enable_acq(this.value);"/>NO
                  </div>
                </td>
              </tr>
              <tr class="table">
                        ...
                        <td colspan="2" height="23">
                         <div align="center">
                          ...
                          <td><input type="button" name="cmdadd_PAYWISE" id="cmdadd_PAYWISE"
                                 value="ADD" onclick="ADD_PAYWISE_GRID()" style="display:block"/></td>
                          <td>
                          ...
                          <td><input type="button" name="cmddelete_PAYWISE" value="DELETE"
                                 id="cmddelete_PAYWISE" onclick="delete_PAYWISE_GRID()"
                  ...
                  <div align="left">
                    <input type="text" name="txtAcc_HeadCode" 
                           ...
                           onkeypress="return numbersonly(event)"
                            onchange="sixdigit();hideRecoup();HeadCodeValidation();" 
