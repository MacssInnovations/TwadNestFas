...
function ADD_PAYWISE_GRID()
{
        ...
        if((document.getElementById("txtPayWise_AcqSL_No").value.length==0 || document.getElementById("txtPayWise_AcqSL_No").value==0) && document.frmSelfCheque_Edit.radAcq_roll_YN[0].checked==true )
        {
...
{
   // Not needed the following if() condition    
    /*   if((document.getElementById("txtPayWise_AcqSL_No").value.length==0 || document.getElementById("txtPayWise_AcqSL_No").value==0) && document.frmSelfCheque_Edit.radAcq_roll_YN[0].checked==true )
        {
            alert("Enter the Acq. Roll SL number");
            document.getElementById("txtPayWise_AcqSL_No").focus();
...
function loadTable_PAYWISE(scod)
{
        ...
        // the following lines are commented for the reason we should not change acq..roll and voucher number
        /*if(document.getElementById("txtPayWise_AcqSL_No").value==0)
         {
             document.frmSelfCheque_Edit.radAcq_roll_YN[1].checked=true;
             document.getElementById("txtPayWise_AcqSL_No").readOnly=true;
         }
         else
         {
            document.frmSelfCheque_Edit.radAcq_roll_YN[0].checked=true;
            document.getElementById("txtPayWise_AcqSL_No").readOnly=false;
         }*/
...
function clearall_PAYWISE()
{
    ...
    document.frmSelfCheque_Edit.radAcq_roll_YN[0].checked=true;
     ...
     //document.frmSelfCheque_Edit.cmdadd_PAYWISE.style.display='block';  //--------- "ADD" not allowed
     document.frmSelfCheque_Edit.cmdupdate_PAYWISE.style.display='none';
     document.frmSelfCheque_Edit.cmddelete_PAYWISE.disabled=true;
}
...
function ADD_PAYWISE_DETAILS_GRID()
{
       ...
       if(document.getElementById("txtpayDetails_Voucher_No").value.length==0 || document.getElementById("txtpayDetails_Voucher_No").value==0)
        ...
        if(document.frmSelfCheque_Edit.payment_type[0].checked==true)
        {
    			items[9]="N";
    			items[10]="New";
        }
        ...
        items[11]=document.getElementById("drawl_purpose").value;
        if(document.getElementById("drawl_purpose").value=="")
        {
        items[12]="--";               
        }
        else
        items[12]=document.getElementById("drawl_purpose").options[document.getElementById("drawl_purpose").selectedIndex].text; 
...
{
	  // alert("loadTable_PAYWISE_DETAILS");
        ...
        try{
        	if(rcells.item(2).firstChild.value=="820102")
        	{
        		document.getElementById("txtAcc_HeadCode").value=rcells.item(2).firstChild.value;
      ...
      //  alert("purpose"+rcells.item(8).firstChild.value);
        var hCode=rcells.item(2).firstChild.value;
      //  alert("hCode"+hCode);
        if(hCode=="820103" || hCode=="820102"){
        loaddrawlPurpose(hCode);
        }
    ...
    //    setTimeout('document.getElementById("drawl_purpose").value=rcells.item(8).firstChild.value;',900);
        try{document.getElementById("drawl_purpose").value=rcells.item(8).firstChild.value;}catch(e){}
          document.frmSelfCheque_Edit.cmdupdate_PAYWISE_DETAILS.style.display='block';
	    document.frmSelfCheque_Edit.cmddelete_PAYWISE_DETAILS.disabled=false;
	    document.frmSelfCheque_Edit.cmdadd_PAYWISE_DETAILS.style.display='none';
        
        if(rcells.item(7).firstChild.value=="N")
   	   	 document.frmSelfCheque_Edit.payment_type[0].checked=true;
        else
   	   	 document.frmSelfCheque_Edit.payment_type[1].checked=true;    
        
	 
	    
	    if(document.frmSelfCheque_Edit.payment_type[1].checked==true)
...
function clearall_PAYWISE_DETAILS()
{
    ...
    document.getElementById("txtPayWise_DetailsParticular").value="";
     ...
     document.frmSelfCheque_Edit.cmdadd_PAYWISE_DETAILS.style.display='block';
     document.frmSelfCheque_Edit.cmdupdate_PAYWISE_DETAILS.style.display='none';
     document.frmSelfCheque_Edit.cmddelete_PAYWISE_DETAILS.disabled=true;
...
function ADD_GRID_Acq()
{
       ...
       var Acq_tbody=document.getElementById("grid_body_Acq");
        ...
        if(document.frmSelfCheque_Edit.radAllSpec[0].checked==true)
        {
...
function loadTable_Acq(scod_acq)
{
    ...
    document.frmSelfCheque_Edit.cmdupdate_Acq.style.display='block';
    document.frmSelfCheque_Edit.cmddelete_Acq.disabled=false;
    document.frmSelfCheque_Edit.cmdadd_Acq.style.display='none';
}
...
function clearall_Acq_byADD()           // in case of specific selected
{
    ...
    document.getElementById("txtAuq_Particular").value="";
     document.frmSelfCheque_Edit.cmdadd_Acq.style.display='block';
     document.frmSelfCheque_Edit.cmdupdate_Acq.style.display='none';
     document.frmSelfCheque_Edit.cmddelete_Acq.disabled=true;
}
...
function call_clr()
{
 ...
 document.frmSelfCheque_Edit.radAllSpec[1].checked=true;
 clearGeneral_Detail();
}
...
function loadRecoupDetails(command,param)
{
		...
		{		
			    ...
			    var url="../../../../../SelfCheque_Create.view?Command=loadRecoupDetails&Option=Edit&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&txtOfficeId="+cmbOffice_code+"&txtCrea_date="+txtCrea_date+"&txtEmpID="+txtEmpID+"&created_by_module="+created_by_module;	    
			    var req=getTransport();
			    req.open("GET",url,true); 
			    req.onreadystatechange=function()
			    {
			       ...
			       {  
				           ...
				           if(flag=="success")
				           {
				        	   	   ...
				        	   	   for(var i=0;i<voucher.length;i++)
				        	   	   {
								        	        	...
								        	        	for(var j=0;j<tb.rows.length;)
								        	    	   	{
								        	        				...
								        	        				if(document.frmSelfCheque_Edit.recoup_vou_no[j].value==items[0] && document.frmSelfCheque_Edit.sl_no[j].value==items[4] && document.frmSelfCheque_Edit.recoup_vou_dt[j].value==items[1])
								        	    	   			    {								        	    	   				 
								        	    	   			    		availability=true;
				        	        		...
				        	        		{						        	        			
				        	        					if(document.frmSelfCheque_Edit.recoup_vou_no.value==items[0] && document.frmSelfCheque_Edit.sl_no.value==items[4] && document.frmSelfCheque_Edit.recoup_vou_dt.value==items[1])
					        	    	   			 	{					        	    	   				 
						        	        						availability=true;   	    	   				 	 					        	    	   				 		
					        	    	   			 	}
				        	        		} 						                    
				        	   	   ...
				        	   	   if(cmd=="edit")
				        	   	   {
						        	        ...
						        	        if(tb.rows.length==1)  // table body checking
						        	        {
						        	        		...
						        	        		if(tbody.rows.length>1)
						        	        		{
									        	        		for(var i=0;i<tbody.rows.length;i++)
									        	        	  	{						        	    	   			 	
									        	    	   			 	if(document.frmSelfCheque_Edit.recoup_vou_no.value==document.frmSelfCheque_Edit.recoup_voucher[i].value && document.frmSelfCheque_Edit.sl_no.value==document.frmSelfCheque_Edit.sno[i].value && document.frmSelfCheque_Edit.recoup_vou_dt.value==document.frmSelfCheque_Edit.recoup_voucher_dt[i].value)
									        	    	   			 	{
									        	    	   				 
									        	    	   				 	    document.frmSelfCheque_Edit.sel[i].checked=true;	
									        	    	   				 	    document.frmSelfCheque_Edit.sel[i].disabled=false;											        	    	   				 	   
						        	        		...
						        	        		{
								        	        			if(document.frmSelfCheque_Edit.recoup_vou_no.value==document.frmSelfCheque_Edit.recoup_voucher.value && document.frmSelfCheque_Edit.sl_no.value==document.frmSelfCheque_Edit.sno.value && document.frmSelfCheque_Edit.recoup_vou_dt.value==document.frmSelfCheque_Edit.recoup_voucher_dt.value)
							        	    	   			 	{
							        	    	   				 
							        	    	   				 	    document.frmSelfCheque_Edit.sel.checked=true;
							        	    	   				 	    document.frmSelfCheque_Edit.sel.disabled=false;							        	    	   				 	    
						        	        ...
						        	        else
						        	        {
						        	        		...
						        	        		if(tbody.rows.length>1)
						        	        		{
										        	        	for(var i=0;i<tbody.rows.length;i++)
										        	    	   	{
										        	    	   			    if(document.frmSelfCheque_Edit.recoup_vou_no[param].value==document.frmSelfCheque_Edit.recoup_voucher[i].value && document.frmSelfCheque_Edit.sl_no[param].value==document.frmSelfCheque_Edit.sno[i].value && document.frmSelfCheque_Edit.recoup_vou_dt[param].value==document.frmSelfCheque_Edit.recoup_voucher_dt[i].value)
										        	    	   			    {
						        	        		...
						        	        		{
								        	        			if(document.frmSelfCheque_Edit.recoup_vou_no[param].value==document.frmSelfCheque_Edit.recoup_voucher.value && document.frmSelfCheque_Edit.sl_no[param].value==document.frmSelfCheque_Edit.sno.value && document.frmSelfCheque_Edit.recoup_vou_dt[param].value==document.frmSelfCheque_Edit.recoup_voucher_dt.value)
							        	    	   			 	{
