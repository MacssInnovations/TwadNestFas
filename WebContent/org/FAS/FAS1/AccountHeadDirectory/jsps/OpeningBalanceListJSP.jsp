...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/OpeningBalanceListScript.js"></script>
           ...
           try
           {
            ...
            while(rs.next())
            {
                ...
                System.out.println("exception in fetching the account head name....."+que);
                 ...
                 String currCR=rs.getString("CURRENT_YEAR_CREDIT_BALANCE").trim();
                 System.out.println(currCR);
                 String currDB=rs.getString("CURRENT_YEAR_DEBIT_BALANCE").trim();
