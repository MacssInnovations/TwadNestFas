...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Account Head Directory Maintenance System</title>
     ...
     <script type="text/javascript" src="../scripts/Acc_Head_Directory_Sys.js"></script>
     ...
     <script type="text/javascript" language="javascript">
         ...
         {  
            ...
            document.FasAcc_Headform_create.txtCrea_date.value=day+"/"+month+"/"+year;
        }
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="FasAcc_Headform_create" id="FasAcc_Headform_create" method="POST"
                            action="../../../../../Acc_Head_Directory_Sys.view?Command=Add"  onsubmit="return checkNull()">
      <%
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.FasAcc_Headform_create.txtCrea_date);"
