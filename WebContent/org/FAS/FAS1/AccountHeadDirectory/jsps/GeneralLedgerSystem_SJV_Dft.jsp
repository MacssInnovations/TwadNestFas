...
<html>
  <head>
    ...
    <title>Supplement General Ledger Posting (Defunct) </title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/GeneralLedgerSystem_SJV.js"></script>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_CheckNew();"><form name="frmGeneralLedgerSystem"
                                                      method="POST"
                                                      action="../../../../../GeneralLedgerServlet_SJV.kv"
   ...
   %>
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Posting with SJV  (Defunct)</strong>
            </div>
          </td>
        </tr>
      </table>
