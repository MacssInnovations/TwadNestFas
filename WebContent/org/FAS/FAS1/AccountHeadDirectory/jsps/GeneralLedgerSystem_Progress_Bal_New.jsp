...
<html>
  ...
  <form name="frmGeneralLedgerSystem" method="POST" action="../../../../../GeneralLedgerServlet_Progress_Bal_new" onsubmit="return checknull()">
  <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
          ...
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3"  maxlength="4" size="5" onchange="CheckYear();" onkeypress="return numbersonly(event)" >  
