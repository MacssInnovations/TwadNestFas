...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/GeneralLedgerSystem.js"></script>
  ...
  <body class="table" onload="loadyear_month();pop()">
  
  <form name="frmGeneralLedgerSystem" method="POST" action="../../../../../GeneralLedgerServlet_Progress_Bal.kv" onsubmit="return checknull()">
  <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>General Ledger Posting ( Progressive Balance) </strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3"  maxlength="4" size="5" value="2009"  onkeypress="return numbersonly(event)" disabled="disabled">  
