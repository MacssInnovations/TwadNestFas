...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/FirmListJS.js"></script>
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
   
  </head>
  <body  bgcolor="rgb(255,255,225)"><form name="firmList" id="firmList">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td>
            <div align="center">
              &nbsp;List of Firms Subsidiary Ledger Master
            </div></td>
        </tr>
        <tr class="table">
          <td>&nbsp;Firm's Name begins with the Letter&nbsp;&nbsp;
