...
<html>
  ...
  <body  bgcolor="rgb(255,255,225)"><form name="chequeForm" id="chequeForm">
  ...
  %>
   <% 
    ...
    //int empid=5556;
    int  oid=0,AccUnit_office_id=0;             // Office id
    String oname="",AccUnit_office_id_name="";        // office name
   ...
   %>
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="table">
          ...
          <td width="45%">
         <!-- <select size="1" name="txtBankAc" id="txtBankAc">
          </select>-->
        ...
        <tr class="table">
          ...
          <td width="45%">
            <input type="text" name="txtChequeCode" maxlength="10" size="10"
                   id="txtChequeCode"/>
          </td>
        </tr>
        <tr class="table">
          ...
          <td width="45%">
            <input type="text" name="txtNoLeaves" maxlength="3" size="5" 
                   id="txtNoLeaves" onkeypress="return numbersonly1(event,this)"/>
          </td>
        </tr>
        <tr class="table">
          ...
          <td width="45%">
            <input type="radio" name="radCheck_NoOfLeaf" id="radCheck_NoOfLeaf" value="Y" onclick="showicons(this.value);"
                   />
            Yes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="radCheck_NoOfLeaf" id="radCheck_NoOfLeaf" value="N" onclick="showicons(this.value);" checked="checked"/>
            No
          </td>
        </tr>
        <tr class="table">
          ...
          <td width="45%">
           ...
           <tr align="left">
             <td>
                <div>
                    <input type="text" name="txtverifyBy" id="txtverifyBy" maxlength="5" size="6" onchange="doFunction('loademp','null');" readonly
                            onkeypress="return numbersonly1(event,this)" />
                     <input type="text" id="txtverifyByName" class="disab" size="30" readonly />
                </div>
              </td>
             <td>
                    <div id="showemplist" style="display:none" > 
                    <img src="../../../../../images/c-lovi.gif" width="20" 
        ...
        <tr class="table">
          ...
          <td width="45%">
           ...
           <td>
                      <div >
                        <input type="text" name="txtPhyVerDate" id="txtPhyVerDate" readonly
        ...
        <tr class="table">
          ...
          <td width="45%">
            <input type="text" name="txtStartLNO" id="txtStartLNO" onchange="fillendleaf()"
                   maxlength="10" size="10" onkeypress="return numbersonly1(event,this)"/>
          </td>
        </tr>
        <tr class="table">
          ...
          <td width="45%">
            <input type="text" name="txtEndLNO" id="txtEndLNO" maxlength="10"   
                   size="10" onkeypress="return numbersonly1(event,this)" onblur="checkLeaf()"/>
          </td>
        </tr>
        <tr class="table">
