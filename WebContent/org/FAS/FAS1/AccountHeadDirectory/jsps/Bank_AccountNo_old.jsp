    ...
    function btnsubmit()
    {
        ...
        if(sele>0)
        {
            ...
            {      //alert("else"+sele);
                    for(i=0;i<sele;i++)
                    { 
                        //alert(document.FAS_AccNumber_Form.choice[i].checked)
        ...
        <th align="center" colspan="2">
         ...
         <!--   <th>
          ...
          <%
           ...
           try
           {
           int cmbAcc_UnitCode=0,txtCash_Acc_code=0,y=0;
            try{
            ...
            String sql="select BANK_ID, BRANCH_ID, BANK_AC_NO from FAS_OFFICE_BANK_AC_CURRENT where STATUS='Y' and ACCOUNTING_UNIT_ID="+cmbAcc_UnitCode;
