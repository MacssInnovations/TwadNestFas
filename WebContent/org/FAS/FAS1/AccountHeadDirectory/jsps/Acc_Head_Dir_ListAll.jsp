...
<html>
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>List of Account Head Directory</title>
     ...
     <script language="javascript" type="text/javascript" src="../scripts/Acc_Head_Dir_ListAll.js"></script>        
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <P align="center">&nbsp;</P>
      ...
      <P class="tdTitle"><font size="4" face="Comic Sans MS">Usage Status: </font>
      <input type="radio" checked name="usage" value="InUse" onclick="callServer()"/>&nbsp;In Use&nbsp;&nbsp;
      <input type="radio" name="usage" value="NotInUse" onclick="callServer()"/>Not In Use &nbsp;
       ...
       <table cellspacing="1" cellpadding="3" border="1" width="100%">
        ...
        <tr>
         ...
         <input type="text" maxlength="8" size="10" name="upper_range" id="upper_range" onblur="sixdigit(this.value);" onkeypress="return numbersonly(event)" disabled style="background-color:rgb(192,192,192);"/>To
          <input type="text" maxlength="8" size="10" name="lower_range" id="lower_range" onblur="sixdigit(this.value);" onkeypress="return numbersonly(event)" disabled style="background-color:rgb(192,192,192);"/>
