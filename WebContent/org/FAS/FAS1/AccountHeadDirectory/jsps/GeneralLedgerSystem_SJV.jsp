...
<html>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_CheckNew();LoadAccountingUnitID('LIST_ALL_UNITS');"><form name="frmGeneralLedgerSystem"
                                                      method="POST"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Posting with SJV </strong>
            </div>
          </td>
        </tr>
      </table>
