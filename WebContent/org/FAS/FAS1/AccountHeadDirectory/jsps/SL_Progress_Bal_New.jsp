...
<html>
  <head>
    ...
    <title>SL Progressive balance</title>
  ...
  <form name="frmGeneralLedgerSystem" method="POST" action="../../../../../SL_Progress_Bal_new" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Sub Ledger Posting ( Progressive Balance) </strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3"  maxlength="4" size="5" value="2009" onchange="CheckYear();"  onkeypress="return numbersonly(event)" >  
