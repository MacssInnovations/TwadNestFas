...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Edit_Acc_Head_Dir_Sys_New.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="FasAcc_Headform_Edit" id="FasAcc_Headform_Edit" method="POST"
                  action="../../../../../Edit_Acc_Head_Dir_Sys_New.view?Command=Add"
                  ...
                  <div align="left">
                    ...
                    <input type="radio" name="txtUse_status" id="txtUse_status"
                          ...
                          />NO
                                                                              ...
                                                                              &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtUse_status" id="txtUse_status"
                           onclick="enableUsage(this.value);" value="B"
                          />BLOCK
                  </div>
                </td>
              </tr>
