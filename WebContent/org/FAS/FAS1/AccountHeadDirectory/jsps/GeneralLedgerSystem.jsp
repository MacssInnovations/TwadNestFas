...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript"
            src="../scripts/GeneralLedgerSystem.js"></script>
	...
	if(document.getElementById("txtCB_Month")){
		...
		if(month >= 1 && month <= 12){
			if(month > 1) var disp = month-1;
			else	var disp = 12;
		} 		
		obj.options[0] = new Option(mon_names[month-1],month);
		obj.options[1] = new Option(mon_names[disp-1],disp);		
  ...
  <body class="table" onload="loadyear_month();pop();LoadAccountingUnitID('LIST_ALL_UNITS')">
  <form name="frmGeneralLedgerSystem"
                                                       method="POST"
                                                       action="../../../../../GeneralLedgerServlet.con"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Posting</strong>
            </div>
          </td>
        </tr>
      </table>
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
                ...
                <select name="txtCB_Month" id="txtCB_Month" tabindex="5">
