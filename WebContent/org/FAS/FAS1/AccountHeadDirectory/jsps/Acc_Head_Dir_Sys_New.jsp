...
<html>
  ...
  <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" no-store, no-cache, must-revalidate" >
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    <title>Account Head Directory Maintenance System</title>
     ...
     <script type="text/javascript" src="../scripts/Acc_Head_Dir_Sys_New.js"></script>
     ...
     <script type="text/javascript" language="javascript">
         ...
         {  
            ...
            document.FasAcc_Headform_create_new.txtCrea_date.value=day+"/"+month+"/"+year;
        }
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <h3><strong>Creation Of Account Head </strong></h3>
          </div>
        </td>
      </tr>
    </table>
    <form name="FasAcc_Headform_create_new" id="FasAcc_Headform_create_new" method="POST"
                            action="../../../../../Acc_Head_Dir_Sys_New.view?Command=Add"  onsubmit="return checkNull()">
      <%
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="tdTitle">
                <td colspan="2">
                  <div align="left">
                    <strong>Accounting Head  Details</strong>
                  </div>
                </td>
              </tr>
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <select size="1" name="txtMajor_id" id="txtMajor_id"
                            onchange="doFunction('loadMinor','null');">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.FasAcc_Headform_create_new.txtCrea_date);"
                ...
                <td>
                  <div align="left">
                    <input type="radio" name="txtBal_type" id="txtBal_type"
                           checked="checked" value="CR"/>Credit only &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtBal_type" id="txtBal_type"
                           value="DR"/>Debit only &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtBal_type" id="txtBal_type"
                           value=""/>Credit/Debit &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtBal_type" id="txtBal_type"
                           checked="checked" value="NCR"/>Net Credit &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtBal_type" id="txtBal_type"
                           value="NDR"/>Net Debit &nbsp;&nbsp;&nbsp;&nbsp; 
                  </div>
                </td>
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.FasAcc_Headform_create.txtlast_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.FasAcc_Headform_create.txtRef_date);"
                         alt="Show Calendar"></img>
                  </div>
                </td>
              </tr>-->
 ...
 <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
              <tr>
                <td colspan="2">
                  <!---my edit -->
                   <div id="office_disp" style="display:block">
                    <table cellspacing="1" cellpadding="2" border="1"
                           width="100%">
                      <tr class="tdTitle">
                        <td colspan="2">
                          <div align="left">
                            <strong>Office Detsils</strong>
                          </div>
                        </td>
                      </tr>
                    <tr class="table">
                        ...
                        <td colspan="2" height="23">
                             <div align="center">
                                <table border="0">
                                    <tr>
                                        <td>
                                            <input type="button" name="cmdadd1" id="cmdadd1"
                                                value="ADD" onclick="ADD_GRID1()" style="display:block"/></td>
                                        <td>
                                            <input type="button" name="cmdupdate1" value="UPDATE"
                                                id="cmdupdate1" onclick="update_GRID1()"
                                                style="display:none"/></td>
                                        <td><input type="button" name="cmddelete1" value="DELETE"
                                                id="cmddelete1" onclick="delete_GRID1()"
                                                disabled="disabled"/></td>
                                        <td><input type="button" name="cmdclea1r" value="CLEAR ALL"
                                                id="cmdclear1" onclick="clearall1()"/></td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                  ...
                  <div id="grid1" style="display:none">
                    <table id="mytable1" cellspacing="3" cellpadding="2"
                      ...
                      <tr class="tdTitle">
                        <td colspan="3">
                          <div align="left">
                            <strong>Existing Office Details </strong>
                          </div>
                        </td>
                      </tr>
                      <tr class="table">
                        <th width="10%">Select</th>
                        <th width="30%">Office Id</th>
                        <th width="30%">Office Name</th>
                        <th width="30%">Wing Name</th>
                      </tr>
