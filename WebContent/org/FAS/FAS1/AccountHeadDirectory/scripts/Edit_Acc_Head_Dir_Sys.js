...
function office_Function(param)
{
            ...
            var oid=param;
            var url="../../../../../Edit_Acc_Head_Dir_Sys.view?Command=office_Function&oid="+oid;
...
function doFunction(Command,param)
{
    ...
    if(Command=="office")
        {  
            //startwaiting(document.FasAcc_Headform_Edit);
            var oid=param;
            var url="../../../../../Edit_Acc_Head_Dir_Sys.view?Command=office&oid="+oid;
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
            {
        ...
        {  
            ...
            var txtProg_sub_id=param;
                var url="../../../../../Edit_Acc_Head_Dir_Sys.view?Command=subgroup&txtProg_id="+txtProg_id+"&txtProg_sub_id="+txtProg_sub_id;
                var req=getTransport();
                req.open("POST",url,true); 
                req.onreadystatechange=function()
                {
        ...
        {  
            ...
            var url="../../../../../Edit_Acc_Head_Dir_Sys.view?Command=loadMinor&txtMajor_id="+txtMajor_id;
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
            {
        ...
        {   
            ...
            {
            startwaiting(document.FasAcc_Headform_Edit);
            var url="../../../../../Edit_Acc_Head_Dir_Sys.view?Command=checkCode&txtAcc_HeadCode="+txtAcc_HeadCode;
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
            {
...
function loadcheckCode(baseResponse)
{
    ...
    if(flag=="success")
    {
      ...
      //document.getElementById("txtAcc_HeadCode").focus();
       ...
       var SL_YN =baseResponse.getElementsByTagName("SL_YN")[0].firstChild.nodeValue;           //  Sub-Ledger Applicable  
...
function ADD_GRID()
{
      ...
      //  items[2]=document.getElementById("txtstatus").value;
       if(document.FasAcc_Headform_Edit.txtstatus[0].checked==true)
          items[2]=document.FasAcc_Headform_Edit.txtstatus[0].value;
        else if(document.FasAcc_Headform_Edit.txtstatus[1].checked==true)
          items[2]=document.FasAcc_Headform_Edit.txtstatus[1].value;
     //    alert("item2"+items[2]);
        tbody=document.getElementById("grid_body");
        var mycurrent_row=document.createElement("TR");
        seq=seq+1;
...
{
    if(document.getElementById("txtApp_offid").value.length==0)
    {
