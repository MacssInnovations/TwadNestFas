...
{
        startwaiting(document.FasAcc_Headform_create_new);
        if(Command=="office")
        {   
            var oid=param;
            var url="../../../../../Acc_Head_Dir_Sys_New.view?Command=office&oid="+oid;
            //alert(url);
        ...
        {  
            ...
            if(txtMajor_id=='I')
            {document.FasAcc_Headform_create_new.txtBal_type[0].checked=true;}
            else if(txtMajor_id=='E')
            {document.FasAcc_Headform_create_new.txtBal_type[1].checked=true;}
            else
            {
            document.FasAcc_Headform_create_new.txtBal_type[2].checked=true;
            }
            
            var url="../../../../../Acc_Head_Dir_Sys_New.view?Command=loadMinor&txtMajor_id="+txtMajor_id;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {  
            ...
            var txtProg_sub_id=param;
                var url="../../../../../Acc_Head_Dir_Sys_New.view?Command=subgroup&txtProg_id="+txtProg_id+"&txtProg_sub_id="+txtProg_sub_id;
                var req=getTransport();
                req.open("POST",url,true); 
                req.onreadystatechange=function()
                {
        ...
        {   
            ...
            var url="../../../../../Acc_Head_Dir_Sys_New.view?Command=checkCode&txtAcc_HeadCode="+txtAcc_HeadCode;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
{  
    if(req.readyState==4)
    {
        ...
        {   
            ...
            stopwaiting(document.FasAcc_Headform_create_new) ;
...
function sub_Ledger_man(opt)
{
  if (opt=="Y")
  {
 //  document.FasAcc_Headform_create_new.txtsub_ledger_YN[0].checked=true;
   document.getElementById("no_applicalbe").style.display='none'
  }
 else if (opt=="N")
  { 
//   document.FasAcc_Headform_create_new.txtsub_ledger_YN[1].checked=true;
...
function enableUsage(opt)
{
	...
	if(opt=="Y")
    {
        document.FasAcc_Headform_create_new.txtlast_date.value="";
        document.FasAcc_Headform_create_new.txtRef_no.value="";
        document.FasAcc_Headform_create_new.txtRef_date.value="";
        document.FasAcc_Headform_create_new.txtlast_date.disabled=true;
        document.FasAcc_Headform_create_new.txtRef_no.disabled=true;
        document.FasAcc_Headform_create_new.txtRef_date.disabled=true;
    }
    else if(opt=="N")
    {
        document.FasAcc_Headform_create_new.txtlast_date.disabled=false;
        document.FasAcc_Headform_create_new.txtRef_no.disabled=false;
        document.FasAcc_Headform_create_new.txtRef_date.disabled=false;
    }
}
...
{  
	...
	if(opt=="Y")
    {
        ...
        document.FasAcc_Headform_create_new.txtApp_for_workid.disabled=false;
        document.FasAcc_Headform_create_new.txtApp_for_workDesc.disabled=false;
        document.FasAcc_Headform_create_new.txtApp_offid.disabled=false;
        //document.FasAcc_Headform_create_new.txtApp_OffName.disabled=false;
        document.FasAcc_Headform_create_new.txtApp_wingId.disabled=false;
        //document.FasAcc_Headform_create_new.txtApp_wingName.disabled=false;
    }
    else if(opt=="N")
    {
    	...
    	document.FasAcc_Headform_create_new.txtApp_offid.value="";
        document.FasAcc_Headform_create_new.txtApp_OffName.value="";
        document.FasAcc_Headform_create_new.txtApp_wingId.value=0;
        document.FasAcc_Headform_create_new.txtApp_for_workid.value="";
        document.FasAcc_Headform_create_new.txtApp_for_workDesc.value="";
        document.FasAcc_Headform_create_new.txtApp_for_workid.disabled=true;
        document.FasAcc_Headform_create_new.txtApp_for_workDesc.disabled=true;
        document.FasAcc_Headform_create_new.txtApp_offid.disabled=true;
        //document.FasAcc_Headform_create_new.txtApp_OffName.disabled=true;
        document.FasAcc_Headform_create_new.txtApp_wingId.disabled=true;
        //document.FasAcc_Headform_create_new.txtApp_wingName.disabled=false;
    }
}
...
{
        com_id=scod;
        //document.FasAcc_Headform_create_new.cmdadd.disabled=true;
        //alert(com_id);
        ...
        if((rcells.item(3).lastChild.nodeValue)=='-')
        	...
        	{
        		try{document.getElementById("txtApp_wingId").options[document.getElementById("txtApp_wingId").selectedIndex].text=rcells.item(3).lastChild.nodeValue;}catch(e){}
        	}
      
       
    document.FasAcc_Headform_create_new.cmdupdate1.style.display='block';
    document.FasAcc_Headform_create_new.cmddelete1.disabled=false;
    document.FasAcc_Headform_create_new.cmdadd1.style.display='none';
}
function loadTable(scod)
{
       ...
       // try{document.getElementById("txtstatus").value=rcells.item(3).lastChild.nodeValue;}catch(e){}
        //alert("aaa*****"+rcells.item(3).lastChild.nodeValue);
         if(rcells.item(3).lastChild.nodeValue=="Y")
         document.FasAcc_Headform_create_new.txtstatus[0].checked=true;
         else if(rcells.item(3).lastChild.nodeValue=="N")
         document.FasAcc_Headform_create_new.txtstatus[1].checked=true;
       
    document.FasAcc_Headform_create_new.cmdupdate.style.display='block';
    document.FasAcc_Headform_create_new.cmddelete.disabled=false;
    document.FasAcc_Headform_create_new.cmdadd.style.display='none';
}
...
function clearall()
{
 ...
 document.FasAcc_Headform_create_new.cmdadd.style.display='block';
 document.FasAcc_Headform_create_new.cmdupdate.style.display='none';
 document.FasAcc_Headform_create_new.cmddelete.disabled=true;
}
function clearall1()
{
 document.getElementById("txtApp_offid").value="";
 ...
 document.FasAcc_Headform_create_new.cmdadd1.style.display='block';
 document.FasAcc_Headform_create_new.cmdupdate1.style.display='none';
 document.FasAcc_Headform_create_new.cmddelete1.disabled=true;
}
...
function ADD_GRID()
{
        ...
        if(checkForRedundancy(exist))
        {
            ...
            if(document.FasAcc_Headform_create_new.txtstatus[0].checked)
            {
                     items[2]="Y";
            }
            else if(document.FasAcc_Headform_create_new.txtstatus[1].checked)
            {
                    items[2]="N";
            }
            //alert("items[2]**"+items[2]);
...
function call_clr()
{
            ...
            document.FasAcc_Headform_create_new.txtBal_type[0].checked=true;
            document.FasAcc_Headform_create_new.txtTB_mandatory[0].checked=true;
            document.getElementById("txtCrea_date").value="";
            document.getElementById("txtRemarks").value="";
            document.FasAcc_Headform_create_new.txtaccess[1].checked=true;
            document.FasAcc_Headform_create_new.txtApp_offid.value="";
            document.FasAcc_Headform_create_new.txtApp_OffName.value="";
            document.FasAcc_Headform_create_new.txtApp_wingId.value=0;
            document.FasAcc_Headform_create_new.txtApp_for_workid.value="";
...
/*if(document.FasAcc_Headform_create_new.txtUse_status[1].checked==true)
{
 ...
 if(document.FasAcc_Headform_create_new.txtaccess[0].checked==true && document.getElementById("txtApp_offid").value.length==0)
{
    alert("Enter the Office Id,if Access Restricted");
    document.getElementById("txtApp_offid").focus();
    return false;    
}
if(document.FasAcc_Headform_create_new.txtsub_ledger_YN[0].checked==true)
{
    var tbody=document.getElementById("grid_body");
