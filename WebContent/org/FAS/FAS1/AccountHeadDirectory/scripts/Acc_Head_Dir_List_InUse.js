...
function ListBy(type,alpha)
{
   ...
   {   
      startwaiting(document.AccList_form);
      var url="../../../../../Acc_Head_Dir_List_InUse.view?Command=StartingAlphabets&Alphabet="+alpha;
      var req=getTransport();
   ...
   {
     startwaiting(document.AccList_form);
      var url="../../../../../Acc_Head_Dir_List_InUse.view?Command=StartingDigit&Digit="+alpha;
      var req=getTransport();
      req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
...
function searchByRange()
{
    ...
    var usagestatus =document.getElementById("usagestatus").value;
