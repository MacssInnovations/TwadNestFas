...
function loadTabAll(cmd)
{
           // var cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
            ...
            var doc=window.opener.document;
             var cmbAcc_UnitCode=doc.supplierForm.cmbAcc_UnitCode.value;
             var cmbOffice_code=doc.supplierForm.comOffId.value;
            
            var url="../../../../../SupplierListServ.view?cmd=ListAll&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;
            //alert(url);
...
//alert(Id);
          ...
          var url="../../../../../SupplierListServ.view?cmd=list&scod="+scod+"&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            //alert(url);
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
...
function loadvalues(scod)
{
    ...
    var table=document.getElementById("mytable");
        ...
        document.supplierList.txtSuppId.value=rcells.item(1).firstChild.nodeValue;
        document.supplierList.txtSuppName.value=rcells.item(2).firstChild.nodeValue;
        document.supplierList.txtaddr.value=rcells.item(3).firstChild.nodeValue;
        document.supplierList.txtEmail.value=rcells.item(4).firstChild.nodeValue;
        document.supplierList.txtFax.value=rcells.item(6).firstChild.nodeValue;
        document.supplierList.txtPhone.value=rcells.item(5).firstChild.nodeValue;
}
...
function loadTabAllRow(baseResponse)
{
   ...
   var tbody=document.getElementById("tb");
    ...
    if(flag=="success")
    {
        ...
        var supName=baseResponse.getElementsByTagName("supplierName");
        var supAddr=baseResponse.getElementsByTagName("supAddr");
        var suplierPhone=baseResponse.getElementsByTagName("supPhone");
        var suplierFax=baseResponse.getElementsByTagName("supFax");
        var supEmail=baseResponse.getElementsByTagName("supemail");
     ...
     for(j=0;j<len;j++)
     {
        ...
        var supName1=supName.item(j).firstChild.nodeValue;
        var supAddr1=supAddr.item(j).firstChild.nodeValue;
        var supPhone1=suplierPhone.item(j).firstChild.nodeValue;
        var supFax1=suplierFax.item(j).firstChild.nodeValue;
        var supEmail1=supEmail.item(j).firstChild.nodeValue;
        var supAddr11=suplierAddr1.item(j).firstChild.nodeValue;
        var supCity1=supCity.item(j).firstChild.nodeValue;
        var status1=status.item(j).firstChild.nodeValue;
