...
function loadingMinor(Command)
{
    if(Command=="loadMinor")
        {   //alert(document.getElementById("Major_Grp"));
            ...
            var url="../../../../../Acc_Head_Dir_List_InUses?Command=loadMinor&txtMajor_id="+txtMajor_id;
            //alert(url);
...
function ListBy(type,alpha)
{
   ...
   {   
      startwaiting(document.AccList_form);
      var url="../../../../../Acc_Head_Dir_List_InUses?Command=StartingAlphabets&Alphabet="+alpha;
      var req=getTransport();
   ...
   {
     startwaiting(document.AccList_form);
      var url="../../../../../Acc_Head_Dir_List_InUses?Command=StartingDigit&Digit="+alpha;
      var req=getTransport();
      req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
...
function searchByMajorMinor()
{
    ...
    var url="../../../../../Acc_Head_Dir_List_InUses?Command=MajorMinor&MajorGroup="+MajorGrp+"&MinorGroup="+MinorGrp;
     var req=getTransport();
     req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
...
function searchByRange()
{
    ...
    var url="../../../../../Acc_Head_Dir_List_InUses?Command=Range&Upper="+upper+"&Lower="+lower;
    var req=getTransport();
    req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
