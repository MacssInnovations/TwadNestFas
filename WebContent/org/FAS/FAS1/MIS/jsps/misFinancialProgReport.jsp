...
<html>
  ...
  action="../../../../../MISFundProgressReport?command=finReport">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Financial Progress Report-RWS and URBAN Works Expenditure</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">             
                <tr align="left">
		          ...
		          <div id="more">
          		From   
          		<input type="text" name="txtCB_Year_from" id="txtCB_Year_from" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly1(event,this)">
          	...
          	To  
          	<input type="text" name="txtCB_Year_to" id="txtCB_Year_to" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly1(event,this)">
        ...
        <tr>
           ...
           <td colspan="3" align="left">
           		<input type="radio" name="urbanrural" id="urbanrural2" value="R" checked="checked">Rural
              	<input type="radio" name="urbanrural" id="urbanrural1" value="U">Urban              
           </td>
      	</tr>
        <tr>
           <td align="left">
