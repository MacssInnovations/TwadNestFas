...
<%
	...
	try {
		/*  minHead=java.net.URLDecoder.decode(((String[])request.getParameterMap().get("minHead"))[0], "UTF-8"); */
...
<script type="text/javascript" charset=UTF-8
	src="../scripts/Accountshierachy_subHead.js"></script>

</head>
<body onload="load();">
	<form name="frmAccountshierachySubHeadWise" method="POST">
		<table>
			<tr id="parameters">
				<td>
		...
		<table class="tableForm">
			<thead>
				...
				<tr>
					<th colspan="3"><%=majHead %>-<%=minHead %> For the Financial Year <%=finYear%></th>
				</tr>
