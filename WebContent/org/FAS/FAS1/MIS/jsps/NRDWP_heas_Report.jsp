...
String val="",id="",qry="",fromMonth="",toMonth="",sub_qry="",d="";
int t=0;
...
toMonth = request.getParameter("toMonth");
		...
		out.println("<tr>");
		out.println("<td colspan='3' valign='bottom' align='center' style='color:#FFF5EE;height:35px;font-size:18px ;font-weight: bold;background:#3B9C9C;'> NRDWP Details</td>");
		out.println("</tr>");
	...
	//	out.println("<th style='font-size:13px ;'>Regular Population</th>");
		...
		out.println("<th style='font-size:13px ;'><a href=\"javascript:loadValuesMinorFirseTable("+cmbAcc_UnitCode+",'" + id + "','" + val + "','" + fromMonth + "','" + toMonth + "','"+WE_R+"',"+imis_id+",'"+imis_val+"',1)\">Net</a></th>");
		//out.println("<th></th>");
		out.println("</tr>");
	...
	out.println("<td align='center' bgcolor='#7D6655' style='color: #FDD7E4;height:35px;' colspan='3' >"+imis_val.trim()+"</td>");
	out.println("</tr>");
		while (rs.next()) {
			c++;
