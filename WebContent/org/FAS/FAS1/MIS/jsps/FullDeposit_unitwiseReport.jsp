...
<head>
	 ...
	 <title>Full Deposit Unitwise Report</title>
	 <link href="../../../../../css/Sample3.css" rel="stylesheet"  media="screen"/>
     <link href="../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    <script language="javascript" type="text/javascript" src="../scripts/FullDeposit_unitwiseReport.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
         ...
         if(year < 1900) year += 1900;
          document.FullDeposit_Unitwise.txtCB_Year.value=year;
          document.FullDeposit_Unitwise.txtCB_Month.value=month;                
         }
...
<body class="table" onload="loadyear_month();">
  <form action=""  id="FullDeposit_Unitwise"  name="FullDeposit_Unitwise"  method="post" onsubmit="return checknull()">
        
        
      <table cellspacing="2" cellpadding="3" border="0" width="100%">
        <tr>
          <td class="tdH" colspan="2">
            <center>Full Deposit Unitwise</center>
          </td>
        </tr>
      <tr class="table">
      <td>
        ...
        <tr align="left">
          ...
          <td>
            <div align="left">               
             <input type=radio id="monthType" name="monthType" value="month" checked onclick="monthPeriod();"> MonthWise
             <input type=radio id="monthType" name="monthType"  value="year" onclick="monthPeriod();"/> PeriodWise
            </div>            
          </td>
        </tr> 
          ...
          <td>
            <div align="left" id="regdate" style="display:none">
                  ...
                  <input type="text" name="txtfromdate" id="txtfromdate"
                         ...
                         onblur="hideType();return checkdt(this);"
                  ...
                  <input type="text" name="txttodate" id="txttodate"
                         onkeypress="return  calins(event,this)"
                         onblur="enterSup();return checkdt(this);"
                         onfocus="javascript:vDateType='3'" maxlength="10"></input>
