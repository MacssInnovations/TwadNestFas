...
<form name="frmFasNRDWP_Details" id="frmFasNRDWP_Details"  method="GET" action="../../../../../NRDWP_Report" >
 <input type="hidden" id="cmd" name="cmd" value="Report">
 <table width="100%" border="1" align="center">
        <tr class="tdH">
          <td>
            <div align="center">NRDWP Details</div></td>
            </tr>
            </table>
...
<tr class="table">
	...
	<tr class="table">
		...
		<select id="liveFY" name="liveFY" style="width: 80pt;"  onchange="monthLoad1(this.value,'FYL');">
		...
		<select id="liveTY" name="liveTY" style="width: 80pt;"  onchange="monthLoad1(this.value,'TYL');">
			<option value="">--Select--</option>			
			<option value="2012-2013">2012-13</option>
			<option value="2013-2014">2013-14</option>
			<option value="2014-2015">2014-15</option>
	...
	<td  colspan="2">
	<input type="radio" id="WE_R" name="WE_R" value="1166" checked="checked">Works Expenditure
	...
	<input type="radio" id="rad_R1" name="rad_R" value="PDF_R"  checked="checked">PDF
	<input type="radio" id="rad_R3" name="rad_R" value="EXCEL_R">EXCEL	
