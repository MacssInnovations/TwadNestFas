...
<title>Asset Consolidated Details</title>
...
<body>
<form id="Frm_Asset"  method="GET" action="../../../../../Trail_balance_Data">
<table width="100%" border="1" align="center">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><strong>Asset Consolidated Details</strong></div>		</td>
	</tr>
	</table>
     ...
     <table cellspacing="1" cellpadding="2" border="1" width="100%">             
            ...
            <tr align="left">
          		...
          		<input type="radio" name="btnRdo" id="PDF" value="PDF" checked="checked">PDF
