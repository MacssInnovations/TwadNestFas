...
<title>SchemeWise Abstract Details -Format4</title>
...
<form name="frmFas_Details" id="frmFas_Details" method="GET" action="../../../../../fas_SchemeWise_Detail" >
 <input type="hidden" id="cmd" name="cmd" value="live">
  <input type="hidden" id="cmd_unit" name="cmd_unit" value="SCH_F41">
 <table width="100%" border="1" align="center">
        <tr class="tdH">
          <td>
            <div align="center">SchemeWise Abstract Details - Format4</div></td>
            </tr>
            </table>
