...
<title>Water Charges Collected Incur On Board</title>
...
<form name="frmCWSS_Details" id="frmCWSS_Details"  method="GET" action="../../../../../Fas_CWSS_Report" >
 <input type="hidden" id="cmd" name="cmd" value="yearly">
 <table width="100%" border="1" align="center">
        <tr class="tdH">
          <td>
            <div align="center"> Water Charges Collected And Expenditure Incurred On Board Owned W.S.S </div></td>
            </tr>
            </table>               
           <br>                
