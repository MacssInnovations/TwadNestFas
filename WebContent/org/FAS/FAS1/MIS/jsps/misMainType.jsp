...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/misMainType.js"></script>   
  </head>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="misMainType" id="misMainType" method="POST">  
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
             ...
             <tr class="table">
                <td>
                  <div align="left">Main Type Code(System Generate)</div>
                </td>
                <td>
                  <input type="text" name="mainTypeCode" id="mainTypeCode" disabled="disabled">
             ...
             <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="mainTypeDesc" id="mainTypeDesc" size="50%;"/>
                  </div>
                </td>
              </tr>               
            </table>
