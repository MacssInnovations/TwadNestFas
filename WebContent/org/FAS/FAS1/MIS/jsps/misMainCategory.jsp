...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/misMainCategory.js"></script>   
  </head>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="misMainCategory" id="misMainCategory" method="POST">  
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              <tr class="table">
                <td>
                  <div align="left">Main Category Code(System Generate)</div>
                </td>
                <td>
                  <input type="text" name="categoryCode" id="categoryCode" disabled="disabled">
                </td>
              </tr>
             <tr class="table">
                <td>
