...
<%@page import="Servlets.FAS.FAS1.CivilBills.servlets.LoadDriver"%><html>
  <head>
    ...
    <title>Expenditure Detailed</title>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.finProgressReportt_jrnl.txtCB_Year.value=year;
        document.finProgressReportt_jrnl.txtCB_Month.value=month;
      }
        </script>
  ...
  <form name="finProgressReportt_jrnl" id="finProgressReportt_jrnl" method="POST" action="../../../../../summary_ind_report_jrnl.pdf?command=individual">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Expenditure Detailed - Journal</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <tr align="left">
               ...
               <td>
               <div style="display:none">
                  <input type="radio" name="displayingOrder" id="displayingOrder" checked value="UW" ></input>Office Wise &nbsp;&nbsp;
                    </div>
