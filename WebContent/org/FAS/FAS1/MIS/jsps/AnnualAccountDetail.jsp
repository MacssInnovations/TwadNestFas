...
<html>
  <head>
    ...
    <title>Annual Account Detail</title>
  ...
  <form name="finProgressReprot" id="finProgressReprot" method="POST" action="../../../../../summary_ind_report.pdf?command=annualSummary">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Annual Account Detail</strong>
            </div>
        </td>
      </tr>
    </table>
