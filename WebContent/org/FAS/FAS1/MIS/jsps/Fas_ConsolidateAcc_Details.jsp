...
<title>Consolidated Accounts</title>
...
<form name="frmFas_CACDetails" id="frmFas_CACDetails"  method="" action="" >
 <input type="hidden" id="cmd" name="cmd" value="yearly">
  <input type="hidden" id="Report_For" name="Report_For" value="Con_Ac">
  
<table width="100%" border="1" align="center">
        <tr class="tdH">
          <td>
            <div align="center">Consolidated Accounts</div></td>
            </tr>
            </table>
...
<tr class="table">
               <td width="30%">
                ...
                <td width="20%">
                  <div align="left"><!--
                    <input type="xt" name="txtAcc_UnitCode"
