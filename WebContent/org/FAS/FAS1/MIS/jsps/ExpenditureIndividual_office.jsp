...
<%@page import="Servlets.FAS.FAS1.CivilBills.servlets.LoadDriver"%><html>
  ...
  <form name="finProgressReprot" id="finProgressReprot" method="POST" action="../../../../../summary_ind_report.pdf?command=individual">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Expenditure Detailed</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
        ...
        <tr align="left">
         ...
         <tr align="left">
               ...
               <td>
               <div style="display:none">
                  <input type="radio" name="displayingOrder" id="displayingOrder" checked value="UW" onclick="cb_month_year1(this.value)" ></input>Office Wise &nbsp;&nbsp;
                    </div>
