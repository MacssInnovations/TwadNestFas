...
%>
  <body onload="loadDate(),frzzDet('<%=s%>'),LoadProgram('<%=val%>'),LoadProgram1('<%=val%>'),Load_grid('gen'),Load_grid('sch'),Load_grid('brd');LcBody('<%=val%>'),LcBody1('<%=val%>');"><table cellspacing="1" cellpadding="3" width="100%">
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
   ...
   <input type="hidden" id="sno_val" name="sno_val" value=""/>
	...
	<tr class="tdH">
        ...
        <div class="tab-page" id="gd">
          <h2 class="tab">scheme liability</h2>
...
<table cellspacing="2" cellpadding="3" border="1" width="100%" >
	...
	<tbody id="tblList_gen1" class="table" align="left"></tbody>
        ...
        <div class="tab-page" id="gd1">
          <h2 class="tab">Amt due to Board</h2>
...
<font style="color: purple;"><blink>UnFreeze Pending</blink></font>
	 ...
	 <div class="tab-page">
          <h2 class="tab">Help</h2>
         <center> <a href="../../../../../commafun.txt" />Help</a></center>
          </div>
