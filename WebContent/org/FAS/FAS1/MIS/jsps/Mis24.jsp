...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/Mis24.js"></script>
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.mis24.txtCB_Year_from.value=year;
        document.mis24.txtCB_Month_from.value=month;
        
        /** Load To Cash Book Month and To Cash Book Year during Form Load */
        document.mis24.txtCB_Year_to.value=year;
        document.mis24.txtCB_Month_to.value=month;
  ...
  <body class="table" onload="loadyear_month();callServer('majorGroup')">
  <form name="mis24" id="mis24" method="POST" action="../../../../../mis24report.pdf?command=report">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>MIS 24</strong>
            </div>
        </td>
      </tr>
    </table>
