...
<%@page import="Servlets.FAS.FAS1.CivilBills.servlets.LoadDriver"%><html>
  <head>
    ...
    <title>MWSS Annexure II B</title>
  ...
  <form name="finProgressReprot" id="finProgressReprot" method="POST" action="../../../../../MWSSAnnexureIIBi3">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>MWSS Annexure II B</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">             
                <tr align="left">
          		...
          		<input type="text" name="txtfrom_CB_Year" id="txtCB_Year_from" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)">
          		<select name="txtfrom_CB_Month"  id="txtCB_Month_from" tabindex="4" >
          	...
          	<input type="hidden" name="txtto_CB_Year" id="txtCB_Year_to" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)">
          <!-- 	<select name="txtto_CB_Month"  id="txtCB_Month_to" tabindex="4" onchange="callSJVload();">
          		<option value="1">January</option>
          		<option value="2">February</option>
          		<option value="3">March</option>
          		<option value="4">April</option>
