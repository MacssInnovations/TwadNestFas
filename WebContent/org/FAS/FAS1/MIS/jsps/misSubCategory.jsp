...
<html>
  <head>
   ...
   <script type="text/javascript" src="../scripts/misSubCategory.js"></script>   
  </head>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
    ...
    <form name="misMainCategory" id="misMainCategory" method="POST">  
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              <tr class="table">
                ...
                <td>
                  <select name="categoryCode" id="categoryCode" onchange="callServer('Get');">
             ...
             <tr class="table">
                <td>
                  <div align="left">Sub Category Code(System Generate)</div>
                </td>
                <td>
                  <input type="text" name="subCategoryCode" id="subCategoryCode" disabled="disabled">
             ...
             <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="subCategoryDesc" id="subCategoryDesc" size="50%;"/>
                  </div>
                </td>
              </tr>               
            </table>
	   ...
	   <table id="mytable" cellspacing="3" cellpadding="2" border="1" width="100%" align="center">
		<tr class="tdH">
			<td colspan="5">Existing Details</td>
			<td colspan="1">
