...
function fun_Live()
{
	...
	var Report_For=document.getElementById("Report_For").value;
	 document.getElementById("cmd").value="live_Report";
     var url="../../../../../Fas_ConsolidateTBAcc_Details?cmd=live_Report&liveFY="+liveFY+
     "&fromMonth="+fromMonth+"&toMonth="+toMonth;
    //alert("mmmm >>> "+url);
     if(Report_For=="Con_TB"){
 	document.frmFas_CTBDetails.action = url;
	document.frmFas_CTBDetails.method = "GET";
	document.frmFas_CTBDetails.submit();}
     else if (Report_For=="Con_Ac")
     {
    		document.frmFas_CACDetails.action = url;
    		document.frmFas_CACDetails.method = "GET";
    		document.frmFas_CACDetails.submit();}
}
function fun_fzdLive()
{
	 ...
	 var Report_For=document.getElementById("Report_For").value;
	 document.getElementById("cmd").value="fzdlive_Report";
     var url="../../../../../Fas_ConsolidateTBAcc_Details?command=fzdlive_Report&fzdFY="+fzdFY+
     "&fromfzdMonth="+fromfzdMonth+"&tofzdMonth="+tofzdMonth;
   //  alert(url);   
     if(Report_For=="Con_TB"){
    	 	document.frmFas_CTBDetails.action = url;
    		document.frmFas_CTBDetails.method = "GET";
...
{
	var fin_year="";
	  var url="../../../../../Fas_trialData_Details?command=loadCmb";
	
	   if(type=="ConFYL")
	    		{
	    		fin_year=document.getElementById("liveFY").value;
	    		
	    		}else if(type=="ConFYFz")
				{
	    			fin_year=document.getElementById("fzdFY").value;
	    		
				}
	    			
	    		url+="&Type="+type+"&Fin_year="+fin_year;
	    		//alert(url);
...
function onCmbLoad(req)
{
	...
	var Type1 = baseResponse.getElementsByTagName("type1")[0].firstChild.nodeValue;
