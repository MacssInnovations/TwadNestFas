...
<html>
  <head>
    ...
    <title>NRDWP Budget</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"  src="../../../../../org/FAS/FAS1/NRDWP/scripts/nrdwp_Budget.js"></script>
  ...
  <table cellspacing="1" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <font size="4">NRDWP Budget</font>
          </div>
        </td>
      </tr>
    </table>
    
    <form name="frmnrdwpBudget" id="frmnrdwpBudget" method="post" >
    ...
    if(session.getAttribute("FAS_SU")!=null && ((String)session.getAttribute("FAS_SU")).equalsIgnoreCase("YES"))
       ...
       <tr class="tdH">
          ...
          <td colspan="3" class="table">
            <input type="button" name="CmdGo" value="View" id="CmdGo" onclick="callServer('Go')" />
            <input type="button" id="editDetails" name="editDetails" value="EDIT" onclick="callServer('Edit1')"/>
            </td>
         ...
         <table id="Existing" cellspacing="1" cellpadding="2" border="1" width="100%" align="center" >
				<tr class="tdH"><!--
					...
					<th width="22%">Budget </th>
					<th width="22%"> Allocation</th>
					<th width="7%"> for the year</th>
					</tr>
            ...
            <table align="center" cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  <td>
                    <div align="center">
                             <input type="button" id="addDetails" name="addDetails" value="ADD" onclick="addbtn();"></input>
                             <input type="button" id="updateDetails" name="updateDetails" value="UPDATE" disabled="disabled" onclick="updatebtn();"></input>
                             <input type="button" id="deleteDetails" name="deleteDetails" value="DELETE" disabled="disabled" onclick="deletebtn();"/>
