...
<title>Freeze for NRDWP Budget</title>
...
<script type="text/javascript" src="../scripts/nrdwp_Freeze.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">NRDWP Budget - Freeze</font></div>
		</td>
	</tr>
</table>

<form name="frmnrdwp_Freeze" id="frmnrdwp_Freeze"
	method="POST" action="../../../../../nrdwp_Freeze">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<td>
		<div align="left"><select name="cmbFinancialYear" id="cmbFinancialYear" >
...
<table cellspacing="1" cellpadding="2" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="button" name="butSub"
			id="butSub" value="Freeze" onClick="FuncSave('<%=s%>');" />
