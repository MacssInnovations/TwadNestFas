...
{ 
	...
	var status=document.getElementById("cmbStatus").value;
	  ...
	  var url="../../../../../TPA_Acceptance_Verification_Cancel?command=get&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&searchby=yearmonth&cmbOffice_code="+cmbOffice_code+"&proformatype="+proformatype+"&status="+status+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"";
 ...
 { 
	...
	if(document.getElementById("txtTo_date").value=="")
	{
 	  ...
 	  var url="../../../../../TPA_Acceptance_Verification_Cancel?command=get&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&searchby=date&cmbOffice_code="+cmbOffice_code+"&proformatype="+proformatype+"&status="+status+"&fromdate="+fromdate+"&todate="+todate+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"";
