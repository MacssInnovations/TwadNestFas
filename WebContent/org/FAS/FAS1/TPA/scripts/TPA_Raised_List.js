...
{ 
	...
	var status=document.getElementById("cmbStatus").value;
		...
		if(document.forms[0].listtype[0].checked==true)
			{
			listall="or";
			}
		else if(document.forms[0].listtype[1].checked==true)
			{
			listall="uv";
			}
		else if(document.forms[0].listtype[2].checked==true)
			{
			listall="av";
			}
		else
	...
	//	alert("listall:"+listall);
	  var url="../../../../../TPA_Raised_List?command=get&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&searchby=yearmonth&cmbOffice_code="+cmbOffice_code+"&proformatype="+proformatype+"&status="+status+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"&listType="+listall;
 ...
 { 
	...
	if(document.getElementById("txtTo_date").value=="")
	{
 	  ...
 	  var url="../../../../../TPA_Raised_List?command=get&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&searchby=date&cmbOffice_code="+cmbOffice_code+"&proformatype="+proformatype+"&status="+status+"&fromdate="+fromdate+"&todate="+todate+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"";
