...
{ 
	...
	var status=document.getElementById("cmbStatus").value;
	  ...
	  var url="../../../../../TPA_Acceptance_Verification?command=get&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&searchby=yearmonth&cmbOffice_code="+cmbOffice_code+"&proformatype="+proformatype+"&status="+status+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"";
...
//                 alert("str2[0]==>"+str2[0]);
                 ...
                 {
                            alert("Verification Date should not be less than Originated Date** ");
                             document.getElementById("txtCreate_Date").value="";
