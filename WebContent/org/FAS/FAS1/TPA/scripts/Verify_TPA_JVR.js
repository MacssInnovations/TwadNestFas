...
{   
           ...
           var tpatype=document.getElementById("proformatype").value;
           ...
           if(Command=="loadPendingJournals_NV")
           {
            ...
            var url="../../../../../Verify_TPA_JVR?Command=loadPendingJournals_NV&cmbAcc_UnitCode="+cmbAcc_UnitCode
                    +"&cmbOffice_code="+cmbOffice_code+"&tpatype="+tpatype+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&txtfromdate="+txtfromdate+"&txttodate="+txttodate;
           }
           ...
           var url="../../../../../Verify_TPA_JVR?Command=loadPendingJournals_V&cmbAcc_UnitCode="+cmbAcc_UnitCode
