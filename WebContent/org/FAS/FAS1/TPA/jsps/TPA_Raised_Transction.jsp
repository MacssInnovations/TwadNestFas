...
<table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
      ...
      <%  ps=con.prepareStatement(" select a.*,b.account_head_desc, c.sub_ledger_type_desc from \n"+       
                   " ( select SL_NO,ACCOUNT_HEAD_CODE,SUB_LEDGER_TYPE_CODE,SUB_LEDGER_CODE,AMOUNT,PARTICULARS,CR_DR_INDICATOR from FAS_TPA_TRANSACTION  where \n"+   
         ...
         <td><%=rs.getString("CR_DR_INDICATOR")%></td>
