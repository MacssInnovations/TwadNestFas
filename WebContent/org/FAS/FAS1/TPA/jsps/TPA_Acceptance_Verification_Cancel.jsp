...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TPA_Acceptance_Verification_Cancel.js"></script>
  ...
  <form name="tpa_raised_list" method="POST" action="../../../../../TPA_Acceptance_Verification_Cancel">
  <%
		    Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong> TPA Verification Cancel</strong>
          </div>
        </td>
      </tr>
    </table>
