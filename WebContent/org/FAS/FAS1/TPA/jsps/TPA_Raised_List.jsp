...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TPA_Raised_List.js"></script>
  ...
  <body class="table" onload="loadyear_month();LoadAccountingUnitID_Create('LIST_ALL_UNITS');" >
  <form name="tpa_raised_list" method="POST">
  <%
		  /*  Connection con=null;
  ...
  <% 
		    ...
		    if(session.getAttribute("FAS_TPA_AUDIT_ROLE")!=null && ((String)session.getAttribute("FAS_TPA_AUDIT_ROLE")).equalsIgnoreCase("YES"))
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of TPA Raised</strong>
          </div>
        </td>
      </tr>
    </table>
         ...
         <tr class="table">
             ...
             <tr class="table">
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="radio" name="listtype" id="listtype" value="or" checked>Originated  
                    <input type="radio" name="listtype" id="listtype" value="uv">Unit Verified                                      
                    <input type="radio" name="listtype" id="listtype" value="av">Audit Verified
                    <input type="radio" name="listtype" id="listtype" value="fr">Freezed
                  </div>
                </td>
              </tr>
               <tr class="table">
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.tpa_raised_list.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.tpa_raised_list.txtTo_date);"
                         alt="Show Calendar"></img>
     ...
     <table id="mytable" align="center"  cellspacing="3" 
         cellpadding="2" border="1" width="100%">
          <tr class="tdH">
            ...
            <th id="ori" style="display:none">
              Originated Date
            </th>
            <th id="uv" style="display:none">
              Unit Verified Date
            </th>
            <th id="av" style="display:none">
              Audit Verified Date
            </th>
            <th id="fr" style="display:none">
              Freeze Date
            </th>
