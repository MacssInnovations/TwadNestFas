...
<html> 
  <head>
    ...
    <script type="text/javascript" src="../scripts/TPA_Raised_Edit.js"></script>
    ...
    <script type="text/javascript" language="javascript">
         ...
         function loadDate()
         {
            ...
            document.frm_TPA_Raised_Edit.Voucher_Date.value=day+"/"+month+"/"+year;
 ...
 %>
    ...
    <form name="frm_TPA_Raised_Edit" id="frm_TPA_Raised_Edit" method="POST" action="../../../../../TPA_Raised_Edit?Command=Add" onsubmit="return checkNull()">
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="Voucher_Date" id="Voucher_Date" tabindex="3" 
                           ...
                           onfocus="javascript:vDateType='3';" onkeypress="return calins(event,this);" onblur="call_date(this);" onchange="resetType();"/>
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frm_TPA_Raised_Edit.Voucher_Date,1);"
                         alt="Show Calendar"></img>  
                         
                         <input type="hidden" name="txtCB_Year" id="txtCB_Year" > 
                           <input type="hidden" name="txtCB_Month" id="txtCB_Month" > 
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">                  
                    <input id="Org_CR_DR" type="radio" value="CR" checked="checked" name="Org_CR_DR" onclick="doFunction_voucher('load_Voucher_No1')"/>Credit     
               ...
               <tr class="table">
                ...
                <td>
                  <div align="left" >
                  	<select name="adviceNumber" id="adviceNumber" onchange="doFunction_voucher('load_Voucher_Details1')">
            ...
            <table cellspacing="1" cellpadding="2" border="0" width="100%">
             ...
             <td>
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    <input type="text" name="Amount" onkeypress="return limit_amt(this,event);" onblur="valid_amt(this);account_head_code()"
