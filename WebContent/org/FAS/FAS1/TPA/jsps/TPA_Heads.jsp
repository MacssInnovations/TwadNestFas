...
<html>
  <head>
   <meta http-equiv="Content-Type" content="text/html; charset=windows-1252"/>   
    ...
    <script type="text/javascript"	src="../scripts/TPA_Heads.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
  </head>
  
  <body onload="getAccountHeadcode();"  bgcolor="rgb(255,255,225)">
        ...
        <form name="formHeadcode" method="" action="">
          <div align="left">
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
          <tr class="tdH">
            <td>
              <div align="center">
                 <input type="button" name="butAdd" id="butAdd" value="ADD" onclick="callheadAdd();"/> 
                    &nbsp;
                 <input type="button" name="butUpdate" id="butUpdate" value="UPDATE" disabled="disabled" onclick="callheadUpdate();"/>
                    &nbsp;
                 <input type="button" name="butDelete" id="butDelete" value="CANCEL" disabled="disabled" onclick="callheadDelete();"/>
                    &nbsp;
