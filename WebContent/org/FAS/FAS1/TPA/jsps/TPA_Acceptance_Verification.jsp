...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TPA_Acceptance_Verification.js"></script>
  ...
  <body class="table" onload="clrForm();loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');" >
  <form name="tpa_raised_list" method="POST" action="../../../../../TPA_Acceptance_Verification" onsubmit="return checknull_submit();">
  <%
		    Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong> TPA Verification</strong>
          </div>
        </td>
      </tr>
    </table>
