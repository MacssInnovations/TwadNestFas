...
function numbersonly(e)
{
 ...
 function confirmation()
 {
  ...
  if(confirm("Do you want to Freeze Trial Balance? If OK All posting will be automatically done and pl wait till you get the message TB Status Frozen Successfully!."))
  {
