...
{  
	    ...
	    var url="../../../../../Arrival_CB_GL.kv?command=checkAvl&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month;
      // alert(url);
...
//                         items[4]=baseResponse.getElementsByTagName("projectId")[k].firstChild.nodeValue;   
                         items[2]=baseResponse.getElementsByTagName("cb")[k].firstChild.nodeValue;
                         items[3]=baseResponse.getElementsByTagName("indicator")[k].firstChild.nodeValue;  
                         items[4]=baseResponse.getElementsByTagName("createdbymodule")[k].firstChild.nodeValue;  
                     ...
                     tbody.appendChild(mycurrent_row);
                      ...
                      alert("Arrival Already Done For GL");
