...
function numbersonly(e)
{
 ...
 //alert("CheckStatus");
  ...
  var url="../../../../../FreezeGL_PB_servlet?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+"&txtCB_Year1="+splyear[0]+"&txtCB_Year2="+splyear[1];
    //    alert(url);
