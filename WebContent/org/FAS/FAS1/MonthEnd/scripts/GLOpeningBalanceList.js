...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Voucher_list_SL= window.open("../../../../../org/FAS/FAS1/PaymentSystem/jsps/BankPay_NilPayment_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"VoucherDetails","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Voucher_list_SL.moveTo(250,250);  
    Voucher_list_SL.focus();
...
function printing(unitcode,offid,yr,mon,recNo)
{
    ...
    document.GLOpeningBalanceList.action=url;
    document.GLOpeningBalanceList.method="POST";
    document.GLOpeningBalanceList.submit();
      return true;
}
/////////-------------------------- end report
...
{   
        ...
        {  
            ...
            {
               // var txtCreat_By_Module='NP';
                var url="../../../../../GLOpeningBalanceList?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                //var txtCreat_By_Module='NP';
                var url="../../../../../GLOpeningBalanceList?Command=searchByHcode&cmbAcc_UnitCode="+cmbAcc_UnitCode+
...
function changepage()
{
var page=document.GLOpeningBalanceList.cmbpage.value;
...
function loadPage(page)
{
            ...
            document.GLOpeningBalanceList.cmbpage.selectedIndex=page-1;
            var tbody=document.getElementById("tbody");
            try{tbody.innerHTML="";}
            catch(e) {tbody.innerText="";}  
             ...
             if(service)
             {
                ...
                for(i=p;i<service.length&& c<__pagination;i++)
                {
                        c++;
                         var items=new Array();
                        items[0]=service[i].getElementsByTagName("Hcode")[0].firstChild.nodeValue;
                       // alert("items[0]"+items[0]);
                       items[1]=service[i].getElementsByTagName("Hname")[0].firstChild.nodeValue;
                      //  alert("items[1]"+items[1]);
                        items[2]=service[i].getElementsByTagName("UptoCRBalance")[0].firstChild.nodeValue;
                        items[3]=service[i].getElementsByTagName("UptoDBBalance")[0].firstChild.nodeValue;
                        items[4]=service[i].getElementsByTagName("currCR")[0].firstChild.nodeValue;
                        items[5]=service[i].getElementsByTagName("currDB")[0].firstChild.nodeValue;
                        items[6]=service[i].getElementsByTagName("OB")[0].firstChild.nodeValue;
                        items[7]=service[i].getElementsByTagName("IND")[0].firstChild.nodeValue;
                        items[8]=service[i].getElementsByTagName("CUR_DEBIT")[0].firstChild.nodeValue; 
                        items[9]=service[i].getElementsByTagName("CUR_CREDIT")[0].firstChild.nodeValue; 
                        items[10]=service[i].getElementsByTagName("CLOSING_BALANCE")[0].firstChild.nodeValue; 
                        items[11]=service[i].getElementsByTagName("CLOSING_BAL_IND")[0].firstChild.nodeValue; 
                        items[12]=service[i].getElementsByTagName("DR_DATE")[0].firstChild.nodeValue; 
                       // alert("drdate"+items[11]);
                        items[13]=service[i].getElementsByTagName("CR_DATE")[0].firstChild.nodeValue; 
                       //  alert("crdate"+items[12]);
...
function changepagesize()
{
           ...
           __pagination=document.GLOpeningBalanceList.cmbpagination.value;
