...
function ListAll()
{
       ...
       // listPopupwindow= window.open("ListofSubLedgerMainForm_OC.jsp?cmbAcc_UnitCode="+Acc_UnitCode+"&cmbOffice_code="+OffCode+"&txtFinanYr="+FinanYr+"&CashbookYear="+CashbookYear+"&CashbookMonth="+CashbookMonth,"mywindow1","status=1,height=400,width=500,resizable=YES, scrollbars=yes"); 
        listPopupwindow= window.open("ListofSubLedgerMainForm_OC.jsp?cmbAcc_UnitCode="+Acc_UnitCode+"&cmbOffice_code="+OffCode+"&txtFinanYr="+FinanYr+"&CashbookYear="+CashbookYear+"&CashbookMonth="+CashbookMonth+"&SL_type="+cmbSL_Type+"&Type_Code="+cmbMas_SL_Code,"mywindow1","status=1,height=400,width=500,resizable=YES, scrollbars=yes"); 
...
{  
    ...
    if(Command=="Load_MasterSL_Code")
        ...
        if(Command=="checkCode")
        {
            ...
            url="../../../../../SubLedgerMainFormServlet_OC.con?Command=HeadCode&txtAcc_Head_code="+headcode;
        ...
        if(Command=="Add")
        {
            if(nullcheck())
            {
                var url="../../../../../SubLedgerMainFormServlet_OC.con?Command=Add&cmbAcc_UnitCode="+Acc_UnitCode+"&comOffCode="+OffCode+"&txtFinanYr="+FinanYr+"&cmbAcHeadCode="+AcHeadCode+"&cmbSL_type="+cmbSL_type+"&cmbMas_SL_Code="+cmbMas_SL_Code+"&CloseBal="+CloseBal+"&CloseBalInd="+CloseBalInd+"&CashbookYear="+CashbookYear+"&CashbookMonth="+CashbookMonth;
             //   alert(url);
                var req=getTransport();
                req.open("GET",url,true); 
                req.onreadystatechange=function()
    ...
    else if(Command=="Update")
    {
                if(nullcheck())
                {
                    var url="../../../../../SubLedgerMainFormServlet_OC.con?Command=Update&cmbAcc_UnitCode="+Acc_UnitCode+"&comOffCode="+OffCode+"&txtFinanYr="+FinanYr+"&cmbAcHeadCode="+AcHeadCode+"&cmbSL_type="+cmbSL_type+"&cmbMas_SL_Code="+cmbMas_SL_Code+"&CloseBal="+CloseBal+"&CloseBalInd="+CloseBalInd+"&CashbookYear="+CashbookYear+"&CashbookMonth="+CashbookMonth;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
    ...
    else if(Command=="Delete")
    {
        if(confirm("Do u really want to delete the record"))
        {
                if(nullcheck())
                {
                    var url="../../../../../SubLedgerMainFormServlet_OC.con?Command=Delete&cmbAcc_UnitCode="+Acc_UnitCode+"&comOffCode="+OffCode+"&txtFinanYr="+FinanYr+"&cmbAcHeadCode="+AcHeadCode+"&CashbookYear="+CashbookYear+"&CashbookMonth="+CashbookMonth+"&cmbSL_type="+cmbSL_type+"&cmbMas_SL_Code="+cmbMas_SL_Code;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
