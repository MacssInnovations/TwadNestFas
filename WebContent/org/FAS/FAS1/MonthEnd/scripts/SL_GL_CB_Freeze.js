...
function  Ledger_Details()
{
       ...
       var cashbook_year = document.getElementById("txtCB_Year").value;    
            ...
            var url="../../../../../SL_GL_CB_Freeze.kv?Command=Ledger_Details&accounting_unit_id="+accounting_unit_id+"&cashbook_month="+cashbook_month+"&cashbook_year="+cashbook_year;
       ...
       if(req.readyState==4)
        {
          ...
          {               
            ...
            if(Command=="Disp_Ledger_Details")
            {
