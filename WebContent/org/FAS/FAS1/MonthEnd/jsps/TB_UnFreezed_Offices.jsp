...
<html>
  <head>
    ...
    <title>Trial Balance Unfreezed Units </title>
 ...
 <form name="frmTB_UnFreezed_Offices" method="POST" action="../../../../../TB_UnFreezed_Offices" onsubmit="return checknull()">
  <%
    Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Trial Balance Unfreezed Units</strong>
            </div>
        </td>
      </tr>
    </table>
