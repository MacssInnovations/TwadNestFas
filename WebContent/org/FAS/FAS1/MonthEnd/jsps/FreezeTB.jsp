         ...
         <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
               <tr class="table">
                  ...
                  <td>
                     <div align="left">
                        <select size="1" name="cmbAcc_UnitCode" onchange="TB_Restrict();checkVerification();"
               ...
               <tr align="left">
                  ...
                  <td>
                     <div align="left">
                        ...
                        <select name="txtCB_Month" id="txtCB_Month" onchange="checkVerification();"
                                tabindex="4">
                        ...
                        <input type="button" name="gobtn" id="gobtn" value="Go" onclick="callGrid();tr_tb_verify();" ></input> 
 ...
 in the column provided so as to take corrective action.
         ...
         <table align="center" cellspacing="3" cellpadding="2" border="1"
            ...
            <tr class="tdH">
               <td>
                  <div align="center">
                     <input type="submit" value="Submit" id="submit" disabled></input>
