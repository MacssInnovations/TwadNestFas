...
<html>
  <head>
    ...
    <title>Trial Balance (Binding) </title>
  ...
  <body class="table" onload="loadyear_month();LoadAccountingUnitID('FOR_LIST_0')"><form name="frmTrialBalance"
                                                                          method="POST"
                                                                          action="../../../../../TB_Report_Binding.kv"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Trial Balance Report (Binding)</strong>
            </div>
          </td>
        </tr>
      </table>
          ...
          <tr align="left">
            ...
            <td>
              <div align="left">
                ...
                <select id="txtCB_Month" name="txtCB_Month">
