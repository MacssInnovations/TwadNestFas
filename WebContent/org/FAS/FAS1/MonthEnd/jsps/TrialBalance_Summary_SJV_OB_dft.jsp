...
<html>
  ...
  <body class="table" onload="loadyear_month();setTimeout('Suppl_Number_Check_allsup()',1000);" >
  <form name="frmTrialBalance" method="POST" action="../../../../../TrialBalance_Summary_SJV.kv?command=withOB" onsubmit="return checknull()">
 <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
          ...
          <input type="text" name="from_txtCB_Year" id="from_txtCB_Year" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)" onblur="Suppl_Number_Check_allsup();">
          ...
          <input type="text" name="to_txtCB_Year" id="to_txtCB_Year" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)" onblur="Suppl_Number_Check_allsup();">
