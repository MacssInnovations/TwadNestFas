...
<html>
  <head>
    ...
    <title>Unfreeze PB</title>
     ...
     function loadyear_month()
        ...
        document.unfreezepb.txtCB_Year.value=year;
        document.unfreezepb.txtCB_Month.value=month;
  ...
  <form name="unfreezepb" method="POST" action="../../../../../UnFreezeSL_PB">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
          ...
          <option value="ttt">select the Month</option>
