...
<html>
  <head>
    ...
    <title>List of Trial Balance Not Generated Offices </title>
 ...
 <form name="frmTB_Not_Generated_Offices" method="POST" action="../../../../../TB_Not_Generated_Offices.kv" onsubmit="return checknull()">
  <%
    Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>List of Trial Balance Not Generated Offices</strong>
            </div>
        </td>
      </tr>
    </table>
