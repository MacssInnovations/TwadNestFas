...
<html>
  ...
  <body class="table" onload="loadyear_month();setTimeout('loadPaymentUnit();',900);" >
  <form name="Jrnldownload" method="POST" action="../../../../../Jrnl_download" onsubmit="return checknull()">
    <input type="hidden" value="PAYMENT" id="jrnl" name="jrnl">
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Payment Data Download</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <select name="from_txtCB_Month"  id="from_txtCB_Month" tabindex="4" onchange="loadPaymentUnit();">          
