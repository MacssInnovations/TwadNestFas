...
<html>
  <head>
    ...
    <title>Supplement Trial Balance</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
    <script language="javascript" type="text/javascript"
            src="../scripts/TrialBalance_SJV.js"></script>
   ...
   <script type="text/javascript"
    ...
    <script type="text/javascript"  src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Supplement_Number_Check.js"></script>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_CheckNew();LoadAccountingUnitID('LIST_ALL_UNITS_ONLY');">
  
  <form name="frmTrialBalance"
          method="POST"
          action="../../../../../TrialBalance_Gen_SJV.kv"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement Trial Balance</strong>
            </div>
          </td>
        </tr>
      </table>
