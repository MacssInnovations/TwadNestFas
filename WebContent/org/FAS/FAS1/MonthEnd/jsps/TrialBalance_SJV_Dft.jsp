...
<html>
  <head>
    ...
    <title>Supplement Trial Balance (Defunct) </title>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_CheckNew();"><form name="frmTrialBalance"
                                                      method="POST"
                                                      action="../../../../../TrialBalance_Gen_SJV.kv?command=normal"
   ...
   %>
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement Trial Balance (Defunct) </strong>
            </div>
          </td>
        </tr>
      </table>
