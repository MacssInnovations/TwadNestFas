...
<html>
  <head>
    ...
    <title>Sub Ledger Posting (Progressive Balance) </title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>
    
    <script language="javascript" type="text/javascript" src="../scripts/SubLedgerMaster_Progress_Bal.js"></script>
  ...
  <form name="frmGeneralLedgerSystem" method="POST" action="../../../../../SubLedgerMasterServlet_MonthEnd_Progress_Bal.kv" onsubmit="return checknull()">
   <%
  Connection con=null;
