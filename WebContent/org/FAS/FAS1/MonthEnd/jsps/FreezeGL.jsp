...
<html>
  <head>
    ...
    <title>Freeze Trial Balance</title>
     ...
     <script language="javascript" type="text/javascript" src="../scripts/FreezeGL.js"></script>
    ...
    <script language="javascript" type="text/javascript">
                ...
                function chkAlert()
                {
                  alert('Are You Verified the GL Balance');
                  return true;
                }
    </script>
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../FreezeGL.view" onsubmit="return chkAlert()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Freeze GL&nbsp;Closing Balance</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <!--<option value="12">December</option>-->
              ...
              <div align="left"  style="display:none">
                 General Ledger Balance Status
              </div>
            
             <div align="left"  style="display:none">
                <input type="radio" id="radGL_status" name="radGL_status" value="Y" checked="checked"> Yes
                <input type="radio" id="radGL_status" name="radGL_status" value="N" > No
             </div>
