...
<html>
  <head>
    ...
    <title>Supplement Trial Balance Report  </title>
...
<script type="text/javascript"
  ...
  <body class="table" onload="LoadAccountingUnitID('LIST_ALL_UNITS_ONLY');loadyear_month();Suppl_Number_Check_allsup();">
  
  <form name="frmTrialBalance"
                                                      method="POST"
                                                      action="../../../../../View_Trial_Balance_SJV.kv"
   ...
   %>
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement Trial Balance Report </strong>
            </div>
          </td>
        </tr>
      </table>
