...
<html>
  <head>
    ...
    <title>Unfreeze Supplement Trial Balance (Defunct) </title>
  ...
  <form name="frmTrialBalance" method="POST" action="" onsubmit="return confirmation()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Unfreeze Supplement Trial Balance (Defunct) </strong>
            </div>
        </td>
      </tr>
    </table>
