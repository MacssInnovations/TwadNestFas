  ...
  <head>
   ...
   <META HTTP-EQUIV="CACHE-CONTROL" CONTENT=" pre-check=0, post-check=0, max-age=0" >
    ...
    <script type="text/javascript" src="../../../../../../org/HR/HR1/EmployeeMaster/scripts/CalendarControl.js"></script>
     <script type="text/javascript" src="../scripts/Arrival_CB_SL_JS.js"></script>
...
%>
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../Arrival_CB_SL.kv" onsubmit="return checknull()">
     
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Arrival of Closing Balance For SL</strong>
            </div>
          </td>
        </tr>
      </table>
