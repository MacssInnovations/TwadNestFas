...
<html>
  <head>
    ...
    <title>Bank Balance Update Report</title>
    ...
    <script type="text/javascript" language="javascript">
      function loadyear_month()
        ...
        document.frmBRS_Bank_Balance_Update_Report.txtCB_Year.value=year;
        document.frmBRS_Bank_Balance_Update_Report.txtCB_Month.value=month;
  ...
  <body onload="loadyear_month();">
   ...
   %>
  <form name="frmBRS_Bank_Balance_Update_Report" method="POST" action="../../../../../BRS_Bank_Balance_Update_Report" >
