...
<html>
  <head>
    ...
    <title>Trial Balance(INCLUDING SJV-ALL UNITS)</title>
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../TrialBalance_Summary_all?command=inc_SJV" onsubmit="return checknull()">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Trial Balance Summary Report Including SJV</strong>
            </div>
        </td>
      </tr>
    </table>
