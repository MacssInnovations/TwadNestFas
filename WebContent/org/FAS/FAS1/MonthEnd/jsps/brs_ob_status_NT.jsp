...
<html>
   <head>
      ...
      <title>Freeze BRS OB-NONTWAD</title>
      ...
      <script language="javascript" type="text/javascript"
              src="../scripts/brs_ob_status_NT.js"></script>
      <script type="text/javascript"
   ...
   <form id="brsobstatusNT" name="brsobstatusNT"  method="POST" action=""   onsubmit="return confirmation()">
         <% 
   ...
   %>
         ...
         <table cellspacing="2" cellpadding="3" width="100%">
            <tr class="tdH">
               <td colspan="2">
                  <div align="center">
                     <strong>BRS OB Freeze-NONTWAD</strong>
                  </div>
               </td>
            </tr>
         </table>
         <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
               ...
               <tr class="table">
				...
				<tr class="table">
	                <td>
	                  <div align="left">Freeze Nill OB</div>
	                </td>
	                <td>
	                  <div align="left">
	                     <input type="radio" id="nill_ob" name="nill_ob" tabindex="14" value="N" checked/> No &nbsp; &nbsp;
	                     <input type="radio" id="nill_ob" name="nill_ob"  tabindex="13" value="Y"/> Yes
	                  </div>
	                </td>
              </tr>
               <tr align="left">
                  ...
                  <td>
                     <div align="left">
                        <input type="text" name="txtCB_Year" id="txtCB_Year" onChange="LoadMonthYear();"
