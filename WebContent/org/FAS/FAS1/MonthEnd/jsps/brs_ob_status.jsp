...
<html>
   <head>
      ...
      <title>Freeze BRS OB-TWAD</title>
      ...
      <script language="javascript" type="text/javascript"
              src="../scripts/brs_ob_status.js"></script>
      <script type="text/javascript"
   ...
   <form id="brsobstatus" name="brsobstatus"  method="POST" action=""   onsubmit="return confirmation()">
         <% 
