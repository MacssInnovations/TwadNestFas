...
<html>
  <head>
    ...
    <title>Unfreeze Supplement Trial Balance</title>
     ...
     <script language="javascript" type="text/javascript" src="../scripts/FreezeTB_Closure_SJV.js"></script>
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>freeze Supplement Trial Balance Closure</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3" maxlength="4" size="5" onkeypress="return numbersonly(event)" onblur="Suppl_Number_Check();">
           ...
           <select name="txtCB_Month"  id="txtCB_Month" tabindex="4" onchange="Suppl_Number_Check();setTimeout('loadSJVUnfreeze()',900);" >
