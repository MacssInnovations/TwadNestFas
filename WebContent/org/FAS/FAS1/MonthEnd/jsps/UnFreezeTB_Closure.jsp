...
<html>
  <head>
    ...
    <title>Unfreeze Trial Balance</title>
     ...
     <script language="javascript" type="text/javascript" src="../scripts/UnFreezeTB_Closure.js"></script>
     ...
     function loadyear_month()
        ...
        document.frmTrialBalance_Unfreeze.txtCB_Year.value=year;
        document.frmTrialBalance_Unfreeze.txtCB_Month.value=month;
  ...
  <form name="frmTrialBalance_Unfreeze" method="POST" action="../../../../../UnFreezeTB_Closure" >
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Unfreeze Trial Balance Closure</strong>
            </div>
        </td>
      </tr>
    </table>
