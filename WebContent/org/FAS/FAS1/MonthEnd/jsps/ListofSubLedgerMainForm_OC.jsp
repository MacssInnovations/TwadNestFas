...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofSubLedgerMainForm_OC.js"></script>
      ...
      A/c Code
       ...
       <tbody id="tb" class="table" align="left">
         ...
         String AcHeadCode="";
           try
           {
            ps=con.prepareStatement("select ACCOUNT_HEAD_CODE,MONTH_CLOSING_BALANCE,MONTH_CLOSING_BAL_DR_CR_IND from FAS_SUB_LEDGER_MASTER_OC where  ACCOUNTING_UNIT_ID=? and  ACCOUNTING_FOR_OFFICE_ID=? and FINANCIAL_YEAR=? and year=? and month=? and SUB_LEDGER_TYPE_CODE=? and SUB_LEDGER_CODE=? order by ACCOUNT_HEAD_CODE");
