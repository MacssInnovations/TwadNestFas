...
<html>
  <head>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>General Ledger Summary Report</title>
    
    
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>    
    <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>    
    <script language="javascript" type="text/javascript" src="../scripts/GL_Summary.js"></script>            
    ...
    {       
         ...
         document.frmGLSummary.txtCB_Year_From.value=year
         document.frmGLSummary.txtCB_Month_From.value=month;
        
         document.frmGLSummary.txtCB_Year_To.value=year
         document.frmGLSummary.txtCB_Month_To.value=month;
     }
    </script>
  ...
  <body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS')"><form name="frmGLSummary"
                                                      method="POST"
                                                      action="../../../../../GL_Summary.kv"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>General Ledger Summary Report</strong>
            </div>
          </td>
        </tr>
      </table>
