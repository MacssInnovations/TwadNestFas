...
<html>
   <head>
      ...
      <script language="javascript" type="text/javascript"
              src="../scripts/YourselfStatus.js"></script>
      <script type="text/javascript"
   ...
   <body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS_ONLY')"><form id="frmTrialBalance"
