...
<html>
  <head>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>Supplement General Ledger Summary Report</title>
  ...
  <body class="table" onload="loadyear_month();LoadAccountingUnitID('LIST_ALL_UNITS');Suppl_Number_Check_allsup();">
  ...
  <form name="frmGeneralLedgerSystem"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement General Ledger Summary Report</strong>
            </div>
          </td>
        </tr>
      </table>
