...
<html>
  <head>
    ...
    <title>Unfreeze Supplement Trial Balance</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>
     <script language="javascript" type="text/javascript" src="../scripts/UnFreezeTB_SJV.js"></script>
   ...
   <script language="javascript" type="text/javascript"
            src="../scripts/View_Trial_Balance_SJV.js"></script>
     ...
     function loadyear_month()
      ...
      //  document.frmTrialBalance.txtCB_Month.value=month;
        setTimeout('loadSJVUnfreeze()',900);
         }
    </script>
    <script language="javascript" type="text/javascript">
  ...
  <form name="frmTrialBalance" method="POST" id="frmTrialBalance" action="" onsubmit="return confirmation()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Unfreeze Supplement Trial Balance</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <div align="left">
            ...
            <td>
             <div align="left">
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3" maxlength="4" size="5" onkeypress="return numbersonly(event)" onchange="Suppl_Number_Check();setTimeout('loadSJVUnfreeze()',500);">
       ...
       <tr class="table">
                <td>
                  <div align="left">
                    Accounting Unit Code (Freezed List)
       ...
       <tr align="left">
            ...
            <td>
              <div align="left">
                ...
                <select name="txtsupplement_no" id="txtsupplement_no"  onchange="checkstatusSJV();">
