...
<html>
   <head>
      ...
      <script language="javascript" type="text/javascript"
              src="../scripts/brs_unFreeze.js"></script>
      <script type="text/javascript"
   ...
   <body class="table" onload="LoadAccountingUnitID('LIST_ALL_UNITS_ONLY');">
   <form id="unfreezebrs" name="unfreezebrs"  method="POST" action=""   onsubmit="return confirmation()">
             <input type="hidden" id="hid" name="hid" value="NonTwad"> 
         <% 
   ...
   %>
         ...
         <table cellspacing="2" cellpadding="3" width="100%">
            <tr class="tdH">
               <td colspan="2">
                  <div align="center">
                     <strong>brs_unFreeze for Non-Twad</strong>
                  </div>
               </td>
            </tr>
         </table>
               ...
               <tr align="left">
                  ...
                  <td>
                     <div align="left">
                        ...
                        onChange="LoadMonthYear('<%=s%>');" tabindex="3" maxlength="4" size="5"
                               onkeypress="return numbersonly(event)"></input>
                         
                        <select name="txtCB_Month" id="txtCB_Month" onChange="LoadMonthYear('<%=s%>');"
                                tabindex="4">
