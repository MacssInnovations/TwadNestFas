...
<html>
  <head>
    ...
    <title>Supplement Trial Balance Report With Opening Balance  </title>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_Check_allsup();LoadAccountingUnitID('FOR_LIST_0')"><form name="frmTrialBalance"
                                                      method="POST"
                                                      action="../../../../../View_Trial_Balance_SJV_WithOB.kv"
      ...
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Supplement Trial Balance Report with Opening Balance </strong>
            </div>
          </td>
        </tr>
      </table>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtCB_Year" id="txtCB_Year"
                       ...
                       onkeypress="return numbersonly(event)" onblur="Suppl_Number_Check_allsup();" ></input>
