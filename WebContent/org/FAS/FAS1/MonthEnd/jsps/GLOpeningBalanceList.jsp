...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/GLOpeningBalanceList.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.GLOpeningBalanceList.txtCB_Year.value=year
        document.GLOpeningBalanceList.txtCB_Month.value=month;
        
         }
    </script>
      </head>
  <body class="table" onload="loadyear_month()" >
  <form name="GLOpeningBalanceList" method="POST">
   <%
  Connection con=null;
  ...
  %>
   ...
   <% 
    ...
    String oname="",FAS_SU="";    
    String AccUnit_office_id_name="",getWing="";        // office name,empname
    ...
    try
    {
            ...
            String findAcc_office="select u.ACCOUNTING_UNIT_OFFICE_ID,off.OFFICE_NAME from FAS_MST_ACCT_UNITS u,FAS_MST_ACCT_UNIT_OFFICES o,COM_MST_OFFICES off"
                + " where u.ACCOUNTING_UNIT_ID=o.ACCOUNTING_UNIT_ID and off.OFFICE_ID=u.ACCOUNTING_UNIT_OFFICE_ID and o.ACCOUNTING_FOR_OFFICE_ID=? ";
              ...
              <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="LoadOffice(this.value);loadAccountOffice();" >
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.GLOpeningBalanceList.txtFrom_date);"
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7"
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.GLOpeningBalanceList.txtTo_date);"
                         alt="Show Calendar"></img>
