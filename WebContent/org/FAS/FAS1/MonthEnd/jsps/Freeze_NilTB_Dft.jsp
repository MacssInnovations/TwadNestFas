...
<html>
   <head>
      ...
      <title>Freeze Trial Balance(Defunct)</title>
      ...
      <script language="javascript" type="text/javascript"
              src="../scripts/FreezeNilTB_new.js"></script>
      <script type="text/javascript"
   ...
   <body class="table" onload="loadyear_month();"><form id="frmTrialBalance"
   ...
   %>
         <table cellspacing="2" cellpadding="3" width="100%">
            <tr class="tdH">
               <td colspan="2">
                  <div align="center">
                     <strong>Nil FreezeTB(Defunct)</strong>
                  </div>
               </td>
            </tr>
         </table>
