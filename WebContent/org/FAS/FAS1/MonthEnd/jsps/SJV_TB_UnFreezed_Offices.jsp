...
<html>
  <head>
    ...
    <title>Supplement Trial Balance Unfreezed Units </title>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/TB_UnFreezed_Offices.js"></script>
    ...
    <script type="text/javascript" language="javascript">
     function loadyear_month()
        ...
        document.frmTB_UnFreezed_Offices.txtCB_Year.value=year
        document.frmTB_UnFreezed_Offices.txtCB_Month.value=month;
 ...
 <form name="frmTB_UnFreezed_Offices" method="POST" action="../../../../../SJV_TB_UnFreezed_Offices.kv" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Supplement Trial Balance Unfreezed Units</strong>
            </div>
        </td>
      </tr>
    </table>
