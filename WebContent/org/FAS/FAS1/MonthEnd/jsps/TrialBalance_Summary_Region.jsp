...
<html>
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../TrialBalance_Summary_Region?command=withOB" onsubmit="return checknull()">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Trial Balance Summary Region Wise Report</strong>
            </div>
        </td>
      </tr>
    </table>
