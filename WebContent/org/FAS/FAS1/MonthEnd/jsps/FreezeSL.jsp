...
<html>
  <head>
    ...
    <title>Freeze SubLedger</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>
     <script language="javascript" type="text/javascript" src="../scripts/FreezeSL.js"></script>
     ...
     function loadyear_month()
        ...
        document.freezeSL.txtCB_Year.value=year
        document.freezeSL.txtCB_Month.value=month;
    ...
    <script language="javascript" type="text/javascript">
                ...
                function chkAlert()
                {
                  alert('Are You Verified the SL Balance');
                  return true;
                }
    </script>
  ...
  <form name="freezeSL" method="POST" action="../../../../../FreezeSL.view" onsubmit="return chkAlert()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Freeze&nbsp;SubLedger</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <option value="3">March</option>
             ...
             <div align="left"  style="display:none">
                <input type="radio" id="radTB_status" name="radTB_status" value="Y" checked="checked"> Yes
                <input type="radio" id="radTB_status" name="radTB_status" value="N" > No
             </div>
