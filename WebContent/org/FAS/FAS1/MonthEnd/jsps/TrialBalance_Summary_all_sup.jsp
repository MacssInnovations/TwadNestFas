...
<html>
    ...
    <script type="text/javascript" language="javascript">
     ...
     function checknull()
     {
          ...
          if(document.getElementById("from_txtCB_Year").value=="")
         {
          ...
          if(document.getElementById("to_txtCB_Year").value=="")
          {
  ...
  <form name="frmTrialBalance" method="POST" action="../../../../../TrialBalance_Summary_all?command=sup_tb" onsubmit="return checknull()">
...
<!--            From &nbsp;&nbsp;  -->
        ...
        <!--    <option value="4">April</option>
         ...
         <tr align="left">
          ...
          <td>
          <input type="text" name="supNo" id="supNo" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)">
         </td>
         </tr>
</table>
          </div>
