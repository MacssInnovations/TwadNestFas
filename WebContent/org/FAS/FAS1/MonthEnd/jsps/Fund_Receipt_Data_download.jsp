...
<html>
  ...
  <body class="table" onload="loadyear_month();setTimeout('forFundReceiptUnit();',900);" >
  <form name="Jrnldownload" method="POST" action="../../../../../Jrnl_download" onsubmit="return checknull()">
    <input type="hidden" value="FundReceipt" id="jrnl" name="jrnl">
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
              <strong>Fund Receipt By Unit Data Download</strong>
            </div>
        </td>
      </tr>
    </table>
     <div align="center">
          ...
          <input type="text" name="from_txtCB_Year" id="from_txtCB_Year"
           tabindex="3"  maxlength="4" size="5" onchange="testlen();" onkeypress="return numbersonly(event)" onblur="forFundReceiptUnit();">
         
          <select name="from_txtCB_Month"  id="from_txtCB_Month" tabindex="4" onchange="forFundReceiptUnit();">          
