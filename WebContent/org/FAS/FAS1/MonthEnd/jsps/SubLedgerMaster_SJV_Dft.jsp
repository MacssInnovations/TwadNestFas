...
<html>
  <head>
    ...
    <meta http-equiv="cache-control" content="no-cache"></meta>
    <title>Sub Ledger Posting With SJV (Defunct) </title>
  ...
  <body class="table" onload="loadyear_month();Suppl_Number_CheckNew();" >
  ...
  %>
   ...
   System.out.println("office id and office name *********************"+oid+"&&&&&&&&"+oname);
   %>
      <table cellspacing="2" cellpadding="3" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Sub Ledger Posting With SJV (Defunct) </strong>
            </div>
          </td>
        </tr>
      </table>
