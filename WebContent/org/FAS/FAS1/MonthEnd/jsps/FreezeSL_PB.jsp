...
<html>
  <head>
    ...
    <title>Freeze SL PB</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>
     <script language="javascript" type="text/javascript" src="../scripts/FreezeSL_PB.js"></script>
     ...
     function loadyear_month()
         ...
         document.frmslpbfreeze.txtCB_Year.value=(year-1)+"-"+year;
        
       document.frmslpbfreeze.txtCB_Month.value=month;
  ...
  <form name="frmslpbfreeze" method="POST" action="../../../../../FreezeSL_PB_servlet" onsubmit="return checknull()">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
     ...
     <div align="center">
          ...
          <div align="left">
            ...
            <td>
             <div align="left">
          <input type="text" name="txtCB_Year" id="txtCB_Year" tabindex="3" readonly  maxlength="4" size="10" onkeypress="return numbersonly(event)">
