    ...
    return;
        ...
        { 
        	...
        	var remarks=document.getElementById("txtRemarks").value;
        	  ...
        	  var url="../../../../../Emp_Bill_Journalisation?command=Add&acc_unit="+acc_unit+"&office_id="+office_id+"&majortype="+majortype+"&minortype="+minortype+"&journaltype="+journaltype+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"&remarks="+remarks+"";
        ...
        { 
        	if(nullcheck()){
        	  ...
        	  var url="../../../../../Emp_Bill_Journalisation?command=Update&acc_unit="+acc_unit+"&office_id="+office_id+"&majortype="+majortype+"&minortype="+minortype+"&journaltype="+journaltype+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"&remarks="+remarks+"";
        	  url=url+"&sid="+Math.random();
              xmlhttp.open("GET",url,true);
              xmlhttp.onreadystatechange=stateChanged;
              xmlhttp.send(null);  
        ...
        { 
        	if(confirm("Do You Really want to Delete it?"))
            {
        	  ...
        	  var url="../../../../../Emp_Bill_Journalisation?command=Delete&acc_unit="+acc_unit+"&office_id="+office_id+"&majortype="+majortype+"&minortype="+minortype+"&journaltype="+journaltype+"&cashmonth="+cashmonth+"&cashyear="+cashyear+"";
        	  url=url+"&sid="+Math.random();
              xmlhttp.open("GET",url,true);
              xmlhttp.onreadystatechange=stateChanged;
              xmlhttp.send(null);  
...
function doParentEmpbill(majortype,minortype,journaltype,cashmonth,cashyear,remarks)
{
