...
{   
        ...
        else
        {
                ...
                var url="../../../../../PassOrder_List?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                "&cmbOffice_code="+cmbOffice_code+"&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&billapprej="+billapprej+"&optionId="+optionId;			                
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
                             ...
                             items[3]=service[i].getElementsByTagName("APPROVED_DATE")[0].firstChild.nodeValue;
                             items[4]=service[i].getElementsByTagName("remarks")[0].firstChild.nodeValue;
                             
                             items[5]=service[i].getElementsByTagName("amount")[0].firstChild.nodeValue;
                        // alert('test'+items[5])
                             // var tbody=document.getElementById("tbody");
