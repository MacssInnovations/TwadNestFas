...
{   
        ...
        else
        {
                ...
                var url="../../../../../PassOrder_List_All?Command=searchByMonthPrepared&txtCB_Year="+txtCB_Year+"&txtCB_Month="+txtCB_Month+"&optionId="+optionId;			                
                ...
                if(service)
                 {
                	 for(i=0;i<service.length;i++)
                     {
                          ...
                          var mycurrent_row=document.createElement("TR");
                            ...
                            var url="";
                            var url="javascript:Show_new('"+items[5]+"','"+items[6]+"','"+txtCB_Year+"','"+txtCB_Month+"','"+items[2]+"')";
                            anc.href=url;
