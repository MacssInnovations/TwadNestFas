...
<title>GPF RJV Request Approved</title>
...
document.getElementById("AppDate").value=day+"/"+month+"/"+year;
		document.getElementById("txtCB_Year").value=year;
	
		document.frmGPF_RJV_Req2.txtCB_Month.value=month;
	
}	


/* function sendMail() {
  var link = 'joanemarson@gmail.com?subject=Message from '
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">GPF RJV Request Approved</font></div>
		</td>
	</tr>
</table>
<form id="frmGPF_RJV_Req2" name="frmGPF_RJV_Req2" method="GET" action="../../../../../GPF_req_RJV_Form">

       <input type="hidden" name="Command" id="Command" value="Add_Jrl" >
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
					<td colspan="2">
			                    <div align="left">
			                   <center> <input type="button" id="btnGo" name="btnGo" value="Go" onclick="goclickApproved('<%=s %>');">
			                 </center>   </div>		
			                </td>
