...
<script src="../scripts/PassOrder_List_All.js"
...
function loadyear_month()
{
       ...
       document.frmpassorder_list.txtCB_Year.value=year;
       document.frmpassorder_list.txtCB_Month.value=month1;
}
</script>
</head>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Pass Order Details List</font></div>
		</td>
	</tr>
</table>
<form name="frmpassorder_list" id="frmpassorder_list" method="POST" >
            ...
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
				...
				<tr class="table">
					...
					<tr class="table">
					<td>
			                    <div align="left">Bill Approved or Rejected <font
			                            color="#ff2121">*</font>
			                    </div>		
			                </td>
					<td>
			                    <div align="left">
			                     <input type=radio name="billapprej" id=billapprej value="Approved" checked="checked">Approved
                                 <input type=radio name=billapprej id=billapprej value="Rejected" >Rejected
            ...
            <th>
             <div id="apprRemark">    
               Pass Order Remarks
                 ...
                 <div id="rejRemark" style="display:none">    
               Rejected Remarks
                 </div> 
            </th>
             <th>
