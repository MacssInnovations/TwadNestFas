  ...
  <head>
   ...
   <script type="text/javascript" language="javascript">
    ...
    function EditHead(rowID)
    {
            	...
            	var remarks=rcells.item(6).firstChild.nodeValue;
                ...
                Minimize();
                opener.doParentEmpbill(majortype,minortype,journaltype,cashmonth,cashyear,remarks);
                self.close();       
   }
       ...
       <tbody id="tb" class="table" align="left">
          <%    
           try
           {
            ...
            String sql_que="SELECT CASHBOOK_YEAR,CASHBOOK_MONTH,BILL_MAJOR_TYPE_CODE,BILL_MINOR_TYPE_CODE,JOURNAL_TYPE_CODE,REMARKS FROM FAS_EMP_BILL_LJV where  ACCOUNTING_UNIT_ID=? and ACCOUNTING_FOR_OFFICE_ID=?";
