...
<html>
  <head>
    ...
    <title>Cheque Memo Type List</title>
     <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
     <script type="text/javascript" src="../scripts/chequeMemotype_list.js"></script>
  </head>
  <body onload="initialLoad();">
          <form name="chequeMemotypelistform" action="Get">
               <table cellspacing="2" cellpadding="3" border="1" width="100%" align="center" >
                 <tr class="tdH" align="center">
                    <th>
                            List of Cheque Memo Type Code
                    </th>
                </tr>
           </table>
