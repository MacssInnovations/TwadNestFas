...
<script src="<%=request.getContextPath()%>/org/FAS/FAS1/BillRegister/scripts/Bills_Token_Register_without_SP_GPF.js"></script>
  ...
  <form  name="paaApproval"  action="upload_civil.jsp" ENCTYPE="multipart/form-data" method="post"> 
         ...
         %>           
                <div class="tab-page">                    
                    ...
                    <td  colspan="2">
                          <div align="center">
                                <font size="4"> BRS Office change Request </font>
                          </div>
                    </td>
                	</tr>
                     <tr class="table">
					...
					<tr class="table">
						...
						<div align="left"><select size="1" name="cmbOffice_code"
							id="cmbOffice_code" onblur="Load_emp_details(),callServer('loadpassno');">
