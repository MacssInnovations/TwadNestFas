...
<script src="../scripts/Passorder_Prepared_List.js"
...
function loadyear_month()
{
       ...
       document.frmpassorder_pre_list.txtCB_Year.value=year;
       document.frmpassorder_pre_list.txtCB_Month.value=month1;
}
</script>
</head>
...
<form name="frmpassorder_pre_list" id="frmpassorder_pre_list" method="POST" >
        ...
        <div class="tab-page">
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
					<td>
			                    <div align="left">PassOrder Year & Month<font
			                            color="#ff2121">*</font>
			                    </div>		
			                </td>
					<td>
					          ...
					          <option value="12">December</option>
					           ...
					           <input type="BUTTON" value="GO" name="ByMonth1" id="ByMonth1"  tabindex="5" onclick="doFunction('searchByMonthPrepared','null')"/>
			                    </div>		
			                </td>
				</tr>
