...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/PassOrderPreparation_js.js"></script>
  ...
  %>
  <body onload="LoadAccountingUnitID('LIST_ALL_UNITS');loadDate();setTimeout('callGridValues()',900);checkForm();" >
  ...
  <form name="passorPreparation" id="passorPreparation" method="POST"  action="../../../../../PassOrderPreparation_servlet?command=AddPassorder" 
          ...
          <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
              ...
              <tr class="table">
                    <td>
                      <div align="left">Bill Year</div>
                    </td>
                    <td>
                      <div align="left">
                         <input type="text" size=4 maxlength=4 id="cbyear" name="cbyear" onkeypress="return numbersonly(event)" onchange="callGridValues()"/>
                      </div>
                    </td>
              </tr>  
            ...
            <tr align="left" class="table">
	             ...
	             <td class="table">
			          <select name="cbmonth"  id="cbmonth" tabindex="4" onchange="callGridValues()">
