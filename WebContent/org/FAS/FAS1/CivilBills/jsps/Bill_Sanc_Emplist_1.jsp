...
<html>
  <head>
    ...
    <title>List for Bill Sanction Level-All Employees Details</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/Bill_Sanc_Emp.js"></script>
    <link href="../../../../../css/Sample3.css" rel="stylesheet" media="screen"/>
    <script type="text/javascript" language="javascript">
	  function EditRender(rid)
		   {
		   	var major="",minor="",off="",sanc="";
		   	...
		   	off=rcells.item(3).firstChild.nodeValue;
		   	sanc=rcells.item(4).firstChild.nodeValue;
            close();
		   	opener.goBack(major,minor,off,sanc);        
		   }
    ...
    System.out.println("Exception in connection...."+e);
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        ...
        <tr class="table">
          <td>
            <div align="center">
              List of Bill Sanction Level-All Employees Details
            </div></td>
                    ...
                    try
                       {
		                  ...
		                  ps=con.prepareStatement("SELECT * from FAS_BILL_SANCTION_LEVEL_ALL where ACCOUNTING_UNIT_ID=? and ACCOUNTING_FOR_OFFICE_ID=? and FINANCIAL_YEAR=?");
		                  ...
		                  {         System.out.println("enter while");
		                            ps1=con.prepareStatement("SELECT * from FAS_BILL_MINOR_TYPES_MST where BILL_MAJOR_TYPE_CODE='"+results.getInt("BILL_MAJOR_TYPE_CODE")+"' and BILL_MINOR_TYPE_CODE='"+results.getInt("BILL_MINOR_TYPE_CODE")+"'");
	                                ...
	                                { 
	                                	...
	                                	{
		                                	ps2=con.prepareStatement("select DESIGNATION from HRM_MST_DESIGNATIONS where DESIGNATION_ID='"+results.getInt("SANCTIONING_AUTHORITY")+"'");
		                                    ...
		                                    while(results2.next())
		                                    {
			                                  ...
			                                  out.println("</tr>");System.out.println(results.getInt("SANCTIONING_AUTHORITY"));
		                                  }
	                                	}
	                                }
		                  }
		                  if(cnt==0)
		                     {
		                        out.println("<tr><td colspan='6' align='center'>No data found</td></tr>");
		                     } 
         		}
                    catch(Exception e)
                    {
