...
function doo(path) {
		...
		if (txtCB_Year == ""){
			...
			var url = path + "/Push_from_NT_OB_to_BRS_Tran?command=do&cmbAcc_UnitCode="
...
function do1(baseResponse) {
	var flag = baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;	
	if (flag == "success") {
			var tbody=document.getElementById("grid_body_TWAD");
		      try{tbody.innerHTML="";}
		  catch(e) {tbody.innerText="";} 
			alert("Datas are Moved from OB-NT to BRS Transaction Successfully");
		...
		alert("The Given Datas are Already Pushed into BRS Transaction");
	}else{
...
function brs_ob_status()
{
	...
	var url ="../../../../../BRS_OB_Create?Command=ob_freeze_NT&cmbAcc_UnitCode="
...
function loadGrid()
{
	...
	if (cmbBankAccNo == "") {
		...
		var url ="../../../../../Push_from_NT_OB_to_BRS_Tran?command=loadGrid&cmbAcc_UnitCode="
		+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
		+ "&txtCB_Year=" + txtCB_Year + "&txtCB_Month=" + txtCB_Month
             ...
             if(flag=="success"){
                 ...
                 {              
                	 var withdrawldate;
                         ...
                         tot_cr=parseInt(tot_cr)+parseInt(cramt);
                         tot_dr=parseInt(tot_dr)+parseInt(dramt);
                 ...
                 var cell2=document.createElement("TD");
                 cell2.align="left";
                 cell2.setAttribute('colspan','7');
                 var bol=document.createElement("b");
                 var currentText1=document.createTextNode(" GRAND TOTAL ");
                 bol.appendChild(currentText1);
                 cell2.appendChild(bol);
                 mycurrent_row.appendChild(cell2); 
                 ...
                 var currentText11=document.createTextNode(tot_cr);
                 cell3.appendChild(currentText11);
                 mycurrent_row.appendChild(cell3);
              
                 var cell2=document.createElement("TD");
                 cell2.align="right";
                 var currentText1=document.createTextNode(tot_dr);
                 cell2.appendChild(currentText1);
                 mycurrent_row.appendChild(cell2);
