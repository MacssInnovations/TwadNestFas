...
function printFunc(path)
{
	...
	if (document.getElementById("txtCB_Year").value == "") {
		...
		document.frmBRSReport_Ob_nontwad.cboCashBook_Year.focus();
	} else if (cboCashBook_Month == "" || cboCashBook_Month == "s") {
		alert("Select Cash Book Month in the Field");
		document.frmBRSReport_Ob_nontwad.cboCashBook_Month.focus();
	}else 
	{
	var url = path
			+ "/BRS_OB_Non_Twad_Report?command=printFunc&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month;
	//alert(url);
	   document.frmBRSReport_Ob_nontwad.action=url;
       document.frmBRSReport_Ob_nontwad.submit();
...
{  	
	   var cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;	 
	   var url="../../../../../BRS_OB_Non_Twad_Report?command=LoadBankAccountNumber&cmbAcc_UnitCode="+cmbAcc_UnitCode;
