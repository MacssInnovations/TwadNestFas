...
function printFunc(path)
{
	...
	if (document.getElementById("txtCB_Year").value == "") {
		...
		document.frmBreakup_Report_for_Part1.cboCashBook_Year.focus();
	} else if (cboCashBook_Month == "" || cboCashBook_Month == "s") {
		alert("Select Cash Book Month in the Field");
		document.frmBreakup_Report_for_Part1.cboCashBook_Month.focus();
	} else if (cmbBankAccNo == "" || cmbBankAccNo == "s") {
		alert("Select Bank Account No in the Field");
		document.frmBreakup_Report_for_Part1.cmbBankAccNo.focus();
	}else 
	{
	var url = path
			+ "/Breakup_Report_for_Part1?command=printFunc&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
//	alert(url);
	   document.frmBreakup_Report_for_Part1.action=url;
       document.frmBreakup_Report_for_Part1.submit();
...
function refresh()
{
	...
	document.frmBreakup_Report_for_Part1.cmbBankAccNo.value = "";	
}
