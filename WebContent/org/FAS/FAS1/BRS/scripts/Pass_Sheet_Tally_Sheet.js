...
{  	
	   ...
	   {
	    	 LoadBankAccountNumberRes_new(xmlrequest);
	   }   
	   xmlrequest.send(null);
	  
}

function LoadBankAccountNumberRes_new(xmlrequest)
{
...
function checkRecord(path)
{
	...
	{
	var url = path+ "/BRS_Pass_Sheet_Tally?command=chkRec&cmbAcc_UnitCode="
...
function freeze_brs(path)
{
	...
	{
	var url = path
			+ "/BRS_Pass_Sheet_Tally?command=f_brs&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
...
function printFunc(path)
{
	...
	{
	var url = path
			+ "/BRS_Pass_Sheet_Tally?command=printFunc&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
