...
function printFunc(path)
{
	...
	if (document.getElementById("txtCB_Year").value == "") {
		...
		document.frmBRS_Report_for_Fund_Receieved.cboCashBook_Year.focus();
	} else if (cboCashBook_Month == "" || cboCashBook_Month == "s") {
		alert("Select Cash Book Month in the Field");
		document.frmBRS_Report_for_Fund_Receieved.cboCashBook_Month.focus();
	} else if (cmbBankAccNo == "" || cmbBankAccNo == "s") {
		alert("Select Bank Account No in the Field");
		document.frmBRS_Report_for_Fund_Receieved.cmbBankAccNo.focus();
	}else 
	{
	var url = path
			+ "/BRS_Report_for_Fund_Receieved?command=printFunc&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
	//alert(url);
	   document.frmBRS_Report_for_Fund_Receieved.action=url;
       document.frmBRS_Report_for_Fund_Receieved.submit();
...
function refresh()
{
	...
	document.frmBRS_Report_for_Fund_Receieved.txtCB_Year.value = year;
	document.frmBRS_Report_for_Fund_Receieved.txtCB_Month.value = month;
	document.frmBRS_Report_for_Fund_Receieved.cmbBankAccNo.value = "";	
}
