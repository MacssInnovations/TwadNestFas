...
function freeze_brs_Report(path)
{
	...
	{
	var url = path
			+ "/BRSReport_Part2C_BS?command=fzd_report&cmbAcc_UnitCode="
...
function checkRecord(path)
{
	...
	{
	var url = path+ "/BRSReport_Part2C_BS?command=chkRec&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
...
function freeze_brs(path)
{
	...
	{
	var url = path	+ "/BRSReport_Part2C_BS?command=f_brs&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo;
...
function printFunc(path)
{
	...
	{
		var x=document.getElementById("cmbBankAccNo");
	   var mode= x.options[x.selectedIndex].text;
	 // alert(mode);
	var url = path
			+ "/BRSReport_Part2C_BS?command=printFunc&cmbAcc_UnitCode="
			+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
			+ "&cboCashBook_Year=" + cboCashBook_Year + "&cboCashBook_Month="
			+ cboCashBook_Month + "&cmbBankAccNo="
			+ cmbBankAccNo+"&Mode="+mode.split("-")[0];
	//alert(url);
	   document.frmBRSReport_Part2C.action=url;
       document.frmBRSReport_Part2C.submit();
