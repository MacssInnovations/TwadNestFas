...
function numbersonly(e)
{
 ...
 function confirmation(path)
 {
          ...
          if(confirm("Are you sure do you want to UnFreeze BRS?"))
          {
             var conf=document.getElementById("unfreezebrsclosure");
          //   alert(conf);
             conf.action=path+"/BRS_UnFreezeMonthly_closure.view";
             conf.submit();
             return true;
