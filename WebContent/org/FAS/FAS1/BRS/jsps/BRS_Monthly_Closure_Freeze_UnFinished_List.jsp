...
<title>BRS_Monthly_Closure_Freeze_UnFinished_List</title>
...
<script type="text/javascript" src="../scripts/BRS_Monthly_Closure_Freeze_UnFinished_List.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - BRS Monthly Closure Freeze UnFinished List</font></div>
		</td>
	</tr>
</table>

<form name="frmBRS_Monthly_Closure_Freeze_UnFinished_List" id="frmBRS_Monthly_Closure_Freeze_UnFinished_List"
	method="POST" action="BRS_Monthly_Closure_Freeze_UnFinished_List">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		<td width="42%">
		<div align="left">Cash Book Year <font
