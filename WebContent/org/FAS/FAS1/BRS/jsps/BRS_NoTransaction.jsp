...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Data From BRS No-Entry Transaction</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center" id="pasdiv"><input type="button" name="onsubmit1" value="Download" id="onsubmit1" onclick="printFunc2();"  />
