...
<script type="text/javascript" src="../scripts/BRSReport_Part2C.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Part-2c Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBRSReport_Part2C" id="frmBRSReport_Part2C" method="POST" action="BRSReport_Part2C">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="chkPart('2b');freeze_check('<%=s%>');">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><input type="button" name="onsubmit1" value="View Report" id="onsubmit1" onClick="printFunc('<%=s%>');" />
		&nbsp;&nbsp;&nbsp;
		<input type="button" style="visibility: visible;"  name="freezeBRS" id="freezeBRS" value="FREEZE REPORT" onclick="freeze_brs('<%=s%>');"/>
		&nbsp;&nbsp;&nbsp; 
		<input type="button" name="fzdReport" id="fzdReport" value="VIEW ALREADY FREEZED REPORT" onclick="freeze_brs_Report('<%=s%>');"/>
		&nbsp;&nbsp;&nbsp; 
