...
<title>BRS Non Freezed List</title>
...
<script type="text/javascript" src="../scripts/Brs_nonFreezed.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">List of BRS Started and Not Freezed </font></div>
		</td>
	</tr>
</table>


<form name="BRSfreezedReport" id="BRSfreezedReport" method="POST" >
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
 ...
 <tr class="tdH">
		<td colspan="2">
		<div align="center">
		<input type="button" name="onsubmit1" value="GO" id="onsubmit1" onclick="Brs_reportFunction('<%=s%>');" />
		&nbsp;&nbsp;&nbsp;&nbsp;
