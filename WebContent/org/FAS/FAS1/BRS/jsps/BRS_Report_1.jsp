...
<script type="text/javascript" src="../scripts/BRS_Report_1.js"></script>
...
<script type="text/javascript" language="javascript">
       function loadyear_month()
       {
         ...
         //   setTimeout('checkpassbookBal()',900);
      }
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Remittance and Acknowledgement - BRS Part1A Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBRSReport1" id="frmBRSReport1" method="POST" action="BRSReport1">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><input type="text" name="txtCB_Year"
			...
			<select name="txtCB_Month" id="txtCB_Month" onchange="checkpassbookBal();" tabindex="4">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="checkpassbookBal();freeze_check('<%=s%>');">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center" id="pasdiv">
		<input type="button" name="onsubmit1" value="View Report" id="onsubmit1" onclick="printFunc('<%=s%>');" />&nbsp;&nbsp;&nbsp; 
		...
		<input type="button" name="fzdBRS" id="fzdBRS" value="VIEW ALREADY FREEZED REPORT" onclick="freeze_brs_Report('<%=s%>');"/>
