...
<title>BRS List Followup Action Taken</title>
...
<script type="text/javascript" src="../scripts/BRS_FollupActionTaken.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
                    <div align="center"><font size="4">Bank Reconciliation System - BRS List - Foilowup Action Taken</font>
                    </div>
		</td>
	</tr>
</table>

<form name="frmBRS_ActionTaken" id="frmBRS_ActionTaken" method="POST" action="BRS_FollupActionTaken">
                ...
                <div align="center">
                	...
                	<tr class="table">
                            <td>
                                <div align="left">Accounting For Office Code <font color="#ff2121">*</font>                                </div>                            </td>
                            <td>
                                <div align="left">
	...
	<div align="left" style="visibility: hidden"><input type="hidden"
		...
		style="background-color: #ececec" readonly="readonly" /></div>
			...
			onclick="showCalendarControl(document.frmBRS_ActionTaken.txtFromDate,1);"
			...
			onkeypress="return calins(event,this);" onBlur="call_date(this);" />
                  <img src="../../../../../images/calendr3.gif"
			onclick="showCalendarControl(document.frmBRS_ActionTaken.txtToDate,1);"
			alt="Show Calendar"></img></div>                </td>
                        ...
                        <tr class="tdH">
                            <td colspan="2">
                                <div align="center">
                                    <input type="button" name="onsubmit1" value="LIST" id="onsubmit1" onClick="ListAll('<%=s%>');" />&nbsp;&nbsp;&nbsp; 
                                        ...
                                        <div id="grid" style="display: block">
                                            <table id="mytable" cellspacing="3" cellpadding="2" border="1" width="107%">
                                                <tr class="tdH" align="center">
                                                    <th ><font size=2>Reference Serial Number </font></th>
                                                    ...
                                                    <th ><font size=2>Action No. </font></th>
                                                    <th ><font size=2>Action Date </font></th>
                                                    <th ><font size=2>Action Taken </font></th>
                                                    <th ><font size=2>Perivious Action Taken</font></th>
                                                </tr>
