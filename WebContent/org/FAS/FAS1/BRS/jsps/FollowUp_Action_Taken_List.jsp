...
<title>FollowUp_Action_Taken_List</title>
...
<script type="text/javascript" src="../scripts/FollowUp_Action_Taken_List.js"></script>
...
<script type="text/javascript" language="javascript">
       function loadyear_month()
       {
            ...
            document.frmFollowUp_Action_Taken_List.txtCB_Year.value=year;
            document.frmFollowUp_Action_Taken_List.txtCB_Month.value=month;
      }
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - FollowUp Action Taken List</font></div>
		</td>
	</tr>
</table>


<form name="frmFollowUp_Action_Taken_List" id="frmFollowUp_Action_Taken_List" method="POST" action="FollowUp_Action_Taken_List">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="tdH">
		...
		<div align="center"><input type="button" name="onsubmit1"
			value="LIST" id="onsubmit1" onClick="ListAll('<%=s%>');" />
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<th width="2%" ><font size=2> Sl No </font> </th>
				...
				<th width="6%"><font size=2>Action No</font></th>
