...
<script type="text/javascript" src="../scripts/BRSReport_Part2A_BS.js"></script>
...
<form name="frmBRSReport_Part2A" id="frmBRSReport_Part2A" method="POST" action="BRSReport_Part2A_BS">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center">
		<input type="button" name="onsubmit1" value="View Freezed Report" id="onsubmit1" onClick="printFunc('<%=s%>');" />&nbsp;&nbsp;&nbsp; 
		<%-- 	<input type="button" name="freezeBRS" id="freezeBRS" value="Submit" onclick="freeze_brs('<%=s%>');"/>
		&nbsp;&nbsp;&nbsp;  --%>
