...
<title>BRS Monthly Closure Nil Freeze</title>
...
<script type="text/javascript" src="../scripts/Freeze_Nil_BRS_Monthly_Closure.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - Monthly Closure Nil Freeze</font></div>
		</td>
	</tr>
</table>

<form name="frmBRS_Monthly_Closure_Freeze_Nil" id="frmBRS_Monthly_Closure_Freeze_Nil"
	method="POST" action="Freeze_Nil_BRS_Monthly_Closure">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" >
			...
			onclick="loadBankDetails();" /> <!--<input type="hidden"
	...
	<tr class="tdH">
		...
		<div align="center"><input type="button" name="onsubmit1"
			value="NIL FREEZE" id="onsubmit1" onClick="Add('<%=s%>');" />
		&nbsp;&nbsp; 
