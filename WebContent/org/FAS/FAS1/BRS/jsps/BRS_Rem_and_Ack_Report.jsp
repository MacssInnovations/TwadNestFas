...
<html>
  <head>
    ...
    <title>Register Cheques Issued System</title>
    
 <!--   
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script>    
    <script language="javascript" type="text/javascript" src="../scripts/BRS_Rem_and_Ack_Report.js"></script>
   ...
   --> 
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Common_Load_Accounting_Unit_ID_4Rpt.js"></script>
  ...
  <form name="frmReceivedRegister" method="POST" action="../../../../../../RegisterChequeServlet.con" onsubmit="return checknull()">
   
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Register of Cheques Issued for the Month & Year</strong>
          </div>
        </td>
      </tr>
    </table>
