...
<title>FollowUp_Action_Not_Taken_List</title>
...
<script type="text/javascript" src="../scripts/FollowUp_Action_Not_Taken_List.js"></script>
...
<script type="text/javascript" language="javascript">
       function loadyear_month()
       {
            ...
            document.frmFollowUp_Action_Not_Taken_List.txtCB_Year.value=year;
            document.frmFollowUp_Action_Not_Taken_List.txtCB_Month.value=month;
      }
...
<form name="frmFollowUp_Action_Not_Taken_List" id="frmFollowUp_Action_Not_Taken_List" method="POST" action="FollowUp_Action_Not_Taken_List">
