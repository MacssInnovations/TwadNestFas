...
<title>BRS Report Part2A-For BankingSection</title>
...
<script type="text/javascript" src="../scripts/BRSReport_Part2B_BS.js"></script>
...
<form name="frmBRSReport_Part2A" id="frmBRSReport_Part2A" method="POST" action="BRSReport_Part2B_BS">
<div align="center">
