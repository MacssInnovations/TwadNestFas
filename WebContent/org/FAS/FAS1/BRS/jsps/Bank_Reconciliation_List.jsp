...
<title>Bank Reconciliation List</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Bank Reconciliation - List</font></div>
                <div id="imgfld"
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="tdH">
		...
		<div align="center" id="passdividlist" style="display:block"><input type="button" name="onsubmit1"
			value="LIST Acknowledged For CashBook MM/YY =PassShett MM/YY" id="onsubmit1" onClick="setListType('list1'),ListAllBrs('<%=s%>');" />
                         <input type="button" name="onsubmit1"
			value="LIST of Previous CashBook MM/YY Acknowledged During PassSheet MM/YY" id="onsubmit1" onClick="setListType('list2'),ListAll_acknowledged_BRS('<%=s%>');" />
                        <input type="button" name="onsubmit1"
			value="LIST Acknowledged For the PassSheet Year & Month" id="onsubmit1" onClick="setListType('list3'),ListAllPassSheet_Brs('<%=s%>');" />
                      
                    </div>
                    <div align="center" id="cashdividlist" style="display:none"><input type="button" name="onsubmit2"
			value="LIST Of Acknowledged Transaction For CashBook MM/YY" id="onsubmit1" onClick="setListType('list4'),ListAllCashBrs('<%=s%>');" />
                        </div>
                    <div align="center">
		 <input type="button" name="butCan" id="butCan"
			value="CANCEL" onClick="exitfun1();" /> &nbsp;&nbsp;&nbsp; <input
...
<div id="tgrid" style="display: none;">
...
<tr class="tdTitle">
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr>
				<td>
					<input type="button" name="print" value="Print Cash" id="print" onClick="printAll_BRS('<%=s%>','T');" />
				</td>
			</tr>			
		</table>		
