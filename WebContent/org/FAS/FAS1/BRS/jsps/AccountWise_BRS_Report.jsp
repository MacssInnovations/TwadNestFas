...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/org/FAS/FAS1/CommonControls/scripts/Clearance.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Data From BRS Transaction</font></div>
		</td>
	</tr>
</table>


<form name="BRS_download" id="BRS_download" method="POST" action="">
<input type="hidden"  name="BRS_Trn" id="BRS_Trn"  value="BRS_Trn" />
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><select size="1" name="cmbAcc_UnitCode"
			...
			onchange="common_LoadOffice(this.value); LoadBankAccountNumber_opr1();">
		</select></div>
		</td>
	</tr>
	...
	<tr class="table">
		...
		<div align="left">Cash Book Year &amp; Month<font
			color="#ff2121">*</font></div></div>
		</td>
		<td>
		<div align="left"><input type="text" name="txtCB_Year"
			id="txtCB_Year" tabindex="3" maxlength="4" size="4"
	...
	<tr class="table">
		...
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" >
			...
			onclick="LoadBankAccountNumber_opr1()" /> <input type="hidden"
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center" id="pasdiv"><input type="button" name="onsubmit1" value="Download" id="onsubmit1" onclick="printFunc1();"  />
