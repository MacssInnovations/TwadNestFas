...
<script type="text/javascript" src="../scripts/BRS_FollowUp.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - BRS FollowUp</font></div>
		</td>
	</tr>
</table>


<form name="frmBRS_FollowUp" id="frmBRS_FollowUp" method="POST" action="BRS_FollowUp">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="Bank_Branch_Namee1(this.value);loadStart('<%=s%>');">
			<option value="k">---Select Bank A/C No---</option>
	...
	<tr class="tdTitle">
		...
		<div align="center"><input type="button" name="onsubmit1"
			value="LIST" id="onsubmit1" onClick="ListAll('<%=s%>');" /></div>
		</td>
	</tr>
</table>
</div>
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="table">
				...
				<th width="7%"><font size=2>Action Date</font></th>
				<th width="7%"><font size=2>Action Taken</font></th>
...
<table cellspacing="3" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<table id="mytable_details" cellspacing="3" cellpadding="2" border="0"
			width="100%">
			<tr class="table">
				<th width="12%">Pass Book Date</th>
				<th width="8%">Particulars</th>
				<th width="9%">Cheque No.</th>
				<th width="6%">Details</th>
				<th width="11%">CR Amount</th>
				<th width="10%">DR Amount</th>
				<th width="16%">Type of Transaction</th>
				<th width="13%">Action Date</th>
      ...
      <div align="center">
        <table cellspacing="1" cellpadding="4" width="108%">
          <tr class="tdH">
			...
			value="SUBMIT" id="onsubmit1" onClick="SaveFunc('<%=s%>');" />
                 &nbsp;&nbsp;&nbsp; 
