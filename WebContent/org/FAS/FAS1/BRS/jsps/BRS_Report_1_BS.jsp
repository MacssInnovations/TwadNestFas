...
<script type="text/javascript" src="../scripts/BRS_Report_1_BS.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Remitance and Acknowledgement - BRS Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBRSReport1" id="frmBRSReport1" method="POST" action="BRSReport1_BS">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" >
			...
			onclick="LoadBankAccountNumber_col()" /> <input type="hidden"
