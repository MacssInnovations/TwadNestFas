...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Cheques Issued and Encashed - BRS Part 2B Report</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="freeze_check('<%=s%>');chkPart('2b');checkpassbookBal(); ">
