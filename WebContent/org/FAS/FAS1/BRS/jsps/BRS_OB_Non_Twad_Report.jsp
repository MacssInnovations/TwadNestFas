...
<title>BRS OB Non Twad Report</title>
...
<script type="text/javascript" src="../scripts/BRS_OB_Non_Twad_Report.js"></script>
...
<script type="text/javascript" language="javascript">
       function loadyear_month()
       {
            ...
            document.frmBRSReport_Ob_nontwad.txtCB_Year.value=year;
            document.frmBRSReport_Ob_nontwad.txtCB_Month.value=month;
      }
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">BRS OB (Non Twad) Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBRSReport_Ob_nontwad" id="frmBRSReport_Ob_nontwad" method="POST" action="BRS_OB_Non_Twad_Report">
<div align="center">
