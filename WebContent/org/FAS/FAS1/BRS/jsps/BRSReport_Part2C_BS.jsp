...
<script type="text/javascript" src="../scripts/BRSReport_Part2C_BS.js"></script>
...
<form name="frmBRSReport_Part2C" id="frmBRSReport_Part2C" method="POST" action="BRSReport_Part2C_BS">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="checkRecord('<%=s%>');">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><input type="button" name="onsubmit1" value="View Freezed Report" id="onsubmit1" onClick="printFunc('<%=s%>');" />
		&nbsp;&nbsp;&nbsp;
