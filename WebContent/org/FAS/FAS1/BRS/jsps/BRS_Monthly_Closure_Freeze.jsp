...
<script type="text/javascript" src="../scripts/BRS_Monthly_Closure_Freeze.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - Monthly Closure </font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="loadStart_year1();">
	...
	<tr class="tdH">
		...
		<div align="center"><input type="button" name="onsubmit1"
			value="FREEZE" id="onsubmit1" onClick="Add_clo('<%=s%>');" />
		&nbsp;&nbsp; 
