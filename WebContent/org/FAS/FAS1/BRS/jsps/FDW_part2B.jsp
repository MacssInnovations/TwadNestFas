...
<script type="text/javascript" src="../scripts/BRSReport_Part2B.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Cheques Issued and Encashed - BRS Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBRSReport_Part2B" id="frmBRSReport_Part2B" method="POST" action="BRSReport_Part2B">
<input type="hidden" id="old" name="old" value="new">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="checkpassbookBal();">
	...
	<tr class="tdH">
		<td colspan="2">
		<div align="center" id="pasdiv"><input type="button" name="onsubmit1" value="View Report" id="onsubmit1" onClick="printFunc('<%=s%>');" />
		&nbsp;&nbsp;&nbsp; 
		<input type="button" name="freezeBRS" id="freezeBRS" style="display: none;"  value="FREEZE REPORT" onclick="freeze_brs('<%=s%>');"/>
		&nbsp;&nbsp;&nbsp; 
