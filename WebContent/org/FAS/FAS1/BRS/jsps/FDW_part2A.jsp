...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><input type="text" name="txtCB_Year"
			...
			name="txtCB_Month" id="txtCB_Month" onchange="checkpassbookBal(),checkFreezeStatus();" tabindex="4">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><select name="cmbBankAccNo" id="cmbBankAccNo" onchange="checkpassbookBal(),checkFreezeStatus();">
	...
	<tr class="tdH">
		...
		<div align="center" id="pasdiv"><input type="button" name="onsubmit1"
			...
			<input type="button" name="freezeBRS" style="display: none;" id="freezeBRS" value="FREEZE REPORT" onclick="freeze_brs('<%=s%>');"/>
		&nbsp;&nbsp;&nbsp; 
