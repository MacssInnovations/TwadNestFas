...
<title>Barred_Cheque_FollowUp_List</title>
...
<script type="text/javascript"
	src="../scripts/Barred_Cheque_FollowUp_List.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		...
		System - Barred Cheque FollowUp List </font></div>
		</td>
	</tr>
</table>

<form name="frmBarred_Cheque_FollowUp_List"
	id="frmBarred_Cheque_FollowUp_List" method="POST"
	action="Barred_Cheque_FollowUp_List">
<div align="center">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	<tr>
		...
		<table id="Existing" cellspacing="1" cellpadding="2" border="1"
			...
			<tr class="tdTitle">
				<td colspan="16">
				<div align="left"><font size="4">Barred Cheque FollowUp
				List</font></div>
				</td>
			</tr>
			<tr>
