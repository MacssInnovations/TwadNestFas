...
<script type="text/javascript" language="javascript">
    ...
    crdr_value=val;
    	if(crdr_value=="CR")
    		document.getElementById("crdr_value").value=crdr_value;
    	else if(crdr_value=="DR")
    		document.getElementById("crdr_value").value=crdr_value;
    }
    </script>
</head>
...
<table cellspacing="1" cellpadding="3" width="101%">
	<tr class="tdH">
		<td colspan="2" style="width: 1171px; ">
		<div align="center"><font size="3">Bank Reconciliation
		System</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><select size="1" name="cmbAcc_UnitCode"
			...
			onchange="common_LoadOffice(this.value); setTimeout('LoadBankAccountNumber()',900);">
		</select></div>
		</td>
	</tr>
	<tr class="table">
	...
	<tr class="table">
		...
		<input type="radio" name="CR_type" id="CR_type" value="CR" checked="checked" onclick="fun(this.value);">CR
	<input type="radio" name="CR_type" id="CR_type" value="DR" onclick="fun(this.value);" >DR
		<input type="hidden"  name="crdr_value" id="crdr_value" value="CR" />
		</div>
		</td>
	</tr>
...
<input type='hidden' name='RecordCount' id='RecordCount' value='0' /> <input
	...
	type='hidden' name='test' id='test' value='0' /> <input
	type='hidden' name='RecordCountNT' id='RecordCountNT' value='0' /> <!-- ------------------------- TWAD  Transactions Part II --------------------------------  -->
<div class="tab-page" id="gd">
<h2 class="tab" onkeypress="SubmitDisabled();">Cash Book Transactions</h2>
<div align="center">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	<tr class="tdTitle">
		...
		<div align="left"><strong>No of Records :</strong> <input
			name="txtNoofRecords" type="text" id="txtNoofRecords" 
			readonly="true">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		...
		<table id="mytable" cellspacing="2" cellpadding="0" border="0"
			...
			<tr class="table">
				...
				<th width="5%"><font size=2> Remittance Date </font></th>
				<th width="5%"><font size=2> Withdrawal Date </font></th>
				<th width="14%"><font size=2> Challan / Voucher No </font></th>
				<th width="11%"><font size=2>Cheque / DD No</font></th>
				<th width="6%"><font size=2>CR Amount </font></th>
				<th width="6%"><font size=2>DR Amount </font></th>
				<th width="5%"><font size=2>Entry Found in Pass Book? </font></th>
				<th width="2%"><font size=2>Pass Book Date </font></th>
				<th width="2%"><font size=2>Amount in Pass Book </font></th>
				<th width="2%"><font size=2>Difference</font></th>
				<th width="8%" ><font size=2>Reason for Difference</font></th>
				<th width="5%"><font size=2>Follow-up Action Required? </font></th>
				<th width="5%"><font size=2>Is it a clearing Entry for Excess/short debit or credit</font></th> -->
				
				<th><font> Sl No </font></th>
				<th><font> Remittance Date </font></th>
				<th><font> Withdrawal Date </font></th>
				<th><font> Challan / Voucher No </font></th>
				<th><font>Cheque / DD No</font></th>
				<th><font>CR Amount </font></th>
				<th><font > Amount </font></th>
				<th><font>Entry Found in Pass Book? </font></th>
				<th>Pass Book Date </th>
				<th>Amount in Pass Book</th>
				<th>Difference</th>
				<th width="5%">Reason for Difference</th>
...
<div class="tab-page" id="gd">
<h2 class="tab" onkeypress="SubmitDisabled();">Not Remitted/Withdrawn but shown in the pass sheet</h2>
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<table id="mytable_details" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="table">
				...
				<th>CR Amount<br>( Deposit )</th>
				<th>DR Amount<br>( Withdrawl )</th>
			...
			<tr class="table">
				...
				<th><input type="button" name="Clear" id="Clear" value="Delete Last Row"
					onclick="ClearRow();" /></th>
			</tr>
