...
<script type="text/javascript" src="../scripts/brs_pass_sheet_transaction.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">BRS Pass Sheet Transaction</font></div>
		</td>
	</tr>
</table>
<form name="frmBRSMainForm" id="frmBRSMainForm" method="POST" 
action="../../../../../BRS_MainForm_PBT.kv" onsubmit="return checkNull()">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<td>
		<div align="left"><input type="text" name="txtCB_Year"  onchange="getBankBalance('<%=s1%>');" id="txtCB_Year" tabindex="3" maxlength="4" size="5"
			onkeypress="return numbersonly1(event,this)"></input> 
			<select name="txtCB_Month" id="txtCB_Month" onchange="getBankBalance('<%=s1%>');" tabindex="4">
	...
	<tr class="table">
		<td>
		<div align="left">Bank Balance as per Pass Sheet<font color="#ff2121">*</font></div>
		</td>
		<td>
		<div align="left">
