...
<script type="text/javascript"
	src="../scripts/Push_from_NT-OB_to_BRS_Tran.js"></script>
	<%
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Bank Reconciliation System</font> 
		<strong>Push from NT-OB to BRS Transaction</strong></div>
		</td>
	</tr>
</table>
