...
<title>Breakup_Report_for_Part1</title>
...
<script type="text/javascript" src="../scripts/Breakup_Report_for_Part1.js"></script>
...
<script type="text/javascript" language="javascript">
       function loadyear_month()
       {
            ...
            document.frmBreakup_Report_for_Part1.txtCB_Year.value=year;
            document.frmBreakup_Report_for_Part1.txtCB_Month.value=month;
      }
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH">
		<td colspan="2">
		<div align="center"><font size="4">Remittance and Acknowledgement - BRS Report</font></div>
		</td>
	</tr>
</table>


<form name="frmBreakup_Report_for_Part1" id="frmBreakup_Report_for_Part1" method="POST" action="Breakup_Report_for_Part1">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left">Type</div>
                ...
                <td>
              <!--    <input type="radio" name="typeName" id="typeName" value="onlyT"/>T
                <input type="radio" name="typeName" id="typeName" value="onlyNT"/>NT   -->
                <input type="radio" name="typeName" id="typeName" checked value="onlyBoth"/>CashBook & Bank Transaction
                </td>
        </tr>
