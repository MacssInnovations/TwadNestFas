  ...
  <table cellspacing="2" cellpadding="3" border="1" width="100%"
       ...
       <tr>
        ...
        <tr>
          ...
          <td class="table">
            <input type="text" name="txtbrscode" maxlength="2"
                   id="txtbrscode" readonly size="3"/>System Generated
           </td>
        ...
        <tr>
            ...
            <td class="table">
            <input type="text" name="txtbrs_shdesc" size="100" maxlength="100"
                   id="txtbrsdesc"/>
        </tr>
        <tr>
            <td class="table">BRS Description</td>
            <td class="table">
             <input type="text" name="txtdesc" id="txtdesc" size="100" maxlength="100"/>     
               </td>
                  
        </tr>
        <tr>
            <td class="table">Is Transaction Type pertains to TWAD</td>
            <td class="table">
             <input type="radio" name="txtbrstype" id="txtbrstype" 
                            value="T"/>Twad &nbsp;&nbsp;&nbsp;&nbsp; 
                    <input type="radio" name="txtbrstype" id="txtbrstype" 
                           value="NT"/>NonTwad  &nbsp;&nbsp;&nbsp;&nbsp; 
             <!--input type="text" name="txtbrstype" id="txtbrstype" size="50"/-->     
               </td>
