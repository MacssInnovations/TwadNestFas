...
<title>Civil_Budget_Format_2</title>
...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="../scripts/Civil_Budget_Format_2.js"></script>
</head>
<%
	String s = request.getContextPath();
%>

<body onLoad="LoadAccountingUnitID('LIST_ALL_UNITS');initialLoad();" bgcolor="#FFF9FF">
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget - Revenue
		Account Expenditure</font> ( Format - 2 )</div>
...
<form name="frmCivil_Budget_Format_2" id="frmCivil_Budget_Format_2"
	method="POST" action="../../../../../Civil_Budget_Format_2"><input
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<td width="70%"><div align="left">
		  ...
		  -->
		   		   <input type="radio" id="r1" name="r1" value="DetailHead" onchange="ChangeYearDuration();initialLoad1();"/>Detail Head Wise
		   		   <input type="radio" id="r1" name="r1" value="DetailGrp" onchange="ChangeYearDuration();initialLoad3();"/>Detail Group Wise
                   <input type="radio" id="r1" name="r1" value="Abstract"  onchange="ChangeYearDuration();initialLoad2();"/>Abstract
		  
		 <!--   <input type="button" name="butView" id="butView" value="View for Update" onClick="LoadData('<%=s%>')" />  -->
	    </div></td>
	</tr>
	<tr class="table1">
		<td colspan="2">
	...
	<div id="grid" style="display: block" width="200%">
		<table id="mytable" cellspacing="1" cellpadding="1" border="0"
			...
			<tr class="tdH1" align="center" >
				...
				<th width="14%" style="font-size: 12px;">Budget Group</th>
				<th width="5%" style="font-size: 12px;">Head of Account</th>
				<th width="9%" style="font-size: 12px;">Actuals for the Last Year<br /><label id="l1" name="l1"></label></th>
				<th width="7%" style="font-size: 12px;">BE for the Year<br /><label id="l2" name="l2"></label></th>
				<th width="9%" style="font-size: 12px;">Actuals for the Period Apr<label id="l3" name="l3"></label> to Nov<br/><label id="l30" name="l30"></label></th>
				...
				<th width="7%" style="font-size: 12px;">RE for the Year<br /><label id="l5" name="l5"></label></th>
				<th width="7%" style="font-size: 12px;">Variation between BE and RE<br/><label id="l6" name="l6"></label></th>
				<th width="9%" style="font-size: 12px;">Reason for Variation</th>
				<th width="9%" style="font-size: 12px;">BE for Next Year<br/><label id="l7" name="l7"></label></th>
				<th width="15%" style="font-size: 12px;">Reason for Variation if any between RE for the
				Year and the next Year</th>
			</tr>
			<tbody id="grid_body" class="table1" align="Center" width="60%">
			</tbody>
		</table>
		</div>
		</td>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="submit" name="butSub"
			id="butSub" value="SAVE" onClick="return funcSave();" /> &nbsp;
			 <input		type="submit" name="butUpdate" id="butUpdate" value="UPDATE"
			...
			name="butexit" id="butexit" value="EXIT" onClick="exitfun();" /></div>
		</td>
	</tr>
</table>
</div>
