...
<html>
  <head>
    ...
    <title>Schedule 2.1(Administrative Expenses) Report</title>
  ...
  <form name="frmSchedule1_1" method="POST" action="../../../../../Schedule_Reports?command=Schedule2.1(AE)" onsubmit="return checknull()">
   <input type="hidden" id="hid" name="hid" />
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Schedule 2.1 (Administrative Expenses) - Report</strong>
          </div>
        </td>
      </tr>
    </table>
