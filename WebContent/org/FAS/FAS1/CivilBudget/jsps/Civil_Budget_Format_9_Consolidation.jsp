...
<title>Civil_Budget_Format_9_Consolidation</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Format_9_Consolidation.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		Account Income</font> ( Format - 9 Consolidate ) </div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Format_9_Consolidation" id="frmCivil_Budget_Format_9_Consolidation"
	method="POST" action="../../../../../Civil_Budget_Format_9_Consolidation"><input
