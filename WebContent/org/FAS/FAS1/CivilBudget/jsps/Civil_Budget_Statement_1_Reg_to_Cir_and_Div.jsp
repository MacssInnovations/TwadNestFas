...
<title>Civil_Budget_Statement_1_Reg_to_Cir_and_Div</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Statement_1_Reg_to_Cir_and_Div.js"></script>
...
<body onLoad="LoadAccountingUnitID('LIST_ALL_UNITS');changeHeadingL();initialLoad('<%=s%>');" bgcolor="#FFF9FF">
...
<form name="frmCivil_Budget_Statement_1_Reg_to_Cir_and_Div" id="frmCivil_Budget_Statement_1_Reg_to_Cir_and_Div"
	method="POST" action="../../../../../Civil_Budget_Statement_1_Reg_to_Cir_and_Div?command=add" onsubmit="return checkNull()">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
	  ...
	  <td>
        <select name="statementGp" id="statementGp" onchange="callStatement('<%=s %>');callAmt('<%=s %>');callHead();">
          <option value="">---Select---</option>
        </select>
	  ...
	  <tr class="table1">
      <td>Unit of Re-Allocation<font color="#ff2121">*</font></td>
	  <td>
        <input type="radio" name="unitallocation" id="unitallocation" value="R"  onclick="changeHeadingR();">In Rupees
        <input type="radio" name="unitallocation" id="unitallocation" value="T" onclick="changeHeadingT();">In Thousands
        <input type="radio" name="unitallocation" id="unitallocation" value="L" checked onclick="changeHeadingL();">In Lakhs
        
	  </td>
	  </tr>
	  <tr class="table1">
	  <td>Total Allocation By HO in lakhs<font color="#ff2121">*</font></td>
	  <td>
	  ...
	  <tr class="table1">
	  <td>Total ReAllocation By Region in Rupees<font color="#ff2121">*</font></td>
	  <td>
        <input type="text" name="reallocation" id="reallocation" size="20" value=0></input>
        <input type="button" name="submitbtn" id="submitbtn" size="20" value="GO" onclick="loadGrid('<%=s %>');"></input>
      </td>
	  </tr>
	  <tr class="table1">
	  <td>Balance Available in Rupees<font color="#ff2121">*</font></td>
	  <td>
       <input type="text" readonly="readonly" name="balanceavail" id="balanceavail" size="20" ></input>
	  </td>
	  </tr>
	<tr class="table1">
      <td>Do You want to have Reserve?<font color="#ff2121">*</font></td>
	  <td width="80%">
        <input type="radio" name="reserveid" id="reserveid" value="Y" onclick="addEmpty(this.value);">Yes
        <input type="radio" name="reserveid" id="reserveid" value="N" checked onclick="delete_empty();">No
	  </td>
	  ...
	  <td colspan="2">
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">
				...
				<th width="8%">Amount<label id="l1" name="l1"></label></th>				
			</tr>
...
<table cellspacing="1" cellpadding="3" width="100%">
	...
	<tr class="tdH1">
		...
		<div align="center"><input type="submit" name="butSub"
			...
			<input	type="submit" name="butDelete" id="butDelete" value="DELETE"
			disabled="disabled" onClick="return funcDelete();" /> &nbsp; 
