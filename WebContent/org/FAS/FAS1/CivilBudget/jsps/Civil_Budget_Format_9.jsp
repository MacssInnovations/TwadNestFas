...
<title>Civil_Budget_Format_9</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Format_9.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget - Asset ( Debit )</font> ( Format - 9 )</div>
...
<form name="frmCivil_Budget_Format_9" id="frmCivil_Budget_Format_9"
	method="POST" action="../../../../../Civil_Budget_Format_9"><input
	...
	<tr class="table1">
		...
		<td width="70%"> <div align="left">
		  <select name="cmbFinancialYear"
			id="cmbFinancialYear" onblur="ChangeYearDuration();" onChange="ChangeYearDuration();">
		    </select> 
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">
				<th width="1%" style="font-size: 12px;">Sl No</th>
				<th width="8%" style="font-size: 12px;">Budget Group</th>
				<th width="8%" style="font-size: 12px;">Head of Account</th>
				<th width="18%" style="font-size: 12px;">Actuals for the Last Year<label id="l1" name="l1"></label></th>
				<th width="8%" style="font-size: 12px;">BE for the Year<label id="l2" name="l2"></label></th>
				<th width="11%" style="font-size: 12px;">Actuals for the Period Apr<label id="l3" name="l3"></label> to Nov<label id="l30" name="l30"></label></th>
				...
				<th width="5%" style="font-size: 12px;">RE for the Year<label id="l5" name="l5"></label></th>
				<th width="7%" style="font-size: 12px;">Variation between BE and RE<label id="l6" name="l6"></label></th>
				<th width="8%" style="font-size: 12px;">Reason for Variation</th>
				<th width="5%" style="font-size: 12px;">BE for Next Year<label id="l7" name="l7"></label></th>
