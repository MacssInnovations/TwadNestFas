...
<script type="text/javascript"
	src="../scripts/Civil_Budget_Report_2.js"></script>
...
<form
	name="frmCivil_Budget_Report2"
	id="frmCivil_Budget_Report2"
	method="POST"
	action="Civil_Budget_Report_2">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table">
		...
		<div align="left"><select size="1" name="format_type"
			...
			<option value="f12">Format-12</option>
			<option value="f13">Format-12A</option>
			</select>
		</div>
		</td>
		</tr>
