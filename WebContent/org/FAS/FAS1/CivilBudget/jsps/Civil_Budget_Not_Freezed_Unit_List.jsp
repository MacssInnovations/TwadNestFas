...
<title>Civil_Budget_Not_Freezed_Unit_List</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Not_Freezed_Unit_List.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget - Not Freezed Units List </font></div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Not_Freezed_Unit_List" id="frmCivil_Budget_Not_Freezed_Unit_List"
	method="POST" action="../../../../../Civil_Budget_Not_Freezed_Unit_List">
<div align="center">
	  ...
	  <td colspan="2">
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">				
				<th width="26%">Accounting Unit Name </th>
				<th width="36%">Accounting Units for Office Name</th>						
			</tr>
