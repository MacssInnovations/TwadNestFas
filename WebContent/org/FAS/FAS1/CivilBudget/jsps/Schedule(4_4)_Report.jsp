...
<html>
  <head>
    ...
    <title>Schedule(4.4)_Report</title>
  ...
  <form name="frmSchedule4.4_report" id="frmSchedule4.4_report" method="POST" action="../../../../../AnnualReport" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
    ...
    <div id="rdobtn" style="display: block;">
     <table cellspacing="1" cellpadding="2" border="1" width="100%">
               ...
               <tr align="center">
           			<td class="table">
           			<input type="radio" id="balance_Sheet_Annual" name="balance_Sheet" value="Annual_rdo" checked />Annual
           			<input type="radio" id="balance_Sheet_month" name="balance_Sheet" value="Monthly_rdo" />Monthly
           			<input type="button" id="okbtn" name="okbtn" value="OK" onclick="radiochk();" />
           			</td></tr>
           			</table>
    ...
    <div id="Annual_div" style="display: none;">
     <div align="center">
            <table cellspacing="1" cellpadding="2" border="1" width="100%">
    ...
    <table align="center"  cellspacing="3" cellpadding="2" border="1" width="100%" >
      ...
      <td>
          ...
          <div id="backBtn" style="display: none;">
           <input type="button" id="back" value="BACK" onclick="window.location.reload();" />
          </div>
