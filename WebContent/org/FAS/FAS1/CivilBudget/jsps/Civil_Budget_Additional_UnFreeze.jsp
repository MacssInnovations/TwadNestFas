...
<title>Civil Budget Additional UnFreeze</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget Additional Required- UnFreeze
		</font></div>
		</td>
	</tr>
</table>

<form name="frmAdditional_Freeze" id="frmAdditional_Freeze"
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<div align="left"><select name="cmbFreezeType"
			id="cmbFreezeType">			
			<option value="UFAB">UnFreeze- Additional Budget</option>			
		</select></div>
		</td>
	</tr>
	<tr class="table1">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="button" name="butSub"
			id="butSub" value="UnFreeze" onClick="FuncDelete('<%=s%>');" />
