...
<title>Civil_Budget_Format_1_Consolidation</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Format_1_Consolidation.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		Account Income</font> ( Format - 1  Consolidate ) </div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Format_1_Consolidation" id="frmCivil_Budget_Format_1_Consolidation"
	method="POST" action="../../../../../Civil_Budget_Format_1_Consolidation"><input
