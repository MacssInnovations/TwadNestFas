...
<title>Civil_Budget_Format_10_Consolidation</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Format_10_Consolidation.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		Account Income</font> ( Format - 10 Consolidate  ) </div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Format_10_Consolidation" id="frmCivil_Budget_Format_10_Consolidation"
	method="POST" action="../../../../../Civil_Budget_Format_10_Consolidation"><input
...
<table cellspacing="1" cellpadding="2" border="0" width="198%">
	<tr class="tdTitle1">
		<td colspan="2">
