...
<title>Un_Freeze_for_Consolidate</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget - Un Freeze for Consolidate</font></div>
		</td>
	</tr>
</table>

<form name="frmUn_Freeze_for_Consolidate" id="frmUn_Freeze_for_Consolidate"
	method="POST" action="../../../../../Un_Freeze_for_Consolidate">
<div align="center">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="button" name="butSub"
			id="butSub" value="UN FREEZE" onClick="FuncSave('<%=s %>');" />
