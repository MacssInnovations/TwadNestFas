...
<title>Consolidation_Freezed_List</title>
...
<script type="text/javascript" src="../scripts/Consolidation_Freezed_Unit_List.js"></script>
...
<body onLoad="LoadAccountingUnitID('LIST_ALL_UNITS');loadyear_month();initialLoad1('<%=s%>');" bgcolor="#FFF9FF">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget Consolidation - Freezed Units List </font></div>
		</td>
	</tr>
</table>

<form name="frmAllocation_Freezed_List" id="frmAllocation_Freezed_List"
	method="POST" action="../../../../../Allocation_Freezed_Report">
	<%
		      Connection con=null;
