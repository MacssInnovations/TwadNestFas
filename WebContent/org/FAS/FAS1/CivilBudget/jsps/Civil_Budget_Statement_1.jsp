...
<body onLoad="load();loadyear_month();"	bgcolor="#FFF9FF">
...
<form name="frmCivil_Budget_Statement_1" id="frmCivil_Budget_Statement_1"
	method="POST" action="../../../../../Civil_Budget_Statement_1">
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
                ...
                <td>
                  ...
                  <div align="left">
                    ...
                    <img src="../../../../../images/calendr3.gif"
                         onclick="showCalendarControl(document.frmCivil_Budget_Statement_1.txtCrea_date,1);"
	...
	<tr class="table1">
	  ...
	  <td><label>
        <select name="cmbStatementName" id="cmbStatementName" onchange="CheckFreeze();">
          <option value="">---Select---</option>
        </select>
       
		  <input type="button" id="butGo" name="butGo" value="GO"
			onClick="CheckFreeze(),LoadGrid();">
...
<tr class="tdH1">
		<td width="63%">	    </td>		
		  <td width="37%">		   
		    <div align="left"><strong>Total Amount &nbsp;&nbsp;</strong> 
	          <input type="text" name="txtTotalAmount" id="txtTotalAmount" onblur="focus_save();">		  
        </div></td></tr>
	<tr class="tdH1">
		<td colspan="2">
		<div align="center">
