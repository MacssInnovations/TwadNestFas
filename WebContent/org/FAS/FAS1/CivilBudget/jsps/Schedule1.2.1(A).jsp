...
<html>
  <head>
    ...
    <title>Schedule 1.2.1(A) - Report</title>
  ...
  <form name="frmSchedule1_1" method="POST" action="../../../../../Schedule_Reports?command=Schedule1.2.1(A)" onsubmit="return checknull()">
   <input type="hidden" id="hid" name="hid" />
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Schedule 1.2.1(A) - Report</strong>
          </div>
        </td>
      </tr>
    </table>
