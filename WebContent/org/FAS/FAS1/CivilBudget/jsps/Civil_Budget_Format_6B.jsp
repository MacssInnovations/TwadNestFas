...
<title>Civil_Budget_Format_6b</title>
...
<script type="text/javascript"
	src="../scripts/Civil_Budget_Format_6B.js"></script></head>
<%
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	<tr class="tdH1">
		...
		<div align="center">
		  ...
		  <p><font size="4">( Seperate Statements for Family Pensioners )</font> ( Format - 6b )</p>
		</div>
...
<form name="frmCivil_Budget_Format_6b" id="frmCivil_Budget_Format_6b"
	method="POST" action="../../../../../Civil_Budget_Format_6B"><input
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<input type="button" name="butGo" id="butGo" value="Go" onClick="load_hrm('<%=s%>')" />&nbsp;&nbsp;&nbsp;
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0">
			<tr class="tdH1" align="center">
				...
				<td></td>
				<td></td>
				<td colspan="13"><strong>2012 - 2013 </strong></td>
			...
			<tr class="tdH1" align="center">
				...
				<td colspan="5"><strong>Addition During 2012-2013 with Reference to Statement 3(Col.14) </strong></td>						
			</tr>
			<tr class="tdH1" align="center">
				<td width="2%"><strong>Select</strong></td>
				<td width="3%"><strong>Sl.No </strong></td>
				<td width="3%"><strong>Category</strong></td>
				<td width="4%"><strong>No of Pensioners  </strong></td>
				<td width="4%"><strong>Upto <label id="l1" name="l1"></label> </strong></td>
				<td width="6%"><strong>Anticipated <label id="l2" name="l2"></label> </strong></td>
				<td width="4%"><strong>Upto <label id="l3" name="l3"></label></strong></td>
				<td width="6%"><strong>Anticipated <label id="l4" name="l4"></label></strong></td>
				<td width="4%"><strong>Upto <label id="l5" name="l5"></label></strong></td>
				<td width="6%"><strong>Anticipated <label id="l6" name="l6"></label></strong></td>
				<td width="4%"><strong>Upto <label id="l7" name="l7"></label> (4+6+8)</strong></td>
				<td width="6%"><strong>Anticipated <label id="l8" name="l8"></label> (5+7+9)</strong></td>
				<td width="75"><strong>No of Pensioners</strong></td>
				<td width="62"><strong>Total Basic Pension </strong> </td>	
				<td width="75"><strong>Total D.A</strong></td>
				<td width="62"><strong>Total</strong><strong> Other Payment</strong></td>			
