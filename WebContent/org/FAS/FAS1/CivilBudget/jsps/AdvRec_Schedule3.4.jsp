...
<html>
  <head>
    ...
    <title>Schedule 3.4(ADVANCE RECOVERABLE) Report</title>
  ...
  <form name="frmSchedule1_1" method="POST" action="../../../../../Schedule_Reports?command=Schedule3.4(AdvRec)" onsubmit="return checknull()">
   <input type="hidden" id="hid" name="hid" />
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Schedule 3.4(Advance Recoverable) - Report</strong>
          </div>
        </td>
      </tr>
    </table>
