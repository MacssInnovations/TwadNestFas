...
<title>Civil_Budget_Freezed_Unit_List</title>
...
<script type="text/javascript" src="../scripts/Civil_Budget_Freezed_Unit_List.js"></script>
...
<!-- <body
	onLoad="LoadAccountingUnitID_OfficeID('<%=s%>');initialLoad1('<%=s%>');loadyear_month();"
	bgcolor="#FFF9FF">-->
	<body onLoad="LoadAccountingUnitID('LIST_ALL_UNITS');initialLoad1('<%=s%>');loadyear_month();"
	bgcolor="#FFF9FF">
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget - Freezed Units List </font></div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Freezed_Unit_List" id="frmCivil_Budget_Freezed_Unit_List"
	method="POST" action="../../../../../Civil_Budget_Freezed_Unit_List">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		<td width="30%">
		<div align="left">Format Name <font color="#ff2121">*</font></div>		</td>
		<td width="70%">
	  ...
	  <td colspan="2">
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">				
				<th width="30%">Accounting Unit Name</th>
				<th width="41%">Accounting Units for Office Name</th>
				<th width="29%">Freezed Date</th>				
			</tr>
