...
<title>Civil Budget Additional Freeze</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget Additional Required- Freeze
		</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<div align="left"><select name="cmbFreezeType"
			id="cmbFreezeType">			
			<option value="FAB">Freeze- Additional Budget</option>			
		</select></div>
		</td>
	</tr>
	<tr class="table1">
