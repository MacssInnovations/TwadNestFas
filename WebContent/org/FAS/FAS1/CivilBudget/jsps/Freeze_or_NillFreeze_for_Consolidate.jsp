...
<title>Freeze_or_NillFreeze_for_Consolidate</title>
...
<script type="text/javascript" src="../scripts/Freeze_or_NillFreeze_for_Consolidate.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		or Nill Freeze  for Consolidate</font></div>
		</td>
	</tr>
</table>

<form name="frmFreeze_or_NillFreeze_for_Consolidate" id="frmFreeze_or_NillFreeze_for_Consolidate"
	method="POST" action="../../../../../Freeze_or_NillFreeze_for_Consolidate">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<div align="left"><select name="cmbFreezeType"
			id="cmbFreezeType">			
			<option value="FC">Freeze-Consolidate</option>			
		</select></div>
		</td>
	</tr>
	<tr class="table1">
		<td width="30%">
		<div align="left">Format Name <font color="#ff2121">*</font></div>
		</td>
		<td width="70%">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="button" name="butSub"
			id="butSub" value="SUBMIT" onClick="FuncSave('<%=s%>');" />
