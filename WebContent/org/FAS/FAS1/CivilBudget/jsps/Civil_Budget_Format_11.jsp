...
<title>Civil_Budget_Format_11</title>
...
<script type="text/javascript"
	src="../scripts/Civil_Budget_Format_11.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	<tr class="tdH1">
		...
		RIG Maintenance of the TWAD Board</font> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ( Format - 11 )</div>
...
<form name="frmCivil_Budget_Format_11" id="frmCivil_Budget_Format_11"
	method="POST" action="../../../../../Civil_Budget_Format_11"><input
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">
				...
				<td width="3%"><strong>Divn Code</strong></td>
				<td width="4%"><strong>Type of Vehicle</strong></td>
				<td width="4%"><strong>Regn No</strong></td>
				<td width="6%"><strong>Date Of Purchase</strong></td>
				<td width="4%"><strong>No of Kms Done</strong></td>
				<td width="9%"><strong>Age of Vehicle</strong></td>
				<td width="12%"><strong>Whetder Fit for Condemnation
				now,Probable Date of Condemnation</strong></td>
				<td width="17%"><strong>If not Condemnation
				now,Probable Date of Condemnation</strong></td>
				<td width="43"><strong>Salary</strong></td>
				<td width="64"><strong>Fuel / Material</strong></td>
				<td width="75"><strong>Ordinary Repairs</strong></td>
				<td width="62"><strong>Special Repairs</strong></td>
				<td width="62"><strong>Total Cost</strong></td>
