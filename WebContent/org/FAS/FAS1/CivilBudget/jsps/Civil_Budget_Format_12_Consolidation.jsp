...
<title>Civil_Budget_Format_12_Consolidation</title>
...
<script type="text/javascript"
	src="../scripts/Civil_Budget_Format_12_Consolidation.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="2" border="0" width="102%">
	<tr class="tdH1">
		...
		<div align="center"><font size="4">Civil Budget - Performance of Workshop at Trichy </font>( Format - 12 Consolidate )</div>
		</td>
	</tr>
</table>
<form name="frmCivil_Budget_Format_12_Consolidation" id="frmCivil_Budget_Format_12_Consolidation"
	method="POST" action="../../../../../Civil_Budget_Format_12_Consolidation"><input
	...
	<tr>
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">
				...
				<td></td>
				<td></td>
				<td colspan="2"><strong>No of Jobs Entrusted</strong> </td>
				<td colspan="2"><strong>No of Jobs Complited</strong></td>
				<td colspan="2"><strong>Direct Labour (Cost) </strong></td>
				<td colspan="2"><strong>Indirect Labour (Cost) </strong></td>
				<td colspan="2"><strong>Value of Work Turned Through Outside </strong></td>
				<td colspan="2"><strong>Cost of Spares </strong></td>
				<td colspan="2"><strong>Expenditure of Others </strong></td>
				<td colspan="2"><strong>Total Cost </strong></td>				
			</tr>
			<tr class="tdH1" align="center">
				<td widtd="2%"><strong>Select</strong></td>
				<td widtd="3%"><strong>Vehicles</strong></td>
				<td widtd="4%"><strong>Jobs Pending </strong></td>
				<td widtd="4%"><strong>Previous Year </strong></td>
				<td widtd="6%"><strong>Current Year </strong></td>
				<td widtd="4%"><strong>Previous Year</strong></td>
				<td widtd="9%"><strong>Current Year </strong></td>
				<td widtd="12%"><strong>Previous Year</strong></td>
				<td widtd="17%"><strong>Current Year</strong></td>
				<td widtd="43"><strong>Previous Year</strong></td>
				<td widtd="64"><strong>Current Year</strong></td>
				<td widtd="75"><strong>Previous Year</strong></td>
				<td widtd="62"><strong>Current Year</strong></td>
				<td widtd="62"><strong>Previous Year</strong></td>
