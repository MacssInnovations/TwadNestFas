...
<title>Civil Budget Additional Consolidate Freeze</title>
...
<body onLoad="LoadAccountingUnitID('LIST_ALL_UNITS');initialLoad1('<%=s%>');"
	bgcolor="#FFF9FF">
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		<td colspan="2">
		<div align="center"><font size="4">Civil Budget Additional Consolidate- Freeze
		</font></div>
		</td>
	</tr>
</table>
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<div align="left"><select name="cmbFreezeType"
			id="cmbFreezeType">			
			<option value="FABC">Freeze- Additional Budget Consolidate</option>			
		</select></div>
		</td>
	</tr>
	<tr class="table1">
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><input type="button" name="butSub"
			id="butSub" value="FreezeE" onClick="FuncSave_Consolidate('<%=s%>');" />
