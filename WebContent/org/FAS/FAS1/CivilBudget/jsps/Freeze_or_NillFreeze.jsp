...
<title>Freeze_or_NillFreeze</title>
...
<script type="text/javascript" src="../scripts/Freeze_or_NillFreeze.js"></script>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		or Nil Freeze </font></div>
		</td>
	</tr>
</table>

<form name="frmFreeze_or_NillFreeze" id="frmFreeze_or_NillFreeze"
	method="POST" action="../../../../../CivilBudget_Freeze_or_NillFreeze">
<div align="center">
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	...
	<tr class="table1">
		...
		<div align="left"><select name="cmbFreezeType"
			...
			<option value="NF">Nill Freeze</option>
		</select></div>
		</td>
	</tr>
	<tr class="table1">
