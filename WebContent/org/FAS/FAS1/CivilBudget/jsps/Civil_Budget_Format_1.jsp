...
<title>Civil_Budget_Format_1</title>
...
<table cellspacing="1" cellpadding="3" width="100%">
	<tr class="tdH1">
		...
		Account Income</font> ( Format - 1 ) </div>
		</td>
	</tr>
</table>

<form name="frmCivil_Budget_Format_1" id="frmCivil_Budget_Format_1"
	method="POST" action="../../../../../Civil_Budget_Format_1"><input
		...
		<td width="70%"><div align="left">
		  ...
		  <!--<input type="button" id="butGo" name="butGo" value="GO"
			...
			-->
                   ...
                   <input type="radio" name="r1" value="DetailGrp" onchange="ChangeYearDuration(),initialLoad3();"/>Detail Group Wise
	  ...
	  <td colspan="2">
		...
		<table id="mytable" cellspacing="3" cellpadding="2" border="0"
			...
			<tr class="tdH1" align="center">
				...
				<th width="7%" style="font-size: 12px;">Head of Account</th>
				<th width="7%" style="font-size: 12px;">Actuals for the Last Year<label id="l1" name="l1"></label></th>
				<th width="7%" style="font-size: 12px;">BE for the Year<label id="l2" name="l2"></label></th>
				<th width="9%" style="font-size: 12px;">Actuals for the Period Apr<label id="l3" name="l3"></label> to Nov<label id="l30" name="l30"></label></th>
