...
<title>Civil_Budget_Format_7</title>
...
<script type="text/javascript"
	src="../scripts/Civil_Budget_Format_7.js"></script>
</head>
<%
...
<table cellspacing="1" cellpadding="2" border="0" width="100%">
	<tr class="tdH1">
		...
		<div align="center"><font size="4">Civil Budget - Staff Utilisation Abstract </font>( Format - 7 )</div>
...
<form name="frmCivil_Budget_Format_7" id="frmCivil_Budget_Format_7"
	method="POST" action="../../../../../Civil_Budget_Format_7"><input
	...
	<tr>
		...
		<table  border="0" cellpadding="2" cellspacing="3" id="mytable"
			...
			<td width="3%"><strong>Sl.No</strong></td>		
				<td width="11%"><strong>Post Rank Name</strong></td>
				<td width="11%"><strong>Sanctioned Post (Upto the Year )  </strong></td>
				<td width="13%"><strong>Diversion to Others(-)</strong></td>		
				<td width="13%"><strong>Diversion from Others(+)</strong></td>				
				<td width="14%"><strong>Total (Upto to the Year) </strong></td>
				<td width="14%"><strong>Utilised (Upto Nov)</strong></td>				
				<td width="14%"><strong>Vacant as on I st Dec </strong></td>
