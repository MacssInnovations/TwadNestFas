...
<html>
  <head>
    ...
    <title>Schedule Sub Head wise Report</title>
...
%>
  ...
  <form id="frmSchedule_report" name="frmSchedule_report" method="POST" action="../../../../../Schedule_Sub_Reports" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Schedule(Sub_Head) - Report</strong>
          </div>
        </td>
      </tr>
    </table>
         ...
         <tr align="left">
          		...
          		From   
          		<input type="text" name="txtCB_Year_from" id="txtCB_Year_from" tabindex="3"  maxlength="4" size="5" onclick="chkCombo();" onkeypress="return numbersonly(event)">
          	...
          	<select name="txtCB_Month_to"  id="txtCB_Month_to" tabindex="4" onchange="valid_finyear();">
          		<option value="1">January</option>
          		<option value="2">February</option>
          		<option value="3">March</option>
          		<option value="4">April</option>
