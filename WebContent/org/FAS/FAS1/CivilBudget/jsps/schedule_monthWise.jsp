...
<html>
  <head>
    ...
    <title>Schedule (MonthWise) Report</title>
  ...
  <form id="frmSch_month_rep" name="frmSch_month_rep" method="GET" action="../../../../../Schedule_Month__Reports" onsubmit="return checknull()">
  ...
  %>
   ...
   <input type="hidden" id="cmbMinor_Head" name="cmbMinor_Head" value=0 />
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Schedule(MonthWise) - Report</strong>
          </div>
        </td>
      </tr>
    </table>
	  ...
	  <td><div align="left">
          <select name="cmbBudgetGroupMajor" id="cmbBudgetGroupMajor" >
