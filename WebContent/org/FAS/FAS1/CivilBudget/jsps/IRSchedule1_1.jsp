...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/org/FAS/FAS1/Reports/ReceiptSystem/scripts/RegisterChequeReport.js"></script>
  ...
  <script type="text/javascript" src="../scripts/Schedule_report.js"></script>
   ...
   function loadyear_month()
   {
    ...
    if(year < 1900) year += 1900;
     ...
     document.frmSchedule_report.txtCB_Year_from.value=year;
   document.frmSchedule_report.txtCB_Year_to.value=year;
...
%>
  ...
  <form id="frmSchedule_report" name="frmSchedule_report" method="POST" action="../../../../../Schedule_Reports" onsubmit="return checknull()">
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      <tr class="tdH">
        <td colspan="2">
         ...
         <tr align="left">
           			<td class="table">
              			<div align="left" id="more_id" style="display:none;"> 
          		...
          		From   
          		<input type="text" name="txtCB_Year_from" id="txtCB_Year_from" tabindex="3"  maxlength="4" size="5" onFocus="chkCombo();" onkeypress="return numbersonly(event)">
          		<select name="txtCB_Month_from"  id="txtCB_Month_from" tabindex="4"  onChange="chkCombo();" >
          	...
          	To  
          	<input type="text" name="txtCB_Year_to" id="txtCB_Year_to" tabindex="3"  maxlength="4" size="5" onFocus="chkCombo();" onkeypress="return numbersonly(event)">
          	<select name="txtCB_Month_to"  id="txtCB_Month_to" tabindex="4" onchange="chkCombo();valid_finyear();">
          		<option value="1">January</option>
          		<option value="2">February</option>
          		<option value="3">March</option>
          		<option value="4">April</option>
	  ...
	  <td><div align="left">
         ...
         <tr  align="left">
            <td>
               <div align="left"> Minor Head Group<font color="#ff2121">*</font></div>
            </td>
            <td>
