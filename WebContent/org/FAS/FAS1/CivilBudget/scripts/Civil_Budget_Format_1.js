...
function changerdo(){
	...
	if(format_type==1 || format_type==2 || format_type==9 || format_type==10){
		document.getElementById("rdo").style.display="inline";
		document.getElementById("rdo11").style.display="none";
	}
	else if(format_type==6){
		document.getElementById("rdo").style.display="none";
		document.getElementById("rdo11").style.display="inline";
	}
	else{
		document.getElementById("rdo").style.display="none";
		document.getElementById("rdo11").style.display="none";
...
function initialLoad1() {	
	...
	var url = "../../../../../Civil_Budget_Format_1?command=get&y1=" + y1
...
function initialLoad3() {	
	...
	//document.frmCivil_Budget_Format_1.butView.disabled = false;
	document.frmCivil_Budget_Format_1.butSub.disabled = true;
	document.frmCivil_Budget_Format_1.butDelete.disabled = true;
	document.frmCivil_Budget_Format_1.butUpdate.disabled = true;
	...
	var url = "../../../../../Civil_Budget_Format_1?command=getGrp&y1=" + y1
			+ "&y2=" + y2 + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code;
	//alert(url);
	var xmlrequest = AjaxFunction();
...
function initialLoad2() {	
	...
	document.frmCivil_Budget_Format_1.butDelete.disabled = true;
	document.frmCivil_Budget_Format_1.butUpdate.disabled = true;
	document.frmCivil_Budget_Format_1.butCan.disabled = true;
	
	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_1?command=get1&y1=" + y1
			+ "&y2=" + y2 + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code;
	//alert(url);
	var xmlrequest = AjaxFunction();
...
//alert("test2");
	if (month < 4) {
		...
		//alert("first "+financialyear0);
		//alert("second   "+year1 + "-" + year);
		...
		financialyear0=(parseInt(year)+1)+ "-" + (parseInt(year1)+1);//year1 + "-" + (parseInt(year1)+1);
	...
	//alert("year1"+year1+"year"+year+financialyear0+"  "+financialyear+" "+financialyear1+" "+financialyear2);
	for(var k=1;k<=1;k++)
		{
			/*if(k==0)
			{
			...
			}else*/ if(k==1)
			{
				var se = document.getElementById("cmbFinancialYear");
		  		...
		  		//op.value = fin1;changed by ss on 01/sep/2016 financial year value 2016-17
...
//	alert("fin1 value ***"+fin1+"fin2 value ****"+fin2);
//		document.getElementById("cmbFinancialYear").value=fin1;//fin1 changed to fin2 2016-17
...
function firstLoad1(baseResponse)
{
	...
	if (flag == "success") {
		...
		for ( var k = 0; k < r_no.length; k++) {
			...
			Variation_btwn_REyr_and_NXTyr.style.width = "170px";
		...
		alert("Format-1 have Already Freezed");
		clrForm();
	}else {	
...
function firstLoad(baseResponse) {
	...
	if (flag == "success") {
		...
		//	alert(":::"+item[1].charAt(0));
			...
			Head_of_Account.readOnly = true;
			Head_of_Account.setAttribute("cols", "5");
			Head_of_Account.style.height = "40px";
			Head_of_Account.style.width = "180px";
			cell2.appendChild(Head_of_Account);
			mycurrent_row.appendChild(cell2);
...
function LoadData(path) {
	...
	//document.frmCivil_Budget_Format_1.butView.disabled = false;
	document.frmCivil_Budget_Format_1.butSub.disabled = true;
	document.frmCivil_Budget_Format_1.butDelete.disabled = false;
	document.frmCivil_Budget_Format_1.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path + "/Civil_Budget_Format_1?filter=view&cmbFinancialYear="
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				var Actuals_for_Period_Apr_to_Nov = document
						.createElement("input");
				Actuals_for_Period_Apr_to_Nov.type = "hidden";
				Actuals_for_Period_Apr_to_Nov.name = "Actuals_for_Period_Apr_to_Nov"+ seq;
				Actuals_for_Period_Apr_to_Nov.id = "Actuals_for_Period_Apr_to_Nov"
						+ seq;
				Actuals_for_Period_Apr_to_Nov.value = item[3] + ".00";				
				cell5.appendChild(Actuals_for_Period_Apr_to_Nov);
				...
				Variation_btwn_REyr_and_NXTyr.setAttribute("cols", "1");
