...
function initialLoad1() {	
	...
	//document.frmCivil_Budget_Format_10.butView.disabled = false;
	document.frmCivil_Budget_Format_10.butSub.disabled = false;
	document.frmCivil_Budget_Format_10.butDelete.disabled = true;
	document.frmCivil_Budget_Format_10.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_10?command=get&y1=" + y1
...
function initialLoad2() {	
	...
	//document.frmCivil_Budget_Format_10.butView.disabled = false;
	document.frmCivil_Budget_Format_10.butSub.disabled = true;
	document.frmCivil_Budget_Format_10.butDelete.disabled = true;
	document.frmCivil_Budget_Format_10.butUpdate.disabled = true;
	document.frmCivil_Budget_Format_10.butCan.disabled = true;
	
	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_10?command=get1&y1=" + y1
			+ "&y2=" + y2 + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code;
	//alert(url);
	var xmlrequest = AjaxFunction();
...
function LoadData(path) {
	...
	//document.frmCivil_Budget_Format_10.butView.disabled = false;
	document.frmCivil_Budget_Format_10.butSub.disabled = true;
	document.frmCivil_Budget_Format_10.butDelete.disabled = false;
	document.frmCivil_Budget_Format_10.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path + "/Civil_Budget_Format_10?filter=view&cmbFinancialYear="
