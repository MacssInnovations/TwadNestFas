//			Civil_Budget_Format_9_Consolidation			//
var seq = 0;
var seq1 = 1;
...
function initialLoad1() {
	...
	document.frmCivil_Budget_Format_9_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_9_Consolidation.butSub.disabled = false;
	document.frmCivil_Budget_Format_9_Consolidation.butDelete.disabled = true;
	document.frmCivil_Budget_Format_9_Consolidation.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_9_Consolidation?command=get&y1="
			+ y1
			+ "&y2="
			+ y2
			+ "&cmbAcc_UnitCode="
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_9_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_9_Consolidation.butSub.disabled = true;
	document.frmCivil_Budget_Format_9_Consolidation.butDelete.disabled = false;
	document.frmCivil_Budget_Format_9_Consolidation.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path
			+ "/Civil_Budget_Format_9_Consolidation?filter=view&cmbFinancialYear="
