//		Civil_Budget_Format_5_Consolidation		//
var seq = 0;
var seq1 = 1;
...
function initialLoade() {
	...
	document.frmCivil_Budget_Format_5_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_5_Consolidation.butSub.disabled = false;
	document.frmCivil_Budget_Format_5_Consolidation.butDelete.disabled = true;
	document.frmCivil_Budget_Format_5_Consolidation.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_5_Consolidation?command=get&y1="
			+ y1
			+ "&y2="
			+ y2
			+ "&cmbAcc_UnitCode="
		...
		if (r_no.length != 0) {
			for ( var k = 0; k < r_no.length; k++) {
				...
				item[11] = baseResponse
						.getElementsByTagName("VR_Commutation_of_Pension")[k].firstChild.nodeValue;
				if ((item[11] == 0) || (item[11] == 'null')) {
					item[11] = "0";
				}
				item[12] = baseResponse.getElementsByTagName("VR_Gratuity")[k].firstChild.nodeValue;
				if (item[12] == 'null') {
					item[12] = "0";
				}
				...
				Name_of_Employee.style.width = "300px";
				...
				SA_Commutation_of_Pension.size = "10";
				...
				Date_of_Retirement1.maxLength = "10";
				...
				VR_Commutation_of_Pension.size = "10";
				...
				document.getElementById(
						"frmCivil_Budget_Format_5_Consolidation").appendChild(
						emp_id);
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_5_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_5_Consolidation.butSub.disabled = true;
	document.frmCivil_Budget_Format_5_Consolidation.butDelete.disabled = false;
	document.frmCivil_Budget_Format_5_Consolidation.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path
			+ "/Civil_Budget_Format_5_Consolidation?filter=view&cmbFinancialYear="
