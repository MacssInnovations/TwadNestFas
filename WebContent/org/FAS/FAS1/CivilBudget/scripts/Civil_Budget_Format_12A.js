...
//	  		var txt = document.createTextNode(fin1);
	...
	document.frmCivil_Budget_Format_12A.butView.disabled = false;
	document.frmCivil_Budget_Format_12A.butSub.disabled = false;
	document.frmCivil_Budget_Format_12A.butDelete.disabled = true;
	document.frmCivil_Budget_Format_12A.butUpdate.disabled = true;
}
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_12A.butView.disabled = false;
	document.frmCivil_Budget_Format_12A.butSub.disabled = true;
	document.frmCivil_Budget_Format_12A.butDelete.disabled = false;
	document.frmCivil_Budget_Format_12A.butUpdate.disabled = false;
	...
	var url = path + "/Civil_Budget_Format_12A?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				document.getElementById("frmCivil_Budget_Format_12A")
						.appendChild(slno_db);
		...
		alert("Civil Budget Format-12A have Already Freezed");
	}  else {
