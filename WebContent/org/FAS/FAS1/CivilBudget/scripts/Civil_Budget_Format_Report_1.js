...
function printFunc(path) {
	...
	if (document.getElementById("txtCB_Year").value == "") {
		...
		var url = path
				+ "/Civil_Budget_Format_Report_1?command=printFunc&cmbAcc_UnitCode="
				+ cmbAcc_UnitCode + "&cmbOffice_code=" + cmbOffice_code
				+ "&cboCashBook_Year=" + cboCashBook_Year
				+ "&cboCashBook_Year2=" + cboCashBook_Year2;
		//alert(url);
		document.frmCivil_Budget_Format_Report_1.action = url;
		document.frmCivil_Budget_Format_Report_1.submit();
