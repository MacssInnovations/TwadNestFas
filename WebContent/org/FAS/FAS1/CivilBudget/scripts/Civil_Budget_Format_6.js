...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_6.butView.disabled = false;
	document.frmCivil_Budget_Format_6.butSub.disabled = true;
	document.frmCivil_Budget_Format_6.butDelete.disabled = false;
	document.frmCivil_Budget_Format_6.butUpdate.disabled = false;
	...
	var url = path + "/Civil_Budget_Format_6?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				document.getElementById("frmCivil_Budget_Format_6")
						.appendChild(slno_db);
