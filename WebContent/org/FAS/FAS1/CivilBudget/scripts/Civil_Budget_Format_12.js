...
//	  		var txt = document.createTextNode(fin1);
	...
	document.frmCivil_Budget_Format_12.butView.disabled = false;
	document.frmCivil_Budget_Format_12.butSub.disabled = false;
	document.frmCivil_Budget_Format_12.butDelete.disabled = true;
	document.frmCivil_Budget_Format_12.butUpdate.disabled = true;
}
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_12.butView.disabled = false;
	document.frmCivil_Budget_Format_12.butSub.disabled = true;
	document.frmCivil_Budget_Format_12.butDelete.disabled = false;
	document.frmCivil_Budget_Format_12.butUpdate.disabled = false;
	...
	var url = path + "/Civil_Budget_Format_12?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				document.getElementById("frmCivil_Budget_Format_12")
						.appendChild(slno_db);
