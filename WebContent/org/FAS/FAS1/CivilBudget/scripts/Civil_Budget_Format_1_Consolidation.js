//			Civil_Budget_Format_1_Consolidation			//
var seq = 0;
var seq1 = 1;
...
function initialLoad1() {
	...
	document.frmCivil_Budget_Format_1_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_1_Consolidation.butSub.disabled = false;
	document.frmCivil_Budget_Format_1_Consolidation.butDelete.disabled = true;
	document.frmCivil_Budget_Format_1_Consolidation.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_1_Consolidation?command=get&y1="
			+ y1
			+ "&y2="
			+ y2
			+ "&cmbAcc_UnitCode="
...
function firstLoad(baseResponse) {
	...
	//added on 10Oct2012
	else if (flag == "Freeze_PendingAllUnits") {
	...
	else if (flag == "Freeze_PendingNonMD") {
		var ofiice_type = baseResponse.getElementsByTagName("ofiice_type")[0].firstChild.nodeValue;
		alert("All the "
				+ ofiice_type
				+ " Under your office have Not Freezed the Civil Budget Closure");
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_1_Consolidation.butView.disabled = false;
	document.frmCivil_Budget_Format_1_Consolidation.butSub.disabled = true;
	document.frmCivil_Budget_Format_1_Consolidation.butDelete.disabled = false;
	document.frmCivil_Budget_Format_1_Consolidation.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path
			+ "/Civil_Budget_Format_1_Consolidation?filter=view&cmbFinancialYear="
