...
function load_hrm(path) {
	//alert(path);
	document.frmCivil_Budget_Format_4.butView.disabled = false;
	document.frmCivil_Budget_Format_4.butSub.disabled = false;
	document.frmCivil_Budget_Format_4.butDelete.disabled = true;
	document.frmCivil_Budget_Format_4.butUpdate.disabled = true;
	...
	var url = path + "/Civil_Budget_Format_4?filter=load_hrm&cmbFinancialYear="
...
function load_hrm_View(baseResponse) {
	...
	if (flag == "success") {
		...
		var Ppo_No = baseResponse.getElementsByTagName("Ppo_No");
		//var len = baseResponse.getElementsByTagName("slno").length;
		seq = 0;
		if (Ppo_No.length != 0) {
			var item = new Array();
			for ( var k = 0; k < Ppo_No.length; k++) {
				item[0] = baseResponse.getElementsByTagName("Ppo_No")[k].firstChild.nodeValue;
				if(item[0]=='null'){
					item[0]="";
				}
				item[1] = baseResponse.getElementsByTagName("Pensioner_Name")[k].firstChild.nodeValue;
				if(item[1]=='null'){
					item[1]="";
				}
				...
				item[3] = baseResponse
						.getElementsByTagName("Designation_Id")[k].firstChild.nodeValue;
				if(item[3]=='null'){
					item[3]="0";
				}
				item[4] = baseResponse.getElementsByTagName("des_name")[k].firstChild.nodeValue;
				if(item[4]=='null'){
					item[4]="0";
				}
				item[5] = baseResponse.getElementsByTagName("Category")[k].firstChild.nodeValue;
				if(item[5]=='null'){
					item[5]="0";
				}
				
				item[6] = baseResponse
						.getElementsByTagName("Commutation_Amount")[k].firstChild.nodeValue;
				if(item[6]=='null'){
					item[6]="";
				}
				item[7] = baseResponse
						.getElementsByTagName("Gratuity")[k].firstChild.nodeValue;
				if(item[7]=='null'){
					item[7]="";
				}
				...
				var ppno = document.createElement("input");
				ppno.type = "text";
				ppno.name = "ppno" + seq;
				ppno.id = "ppno" + seq;
				ppno.value = item[0];
				cell33.appendChild(ppno);
				...
				if(item[5]=="VRS")
				{
					...
					var super_Date_of_Retirement  = document.createElement("input");
					super_Date_of_Retirement.type = "text";
					super_Date_of_Retirement.name = "super_Date_of_Retirement" + seq;
					super_Date_of_Retirement.id = "super_Date_of_Retirement" + seq;
					super_Date_of_Retirement.value ="";
					super_Date_of_Retirement.size = "10";
					cell4.appendChild(super_Date_of_Retirement );
					mycurrent_row.appendChild(cell4);
					
					var cell5 = document.createElement("TD");
					var super_Encashment = document.createElement("input");
					super_Encashment.type = "text";
					super_Encashment.name = "super_Encashment" + seq;
					super_Encashment.id = "super_Encashment" + seq;
					super_Encashment.value =0;
					cell5.appendChild(super_Encashment);
					mycurrent_row.appendChild(cell5);
					
					var cell6 = document.createElement("TD");
					var super_commutation = document.createElement("input");
					super_commutation.type = "text";
					super_commutation.name = "super_commutation" + seq;
					super_commutation.id = "super_commutation" + seq;
					super_commutation.value =0;
					cell6.appendChild(super_commutation);
					mycurrent_row.appendChild(cell6);
					
					var cell7 = document.createElement("TD");
					var super_Gratuity = document.createElement("input");
					super_Gratuity.type = "text";
					super_Gratuity.name = "super_Gratuity" + seq;
					super_Gratuity.id = "super_Gratuity" + seq;
					super_Gratuity.value =0;
					cell7.appendChild(super_Gratuity);
					mycurrent_row.appendChild(cell7);
					
					
					var cell4 = document.createElement("TD");
					var vrs_Date_of_Retirement  = document.createElement("input");
					vrs_Date_of_Retirement.type = "text";
					vrs_Date_of_Retirement.name = "vrs_Date_of_Retirement" + seq;
					vrs_Date_of_Retirement.id = "vrs_Date_of_Retirement" + seq;
					vrs_Date_of_Retirement.value = item[2];
					vrs_Date_of_Retirement.size = "10";
					cell4.appendChild(vrs_Date_of_Retirement );
					mycurrent_row.appendChild(cell4);
					
					var cell5 = document.createElement("TD");
					var vrs_Encashment = document.createElement("input");
					vrs_Encashment.type = "text";
					vrs_Encashment.name = "vrs_Encashment" + seq;
					vrs_Encashment.id = "vrs_Encashment" + seq;
					vrs_Encashment.value =0;
					cell5.appendChild(vrs_Encashment);
					mycurrent_row.appendChild(cell5);
					
					var cell6 = document.createElement("TD");
					var vrs_commutation = document.createElement("input");
					vrs_commutation.type = "text";
					vrs_commutation.name = "vrs_commutation" + seq;
					vrs_commutation.id = "vrs_commutation" + seq;
					vrs_commutation.value ==item[6];
					cell6.appendChild(vrs_commutation);
					mycurrent_row.appendChild(cell6);
					
					var cell7 = document.createElement("TD");
					var vrs_Gratuity = document.createElement("input");
					vrs_Gratuity.type = "text";
					vrs_Gratuity.name = "vrs_Gratuity" + seq;
					vrs_Gratuity.id = "vrs_Gratuity" + seq;
					vrs_Gratuity.value =item[7];
					cell7.appendChild(vrs_Gratuity);
					mycurrent_row.appendChild(cell7);
				...
				else 
				{
					...
					super_Date_of_Retirement.name = "super_Date_of_Retirement" + seq;
					super_Date_of_Retirement.id = "super_Date_of_Retirement" + seq;
					super_Date_of_Retirement.value = item[2];
					super_Date_of_Retirement.size = "10";
					cell4.appendChild(super_Date_of_Retirement);
					mycurrent_row.appendChild(cell4);
					...
					super_commutation.name = "super_commutation" + seq;
					super_commutation.id = "super_commutation" + seq;
					super_commutation.value = item[6];
					cell6.appendChild(super_commutation);
					mycurrent_row.appendChild(cell6);
				...
				S_Anticipated_Amt_E_of_LS.value = "0";
				...
				S_Anticipated_Amt_Cmutation_of_Pension.value = "0";
				...
				S_Anticipated_Amt_Gratuity.value ="0";
				...
				VR_Anticipated_Amt_E_of_LS.value ="0";
				...
				VR_Anticipated_Amt_Cmutation_of_Pension.value = "0";
				...
				VR_Anticipated_Amt_Gratuity.value = "0";
				...
				slno_db.setAttribute("value",slno);
				slno_db.setAttribute("name", "slno_db" + seq);
				slno_db.setAttribute("id", "slno_db" + seq);
				document.getElementById("frmCivil_Budget_Format_4")
						.appendChild(slno_db);  
		...
		alert("Civil Budget Format-4 have Already Freezed");
	}  else {
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_4.butView.disabled = false;
	document.frmCivil_Budget_Format_4.butSub.disabled = true;
	document.frmCivil_Budget_Format_4.butDelete.disabled = false;
	document.frmCivil_Budget_Format_4.butUpdate.disabled = false;
	...
	var url = path + "/Civil_Budget_Format_4?filter=view&cmbFinancialYear="
			+ cmbFinancialYear + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code + "&RecordCount="
			+ RecordCount;
	//alert(url);
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				item[2] = baseResponse.getElementsByTagName("S_DATE_OF_RETIREMENT")[k].firstChild.nodeValue;
				if(item[2]=='null'){
					item[2]="";
				}
				item[3] = baseResponse
				...
				item[6] = baseResponse
						.getElementsByTagName("VRS_DATE_OF_RETIREMENT")[k].firstChild.nodeValue;
				if(item[6]=='null'){
					item[6]="";
				}
				item[7] = baseResponse
				...
				item[19] = baseResponse.getElementsByTagName("PPO_NO")[k].firstChild.nodeValue;
				if(item[19]=='null'){
					item[19]="";
				}
				item[20] = baseResponse.getElementsByTagName("des_name")[k].firstChild.nodeValue;
				if(item[20]=='null'){
					item[20]="";
				}
				...
				var cells_one = document.createElement("TD");
				var ppono = document.createElement("input");
				ppono.type = "text";
				ppono.name = "ppono" + seq;
				ppono.id = "ppono" + seq;
				ppono.value = item[19];	
				//ppono.size = "2";
				cells_one.appendChild(ppono);
				mycurrent_row.appendChild(cells_one);
