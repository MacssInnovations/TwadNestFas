...
function initialLoad1() {
	...
	document.frmCivil_Budget_Format_8.butView.disabled = false;
	document.frmCivil_Budget_Format_8.butSub.disabled = false;
	document.frmCivil_Budget_Format_8.butDelete.disabled = true;
	document.frmCivil_Budget_Format_8.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_8?command=get&y1=" + y1
...
var le=r_no.length;
		...
		if(le!=0){
			for ( var k = 0; k < r_no.length; k++) {
				...
				item[1] = baseResponse.getElementsByTagName("BE_fr_Yr")[k].firstChild.nodeValue;
				item[2] = baseResponse.getElementsByTagName("budger_g_id")[k].firstChild.nodeValue;
				...
				BE_for_the_Year.value = item[1] + ".00";
				...
				var Anticipated_Dec_to_End_of_CY = document.createElement("input");
				...
				Anticipated_Dec_to_End_of_CY.id = "Anticipated_Dec_to_End_of_CY"
						+ seq;
				Anticipated_Dec_to_End_of_CY.value = "";
				...
				budger_g_id.setAttribute("value", item[2]);
				budger_g_id.setAttribute("name", "budger_g_id" + seq);
				budger_g_id.setAttribute("id", "budger_g_id" + seq);
				document.getElementById("frmCivil_Budget_Format_8").appendChild(
						budger_g_id);
		...
		alert("Format-8 have Already Freezed");
		clrForm();
	} else {
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_8.butView.disabled = false;
	document.frmCivil_Budget_Format_8.butSub.disabled = true;
	document.frmCivil_Budget_Format_8.butDelete.disabled = false;
	document.frmCivil_Budget_Format_8.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path + "/Civil_Budget_Format_8?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				budger_g_id.setAttribute("name", "budger_g_id" + seq);
				budger_g_id.setAttribute("id", "budger_g_id" + seq);
				document.getElementById("frmCivil_Budget_Format_8")
