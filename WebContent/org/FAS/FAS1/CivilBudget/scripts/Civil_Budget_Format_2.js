//			Civil_Budget_Format_2			//
//alert("call format 2 js");
var seq = 0;
var seq1 = 1;
	...
	if (xmlrequest.readyState == 4) {
		if (xmlrequest.status == 200) {
			...
			if (command == "add") {
			 ...
			 else if (command == "getGrp") {
					firstLoad12(baseResponse);
				}
...
function initialLoad1() {	
	...
	//document.frmCivil_Budget_Format_2.butView.disabled = false;
	document.frmCivil_Budget_Format_2.butSub.disabled = false;
	document.frmCivil_Budget_Format_2.butDelete.disabled = true;
	document.frmCivil_Budget_Format_2.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_2?command=get&y1=" + y1
...
function initialLoad2() {	
	...
	//document.frmCivil_Budget_Format_2.butView.disabled = false;
	document.frmCivil_Budget_Format_2.butSub.disabled = true;
	document.frmCivil_Budget_Format_2.butDelete.disabled = true;
	document.frmCivil_Budget_Format_2.butUpdate.disabled = true;
	document.frmCivil_Budget_Format_2.butCan.disabled = true;
	
	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_2?command=get1&y1=" + y1
			+ "&y2=" + y2 + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code;
	//alert(url);
	var xmlrequest = AjaxFunction();
...
function initialLoad3() {	
	...
	var url = "../../../../../Civil_Budget_Format_2?command=getGrp&y1=" + y1
			+ "&y2=" + y2 + "&cmbAcc_UnitCode=" + cmbAcc_UnitCode
			+ "&cmbOffice_code=" + cmbOffice_code;
	//alert(url);
	var xmlrequest = AjaxFunction();
...
function initialLoad() {
	...
	/*	document.getElementById("l1").innerHTML='<font color="#FF0000">'+ " ("+ (parseInt(year1)-3) + "-" + (parseInt(year)-3) +")"+ '</font>';		
		...
		document.getElementById("l5").innerHTML='<font color="#FF0000">'+" ("+ (parseInt(year1)-2) + "-" + (parseInt(year)-2) +")"+ '</font>';
		document.getElementById("l6").innerHTML='<font color="#FF0000">'+" ("+ (parseInt(year1)-2) + "-" + (parseInt(year)-2) +")"+ '</font>';
...
function firstLoad1(baseResponse)
{
	...
	if (flag == "success") {
		...
		for ( var k = 0; k < r_no.length; k++) {
			...
			item[11] = baseResponse.getElementsByTagName("budger_g_id")[k].firstChild.nodeValue;
			item[12]=	baseResponse.getElementsByTagName("ALLOCATION_TYPE")[k].firstChild.nodeValue;
			...
			Head_of_Account.style.width = "160px";
			...
			span.setAttribute("width","1000px");*/
			...
			Actuals_for_Period_Apr_to_Nov.name = "Actuals_for_Period_Apr_to_Nov"  + seq; //actuals_for_period_apr_to_nov change 
			Actuals_for_Period_Apr_to_Nov.id = "Actuals_for_Period_Apr_to_Nov"+ seq;//actuals_for_period_apr_to_nov change 
			...
			var budget_gg_id1=document.createElement("input");
			budget_gg_id1.type="hidden";
			budget_gg_id1.name="budget_gg_id" + seq;
			budget_gg_id1.id="budget_gg_id" + seq;
			budget_gg_id1.value=item[11];
			budget_gg_id1.size=1;          			
			cell10.appendChild(budget_gg_id1);
			mycurrent_row.appendChild(cell10);
			
			
			var cell10 = document.createElement("TD");
			cell10.style.display="none";
			var ALLOCATION_TYPE1=document.createElement("input");
			ALLOCATION_TYPE1.type="hidden";
			ALLOCATION_TYPE1.name="ALLOCATION_TYPE" + seq;
			ALLOCATION_TYPE1.id="ALLOCATION_TYPE" + seq;
			ALLOCATION_TYPE1.value=item[12];
			ALLOCATION_TYPE1.size=1;          			
			cell10.appendChild(ALLOCATION_TYPE1);
			mycurrent_row.appendChild(cell10);
...
function firstLoad12(baseResponse)
{
	...
	if (flag == "success") {
		...
		var item = new Array();
		var hcode1=0;
		var acfr=0,befr=0,actual=0,anticipated=0;
		//alert("r_no"+r_no.length);
		for ( var k = 0; k < r_no.length; k++) {
			//alert("111");
			item[0] = baseResponse.getElementsByTagName("BudgetGroupMajor")[k].firstChild.nodeValue;
			...
			item[3] = baseResponse.getElementsByTagName("Actual_fr_Period_Apr_Nov")[k].firstChild.nodeValue;
			...
			item[11] = baseResponse.getElementsByTagName("budger_g_id")[k].firstChild.nodeValue;
			item[12]=	baseResponse.getElementsByTagName("ALLOCATION_TYPE")[k].firstChild.nodeValue;
			item[13]=	baseResponse.getElementsByTagName("acc_head")[k].firstChild.nodeValue;
			...
			/*for ( var k = 0; k < r_no.length; k++) {
				...
				{
					//alert("test if:::"+k);
					hcode1=baseResponse.getElementsByTagName("account_head")[k].firstChild.nodeValue;
					acfr = baseResponse.getElementsByTagName("Ac_fr_lst_yr")[k].firstChild.nodeValue;
					befr = baseResponse.getElementsByTagName("BE_fr_Yr")[k].firstChild.nodeValue;
					actual=	baseResponse.getElementsByTagName("Actual_fr_Period_Apr_Nov")[k].firstChild.nodeValue;
					anticipated=baseResponse.getElementsByTagName("anticipated")[k].firstChild.nodeValue;
				}
				else if(hcode1==baseResponse.getElementsByTagName("account_head")[k].firstChild.nodeValue)
				{
					//alert("test2::::"+k);
					hcode1=hcode1;
					acfr=parseInt(acfr)+parseInt(baseResponse.getElementsByTagName("Ac_fr_lst_yr")[k].firstChild.nodeValue);
					befr=parseInt(befr)+parseInt(baseResponse.getElementsByTagName("BE_fr_Yr")[k].firstChild.nodeValue);
					actual=parseInt(actual)+parseInt(baseResponse.getElementsByTagName("Actual_fr_Period_Apr_Nov")[k].firstChild.nodeValue);
					anticipated=parseInt(anticipated)+parseInt(baseResponse.getElementsByTagName("anticipated")[k].firstChild.nodeValue);
				...
				else
				{
					...
					*//** Head of Account     *//*
					...
					span.style.fontSize = "10px";
					span.setAttribute("width","1000px");
					var currentText = document.createTextNode(hcode1);
					cell33.appendChild(currentText);
					mycurrent_row.appendChild(cell33);
					...
					*//** Actuals for the Last Year *//*
					...
					Actuals_for_Last_Year.name = "Actuals_for_Last_Year" + seq;
					Actuals_for_Last_Year.id = "Actuals_for_Last_Year" + seq;
					Actuals_for_Last_Year.value = acfr;
					cell3.appendChild(Actuals_for_Last_Year);
					cell3.style.textAlign="right";
					cell3.style.fontSize="16px";
					cell3.style.color="#A52A2A";
					...
					span.style.fontSize = "15px";
					span.setAttribute("width","1000px");
					var currentText = document.createTextNode(acfr);
					//span.appendChild(currentText);
					//cell3.appendChild(span);
					cell3.appendChild(currentText);
					mycurrent_row.appendChild(cell3);
					...
					*//** BE for the Year *//*
					...
					BE_for_the_Year.name = "BE_for_the_Year" + seq;
					BE_for_the_Year.id = "BE_for_the_Year" + seq;
					BE_for_the_Year.value = befr;
					cell4.appendChild(BE_for_the_Year);
					cell4.style.textAlign="right";
					cell4.style.color="#00008B";
					cell4.style.fontSize="16px";
					var currentText = document.createTextNode(befr);		
					cell4.appendChild(currentText);
					mycurrent_row.appendChild(cell4);
					...
					*//** Actuals for the Period Apr to Nov *//*
					...
					Actuals_for_Period_Apr_to_Nov.name = "Actuals_for_Period_Apr_to_Nov"  + seq; //actuals_for_period_apr_to_nov change 
					Actuals_for_Period_Apr_to_Nov.id = "Actuals_for_Period_Apr_to_Nov"+ seq;//actuals_for_period_apr_to_nov change 
					Actuals_for_Period_Apr_to_Nov.value = actual + ".00";
					cell5.appendChild(Actuals_for_Period_Apr_to_Nov);
					cell5.style.textAlign="right";
					cell5.style.color="#006400";
					cell5.style.fontSize="16px";
					var currentText = document.createTextNode(actual + ".00");
					cell5.appendChild(currentText);
					mycurrent_row.appendChild(cell5);
					...
					*//** Anticipated Dec to Mar *//*
					...
					Anticipated_Dec_to_Mar.id = "Anticipated_Dec_to_Mar"
							+ seq;
					Anticipated_Dec_to_Mar.value = anticipated + ".00";
					//Anticipated_Dec_to_Mar.maxLength = "10";
					Anticipated_Dec_to_Mar.size = "8";
					//Anticipated_Dec_to_Mar.style.textAlign="right";
					Anticipated_Dec_to_Mar.readOnly = true;
			...
			/*var acchead=item[4].split("to");
			var fr=acchead[0];
			var too=acchead[1];
			//alert(fr+"ttttt"+too);
			 //if( (acc_head>=fromi) && (acc_head<=tooi) )
			var actual_last=0,br=0,actual_dur=0;
			var mm=0;
			if((item[13]<=fr) && (item[13]>=too)){
				mm=mm+item[1];
			}
			
			//alert(mm);
			tot=parseInt(baseResponse.getElementsByTagName("Ac_fr_lst_yr")[k].firstChild.nodeValue);
			//alert(r_no.length);
			for(var iii=k+1;i<r_no.length;iii++){
				
				//alert(baseResponse.getElementsByTagName("account_head")[iii].firstChild.nodeValue);
				if(iii==r_no.length)
				{
					break;
				}
				if(baseResponse.getElementsByTagName("account_head")[k].firstChild.nodeValue==baseResponse.getElementsByTagName("account_head")[iii+i].firstChild.nodeValue){
					tot=tot+parseInt(baseResponse.getElementsByTagName("Ac_fr_lst_yr")[iii+1].firstChild.nodeValue);
				}
				//alert("iii "+iii);
			}
			alert(tot);*/	
		...
		var mycurrent_row = document.createElement("TR");
			...
			Reason_for_Variation.id = "Reason_for_Variation" + seq;
			Reason_for_Variation.value = item[9];
			//Reason_for_Variation.value = tot;
			Reason_for_Variation.setAttribute("cols", "5");
			Reason_for_Variation.style.height = "30px";
			Reason_for_Variation.style.width = "150px";
			cell9.appendChild(Reason_for_Variation);
...
function firstLoad(baseResponse) {
	...
	if (flag == "success") {
		...
		//	item[3] = baseResponse.getElementsByTagName("actuals_for_period_apr_to_nov")[k].firstChild.nodeValue;
			...
			//Actual_fr_Period_Apr_Nov not in use change 23Nov13
			item[3] = baseResponse.getElementsByTagName("Actual_fr_Period_Apr_Nov")[k].firstChild.nodeValue;
			...
			item[8] = baseResponse.getElementsByTagName("budger_g_id")[k].firstChild.nodeValue;
			/** Create Table Row */
			var mycurrent_row = document.createElement("TR");
			mycurrent_row.id = seq;
		...
		//	Anticipated_Dec_to_Mar.style.textAlign="right";
			...
			Variation_betwen_BE_and_RE.name = "Variation_betwen_BE_and_RE"
					+ seq;
			Variation_betwen_BE_and_RE.id = "Variation_betwen_BE_and_RE" + seq;
			Variation_betwen_BE_and_RE.value = "";
			Variation_betwen_BE_and_RE.readOnly = true;
			//Variation_betwen_BE_and_RE.maxLength = "10";
			Variation_betwen_BE_and_RE.size = "8";
			cell8.appendChild(Variation_betwen_BE_and_RE);
...
function clrForm() {
	...
	//document.frmCivil_Budget_Format_1.butView.disabled = false;
	document.frmCivil_Budget_Format_1.butSub.disabled = false;
	document.frmCivil_Budget_Format_1.butDelete.disabled = true;
	document.frmCivil_Budget_Format_1.butUpdate.disabled = true;
	document.getElementById("imgfld").style.visibility = "hidden";
}
...
function LoadData(path) {
	...
	//document.frmCivil_Budget_Format_2.butView.disabled = false;
	document.frmCivil_Budget_Format_2.butSub.disabled = true;
	document.frmCivil_Budget_Format_2.butDelete.disabled = false;
	document.frmCivil_Budget_Format_2.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path + "/Civil_Budget_Format_2?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				item[10] = baseResponse.getElementsByTagName("budger_g_id")[k].firstChild.nodeValue;
				if (item[9] == 'null') {
					item[9] = "";
				}
...
function Variation_bt_BE_RE(sam) {
	//alert("sam:::"+sam);
	//alert(document.getElementById("RE_for_Year" + sam));
