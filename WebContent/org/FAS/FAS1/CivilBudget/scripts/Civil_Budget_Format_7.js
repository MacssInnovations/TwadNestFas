...
function initialLoad1() {
	...
	document.frmCivil_Budget_Format_7.butView.disabled = false;
	document.frmCivil_Budget_Format_7.butSub.disabled = false;
	document.frmCivil_Budget_Format_7.butDelete.disabled = true;
	document.frmCivil_Budget_Format_7.butUpdate.disabled = true;

	var cmbAcc_UnitCode = document.getElementById("cmbAcc_UnitCode").value;
	var cmbOffice_code = document.getElementById("cmbOffice_code").value;

	var url = "../../../../../Civil_Budget_Format_7?command=get&y1=" + y1
...
function firstLoad(baseResponse) {
	...
	if (flag == "success") {
		...
		for ( var k = 0; k < r_no.length; k++) {
			...
			Post_Rank_Name.style.width = "150px";
			...
			document.getElementById("frmCivil_Budget_Format_7").appendChild(
					Post_Rank_id);
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_7.butView.disabled = false;
	document.frmCivil_Budget_Format_7.butSub.disabled = true;
	document.frmCivil_Budget_Format_7.butDelete.disabled = false;
	document.frmCivil_Budget_Format_7.butUpdate.disabled = false;
	...
	var RecordCount = 0;
	var url = path + "/Civil_Budget_Format_7?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				Post_Rank_id.setAttribute("name", "Post_Rank_id" + seq);
				Post_Rank_id.setAttribute("id", "Post_Rank_id" + seq);
				document.getElementById("frmCivil_Budget_Format_7")
