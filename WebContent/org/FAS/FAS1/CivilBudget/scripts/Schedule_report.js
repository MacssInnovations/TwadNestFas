...
function Chk_finyr() {
	...
	if (document.frmSchedule_report.rad_fin_year[0].checked == true) {
		document.frmSchedule_report.rad_fin_year[0].checked = false;
	}
	/*
...
function Chk_Mnthwise()
{
	...
	if (document.frmSchedule_report.rad_fin_year[1].checked == true) {
		document.frmSchedule_report.rad_fin_year[1].checked = false;
	}
	...
	if (document.getElementById("more_id").style.display == "block") {
...
function getMinorBudgetHeadDesc(path) {
	...
	if (cmbBudgetGroupMajor == "") {
		...
		document.frmSchedule_report.cmbBudgetGroupMajor.focus();
	} else {
