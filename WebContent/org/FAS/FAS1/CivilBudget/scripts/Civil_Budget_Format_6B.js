...
function initialLoad() {
	...
	if (month < 4) {
		...
		/*document.getElementById("l1").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l2").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year1)-1) + " to 3/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l3").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l4").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year1)-1) + " to 3/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l5").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l6").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year1)-1) + " to 3/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l7").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l8").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year1)-1) + " to 3/"+(parseInt(year)-1)+ '</font>';*/
	} else {
		...
		document.getElementById("l1").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l2").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year)-1) + " to 3/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l3").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l4").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year)-1) + " to 3/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l5").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l6").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year)-1) + " to 3/"+(parseInt(year1)-1)+ '</font>';
		document.getElementById("l7").innerHTML='<font color="#FF0000">'+" 11/"+(parseInt(year)-1)+ '</font>';
		document.getElementById("l8").innerHTML='<font color="#FF0000">'+" 12/"+(parseInt(year)-1) + " to 3/"+(parseInt(year1)-1)+ '</font>';*/
	}
...
//		  		var txt = document.createTextNode(fin1);
	...
	document.frmCivil_Budget_Format_6.butView.disabled = false;
	document.frmCivil_Budget_Format_6.butSub.disabled = false;
	document.frmCivil_Budget_Format_6.butDelete.disabled = true;
	document.frmCivil_Budget_Format_6.butUpdate.disabled = true;
}
...
function LoadData(path) {
	//alert(path);
	document.frmCivil_Budget_Format_6b.butView.disabled = false;
	document.frmCivil_Budget_Format_6b.butSub.disabled = true;
	document.frmCivil_Budget_Format_6b.butDelete.disabled = false;
	document.frmCivil_Budget_Format_6b.butUpdate.disabled = false;
	...
	var url = path + "/Civil_Budget_Format_6B?filter=view&cmbFinancialYear="
	...
	if (flag == "success") {
		...
		if (len != 0) {
			...
			for ( var k = 0; k < r_no.length; k++) {
				...
				document.getElementById("frmCivil_Budget_Format_6b")
						.appendChild(slno_db);
		...
		alert("Civil Budget Format-6 have Already Freezed");
	}  else {
...
function clrForm() {
	...
	document.getElementById("imgfld").style.visibility = "hidden";
	document.frmCivil_Budget_Format_6b.butView.disabled = false;
	document.frmCivil_Budget_Format_6b.butSub.disabled = false;
	document.frmCivil_Budget_Format_6b.butDelete.disabled = true;
	document.frmCivil_Budget_Format_6b.butUpdate.disabled = true;
}
