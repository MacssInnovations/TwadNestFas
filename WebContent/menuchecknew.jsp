...
try
{
	System.out.println("This is menuchecknew.jsp");
  flag_chk=request.isRequestedSessionIdFromCookie();
  System.out.println("from cookie : :::::ddd"+flag_chk);
  //Getting  Remote host IP
  Remote_host=request.getRemoteHost();
  System.out.println("Remote Host in menu checknew :"+Remote_host);
...
System.out.println("ses parameterYES :"+request.getParameter("session"));
    ...
    System.out.println("-------------------YES session object created in SERVLET LOGIN.Session Id is  :"+sess_id);
    UserProfile up=null;
...
%>
<frameset rows="210,*" name="framehead" id="framehead" frameborder="0" border="0" framespacing="0">
