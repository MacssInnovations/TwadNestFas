...
<%
 ...
 try {
   ...
   Color backgroundColor = Color.decode("#FFEE9D");
   
   Color borderColor = Color.decode("#FFEE9D");  
   Color textColor = Color.red;
   Color circleColor = new Color(160,160,160);
   Font textFont = new Font("Century Schoolbook L", Font.ROMAN_BASELINE, paramInt(request, "fontSize", 35));
   int charsToPrint = 6;
