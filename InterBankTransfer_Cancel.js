...
function doFunction(Command,param)
{
        ...
        {  
           clearGeneral_Detail();
           var txtCrea_date= document.frmInterBankTransfer_Cancel.txtCrea_date.value
           var  cmbAcc_UnitCode=document.getElementById("cmbAcc_UnitCode").value;
           var cmbOffice_code=document.getElementById("cmbOffice_code").value;
            
            if(txtCrea_date.length!=0)
            {
            var url="../../../../../InterBankTransfer_Cancel.view?Command=load_Voucher_No&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
        ...
        {  
            ...
            if(txtVoucher_No!="")
            {
            var url="../../../../../InterBankTransfer_Cancel.view?Command=load_Voucher_Details&txtVoucher_No="+txtVoucher_No+"&txtCrea_date="+txtCrea_date+"&cmbAcc_UnitCode="+
            cmbAcc_UnitCode+"&cmbOffice_code="+cmbOffice_code;;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function clearGeneral_Detail()
{
    ...
    document.frmInterBankTransfer_Cancel.txtCheque_DD[0].checked=true;
...
function load_Voucher_Details(baseResponse)
{
 ...
 //      var bk_id=baseResponse.getElementsByTagName("bk_id")[0].firstChild.nodeValue;
       ...
       if (baseResponse.getElementsByTagName("bk_id")[0]!=null)
       bk_id=baseResponse.getElementsByTagName("bk_id")[0].firstChild.nodeValue;
       
  //     var br_id=baseResponse.getElementsByTagName("br_id")[0].firstChild.nodeValue;
            if (baseResponse.getElementsByTagName("br_id")[0]!=null)
       br_id=baseResponse.getElementsByTagName("br_id")[0].firstChild.nodeValue;
       
       
  //     var Total_amt=baseResponse.getElementsByTagName("Total_amt")[0].firstChild.nodeValue;
       
         if (baseResponse.getElementsByTagName("Total_amt")[0]!=null)
       Total_amt=baseResponse.getElementsByTagName("Total_amt")[0].firstChild.nodeValue;
       
       
       //var REF_NO=baseResponse.getElementsByTagName("REF_NO")[0].firstChild.nodeValue;
       
       if (baseResponse.getElementsByTagName("REF_NO")[0]!=null)
       REF_NO=baseResponse.getElementsByTagName("REF_NO")[0].firstChild.nodeValue;
      // var referDate=baseResponse.getElementsByTagName("referDate")[0].firstChild.nodeValue;
       
        if (baseResponse.getElementsByTagName("referDate")[0]!=null)
       referDate=baseResponse.getElementsByTagName("referDate")[0].firstChild.nodeValue;
      
     //  var Remak=baseResponse.getElementsByTagName("Remak")[0].firstChild.nodeValue;
       
       if (baseResponse.getElementsByTagName("Remak")[0]!=null)
       Remak=baseResponse.getElementsByTagName("Remak")[0].firstChild.nodeValue;
    ...
    //   sub_bank_name=baseResponse.getElementsByTagName("sub_bank_name")[0].firstChild.nodeValue;
      ...
      // che_DD_no =baseResponse.getElementsByTagName("che_DD_no")[0].firstChild.nodeValue;
       ...
       che_DD_date=baseResponse.getElementsByTagName("che_DD_date")[0].firstChild.nodeValue;   
        ...
        {
        	document.frmInterBankTransfer_Cancel.txtCheque_DD[1].checked=true;
        }
        else if(che_or_DD=="E")
        {
        	document.frmInterBankTransfer_Cancel.txtCheque_DD[2].checked=true;
        }
