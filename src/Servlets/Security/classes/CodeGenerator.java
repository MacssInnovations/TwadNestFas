...
public class CodeGenerator {
    ...
    private String nextRegionCode() throws CodeException {
        ...
        String sql =
            "SELECT Regions.Region_Code FROM Regions ORDER BY Regions.Region_Code";
        try {
    ...
    private String nextCircleCode() throws CodeException {
        ...
        String sql =
            "SELECT Circles.Circle_Code FROM Circles WHERE Circles.Region_Code='" +
            this.hierarchyCode + "' ORDER BY Circles.Circle_Code";
        try {
            // getting the max of all
    ...
    private String nextDivisionCode() throws CodeException {
        ...
        String sql =
            "SELECT Divisions.Division_Code FROM Divisions WHERE Divisions.Region_Code='" +
            strrcode + "' and Divisions.Circle_Code='" + strccode +
            "' ORDER BY Divisions.Division_Code";
    ...
    private String nextLabCode() throws CodeException {
        ...
        String sql =
            "SELECT Labs.Lab_Code FROM Labs WHERE Labs.Region_Code='" +
            strrcode + "' and Labs.Circle_Code='" + strccode +
            "' ORDER BY Labs.Lab_Code";
        //System.out.println(sql);
    ...
    private String nextSubDivisionCode() throws CodeException {
        String strrcode = "", strccode = "", strdcode = "", strsdcode =
            "", strCode = "";
        StringTokenizer st = new StringTokenizer(this.hierarchyCode, "-");
        try {
            strrcode = st.nextToken();
        ...
        String sql =
            "SELECT SubDivisions.SubDivision_Code FROM SubDivisions WHERE SubDivisions.Region_Code='" +
            strrcode + "' and SubDivisions.Circle_Code='" + strccode +
            "' and SubDivisions.Division_Code='" + strdcode +
            "' ORDER BY SubDivisions.SubDivision_Code";
        //System.out.println(sql);
        try {
            // getting the max of all
    ...
    private String nextSectionCode() throws CodeException {
        ...
        String sql =
            "SELECT Sections.Section_Code FROM Sections WHERE Sections.Region_Code='" +
            strrcode + "' and Sections.Circle_Code='" + strccode +
            "' and Sections.Division_Code='" + strdcode +
            "' and Sections.SubDivision_Code='" + strsdcode +
            "' ORDER BY Sections.Section_Code";
        //System.out.println(sql);
        try {
            // getting the max of all
