...
public class ServletLoad extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        sql =
 "select * from PMS_MST_CONTRACTOR_REGN_FEES Order By Office_Level_Id";
...
//                    ":" + strsid.trim();
            ...
            try {
                ...
                while (results.next()) {
                    ...
                    out.println("<td>" + results.getString("Office_Level_Id") +
                                "</td>");
                    out.println("<td>" + results.getString("Regn_Class_Id") +
                                "</td>");
                    out.println("<td>" + results.getString("Entire_State") +
                                "</td>");
                    out.println("<td>" + results.getString("Regn_Fees") +
                                "</td>");
                    out.println("<td>" +
                                results.getString("Date_effective_from") +
                                "</td>");
