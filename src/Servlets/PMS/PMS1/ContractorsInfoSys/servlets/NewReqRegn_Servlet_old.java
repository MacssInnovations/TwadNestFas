...
public class NewReqRegn_Servlet_old extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        String txtContName = "", txtadd = "", txtPhone = "", txtEmail =
            "", State = "", txtAlias = "";
        try {

            try {
                txtContID =
                        Integer.parseInt(request.getParameter("txtContID")); // changes..
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // changes...
                ps =
  connection.prepareStatement("select max(CONTRACTOR_ID) as maxContra_ID from  PMS_CONT_REQUEST_REGN");
                rs = ps.executeQuery();
                if (rs.next()) {
                ...
                // corrected...
                sql =
 "insert into PMS_CONT_REQUEST_REGN(OFFICE_ID,REGN_YEAR,REGN_SLNO," +
   ...
   "UPDATED_DATE,CONTRACTOR_ID) ";
                ...
                try {
                    ...
                    pw.print("<center><input type=\"button\" onClick=\"window.open(\'" +
