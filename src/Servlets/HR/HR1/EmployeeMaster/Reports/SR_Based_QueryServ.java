...
public class SR_Based_QueryServ extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        if (strCommand.equalsIgnoreCase("SGroup")) {
            ...
            try {
                ...
                ps =
  connection.prepareStatement("select POST_RANK_ID,POST_RANK_NAME from HRM_MST_POST_RANKS  where SERVICE_GROUP_ID=? order by POST_RANK_NAME");
                ps.setInt(1, sgroup);
                rs = ps.executeQuery();
                int count = 0;
 ...
 xml + "<option><id>" + rs.getInt("POST_RANK_ID") + "</id><name>" +
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if (optbase.equalsIgnoreCase("Dest")) {
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/SR_BasedQuery_off_des.jasper"));
            } else {

                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/SR_BasedQuery_off_rank.jasper"));
            }
            ...
            String dtfromsession = request.getParameter("optDateFrom");
   ...
   new GregorianCalendar(Integer.parseInt(sd[2]), Integer.parseInt(sd[1]) - 1,
            ...
            System.out.println("To Date:" + dtto);

            int offid = Integer.parseInt(request.getParameter("txtOffice_Id"));
