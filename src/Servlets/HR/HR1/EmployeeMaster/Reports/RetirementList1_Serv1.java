...
public class RetirementList1_Serv1 extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            if (optbase1.equalsIgnoreCase("RadAl")) {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/retirementlist2_New.jasper"));
            ...
            if (flag) {
                if (optbase.equalsIgnoreCase("Dest")) {
                    ...
                    reportFile =
                            new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/retirementlist1_New.jasper"));
                    System.out.println("after" + reportFile);
                    map.put("txtfrom", d);
                    map.put("txtto", d1);
                    ...
                    reportFile =
                            new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/retirementlist1_Rank_New.jasper"));
                    System.out.println("after" + reportFile);
                    map.put("txtfrom", d);
                    map.put("txtto", d1);
                    ...
                    reportFile =
                            new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/retirementlist1_Cadre_New.jasper"));
                    System.out.println("after" + reportFile);
                    map.put("txtfrom", d);
                    map.put("txtto", d1);
            ...
            */
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Retirementlist.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Retirementlist.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Retirementlist.xls\"");
