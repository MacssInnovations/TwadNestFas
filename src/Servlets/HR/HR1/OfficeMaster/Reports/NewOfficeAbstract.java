...
public class NewOfficeAbstract extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            String cmbOfficeType = request.getParameter("cmbOfficeType");

            System.out.println("aaaaaaaaaaaaaaaa" + cmbOfficeType);
            if (opt.equalsIgnoreCase("ALLABS")) {
            ...
            } else if (opt.equalsIgnoreCase("SEL2")) {

                System.out.println("eeeeeeeeeeeeeeeeee" + opt);
                if (!cmbOfficeType.equalsIgnoreCase("0")) {
                    reportFile =
                            new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/NewOfficeSubDivisionAbstract.jasper"));
                }
                ...
                if (selstr.equalsIgnoreCase("ABS")) {
                    ...
                    // reportFile = new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/NewOfficeCirclewiseAbstractSpe.jasper"));
