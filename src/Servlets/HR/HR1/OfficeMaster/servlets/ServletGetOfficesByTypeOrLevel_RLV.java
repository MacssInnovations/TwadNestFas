...
public class ServletGetOfficesByTypeOrLevel_RLV extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if ((command.equals("level")) &&
                    ...
                    sql =
 "select CIRCLE_OFFICE_ID,CIRCLE_OFFICE_NAME from COM_MST_CIRCLES_HVIEW";
 ...
 xml + "<options><id>" + results.getInt("REGION_OFFICE_ID") + "</id><name>" +
   results.getString("REGION_OFFICE_NAME") + "</name></options>";
                    ...
                    sql =
 "select AUDITWING_OFFICE_ID,AUDITWING_OFFICE_NAME from COM_MST_AUDIT_WING_HVIEW ";
                    System.out.println("the sql is and i have selected circle " +
                                       sql);
                    Statement statement = connection.createStatement();
                    ResultSet results = statement.executeQuery(sql);
 ...
 xml + "<options><id>" + results.getInt("AUDITWING_OFFICE_ID") +
   ...
   "</name></options>";
                    ...
                    sql =
 "select LAB_OFFICE_ID,LAB_OFFICE_NAME from COM_MST_LABS_HVIEW ";
                    System.out.println("the sql is and i have selected circle " +
                                       sql);
                    Statement statement = connection.createStatement();
                    ResultSet results = statement.executeQuery(sql);
 ...
 "select DIVISION_OFFICE_ID,DIVISION_OFFICE_NAME from\n" + "(\n" +
   ...
   ") b\n" + "on a.office_id=b.division_office_id";
                    System.out.println("the sql is and i have selected circle " +
                                       sql);
                    Statement statement = connection.createStatement();
                    ResultSet results = statement.executeQuery(sql);
 ...
 "select SUBDIVISION_OFFICE_ID,SUBDIVISION_OFFICE_NAME from\n" + "(\n" +
   ...
   ") b\n" + "on a.office_id=b.SUBDIVISION_OFFICE_ID";
                    System.out.println("the sql is and i have selected circle " +
                                       sql);
                    Statement statement = connection.createStatement();
                    ResultSet results = statement.executeQuery(sql);
