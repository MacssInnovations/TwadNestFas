...
public class ServletOffices extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            try {
                String sql1 = "";
                sql1 =
"insert into COM_MST_OFFICES(Office_Name,Office_Short_Name,OFFICE_HEAD_CADRE_ID,Office_Address1,Office_Address2,CITY_TOWN_NAME,Office_Pin_Code,District_Code,Office_STD_Code,Office_Phone_no,";
                sql1 =
sql1 + "Addl_Phone_Nos,Office_Fax_No,Addl_Fax_Nos,Office_Email_Id,Addl_Email_Ids,Office_Level_Id,Office_Old_Code,Primary_Work_Id,Date_of_Formation,";
                sql1 =
sql1 + "HRA_Class_Id,CCA_Class_Id,Accounting_Unit,Wings_Applicable,Remarks,UPDATED_DATE,UPDATED_BY_USER_ID,OFFICE_STATUS_ID,STATUS_EFFECTIVE_FROM) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

                String sql2 =
                    "insert into COM_OFFICE_CONTROL(OFFICE_ID,CONTROLLING_OFFICE_ID,DATE_EFFECTIVE_FROM,REMARKS,UPDATED_BY_USER_ID,UPDATED_DATE) values (?,?,?,?,?,?)";
                ...
                ps1.setDate(19, dateOfFormation);
                ...
                ps1.setString(24, strRemarks);

                long l = System.currentTimeMillis();
                Timestamp ts = new Timestamp(l);
                ps1.setTimestamp(25, ts);
                System.out.println("executijng  1");
                ps1.setString(26, "unknown"); // user id
                ps1.setString(27, "CR");
                java.sql.Date sdate =
                    new java.sql.Date(System.currentTimeMillis());
                ps1.setDate(28, sdate);
                ...
                try {
                    ...
                    if (i >= 1) {
                        String query =
                            "select Office_Id from COM_MST_OFFICES where UPDATED_DATE=?";
                        try {
