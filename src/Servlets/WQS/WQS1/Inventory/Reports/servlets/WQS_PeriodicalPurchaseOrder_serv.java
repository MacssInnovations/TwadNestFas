...
public class WQS_PeriodicalPurchaseOrder_serv extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/wqs_PeriodicalPurchseOrder_Rep.jasper"));
   ...
   new GregorianCalendar(Integer.parseInt(sd[2]), Integer.parseInt(sd[1]) - 1,
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"periodicalPurchaseOrder.html\"");
                PrintWriter out = response.getWriter();
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"periodicalPurchaseOrder.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"periodicalPurchaseOrder.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"periodicalPurchaseOrder.txt\"");
