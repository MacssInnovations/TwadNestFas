...
public class WQS_DateWise_ItemReceipt extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
   ...
   new GregorianCalendar(Integer.parseInt(sd[2]), Integer.parseInt(sd[1]) - 1,
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/WQS_DatewiseReceipt_Rep.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"ItemReceipt.html\"");
                PrintWriter out = response.getWriter();
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"ItemReceipt.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"ItemReceipt.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"ItemReceipt.txt\"");
