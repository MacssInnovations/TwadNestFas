...
public class WQS_DirectoryRepserv extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            if (cat.equalsIgnoreCase("chemical")) {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/wqs_ChemicalDirectoryReport.jasper"));
                ...
                System.out.println("calling servlet");
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/wqs_InstrumentDirectoryReport.jasper"));
                System.out.println("after path");
                ...
                System.out.println("calling servlet");
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/wqs_GlasswareDirectoryReport.jasper"));
                System.out.println("after path");
                ...
                System.out.println("calling servlet");
                reportFile =
                        new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/WQS_MiscellaneousRep.jasper"));
                System.out.println("after path");
