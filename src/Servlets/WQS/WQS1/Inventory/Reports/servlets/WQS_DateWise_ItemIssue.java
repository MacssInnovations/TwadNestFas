...
public class WQS_DateWise_ItemIssue extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
   ...
   new GregorianCalendar(Integer.parseInt(sd[2]), Integer.parseInt(sd[1]) - 1,
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/WQS_Datewise_ItemIssue_Rep.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"datewiseReceipt.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"datewiseReceipt.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"datewiseReceipt.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"datewiseReceipt.txt\"");
