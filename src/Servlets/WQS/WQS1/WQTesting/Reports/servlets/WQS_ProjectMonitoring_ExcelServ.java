...
public class WQS_ProjectMonitoring_ExcelServ extends HttpServlet {
...
//                    ":" + strsid.trim();
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/WQS_ProjectMonitoring_ExcelRep.jasper"));
