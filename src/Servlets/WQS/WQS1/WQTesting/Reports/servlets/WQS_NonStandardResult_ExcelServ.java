...
public class WQS_NonStandardResult_ExcelServ extends HttpServlet {
...
//                    ":" + strsid.trim();
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/WQS_NonStandardResult_ExcelRep.jasper"));
