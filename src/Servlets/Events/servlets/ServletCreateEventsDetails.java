...
//                    ":" + strsid.trim();
            ...
            String str_event_id = "", str_event_desc = "", str_event_venue =
                "", str_event_date = "", str_target_url = "", trimed_url = "";
            int event_id = 0;
            ...
            try {
                ...
                System.out.println("values retrived sucessfully   :" +
                                   str_event_id + "  " + str_event_desc +
                                   "  " + str_event_venue + "  " +
                                   str_event_date + "  " + str_target_url);
            } catch (Exception e) {
                e.printStackTrace();
            ...
            try {
                String sql1 = "";
                sql1 =
"insert into com_mst_events(EVENT_ID,EVENT_DESC,EVENT_VENUE,EVENT_DATE,TARGET_URL,EVENT_STATUS_ID) VALUES (?,?,?,?,?,'CD')";
                ...
                if (str_event_date != "" && str_event_date != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        sendMessage(response,
                                    "Date of Event is not valid.<br>", "back");
                    }
                }
                ...
                if (i >= 1) {
                    ...
                    String msg =
                        "Event has been created successfully. Event ID : " +
                        event_id + "";
                    msg = msg + "<br><br>";
