...
public class View_Trial_Balance_SJV_WithOB extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/View_Trial_Balance_SJV_WithOB.jasper"));
                ...
                map.put("supplementno", Supplment_No);
