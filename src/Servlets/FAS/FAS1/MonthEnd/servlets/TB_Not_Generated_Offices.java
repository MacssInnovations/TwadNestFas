...
public class TB_Not_Generated_Offices extends HttpServlet {
        ...
        */
        ...
        try {
            ...
            try {
                ...
                if (RegionId == 101) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TB_Not_Generated_Offices_AllRegion.jasper"));
                } else if (RegionId == 5000) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TB_Not_Generated_Offices_forHO.jasper"));
                } else {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TB_Not_Generated_Offices.jasper"));
                }
