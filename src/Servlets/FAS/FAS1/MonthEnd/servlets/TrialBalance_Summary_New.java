...
public class TrialBalance_Summary_New extends HttpServlet {
        ...
        */
        ...
        try {
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_New.jasper"));
