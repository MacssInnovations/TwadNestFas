...
public class Self_Balance extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Self_Balance/SelfBalance2.jasper"));
