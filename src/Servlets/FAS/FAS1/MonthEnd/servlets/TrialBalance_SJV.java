...
public class TrialBalance_SJV extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try { /////////////////////-------------------------- Print Challan------------------
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Trial_Balance_SJV.jasper"));
