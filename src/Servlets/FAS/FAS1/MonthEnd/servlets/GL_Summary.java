...
public class GL_Summary extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try {
                ...
                {
                   txtAcc_HeadCode=request.getParameter("txtAcc_HeadCode");
                   sql="and account_head_code = "+txtAcc_HeadCode;
                   
                   reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Reg_Summary/GL_Summary1.jasper"));
                   
                }
                else
                {
                    
                    reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Reg_Summary/GL_Summary1_All.jasper"));
         ...
         if(rs.next())
            ...
            map.put("month_from",month_from);
            map.put("year_from",year_from);
            map.put("monthvalue",monthInWords);
            map.put("month_to",month_to);
            map.put("year_to",year_to);
            map.put("monthvalue_to",monthInWords_to);
            map.put("headcode",txtAcc_HeadCode);
            map.put("supplementno",txtsupplement_no);            
            ...
            else if (rtype.equalsIgnoreCase("PDF"))   
            {
                        ...
                        response.setHeader ("Content-Disposition", "attachment;filename=\"GLSummary.pdf\"");
            ...
            else if (rtype.equalsIgnoreCase("EXCEL"))   
            {
                    ...
                    response.setHeader ("Content-Disposition", "attachment;filename=\"SubLedgerReport.xls\"");
