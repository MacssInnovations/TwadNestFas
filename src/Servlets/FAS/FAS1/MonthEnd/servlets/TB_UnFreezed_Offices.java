...
public class TB_UnFreezed_Offices extends HttpServlet {
 ...
 statement.executeQuery("select office_id from com_mst_all_offices_view where region_office_id=" +
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TB_UnFreezed_Offices.jasper"));
