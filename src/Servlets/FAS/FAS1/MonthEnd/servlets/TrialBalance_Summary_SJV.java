...
public class TrialBalance_Summary_SJV extends HttpServlet {
        ...
        */
        ...
        try {
            ...
            try {
                ...
                if ( (Supplement_No == 1) && (command.equalsIgnoreCase("normal")) ) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_SJV.jasper"));
                } else if (command.equalsIgnoreCase("normal") ){
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_SJV_2.jasper"));
                }
                
                //added as on 22 Mar 2012
                
                if ( (Supplement_No == 1) && (command.equalsIgnoreCase("withOB")) ) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_SJV_OB.jasper"));
                } else if (command.equalsIgnoreCase("withOB") ){
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_SJV_2_OB.jasper"));
                }
