...
public class SJV_GL_Summary extends HttpServlet {
    ...
    void doGet(HttpServletRequest request,
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/SJV_Summary/SJV_GL_Summary.jasper"));
            ...
            map.put("cbyear", year);
            map.put("cbmonth_value", monthInWords);
            map.put("supplno", txtsupplement_no);
