...
public class TrialBalance_Summary extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                if( command.equalsIgnoreCase("normal"))
                {
                	...
                	reportFile =new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary_OB.jasper"));
                }
                else if( command.equalsIgnoreCase("withOB"))
                {
                	System.out.println("normal");
                reportFile =new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TrialBalance_Summary.jasper"));
                }
