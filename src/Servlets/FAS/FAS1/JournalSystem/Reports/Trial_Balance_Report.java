...
public class Trial_Balance_Report extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
     ...
     */
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/TrialBalance/jasper/Trial_Balance_Report1.jasper"));
