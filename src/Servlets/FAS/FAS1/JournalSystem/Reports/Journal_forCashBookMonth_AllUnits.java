...
public class Journal_forCashBookMonth_AllUnits extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        int txtCB_Year = 0, txtCB_Month = 0, cmbAcc_UnitCode =
            0, cmbOffice_code = 0, txtVoucher_No = 0, txtSupplement_No = 0;
        ...
        try {
            ...
            System.out.println("Exp in supplement");
        }
        ...
        try {
            ...
            if (cmbAcc_UnitCode != 999)
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/JournalSystem/jasper/Journal_forCashBookMonth.jasper"));
            else
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/JournalSystem/jasper/Journal_forCashBookMonth_AllUnits.jasper"));
