...
public class Journal_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/JournalSystem/jasper/Journal_Report.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Journal_Print.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Journal_Print.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Journal_Print.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Journal_Print.txt\"");
