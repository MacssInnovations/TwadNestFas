...
//                    ":" + strsid.trim();
    ...
    public void doPost(HttpServletRequest request,
        ...
        String sql =
            "insert into FAS_ACCOUNT_HEAD_MASTER  values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            ...
            java.sql.Date date2 = null, date3 = null;
            ...
            if (!strStatus.equals("Y")) {
                ...
                date3 = java.sql.Date.valueOf(dateString3);
            ...
            if (strSub_ledg.equals("Y")) {
                ...
                PreparedStatement ps1 =
                    connection.prepareStatement("insert into FAS_APPLICABLE_SL_TYPE  values(?,?,?,?)");
