...
public class TDA_Report extends HttpServlet {
				...
				try
							{
								...
								ps=con.prepareStatement("select VOUCHER_NO from FAS_TDA_TCA_RAISED_MST where CASHBOOK_YEAR='"+year+"' and CASHBOOK_MONTH='"+month+"' and ACCOUNTING_UNIT_ID='"+cmbAcc_UnitCode+"' and  ACCOUNTING_FOR_OFFICE_ID='"+cmbOffice_code+"'");
								rs=ps.executeQuery();
								while(rs.next())
								{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
        ...
        if(reporttype==1)
        {
      	  repcondn = " and (supplement_no =0 or supplement_no is null)";
        }
        else if(reporttype==3)
        {
      	  repcondn = " and supplement_no ="+suppnumber;
        }
		...
		File reportFile=null;
		 try {
            ...
            System.out.println("monthInWords....."+monthInWords);
                ...
                reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/TDA_Report.jasper"));
     ...
     //   JasperReport jasperReport =     JasperCompileManager.compileReport(jasperDesign);
        ...
        System.out.println("accountingunitid"+cmbAcc_UnitCode+"accountofficeid"+cmbOffice_code+"txtCB_Year"+year+"monthInWords"+monthInWords+"vou_no"+vou_no+"supplement_no"+repcondn);
        ...
        if (rtype.equalsIgnoreCase("PDF"))   
        {
        	System.out.println("PDF");
                    ...
                    response.setHeader ("Content-Disposition", "attachment;filename=\"tdaoriginating.pdf\"");
