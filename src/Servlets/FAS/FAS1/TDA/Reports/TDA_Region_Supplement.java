 ...
 */
public class TDA_Region_Supplement extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 private static final String CONTENT_TYPE = "text/html; charset=windows-1252";        
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TDA_Region_Supplement() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResultSet rs=null;
        Calendar c;
        int supp_No=0,cmbAcc_UnitCode=0,cmbOffice_code=0,cashYear=0,cashMonth=0,cashYearFrom=0,cashYearTo=0,cashMonthFrom=0,cashMonthTo=0;
        ...
        try{
        	...
        	supp_No=Integer.parseInt(request.getParameter("supp_id"));
...
//       }
        ...
        try
        {
	        ...
	        if(request.getParameter("month_year").equalsIgnoreCase("particular_cb")){
	        	...
	        	queryString +="  AND mst.tda_or_tca  ='"+tpaType+"'" +
							...
							s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Raised_Region.jrxml");
	        } else if(displayOrder.equalsIgnoreCase("OW")){        	
	        	queryString="";
	        	s="";
	        	queryString = "SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
	        	...
	        	queryString +="  AND mst.tda_or_tca  ='"+tpaType+"'" +
				        	...
				        	"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
				        	"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
	        	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Raised_Office.jrxml");
	        		...
	        		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Raised_All.jrxml");
	        	}   
        ...
        try {
            ...
            if(request.getParameter("month_year").equalsIgnoreCase("particular_cb")){
            	...
            	queryString +="  AND mst.tda_or_tca  ='"+tpaType+"'" +    				    	
    				    	...
    				    	"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
    				    	"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
    						s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Accepted_Region.jrxml");
            } else if(displayOrder.equalsIgnoreCase("OW")){           	
            	queryString="";
            	s="";
            	queryString = "SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
            	...
            	queryString +="  AND mst.tda_or_tca  ='"+tpaType+"'" +    			        	
    			        	...
    			        	"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
    			        	"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
            	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Accepted_Office.jrxml");
            } else if(displayOrder.equalsIgnoreCase("ALL")){            	
            		queryString="";
            		s="";
            		queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
            		...
            		queryString+=" AND (mst.TDA_OR_TCA             ='"+tpaType+"' " +
    			        		...
    			        		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID " +
    			        		"ORDER BY a.voucher_no";
            		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Accepted_All.jrxml");
            	}   
	            map.put("unitid",cmbAcc_UnitCode);
	            map.put("officeid",cmbOffice_code);
	            map.put("cashyear",cashYear);
                 ...
                 queryString="SELECT TO_CHAR(mst.VOUCHER_DATE,'dd/MM/yyyy') AS VOUCHER_DATE, " +
          		...
          		queryString+="AND (mst.TDA_OR_TCA      ='"+tpaType+"'"+
			                 	...
			                 	"  ) " +
			                 	 ...
			                 	 "ORDER BY mst.voucher_no";
         			s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Rejected_Region.jrxml");
                 } else if(displayOrder.equalsIgnoreCase("OW")){
                 	queryString="";
                 	s="";
                 	queryString="SELECT TO_CHAR(mst.VOUCHER_DATE,'dd/MM/yyyy') AS VOUCHER_DATE, " +
             		...
             		queryString+="AND (mst.TDA_OR_TCA      ='"+tpaType+"'"+
			                 	 ...
			                 	 "ORDER BY mst.voucher_no";
                 	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Rejected_Office.jrxml");
                 } else if(displayOrder.equalsIgnoreCase("ALL")){            	
                 		queryString="";
                 		s="";
                 		queryString="SELECT TO_CHAR(mst.VOUCHER_DATE,'dd/MM/yyyy') AS VOUCHER_DATE, " +
                 		...
                 		queryString+="AND (mst.TDA_OR_TCA      ='"+tpaType+"'"+
				                 	 ...
				                 	 "AND mst.ACCEPTANCE_STATUS ='N' " +
				                 	 "ORDER BY mst.voucher_no";
                 		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Rejected_All.jrxml");
                 	}   
     	            map.put("unitid",cmbAcc_UnitCode);
     	            map.put("officeid",cmbOffice_code);
     	            map.put("cashyear",cashYear);
        ...
        try {    
            ...
            if(displayOrder.equalsIgnoreCase("RW")) {
        		...
        		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID " +
        		"ORDER BY a.voucher_no";
        			s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Pending_Region.jrxml");
                } else if(displayOrder.equalsIgnoreCase("OW")){
                	queryString="";
                	s="";
                	queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy') AS VOUCHER_DATE, " +
            		...
            		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID " +
            		"ORDER BY a.voucher_no";
                	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Pending.jrxml");
                } else if(displayOrder.equalsIgnoreCase("ALL")){ 
                		queryString="";
                		s="";
                		queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy') AS VOUCHER_DATE, " +
                		...
                		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID " +
                		"ORDER BY a.voucher_no";             		
                		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Pending_All.jrxml");
                	}   
    	            map.put("unitid",cmbAcc_UnitCode);
    	            map.put("officeid",cmbOffice_code);
    	            map.put("cashyear",cashYear);
          ...
          try {
              ...
              if(displayOrder.equalsIgnoreCase("RW")) {
                  ...
                  queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
            		...
            		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
            		"ORDER BY a.voucher_no";
          			s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Resp_pending_Region.jrxml");
                  } else if(displayOrder.equalsIgnoreCase("OW")){ 
                  	queryString="";
                  	s="";
                  	queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
              		...
              		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
              		"ORDER BY a.voucher_no";
                  	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Resp_pending_Office.jrxml");
                  } else if(displayOrder.equalsIgnoreCase("ALL")){ 
                  		queryString="";
                  		s="";
                  		queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
                  		...
                  		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
                  		"ORDER BY a.voucher_no";           		
                  		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Responding_Report.jrxml");
                  	}   
      	            map.put("unitid",cmbAcc_UnitCode);
      	            map.put("officeid",cmbOffice_code);
      	            map.put("cashyear",cashYear);
               ...
               try {
                   ...
                   if(displayOrder.equalsIgnoreCase("RW")) {
                       ...
                       queryString = "SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
                  		...
                  		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
                  		"ORDER BY a.VOUCHER_NO";
               			s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Resp_Cleared_region.jrxml");
                       } else if(displayOrder.equalsIgnoreCase("OW")){ 
                       	queryString="";
                       	s="";
                       	queryString = "SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
                   		...
                   		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
                   		"ORDER BY a.VOUCHER_NO";
                       	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Resp_Cleared_Office.jrxml");
                       } else if(displayOrder.equalsIgnoreCase("ALL")){ 
                       		queryString="";
                       		s="";                       		
                       		queryString = "SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
                       		...
                       		"ON a.ACCOUNTING_UNIT_ID=b.ACCOUNTING_UNIT_ID " +
                       		"ORDER BY a.VOUCHER_NO";
                       		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_Responding_all_cleared.jrxml");
                       	}   
           	            map.put("unitid",cmbAcc_UnitCode);
           	            map.put("officeid",cmbOffice_code);
           	            map.put("cashyear",cashYear);
        ...
        try
        {
            ...
            if(displayOrder.equalsIgnoreCase("RW")) {
        		...
        		queryString+="  )a " +
	                		...
	                		"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
	                		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
        			s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_ALL_Region.jrxml");
                } else if(displayOrder.equalsIgnoreCase("OW")){ 
                	queryString="";
                	s="";
            		...
            		queryString+="  )a " +
		                		...
		                		"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
		                		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
                	s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_ALL.jrxml");
                } else if(displayOrder.equalsIgnoreCase("ALL")){ 
                		queryString="";
                		s="";             		
                		queryString="SELECT TO_CHAR(a.VOUCHER_DATE,'dd/MM/yyyy')   AS VOUCHER_DATE, " +
                		...
                		queryString+="  )a " +
			                		...
			                		"LEFT OUTER JOIN FAS_MST_ACCT_UNITS c " +
			                		"ON c.ACCOUNTING_UNIT_ID=a.TRF_ACCOUNTING_UNIT_ID";
                		s=request.getRealPath("/org/FAS/FAS1/Reports/TDA/jasper/Supp_Region/TDA_ALL_All.jrxml");
                	}   
    	            map.put("unitid",cmbAcc_UnitCode);
    	            map.put("officeid",cmbOffice_code);
    	            map.put("cashyear",cashYear);
