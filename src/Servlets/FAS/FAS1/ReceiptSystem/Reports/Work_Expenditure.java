...
public class Work_Expenditure extends HttpServlet {
  ...
  connection.prepareStatement("select OFFICE_NAME,OFFICE_ID from COM_MST_OFFICES where OFFICE_LEVEL_ID in ('RN','HO') and office_id=" +
        ...
        try {
            ...
            try {
                ...
                if (RegionId == 5000) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Works_Expenditure_new_4HO.jasper"));
                } else {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Works_Expenditure_new.jasper"));
                }
