...
public class OldtrailbalanceReport_New extends HttpServlet {
   ...
   // int month=Integer.parseInt(txtCB_Month);
    ...
    if(strCommand.equalsIgnoreCase("loadunit"))
        ...
        //    ps.setInt(2,month);
            ...
            while(rs1.next())
            {
                ...
                //xml=xml+"&amp<accounting_unit_name>"+rs1.getString("ACCOUNTING_UNIT_NAME")+"</accounting_unit_name>";                                                                                                                                                                                                                                            
                xml=xml+"</option>";  
               cnt++;  
    ...
    public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
    {
       ...
       // PrintWriter out = response.getWriter();
        ...
        String Account_unit_Code=request.getParameter("cmbAcc_UnitCode2");
        String Yearfrom=request.getParameter("txtCB_Year_from");
        String Yearto=request.getParameter("myselect");
        ...
        //This Two Variables for calculateting Finyearto and year
        ...
        System.out.println("accountheadcode"+accountheadcode);  
         try 
         {
                   ...
                   try
                   {
                       ...
                       {
                           reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear.jasper"));
                       }
                       /**
                        * Single Month + Single A/C Head 
                        */
                        if(Specifictype.equalsIgnoreCase("Specific"))
                       {  System.out.println("Single");
                           reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear_spAC.jasper"));
                        ...
                        if(Specifictype.equalsIgnoreCase("Allunits"))         
                        {
                            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear_All.jasper"));
                        }
                        if(Specifictype.equalsIgnoreCase("AllunitsTB"))         
                        {
                            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear_Allunits.jasper"));
                        }
                        if(Specifictype.equalsIgnoreCase("SpecificTB"))
                        {  System.out.println("Single");
                            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear_spAC_units.jasper"));
                                  // reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_spAC.jasper")); 
                        }
                        if(Specifictype.equalsIgnoreCase("UnitwiseTB"))
                        {
                        	reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_data9507_fromtofinyear_spAC_1.jasper"));
                        }
