...
public class Old_Data_TrialBalance_Supplment extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(strCommand.equalsIgnoreCase("loadsupp"))
		{  
		String CONTENT_TYPE = "text/xml; charset=windows-1252";
		response.setContentType(CONTENT_TYPE);
		// PrintWriter out = response.getWriter();
		...
		flag=Integer.parseInt(flagid); 
		supp_Month=request.getParameter("supp_Month");
		cb_mon=12+flag;
		...
		try 
		{
			...
			try
			{
				reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/old_trilbalance_Report_Allsupp.jasper"));
				...
				map.put("cb_mon",cb_mon);
				map.put("cb_year",CashBookYear);
				map.put("flag",flag);
