...
public class Work_Expenditure_SJV extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        */
        ...
        /** Get Region Name */
        String Region_Name = request.getParameter("");
        ...
        try {
            ...
            ps =
  connection.prepareStatement("select OFFICE_NAME,OFFICE_ID from COM_MST_OFFICES where OFFICE_LEVEL_ID in ('RN','HO') and office_id=" +
                              RegionId);
            rs1 = ps.executeQuery();
            while (rs1.next()) {
                RegionName = rs1.getString("OFFICE_NAME");
        ...
        try {
            ...
            try {
                if (RegionId == 5000) {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Works_Expenditure_new_SJV_4HO.jasper"));
                } else {
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Works_Expenditure_new_SJV.jasper"));
                }
