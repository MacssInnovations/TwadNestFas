...
public class List_of_AllTransactions extends HttpServlet {
        ...
        */
        ...
        try {
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/TransactionCount/List_of_All_Transactions.jasper"));
                ...
                map.put("from_cashbookmonthvalue", from_monthInWords);
                map.put("to_cashbookmonthvalue", to_monthInWords);
