...
public class Sales_Tax_Return_ComWing extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/SalesTax_Return_report_ComWing.jasper"));
                ...
                //      map.put("unitid",AccountUnitCode);
