 ...
 */
public class A5ScheduleReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 try
	        ...
	        try 
	        {
	        	System.out.println("A5Schedule  Checking...1");
	            ...
	            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/A5ScheduleReport.jasper")); 
	         ...
	         System.out.println("map values"+map);
	            ...
	            if (rtype.equalsIgnoreCase("HTML"))   
	            {
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A5ScheduleReport.html\"");
	            ...
	            else if (rtype.equalsIgnoreCase("PDF"))   
	            {
	            	...
	            	//System.out.println("inside apdf...");
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A5ScheduleReport.pdf\"");
	            ...
	            else if (rtype.equalsIgnoreCase("EXCEL"))   
	            {
		                    ...
		                    response.setHeader ("Content-Disposition", "attachment;filename=\"A5ScheduleReport.xls\"");
	            ...
	            else if (rtype.equalsIgnoreCase("TXT"))   
	            {
			                ...
			                response.setHeader ("Content-Disposition", "attachment;filename=\"A5ScheduleReport.txt\"");
