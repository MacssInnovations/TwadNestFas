...
/**
 * Servlet implementation class A24ScheduleReport
 */
public class A24ScheduleReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 try
	        ...
	        try 
	        {
	        	System.out.println("A24Schedule  Checking...1");
	            ...
	            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/A24ScheduleReport.jasper")); 
	           ...
	           System.out.println("map values"+map);
	            ...
	            if (rtype.equalsIgnoreCase("HTML"))   
	            {
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A24ScheduleReport.html\"");
	            ...
	            else if (rtype.equalsIgnoreCase("PDF"))   
	            {
	            	...
	            	//System.out.println("inside apdf...");
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A24ScheduleReport.pdf\"");
	            ...
	            else if (rtype.equalsIgnoreCase("EXCEL"))   
	            {
		                    ...
		                    response.setHeader ("Content-Disposition", "attachment;filename=\"A24ScheduleReport.xls\"");
	            ...
	            else if (rtype.equalsIgnoreCase("TXT"))   
	            {
			                ...
			                response.setHeader ("Content-Disposition", "attachment;filename=\"A24ScheduleReport.txt\"");
