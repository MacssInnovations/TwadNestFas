...
/**
 * Servlet implementation class CashReceipt
 */
public class CashReceipt extends HttpServlet {
	 ...
	 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
	     ...
	     */
	        ...
	        try {
	            ...
	            reportFile =
	                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/CashReceiptRegister.jasper"));
	            ...
	            if(txtCB_Month == 3)
	            {
	            	heading = "(Including Supplement(s))";
	            }
