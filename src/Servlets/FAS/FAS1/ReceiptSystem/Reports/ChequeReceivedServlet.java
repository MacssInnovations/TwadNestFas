...
public class ChequeReceivedServlet extends HttpServlet {
 ...
 //           	 acc_no_1=" where ACCOUNT_NO="+cmbBankAccNo;
            ...
            if (accountingunit == 5) {
          	  if (rtype.equalsIgnoreCase("EXCEL")) {
        		  reportFile =
                          new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeReceivedReport_HOEX.jasper"));
        	  }else{
                reportFile =
            	  ...
            	  if (rtype.equalsIgnoreCase("EXCEL")) {
            		  reportFile =
                              new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeReceivedReport_OfficeEX.jasper"));
            	  }else{
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeReceivedReport_Office.jasper"));
            	  }
            	  }
