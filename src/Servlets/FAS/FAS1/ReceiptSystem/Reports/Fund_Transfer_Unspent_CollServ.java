...
public class Fund_Transfer_Unspent_CollServ extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        int bank_id = Integer.parseInt(request.getParameter("txt_bkname"));
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Fund_Transfer_Unspent_Coll.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer.txt\"");
