...
/**
 * Servlet implementation class A28ScheduleReport
 */
public class A28ScheduleReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final String CONTENT_TYPE = "text/html; charset=windows-1252"; 
	 Connection connection = null;
    public A28ScheduleReport() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 try
	        ...
	        try 
	        {
	        	System.out.println("A28Schedule  Checking...1");
	            ...
	            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Schedules/A28/A28ScheduleReport.jasper")); 
	           ...
	           System.out.println("map values"+map);
	            ...
	            if (rtype.equalsIgnoreCase("HTML"))   
	            {
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A28ScheduleReport.html\"");
	            ...
	            else if (rtype.equalsIgnoreCase("PDF"))   
	            {
	            	...
	            	//System.out.println("inside apdf...");
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A28ScheduleReport.pdf\"");
	            ...
	            else if (rtype.equalsIgnoreCase("EXCEL"))   
	            {
		                    ...
		                    response.setHeader ("Content-Disposition", "attachment;filename=\"A28ScheduleReport.xls\"");
	            ...
	            else if (rtype.equalsIgnoreCase("TXT"))   
	            {
			                ...
			                response.setHeader ("Content-Disposition", "attachment;filename=\"A28ScheduleReport.txt\"");
