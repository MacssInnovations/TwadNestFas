...
/**
 * Servlet implementation class A4ScheduleReport
 */
public class A4ScheduleReport extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 try
	        ...
	        try 
	        {
	        	//System.out.println("A4Schedule  Checking...1");
	            ...
	            reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/A4ScheduleReport.jasper")); 
  	         ...
  	         System.out.println("map values"+map);
	            ...
	            if (rtype.equalsIgnoreCase("HTML"))   
	            {
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A4ScheduleReport.html\"");
	            ...
	            else if (rtype.equalsIgnoreCase("PDF"))   
	            {
	            	...
	            	//System.out.println("inside apdf...");
	                        ...
	                        response.setHeader ("Content-Disposition", "attachment;filename=\"A4ScheduleReport.pdf\"");
	            ...
	            else if (rtype.equalsIgnoreCase("EXCEL"))   
	            {
		                    ...
		                    response.setHeader ("Content-Disposition", "attachment;filename=\"A4ScheduleReport.xls\"");
	            ...
	            else if (rtype.equalsIgnoreCase("TXT"))   
	            {
			                ...
			                response.setHeader ("Content-Disposition", "attachment;filename=\"A4ScheduleReport.txt\"");
