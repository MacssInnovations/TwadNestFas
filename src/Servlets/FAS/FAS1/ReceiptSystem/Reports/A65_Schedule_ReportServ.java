...
public class A65_Schedule_ReportServ extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/A65_Schedule_Report.jasper"));
            ...
            System.out.println("\n acc_unit_id"+ cmbAcc_UnitCode);
            System.out.println("\n off_id"+ cmbOffice_code);
            System.out.println("\n yr"+ txtCB_Year);
            System.out.println("\n mon"+ txtCB_Month);
            System.out.println("\n monthInWords"+ monthInWords + " " + txtCB_Year);

            byte buf[] = JasperExportManager.exportReportToPdf(jasperPrint);
            response.setContentType("application/pdf");
            response.setContentLength(buf.length);
            response.setHeader("Content-Disposition",
                               "attachment;filename=\"FAS_Schedule_A65.pdf\"");
