...
public class Work_Expenditure_UnitWise_SJV extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        */
        ...
        int CashBookMonth = 0;
        int Account_unit = 0;
        int Account_office_code = 0;


        /** Convert String data into Integer Data */
        try {

            Account_unit = Integer.parseInt(Account_unit_Code);
            Account_office_code = Integer.parseInt(Office_Code);
        ...
        try {
            ...
            try {
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Works_Expenditure_new_UnitWise_SJV.jasper"));
                ...
                map.put("accountingunitid", Account_unit);
                map.put("accountingofficecode", Account_office_code);
