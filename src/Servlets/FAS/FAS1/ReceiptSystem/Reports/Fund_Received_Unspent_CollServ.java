...
public class Fund_Received_Unspent_CollServ extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        int txtCB_Year = 0, txtCB_Month = 0, cmbAcc_UnitCode =
            0, cmbOffice_code = 0, txtVoucher_No = 0, bank_id = 0;
        ...
        bank_id = Integer.parseInt(request.getParameter("txt_bkname"));
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/Fund_Receipt_Unspent_Coll.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Receipt.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Receipt.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Receipt.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Receipt.txt\"");
