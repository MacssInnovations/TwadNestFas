...
public class MIS_Grouping_AssetLiability_Serv extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/MIS_Assets_Liabilities.jasper"));
            ...
            if (rtype.equalsIgnoreCase("PDF")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Asset_and_Liability.pdf\"");
