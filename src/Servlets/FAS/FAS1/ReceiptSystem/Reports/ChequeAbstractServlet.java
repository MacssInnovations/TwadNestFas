...
public class ChequeAbstractServlet extends HttpServlet {
...
{	 acc_no_1="";
	...
	// acc_no_1=" where ACCOUNT_NO="+cmbBankAccNo;
	acc_no_1=cmbBankAccNo;
            ...
            if (accountingunit == 5) {
            	...
            	{
                reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_HOEX.jasper"));
            	}
            	else if(total_wise.equals("rec"))
            	{
            		 reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_HO_receipt.jasper"));
            	}}else
            	{
                	if(total_wise.equals("che"))
                	{
                    reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_HO.jasper"));
                	}
                	else if(total_wise.equals("rec"))
                	{
                		 reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_HO_receipt.jasper"));
           	 ...
           	 if (rtype.equalsIgnoreCase("EXCEL")){
           		if(total_wise.equals("che"))
            	{
                reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_OfficeEX.jasper"));
            	}
            	else if(total_wise.equals("rec"))
            	{
            		reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_Office_receipt.jasper"));
            	}
           		 }else{
           			if(total_wise.equals("che"))
                	{
                    reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_Office.jasper"));
                	}
                	else if(total_wise.equals("rec"))
                	{
                		reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/ReceiptSystem/jasper/ChequeAbstractReport_Office_receipt.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"ChequeReceivedReport.html\"");
