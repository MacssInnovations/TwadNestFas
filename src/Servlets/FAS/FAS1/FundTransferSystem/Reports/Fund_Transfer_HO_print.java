...
public class Fund_Transfer_HO_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            if (txtCreat_By_Module.equalsIgnoreCase("ByHO"))
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/FundTransferSystem/jasper/Fund_Transfer_ByHo.jasper"));
            else if (txtCreat_By_Module.equalsIgnoreCase("ByOffice"))
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/FundTransferSystem/jasper/Fund_Transfer_ByOffice.jasper"));
            System.out.println("txtCreat_By_Module" + txtCreat_By_Module);
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer_HO.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer_HO.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Fund_Transfer_HO.txt\"");
