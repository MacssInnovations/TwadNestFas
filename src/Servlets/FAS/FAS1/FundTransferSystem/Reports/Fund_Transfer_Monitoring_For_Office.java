...
public class Fund_Transfer_Monitoring_For_Office extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
        ...
        System.out.println("inside fund transfer monitoring by venkat");
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/FundTransferSystem/jasper/Fund_Transfer_Monitoring_For_Office.jasper"));
