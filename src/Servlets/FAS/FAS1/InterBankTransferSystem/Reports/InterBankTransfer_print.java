package Servlets.FAS.FAS1.InterBankTransferSystem.Reports;
...
public class InterBankTransfer_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/InterBankTransferSystem/jasper/InterBankTransfer_print.jasper"));
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"InterBankTransfer.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"InterBankTransfer.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"InterBankTransfer.xls\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"InterBankTransfer.txt\"");
