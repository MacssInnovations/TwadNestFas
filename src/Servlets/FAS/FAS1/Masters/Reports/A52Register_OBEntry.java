...
/**
 * Servlet implementation class A52Register_OBEntry
 */
public class A52Register_OBEntry extends HttpServlet {
	   /**
	 * 
	 */
		  	        ...
		  	        //	System.out.println("offstatus  "+offstatus);
		  	        	//&&(offstatus.equalsIgnoreCase("CR"))
		  	        	 if((officlevel.equalsIgnoreCase("CL")) ){
				  	        	 ...
				  	        	 PreparedStatement ps211=connection.prepareStatement(ssq2);
				  	        	   ...
				  	        	   while(rs112.next()){
				  	        		 ...
				  	        		 xml = xml + "<unit_No>"+ rs112.getInt("ACCT_UNIT_ID_RENDERED_FOR") +"-"+rs112.getInt("RENDERING_UNIT_OFFICE_ID")+"-"+rs112.getInt("RENDERING_UNIT_OFFICE_ID")+"</unit_No>";
				  	        		  ...
				  	        		  /* xml =xml + "<offid>" + rs112.getInt("RENDERING_UNIT_OFFICE_ID") + "</offid>";
		  	        		 ...
		  	        		 //query
		  	        		/*select accounting_for_office_id,accounting_unit_id,b.office_name from fas_mst_acct_unit_offices a,com_mst_offices b
	  	                     where --a.ACCOUNTING_FOR_OFFICE_ID=b.OFFICE_ID  
                      --   a.accounting_for_office_id in (select office_id from com_mst_all_offices_view  where division_office_id=6796)
                           b.OFFICE_ID in (select office_id from com_mst_all_offices_view  where division_office_id=6796)
                          and a.ACCOUNTING_UNIT_ID= 345*/
	    	 ...
	    	 JasperDesign jasperDesign = null;
		        ...
		        try {
		          ...
		          System.out.println("check "+check);
		            	...
		            	String selectQry="select office_level_id from FAS_NEW_VIEW  where office_id="+officeidd;
				         ...
				         /*  if(officelevel.equalsIgnoreCase("CL")){
				           ...
				           ///finding circle id for unit.....
		    				...
		    				String selectQry2="select office_level_id from com_mst_all_offices_view  where office_id="+officeidd;
					           PreparedStatement ps12=connection.prepareStatement(selectQry2);
					           ResultSet rs12=ps12.executeQuery();
					           while(rs12.next()){
					        	   officelevel1=rs12.getString("office_level_id");
					          ...
					          // System.out.println(" officelevel1 "+officelevel1);
					           if(officelevel1.equalsIgnoreCase("DN")){
					        	   ...
					        	   units=" and a.accounting_unit_office_id in (select office_id from com_mst_all_offices_view  where division_office_id="+officeidd+")"  ;
		            ...
		            /*	if(check1.equalsIgnoreCase("All"))
						...
						{	
					          ...
					          // System.out.println("unit_rendered==="+unit_rendered+"  officeiddd--- "+officeiddd);
					           ...
					           String selectQry1="select office_level_id from com_mst_all_offices_view  where office_id="+officeiddd;
					           PreparedStatement ps11=connection.prepareStatement(selectQry1);
					           ...
					           if(officelevel.equalsIgnoreCase("DN")){
					        	newQry="in (select office_id from com_mst_all_offices_view  where division_office_id="+officeiddd+")"  ;
					        	   String selectQry1="select OFFICE_ID,office_level_id from com_mst_all_offices_view  where division_office_id="+officeiddd;
						           PreparedStatement ps1=connection.prepareStatement(selectQry1);
						           ResultSet rs1=ps1.executeQuery();
						           while(rs1.next()){
						        	   officelevelid=rs1.getInt("OFFICE_ID");
						           }
					           }else{
					        	   newQry="="+officeiddd;
					           }
					           ...
					           //in (select office_id from com_mst_all_offices_view  where division_office_id=5052)
					           System.out.println("new qry---  "+newQry);	
						}*/
		           ...
		           reportFile =new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Masters/jasper/A52RegisterOBDataEntry.jasper"));
		           ...
		           // input get from
		            ...
		            if (rtype.equalsIgnoreCase("HTML")) {
		                ...
		                response.setHeader("Content-Disposition",
		                                   "attachment;filename=\"A52RegisterOBEntry.html\"");
		                PrintWriter out = response.getWriter();
		                ...
		                response.setHeader("Content-Disposition",
		                                   "attachment;filename=\"A52RegisterOBEntry.pdf\"");
		                ...
		                response.setHeader("Content-Disposition",
		                                   "attachment;filename=\"A52RegisterOBEntry.xls\"");
		                ...
		                response.setHeader("Content-Disposition",
		                                   "attachment;filename=\"A52RegisterOBEntry.txt\"");
