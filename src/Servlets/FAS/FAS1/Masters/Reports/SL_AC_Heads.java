...
public class SL_AC_Heads extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        try {
            ...
            if (Specifictype.equalsIgnoreCase("All")) {
                if (accountingunit == 5)
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Masters/jasper/openeing_balance_SL_AH_All.jasper"));
                else
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Masters/jasper/openeing_balance_SL_AH_All.jasper"));
            } else {
                if (accountingunit == 5)
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Masters/jasper/openeing_balance_SL_AH.jasper"));
                else
                    reportFile =
                            new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Masters/jasper/openeing_balance_SL_AH.jasper"));
            }
