...
/**
 * Servlet implementation class MIS_Monthly_Acc_Grouping_of_Consolidated_trial_Balance_Report
 */
public class MIS_Monthly_Acc_Grouping_of_Consolidated_trial_Balance_Report extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MIS_Monthly_Acc_Grouping_of_Consolidated_trial_Balance_Report() {
        super();
...
//				.getParameter("cmbOffice_code"));
		...
		String year = null;
		int year1=cboCashBook_Year+1;
		int year2=cboCashBook_Year-1;
		if(cboCashBook_Month>3)
		{
			year = cboCashBook_Year +"-"+year1;
		}else{
			year = year2 +"-"+cboCashBook_Year;
		}
		//added to find the for the year cr dr amount*********
		...
		try {
			...
			reportFile = new File(getServletContext().getRealPath(
					"/org/FAS/FAS1/MIS/jaspers/MIS_Monthly_Acc_Grouping_of_Consolidated_trial_Balance_Report.jasper"));
