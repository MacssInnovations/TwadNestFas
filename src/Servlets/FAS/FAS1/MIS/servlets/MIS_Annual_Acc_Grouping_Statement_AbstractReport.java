...
/**
 * Servlet implementation class MIS_Annual_Acc_Grouping_Statement_AbstractReport
 */
public class MIS_Annual_Acc_Grouping_Statement_AbstractReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MIS_Annual_Acc_Grouping_Statement_AbstractReport() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			reportFile = new File(getServletContext().getRealPath(
					"/org/FAS/FAS1/MIS/jaspers/MIS_Annual_Acc_Grouping_Statement_AbstractReport.jasper"));
