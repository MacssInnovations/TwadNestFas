...
/**
 * Servlet implementation class BRS_Monthly_Closure_Freeze_UnFinished_List
 */
public class BRS_Monthly_Closure_Freeze_UnFinished_List extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			reportFile = new File(getServletContext().getRealPath(
					"/org/FAS/FAS1/BRS/jaspers/BRS_Monthly_Closure_Freeze_UnFinished_List.jasper"));
			...
			if (rtype.equalsIgnoreCase("HTML")) {
				...
				response.setHeader("Content-Disposition",
						"attachment;filename=\"BRS_Monthly_Closure_Freeze_UnFinished_List.pdf\"");
