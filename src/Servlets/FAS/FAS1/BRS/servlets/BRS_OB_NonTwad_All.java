...
/**
 * Servlet implementation class BRS_OB_NonTwad_All
 */
public class BRS_OB_NonTwad_All extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BRS_OB_NonTwad_All() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		  ...
		  Connection con = null;
			...
			int cboCashBook_Year = Integer.parseInt(request.getParameter("txtCB_Year"));
			int cboCashBook_Month = Integer.parseInt(request.getParameter("txtCB_Month"));
			String rtype=request.getParameter("txtoption");
			
			String display=request.getParameter("displayingOrder");
			int cboAcc_UnitCode =0;
			String query="";

			if(display.equalsIgnoreCase("OW")){
				cboAcc_UnitCode = Integer.parseInt(request.getParameter("cmbAcc_UnitCode"));
				query="  a.accounting_unit_id=  "+cboAcc_UnitCode +" and " ;
			}
		...
		*/
			...
			try {	
					reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/BRS/jaspers/Brs_OB_Non_Twad_Report_All.jasper"));
				...
				if (rtype.equalsIgnoreCase("HTML")) {
					...
					response.setHeader("Content-Disposition",
							"attachment;filename=\"BRS_OB_NON_TWAD.html\"");
					...
					response.setHeader("Content-Disposition",
							"attachment;filename=\"BRS_OB_NON_TWAD.pdf\"");
					...
					response.setHeader("Content-Disposition",
							"attachment;filename=\"BRS_OB_NON_TWAD.xls\"");
					...
					response.setHeader("Content-Disposition",
							"attachment;filename=\"BRS_OB_NON_TWAD.txt\"");
