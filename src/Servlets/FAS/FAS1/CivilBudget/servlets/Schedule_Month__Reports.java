 ...
 */
public class Schedule_Month__Reports extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
     private static final String CONTENT_TYPE = 
            "text/html; charset=windows-1252";
        Connection connection = null;
    public Schedule_Month__Reports() {
        super();
 ...
 //        "        AND MINOR_HEAD_CODE  = " +minor_code+
		...
		"    AND cashbook_year = " +txtCB_Year_from+
         ...
         " order by step2.minor_head_code ";
       System.out.println(" !!! "+head_Cmd);
         if(head_Cmd.equalsIgnoreCase("No")){
         reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/CivilBudget/jasper/schedule/Month_Schedule_Detail_trial.jasper"));
         }
       /* else if(head_Cmd.equalsIgnoreCase("Yes")){
        	 ...
        	 reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/CivilBudget/jasper/schedule/Month_Schedule_Head.jasper")); 
         }
