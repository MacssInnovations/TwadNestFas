...
public class Fund_Receipt_HO_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            if (txtCreat_By_Module.equalsIgnoreCase("ByHO"))
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/FundReceiptSystem/jasper/Fund_Receipt_ByHo.jasper"));
            else if (txtCreat_By_Module.equalsIgnoreCase("ByOffice"))
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/FundReceiptSystem/jasper/Fund_Receipt_ByOffice.jasper"));
