...
public class PendingBills_Revised_23dec19 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (cmbMas_SL_type == 11|| cmbMas_SL_type == 7 || cmbMas_SL_type == 2 || cmbMas_SL_type == 9
					|| cmbMas_SL_type == 96 || cmbMas_SL_type == 1 || cmbMas_SL_type == 84||cmbMas_SL_type == 17) // on
																							// 29th
																							// jun
																							// (if
...
//						+ "    AND trs.CASHBOOK_MONTH        =pt.CASHBOOK_MONTH "
			...
			int cnt = 0;
			while (rs2.next()) {// System.out.println("while start");
