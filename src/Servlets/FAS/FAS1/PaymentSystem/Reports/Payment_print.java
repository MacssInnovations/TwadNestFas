package Servlets.FAS.FAS1.PaymentSystem.Reports;
...
public class Payment_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/PaymentSystem/jasper/Bank_Payment_Report.jasper"));
            //System.out.println("1234566976");
            ...
            if (rtype.equalsIgnoreCase("HTML")) {
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Payment.html\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Payment.pdf\"");
                ...
                response.setHeader("Content-Disposition",
                                   "attachment;filename=\"Payment.txt\"");
