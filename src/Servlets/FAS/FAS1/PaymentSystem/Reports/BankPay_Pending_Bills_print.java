...
public class BankPay_Pending_Bills_print extends HttpServlet {
 ...
 DriverManager.getConnection(ConnectionString, strdbusername.trim(),
        ...
        try {
            ...
            reportFile =
                    new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/PaymentSystem/jasper/Bank_Payment_PendingBills_Rep.jasper"));
