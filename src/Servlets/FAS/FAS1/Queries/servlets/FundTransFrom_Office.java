...
public class FundTransFrom_Office extends HttpServlet {
        ...
        */
        ...
        try {
            if (command.equals("searchByMonth")) {
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Queries/jasper/FundsTransReport_Office_Month.jasper"));
                ...
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Queries/jasper/FundsTransReport_Office.jasper"));
            }
