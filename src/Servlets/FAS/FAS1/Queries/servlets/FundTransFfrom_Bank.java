...
public class FundTransFfrom_Bank extends HttpServlet {
        ...
        */
        ...
        try {
            if (command.equals("searchByMonth")) {
                reportFile =
                        new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Queries/jasper/FundsTransReport_Bank.jasper"));
            }
        ...
        reportFile = new File(getServletContext().getRealPath("/org/FAS/FAS1/Reports/Queries/jasper/FundsTransReport_HO.jasper"));
       }*/
